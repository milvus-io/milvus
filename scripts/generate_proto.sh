...
${protoc_opt} --go_out=paths=source_relative:./catalogpb --go-grpc_out=require_unimplemented_servers=false,paths=source_relative:./catalogpb catalog_service.proto || { echo 'generate catalog_service.proto failed'; exit 1; }
