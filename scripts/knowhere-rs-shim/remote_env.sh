...
export MILVUS_RS_STANDALONE_ENDPOINT="${MILVUS_RS_STANDALONE_ENDPOINT:-http://127.0.0.1:19530}"
export MILVUS_RS_STANDALONE_TOKEN="${MILVUS_RS_STANDALONE_TOKEN:-root:Milvus}"
export MILVUS_RS_STANDALONE_MINIO_HOST="${MILVUS_RS_STANDALONE_MINIO_HOST:-127.0.0.1}"
export MILVUS_RS_STANDALONE_HEALTH_URL="${MILVUS_RS_STANDALONE_HEALTH_URL:-http://127.0.0.1:9091/healthz}"
export MILVUS_RS_STANDALONE_SUBSET_ROOT="${MILVUS_RS_STANDALONE_SUBSET_ROOT_DEFAULT}"
export MILVUS_RS_SUBSET_TEST_TIMEOUT="${MILVUS_RS_SUBSET_TEST_TIMEOUT:-20m}"
