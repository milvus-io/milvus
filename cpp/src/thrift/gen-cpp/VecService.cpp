...
VecService_add_binary_vector_args::~VecService_add_binary_vector_args() throw() {
}


uint32_t VecService_add_binary_vector_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t VecService_add_binary_vector_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("VecService_add_binary_vector_args");
...
VecService_add_binary_vector_pargs::~VecService_add_binary_vector_pargs() throw() {
}


uint32_t VecService_add_binary_vector_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("VecService_add_binary_vector_pargs");
...
VecService_add_binary_vector_result::~VecService_add_binary_vector_result() throw() {
}


uint32_t VecService_add_binary_vector_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t VecService_add_binary_vector_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
...
VecService_add_binary_vector_presult::~VecService_add_binary_vector_presult() throw() {
}


uint32_t VecService_add_binary_vector_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
VecService_add_binary_vector_batch_args::~VecService_add_binary_vector_batch_args() throw() {
}


uint32_t VecService_add_binary_vector_batch_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t VecService_add_binary_vector_batch_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("VecService_add_binary_vector_batch_args");
...
VecService_add_binary_vector_batch_pargs::~VecService_add_binary_vector_batch_pargs() throw() {
}


uint32_t VecService_add_binary_vector_batch_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("VecService_add_binary_vector_batch_pargs");
...
VecService_add_binary_vector_batch_result::~VecService_add_binary_vector_batch_result() throw() {
}


uint32_t VecService_add_binary_vector_batch_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t VecService_add_binary_vector_batch_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
...
VecService_add_binary_vector_batch_presult::~VecService_add_binary_vector_batch_presult() throw() {
}


uint32_t VecService_add_binary_vector_batch_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("add_binary_vector", ::apache::thrift::protocol::T_CALL, cseqid);

  VecService_add_binary_vector_pargs args;
  args.group_id = &group_id;
  args.tensor = &tensor;
  args.write(oprot_);
...
void VecServiceClient::recv_add_binary_vector()
{
  ...
  if (fname.compare("add_binary_vector") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
...
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("add_binary_vector_batch", ::apache::thrift::protocol::T_CALL, cseqid);

  VecService_add_binary_vector_batch_pargs args;
  args.group_id = &group_id;
  args.tensor_list = &tensor_list;
  args.write(oprot_);
...
void VecServiceClient::recv_add_binary_vector_batch()
{
  ...
  if (fname.compare("add_binary_vector_batch") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
...
void VecServiceProcessor::process_add_binary_vector(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("VecService.add_binary_vector", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "VecService.add_binary_vector");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "VecService.add_binary_vector");
  }

  VecService_add_binary_vector_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "VecService.add_binary_vector", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "VecService.add_binary_vector");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("add_binary_vector", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "VecService.add_binary_vector");
  }

  oprot->writeMessageBegin("add_binary_vector", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "VecService.add_binary_vector", bytes);
  }
}

void VecServiceProcessor::process_add_binary_vector_batch(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("VecService.add_binary_vector_batch", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "VecService.add_binary_vector_batch");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "VecService.add_binary_vector_batch");
  }

  VecService_add_binary_vector_batch_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "VecService.add_binary_vector_batch", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "VecService.add_binary_vector_batch");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("add_binary_vector_batch", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "VecService.add_binary_vector_batch");
  }

  oprot->writeMessageBegin("add_binary_vector_batch", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "VecService.add_binary_vector_batch", bytes);
  }
}
