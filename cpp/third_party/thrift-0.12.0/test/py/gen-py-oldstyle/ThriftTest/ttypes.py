...
class Xtruct:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.string_thing = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.BYTE:
    ...
    def write(self, oprot):
        ...
        if self.string_thing is not None:
            ...
            oprot.writeString(self.string_thing.encode('utf-8') if sys.version_info[0] == 2 else self.string_thing)
            oprot.writeFieldEnd()
...
class Insanity:
    ...
    def __init__(self, userMap=None, xtructs=None,):
        self.__dict__['userMap'] = userMap
        self.__dict__['xtructs'] = xtructs
...
class VersioningTestV1:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.old_string = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.I32:
    ...
    def write(self, oprot):
        ...
        if self.old_string is not None:
            ...
            oprot.writeString(self.old_string.encode('utf-8') if sys.version_info[0] == 2 else self.old_string)
            oprot.writeFieldEnd()
...
class VersioningTestV2:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.newstring = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.I32:
    ...
    def write(self, oprot):
        ...
        if self.newstring is not None:
            ...
            oprot.writeString(self.newstring.encode('utf-8') if sys.version_info[0] == 2 else self.newstring)
            oprot.writeFieldEnd()
        if self.end_in_both is not None:
            oprot.writeFieldBegin('end_in_both', TType.I32, 12)
            oprot.writeI32(self.end_in_both)
...
class ListTypeVersioningV1:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.hello = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.hello is not None:
            ...
            oprot.writeString(self.hello.encode('utf-8') if sys.version_info[0] == 2 else self.hello)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
Xtruct.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'string_thing', 'UTF8', None, ),  # 1
    None,  # 2
    None,  # 3
...
CrazyNesting.thrift_spec = (
    ...
    (3, TType.LIST, 'list_field', (TType.MAP, (TType.SET, (TType.I32, None, True), TType.MAP, (TType.I32, None, TType.SET, (TType.LIST, (TType.MAP, (TType.STRUCT, [Insanity, None], TType.STRING, 'UTF8', True), True), False), False), False), False), None, ),  # 3
...
SomeUnion.thrift_spec = (
    ...
    (2, TType.STRING, 'string_thing', 'UTF8', None, ),  # 2
    (3, TType.I32, 'i32_thing', None, None, ),  # 3
...
VersioningTestV1.thrift_spec = (
    ...
    None,  # 2
    (3, TType.STRING, 'old_string', 'UTF8', None, ),  # 3
    None,  # 4
    None,  # 5
    None,  # 6
    None,  # 7
...
VersioningTestV2.thrift_spec = (
    ...
    (11, TType.STRING, 'newstring', 'UTF8', None, ),  # 11
    (12, TType.I32, 'end_in_both', None, None, ),  # 12
)
...
ListTypeVersioningV1.thrift_spec = (
    ...
    (2, TType.STRING, 'hello', 'UTF8', None, ),  # 2
)
all_structs.append(ListTypeVersioningV2)
ListTypeVersioningV2.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'strings', (TType.STRING, 'UTF8', False), None, ),  # 1
    (2, TType.STRING, 'hello', 'UTF8', None, ),  # 2
)
...
GuessProtocolStruct.thrift_spec = (
    ...
    None,  # 5
    None,  # 6
    (7, TType.MAP, 'map_field', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 7
)
...
LargeDeltas.thrift_spec = (
    ...
    None,  # 2498
    None,  # 2499
    (2500, TType.SET, 'a_set2500', (TType.STRING, 'UTF8', False), None, ),  # 2500
    None,  # 2501
    None,  # 2502
    None,  # 2503
    None,  # 2504
...
NestedMixedx2.thrift_spec = (
    ...
    (2, TType.MAP, 'map_int_strset', (TType.I32, None, TType.SET, (TType.STRING, 'UTF8', False), False), None, ),  # 2
    (3, TType.LIST, 'map_int_strset_list', (TType.MAP, (TType.I32, None, TType.SET, (TType.STRING, 'UTF8', False), False), False), None, ),  # 3
)
