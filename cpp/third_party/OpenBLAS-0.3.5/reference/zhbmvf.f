      SUBROUTINE ZHBMVF( UPLO, N, K, ALPHA, A, LDA, X, INCX,
     $                   BETA, Y, INCY )
*     .. Scalar Arguments ..
      ...
      IF( LSAME( UPLO, 'V' ) )THEN
         ...
         IF( ( INCX.EQ.1 ).AND.( INCY.EQ.1 ) )THEN
            DO 160, J = 1, N
               ...
               TEMP2 = ZERO
               L     = KPLUS1 - J
               DO 150, I = MAX( 1, J - K ), J - 1
                  Y( I ) = Y( I ) + TEMP1*DCONJG(A( L + I, J ))
  ...
  160       CONTINUE
         ELSE
            ...
            DO 180, J = 1, N
               ...
               IY    = KY
               L     = KPLUS1 - J
               DO 170, I = MAX( 1, J - K ), J - 1
                  Y( IY ) = Y( IY ) + TEMP1*DCONJG(A( L + I, J ))
