...
func (mc *MilvusClient) GrantPrivilegeV2(ctx context.Context, option client.GrantV2Option, callOptions ...grpc.CallOption) error {
	err := mc.mClient.GrantPrivilegeV2(ctx, option, callOptions...)
	return err
}

func (mc *MilvusClient) RevokePrivilegeV2(ctx context.Context, option client.RevokeV2Option, callOptions ...grpc.CallOption) error {
