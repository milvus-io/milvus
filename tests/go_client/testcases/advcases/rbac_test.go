	...
	for _, roleName := range roleNames {
		...
		if role.Privileges != nil {
			for _, grantItem := range role.Privileges {
				// if !lo.Contains([]string{common.AdminRole, common.PublicRole}, grantItem.Privilege) {
				err := mc.RevokePrivilegeV2(ctx, client.NewRevokeV2Option(roleName, grantItem.Privilege, grantItem.ObjectName).WithDbName(grantItem.DbName))
				common.CheckErr(t, err, true)
				//}
			}
		}
...
func TestRbacDefaultV2(t *testing.T) {
	...
	// grant privilege to role
	errGrant = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "CollectionAdmin", AllObjectName))
	common.CheckErr(t, errGrant, true)
	...
	errDrop := mc.DropUser(ctx, client.NewDropUserOption(userName))
	common.CheckErr(t, errDrop, true)
	errRevoke := mc.RevokePrivilegeV2(ctx, client.NewRevokeV2Option(roleName, "CollectionAdmin", "*"))
	common.CheckErr(t, errRevoke, true)
	errDrop = mc.DropRole(ctx, client.NewDropRoleOption(roleName))
	common.CheckErr(t, errDrop, true)
}
...
func TestDropUser(t *testing.T) {
	...
	common.CheckErr(t, err, true)
	err = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "CollectionAdmin", AllObjectName))
	common.CheckErr(t, err, true)
...
func TestDropRoleBindPrivilege(t *testing.T) {
	...
	err = mc.RevokePrivilegeV2(ctx, client.NewRevokeV2Option(roleName, "CollectionAdmin", AllObjectName))
	common.CheckErr(t, err, true)
...
func TestDescribeRole(t *testing.T) {
	...
	err = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "DatabaseAdmin", AllObjectName))
	common.CheckErr(t, err, true)

	err = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "ClusterAdmin", AllObjectName).WithDbName(AllObjectName))
	common.CheckErr(t, err, true)
...
func TestGrantV2PrivilegeConnectedDb(t *testing.T) {
	...
	err = mcDb.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "CollectionAdmin", AllObjectName))
	common.CheckErr(t, err, true)
...
func TestGrantV2PrivilegeSpecifyDb(t *testing.T) {
	...
	err = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "CollectionAdmin", AllObjectName).WithDbName(dbName))
	common.CheckErr(t, err, true)
...
func TestGrantPrivilegeInvalid(t *testing.T) {
	...
	err = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(common.GenRandomString("role", 6), "CollectionAdmin", "*"))
	common.CheckErr(t, err, false, "not found the role")
	...
	common.CheckErr(t, err, true)
	err = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "CollectionAdmin", common.GenRandomString("collection", 6)))
	common.CheckErr(t, err, true)
	...
	err = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "aaa", "*"))
	common.CheckErr(t, err, false, "not found the privilege name")
	...
	common.CheckErr(t, err, true)
	err = mc.GrantPrivilegeV2(ctx, client.NewGrantV2Option(roleName, "CollectionAdmin", "*").WithDbName(common.GenRandomString("db", 6)))
	common.CheckErr(t, err, true)
}
...
func TestRevokePrivilegeInvalid(t *testing.T) {
	...
	common.CheckErr(t, err, false, "not found the role")
	err = mc.RevokePrivilegeV2(ctx, client.NewRevokeV2Option(common.GenRandomString("role", 6), "CollectionAdmin", "*"))
	common.CheckErr(t, err, false, "not found the role")
	...
	common.CheckErr(t, err, true)
	err = mc.RevokePrivilegeV2(ctx, client.NewRevokeV2Option(roleName, "CollectionAdmin", common.GenRandomString("collection", 6)))
	common.CheckErr(t, err, true)
	...
	common.CheckErr(t, err, false, "not found the privilege name")
	err = mc.RevokePrivilegeV2(ctx, client.NewRevokeV2Option(roleName, "aaa", "*"))
	common.CheckErr(t, err, false, "not found the privilege name")
	...
	common.CheckErr(t, err, true)
	err = mc.RevokePrivilegeV2(ctx, client.NewRevokeV2Option(roleName, "CollectionAdmin", "*").WithDbName(common.GenRandomString("db", 6)))
	common.CheckErr(t, err, true)
}
