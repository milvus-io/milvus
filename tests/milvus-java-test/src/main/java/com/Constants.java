...
public final class Constants {
    ...
    public static final String getDefaultMetricType = "L2";
    ...
    public static final String searchParam = Utils.setSearchParam(getDefaultMetricType, vectors.subList(0, nq), topk, n_probe);
