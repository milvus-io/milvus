...
func (s *SparseTestSuite) createCollection(c *integration.MiniClusterV2, ctx context.Context, dbName string) string {
...
func (s *SparseTestSuite) TestSparse_invalid_insert() {
	...
	collectionName := s.createCollection(c, ctx, dbName)
...
func (s *SparseTestSuite) TestSparse_invalid_index_build() {
	...
	index_params := []*commonpb.KeyValuePair{
		{
...
func (s *SparseTestSuite) TestSparse_invalid_search_request() {
	...
	replace_query := func(vecs *schemapb.SparseFloatArray) {
