...
func (s *Suite) TestCompactionTypesAreCounted() {
	...
	s.requireCounterEventually(ctx, typeutil.MixCoordRole, "compaction=sort",
	...
	s.requireCounterEventually(ctx, typeutil.MixCoordRole, "compaction=l0",
	...
	s.requireCounterEventually(ctx, typeutil.MixCoordRole, "compaction=bump_schema_version",
...
func (s *Suite) TestClusteringCompactionAndSegmentPrune() {
	...
	s.requireCounterEventually(ctx, typeutil.MixCoordRole, "compaction=clustering",
