...
from chaos.checker import (CollectionCreateChecker,
                           ...
                           HybridSearchChecker,
                           QueryChecker,
                           GrowingSegmentCountChecker,
                           SealedSegmentCountChecker,
                           TextMatchChecker,
                           IndexCreateChecker,
                           DeleteChecker,
...
class TestOperations(TestBase):
    ...
    def init_health_checkers(self, collection_name=None):
        ...
        checkers = {
            ...
            Op.growing_count: GrowingSegmentCountChecker(collection_name=c_name),
            Op.sealed_count: SealedSegmentCountChecker(collection_name=c_name),
