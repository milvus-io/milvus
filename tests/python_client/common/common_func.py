...
def gen_default_schema_for_upsert(client, description=ct.default_desc, primary_field=ct.default_int64_field_name,
                                  auto_id=False, dim=ct.default_dim, enable_dynamic_field=True, is_binary=False,
                                  with_json=True, **kwargs):
    """
    Generate collection schema for upsert operations using MilvusClient API.
    This schema matches the fields generated by gen_default_rows_data_for_upsert.
    """
    ...
    if primary_field == ct.default_int64_field_name:
        ...
        schema.add_field(field_name=primary_field, datatype=DataType.VARCHAR, max_length=ct.default_length,
                         is_primary=True, auto_id=auto_id)
