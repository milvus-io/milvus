...
class TestMilvusClientAliasInvalid(TestMilvusClientV2Base):
    ...
    ******************************************************************
    ...
    def test_milvus_client_create_alias_with_invalid_name(self, alias_name):
        ...
        self.create_alias(client, collection_name, alias_name, check_task=CheckTasks.err_res, check_items=error)
    ...
    ******************************************************************
    ...
    def test_milvus_client_alias_search_query(self):
        ...
        self.drop_collection(
            ...
            check_items={ct.err_code: 1100, ct.err_msg: "cannot drop the collection via alias = collection_alias"},
        )
        self.drop_alias(client, alias)
...
class TestMilvusClientAliasOperation(TestMilvusClientV2Base):
    ...
    def test_milvus_client_alter_alias_operation_default(self):
        ...
        self.create_collection(
            client, collection_name1, schema=schema1, index_params=index_params, consistency_level="Bounded"
        )
        ...
        res1 = self.query(client, alias_name, filter=f"{ct.default_int64_field_name} >= 0", output_fields=["count(*)"])
        ...
        self.create_collection(
            client, collection_name2, schema=schema1, index_params=index_params, consistency_level="Bounded"
        )
        ...
        res2 = self.query(client, alias_name, filter=f"{ct.default_int64_field_name} >= 0", output_fields=["count(*)"])
        ...
        res1_after = self.query(
            client, collection_name1, filter=f"{ct.default_int64_field_name} >= 0", output_fields=["count(*)"]
        )
    ...
    def test_milvus_client_create_drop_alias_operation_default(self):
        ...
        error = {ct.err_code: 100, ct.err_msg: f"can't find collection[database=default][collection={alias_name}]"}
        self.describe_collection(client, alias_name, check_task=CheckTasks.err_res, check_items=error)
    ...
    def test_milvus_client_collection_operations_by_alias(self):
        ...
        error = {ct.err_code: 1100, ct.err_msg: f"cannot drop the collection via alias = {alias_name}"}
        self.drop_collection(client, alias_name, check_task=CheckTasks.err_res, check_items=error)
...
class TestMilvusClientAliasOperationInvalid(TestMilvusClientV2Base):
    ...
    def test_milvus_client_create_alias_for_non_exist_collection(self):
        ...
        self.create_alias(client, non_exist_collection, alias_name, check_task=CheckTasks.err_res, check_items=error)
    ...
    def test_milvus_client_alter_alias_to_non_exist_collection(self):
        ...
        non_exist_collection = cf.gen_unique_str("non_exist_collection")
        error = {ct.err_code: 100, ct.err_msg: f"collection not found[collection={non_exist_collection}]"}
        self.alter_alias(client, non_exist_collection, alias_name, check_task=CheckTasks.err_res, check_items=error)
    ...
    def test_milvus_client_create_duplicate_alias(self):
        ...
        error = {ct.err_code: 1602, ct.err_msg: f"{alias_name} is alias to another collection: {collection_name1}"}
        self.create_alias(client, collection_name2, alias_name, check_task=CheckTasks.err_res, check_items=error)
    ...
    def test_milvus_client_alter_not_exist_alias(self):
        ...
        error = {ct.err_code: 1600, ct.err_msg: f"alias not found[database=default][alias={non_exist_alias}]"}
        self.alter_alias(client, collection_name, non_exist_alias, check_task=CheckTasks.err_res, check_items=error)
    ...
    def test_milvus_client_rename_collection_to_alias_name(self):
        ...
        self.rename_collection(client, collection_name2, alias_name, check_task=CheckTasks.err_res, check_items=error)
