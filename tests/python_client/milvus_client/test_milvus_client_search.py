...
class TestMilvusClientSearchInvalid(TestMilvusClientV2Base):
    ...
    ******************************************************************
    ...
    def test_milvus_client_search_reranker_not_exist_field(self):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: "function input field not found: not_exist_field"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_multiple_fields(self):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: "unsupported rerank function: [1]"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_not_supported_reranker_value(self, not_supported_reranker):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: f"unsupported rerank function: [{not_supported_reranker}]"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_not_supported_function_value(self, not_supported_function):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: "invalid decay function: decay, only support [gauss,linear,exp]"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_invalid_origin(self, invalid_origin):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: f"param origin:{invalid_origin} is not a number"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_without_origin(self):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: "decay function lost param: origin"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_invalid_scale(self, invalid_scale):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: f"param scale:{invalid_scale} is not a number"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_without_scale(self):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: "decay function lost param: scale"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_scale_out_of_range(self, invalid_scale):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: f"decay function param: scale must > 0, but got {invalid_scale}"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_invalid_offset(self, invalid_offset):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: f"param offset:{invalid_offset} is not a number"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_offset_out_of_range(self, invalid_offset):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: f"decay function param: offset must >= 0, but got {invalid_offset}"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_reranker_invalid_decay(self, invalid_decay):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: f"param decay:{invalid_decay} is not a number"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
    ...
    def test_milvus_client_search_with_reranker_on_dynamic_fields(self):
        ...
        vectors_to_search = rng.random((1, dim))
        error = {ct.err_code: 65535, ct.err_msg: "function input field not found: dynamic_fields"}
        self.search(
            client,
            collection_name,
            vectors_to_search,
