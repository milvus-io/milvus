...
class TestMilvusClientTimestamptz(TestMilvusClientV2Base):
    ...
    def test_milvus_client_timestamptz_Feb_29(self):
        ...
        self.query(
            client,
            collection_name,
            filter=f"{default_primary_key_field_name} == 4",
            check_task=CheckTasks.check_query_results,
            check_items={exp_res: row, "pk_name": default_primary_key_field_name},
        )
    ...
    def test_milvus_client_timestamptz_partial_update(self):
        ...
        rows = [
            {default_primary_key_field_name: 0, default_timestamp_field_name: "1970-01-01 00:00:00"},
    ...
    def test_milvus_client_timestamptz_query(self):
        ...
        self.query(
            ...
            timezone="Asia/Shanghai",
            check_task=CheckTasks.check_query_results,
            check_items={exp_res: shanghai_time_row, "pk_name": default_primary_key_field_name},
        )
        # >=
        ...
        self.query(
            ...
            timezone="Asia/Shanghai",
            check_task=CheckTasks.check_query_results,
            check_items={exp_res: shanghai_time_row[3:], "pk_name": default_primary_key_field_name},
        )
        # ==
        ...
        self.query(
            ...
            timezone="Asia/Shanghai",
            check_task=CheckTasks.check_query_results,
            check_items={exp_res: [shanghai_time_row[-1]], "pk_name": default_primary_key_field_name},
        )
        ...
        self.query(
            ...
            timezone="Asia/Shanghai",
            check_task=CheckTasks.check_query_results,
            check_items={exp_res: shanghai_time_row[:2], "pk_name": default_primary_key_field_name},
        )
        # !=
        expr = f"{default_timestamp_field_name} != ISO '9999-12-31T23:46:05Z'"
        self.query(
    ...
    def test_milvus_client_timestamptz_different_time_expressions(self):
        ...
        rows = [
            ...
            {
                default_primary_key_field_name: 7,
        ...
        self.query(
            client,
            collection_name,
            filter=f"{default_primary_key_field_name} <= 7",
            check_task=CheckTasks.check_query_results,
    ...
    def test_milvus_client_timestamptz_different_timezone_query(self):
        ...
        expected_rows = [
            {
                default_primary_key_field_name: 0,
                default_vector_field_name: [1, 2, 3],
                default_timestamp_field_name: "2025-01-01T06:00:00+08:00",
            },
            {
                default_primary_key_field_name: 5,
                default_vector_field_name: [16, 17, 18],
        ...
        self.query(
            client,
            collection_name,
            filter=f"{default_timestamp_field_name} == ISO '2024-12-31T22:00:00Z'",
            check_task=CheckTasks.check_query_results,
            check_items={exp_res: expected_rows, "pk_name": default_primary_key_field_name},
        )
        ...
        self.query(
            client,
            collection_name,
            filter=f"{default_timestamp_field_name} == ISO '2024-12-31 17:00:00'",
            timezone="Asia/Shanghai",
            check_task=CheckTasks.check_query_results,
            check_items={exp_res: expected_rows, "pk_name": default_primary_key_field_name},
        )
        ...
        expected_rows = [
            {
                default_primary_key_field_name: 0,
                default_vector_field_name: [1, 2, 3],
                default_timestamp_field_name: "2024-12-31T17:00:00-05:00",
            },
            {
                default_primary_key_field_name: 5,
                default_vector_field_name: [16, 17, 18],
        ...
        self.query(
            client,
            collection_name,
            filter=f"{default_timestamp_field_name} == ISO '2025-01-01 06:00:00'",
            timezone="Asia/Shanghai",
            check_task=CheckTasks.check_query_results,
            check_items={exp_res: expected_rows, "pk_name": default_primary_key_field_name},
        )
