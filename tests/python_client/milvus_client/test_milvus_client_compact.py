...
class TestMilvusClientCompactInvalid(TestMilvusClientV2Base):
    ...
    ******************************************************************
    ...
    def test_milvus_client_compact_invalid_collection_name_string(self, name):
        ...
        self.compact(client, name, check_task=CheckTasks.err_res, check_items=error)
    ...
    def test_milvus_client_compact_invalid_is_clustering(self, invalid_clustering):
        ...
        error = {ct.err_code: 1, ct.err_msg: f"is_clustering value {invalid_clustering} is illegal"}
        self.compact(
            client, collection_name, is_clustering=invalid_clustering, check_task=CheckTasks.err_res, check_items=error
        )
    ...
    def test_milvus_client_get_compact_state_invalid_job_id(self, invalid_job_id):
        ...
        # 1. create collection
        self.create_collection(client, collection_name, default_dim)
        error = {ct.err_code: 1, ct.err_msg: f"compaction_id value {invalid_job_id} is illegal"}
        self.get_compaction_state(client, invalid_job_id, check_task=CheckTasks.err_res, check_items=error)
...
class TestMilvusClientCompactValid(TestMilvusClientV2Base):
    ...
    ******************************************************************
    ...
    @pytest.mark.tags(CaseLabel.L1)
    def test_milvus_client_compact_json_path_index(
        self, is_clustering, supported_varchar_scalar_index, supported_json_cast_type
    ):
        """
        target: test hybrid search with default normal case (2 vector fields)
        method: create connection, collection, insert and hybrid search
