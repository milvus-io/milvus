...
class TestMilvusClientWarmup(TestMilvusClientV2Base):
    ...
    def test_warmup_negative_cases(self):
        ...
        self.alter_collection_properties(
            ...
            check_task=CheckTasks.err_res,
            check_items={ct.err_code: 104, ct.err_msg: "can not alter warmup properties if collection loaded"},
        )
        ...
        self.alter_collection_field(
            ...
            field_params={"warmup": "sync"},
            check_task=CheckTasks.err_res,
            check_items={ct.err_code: 104, ct.err_msg: "can not alter warmup if collection loaded"},
        )
