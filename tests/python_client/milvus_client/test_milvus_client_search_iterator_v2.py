...
class TestSearchIteratorShared(TestMilvusClientV2Base):
    ...
    def test_search_iterator_not_support_search_by_pk(self):
        ...
        self.search_iterator(
            ...
            ids=ids_to_search,
            check_task=CheckTasks.err_res,
            check_items={"err_code": ct.ANY_CODE, "err_msg": "object of type 'NoneType' has no len()"},
        )
        ...
        self.search_iterator(
            ...
            ids=ids_to_search,
            check_task=CheckTasks.err_res,
            check_items={"err_code": ct.ANY_CODE, "err_msg": "Either ids or data must be provided, not both"},
        )
