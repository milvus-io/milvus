    ...
    def _do_search(self, client, collection_name, partition_names, limit, expected):
        ...
        if expected == NOT_LOADED:
            self.search(
                ...
                check_items={ct.err_code: ct.ANY_CODE, ct.err_msg: "not loaded", "enable_milvus_client_api": True},
            )
            ...
            self.search(
                ...
                partition_names=partition_names,
                check_task=CheckTasks.err_res,
                check_items={ct.err_code: ct.ANY_CODE, ct.err_msg: "not found", "enable_milvus_client_api": True},
            )
