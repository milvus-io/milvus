...
class TestScalarArrayMatch(TestcaseBase):
    ...
    def _build_collection(self, with_scalar_index=False):
        ...
        # VERIFY: gen_*_field / gen_array_field signatures and gen_collection_schema usage.
        fields = [
        ...
        if with_scalar_index:
            # VERIFY: {"index_type": "INVERTED"} is the scalar/array index params dict.
    ...
    def test_scalar_array_quantified_match_int64(self, with_scalar_index):
        ...
        # VERIFY: expression grammar 'MATCH_ANY(scores, $ > 90)' with '$' as the element.
        collection_w.query(
        ...
        # VERIFY: empty-array MATCH_ALL semantics include pk 3.
        collection_w.query(
        ...
        # VERIFY: keyword-arg syntax 'threshold=2'.
        collection_w.query(
        ...
        # VERIFY: MATCH_EXACT keyword 'threshold=3' semantics (exactly N).
        collection_w.query(
        ...
        #   pk 3 []      -> 0 true
        #   pk 4 [60,60] -> 0 true
        # VERIFY: MATCH_MOST keyword 'threshold=1' semantics (at most N), incl. empty array.
        collection_w.query(
    ...
    def test_scalar_array_quantified_match_varchar(self):
        ...
        # VERIFY: string element comparison in MATCH_ANY ($ == "x").
        collection_w.query(
