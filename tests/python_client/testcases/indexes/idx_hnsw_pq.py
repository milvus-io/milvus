...
class HNSW_PQ:
    ...
    build_params = [
        ...
        {"description": "Half of Dimension Value Test", "params": {"m": 64}, "expected": success},
        {"description": "Maximum Boundary Test (Dimension)", "params": {"m": 128}, "expected": success},
        {
        ...
        {"description": "Maximum Boundary Test (doc:24) ", "params": {"nbits": 10}, "expected": success},
        ...
        pytest.param(
            ...
            marks=pytest.mark.skip(
                reason="Flaky in CI: index build with max params (M=2048, efConstruction=10000) "
