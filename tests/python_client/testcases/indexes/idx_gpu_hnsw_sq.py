...
class GPU_HNSW_SQ:
    ...
    build_params = [
        ...
        # sq_type params test
        {"description": "SQ8 quantization type", "params": {"sq_type": "SQ8"}, "expected": success},
        {"description": "SQ6 quantization type", "params": {"sq_type": "SQ6"}, "expected": success},
        {"description": "FP16 quantization type", "params": {"sq_type": "FP16"}, "expected": success},
        {"description": "BF16 quantization type", "params": {"sq_type": "BF16"}, "expected": success},
        {
    ...
    search_params = [
        ...
        # combination test
        {"description": "Optimal combination", "params": {"ef": 64, "refine_k": 2}, "expected": success},
        {"description": "empty dict params", "params": {}, "expected": success},
    ]
