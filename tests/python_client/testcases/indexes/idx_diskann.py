...
class DISKANN:
    ...
    build_params = [
        ...
        {"description": "Default value Test", "params": {"search_cache_budget_gb_ratio": 0.1}, "expected": success},
        {
            ...
            "params": {"search_cache_budget_gb_ratio": -0.1},
            "expected": success,
        },
        {
            "description": "Out of Range Test - Too Large",
            "params": {"search_cache_budget_gb_ratio": 0.31},
            "expected": success,
        },
        ...
        {
            "description": "Out of Range Test - Negative",
            "params": {"pq_code_budget_gb_ratio": -0.1},
            "expected": success,
        },
        {
            "description": "Out of Range Test - Too Large",
            "params": {"pq_code_budget_gb_ratio": 0.26},
            "expected": success,
        },
        ...
        # 组合参数
        {
            ...
            "params": {
                ...
                "beamwidth": 10,
                "search_cache_budget_gb_ratio": 0.5,
                "pq_code_budget_gb_ratio": 0.5,
            },
            "expected": success,
        },
        {"description": "empty dict params", "params": {}, "expected": success},
        {
            ...
            "params": {"search_list_size": 100, "not_defined_param": "nothing"},
            "expected": success,
        },
    ]
    ...
    search_params = [
        ...
        # Default value: 100
        {
            ...
            "expected": {"err_code": ct.ANY_CODE, "err_msg": "search_list_size(1) should be larger than k(10)"},
        },
        ...
        {"description": "Default value Test", "params": {"search_list_size": 100}, "expected": success},
        {
            ...
            "expected": {
                ...
                "err_msg": "param 'search_list_size' (-1) should be in range [1, 2147483647]",
            },
        },
        {"description": "String Type Test", "params": {"search_list_size": "100"}, "expected": success},
        {
            "description": "Float Type Test",
            "params": {"search_list_size": 100.0},
            "expected": {
                "err_code": ct.ANY_CODE,
                "err_msg": "Type conflict in json: param 'search_list_size' (100.0) should be integer",
            },
        },
        {
            "description": "Boolean Type Test",
            "params": {"search_list_size": True},
            "expected": {
                "err_code": ct.ANY_CODE,
                "err_msg": "Type conflict in json: param 'search_list_size' (true) should be integer",
            },
        },
        {
            "description": "None Type Test",
            "params": {"search_list_size": None},
            "expected": {
                "err_code": ct.ANY_CODE,
                "err_msg": "Type conflict in json: param 'search_list_size' (null) should be integer",
            },
        },
        # mix params
        {
            "description": "mix params",
            "params": {"search_list_size": 100, "beam_width_ratio": 0.5},
            "expected": success,
        },
