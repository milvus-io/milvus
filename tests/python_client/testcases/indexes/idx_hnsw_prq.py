...
class HNSW_PRQ:
    ...
    build_params = [
        ...
        # m params test
        {"description": "Minimum Boundary Test", "params": {"m": 1}, "expected": success},
        # timeout
        # {
        ...
        {"description": "String Type Test", "params": {"m": "16"}, "expected": success},
        {
            "description": "Float Type Test",
            "params": {"m": 16.0},
            "expected": {
        ...
        {"description": "None Type Test", "params": {"m": None}, "expected": success},
        # nbits params test
        {"description": "Minimum Boundary Test", "params": {"nbits": 1}, "expected": success},
        {"description": "Default Value Test", "params": {"nbits": 8}, "expected": success},
        {"description": "Maximum Boundary Test", "params": {"nbits": 10}, "expected": success},
        {
            "description": "Negative Value Test",
            "params": {"nbits": -1},
            "expected": {
        ...
        {"description": "String Type Test", "params": {"nbits": "8"}, "expected": success},
        {
            "description": "Float Type Test",
            "params": {"nbits": 8.0},
            "expected": {"err_code": 1100, "err_msg": "wrong data type in json, key: 'nbits', value: '8.0'"},
        },
        {
            "description": "Boolean Type Test",
            "params": {"nbits": True},
        ...
        {"description": "None Type Test", "params": {"nbits": None}, "expected": success},
        # nrq params test
        {"description": "Minimum Boundary Test", "params": {"nrq": 1}, "expected": success},
        {"description": "Default Value Test", "params": {"nrq": 2}, "expected": success},
        {"description": "Maximum Boundary Test", "params": {"nrq": 16}, "expected": success},
        {
            "description": "Negative Value Test",
            "params": {"nrq": -1},
            "expected": {
        ...
        {"description": "String Type Test", "params": {"nrq": "4"}, "expected": success},
        {
            "description": "Float Type Test",
            "params": {"nrq": 4.0},
            "expected": {
        ...
        {"description": "None Type Test", "params": {"nrq": None}, "expected": success},
        {
            "description": "List Type Test",
            "params": {"nrq": [2]},
            "expected": {
        ...
        {"description": "Valid refine_type - FP32", "params": {"refine_type": "FP32"}, "expected": success},
        {
            ...
            "expected": {
                "err_code": 1100,
                "err_msg": "invalid refine type : INT8, optional types are [sq6, sq8, fp16, bf16, fp32, flat]: invalid parameter",
            },
        },
        {
            "description": "Integer Type Test",
            ...
            "expected": {
                "err_code": 1100,
                "err_msg": "invalid refine type : 1, optional types are [sq6, sq8, fp16, bf16, fp32, flat]: invalid parameter",
            },
        },
        {
            "description": "Float Type Test",
            ...
            "expected": {
                "err_code": 1100,
                "err_msg": "invalid refine type : 1.0, optional types are [sq6, sq8, fp16, bf16, fp32, flat]: invalid parameter",
            },
        },
        {
            "description": "List Type Test",
            ...
            "expected": {
                "err_code": 1100,
                "err_msg": "['FP16'], optional types are [sq6, sq8, fp16, bf16, fp32, flat]: invalid parameter",
            },
        },
        ...
        {"description": "Partial parameters set (M + m only)", "params": {"M": 32, "m": 32}, "expected": success},
        {
    ...
    search_params = [
        ...
        {"description": "Minimum Boundary Test", "params": {"ef": 1}, "expected": success},
