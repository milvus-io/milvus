...
class IVF_RABITQ:
    ...
    build_params = [
        # nlist params test
        {"description": "Minimum Boundary Test", "params": {"nlist": 1}, "expected": success},
        {"description": "Maximum Boundary Test", "params": {"nlist": 65536}, "expected": success},
        {
        ...
        {"description": "String Type Test will ignore the wrong type", "params": {"nlist": "128"}, "expected": success},
        {
        ...
        {"description": "None Type Test, use default value", "params": {"nlist": None}, "expected": success},
        {
        ...
        # refine params test
        {"description": "Enable Refine Test", "params": {"refine": "true"}, "expected": success},
        {"description": "Disable Refine Test", "params": {"refine": "false"}, "expected": success},
        # refine_type test
        {
        ...
        {"description": "SQ6 Test", "params": {"refine": "true", "refine_type": "SQ6"}, "expected": success},
        {"description": "SQ8 Test", "params": {"refine": "TRUE", "refine_type": "SQ8"}, "expected": success},
        {"description": "FP16 Test", "params": {"refine": True, "refine_type": "FP16"}, "expected": success},
        {"description": "BF16 Test", "params": {"refine": "True", "refine_type": "BF16"}, "expected": success},
        {"description": "FP32 Test", "params": {"refine": True, "refine_type": "FP32"}, "expected": success},
        {
        ...
        {"description": "Lowercase String Test", "params": {"refine": True, "refine_type": "sq6"}, "expected": success},
        {
        ...
        {"description": "None Type Test", "params": {"refine": True, "refine_type": None}, "expected": success},
    ...
    search_params = [
        # nprobe params test
        {"description": "Minimum Boundary Test", "params": {"nprobe": 1}, "expected": success},
        {
        ...
        },
        {
            ...
            "params": {"nprobe": 65537},
            "expected": {"err_code": 999, "err_msg": "should be in range [1, 65536]"},
        },
        {
        ...
        },
        {
            "description": "Float Type Test",
            "params": {"nprobe": 32.0},
            "expected": {"err_code": 999, "err_msg": "Type conflict in json: param 'nprobe' (32.0) should be integer"},
        },
        {
            "description": "Boolean Type Test",
            "params": {"nprobe": True},
            "expected": {"err_code": 999, "err_msg": "Type conflict in json: param 'nprobe' (true) should be integer"},
        },
        {
            "description": "None Type Test",
            "params": {"nprobe": None},
            "expected": {"err_code": 999, "err_msg": "Type conflict in json: param 'nprobe' (null) should be integer"},
        },
        # rbq_bits_query test
        {"description": "Default Value Test", "params": {"rbq_bits_query": 0}, "expected": success},
        {"description": "Maximum Value Test", "params": {"rbq_bits_query": 8}, "expected": success},
        {"description": "Recommended Value Test - 6bit", "params": {"rbq_bits_query": 6}, "expected": success},
        {
        ...
        # refine_k test
        {"description": "Default Value Test", "params": {"refine_k": 1.0}, "expected": success},
        {"description": "Recommended Value Test - 2", "params": {"refine_k": 2.0}, "expected": success},
        {"description": "Recommended Value Test - 5", "params": {"refine_k": 5.0}, "expected": success},
        {
        ...
        {"description": "Integer Type Test", "params": {"refine_k": 2}, "expected": success},
        {
            "description": "Boolean Type Test",
