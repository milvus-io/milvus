    ...
    ******************************************************************
    ...
    def test_rename_collection_old_invalid_type(self, get_invalid_type_collection_name):
        ...
        self.utility_wrap.rename_collection(
            ...
            new_collection_name,
            check_task=CheckTasks.err_res,
            check_items={"err_code": 999, "err_msg": f"`collection_name` value {old_collection_name} is illegal"},
        )
    ...
    def test_rename_collection_using_alias(self):
        ...
        self.utility_wrap.rename_collection(
            ...
            new_collection_name,
            check_task=CheckTasks.err_res,
            check_items={"err_code": 1, "err_msg": f"unsupported use an alias to rename collection, alias:{alias}"},
        )
