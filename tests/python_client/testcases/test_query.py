...
class TestQueryParams(TestcaseBase):
    ...
    def test_query_invalid(self):
        ...
        error = {
            ...
            ct.err_msg: "the value of expression template variable name {value_0} is not found",
        }
        ...
        error = {
            ct.err_code: ct.ANY_CODE,
            ct.err_msg: "the value of term expression template variable {value_0} is not array",
        }
        collection_w.query(expr=expr, expr_params=expr_params, check_task=CheckTasks.err_res, check_items=error)
