...
class TestAliasParamsInvalid(TestcaseBase):
    ...
    def test_alias_create_alias_with_invalid_name(self, alias_name):
        ...
        collection_w.create_alias(
            alias_name, check_task=CheckTasks.err_res, check_items=error
        )
...
class TestAliasOperation(TestcaseBase):
    ...
    def test_alias_create_operation_default(self):
        ...
        collection_alias, _ = self.collection_wrap.init_collection(
            name=alias_name,
            check_task=CheckTasks.check_collection_property,
    ...
    def test_alias_alter_operation_default(self):
        ...
        collection_1 = self.init_collection_wrap(
            name=c_1_name,
            schema=default_schema,
            check_task=CheckTasks.check_collection_property,
        ...
        collection_alias_a, _ = self.collection_wrap.init_collection(
            name=alias_a_name,
            check_task=CheckTasks.check_collection_property,
        ...
        collection_2 = self.init_collection_wrap(
            name=c_2_name,
            schema=default_schema,
            check_task=CheckTasks.check_collection_property,
        ...
        collection_alias_b, _ = self.collection_wrap.init_collection(
            name=alias_b_name,
            check_task=CheckTasks.check_collection_property,
    ...
    def test_alias_drop_operation_default(self):
        ...
        collection_alias, _ = self.collection_wrap.init_collection(
            name=alias_name, check_task=CheckTasks.err_res, check_items=error
        )
...
class TestAliasOperationInvalid(TestcaseBase):
    ...
    def test_alias_create_duplication_alias(self):
        ...
        collection_2.create_alias(
            alias_a_name, check_task=CheckTasks.err_res, check_items=error
        )
    ...
    def test_alias_alter_not_exist_alias(self):
        ...
        collection_w.alter_alias(
            alias_not_exist_name, check_task=CheckTasks.err_res, check_items=error
        )
