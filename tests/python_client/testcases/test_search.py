...
class TestCollectionSearch(TestcaseBase):
    ...
    ******************************************************************
    ...
    def test_search_during_upsert(self, nq):
        """
        ...
        res1 = collection_w.search(vectors[:nq], default_search_field, default_search_field, default_limit,
                                   check_task=CheckTasks.check_search_results,
                                   check_items={"nq": nq,
                                                "limit": default_limit})[0]
        ...
        t.start()
        res2 = collection_w.search(vectors[:nq], default_search_field, default_search_field, default_limit,
                                   check_task=CheckTasks.check_search_results,
                                   check_items={"nq": nq,
                                                "limit": default_limit})[0]
        t.join()
