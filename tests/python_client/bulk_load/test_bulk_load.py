...
class TestBulkLoad(TestcaseBase):
    ...
    @pytest.mark.xfail(reason="issue https://github.com/milvus-io/milvus/issues/19499")
    ...
    @pytest.mark.xfail(reason="issue https://github.com/milvus-io/milvus/issues/19503")
