...
class TestCDCSyncDML(TestCDCSyncBase):
    ...
    def test_insert(self, upstream_client, downstream_client, sync_timeout):
        ...
        try:
            ...
            upstream_client.create_index(collection_name=collection_name, index_params=index_params)
    ...
    def test_insert_auto_id_consistency(self, upstream_client, downstream_client, sync_timeout):
        ...
        try:
            ...
            logger.info("[VERIFICATION] Verifying ID consistency between upstream and downstream")
            ...
            assert upstream_ids == downstream_ids, "ID mismatch detected between upstream and downstream"
            ...
            for sample_id in sample_ids:
                ...
                if upstream_rec["text"] != downstream_rec["text"] or upstream_rec["number"] != downstream_rec["number"]:
            ...
            assert len(mismatches) == 0, f"Data mismatch detected for {len(mismatches)} records with IDs: {mismatches}"
