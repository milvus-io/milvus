...
![drop_collection](../assets/graphs/dml_drop_collection.png)
...
![release_collection](../assets/graphs/dml_release_collection.png)
...
![release_collection](../assets/graphs/dml_release_flow_graph_on_data_node.png)
