...
This entry explicitly collects `milvus_client/compaction_integrity_helpers.py`
...
E2E class or server connection; the helper filename intentionally stays outside
