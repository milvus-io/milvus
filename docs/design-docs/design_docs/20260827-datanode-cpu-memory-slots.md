...
| message | new fields |
|---|---|
| `datapb.QuerySlotResponse` | `int64 total_cpu`, `int64 available_cpu`, `int64 total_memory`, `int64 available_memory` (memory in bytes), tags 5-8; tag 4 is master's `copy_segment_shared_indexes` |
