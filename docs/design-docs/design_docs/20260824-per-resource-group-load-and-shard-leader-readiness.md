...
| `-1`, `ErrServiceNotReady` | The coordinator's own read stores are not wired up yet | Retry. Nothing is known, as opposed to something being known to be absent. |
