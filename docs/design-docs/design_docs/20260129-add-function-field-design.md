...
- Segcore Pipeline: [segcore source tree](https://github.com/milvus-io/milvus/tree/master/internal/core/src/segcore)
- Reduce Mechanism: [docs/developer_guides/proxy-reduce.md](../../developer_guides/proxy-reduce.md)
