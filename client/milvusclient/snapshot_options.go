...
func (opt *createSnapshotOption) Request() *milvuspb.CreateSnapshotRequest {
	return &milvuspb.CreateSnapshotRequest{
		...
		CompactionProtectionSeconds: opt.compactionProtectionSeconds,
	}
}

func (opt *createSnapshotOption) WithCompactionProtectionSeconds(seconds int64) *createSnapshotOption {
	opt.compactionProtectionSeconds = seconds
	return opt
}
