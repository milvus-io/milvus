...
func (_m *MilvusServiceServer) Update(_a0 context.Context, _a1 *milvuspb.UpdateRequest) (*milvuspb.MutationResult, error) {
	ret := _m.Called(_a0, _a1)
...
// MilvusServiceServer_Update_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Update'
type MilvusServiceServer_Update_Call struct {
	*mock.Call
}
...
func (_e *MilvusServiceServer_Expecter) Update(_a0 interface{}, _a1 interface{}) *MilvusServiceServer_Update_Call {
	return &MilvusServiceServer_Update_Call{Call: _e.mock.On("Update", _a0, _a1)}
}

func (_c *MilvusServiceServer_Update_Call) Run(run func(_a0 context.Context, _a1 *milvuspb.UpdateRequest)) *MilvusServiceServer_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MilvusServiceServer_Update_Call) Return(_a0 *milvuspb.MutationResult, _a1 error) *MilvusServiceServer_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MilvusServiceServer_Update_Call) RunAndReturn(run func(context.Context, *milvuspb.UpdateRequest) (*milvuspb.MutationResult, error)) *MilvusServiceServer_Update_Call {
	_c.Call.Return(run)
	return _c
}
