...
### 3. Security Bugs
Please do not report the safe disclosure of bugs to public issues. Contact us by [Support Email](mailto:mockey@bytedance.com)

## How to Get in Touch
- [Email](mailto:mockey@bytedance.com)

## Submit a Pull Request
Before you submit your Pull Request (PR) consider the following guidelines:
1. Search [GitHub](https://github.com/bytedance/mockey/pulls) for an open or closed PR that relates to your submission. You don't want to duplicate existing efforts.
...
8. Push your branch to GitHub:
    ...
    ```
9. In GitHub, send a pull request to `mockey:develop`
