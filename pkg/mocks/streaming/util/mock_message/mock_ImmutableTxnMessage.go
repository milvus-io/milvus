...
func (_m *MockImmutableTxnMessage) MarshalLogObject(_a0 mlog.ObjectEncoder) error {
	ret := _m.Called(_a0)
...
func (_c *MockImmutableTxnMessage_MarshalLogObject_Call) Run(run func(_a0 mlog.ObjectEncoder)) *MockImmutableTxnMessage_MarshalLogObject_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockImmutableTxnMessage_MarshalLogObject_Call) RunAndReturn(run func(mlog.ObjectEncoder) error) *MockImmutableTxnMessage_MarshalLogObject_Call {
	_c.Call.Return(run)
	return _c
}
