...
// ValidateRuntime provides a mock function with given fields: ctx, in, opts
func (_m *MockStreamingNodeManagerServiceClient) ValidateRuntime(ctx context.Context, in *streamingpb.StreamingNodeManagerValidateRuntimeRequest, opts ...grpc.CallOption) (*streamingpb.StreamingNodeManagerValidateRuntimeResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *streamingpb.StreamingNodeManagerValidateRuntimeRequest, ...grpc.CallOption) (*streamingpb.StreamingNodeManagerValidateRuntimeResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *streamingpb.StreamingNodeManagerValidateRuntimeRequest, ...grpc.CallOption) *streamingpb.StreamingNodeManagerValidateRuntimeResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *streamingpb.StreamingNodeManagerValidateRuntimeRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockStreamingNodeManagerServiceClient_ValidateRuntime_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ValidateRuntime'
type MockStreamingNodeManagerServiceClient_ValidateRuntime_Call struct {
	*mock.Call
}

// ValidateRuntime is a helper method to define mock.On call
//   - ctx context.Context
//   - in *streamingpb.StreamingNodeManagerValidateRuntimeRequest
//   - opts ...grpc.CallOption
func (_e *MockStreamingNodeManagerServiceClient_Expecter) ValidateRuntime(ctx interface{}, in interface{}, opts ...interface{}) *MockStreamingNodeManagerServiceClient_ValidateRuntime_Call {
	return &MockStreamingNodeManagerServiceClient_ValidateRuntime_Call{Call: _e.mock.On("ValidateRuntime",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockStreamingNodeManagerServiceClient_ValidateRuntime_Call) Run(run func(ctx context.Context, in *streamingpb.StreamingNodeManagerValidateRuntimeRequest, opts ...grpc.CallOption)) *MockStreamingNodeManagerServiceClient_ValidateRuntime_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*streamingpb.StreamingNodeManagerValidateRuntimeRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockStreamingNodeManagerServiceClient_ValidateRuntime_Call) Return(_a0 *streamingpb.StreamingNodeManagerValidateRuntimeResponse, _a1 error) *MockStreamingNodeManagerServiceClient_ValidateRuntime_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStreamingNodeManagerServiceClient_ValidateRuntime_Call) RunAndReturn(run func(context.Context, *streamingpb.StreamingNodeManagerValidateRuntimeRequest, ...grpc.CallOption) (*streamingpb.StreamingNodeManagerValidateRuntimeResponse, error)) *MockStreamingNodeManagerServiceClient_ValidateRuntime_Call {
	_c.Call.Return(run)
	return _c
}
