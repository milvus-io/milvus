...
// SubscribeTransform provides a mock function with given fields: ctx, opts
func (_m *MockStreamingNodeHandlerServiceClient) SubscribeTransform(ctx context.Context, opts ...grpc.CallOption) (streamingpb.StreamingNodeHandlerService_SubscribeTransformClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for SubscribeTransform")
	}

	var r0 streamingpb.StreamingNodeHandlerService_SubscribeTransformClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) (streamingpb.StreamingNodeHandlerService_SubscribeTransformClient, error)); ok {
		return rf(ctx, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) streamingpb.StreamingNodeHandlerService_SubscribeTransformClient); ok {
		r0 = rf(ctx, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(streamingpb.StreamingNodeHandlerService_SubscribeTransformClient)
		}
	}
...
// MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SubscribeTransform'
type MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call struct {
	*mock.Call
}

// SubscribeTransform is a helper method to define mock.On call
//   - ctx context.Context
//   - opts ...grpc.CallOption
func (_e *MockStreamingNodeHandlerServiceClient_Expecter) SubscribeTransform(ctx interface{}, opts ...interface{}) *MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call {
	return &MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call{Call: _e.mock.On("SubscribeTransform",
		append([]interface{}{ctx}, opts...)...)}
}

func (_c *MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call) Run(run func(ctx context.Context, opts ...grpc.CallOption)) *MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_c *MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call) Return(_a0 streamingpb.StreamingNodeHandlerService_SubscribeTransformClient, _a1 error) *MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call) RunAndReturn(run func(context.Context, ...grpc.CallOption) (streamingpb.StreamingNodeHandlerService_SubscribeTransformClient, error)) *MockStreamingNodeHandlerServiceClient_SubscribeTransform_Call {
	_c.Call.Return(run)
	return _c
}
