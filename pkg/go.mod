...
replace (
	...
	github.com/milvus-io/milvus-proto/go-api/v2 v2.6.0-rc.1.0.20250716031043-88051c3893ce => github.com/bigsheeper/milvus-proto/go-api/v2 v2.0.0-20250828030113-bcc562cf1dd5
