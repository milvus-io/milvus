...
func (l *LoadCollectionMsg) Unmarshal(input MarshalType) (TsMsg, error) {
	...
	loadCollectionMsg.BeginTimestamp = loadCollectionMsg.Base.Timestamp
	loadCollectionMsg.EndTimestamp = loadCollectionMsg.Base.Timestamp
...
func (r *ReleaseCollectionMsg) Unmarshal(input MarshalType) (TsMsg, error) {
	...
	releaseCollectionMsg.BeginTimestamp = releaseCollectionMsg.Base.Timestamp
	releaseCollectionMsg.EndTimestamp = releaseCollectionMsg.Base.Timestamp
