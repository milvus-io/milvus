...
func TestConfigKeysStringOmitsValues(t *testing.T) {
	...
	assert.Equal(t, got, ConfigtoString(config), "deprecated wrapper must preserve compatibility")
}
