...
func (it *CreateIndexMsg) Unmarshal(input MarshalType) (TsMsg, error) {
	...
	createIndexMsg.BeginTimestamp = createIndexMsg.Base.Timestamp
	createIndexMsg.EndTimestamp = createIndexMsg.Base.Timestamp
...
func (d *DropIndexMsg) Unmarshal(input MarshalType) (TsMsg, error) {
	...
	dropIndexMsg.BeginTimestamp = dropIndexMsg.Base.Timestamp
	dropIndexMsg.EndTimestamp = dropIndexMsg.Base.Timestamp
