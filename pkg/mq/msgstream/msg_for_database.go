...
func (c *CreateDatabaseMsg) Unmarshal(input MarshalType) (TsMsg, error) {
	...
	createDatabaseMsg.BeginTimestamp = createDatabaseMsg.Base.Timestamp
	createDatabaseMsg.EndTimestamp = createDatabaseMsg.Base.Timestamp
...
func (d *DropDatabaseMsg) Unmarshal(input MarshalType) (TsMsg, error) {
	...
	dropDatabaseMsg.BeginTimestamp = dropDatabaseMsg.Base.Timestamp
	dropDatabaseMsg.EndTimestamp = dropDatabaseMsg.Base.Timestamp
