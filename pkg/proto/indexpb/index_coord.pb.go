...
type SegmentIndex struct {
	...
	// data_manifest is the StorageV3 segment manifest this index build read.
	// DataCoord invalidates the SegmentIndex when the segment advances to a
	// different manifest, so an in-place external refresh cannot leave an index
	// built from superseded data attached to the same segment ID.
	DataManifest string `protobuf:"bytes,23,opt,name=data_manifest,json=dataManifest,proto3" json:"data_manifest,omitempty"`
}
...
func (x *SegmentIndex) GetDataManifest() string {
	if x != nil {
		return x.DataManifest
	}
	return ""
}
...
type StatsTask struct {
	...
	// dispatched_manifest is the segment manifest this attempt was dispatched on,
	// stamped by DataCoord when it assigns the task (same snapshot that fills
	// CreateStatsRequest.manifest_path). It is the expected value of the
	// optimistic-concurrency CAS performed when the result is adopted.
	//
	// DataCoord deliberately keeps its own copy rather than reading the base back
	// out of StatsResult: the value originates here, so a round trip through the
	// worker would make the fence depend on the worker's version (a DataNode too
	// old to echo it would have to be adopted unfenced) and would let a buggy
	// worker misreport it. Empty only for an attempt dispatched by a DataCoord
	// predating this field, which drains within one upgrade cycle.
	DispatchedManifest string `protobuf:"bytes,14,opt,name=dispatched_manifest,json=dispatchedManifest,proto3" json:"dispatched_manifest,omitempty"`
}
...
func (x *StatsTask) GetDispatchedManifest() string {
	if x != nil {
		return x.DispatchedManifest
	}
	return ""
}
...
var file_index_coord_proto_rawDesc = []byte{
	...
	0x96, 0x07, 0x0a, 0x0c, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x64, 0x65, 0x78,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6d, 0x61, 0x6e, 0x69,
	0x66, 0x65, 0x73, 0x74, 0x18, 0x17, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x64, 0x61, 0x74, 0x61,
	0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x22, 0x97, 0x01, 0x0a, 0x13, 0x52, 0x65, 0x67,
	...
	0x61, 0x6d, 0x65, 0x22, 0xeb, 0x04, 0x0a, 0x11, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x46, 0x69, 0x6c,
	...
	0x6e, 0x22, 0xba, 0x01, 0x0a, 0x0b, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66,
	...
	0x52, 0x6f, 0x77, 0x73, 0x22, 0x96, 0x05, 0x0a, 0x0d, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
	...
	0x54, 0x6c, 0x73, 0x4d, 0x69, 0x6e, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2e, 0x0a,
	0x13, 0x75, 0x73, 0x65, 0x5f, 0x63, 0x72, 0x63, 0x33, 0x32, 0x63, 0x5f, 0x63, 0x68, 0x65, 0x63,
	0x6b, 0x73, 0x75, 0x6d, 0x18, 0x12, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x75, 0x73, 0x65, 0x43,
	0x72, 0x63, 0x33, 0x32, 0x63, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x22, 0xc8, 0x01,
	...
	0x74, 0x68, 0x73, 0x22, 0xc2, 0x04, 0x0a, 0x09, 0x53, 0x74, 0x61, 0x74, 0x73, 0x54, 0x61, 0x73,
	...
	0x52, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x12, 0x4e, 0x0a, 0x0e, 0x66, 0x69, 0x6c, 0x65, 0x5f,
	...
	,
	...
	,
	...
	0x2f, 0x76, 0x33, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x70,
