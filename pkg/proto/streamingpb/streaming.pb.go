...
// / Summary store
// /
// The summary store is a business-agnostic summary of what a pchannel durably
// wrote: per-vchannel chunks of committed-write records (source message id,
// primary keys and the extra information a record carries). Applications build
// their own views on top of it — the idempotency interceptor materializes a
// dedup window from these entries — but the store itself knows nothing about
// them beyond the view_type it stores metadata under.
//
// VChannelSummaryMeta stores logical view progress for one view_type +
// vchannel. Physical summary entries are stored in the pchannel-level
// PChannelSummary chunks. This meta only records the view checkpoint hint and
// the oldest physical generation still required to recover the retained view.
type VChannelSummaryMeta struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	EvictedWatermarkTimetick    uint64              `protobuf:"varint,3,opt,name=evicted_watermark_timetick,json=evictedWatermarkTimetick,proto3" json:"evicted_watermark_timetick,omitempty"`
	SnapshotCheckpointTimetick  uint64              `protobuf:"varint,4,opt,name=snapshot_checkpoint_timetick,json=snapshotCheckpointTimetick,proto3" json:"snapshot_checkpoint_timetick,omitempty"`
	SnapshotCheckpointMessageId *commonpb.MessageID `protobuf:"bytes,5,opt,name=snapshot_checkpoint_message_id,json=snapshotCheckpointMessageId,proto3" json:"snapshot_checkpoint_message_id,omitempty"`
	LatestAppliedGeneration     uint64              `protobuf:"varint,6,opt,name=latest_applied_generation,json=latestAppliedGeneration,proto3" json:"latest_applied_generation,omitempty"`
	MinRequiredGeneration       uint64              `protobuf:"varint,7,opt,name=min_required_generation,json=minRequiredGeneration,proto3" json:"min_required_generation,omitempty"`
	// Summary view type, e.g. idempotency or meta-only index.
	ViewType string `protobuf:"bytes,8,opt,name=view_type,json=viewType,proto3" json:"view_type,omitempty"`
	// Metrics only.
	EntryCount uint64 `protobuf:"varint,9,opt,name=entry_count,json=entryCount,proto3" json:"entry_count,omitempty"`
}

func (x *VChannelSummaryMeta) Reset() {
	*x = VChannelSummaryMeta{}
	if protoimpl.UnsafeEnabled {
...
func (x *VChannelSummaryMeta) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VChannelSummaryMeta) ProtoMessage() {}

func (x *VChannelSummaryMeta) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[75]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VChannelSummaryMeta.ProtoReflect.Descriptor instead.
func (*VChannelSummaryMeta) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{75}
}

func (x *VChannelSummaryMeta) GetPchannel() string {
	if x != nil {
		return x.Pchannel
	}
	return ""
...
func (x *VChannelSummaryMeta) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *VChannelSummaryMeta) GetEvictedWatermarkTimetick() uint64 {
	if x != nil {
		return x.EvictedWatermarkTimetick
	}
	return 0
}

func (x *VChannelSummaryMeta) GetSnapshotCheckpointTimetick() uint64 {
	if x != nil {
		return x.SnapshotCheckpointTimetick
	}
	return 0
}

func (x *VChannelSummaryMeta) GetSnapshotCheckpointMessageId() *commonpb.MessageID {
	if x != nil {
		return x.SnapshotCheckpointMessageId
	}
	return nil
}

func (x *VChannelSummaryMeta) GetLatestAppliedGeneration() uint64 {
	if x != nil {
		return x.LatestAppliedGeneration
	}
	return 0
}

func (x *VChannelSummaryMeta) GetMinRequiredGeneration() uint64 {
	if x != nil {
		return x.MinRequiredGeneration
	}
	return 0
}

func (x *VChannelSummaryMeta) GetViewType() string {
	if x != nil {
		return x.ViewType
	}
	return ""
...
func (x *VChannelSummaryMeta) GetEntryCount() uint64 {
	if x != nil {
		return x.EntryCount
	}
	return 0
...
// PChannelSummaryChunkTermRange records which WAL assignment term owns a
// contiguous physical chunk generation range. Chunks are stored under
// generation+term scoped object keys, and recovery only reads chunks published
// by this manifest.
type PChannelSummaryChunkTermRange struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// WAL assignment term that wrote the chunks in this range.
	Term int64 `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`
	// Inclusive range start.
	StartGeneration uint64 `protobuf:"varint,2,opt,name=start_generation,json=startGeneration,proto3" json:"start_generation,omitempty"`
	// Inclusive latest generation published for this range. When sealed is
	// false this is the best-known end and can advance as recovery seals the
	// previous term.
	EndGeneration uint64 `protobuf:"varint,3,opt,name=end_generation,json=endGeneration,proto3" json:"end_generation,omitempty"`
	// True when no more chunks can be appended for this term.
	Sealed bool `protobuf:"varint,4,opt,name=sealed,proto3" json:"sealed,omitempty"`
	// Operational hints for range inspection.
	StartTimetick uint64 `protobuf:"varint,5,opt,name=start_timetick,json=startTimetick,proto3" json:"start_timetick,omitempty"`
	EndTimetick   uint64 `protobuf:"varint,6,opt,name=end_timetick,json=endTimetick,proto3" json:"end_timetick,omitempty"`
}

func (x *PChannelSummaryChunkTermRange) Reset() {
	*x = PChannelSummaryChunkTermRange{}
	if protoimpl.UnsafeEnabled {
...
func (x *PChannelSummaryChunkTermRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PChannelSummaryChunkTermRange) ProtoMessage() {}

func (x *PChannelSummaryChunkTermRange) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[76]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PChannelSummaryChunkTermRange.ProtoReflect.Descriptor instead.
func (*PChannelSummaryChunkTermRange) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{76}
}

func (x *PChannelSummaryChunkTermRange) GetTerm() int64 {
	if x != nil {
		return x.Term
	}
	return 0
...
func (x *PChannelSummaryChunkTermRange) GetStartGeneration() uint64 {
	if x != nil {
		return x.StartGeneration
	}
	return 0
}

func (x *PChannelSummaryChunkTermRange) GetEndGeneration() uint64 {
	if x != nil {
		return x.EndGeneration
	}
	return 0
}

func (x *PChannelSummaryChunkTermRange) GetSealed() bool {
	if x != nil {
		return x.Sealed
	}
	return false
...
func (x *PChannelSummaryChunkTermRange) GetStartTimetick() uint64 {
	if x != nil {
...
func (x *PChannelSummaryChunkTermRange) GetEndTimetick() uint64 {
	if x != nil {
...
type PChannelSummaryChunkManifest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Ranges []*PChannelSummaryChunkTermRange `protobuf:"bytes,1,rep,name=ranges,proto3" json:"ranges,omitempty"`
}

func (x *PChannelSummaryChunkManifest) Reset() {
	*x = PChannelSummaryChunkManifest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PChannelSummaryChunkManifest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PChannelSummaryChunkManifest) ProtoMessage() {}

func (x *PChannelSummaryChunkManifest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[77]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PChannelSummaryChunkManifest.ProtoReflect.Descriptor instead.
func (*PChannelSummaryChunkManifest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{77}
}

func (x *PChannelSummaryChunkManifest) GetRanges() []*PChannelSummaryChunkTermRange {
	if x != nil {
		return x.Ranges
	}
	return nil
...
// PChannelSummaryMeta stores pchannel-level physical summary store progress.
// It points to the latest physical chunk and summarizes the generation range
// that is still physically available / logically in use by active view metas.
type PChannelSummaryMeta struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Pchannel                  string              `protobuf:"bytes,1,opt,name=pchannel,proto3" json:"pchannel,omitempty"`
	SourceCheckpointTimetick  uint64              `protobuf:"varint,2,opt,name=source_checkpoint_timetick,json=sourceCheckpointTimetick,proto3" json:"source_checkpoint_timetick,omitempty"`
	SourceCheckpointMessageId *commonpb.MessageID `protobuf:"bytes,3,opt,name=source_checkpoint_message_id,json=sourceCheckpointMessageId,proto3" json:"source_checkpoint_message_id,omitempty"`
	LatestGeneration          uint64              `protobuf:"varint,4,opt,name=latest_generation,json=latestGeneration,proto3" json:"latest_generation,omitempty"`
	// Used by GC. The cleaner deletes chunk generations in [min_available_generation, min_in_use_generation)
	// and then advances min_available_generation up to min_in_use_generation; everything below
	// min_available_generation is already deleted. [min_in_use_generation, latest_generation] is still in
	// use and is required to rebuild active summary views on recovery.
	MinAvailableGeneration uint64 `protobuf:"varint,5,opt,name=min_available_generation,json=minAvailableGeneration,proto3" json:"min_available_generation,omitempty"`
	MinInUseGeneration     uint64 `protobuf:"varint,6,opt,name=min_in_use_generation,json=minInUseGeneration,proto3" json:"min_in_use_generation,omitempty"`
	// Physical chunk codec version.
	CodecVersion uint32 `protobuf:"varint,7,opt,name=codec_version,json=codecVersion,proto3" json:"codec_version,omitempty"`
	// The WAL assignment term of the owner that last persisted this meta.
	// Split-brain fencing: writers publish this meta through catalog CAS and
	// refuse to update a meta carrying a newer term than their own assignment.
	Term int64 `protobuf:"varint,8,opt,name=term,proto3" json:"term,omitempty"`
	// Manifest mapping generation ranges to WAL assignment terms. Chunk object
	// keys include both generation and term; recovery must only read chunks
	// published through this manifest.
	ChunkManifest *PChannelSummaryChunkManifest `protobuf:"bytes,9,opt,name=chunk_manifest,json=chunkManifest,proto3" json:"chunk_manifest,omitempty"`
}

func (x *PChannelSummaryMeta) Reset() {
	*x = PChannelSummaryMeta{}
	if protoimpl.UnsafeEnabled {
...
func (x *PChannelSummaryMeta) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PChannelSummaryMeta) ProtoMessage() {}

func (x *PChannelSummaryMeta) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[78]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PChannelSummaryMeta.ProtoReflect.Descriptor instead.
func (*PChannelSummaryMeta) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{78}
}

func (x *PChannelSummaryMeta) GetPchannel() string {
	if x != nil {
		return x.Pchannel
	}
	return ""
...
func (x *PChannelSummaryMeta) GetSourceCheckpointTimetick() uint64 {
	if x != nil {
		return x.SourceCheckpointTimetick
	}
	return 0
}

func (x *PChannelSummaryMeta) GetSourceCheckpointMessageId() *commonpb.MessageID {
	if x != nil {
		return x.SourceCheckpointMessageId
	}
	return nil
}

func (x *PChannelSummaryMeta) GetLatestGeneration() uint64 {
	if x != nil {
...
func (x *PChannelSummaryMeta) GetMinAvailableGeneration() uint64 {
	if x != nil {
		return x.MinAvailableGeneration
	}
	return 0
}

func (x *PChannelSummaryMeta) GetMinInUseGeneration() uint64 {
	if x != nil {
		return x.MinInUseGeneration
	}
	return 0
}

func (x *PChannelSummaryMeta) GetCodecVersion() uint32 {
	if x != nil {
...
func (x *PChannelSummaryMeta) GetTerm() int64 {
	if x != nil {
		return x.Term
	}
	return 0
...
func (x *PChannelSummaryMeta) GetChunkManifest() *PChannelSummaryChunkManifest {
	if x != nil {
		return x.ChunkManifest
	}
	return nil
}

// SummaryEntry is one committed-write fact of a vchannel: where it landed in the
// WAL plus the extra payload the write carried. It is plain data — the key and
// the insert result are what an idempotency view happens to need, but nothing
// here presumes that consumer.
type SummaryEntry struct {
	...
	CommitTimetick         uint64              `protobuf:"varint,2,opt,name=commit_timetick,json=commitTimetick,proto3" json:"commit_timetick,omitempty"`
	MessageId              *commonpb.MessageID `protobuf:"bytes,3,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"`
	LastConfirmedMessageId *commonpb.MessageID `protobuf:"bytes,4,opt,name=last_confirmed_message_id,json=lastConfirmedMessageId,proto3" json:"last_confirmed_message_id,omitempty"`
	// Result returned for duplicate insert response.
	IdempotentResult *messagespb.IdempotentInsertResult `protobuf:"bytes,5,opt,name=idempotent_result,json=idempotentResult,proto3" json:"idempotent_result,omitempty"`
}
...
func (x *SummaryEntry) GetCommitTimetick() uint64 {
	if x != nil {
		return x.CommitTimetick
	}
	return 0
}

func (x *SummaryEntry) GetMessageId() *commonpb.MessageID {
	if x != nil {
		return x.MessageId
	}
	return nil
...
func (x *SummaryEntry) GetLastConfirmedMessageId() *commonpb.MessageID {
	if x != nil {
		return x.LastConfirmedMessageId
	}
	return nil
...
func (x *SummaryEntry) GetIdempotentResult() *messagespb.IdempotentInsertResult {
	if x != nil {
		return x.IdempotentResult
	}
	return nil
}

// SummarySnapshot is the in-memory materialization of one vchannel's retained
// summary entries, handed to whichever application view consumes them.
type SummarySnapshot struct {
	...
	SnapshotCheckpointTimetick  uint64              `protobuf:"varint,4,opt,name=snapshot_checkpoint_timetick,json=snapshotCheckpointTimetick,proto3" json:"snapshot_checkpoint_timetick,omitempty"`
	SnapshotCheckpointMessageId *commonpb.MessageID `protobuf:"bytes,5,opt,name=snapshot_checkpoint_message_id,json=snapshotCheckpointMessageId,proto3" json:"snapshot_checkpoint_message_id,omitempty"`
	Entries                     []*SummaryEntry     `protobuf:"bytes,6,rep,name=entries,proto3" json:"entries,omitempty"`
}

func (x *SummarySnapshot) Reset() {
	*x = SummarySnapshot{}
	if protoimpl.UnsafeEnabled {
...
func (x *SummarySnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SummarySnapshot) ProtoMessage() {}

func (x *SummarySnapshot) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[80]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SummarySnapshot.ProtoReflect.Descriptor instead.
func (*SummarySnapshot) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{80}
}

func (x *SummarySnapshot) GetPchannel() string {
	if x != nil {
		return x.Pchannel
	}
	return ""
...
func (x *SummarySnapshot) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *SummarySnapshot) GetEvictedWatermarkTimetick() uint64 {
	if x != nil {
		return x.EvictedWatermarkTimetick
	}
	return 0
...
func (x *SummarySnapshot) GetSnapshotCheckpointTimetick() uint64 {
	if x != nil {
		return x.SnapshotCheckpointTimetick
	}
	return 0
...
func (x *SummarySnapshot) GetSnapshotCheckpointMessageId() *commonpb.MessageID {
	if x != nil {
		return x.SnapshotCheckpointMessageId
	}
	return nil
...
func (x *SummarySnapshot) GetEntries() []*SummaryEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
// SummaryChunkSourceRange is the source WAL span covered by a chunk or by one
// vchannel inside it, kept for operational inspection and replay bounds.
type SummaryChunkSourceRange struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	StartMessageId *commonpb.MessageID `protobuf:"bytes,1,opt,name=start_message_id,json=startMessageId,proto3" json:"start_message_id,omitempty"`
	EndMessageId   *commonpb.MessageID `protobuf:"bytes,2,opt,name=end_message_id,json=endMessageId,proto3" json:"end_message_id,omitempty"`
	StartTimetick  uint64              `protobuf:"varint,3,opt,name=start_timetick,json=startTimetick,proto3" json:"start_timetick,omitempty"`
	EndTimetick    uint64              `protobuf:"varint,4,opt,name=end_timetick,json=endTimetick,proto3" json:"end_timetick,omitempty"`
}

func (x *SummaryChunkSourceRange) Reset() {
	*x = SummaryChunkSourceRange{}
	if protoimpl.UnsafeEnabled {
...
func (x *SummaryChunkSourceRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SummaryChunkSourceRange) ProtoMessage() {}

func (x *SummaryChunkSourceRange) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[81]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SummaryChunkSourceRange.ProtoReflect.Descriptor instead.
func (*SummaryChunkSourceRange) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{81}
}

func (x *SummaryChunkSourceRange) GetStartMessageId() *commonpb.MessageID {
	if x != nil {
...
func (x *SummaryChunkSourceRange) GetEndMessageId() *commonpb.MessageID {
	if x != nil {
		return x.EndMessageId
	}
	return nil
}

func (x *SummaryChunkSourceRange) GetStartTimetick() uint64 {
	if x != nil {
		return x.StartTimetick
	}
	return 0
...
func (x *SummaryChunkSourceRange) GetEndTimetick() uint64 {
	if x != nil {
		return x.EndTimetick
	}
	return 0
...
// VChannelSummaryChunkIndex locates one vchannel's payload inside the chunk
// object. The checksum covers exactly the stored payload bytes and is always
// present; it is verified before that payload is decoded.
type VChannelSummaryChunkIndex struct {
	...
	SourceRange *SummaryChunkSourceRange `protobuf:"bytes,6,opt,name=source_range,json=sourceRange,proto3" json:"source_range,omitempty"`
}
...
func (x *VChannelSummaryChunkIndex) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *VChannelSummaryChunkIndex) GetLength() uint64 {
	if x != nil {
		return x.Length
	}
	return 0
...
func (x *VChannelSummaryChunkIndex) GetChecksum() []byte {
	if x != nil {
		return x.Checksum
	}
	return nil
...
func (x *VChannelSummaryChunkIndex) GetRecordCount() uint64 {
	if x != nil {
...
func (x *VChannelSummaryChunkIndex) GetSourceRange() *SummaryChunkSourceRange {
	if x != nil {
...
// PChannelSummaryChunkFooter is the chunk object's index. Recovery reads it
// first, from the object's tail.
type PChannelSummaryChunkFooter struct {
	...
	SourceCheckpointMessageId *commonpb.MessageID          `protobuf:"bytes,5,opt,name=source_checkpoint_message_id,json=sourceCheckpointMessageId,proto3" json:"source_checkpoint_message_id,omitempty"`
	SourceCheckpointTimetick  uint64                       `protobuf:"varint,6,opt,name=source_checkpoint_timetick,json=sourceCheckpointTimetick,proto3" json:"source_checkpoint_timetick,omitempty"`
	SourceRange               *SummaryChunkSourceRange     `protobuf:"bytes,7,opt,name=source_range,json=sourceRange,proto3" json:"source_range,omitempty"`
	Chunks                    []*VChannelSummaryChunkIndex `protobuf:"bytes,8,rep,name=chunks,proto3" json:"chunks,omitempty"`
}
...
func (x *PChannelSummaryChunkFooter) GetCodecVersion() uint32 {
	if x != nil {
		return x.CodecVersion
	}
	return 0
...
func (x *PChannelSummaryChunkFooter) GetSourceCheckpointMessageId() *commonpb.MessageID {
	if x != nil {
		return x.SourceCheckpointMessageId
	}
	return nil
...
func (x *PChannelSummaryChunkFooter) GetSourceCheckpointTimetick() uint64 {
	if x != nil {
		return x.SourceCheckpointTimetick
	}
	return 0
...
func (x *PChannelSummaryChunkFooter) GetSourceRange() *SummaryChunkSourceRange {
	if x != nil {
		return x.SourceRange
	}
	return nil
...
// CommittedWriteRow is one row of a committed write: where it sat in the
// original request and the primary key it was written under.
type CommittedWriteRow struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RowOffset uint32 `protobuf:"varint,1,opt,name=row_offset,json=rowOffset,proto3" json:"row_offset,omitempty"`
	// Types that are assignable to PrimaryKey:
	//
	//	*CommittedWriteRow_Int64PrimaryKey
	//	*CommittedWriteRow_StringPrimaryKey
	PrimaryKey isCommittedWriteRow_PrimaryKey `protobuf_oneof:"primary_key"`
}

func (x *CommittedWriteRow) Reset() {
	*x = CommittedWriteRow{}
	if protoimpl.UnsafeEnabled {
...
func (x *CommittedWriteRow) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CommittedWriteRow) ProtoMessage() {}

func (x *CommittedWriteRow) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[84]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CommittedWriteRow.ProtoReflect.Descriptor instead.
func (*CommittedWriteRow) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{84}
}

func (x *CommittedWriteRow) GetRowOffset() uint32 {
	if x != nil {
		return x.RowOffset
	}
	return 0
...
func (m *CommittedWriteRow) GetPrimaryKey() isCommittedWriteRow_PrimaryKey {
	if m != nil {
		return m.PrimaryKey
	}
	return nil
...
func (x *CommittedWriteRow) GetInt64PrimaryKey() int64 {
	if x, ok := x.GetPrimaryKey().(*CommittedWriteRow_Int64PrimaryKey); ok {
		return x.Int64PrimaryKey
	}
	return 0
}

func (x *CommittedWriteRow) GetStringPrimaryKey() string {
	if x, ok := x.GetPrimaryKey().(*CommittedWriteRow_StringPrimaryKey); ok {
		return x.StringPrimaryKey
	}
	return ""
}

type isCommittedWriteRow_PrimaryKey interface {
	isCommittedWriteRow_PrimaryKey()
}

type CommittedWriteRow_Int64PrimaryKey struct {
	Int64PrimaryKey int64 `protobuf:"varint,2,opt,name=int64_primary_key,json=int64PrimaryKey,proto3,oneof"`
}

type CommittedWriteRow_StringPrimaryKey struct {
	StringPrimaryKey string `protobuf:"bytes,3,opt,name=string_primary_key,json=stringPrimaryKey,proto3,oneof"`
}

func (*CommittedWriteRow_Int64PrimaryKey) isCommittedWriteRow_PrimaryKey() {}

func (*CommittedWriteRow_StringPrimaryKey) isCommittedWriteRow_PrimaryKey() {}

// CommittedWriteRecord is one committed write fact derived from an already
// landed WAL message.
type CommittedWriteRecord struct {
	...
	SourcePchannel  string               `protobuf:"bytes,1,opt,name=source_pchannel,json=sourcePchannel,proto3" json:"source_pchannel,omitempty"`
	SourceMessageId *commonpb.MessageID  `protobuf:"bytes,2,opt,name=source_message_id,json=sourceMessageId,proto3" json:"source_message_id,omitempty"`
	SourceTimetick  uint64               `protobuf:"varint,3,opt,name=source_timetick,json=sourceTimetick,proto3" json:"source_timetick,omitempty"`
	Vchannel        string               `protobuf:"bytes,4,opt,name=vchannel,proto3" json:"vchannel,omitempty"`
	Rows            []*CommittedWriteRow `protobuf:"bytes,5,rep,name=rows,proto3" json:"rows,omitempty"`
	// Empty when the write carried no idempotency key.
	IdempotencyKey         string              `protobuf:"bytes,6,opt,name=idempotency_key,json=idempotencyKey,proto3" json:"idempotency_key,omitempty"`
	LastConfirmedMessageId *commonpb.MessageID `protobuf:"bytes,7,opt,name=last_confirmed_message_id,json=lastConfirmedMessageId,proto3" json:"last_confirmed_message_id,omitempty"`
}

func (x *CommittedWriteRecord) Reset() {
	*x = CommittedWriteRecord{}
	if protoimpl.UnsafeEnabled {
...
func (x *CommittedWriteRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CommittedWriteRecord) ProtoMessage() {}

func (x *CommittedWriteRecord) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[85]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CommittedWriteRecord.ProtoReflect.Descriptor instead.
func (*CommittedWriteRecord) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{85}
}

func (x *CommittedWriteRecord) GetSourcePchannel() string {
	if x != nil {
		return x.SourcePchannel
	}
	return ""
}

func (x *CommittedWriteRecord) GetSourceMessageId() *commonpb.MessageID {
	if x != nil {
...
func (x *CommittedWriteRecord) GetSourceTimetick() uint64 {
	if x != nil {
...
func (x *CommittedWriteRecord) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *CommittedWriteRecord) GetRows() []*CommittedWriteRow {
	if x != nil {
		return x.Rows
	}
	return nil
...
func (x *CommittedWriteRecord) GetIdempotencyKey() string {
	if x != nil {
...
func (x *CommittedWriteRecord) GetLastConfirmedMessageId() *commonpb.MessageID {
	if x != nil {
		return x.LastConfirmedMessageId
	}
	return nil
...
// VChannelSummaryChunk is one vchannel's payload inside the chunk object.
type VChannelSummaryChunk struct {
	...
	SourceRange  *SummaryChunkSourceRange `protobuf:"bytes,5,opt,name=source_range,json=sourceRange,proto3" json:"source_range,omitempty"`
	Records      []*CommittedWriteRecord  `protobuf:"bytes,6,rep,name=records,proto3" json:"records,omitempty"`
}

func (x *VChannelSummaryChunk) Reset() {
	*x = VChannelSummaryChunk{}
	if protoimpl.UnsafeEnabled {
...
func (x *VChannelSummaryChunk) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VChannelSummaryChunk) ProtoMessage() {}

func (x *VChannelSummaryChunk) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[86]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VChannelSummaryChunk.ProtoReflect.Descriptor instead.
func (*VChannelSummaryChunk) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{86}
}

func (x *VChannelSummaryChunk) GetCodecVersion() uint32 {
	if x != nil {
		return x.CodecVersion
	}
	return 0
...
func (x *VChannelSummaryChunk) GetPchannel() string {
	if x != nil {
		return x.Pchannel
	}
	return ""
...
func (x *VChannelSummaryChunk) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *VChannelSummaryChunk) GetGeneration() uint64 {
	if x != nil {
		return x.Generation
	}
	return 0
...
func (x *VChannelSummaryChunk) GetSourceRange() *SummaryChunkSourceRange {
	if x != nil {
		return x.SourceRange
	}
	return nil
...
func (x *VChannelSummaryChunk) GetRecords() []*CommittedWriteRecord {
	if x != nil {
		return x.Records
	}
	return nil
...
var file_streaming_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x49, 0x44, 0x52, 0x09, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x64, 0x12, 0x59,
	0x0a, 0x19, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x65, 0x64,
	...
	,
	...
	,
	...
	0x0b, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x74, 0x69, 0x63, 0x6b, 0x22, 0xfa, 0x01, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x6e, 0x63, 0x79, 0x4b, 0x65, 0x79, 0x12, 0x59, 0x0a, 0x19, 0x6c, 0x61, 0x73, 0x74,
	0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x65, 0x64, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6d, 0x69,
	...
	,
	...
	0x65, 0x6c, 0x12, 0x44, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	,
	...
	0x52, 0x6f, 0x77, 0x73, 0x22, 0x96, 0x03, 0x0a, 0x0d, 0x57, 0x41, 0x4c, 0x43, 0x68, 0x65, 0x63,
	...
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x44, 0x52, 0x4f, 0x50, 0x50, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x8a,
	...
	0x45, 0x5f, 0x46, 0x4c, 0x55, 0x53, 0x48, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x3f, 0x0a, 0x0d, 0x41,
	...
	0x43, 0x48, 0x45, 0x43, 0x4b, 0x50, 0x4f, 0x49, 0x4e, 0x54, 0x10, 0x02, 0x32, 0x89, 0x01, 0x0a,
...
var file_streaming_proto_msgTypes = make([]protoimpl.MessageInfo, 95)
var file_streaming_proto_goTypes = []interface{}{
	...
	(*VChannelSummaryMeta)(nil),                       // 84: milvus.proto.streaming.VChannelSummaryMeta
	(*PChannelSummaryChunkTermRange)(nil),             // 85: milvus.proto.streaming.PChannelSummaryChunkTermRange
	(*PChannelSummaryChunkManifest)(nil),              // 86: milvus.proto.streaming.PChannelSummaryChunkManifest
	(*PChannelSummaryMeta)(nil),                       // 87: milvus.proto.streaming.PChannelSummaryMeta
	(*SummaryEntry)(nil),                              // 88: milvus.proto.streaming.SummaryEntry
	(*SummarySnapshot)(nil),                           // 89: milvus.proto.streaming.SummarySnapshot
	(*SummaryChunkSourceRange)(nil),                   // 90: milvus.proto.streaming.SummaryChunkSourceRange
	(*VChannelSummaryChunkIndex)(nil),                 // 91: milvus.proto.streaming.VChannelSummaryChunkIndex
	(*PChannelSummaryChunkFooter)(nil),                // 92: milvus.proto.streaming.PChannelSummaryChunkFooter
	(*CommittedWriteRow)(nil),                         // 93: milvus.proto.streaming.CommittedWriteRow
	(*CommittedWriteRecord)(nil),                      // 94: milvus.proto.streaming.CommittedWriteRecord
	(*VChannelSummaryChunk)(nil),                      // 95: milvus.proto.streaming.VChannelSummaryChunk
	(*SegmentAssignmentMeta)(nil),                     // 96: milvus.proto.streaming.SegmentAssignmentMeta
	(*SegmentAssignmentStat)(nil),                     // 97: milvus.proto.streaming.SegmentAssignmentStat
	(*WALCheckpoint)(nil),                             // 98: milvus.proto.streaming.WALCheckpoint
	(*AlterWALState)(nil),                             // 99: milvus.proto.streaming.AlterWALState
	(*ReplicateConfigurationMeta)(nil),                // 100: milvus.proto.streaming.ReplicateConfigurationMeta
	(*ReplicatePChannelMeta)(nil),                     // 101: milvus.proto.streaming.ReplicatePChannelMeta
	nil,                                               // 102: milvus.proto.streaming.BroadcastResponse.ResultsEntry
	nil,                                               // 103: milvus.proto.streaming.AlterWALState.ConfigsEntry
	(*messagespb.Message)(nil),                        // 104: milvus.proto.messages.Message
	(*commonpb.MessageID)(nil),                        // 105: milvus.proto.common.MessageID
	(*commonpb.ImmutableMessage)(nil),                 // 106: milvus.proto.common.ImmutableMessage
	(*commonpb.ReplicateConfiguration)(nil),           // 107: milvus.proto.common.ReplicateConfiguration
	(*fieldmaskpb.FieldMask)(nil),                     // 108: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                             // 109: google.protobuf.Empty
	(messagespb.MessageType)(0),                       // 110: milvus.proto.messages.MessageType
	(*commonpb.ReplicateCheckpoint)(nil),              // 111: milvus.proto.common.ReplicateCheckpoint
	(*messagespb.TxnContext)(nil),                     // 112: milvus.proto.messages.TxnContext
	(*anypb.Any)(nil),                                 // 113: google.protobuf.Any
	(*schemapb.CollectionSchema)(nil),                 // 114: milvus.proto.schema.CollectionSchema
	(*messagespb.IdempotentInsertResult)(nil),         // 115: milvus.proto.messages.IdempotentInsertResult
...
var file_streaming_proto_depIdxs = []int32{
	...
	104, // 7: milvus.proto.streaming.BroadcastTask.message:type_name -> milvus.proto.messages.Message
	...
	105, // 11: milvus.proto.streaming.AckedCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	105, // 12: milvus.proto.streaming.AckedCheckpoint.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	104, // 13: milvus.proto.streaming.BroadcastRequest.message:type_name -> milvus.proto.messages.Message
	102, // 14: milvus.proto.streaming.BroadcastResponse.results:type_name -> milvus.proto.streaming.BroadcastResponse.ResultsEntry
	106, // 15: milvus.proto.streaming.BroadcastAckRequest.message:type_name -> milvus.proto.common.ImmutableMessage
	107, // 16: milvus.proto.streaming.UpdateReplicateConfigurationRequest.configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	108, // 19: milvus.proto.streaming.UpdateWALBalancePolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	107, // 30: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	109, // 36: milvus.proto.streaming.DeliverPolicy.all:type_name -> google.protobuf.Empty
	109, // 37: milvus.proto.streaming.DeliverPolicy.latest:type_name -> google.protobuf.Empty
	105, // 38: milvus.proto.streaming.DeliverPolicy.start_from:type_name -> milvus.proto.common.MessageID
	105, // 39: milvus.proto.streaming.DeliverPolicy.start_after:type_name -> milvus.proto.common.MessageID
	...
	110, // 43: milvus.proto.streaming.DeliverFilterMessageType.message_types:type_name -> milvus.proto.messages.MessageType
	...
	111, // 46: milvus.proto.streaming.GetReplicateCheckpointResponse.checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	9,   // 47: milvus.proto.streaming.GetSalvageCheckpointRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	111, // 48: milvus.proto.streaming.GetSalvageCheckpointResponse.checkpoints:type_name -> milvus.proto.common.ReplicateCheckpoint
	...
	104, // 52: milvus.proto.streaming.ProduceMessageRequest.message:type_name -> milvus.proto.messages.Message
	...
	105, // 60: milvus.proto.streaming.ProduceMessageResponseResult.id:type_name -> milvus.proto.common.MessageID
	112, // 61: milvus.proto.streaming.ProduceMessageResponseResult.txnContext:type_name -> milvus.proto.messages.TxnContext
	113, // 62: milvus.proto.streaming.ProduceMessageResponseResult.extra:type_name -> google.protobuf.Any
	105, // 63: milvus.proto.streaming.ProduceMessageResponseResult.last_confirmed_id:type_name -> milvus.proto.common.MessageID
	...
	106, // 80: milvus.proto.streaming.ConsumeMessageReponse.message:type_name -> milvus.proto.common.ImmutableMessage
	...
	114, // 92: milvus.proto.streaming.CollectionSchemaOfVChannel.schema:type_name -> milvus.proto.schema.CollectionSchema
	6,   // 93: milvus.proto.streaming.CollectionSchemaOfVChannel.state:type_name -> milvus.proto.streaming.VChannelSchemaState
	105, // 94: milvus.proto.streaming.VChannelSummaryMeta.snapshot_checkpoint_message_id:type_name -> milvus.proto.common.MessageID
	85,  // 95: milvus.proto.streaming.PChannelSummaryChunkManifest.ranges:type_name -> milvus.proto.streaming.PChannelSummaryChunkTermRange
	105, // 96: milvus.proto.streaming.PChannelSummaryMeta.source_checkpoint_message_id:type_name -> milvus.proto.common.MessageID
	86,  // 97: milvus.proto.streaming.PChannelSummaryMeta.chunk_manifest:type_name -> milvus.proto.streaming.PChannelSummaryChunkManifest
	105, // 98: milvus.proto.streaming.SummaryEntry.message_id:type_name -> milvus.proto.common.MessageID
	105, // 99: milvus.proto.streaming.SummaryEntry.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	115, // 100: milvus.proto.streaming.SummaryEntry.idempotent_result:type_name -> milvus.proto.messages.IdempotentInsertResult
	105, // 101: milvus.proto.streaming.SummarySnapshot.snapshot_checkpoint_message_id:type_name -> milvus.proto.common.MessageID
	88,  // 102: milvus.proto.streaming.SummarySnapshot.entries:type_name -> milvus.proto.streaming.SummaryEntry
	105, // 103: milvus.proto.streaming.SummaryChunkSourceRange.start_message_id:type_name -> milvus.proto.common.MessageID
	105, // 104: milvus.proto.streaming.SummaryChunkSourceRange.end_message_id:type_name -> milvus.proto.common.MessageID
	90,  // 105: milvus.proto.streaming.VChannelSummaryChunkIndex.source_range:type_name -> milvus.proto.streaming.SummaryChunkSourceRange
	105, // 106: milvus.proto.streaming.PChannelSummaryChunkFooter.source_checkpoint_message_id:type_name -> milvus.proto.common.MessageID
	90,  // 107: milvus.proto.streaming.PChannelSummaryChunkFooter.source_range:type_name -> milvus.proto.streaming.SummaryChunkSourceRange
	91,  // 108: milvus.proto.streaming.PChannelSummaryChunkFooter.chunks:type_name -> milvus.proto.streaming.VChannelSummaryChunkIndex
	105, // 109: milvus.proto.streaming.CommittedWriteRecord.source_message_id:type_name -> milvus.proto.common.MessageID
	93,  // 110: milvus.proto.streaming.CommittedWriteRecord.rows:type_name -> milvus.proto.streaming.CommittedWriteRow
	105, // 111: milvus.proto.streaming.CommittedWriteRecord.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	90,  // 112: milvus.proto.streaming.VChannelSummaryChunk.source_range:type_name -> milvus.proto.streaming.SummaryChunkSourceRange
	94,  // 113: milvus.proto.streaming.VChannelSummaryChunk.records:type_name -> milvus.proto.streaming.CommittedWriteRecord
	7,   // 114: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	97,  // 115: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	116, // 116: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	105, // 117: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	107, // 118: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	111, // 119: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	99,  // 120: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	117, // 121: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	103, // 122: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	8,   // 123: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	107, // 124: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	16,  // 125: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	118, // 126: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	111, // 127: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	55,  // 128: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	119, // 129: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	18,  // 130: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	20,  // 131: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	22,  // 132: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	24,  // 133: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	28,  // 134: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	43,  // 135: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	45,  // 136: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:input_type -> milvus.proto.streaming.GetSalvageCheckpointRequest
	47,  // 137: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	57,  // 138: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	70,  // 139: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	72,  // 140: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	74,  // 141: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	120, // 142: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	19,  // 143: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	21,  // 144: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	23,  // 145: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	27,  // 146: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	31,  // 147: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	44,  // 148: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	46,  // 149: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:output_type -> milvus.proto.streaming.GetSalvageCheckpointResponse
	51,  // 150: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	66,  // 151: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	71,  // 152: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	73,  // 153: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	79,  // 154: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	142, // [142:155] is the sub-list for method output_type
	129, // [129:142] is the sub-list for method input_type
...
func file_streaming_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streaming_proto_msgTypes[75].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VChannelSummaryMeta); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[76].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PChannelSummaryChunkTermRange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[77].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PChannelSummaryChunkManifest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[78].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PChannelSummaryMeta); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[81].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SummaryChunkSourceRange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CommittedWriteRow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[85].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CommittedWriteRecord); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[86].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VChannelSummaryChunk); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_streaming_proto_msgTypes[84].OneofWrappers = []interface{}{
		(*CommittedWriteRow_Int64PrimaryKey)(nil),
		(*CommittedWriteRow_StringPrimaryKey)(nil),
	}
	type x struct{}
