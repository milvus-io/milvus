...
type SegmentAssignmentMeta struct {
	...
	PersistedStorage   *L1SegmentPersistedStorage `protobuf:"bytes,9,opt,name=persisted_storage,json=persistedStorage,proto3" json:"persisted_storage,omitempty"`          // L1 segment persisted storage.
}
...
type L1SegmentPersistedStorage struct {
	...
	ManifestPath      string              `protobuf:"bytes,1,opt,name=manifest_path,json=manifestPath,proto3" json:"manifest_path,omitempty"` // latest manifest path of current segment.
...
type L1SegmentBinLogs struct {
	...
	FromTimeTick uint64                `protobuf:"varint,4,opt,name=from_time_tick,json=fromTimeTick,proto3" json:"from_time_tick,omitempty"` // the time tick of the first message in the binlogs.
	ToTimeTick   uint64                `protobuf:"varint,5,opt,name=to_time_tick,json=toTimeTick,proto3" json:"to_time_tick,omitempty"`       // the time tick of the last message in the binlogs.
}
...
type SegmentAssignmentStat struct {
	...
	BeginTimeTick         uint64              `protobuf:"varint,10,opt,name=begin_time_tick,json=beginTimeTick,proto3" json:"begin_time_tick,omitempty"`                          // The begin of first modified message in wal.
	EndTimeTick           uint64              `protobuf:"varint,11,opt,name=end_time_tick,json=endTimeTick,proto3" json:"end_time_tick,omitempty"`                                // The end of last modified message in wal.
	FlushSegmentTimeTick  uint64              `protobuf:"varint,12,opt,name=flush_segment_time_tick,json=flushSegmentTimeTick,proto3" json:"flush_segment_time_tick,omitempty"`   // The timetick of message with flush semantics in wal.
}
...
func (x *SegmentAssignmentStat) GetBeginTimeTick() uint64 {
	if x != nil {
		return x.BeginTimeTick
	}
	return 0
}

func (x *SegmentAssignmentStat) GetEndTimeTick() uint64 {
	if x != nil {
...
func (x *SegmentAssignmentStat) GetFlushSegmentTimeTick() uint64 {
	if x != nil {
		return x.FlushSegmentTimeTick
	}
	return 0
}
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x22, 0xde, 0x03, 0x0a, 0x15, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x73, 0x73, 0x69,
	...
	0x65, 0x22, 0xd4, 0x01, 0x0a, 0x19, 0x4c, 0x31, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x50,
	...
	0x74, 0x73, 0x42, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x22, 0xa1, 0x02, 0x0a, 0x10, 0x4c, 0x31, 0x53,
	...
	0x52, 0x0a, 0x74, 0x6f, 0x54, 0x69, 0x6d, 0x65, 0x54, 0x69, 0x63, 0x6b, 0x22, 0xae, 0x04, 0x0a,
	...
	,
	...
	0x4e, 0x45, 0x10, 0x05, 0x2a, 0xa3, 0x05, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69,
	...
	0x49, 0x54, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x10, 0x12, 0x1b, 0x0a,
...
var file_streaming_proto_goTypes = []interface{}{
	...
	(datapb.SegmentLevel)(0),                          // 106: milvus.proto.data.SegmentLevel
	(commonpb.WALName)(0),                             // 107: milvus.proto.common.WALName
	(*commonpb.MilvusCluster)(nil),                    // 108: milvus.proto.common.MilvusCluster
	(*milvuspb.GetComponentStatesRequest)(nil),        // 109: milvus.proto.milvus.GetComponentStatesRequest
	(*milvuspb.ComponentStates)(nil),                  // 110: milvus.proto.milvus.ComponentStates
}
var file_streaming_proto_depIdxs = []int32{
	...
	105, // 99: milvus.proto.streaming.L1SegmentBinLogs.field_binlog:type_name -> milvus.proto.data.FieldBinlog
	105, // 100: milvus.proto.streaming.L1SegmentBinLogs.stats_binlog:type_name -> milvus.proto.data.FieldBinlog
	105, // 101: milvus.proto.streaming.L1SegmentBinLogs.bm25_binlog:type_name -> milvus.proto.data.FieldBinlog
	106, // 102: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	95,  // 103: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	97,  // 104: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	101, // 105: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	89,  // 106: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	107, // 107: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	93,  // 108: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	8,   // 109: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	97,  // 110: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	16,  // 111: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	108, // 112: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	101, // 113: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	55,  // 114: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	109, // 115: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	18,  // 116: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	20,  // 117: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	22,  // 118: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	24,  // 119: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	28,  // 120: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	43,  // 121: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	45,  // 122: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:input_type -> milvus.proto.streaming.GetSalvageCheckpointRequest
	47,  // 123: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	57,  // 124: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	70,  // 125: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	72,  // 126: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	74,  // 127: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	110, // 128: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	19,  // 129: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	21,  // 130: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	23,  // 131: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	27,  // 132: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	31,  // 133: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	44,  // 134: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	46,  // 135: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:output_type -> milvus.proto.streaming.GetSalvageCheckpointResponse
	51,  // 136: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	66,  // 137: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	71,  // 138: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	73,  // 139: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	79,  // 140: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
