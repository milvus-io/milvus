...
// VChannelSummaryMeta stores one view's progress over one vchannel: how far it
// has consumed, and the oldest chunk generation it still needs to rebuild what
// it retains. The facts themselves live in the pchannel chunks.
//
...
type VChannelSummaryChunk struct {
	...
	Vchannel string          `protobuf:"bytes,1,opt,name=vchannel,proto3" json:"vchannel,omitempty"`
	Entries  []*SummaryEntry `protobuf:"bytes,2,rep,name=entries,proto3" json:"entries,omitempty"`
}
...
func (x *VChannelSummaryChunk) GetEntries() []*SummaryEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
// SummaryEntry is one committed write fact: where and when it landed in the WAL,
// plus whatever the views need to remember about it.
//
// It is the store's only element type. What a chunk holds durably and what a
// snapshot hands a view at recovery are the same thing, so nothing is projected
// between two shapes and the two cannot drift apart.
//
// The top level is view-neutral, and an entry may carry no view content at all:
// such an entry is checkpoint bookkeeping — a write that happened and moved the
// vchannel forward, that no view needs to remember. It records no destination
// either; every entry in a chunk shares one, so the vchannel is stored once on
// the chunk and the pchannel once on the footer.
type SummaryEntry struct {
	...
	// Per-view content. A new view adds a sibling field here rather than a
	// column on the entry, and views stay independent: an entry may carry
	// content for several of them at once.
	Idempotency *IdempotencyContent `protobuf:"bytes,4,opt,name=idempotency,proto3" json:"idempotency,omitempty"`
}
...
func (x *SummaryEntry) GetSourceMessageId() *commonpb.MessageID {
	if x != nil {
...
func (x *SummaryEntry) GetSourceTimetick() uint64 {
	if x != nil {
...
func (x *SummaryEntry) GetIdempotency() *IdempotencyContent {
	if x != nil {
...
// IdempotencyContent is what the idempotency view remembers about a committed
// write: the client key that produced it, and the result a duplicate append
// replays back to that client.
//
// The rows live here rather than on the entry because they only exist for
// idempotent writes — the proxy stamps them onto the insert header only when
// idempotency is enabled — so hoisting them would claim every committed write
// carries its rows, which is false. A view that later needs rows for ordinary
// writes brings its own content message and its own way of obtaining them.
type IdempotencyContent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Key          string                             `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	InsertResult *messagespb.IdempotentInsertResult `protobuf:"bytes,2,opt,name=insert_result,json=insertResult,proto3" json:"insert_result,omitempty"`
}

func (x *IdempotencyContent) Reset() {
	*x = IdempotencyContent{}
	if protoimpl.UnsafeEnabled {
...
func (x *IdempotencyContent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IdempotencyContent) ProtoMessage() {}

func (x *IdempotencyContent) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[84]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IdempotencyContent.ProtoReflect.Descriptor instead.
func (*IdempotencyContent) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{84}
}

func (x *IdempotencyContent) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *IdempotencyContent) GetInsertResult() *messagespb.IdempotentInsertResult {
	if x != nil {
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x22, 0x6d, 0x0a, 0x1c, 0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53,
	0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x4d, 0x61, 0x6e, 0x69, 0x66,
	0x65, 0x73, 0x74, 0x12, 0x4d, 0x0a, 0x06, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x01, 0x20,
	...
	0x6b, 0x54, 0x65, 0x72, 0x6d, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x06, 0x72, 0x61, 0x6e, 0x67,
	0x65, 0x73, 0x22, 0xe7, 0x01, 0x0a, 0x1d, 0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53,
	...
	0x0b, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x74, 0x69, 0x63, 0x6b, 0x22, 0xff, 0x02, 0x0a,
	0x13, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79,
	0x4d, 0x65, 0x74, 0x61, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
	...
	,
	...
	,
	...
	0x22, 0x8a, 0x02, 0x0a, 0x19, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x6d,
	0x6d, 0x61, 0x72, 0x79, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1a,
	0x0a, 0x08, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x66,
	...
	0x28, 0x04, 0x52, 0x06, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x68,
	0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x63, 0x68,
	0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x72, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x32, 0x0a, 0x15, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x74, 0x69,
	0x63, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x13, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x74, 0x69, 0x63, 0x6b, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x11, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x45, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x74, 0x69, 0x63, 0x6b, 0x22, 0x72, 0x0a,
	0x14, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79,
	0x43, 0x68, 0x75, 0x6e, 0x6b, 0x12, 0x1a, 0x0a, 0x08, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65,
	0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65,
	0x6c, 0x12, 0x3e, 0x0a, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x24, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x73, 0x22, 0xac, 0x02, 0x0a, 0x0c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x12, 0x4a, 0x0a, 0x11, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6d, 0x65, 0x73,
	...
	0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x44, 0x52, 0x16, 0x6c, 0x61, 0x73, 0x74,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x65, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x49, 0x64, 0x12, 0x4c, 0x0a, 0x0b, 0x69, 0x64, 0x65, 0x6d, 0x70, 0x6f, 0x74, 0x65, 0x6e, 0x63,
	0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67,
	0x2e, 0x49, 0x64, 0x65, 0x6d, 0x70, 0x6f, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x43, 0x6f, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x52, 0x0b, 0x69, 0x64, 0x65, 0x6d, 0x70, 0x6f, 0x74, 0x65, 0x6e, 0x63, 0x79,
	...
	,
	...
	0x6d, 0x61, 0x78, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x96, 0x03, 0x0a, 0x0d, 0x57, 0x41, 0x4c, 0x43,
	...
	0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x10, 0x03, 0x2a, 0x62,
	...
	0x10, 0x02, 0x2a, 0x7d, 0x0a, 0x13, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x63,
	...
	0x02, 0x2a, 0x8a, 0x01, 0x0a, 0x16, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x73, 0x73,
	...
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x46, 0x4c, 0x55, 0x53, 0x48, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x3f,
...
var file_streaming_proto_goTypes = []interface{}{
	...
	(*PChannelSummaryChunkManifest)(nil),              // 85: milvus.proto.streaming.PChannelSummaryChunkManifest
	(*PChannelSummaryChunkTermRange)(nil),             // 86: milvus.proto.streaming.PChannelSummaryChunkTermRange
	(*VChannelSummaryMeta)(nil),                       // 87: milvus.proto.streaming.VChannelSummaryMeta
	...
	(*VChannelSummaryChunk)(nil),                      // 90: milvus.proto.streaming.VChannelSummaryChunk
	(*SummaryEntry)(nil),                              // 91: milvus.proto.streaming.SummaryEntry
	(*SummarySnapshot)(nil),                           // 92: milvus.proto.streaming.SummarySnapshot
	(*IdempotencyContent)(nil),                        // 93: milvus.proto.streaming.IdempotencyContent
...
var file_streaming_proto_depIdxs = []int32{
	...
	103, // 94: milvus.proto.streaming.PChannelSummaryMeta.source_checkpoint_message_id:type_name -> milvus.proto.common.MessageID
	85,  // 95: milvus.proto.streaming.PChannelSummaryMeta.chunk_manifest:type_name -> milvus.proto.streaming.PChannelSummaryChunkManifest
	86,  // 96: milvus.proto.streaming.PChannelSummaryChunkManifest.ranges:type_name -> milvus.proto.streaming.PChannelSummaryChunkTermRange
	103, // 97: milvus.proto.streaming.PChannelSummaryChunkFooter.source_checkpoint_message_id:type_name -> milvus.proto.common.MessageID
	89,  // 98: milvus.proto.streaming.PChannelSummaryChunkFooter.chunks:type_name -> milvus.proto.streaming.VChannelSummaryChunkIndex
	91,  // 99: milvus.proto.streaming.VChannelSummaryChunk.entries:type_name -> milvus.proto.streaming.SummaryEntry
	103, // 100: milvus.proto.streaming.SummaryEntry.source_message_id:type_name -> milvus.proto.common.MessageID
	103, // 101: milvus.proto.streaming.SummaryEntry.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	93,  // 102: milvus.proto.streaming.SummaryEntry.idempotency:type_name -> milvus.proto.streaming.IdempotencyContent
	91,  // 103: milvus.proto.streaming.SummarySnapshot.entries:type_name -> milvus.proto.streaming.SummaryEntry
	113, // 104: milvus.proto.streaming.IdempotencyContent.insert_result:type_name -> milvus.proto.messages.IdempotentInsertResult
	7,   // 105: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	95,  // 106: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	114, // 107: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	103, // 108: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	105, // 109: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	109, // 110: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	97,  // 111: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	115, // 112: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	101, // 113: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	8,   // 114: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	105, // 115: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	16,  // 116: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	116, // 117: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	109, // 118: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	55,  // 119: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	117, // 120: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	18,  // 121: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	20,  // 122: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	22,  // 123: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	24,  // 124: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	28,  // 125: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	43,  // 126: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	45,  // 127: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:input_type -> milvus.proto.streaming.GetSalvageCheckpointRequest
	47,  // 128: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	57,  // 129: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	70,  // 130: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	72,  // 131: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	74,  // 132: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	118, // 133: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	19,  // 134: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	21,  // 135: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	23,  // 136: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	27,  // 137: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	31,  // 138: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	44,  // 139: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	46,  // 140: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:output_type -> milvus.proto.streaming.GetSalvageCheckpointResponse
	51,  // 141: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	66,  // 142: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	71,  // 143: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	73,  // 144: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	79,  // 145: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	133, // [133:146] is the sub-list for method output_type
	120, // [120:133] is the sub-list for method input_type
...
func file_streaming_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streaming_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IdempotencyContent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
