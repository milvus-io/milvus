...
const (
	...
	PChannelMetaState_PCHANNEL_META_STATE_DROPPING      PChannelMetaState = 5 // channel or WAL replica is being removed.
)
...
var (
	PChannelMetaState_name = map[int32]string{
		...
		5: "PCHANNEL_META_STATE_DROPPING",
	}
	PChannelMetaState_value = map[string]int32{
		...
		"PCHANNEL_META_STATE_DROPPING":      5,
	}
)
...
type PChannelInfo struct {
	...
	Term int64  `protobuf:"varint,2,opt,name=term,proto3" json:"term,omitempty"` // PChannel write-link epoch. It increases when the
	// READWRITE write chain is opened or reopened.
...
type PChannelAssignmentLog struct {
	...
	AccessMode      PChannelAccessMode `protobuf:"varint,3,opt,name=access_mode,json=accessMode,proto3,enum=milvus.proto.streaming.PChannelAccessMode" json:"access_mode,omitempty"` // access mode of the channel.
	AssignmentEpoch int64              `protobuf:"varint,4,opt,name=assignment_epoch,json=assignmentEpoch,proto3" json:"assignment_epoch,omitempty"`                                 // WAL replica assignment epoch for same-term fencing.
}
...
func (x *PChannelAssignmentLog) GetAssignmentEpoch() int64 {
	if x != nil {
...
// WALReplicaAssignment is one serving replica assignment of a PChannel.
// The backend WAL and authoritative recovery projection are still keyed by the
// PChannel name. replica_id only distinguishes serving runtimes over that
// shared WAL.
type WALReplicaAssignment struct {
	...
	AccessMode                 PChannelAccessMode       `protobuf:"varint,2,opt,name=access_mode,json=accessMode,proto3,enum=milvus.proto.streaming.PChannelAccessMode" json:"access_mode,omitempty"`
	...
	ActiveNode                 *StreamingNodeInfo       `protobuf:"bytes,5,opt,name=active_node,json=activeNode,proto3" json:"active_node,omitempty"`
	TargetNode                 *StreamingNodeInfo       `protobuf:"bytes,6,opt,name=target_node,json=targetNode,proto3" json:"target_node,omitempty"`
	State                      PChannelMetaState        `protobuf:"varint,7,opt,name=state,proto3,enum=milvus.proto.streaming.PChannelMetaState" json:"state,omitempty"`
	Histories                  []*PChannelAssignmentLog `protobuf:"bytes,8,rep,name=histories,proto3" json:"histories,omitempty"`
	LastAssignTimestampSeconds uint64                   `protobuf:"varint,9,opt,name=last_assign_timestamp_seconds,json=lastAssignTimestampSeconds,proto3" json:"last_assign_timestamp_seconds,omitempty"`
}

func (x *WALReplicaAssignment) Reset() {
	*x = WALReplicaAssignment{}
	if protoimpl.UnsafeEnabled {
...
func (x *WALReplicaAssignment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WALReplicaAssignment) ProtoMessage() {}

func (x *WALReplicaAssignment) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WALReplicaAssignment.ProtoReflect.Descriptor instead.
func (*WALReplicaAssignment) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{2}
}

func (x *WALReplicaAssignment) GetReplicaId() int64 {
	if x != nil {
		return x.ReplicaId
	}
	return 0
...
func (x *WALReplicaAssignment) GetAccessMode() PChannelAccessMode {
	if x != nil {
		return x.AccessMode
	}
	return PChannelAccessMode_PCHANNEL_ACCESS_READWRITE
...
func (x *WALReplicaAssignment) GetAssignmentEpoch() int64 {
	if x != nil {
		return x.AssignmentEpoch
	}
	return 0
...
func (x *WALReplicaAssignment) GetResourceGroup() string {
	if x != nil {
...
func (x *WALReplicaAssignment) GetActiveNode() *StreamingNodeInfo {
	if x != nil {
		return x.ActiveNode
	}
	return nil
...
func (x *WALReplicaAssignment) GetTargetNode() *StreamingNodeInfo {
	if x != nil {
		return x.TargetNode
	}
	return nil
...
func (x *WALReplicaAssignment) GetState() PChannelMetaState {
	if x != nil {
		return x.State
	}
...
func (x *WALReplicaAssignment) GetHistories() []*PChannelAssignmentLog {
	if x != nil {
		return x.Histories
	}
	return nil
...
func (x *WALReplicaAssignment) GetLastAssignTimestampSeconds() uint64 {
	if x != nil {
...
type PChannelMeta struct {
	...
	// PrimaryReplicaID points to the single AccessModeRW WAL replica.
	PrimaryReplicaId int64                   `protobuf:"varint,6,opt,name=primary_replica_id,json=primaryReplicaId,proto3" json:"primary_replica_id,omitempty"`
	NextReplicaId    int64                   `protobuf:"varint,7,opt,name=next_replica_id,json=nextReplicaId,proto3" json:"next_replica_id,omitempty"`
	Replicas         []*WALReplicaAssignment `protobuf:"bytes,8,rep,name=replicas,proto3" json:"replicas,omitempty"`
}
...
func (x *PChannelMeta) GetPrimaryReplicaId() int64 {
	if x != nil {
...
func (x *PChannelMeta) GetNextReplicaId() int64 {
	if x != nil {
...
func (x *PChannelMeta) GetReplicas() []*WALReplicaAssignment {
	if x != nil {
		return x.Replicas
	}
	return nil
...
type ReportAssignmentErrorRequest struct {
	...
	WalReplicaId    int64           `protobuf:"varint,3,opt,name=wal_replica_id,json=walReplicaId,proto3" json:"wal_replica_id,omitempty"`        // WAL replica that reported the error. Zero is a valid replica ID.
	AssignmentEpoch int64           `protobuf:"varint,4,opt,name=assignment_epoch,json=assignmentEpoch,proto3" json:"assignment_epoch,omitempty"` // WAL replica assignment epoch, used to ignore stale reports.
}
...
func (x *ReportAssignmentErrorRequest) GetWalReplicaId() int64 {
	if x != nil {
		return x.WalReplicaId
	}
	return 0
}

func (x *ReportAssignmentErrorRequest) GetAssignmentEpoch() int64 {
	if x != nil {
		return x.AssignmentEpoch
	}
	return 0
...
type StreamingNodeAssignment struct {
	...
	WalReplicas []*WALReplicaInfo  `protobuf:"bytes,5,rep,name=wal_replicas,json=walReplicas,proto3" json:"wal_replicas,omitempty"`
}
...
func (x *StreamingNodeAssignment) GetWalReplicas() []*WALReplicaInfo {
	if x != nil {
		return x.WalReplicas
	}
	return nil
}

// WALReplicaInfo is the explicit assignment discovery projection for one WAL replica.
type WALReplicaInfo struct {
	...
	WalReplicaId      int64              `protobuf:"varint,2,opt,name=wal_replica_id,json=walReplicaId,proto3" json:"wal_replica_id,omitempty"`
	...
	ResourceGroup     string             `protobuf:"bytes,4,opt,name=resource_group,json=resourceGroup,proto3" json:"resource_group,omitempty"`
	PchannelWriteTerm int64              `protobuf:"varint,5,opt,name=pchannel_write_term,json=pchannelWriteTerm,proto3" json:"pchannel_write_term,omitempty"`
	State             PChannelMetaState  `protobuf:"varint,6,opt,name=state,proto3,enum=milvus.proto.streaming.PChannelMetaState" json:"state,omitempty"`
	AssignmentEpoch   int64              `protobuf:"varint,7,opt,name=assignment_epoch,json=assignmentEpoch,proto3" json:"assignment_epoch,omitempty"`
}

func (x *WALReplicaInfo) Reset() {
	*x = WALReplicaInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *WALReplicaInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WALReplicaInfo) ProtoMessage() {}

func (x *WALReplicaInfo) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WALReplicaInfo.ProtoReflect.Descriptor instead.
func (*WALReplicaInfo) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{29}
}

func (x *WALReplicaInfo) GetPchannel() string {
	if x != nil {
		return x.Pchannel
	}
	return ""
...
func (x *WALReplicaInfo) GetWalReplicaId() int64 {
	if x != nil {
		return x.WalReplicaId
	}
	return 0
...
func (x *WALReplicaInfo) GetAccessMode() PChannelAccessMode {
	if x != nil {
		return x.AccessMode
	}
	return PChannelAccessMode_PCHANNEL_ACCESS_READWRITE
...
func (x *WALReplicaInfo) GetResourceGroup() string {
	if x != nil {
		return x.ResourceGroup
	}
	return ""
...
func (x *WALReplicaInfo) GetPchannelWriteTerm() int64 {
	if x != nil {
		return x.PchannelWriteTerm
	}
	return 0
}

func (x *WALReplicaInfo) GetState() PChannelMetaState {
	if x != nil {
		return x.State
	}
	return PChannelMetaState_PCHANNEL_META_STATE_UNKNOWN
...
func (x *WALReplicaInfo) GetAssignmentEpoch() int64 {
	if x != nil {
		return x.AssignmentEpoch
	}
	return 0
...
func (x *StreamingNodeManagerAssignRequest) GetWalReplicaId() int64 {
	if x != nil {
		return x.WalReplicaId
	}
	return 0
...
func (x *StreamingNodeManagerAssignRequest) GetAssignmentEpoch() int64 {
	if x != nil {
		return x.AssignmentEpoch
	}
	return 0
...
func (x *StreamingNodeManagerRemoveRequest) GetWalReplicaId() int64 {
	if x != nil {
		return x.WalReplicaId
	}
	return 0
...
func (x *StreamingNodeManagerRemoveRequest) GetAssignmentEpoch() int64 {
	if x != nil {
		return x.AssignmentEpoch
	}
	return 0
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x73, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0xe2, 0x01, 0x0a, 0x15, 0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e,
	...
	,
	...
	0x70, 0x12, 0x4a, 0x0a, 0x0b, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x6e, 0x6f, 0x64, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e,
	...
	0x6f, 0x52, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x4a, 0x0a,
	0x0b, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01,
	...
	,
	...
	0x74, 0x61, 0x6d, 0x70, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x70,
	0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x5f, 0x69,
	0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79,
	0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x6e, 0x65, 0x78,
	0x74, 0x5f, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0d, 0x6e, 0x65, 0x78, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49,
	0x64, 0x12, 0x48, 0x0a, 0x08, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x18, 0x08, 0x20,
	...
	0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e,
	0x74, 0x52, 0x08, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x22, 0x2a, 0x0a, 0x0c, 0x43,
	...
	0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0xeb, 0x01, 0x0a, 0x1c, 0x52, 0x65, 0x70,
	...
	0x52, 0x03, 0x65, 0x72, 0x72, 0x12, 0x24, 0x0a, 0x0e, 0x77, 0x61, 0x6c, 0x5f, 0x72, 0x65, 0x70,
	0x6c, 0x69, 0x63, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x77,
	0x61, 0x6c, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x61,
	0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e,
	0x74, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x20, 0x0a, 0x1e, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x41,
	...
	0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xe5, 0x01, 0x0a, 0x17, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65, 0x41, 0x73, 0x73, 0x69, 0x67,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0xb6, 0x01, 0x0a, 0x21, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67,
	...
	0x52, 0x08, 0x70, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x24, 0x0a, 0x0e, 0x77, 0x61,
	0x6c, 0x5f, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0c, 0x77, 0x61, 0x6c, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64,
	0x12, 0x29, 0x0a, 0x10, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x65,
	0x70, 0x6f, 0x63, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x61, 0x73, 0x73, 0x69,
	0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x24, 0x0a, 0x22, 0x53,
	...
	0x65, 0x22, 0xb6, 0x01, 0x0a, 0x21, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e,
	...
	0x08, 0x70, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x24, 0x0a, 0x0e, 0x77, 0x61, 0x6c,
	0x5f, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x0c, 0x77, 0x61, 0x6c, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64, 0x12,
	0x29, 0x0a, 0x10, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x65, 0x70,
	0x6f, 0x63, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x61, 0x73, 0x73, 0x69, 0x67,
	0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x24, 0x0a, 0x22, 0x53, 0x74,
	...
	0x4c, 0x59, 0x10, 0x01, 0x2a, 0xe7, 0x01, 0x0a, 0x11, 0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65,
	...
	0x41, 0x54, 0x45, 0x5f, 0x44, 0x52, 0x4f, 0x50, 0x50, 0x49, 0x4e, 0x47, 0x10, 0x05, 0x2a, 0xe7,
...
var file_streaming_proto_msgTypes = make([]protoimpl.MessageInfo, 85)
var file_streaming_proto_goTypes = []interface{}{
	...
	(*WALReplicaAssignment)(nil),                      // 11: milvus.proto.streaming.WALReplicaAssignment
	...
	(*WALReplicaInfo)(nil),                            // 38: milvus.proto.streaming.WALReplicaInfo
	...
	(*SegmentAssignmentStat)(nil),                     // 87: milvus.proto.streaming.SegmentAssignmentStat
	(*WALCheckpoint)(nil),                             // 88: milvus.proto.streaming.WALCheckpoint
	(*AlterWALState)(nil),                             // 89: milvus.proto.streaming.AlterWALState
	(*ReplicateConfigurationMeta)(nil),                // 90: milvus.proto.streaming.ReplicateConfigurationMeta
	(*ReplicatePChannelMeta)(nil),                     // 91: milvus.proto.streaming.ReplicatePChannelMeta
	nil,                                               // 92: milvus.proto.streaming.BroadcastResponse.ResultsEntry
	nil,                                               // 93: milvus.proto.streaming.AlterWALState.ConfigsEntry
	(*messagespb.Message)(nil),                        // 94: milvus.proto.messages.Message
	(*commonpb.MessageID)(nil),                        // 95: milvus.proto.common.MessageID
	(*commonpb.ImmutableMessage)(nil),                 // 96: milvus.proto.common.ImmutableMessage
	(*commonpb.ReplicateConfiguration)(nil),           // 97: milvus.proto.common.ReplicateConfiguration
	(*fieldmaskpb.FieldMask)(nil),                     // 98: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                             // 99: google.protobuf.Empty
	(messagespb.MessageType)(0),                       // 100: milvus.proto.messages.MessageType
	(*commonpb.ReplicateCheckpoint)(nil),              // 101: milvus.proto.common.ReplicateCheckpoint
	(*messagespb.TxnContext)(nil),                     // 102: milvus.proto.messages.TxnContext
	(*anypb.Any)(nil),                                 // 103: google.protobuf.Any
	(*schemapb.CollectionSchema)(nil),                 // 104: milvus.proto.schema.CollectionSchema
	(datapb.SegmentLevel)(0),                          // 105: milvus.proto.data.SegmentLevel
	(commonpb.WALName)(0),                             // 106: milvus.proto.common.WALName
	(*commonpb.MilvusCluster)(nil),                    // 107: milvus.proto.common.MilvusCluster
	(*milvuspb.GetComponentStatesRequest)(nil),        // 108: milvus.proto.milvus.GetComponentStatesRequest
	(*milvuspb.ComponentStates)(nil),                  // 109: milvus.proto.milvus.ComponentStates
}
var file_streaming_proto_depIdxs = []int32{
	...
	0,   // 3: milvus.proto.streaming.WALReplicaAssignment.access_mode:type_name -> milvus.proto.streaming.PChannelAccessMode
	36,  // 4: milvus.proto.streaming.WALReplicaAssignment.active_node:type_name -> milvus.proto.streaming.StreamingNodeInfo
	36,  // 5: milvus.proto.streaming.WALReplicaAssignment.target_node:type_name -> milvus.proto.streaming.StreamingNodeInfo
	1,   // 6: milvus.proto.streaming.WALReplicaAssignment.state:type_name -> milvus.proto.streaming.PChannelMetaState
	10,  // 7: milvus.proto.streaming.WALReplicaAssignment.histories:type_name -> milvus.proto.streaming.PChannelAssignmentLog
	9,   // 8: milvus.proto.streaming.PChannelMeta.channel:type_name -> milvus.proto.streaming.PChannelInfo
	36,  // 9: milvus.proto.streaming.PChannelMeta.node:type_name -> milvus.proto.streaming.StreamingNodeInfo
	1,   // 10: milvus.proto.streaming.PChannelMeta.state:type_name -> milvus.proto.streaming.PChannelMetaState
	10,  // 11: milvus.proto.streaming.PChannelMeta.histories:type_name -> milvus.proto.streaming.PChannelAssignmentLog
	11,  // 12: milvus.proto.streaming.PChannelMeta.replicas:type_name -> milvus.proto.streaming.WALReplicaAssignment
	94,  // 13: milvus.proto.streaming.BroadcastTask.message:type_name -> milvus.proto.messages.Message
	2,   // 14: milvus.proto.streaming.BroadcastTask.state:type_name -> milvus.proto.streaming.BroadcastTaskState
	18,  // 15: milvus.proto.streaming.BroadcastTask.acked_checkpoints:type_name -> milvus.proto.streaming.AckedCheckpoint
	18,  // 16: milvus.proto.streaming.AckedResult.acked_checkpoints:type_name -> milvus.proto.streaming.AckedCheckpoint
	95,  // 17: milvus.proto.streaming.AckedCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	95,  // 18: milvus.proto.streaming.AckedCheckpoint.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	94,  // 19: milvus.proto.streaming.BroadcastRequest.message:type_name -> milvus.proto.messages.Message
	92,  // 20: milvus.proto.streaming.BroadcastResponse.results:type_name -> milvus.proto.streaming.BroadcastResponse.ResultsEntry
	96,  // 21: milvus.proto.streaming.BroadcastAckRequest.message:type_name -> milvus.proto.common.ImmutableMessage
	97,  // 22: milvus.proto.streaming.UpdateReplicateConfigurationRequest.configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	26,  // 23: milvus.proto.streaming.UpdateWALBalancePolicyRequest.config:type_name -> milvus.proto.streaming.WALBalancePolicyConfig
	27,  // 24: milvus.proto.streaming.UpdateWALBalancePolicyRequest.nodes:type_name -> milvus.proto.streaming.WALBalancePolicyNodes
	98,  // 25: milvus.proto.streaming.UpdateWALBalancePolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	26,  // 26: milvus.proto.streaming.UpdateWALBalancePolicyResponse.config:type_name -> milvus.proto.streaming.WALBalancePolicyConfig
	30,  // 27: milvus.proto.streaming.AssignmentDiscoverRequest.report_error:type_name -> milvus.proto.streaming.ReportAssignmentErrorRequest
	31,  // 28: milvus.proto.streaming.AssignmentDiscoverRequest.close:type_name -> milvus.proto.streaming.CloseAssignmentDiscoverRequest
	9,   // 29: milvus.proto.streaming.ReportAssignmentErrorRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	44,  // 30: milvus.proto.streaming.ReportAssignmentErrorRequest.err:type_name -> milvus.proto.streaming.StreamingError
	33,  // 31: milvus.proto.streaming.AssignmentDiscoverResponse.full_assignment:type_name -> milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion
	35,  // 32: milvus.proto.streaming.AssignmentDiscoverResponse.close:type_name -> milvus.proto.streaming.CloseAssignmentDiscoverResponse
	15,  // 33: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.version:type_name -> milvus.proto.streaming.VersionPair
	37,  // 34: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.assignments:type_name -> milvus.proto.streaming.StreamingNodeAssignment
	34,  // 35: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.cchannel:type_name -> milvus.proto.streaming.CChannelAssignment
	97,  // 36: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	14,  // 37: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.streaming_version:type_name -> milvus.proto.streaming.StreamingVersion
	15,  // 38: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.version_by_revision:type_name -> milvus.proto.streaming.VersionPair
	13,  // 39: milvus.proto.streaming.CChannelAssignment.meta:type_name -> milvus.proto.streaming.CChannelMeta
	36,  // 40: milvus.proto.streaming.StreamingNodeAssignment.node:type_name -> milvus.proto.streaming.StreamingNodeInfo
	9,   // 41: milvus.proto.streaming.StreamingNodeAssignment.channels:type_name -> milvus.proto.streaming.PChannelInfo
	38,  // 42: milvus.proto.streaming.StreamingNodeAssignment.wal_replicas:type_name -> milvus.proto.streaming.WALReplicaInfo
	0,   // 43: milvus.proto.streaming.WALReplicaInfo.access_mode:type_name -> milvus.proto.streaming.PChannelAccessMode
	1,   // 44: milvus.proto.streaming.WALReplicaInfo.state:type_name -> milvus.proto.streaming.PChannelMetaState
	99,  // 45: milvus.proto.streaming.DeliverPolicy.all:type_name -> google.protobuf.Empty
	99,  // 46: milvus.proto.streaming.DeliverPolicy.latest:type_name -> google.protobuf.Empty
	95,  // 47: milvus.proto.streaming.DeliverPolicy.start_from:type_name -> milvus.proto.common.MessageID
	95,  // 48: milvus.proto.streaming.DeliverPolicy.start_after:type_name -> milvus.proto.common.MessageID
	41,  // 49: milvus.proto.streaming.DeliverFilter.time_tick_gt:type_name -> milvus.proto.streaming.DeliverFilterTimeTickGT
	42,  // 50: milvus.proto.streaming.DeliverFilter.time_tick_gte:type_name -> milvus.proto.streaming.DeliverFilterTimeTickGTE
	43,  // 51: milvus.proto.streaming.DeliverFilter.message_type:type_name -> milvus.proto.streaming.DeliverFilterMessageType
	100, // 52: milvus.proto.streaming.DeliverFilterMessageType.message_types:type_name -> milvus.proto.messages.MessageType
	3,   // 53: milvus.proto.streaming.StreamingError.code:type_name -> milvus.proto.streaming.StreamingCode
	9,   // 54: milvus.proto.streaming.GetReplicateCheckpointRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	101, // 55: milvus.proto.streaming.GetReplicateCheckpointResponse.checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	9,   // 56: milvus.proto.streaming.GetSalvageCheckpointRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	101, // 57: milvus.proto.streaming.GetSalvageCheckpointResponse.checkpoints:type_name -> milvus.proto.common.ReplicateCheckpoint
	51,  // 58: milvus.proto.streaming.ProduceRequest.produce:type_name -> milvus.proto.streaming.ProduceMessageRequest
	52,  // 59: milvus.proto.streaming.ProduceRequest.close:type_name -> milvus.proto.streaming.CloseProducerRequest
	9,   // 60: milvus.proto.streaming.CreateProducerRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	94,  // 61: milvus.proto.streaming.ProduceMessageRequest.message:type_name -> milvus.proto.messages.Message
	54,  // 62: milvus.proto.streaming.ProduceResponse.create:type_name -> milvus.proto.streaming.CreateProducerResponse
	55,  // 63: milvus.proto.streaming.ProduceResponse.produce:type_name -> milvus.proto.streaming.ProduceMessageResponse
	58,  // 64: milvus.proto.streaming.ProduceResponse.close:type_name -> milvus.proto.streaming.CloseProducerResponse
	56,  // 65: milvus.proto.streaming.ProduceResponse.rate_limit:type_name -> milvus.proto.streaming.ProduceRateLimitResponse
	57,  // 66: milvus.proto.streaming.ProduceMessageResponse.result:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	44,  // 67: milvus.proto.streaming.ProduceMessageResponse.error:type_name -> milvus.proto.streaming.StreamingError
	4,   // 68: milvus.proto.streaming.ProduceRateLimitResponse.state:type_name -> milvus.proto.streaming.WALRateLimitState
	95,  // 69: milvus.proto.streaming.ProduceMessageResponseResult.id:type_name -> milvus.proto.common.MessageID
	102, // 70: milvus.proto.streaming.ProduceMessageResponseResult.txnContext:type_name -> milvus.proto.messages.TxnContext
	103, // 71: milvus.proto.streaming.ProduceMessageResponseResult.extra:type_name -> google.protobuf.Any
	95,  // 72: milvus.proto.streaming.ProduceMessageResponseResult.last_confirmed_id:type_name -> milvus.proto.common.MessageID
	63,  // 73: milvus.proto.streaming.ConsumeRequest.create_vchannel_consumer:type_name -> milvus.proto.streaming.CreateVChannelConsumerRequest
	62,  // 74: milvus.proto.streaming.ConsumeRequest.create_vchannel_consumers:type_name -> milvus.proto.streaming.CreateVChannelConsumersRequest
	66,  // 75: milvus.proto.streaming.ConsumeRequest.close_vchannel:type_name -> milvus.proto.streaming.CloseVChannelConsumerRequest
	60,  // 76: milvus.proto.streaming.ConsumeRequest.close:type_name -> milvus.proto.streaming.CloseConsumerRequest
	9,   // 77: milvus.proto.streaming.CreateConsumerRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	63,  // 78: milvus.proto.streaming.CreateVChannelConsumersRequest.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumerRequest
	39,  // 79: milvus.proto.streaming.CreateVChannelConsumerRequest.deliver_policy:type_name -> milvus.proto.streaming.DeliverPolicy
	40,  // 80: milvus.proto.streaming.CreateVChannelConsumerRequest.deliver_filters:type_name -> milvus.proto.streaming.DeliverFilter
	65,  // 81: milvus.proto.streaming.CreateVChannelConsumersResponse.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumerResponse
	44,  // 82: milvus.proto.streaming.CreateVChannelConsumerResponse.error:type_name -> milvus.proto.streaming.StreamingError
	69,  // 83: milvus.proto.streaming.ConsumeResponse.create:type_name -> milvus.proto.streaming.CreateConsumerResponse
	70,  // 84: milvus.proto.streaming.ConsumeResponse.consume:type_name -> milvus.proto.streaming.ConsumeMessageReponse
	65,  // 85: milvus.proto.streaming.ConsumeResponse.create_vchannel:type_name -> milvus.proto.streaming.CreateVChannelConsumerResponse
	64,  // 86: milvus.proto.streaming.ConsumeResponse.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumersResponse
	67,  // 87: milvus.proto.streaming.ConsumeResponse.close_vchannel:type_name -> milvus.proto.streaming.CloseVChannelConsumerResponse
	71,  // 88: milvus.proto.streaming.ConsumeResponse.close:type_name -> milvus.proto.streaming.CloseConsumerResponse
	96,  // 89: milvus.proto.streaming.ConsumeMessageReponse.message:type_name -> milvus.proto.common.ImmutableMessage
	9,   // 90: milvus.proto.streaming.StreamingNodeManagerAssignRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	9,   // 91: milvus.proto.streaming.StreamingNodeManagerRemoveRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	78,  // 92: milvus.proto.streaming.StreamingNodeMetrics.wals:type_name -> milvus.proto.streaming.StreamingNodeWALMetrics
	9,   // 93: milvus.proto.streaming.StreamingNodeWALMetrics.info:type_name -> milvus.proto.streaming.PChannelInfo
	79,  // 94: milvus.proto.streaming.StreamingNodeWALMetrics.rw:type_name -> milvus.proto.streaming.StreamingNodeRWWALMetrics
	80,  // 95: milvus.proto.streaming.StreamingNodeWALMetrics.ro:type_name -> milvus.proto.streaming.StreamingNodeROWALMetrics
	77,  // 96: milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse.metrics:type_name -> milvus.proto.streaming.StreamingNodeMetrics
	5,   // 97: milvus.proto.streaming.VChannelMeta.state:type_name -> milvus.proto.streaming.VChannelState
	83,  // 98: milvus.proto.streaming.VChannelMeta.collection_info:type_name -> milvus.proto.streaming.CollectionInfoOfVChannel
	85,  // 99: milvus.proto.streaming.CollectionInfoOfVChannel.partitions:type_name -> milvus.proto.streaming.PartitionInfoOfVChannel
	84,  // 100: milvus.proto.streaming.CollectionInfoOfVChannel.schemas:type_name -> milvus.proto.streaming.CollectionSchemaOfVChannel
	104, // 101: milvus.proto.streaming.CollectionSchemaOfVChannel.schema:type_name -> milvus.proto.schema.CollectionSchema
	6,   // 102: milvus.proto.streaming.CollectionSchemaOfVChannel.state:type_name -> milvus.proto.streaming.VChannelSchemaState
	7,   // 103: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	87,  // 104: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	105, // 105: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	95,  // 106: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	97,  // 107: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	101, // 108: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	89,  // 109: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	106, // 110: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	93,  // 111: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	8,   // 112: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	97,  // 113: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	17,  // 114: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	107, // 115: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	101, // 116: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	57,  // 117: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	108, // 118: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	19,  // 119: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	21,  // 120: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	23,  // 121: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	25,  // 122: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	29,  // 123: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	45,  // 124: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	47,  // 125: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:input_type -> milvus.proto.streaming.GetSalvageCheckpointRequest
	49,  // 126: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	59,  // 127: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	72,  // 128: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	74,  // 129: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	76,  // 130: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	109, // 131: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	20,  // 132: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	22,  // 133: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	24,  // 134: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	28,  // 135: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	32,  // 136: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	46,  // 137: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	48,  // 138: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:output_type -> milvus.proto.streaming.GetSalvageCheckpointResponse
	53,  // 139: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	68,  // 140: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	73,  // 141: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	75,  // 142: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	81,  // 143: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
...
func file_streaming_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streaming_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WALReplicaAssignment); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_streaming_proto_msgTypes[20].OneofWrappers = []interface{}{
