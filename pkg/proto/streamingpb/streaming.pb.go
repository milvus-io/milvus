...
type CommittedWriteRecord struct {
	...
	// The rows the write produced, in the shape they are handed back in: the
	// same IdempotentInsertResult a duplicate append returns. Storing the result
	// itself rather than a per-row projection keeps one representation of the
	// rows end to end, and its columnar packed encoding is more compact than a
	// sub-message per row.
	IdempotentResult *messagespb.IdempotentInsertResult `protobuf:"bytes,5,opt,name=idempotent_result,json=idempotentResult,proto3" json:"idempotent_result,omitempty"`
...
func (x *CommittedWriteRecord) GetIdempotentResult() *messagespb.IdempotentInsertResult {
	if x != nil {
		return x.IdempotentResult
	}
	return nil
...
//
// It carries records and nothing else today. It is kept as its own message
// because block-level information — a key range, a filter, whatever lets a
// reader skip the entire block without decoding it — belongs here when it
// arrives.
//
// What it must not grow is a self-describing header. The footer index above
// already names the vchannel and records this payload's offset, length,
// checksum, record count and timetick range, and the payload is never decoded
// without that index in hand and its checksum verified, so a pchannel,
// vchannel, generation or codec version here could only repeat what the reader
// already holds and has already proven.
type VChannelSummaryChunk struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Records []*CommittedWriteRecord `protobuf:"bytes,1,rep,name=records,proto3" json:"records,omitempty"`
}
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x78, 0x52, 0x06, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x22, 0xb0, 0x03, 0x0a, 0x14,
	0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x64, 0x57, 0x72, 0x69, 0x74, 0x65, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x70,
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x4a, 0x0a,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x96, 0x03,
	...
	0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0xb9, 0x02, 0x0a, 0x0d, 0x41, 0x6c, 0x74, 0x65, 0x72,
	...
	0x43, 0x54, 0x10, 0x03, 0x2a, 0x62, 0x0a, 0x0d, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
	...
	0x52, 0x4f, 0x50, 0x50, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x7d, 0x0a, 0x13, 0x56, 0x43, 0x68, 0x61,
	...
	0x4f, 0x50, 0x50, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x8a, 0x01, 0x0a, 0x16, 0x53, 0x65, 0x67, 0x6d,
	...
	0x45, 0x44, 0x10, 0x02, 0x2a, 0x3f, 0x0a, 0x0d, 0x41, 0x6c, 0x74, 0x65, 0x72, 0x57, 0x41, 0x4c,
...
var file_streaming_proto_msgTypes = make([]protoimpl.MessageInfo, 93)
var file_streaming_proto_goTypes = []interface{}{
	...
	(*CommittedWriteRecord)(nil),                      // 92: milvus.proto.streaming.CommittedWriteRecord
	(*VChannelSummaryChunk)(nil),                      // 93: milvus.proto.streaming.VChannelSummaryChunk
	(*SegmentAssignmentMeta)(nil),                     // 94: milvus.proto.streaming.SegmentAssignmentMeta
	(*SegmentAssignmentStat)(nil),                     // 95: milvus.proto.streaming.SegmentAssignmentStat
	(*WALCheckpoint)(nil),                             // 96: milvus.proto.streaming.WALCheckpoint
	...
	(*schemapb.CollectionSchema)(nil),                 // 112: milvus.proto.schema.CollectionSchema
	(*messagespb.IdempotentInsertResult)(nil),         // 113: milvus.proto.messages.IdempotentInsertResult
	(datapb.SegmentLevel)(0),                          // 114: milvus.proto.data.SegmentLevel
	(commonpb.WALName)(0),                             // 115: milvus.proto.common.WALName
	(*commonpb.MilvusCluster)(nil),                    // 116: milvus.proto.common.MilvusCluster
	(*milvuspb.GetComponentStatesRequest)(nil),        // 117: milvus.proto.milvus.GetComponentStatesRequest
	(*milvuspb.ComponentStates)(nil),                  // 118: milvus.proto.milvus.ComponentStates
}
var file_streaming_proto_depIdxs = []int32{
	...
	102, // 7: milvus.proto.streaming.BroadcastTask.message:type_name -> milvus.proto.messages.Message
	...
	103, // 11: milvus.proto.streaming.AckedCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	103, // 12: milvus.proto.streaming.AckedCheckpoint.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	102, // 13: milvus.proto.streaming.BroadcastRequest.message:type_name -> milvus.proto.messages.Message
	100, // 14: milvus.proto.streaming.BroadcastResponse.results:type_name -> milvus.proto.streaming.BroadcastResponse.ResultsEntry
	104, // 15: milvus.proto.streaming.BroadcastAckRequest.message:type_name -> milvus.proto.common.ImmutableMessage
	105, // 16: milvus.proto.streaming.UpdateReplicateConfigurationRequest.configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	106, // 19: milvus.proto.streaming.UpdateWALBalancePolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	105, // 30: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	107, // 36: milvus.proto.streaming.DeliverPolicy.all:type_name -> google.protobuf.Empty
	107, // 37: milvus.proto.streaming.DeliverPolicy.latest:type_name -> google.protobuf.Empty
	103, // 38: milvus.proto.streaming.DeliverPolicy.start_from:type_name -> milvus.proto.common.MessageID
	103, // 39: milvus.proto.streaming.DeliverPolicy.start_after:type_name -> milvus.proto.common.MessageID
	...
	108, // 43: milvus.proto.streaming.DeliverFilterMessageType.message_types:type_name -> milvus.proto.messages.MessageType
	...
	109, // 46: milvus.proto.streaming.GetReplicateCheckpointResponse.checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	9,   // 47: milvus.proto.streaming.GetSalvageCheckpointRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	109, // 48: milvus.proto.streaming.GetSalvageCheckpointResponse.checkpoints:type_name -> milvus.proto.common.ReplicateCheckpoint
	...
	102, // 52: milvus.proto.streaming.ProduceMessageRequest.message:type_name -> milvus.proto.messages.Message
	...
	103, // 60: milvus.proto.streaming.ProduceMessageResponseResult.id:type_name -> milvus.proto.common.MessageID
	110, // 61: milvus.proto.streaming.ProduceMessageResponseResult.txnContext:type_name -> milvus.proto.messages.TxnContext
	111, // 62: milvus.proto.streaming.ProduceMessageResponseResult.extra:type_name -> google.protobuf.Any
	103, // 63: milvus.proto.streaming.ProduceMessageResponseResult.last_confirmed_id:type_name -> milvus.proto.common.MessageID
	...
	104, // 80: milvus.proto.streaming.ConsumeMessageReponse.message:type_name -> milvus.proto.common.ImmutableMessage
	...
	112, // 92: milvus.proto.streaming.CollectionSchemaOfVChannel.schema:type_name -> milvus.proto.schema.CollectionSchema
	...
	103, // 95: milvus.proto.streaming.PChannelSummaryMeta.source_checkpoint_message_id:type_name -> milvus.proto.common.MessageID
	...
	103, // 97: milvus.proto.streaming.SummaryEntry.message_id:type_name -> milvus.proto.common.MessageID
	103, // 98: milvus.proto.streaming.SummaryEntry.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	113, // 99: milvus.proto.streaming.SummaryEntry.idempotent_result:type_name -> milvus.proto.messages.IdempotentInsertResult
	88,  // 100: milvus.proto.streaming.SummarySnapshot.entries:type_name -> milvus.proto.streaming.SummaryEntry
	103, // 101: milvus.proto.streaming.PChannelSummaryChunkFooter.source_checkpoint_message_id:type_name -> milvus.proto.common.MessageID
	...
	103, // 103: milvus.proto.streaming.CommittedWriteRecord.source_message_id:type_name -> milvus.proto.common.MessageID
	113, // 104: milvus.proto.streaming.CommittedWriteRecord.idempotent_result:type_name -> milvus.proto.messages.IdempotentInsertResult
	103, // 105: milvus.proto.streaming.CommittedWriteRecord.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	92,  // 106: milvus.proto.streaming.VChannelSummaryChunk.records:type_name -> milvus.proto.streaming.CommittedWriteRecord
	7,   // 107: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	95,  // 108: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	114, // 109: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	103, // 110: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	105, // 111: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	109, // 112: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	97,  // 113: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	115, // 114: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	101, // 115: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	8,   // 116: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	105, // 117: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	16,  // 118: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	116, // 119: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	109, // 120: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	...
	117, // 122: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	...
	118, // 135: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
