...
//
// There is no persist watermark anywhere in this design. A summary chunk is
// written synchronously before the WAL consume checkpoint that covers it is
// persisted, so the two are aligned by construction: everything below the WAL
// checkpoint is already in a chunk, everything above it is still in the WAL.
// Recording a second position would only create something that can disagree.
//
// The term exists to give recovery a floor when it probes for the newest
// manifest, so a pchannel with a large assignment term but no store does not
// pay one probe per term.
...
// PChannelSummaryChunkIndexEntry describes one chunk. It mirrors that chunk's
// footer index into the manifest, which is what lets a consumer locate its own
// vchannel inside a chunk without opening the chunk, and what lets the retention
// boundary be computed per vchannel without any read at all.
type PChannelSummaryChunkIndexEntry struct {
	...
	// The chunk footer's per-vchannel index, copied verbatim.
	Vchannels []*VChannelSummaryChunkIndex `protobuf:"bytes,5,rep,name=vchannels,proto3" json:"vchannels,omitempty"`
}
...
// PChannelSummaryChunkRef is the minimum needed to address a chunk object:
// generation and term together build its key. Nothing else is carried, because
// gc needs nothing else.
...
// PChannelSummaryChunkFooter is the chunk object's index. A reader reads it
...
type PChannelSummaryChunkFooter struct {
	...
	//
	// No checkpoint is recorded here. A chunk is written synchronously before the
	// WAL consume checkpoint that covers it is persisted, so that checkpoint is
	// already the boundary between what a chunk holds and what the WAL holds; a
	// second position stored here could only ever disagree with it.
...
// VChannelSummaryChunkIndex locates one vchannel's sections inside the chunk
// object. A section absent from here was never written for this vchannel.
type VChannelSummaryChunkIndex struct {
	...
	Inserts     *VChannelSummarySectionRef `protobuf:"bytes,5,opt,name=inserts,proto3" json:"inserts,omitempty"` // 6 is reserved for the delete section.
}
...
// VChannelSummarySectionRef locates one section: where it starts, how long it
// is, and how many records it holds.
//
// No checksum. The object store already guarantees the bytes a read returns are
// the bytes that were written, so a checksum here would only re-verify that. The
// failure this format does have to catch is OUR OWN mislocation -- an offset or
// length computed wrong -- and that is caught without one, because a decode of
// the wrong bytes fails to parse or yields a record count that disagrees with
// the one stored here. The footer keeps its checksum, because every offset in
// the object derives from it and a silently wrong footer would send every read
// to the wrong place.
...
type VChannelSummaryInsertRecord struct {
	...
	// The primary keys this vchannel took from the insert. No last-confirmed
	// position is recorded: the only reader is a duplicate append, whose response
	// is not a resumable read position.
	Ids *schemapb.IDs `protobuf:"bytes,3,opt,name=ids,proto3" json:"ids,omitempty"`
}
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x22, 0x45, 0x0a, 0x13, 0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x6d, 0x6d,
	0x61, 0x72, 0x79, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x63, 0x68, 0x61, 0x6e,
	0x6e, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x63, 0x68, 0x61, 0x6e,
	0x6e, 0x65, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x22, 0xb9, 0x01, 0x0a, 0x17, 0x50, 0x43, 0x68, 0x61,
	0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x4d, 0x61, 0x6e, 0x69, 0x66,
	0x65, 0x73, 0x74, 0x12, 0x4e, 0x0a, 0x06, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x18, 0x01, 0x20,
	...
	,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x12, 0x25, 0x0a, 0x0e, 0x73, 0x74,
	0x61, 0x72, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x74, 0x69, 0x63, 0x6b, 0x18, 0x03, 0x20, 0x01,
	...
	0x6b, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65,
	0x74, 0x69, 0x63, 0x6b, 0x12, 0x4f, 0x0a, 0x09, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
	0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67,
	...
	0x52, 0x06, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x22, 0xa3, 0x02, 0x0a, 0x19, 0x56, 0x43, 0x68,
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x43, 0x68, 0x75, 0x6e,
	...
	0x6f, 0x6e, 0x52, 0x65, 0x66, 0x52, 0x07, 0x69, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x73, 0x22, 0x6e,
	0x0a, 0x19, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72,
	0x79, 0x53, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x66, 0x12, 0x16, 0x0a, 0x06, 0x6f,
	...
	0x01, 0x28, 0x04, 0x52, 0x06, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x21, 0x0a, 0x0c, 0x72,
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x0b, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x77,
	...
	0x63, 0x6f, 0x72, 0x64, 0x52, 0x07, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x22, 0xbe, 0x01,
	...
	0x63, 0x6b, 0x12, 0x2a, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x18, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73,
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x49, 0x44, 0x73, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xfe,
...
var file_streaming_proto_goTypes = []interface{}{
	...
	(*PChannelSummaryMeta)(nil),                       // 84: milvus.proto.streaming.PChannelSummaryMeta
	(*PChannelSummaryManifest)(nil),                   // 85: milvus.proto.streaming.PChannelSummaryManifest
	(*PChannelSummaryChunkIndexEntry)(nil),            // 86: milvus.proto.streaming.PChannelSummaryChunkIndexEntry
	(*PChannelSummaryChunkRef)(nil),                   // 87: milvus.proto.streaming.PChannelSummaryChunkRef
	(*PChannelSummaryChunkFooter)(nil),                // 88: milvus.proto.streaming.PChannelSummaryChunkFooter
	(*VChannelSummaryChunkIndex)(nil),                 // 89: milvus.proto.streaming.VChannelSummaryChunkIndex
	(*VChannelSummarySectionRef)(nil),                 // 90: milvus.proto.streaming.VChannelSummarySectionRef
	(*VChannelSummaryIdempotencySection)(nil),         // 91: milvus.proto.streaming.VChannelSummaryIdempotencySection
	(*VChannelSummaryIdempotencyRecord)(nil),          // 92: milvus.proto.streaming.VChannelSummaryIdempotencyRecord
	(*VChannelSummaryInsertSection)(nil),              // 93: milvus.proto.streaming.VChannelSummaryInsertSection
	(*VChannelSummaryInsertRecord)(nil),               // 94: milvus.proto.streaming.VChannelSummaryInsertRecord
	...
	(*schemapb.IDs)(nil),                              // 114: milvus.proto.schema.IDs
...
var file_streaming_proto_depIdxs = []int32{
	...
	86,  // 94: milvus.proto.streaming.PChannelSummaryManifest.chunks:type_name -> milvus.proto.streaming.PChannelSummaryChunkIndexEntry
	87,  // 95: milvus.proto.streaming.PChannelSummaryManifest.pending_gc:type_name -> milvus.proto.streaming.PChannelSummaryChunkRef
	89,  // 96: milvus.proto.streaming.PChannelSummaryChunkIndexEntry.vchannels:type_name -> milvus.proto.streaming.VChannelSummaryChunkIndex
	89,  // 97: milvus.proto.streaming.PChannelSummaryChunkFooter.chunks:type_name -> milvus.proto.streaming.VChannelSummaryChunkIndex
	90,  // 98: milvus.proto.streaming.VChannelSummaryChunkIndex.idempotency:type_name -> milvus.proto.streaming.VChannelSummarySectionRef
	90,  // 99: milvus.proto.streaming.VChannelSummaryChunkIndex.inserts:type_name -> milvus.proto.streaming.VChannelSummarySectionRef
	92,  // 100: milvus.proto.streaming.VChannelSummaryIdempotencySection.records:type_name -> milvus.proto.streaming.VChannelSummaryIdempotencyRecord
	94,  // 101: milvus.proto.streaming.VChannelSummaryInsertSection.records:type_name -> milvus.proto.streaming.VChannelSummaryInsertRecord
	104, // 102: milvus.proto.streaming.VChannelSummaryInsertRecord.source_message_id:type_name -> milvus.proto.common.MessageID
	114, // 103: milvus.proto.streaming.VChannelSummaryInsertRecord.ids:type_name -> milvus.proto.schema.IDs
	7,   // 104: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	96,  // 105: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	115, // 106: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	104, // 107: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	106, // 108: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	110, // 109: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	98,  // 110: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	116, // 111: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	102, // 112: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	8,   // 113: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	106, // 114: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	16,  // 115: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	117, // 116: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	110, // 117: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	55,  // 118: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	118, // 119: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	18,  // 120: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	20,  // 121: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	22,  // 122: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	24,  // 123: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	28,  // 124: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	43,  // 125: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	45,  // 126: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:input_type -> milvus.proto.streaming.GetSalvageCheckpointRequest
	47,  // 127: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	57,  // 128: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	70,  // 129: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	72,  // 130: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	74,  // 131: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	119, // 132: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	19,  // 133: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	21,  // 134: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	23,  // 135: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	27,  // 136: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	31,  // 137: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	44,  // 138: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	46,  // 139: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:output_type -> milvus.proto.streaming.GetSalvageCheckpointResponse
	51,  // 140: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	66,  // 141: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	71,  // 142: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	73,  // 143: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	79,  // 144: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	132, // [132:145] is the sub-list for method output_type
	119, // [119:132] is the sub-list for method input_type
