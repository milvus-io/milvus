...
// landed WAL message.
//
// It records no destination. Every record in a chunk shares one, so the vchannel
// is stored once on the chunk and the pchannel once on the footer; repeating
// them per record would cost two strings per row-batch to say what the container
// already says.
type CommittedWriteRecord struct {
	...
	// sub-message per row.
	IdempotentResult *messagespb.IdempotentInsertResult `protobuf:"bytes,3,opt,name=idempotent_result,json=idempotentResult,proto3" json:"idempotent_result,omitempty"`
	// Empty when the write carried no idempotency key.
	IdempotencyKey         string              `protobuf:"bytes,4,opt,name=idempotency_key,json=idempotencyKey,proto3" json:"idempotency_key,omitempty"`
	LastConfirmedMessageId *commonpb.MessageID `protobuf:"bytes,5,opt,name=last_confirmed_message_id,json=lastConfirmedMessageId,proto3" json:"last_confirmed_message_id,omitempty"`
}
...
//
// It is the block its records belong to, so it names the vchannel once here
// rather than on every record. Block-level information — a key range, a filter,
// whatever lets a reader skip the entire block without decoding it — belongs
// here too when it arrives.
//
// What it must not grow is a copy of what locates it. The footer index above
// records this payload's offset, length, checksum, record count and timetick
// range, and the payload is never decoded without that index in hand and its
// checksum verified, so a generation or codec version here could only repeat
// what the reader already holds and has already proven.
type VChannelSummaryChunk struct {
	...
	Vchannel string                  `protobuf:"bytes,1,opt,name=vchannel,proto3" json:"vchannel,omitempty"`
	Records  []*CommittedWriteRecord `protobuf:"bytes,2,rep,name=records,proto3" json:"records,omitempty"`
}
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x78, 0x52, 0x06, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x22, 0xeb, 0x02, 0x0a, 0x14,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x74, 0x69, 0x63, 0x6b, 0x12, 0x5a, 0x0a, 0x11, 0x69, 0x64, 0x65,
	0x6d, 0x70, 0x6f, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x03,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x69, 0x64, 0x65, 0x6d, 0x70, 0x6f, 0x74,
	0x65, 0x6e, 0x63, 0x79, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
	0x69, 0x64, 0x65, 0x6d, 0x70, 0x6f, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x4b, 0x65, 0x79, 0x12, 0x59,
	...
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x64, 0x22, 0x7a, 0x0a, 0x14, 0x56, 0x43, 0x68,
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x43, 0x68, 0x75, 0x6e,
	0x6b, 0x12, 0x1a, 0x0a, 0x08, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x46, 0x0a,
	0x07, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c,
	0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74,
