...
func file_streaming_proto_init() {
	...
	file_streaming_proto_msgTypes[38].OneofWrappers = []any{
	...
	file_streaming_proto_msgTypes[44].OneofWrappers = []any{
		(*ProduceMessageResponse_Result)(nil),
		(*ProduceMessageResponse_Error)(nil),
	}
	file_streaming_proto_msgTypes[48].OneofWrappers = []any{
	...
	file_streaming_proto_msgTypes[67].OneofWrappers = []any{
