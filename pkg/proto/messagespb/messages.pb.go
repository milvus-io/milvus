...
type ReplicateHeader struct {
	...
	MessageId *MessageID `protobuf:"bytes,2,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"` // the message id of replicate msg from source cluster
...
func (x *ReplicateHeader) GetMessageId() *MessageID {
	if x != nil {
		return x.MessageId
	}
	return nil
...
var file_messages_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4b, 0x65, 0x79, 0x73, 0x22, 0xaa, 0x01,
	...
	0x12, 0x3f, 0x0a, 0x0a, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02,
	...
	0x64, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x74, 0x69, 0x63, 0x6b, 0x18, 0x03,
	...
	0x52, 0x08, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x22, 0x5e, 0x0a, 0x0b, 0x52, 0x65,
...
var file_messages_proto_depIdxs = []int32{
	...
	42, // 6: milvus.proto.messages.CreateSegmentMessageHeader.level:type_name -> milvus.proto.data.SegmentLevel
	43, // 7: milvus.proto.messages.SchemaChangeMessageBody.schema:type_name -> milvus.proto.schema.CollectionSchema
	...
	3,  // 10: milvus.proto.messages.ReplicateHeader.message_id:type_name -> milvus.proto.messages.MessageID
