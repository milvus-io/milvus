...
// PartialUpdateCAS carries transaction-scoped commit-admission metadata from
// Proxy to StreamingNode.
type PartialUpdateCAS struct {
	...
	// primary_key_field_id identifies the PK column in each insert chunk.
	PrimaryKeyFieldId int64 `protobuf:"varint,3,opt,name=primary_key_field_id,json=primaryKeyFieldId,proto3" json:"primary_key_field_id,omitempty"`
	// collection_id scopes non-PK invalidation checks.
...
func (x *PartialUpdateCAS) GetPrimaryKeyFieldId() int64 {
	if x != nil {
		return x.PrimaryKeyFieldId
	}
	return 0
}

func (x *PartialUpdateCAS) GetCollectionId() int64 {
	if x != nil {
		return x.CollectionId
	}
	return 0
...
var file_messages_proto_rawDesc = []byte{
	...
	0x54, 0x79, 0x70, 0x65, 0x52, 0x07, 0x6d, 0x73, 0x67, 0x54, 0x79, 0x70, 0x65, 0x22, 0xb7, 0x01,
	...
	0x6d, 0x12, 0x2f, 0x0a, 0x14, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x6b, 0x65, 0x79,
	0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x11, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x4b, 0x65, 0x79, 0x46, 0x69, 0x65, 0x6c, 0x64,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x3b, 0x0a, 0x18, 0x4d, 0x61, 0x6e, 0x75, 0x61,
	...
	0x2a, 0xe3, 0x07, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65,
