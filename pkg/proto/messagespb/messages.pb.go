...
type CreateCollectionMessageHeader struct {
	...
	// Optional: Snapshot restore information
	// When restore_from_snapshot is true, the callback will also:
	// 1. Create user partitions from snapshot
	// 2. Create indexes from snapshot
	// 3. Trigger data restore job
	SnapshotName string `protobuf:"bytes,4,opt,name=snapshot_name,json=snapshotName,proto3" json:"snapshot_name,omitempty"`
	JobId        int64  `protobuf:"varint,5,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"` // Pre-allocated job ID for async restore tracking
	// Snapshot restore metadata (populated when restore_from_snapshot is true)
	// These fields avoid a second DescribeSnapshot RPC in the callback
	RestoreFromSnapshot   bool                 `protobuf:"varint,6,opt,name=restore_from_snapshot,json=restoreFromSnapshot,proto3" json:"restore_from_snapshot,omitempty"`                                                                                               // Explicitly mark this as a restore operation
	UserCreatedPartitions map[int64]string     `protobuf:"bytes,7,rep,name=user_created_partitions,json=userCreatedPartitions,proto3" json:"user_created_partitions,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // partition_id -> name, for creating user partitions
	IndexInfos            []*indexpb.IndexInfo `protobuf:"bytes,8,rep,name=index_infos,json=indexInfos,proto3" json:"index_infos,omitempty"`                                                                                                                             // indexes to restore
}
...
func (x *CreateCollectionMessageHeader) GetSnapshotName() string {
	if x != nil {
...
func (x *CreateCollectionMessageHeader) GetJobId() int64 {
	if x != nil {
		return x.JobId
	}
	return 0
...
func (x *CreateCollectionMessageHeader) GetRestoreFromSnapshot() bool {
	if x != nil {
		return x.RestoreFromSnapshot
	}
	return false
}

func (x *CreateCollectionMessageHeader) GetUserCreatedPartitions() map[int64]string {
	if x != nil {
...
func (x *CreateCollectionMessageHeader) GetIndexInfos() []*indexpb.IndexInfo {
	if x != nil {
		return x.IndexInfos
	}
	return nil
...
var file_messages_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x22, 0x82, 0x04, 0x0a, 0x1d, 0x43,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x64, 0x62, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x73,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x3e, 0x0a, 0x0b, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6d, 0x69, 0x6c,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x73, 0x1a, 0x48, 0x0a, 0x1a, 0x55, 0x73, 0x65, 0x72, 0x43, 0x72, 0x65,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x89, 0x01, 0x0a, 0x21, 0x41, 0x6c, 0x74, 0x65, 0x72,
	...
	0x6f, 0x6e, 0x22, 0x21, 0x0a, 0x1f, 0x41, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x69,
	...
	0x63, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x22, 0xcb, 0x02, 0x0a, 0x1c, 0x41, 0x6c, 0x74,
	...
	0x63, 0x61, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0x1c, 0x0a, 0x1a, 0x41, 0x6c, 0x74, 0x65, 0x72, 0x4c,
	...
	0x78, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x6f, 0x64, 0x79, 0x22, 0x78, 0x0a, 0x1b,
	...
	0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x1b, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42,
	0x6f, 0x64, 0x79, 0x22, 0x2f, 0x0a, 0x19, 0x44, 0x72, 0x6f, 0x70, 0x53, 0x6e, 0x61, 0x70, 0x73,
	0x68, 0x6f, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x19, 0x0a, 0x17, 0x44, 0x72, 0x6f, 0x70, 0x53, 0x6e, 0x61, 0x70,
...
var file_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 107)
var file_messages_proto_goTypes = []interface{}{
	...
	(*CacheExpirations)(nil),                  // 92: milvus.proto.messages.CacheExpirations
	(*CacheExpiration)(nil),                   // 93: milvus.proto.messages.CacheExpiration
	(*LegacyProxyCollectionMetaCache)(nil),    // 94: milvus.proto.messages.LegacyProxyCollectionMetaCache
	(*ManualFlushExtraResponse)(nil),          // 95: milvus.proto.messages.ManualFlushExtraResponse
	(*FlushAllMessageHeader)(nil),             // 96: milvus.proto.messages.FlushAllMessageHeader
	(*FlushAllMessageBody)(nil),               // 97: milvus.proto.messages.FlushAllMessageBody
	...
	(*TruncateCollectionMessageHeader)(nil),   // 104: milvus.proto.messages.TruncateCollectionMessageHeader
	(*TruncateCollectionMessageBody)(nil),     // 105: milvus.proto.messages.TruncateCollectionMessageBody
	nil,                                       // 106: milvus.proto.messages.Message.PropertiesEntry
	nil,                                       // 107: milvus.proto.messages.CreateCollectionMessageHeader.UserCreatedPartitionsEntry
	nil,                                       // 108: milvus.proto.messages.AlterResourceGroupMessageHeader.ResourceGroupConfigsEntry
	nil,                                       // 109: milvus.proto.messages.RMQMessageLayout.PropertiesEntry
	(datapb.SegmentLevel)(0),                  // 110: milvus.proto.data.SegmentLevel
	(*indexpb.IndexInfo)(nil),                 // 111: milvus.proto.index.IndexInfo
...
var file_messages_proto_depIdxs = []int32{
	106, // 0: milvus.proto.messages.Message.properties:type_name -> milvus.proto.messages.Message.PropertiesEntry
	...
	110, // 4: milvus.proto.messages.CreateSegmentMessageHeader.level:type_name -> milvus.proto.data.SegmentLevel
	107, // 5: milvus.proto.messages.CreateCollectionMessageHeader.user_created_partitions:type_name -> milvus.proto.messages.CreateCollectionMessageHeader.UserCreatedPartitionsEntry
	111, // 6: milvus.proto.messages.CreateCollectionMessageHeader.index_infos:type_name -> milvus.proto.index.IndexInfo
	112, // 7: milvus.proto.messages.AlterReplicateConfigMessageHeader.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	113, // 8: milvus.proto.messages.SchemaChangeMessageBody.schema:type_name -> milvus.proto.schema.CollectionSchema
	114, // 9: milvus.proto.messages.AlterCollectionMessageHeader.update_mask:type_name -> google.protobuf.FieldMask
	92,  // 10: milvus.proto.messages.AlterCollectionMessageHeader.cache_expirations:type_name -> milvus.proto.messages.CacheExpirations
	34,  // 11: milvus.proto.messages.AlterCollectionMessageBody.updates:type_name -> milvus.proto.messages.AlterCollectionMessageUpdates
	113, // 12: milvus.proto.messages.AlterCollectionMessageUpdates.schema:type_name -> milvus.proto.schema.CollectionSchema
	115, // 13: milvus.proto.messages.AlterCollectionMessageUpdates.consistency_level:type_name -> milvus.proto.common.ConsistencyLevel
	116, // 14: milvus.proto.messages.AlterCollectionMessageUpdates.properties:type_name -> milvus.proto.common.KeyValuePair
	35,  // 15: milvus.proto.messages.AlterCollectionMessageUpdates.alter_load_config:type_name -> milvus.proto.messages.AlterLoadConfigOfAlterCollection
	38,  // 16: milvus.proto.messages.AlterLoadConfigMessageHeader.load_fields:type_name -> milvus.proto.messages.LoadFieldConfig
	39,  // 17: milvus.proto.messages.AlterLoadConfigMessageHeader.replicas:type_name -> milvus.proto.messages.LoadReplicaConfig
	117, // 18: milvus.proto.messages.LoadReplicaConfig.priority:type_name -> milvus.proto.common.LoadPriority
	116, // 19: milvus.proto.messages.CreateDatabaseMessageBody.properties:type_name -> milvus.proto.common.KeyValuePair
	116, // 20: milvus.proto.messages.AlterDatabaseMessageBody.properties:type_name -> milvus.proto.common.KeyValuePair
	46,  // 21: milvus.proto.messages.AlterDatabaseMessageBody.alter_load_config:type_name -> milvus.proto.messages.AlterLoadConfigOfAlterDatabase
	118, // 22: milvus.proto.messages.CreateUserMessageHeader.user_entity:type_name -> milvus.proto.milvus.UserEntity
	119, // 23: milvus.proto.messages.CreateUserMessageBody.credential_info:type_name -> milvus.proto.internal.CredentialInfo
	118, // 24: milvus.proto.messages.AlterUserMessageHeader.user_entity:type_name -> milvus.proto.milvus.UserEntity
	119, // 25: milvus.proto.messages.AlterUserMessageBody.credential_info:type_name -> milvus.proto.internal.CredentialInfo
	120, // 26: milvus.proto.messages.AlterRoleMessageHeader.role_entity:type_name -> milvus.proto.milvus.RoleEntity
	118, // 27: milvus.proto.messages.RoleBinding.user_entity:type_name -> milvus.proto.milvus.UserEntity
	120, // 28: milvus.proto.messages.RoleBinding.role_entity:type_name -> milvus.proto.milvus.RoleEntity
	63,  // 29: milvus.proto.messages.AlterUserRoleMessageHeader.role_binding:type_name -> milvus.proto.messages.RoleBinding
	63,  // 30: milvus.proto.messages.DropUserRoleMessageHeader.role_binding:type_name -> milvus.proto.messages.RoleBinding
	121, // 31: milvus.proto.messages.RestoreRBACMessageBody.rbac_meta:type_name -> milvus.proto.milvus.RBACMeta
	122, // 32: milvus.proto.messages.AlterPrivilegeMessageHeader.entity:type_name -> milvus.proto.milvus.GrantEntity
	122, // 33: milvus.proto.messages.DropPrivilegeMessageHeader.entity:type_name -> milvus.proto.milvus.GrantEntity
	123, // 34: milvus.proto.messages.AlterPrivilegeGroupMessageHeader.privilege_group_info:type_name -> milvus.proto.milvus.PrivilegeGroupInfo
	123, // 35: milvus.proto.messages.DropPrivilegeGroupMessageHeader.privilege_group_info:type_name -> milvus.proto.milvus.PrivilegeGroupInfo
	108, // 36: milvus.proto.messages.AlterResourceGroupMessageHeader.resource_group_configs:type_name -> milvus.proto.messages.AlterResourceGroupMessageHeader.ResourceGroupConfigsEntry
	124, // 37: milvus.proto.messages.CreateIndexMessageBody.field_index:type_name -> milvus.proto.index.FieldIndex
	124, // 38: milvus.proto.messages.AlterIndexMessageBody.field_indexes:type_name -> milvus.proto.index.FieldIndex
	93,  // 39: milvus.proto.messages.CacheExpirations.cache_expirations:type_name -> milvus.proto.messages.CacheExpiration
	94,  // 40: milvus.proto.messages.CacheExpiration.legacy_proxy_collection_meta_cache:type_name -> milvus.proto.messages.LegacyProxyCollectionMetaCache
	125, // 41: milvus.proto.messages.LegacyProxyCollectionMetaCache.msg_type:type_name -> milvus.proto.common.MsgType
	109, // 42: milvus.proto.messages.RMQMessageLayout.properties:type_name -> milvus.proto.messages.RMQMessageLayout.PropertiesEntry
	102, // 43: milvus.proto.messages.BroadcastHeader.Resource_keys:type_name -> milvus.proto.messages.ResourceKey
	126, // 44: milvus.proto.messages.ReplicateHeader.message_id:type_name -> milvus.proto.common.MessageID
	126, // 45: milvus.proto.messages.ReplicateHeader.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	2,   // 46: milvus.proto.messages.ResourceKey.domain:type_name -> milvus.proto.messages.ResourceDomain
	127, // 47: milvus.proto.messages.AlterResourceGroupMessageHeader.ResourceGroupConfigsEntry.value:type_name -> milvus.proto.rg.ResourceGroupConfig
...
func file_messages_proto_init() {
	...
	file_messages_proto_msgTypes[90].OneofWrappers = []interface{}{
