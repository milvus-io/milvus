...
type Message struct {
	...
	Properties    map[string]string      `protobuf:"bytes,2,rep,name=properties,proto3" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // message properties
...
type AlterResourceGroupMessageHeader struct {
	state                protoimpl.MessageState               `protogen:"open.v1"`
	ResourceGroupConfigs map[string]*rgpb.ResourceGroupConfig `protobuf:"bytes,3,rep,name=resource_group_configs,json=resourceGroupConfigs,proto3" json:"resource_group_configs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type AlterWALMessageHeader struct {
	...
	Config        map[string]string      `protobuf:"bytes,2,rep,name=config,proto3" json:"config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Contains additional configuration parameters for the WAL alter operation.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CacheExpiration struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Cache:
	//
...
func (x *CacheExpiration) GetCache() isCacheExpiration_Cache {
	if x != nil {
		return x.Cache
	}
	return nil
...
func (x *CacheExpiration) GetLegacyProxyCollectionMetaCache() *LegacyProxyCollectionMetaCache {
	if x != nil {
		if x, ok := x.Cache.(*CacheExpiration_LegacyProxyCollectionMetaCache); ok {
...
const file_messages_proto_rawDesc = "" +
	"\n" +
	"\x0emessages.proto\x12\x15milvus.proto.messages\x1a\fcommon.proto\x1a\fschema.proto\x1a\x10data_coord.proto\x1a\x11index_coord.proto\x1a\x0einternal.proto\x1a\fmilvus.proto\x1a\brg.proto\x1a google/protobuf/field_mask.proto\"\xb2\x01\n" +
	"\aMessage\x12\x18\n" +
	"\apayload\x18\x01 \x01(\fR\apayload\x12N\n" +
	"\n" +
	"properties\x18\x02 \x03(\v2..milvus.proto.messages.Message.PropertiesEntryR\n" +
	"properties\x1a=\n" +
	"\x0fPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x12\n" +
	"\x10FlushMessageBody\"\x18\n" +
	"\x16ManualFlushMessageBody\"\x1a\n" +
	"\x18CreateSegmentMessageBody\"\x15\n" +
	"\x13BeginTxnMessageBody\"\x16\n" +
	"\x14CommitTxnMessageBody\"\x18\n" +
	"\x16RollbackTxnMessageBody\"L\n" +
	"\x0eTxnMessageBody\x12:\n" +
	"\bmessages\x18\x01 \x03(\v2\x1e.milvus.proto.messages.MessageR\bmessages\"\x17\n" +
	"\x15TimeTickMessageHeader\"\xb4\x01\n" +
	"\x13InsertMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12Q\n" +
	"\n" +
	"partitions\x18\x02 \x03(\v21.milvus.proto.messages.PartitionSegmentAssignmentR\n" +
	"partitions\x12%\n" +
	"\x0eschema_version\x18\x03 \x01(\x05R\rschemaVersion\"\xcd\x01\n" +
	"\x1aPartitionSegmentAssignment\x12!\n" +
	"\fpartition_id\x18\x01 \x01(\x03R\vpartitionId\x12\x12\n" +
	"\x04rows\x18\x02 \x01(\x04R\x04rows\x12\x1f\n" +
	"\vbinary_size\x18\x03 \x01(\x04R\n" +
	"binarySize\x12W\n" +
	"\x12segment_assignment\x18\x04 \x01(\v2(.milvus.proto.messages.SegmentAssignmentR\x11segmentAssignment\"2\n" +
	"\x11SegmentAssignment\x12\x1d\n" +
	"\n" +
	"segment_id\x18\x01 \x01(\x03R\tsegmentId\"N\n" +
	"\x13DeleteMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12\x12\n" +
	"\x04rows\x18\x02 \x01(\x04R\x04rows\"{\n" +
	"\x12FlushMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12!\n" +
	"\fpartition_id\x18\x02 \x01(\x03R\vpartitionId\x12\x1d\n" +
	"\n" +
	"segment_id\x18\x03 \x01(\x03R\tsegmentId\"\xcf\x02\n" +
	"\x1aCreateSegmentMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12!\n" +
	"\fpartition_id\x18\x02 \x01(\x03R\vpartitionId\x12\x1d\n" +
	"\n" +
	"segment_id\x18\x03 \x01(\x03R\tsegmentId\x12'\n" +
	"\x0fstorage_version\x18\x04 \x01(\x03R\x0estorageVersion\x12(\n" +
	"\x10max_segment_size\x18\x05 \x01(\x04R\x0emaxSegmentSize\x12\x19\n" +
	"\bmax_rows\x18\x06 \x01(\x04R\amaxRows\x125\n" +
	"\x05level\x18\a \x01(\x0e2\x1f.milvus.proto.data.SegmentLevelR\x05level\x12%\n" +
	"\x0eschema_version\x18\b \x01(\x05R\rschemaVersion\"{\n" +
	"\x18ManualFlushMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12\x19\n" +
	"\bflush_ts\x18\x02 \x01(\x04R\aflushTs\x12\x1f\n" +
	"\vsegment_ids\x18\x03 \x03(\x03R\n" +
	"segmentIds\"~\n" +
	"\x1dCreateCollectionMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12#\n" +
	"\rpartition_ids\x18\x02 \x03(\x03R\fpartitionIds\x12\x13\n" +
	"\x05db_id\x18\x03 \x01(\x03R\x04dbId\"W\n" +
	"\x1bDropCollectionMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12\x13\n" +
	"\x05db_id\x18\x02 \x01(\x03R\x04dbId\"f\n" +
	"\x1cCreatePartitionMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12!\n" +
	"\fpartition_id\x18\x02 \x01(\x03R\vpartitionId\"d\n" +
	"\x1aDropPartitionMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12!\n" +
	"\fpartition_id\x18\x02 \x01(\x03R\vpartitionId\"\x89\x01\n" +
	"!AlterReplicateConfigMessageHeader\x12d\n" +
	"\x17replicate_configuration\x18\x01 \x01(\v2+.milvus.proto.common.ReplicateConfigurationR\x16replicateConfiguration\"!\n" +
	"\x1fAlterReplicateConfigMessageBody\"N\n" +
	"\x15BeginTxnMessageHeader\x125\n" +
	"\x16keepalive_milliseconds\x18\x01 \x01(\x03R\x15keepaliveMilliseconds\"\x18\n" +
	"\x16CommitTxnMessageHeader\"\x1a\n" +
	"\x18RollbackTxnMessageHeader\"\x12\n" +
	"\x10TxnMessageHeader\"\x15\n" +
	"\x13ImportMessageHeader\"p\n" +
	"\x19SchemaChangeMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12.\n" +
	"\x13flushed_segment_ids\x18\x02 \x03(\x03R\x11flushedSegmentIds\"X\n" +
	"\x17SchemaChangeMessageBody\x12=\n" +
	"\x06schema\x18\x01 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\"\x9b\x02\n" +
	"\x1cAlterCollectionMessageHeader\x12\x13\n" +
	"\x05db_id\x18\x01 \x01(\x03R\x04dbId\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12T\n" +
	"\x11cache_expirations\x18\x04 \x01(\v2'.milvus.proto.messages.CacheExpirationsR\x10cacheExpirations\x12.\n" +
	"\x13flushed_segment_ids\x18\x05 \x03(\x03R\x11flushedSegmentIds\"l\n" +
	"\x1aAlterCollectionMessageBody\x12N\n" +
	"\aupdates\x18\x01 \x01(\v24.milvus.proto.messages.AlterCollectionMessageUpdatesR\aupdates\"\xd3\x03\n" +
	"\x1dAlterCollectionMessageUpdates\x12\x13\n" +
	"\x05db_id\x18\x01 \x01(\x03R\x04dbId\x12\x17\n" +
	"\adb_name\x18\x02 \x01(\tR\x06dbName\x12'\n" +
	"\x0fcollection_name\x18\x03 \x01(\tR\x0ecollectionName\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12=\n" +
	"\x06schema\x18\x05 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x12R\n" +
	"\x11consistency_level\x18\x06 \x01(\x0e2%.milvus.proto.common.ConsistencyLevelR\x10consistencyLevel\x12A\n" +
	"\n" +
	"properties\x18\a \x03(\v2!.milvus.proto.common.KeyValuePairR\n" +
	"properties\x12c\n" +
	"\x11alter_load_config\x18\b \x01(\v27.milvus.proto.messages.AlterLoadConfigOfAlterCollectionR\x0falterLoadConfig\"r\n" +
	" AlterLoadConfigOfAlterCollection\x12%\n" +
	"\x0ereplica_number\x18\x01 \x01(\x05R\rreplicaNumber\x12'\n" +
	"\x0fresource_groups\x18\x02 \x03(\tR\x0eresourceGroups\"\xcb\x02\n" +
	"\x1cAlterLoadConfigMessageHeader\x12\x13\n" +
	"\x05db_id\x18\x01 \x01(\x03R\x04dbId\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\x12#\n" +
	"\rpartition_ids\x18\x03 \x03(\x03R\fpartitionIds\x12G\n" +
	"\vload_fields\x18\x04 \x03(\v2&.milvus.proto.messages.LoadFieldConfigR\n" +
	"loadFields\x12D\n" +
	"\breplicas\x18\x05 \x03(\v2(.milvus.proto.messages.LoadReplicaConfigR\breplicas\x12=\n" +
	"\x1buser_specified_replica_mode\x18\x06 \x01(\bR\x18userSpecifiedReplicaMode\"\x1c\n" +
	"\x1aAlterLoadConfigMessageBody\"G\n" +
	"\x0fLoadFieldConfig\x12\x19\n" +
	"\bfield_id\x18\x01 \x01(\x03R\afieldId\x12\x19\n" +
	"\bindex_id\x18\x02 \x01(\x03R\aindexId\"\xa1\x01\n" +
	"\x11LoadReplicaConfig\x12\x1d\n" +
	"\n" +
	"replica_id\x18\x01 \x01(\x03R\treplicaId\x12.\n" +
	"\x13resource_group_name\x18\x02 \x01(\tR\x11resourceGroupName\x12=\n" +
	"\bpriority\x18\x03 \x01(\x0e2!.milvus.proto.common.LoadPriorityR\bpriority\"W\n" +
	"\x1bDropLoadConfigMessageHeader\x12\x13\n" +
	"\x05db_id\x18\x01 \x01(\x03R\x04dbId\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\"\x1b\n" +
	"\x19DropLoadConfigMessageBody\"K\n" +
	"\x1bCreateDatabaseMessageHeader\x12\x17\n" +
	"\adb_name\x18\x01 \x01(\tR\x06dbName\x12\x13\n" +
	"\x05db_id\x18\x02 \x01(\x03R\x04dbId\"^\n" +
	"\x19CreateDatabaseMessageBody\x12A\n" +
	"\n" +
	"properties\x18\x01 \x03(\v2!.milvus.proto.common.KeyValuePairR\n" +
	"properties\"J\n" +
	"\x1aAlterDatabaseMessageHeader\x12\x17\n" +
	"\adb_name\x18\x01 \x01(\tR\x06dbName\x12\x13\n" +
	"\x05db_id\x18\x02 \x01(\x03R\x04dbId\"\xc0\x01\n" +
	"\x18AlterDatabaseMessageBody\x12A\n" +
	"\n" +
	"properties\x18\x01 \x03(\v2!.milvus.proto.common.KeyValuePairR\n" +
	"properties\x12a\n" +
	"\x11alter_load_config\x18\x02 \x01(\v25.milvus.proto.messages.AlterLoadConfigOfAlterDatabaseR\x0falterLoadConfig\"\x97\x01\n" +
	"\x1eAlterLoadConfigOfAlterDatabase\x12%\n" +
	"\x0ecollection_ids\x18\x01 \x03(\x03R\rcollectionIds\x12%\n" +
	"\x0ereplica_number\x18\x02 \x01(\x05R\rreplicaNumber\x12'\n" +
	"\x0fresource_groups\x18\x03 \x03(\tR\x0eresourceGroups\"I\n" +
	"\x19DropDatabaseMessageHeader\x12\x17\n" +
	"\adb_name\x18\x01 \x01(\tR\x06dbName\x12\x13\n" +
	"\x05db_id\x18\x02 \x01(\x03R\x04dbId\"\x19\n" +
	"\x17DropDatabaseMessageBody\"\xab\x01\n" +
	"\x17AlterAliasMessageHeader\x12\x13\n" +
	"\x05db_id\x18\x01 \x01(\x03R\x04dbId\x12\x17\n" +
	"\adb_name\x18\x02 \x01(\tR\x06dbName\x12#\n" +
	"\rcollection_id\x18\x03 \x01(\x03R\fcollectionId\x12'\n" +
	"\x0fcollection_name\x18\x04 \x01(\tR\x0ecollectionName\x12\x14\n" +
	"\x05alias\x18\x05 \x01(\tR\x05alias\"\x17\n" +
	"\x15AlterAliasMessageBody\"\\\n" +
	"\x16DropAliasMessageHeader\x12\x13\n" +
	"\x05db_id\x18\x01 \x01(\x03R\x04dbId\x12\x17\n" +
	"\adb_name\x18\x02 \x01(\tR\x06dbName\x12\x14\n" +
	"\x05alias\x18\x03 \x01(\tR\x05alias\"\x16\n" +
	"\x14DropAliasMessageBody\"[\n" +
	"\x17CreateUserMessageHeader\x12@\n" +
	"\vuser_entity\x18\x01 \x01(\v2\x1f.milvus.proto.milvus.UserEntityR\n" +
	"userEntity\"g\n" +
	"\x15CreateUserMessageBody\x12N\n" +
	"\x0fcredential_info\x18\x01 \x01(\v2%.milvus.proto.internal.CredentialInfoR\x0ecredentialInfo\"Z\n" +
	"\x16AlterUserMessageHeader\x12@\n" +
	"\vuser_entity\x18\x01 \x01(\v2\x1f.milvus.proto.milvus.UserEntityR\n" +
	"userEntity\"f\n" +
	"\x14AlterUserMessageBody\x12N\n" +
	"\x0fcredential_info\x18\x01 \x01(\v2%.milvus.proto.internal.CredentialInfoR\x0ecredentialInfo\"4\n" +
	"\x15DropUserMessageHeader\x12\x1b\n" +
	"\tuser_name\x18\x01 \x01(\tR\buserName\"\x15\n" +
	"\x13DropUserMessageBody\"Z\n" +
	"\x16AlterRoleMessageHeader\x12@\n" +
	"\vrole_entity\x18\x01 \x01(\v2\x1f.milvus.proto.milvus.RoleEntityR\n" +
	"roleEntity\"\x16\n" +
	"\x14AlterRoleMessageBody\"S\n" +
	"\x15DropRoleMessageHeader\x12\x1b\n" +
	"\trole_name\x18\x01 \x01(\tR\broleName\x12\x1d\n" +
	"\n" +
	"force_drop\x18\x02 \x01(\bR\tforceDrop\"\x15\n" +
	"\x13DropRoleMessageBody\"\x91\x01\n" +
	"\vRoleBinding\x12@\n" +
	"\vuser_entity\x18\x01 \x01(\v2\x1f.milvus.proto.milvus.UserEntityR\n" +
	"userEntity\x12@\n" +
	"\vrole_entity\x18\x02 \x01(\v2\x1f.milvus.proto.milvus.RoleEntityR\n" +
	"roleEntity\"c\n" +
	"\x1aAlterUserRoleMessageHeader\x12E\n" +
	"\frole_binding\x18\x01 \x01(\v2\".milvus.proto.messages.RoleBindingR\vroleBinding\"\x1a\n" +
	"\x18AlterUserRoleMessageBody\"b\n" +
	"\x19DropUserRoleMessageHeader\x12E\n" +
	"\frole_binding\x18\x01 \x01(\v2\".milvus.proto.messages.RoleBindingR\vroleBinding\"\x19\n" +
	"\x17DropUserRoleMessageBody\"\x1a\n" +
	"\x18RestoreRBACMessageHeader\"T\n" +
	"\x16RestoreRBACMessageBody\x12:\n" +
	"\trbac_meta\x18\x01 \x01(\v2\x1d.milvus.proto.milvus.RBACMetaR\brbacMeta\"W\n" +
	"\x1bAlterPrivilegeMessageHeader\x128\n" +
	"\x06entity\x18\x01 \x01(\v2 .milvus.proto.milvus.GrantEntityR\x06entity\"\x1b\n" +
	"\x19AlterPrivilegeMessageBody\"V\n" +
	"\x1aDropPrivilegeMessageHeader\x128\n" +
	"\x06entity\x18\x01 \x01(\v2 .milvus.proto.milvus.GrantEntityR\x06entity\"\x1a\n" +
	"\x18DropPrivilegeMessageBody\"}\n" +
	" AlterPrivilegeGroupMessageHeader\x12Y\n" +
	"\x14privilege_group_info\x18\x01 \x01(\v2'.milvus.proto.milvus.PrivilegeGroupInfoR\x12privilegeGroupInfo\" \n" +
	"\x1eAlterPrivilegeGroupMessageBody\"|\n" +
	"\x1fDropPrivilegeGroupMessageHeader\x12Y\n" +
	"\x14privilege_group_info\x18\x01 \x01(\v2'.milvus.proto.milvus.PrivilegeGroupInfoR\x12privilegeGroupInfo\"\x1f\n" +
	"\x1dDropPrivilegeGroupMessageBody\"\x99\x02\n" +
	"\x1fAlterResourceGroupMessageHeader\x12\x86\x01\n" +
	"\x16resource_group_configs\x18\x03 \x03(\v2P.milvus.proto.messages.AlterResourceGroupMessageHeader.ResourceGroupConfigsEntryR\x14resourceGroupConfigs\x1am\n" +
	"\x19ResourceGroupConfigsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12:\n" +
	"\x05value\x18\x02 \x01(\v2$.milvus.proto.rg.ResourceGroupConfigR\x05value:\x028\x01\"\x1f\n" +
	"\x1dAlterResourceGroupMessageBody\"P\n" +
	"\x1eDropResourceGroupMessageHeader\x12.\n" +
	"\x13resource_group_name\x18\x01 \x01(\tR\x11resourceGroupName\"\x1e\n" +
	"\x1cDropResourceGroupMessageBody\"\xa9\x01\n" +
	"\x18CreateIndexMessageHeader\x12\x13\n" +
	"\x05db_id\x18\x01 \x01(\x03R\x04dbId\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\x12\x19\n" +
	"\bfield_id\x18\x03 \x01(\x03R\afieldId\x12\x19\n" +
	"\bindex_id\x18\x04 \x01(\x03R\aindexId\x12\x1d\n" +
	"\n" +
	"index_name\x18\x05 \x01(\tR\tindexName\"Y\n" +
	"\x16CreateIndexMessageBody\x12?\n" +
	"\vfield_index\x18\x01 \x01(\v2\x1e.milvus.proto.index.FieldIndexR\n" +
	"fieldIndex\"[\n" +
	"\x17AlterIndexMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12\x1b\n" +
	"\tindex_ids\x18\x02 \x03(\x03R\bindexIds\"\\\n" +
	"\x15AlterIndexMessageBody\x12C\n" +
	"\rfield_indexes\x18\x01 \x03(\v2\x1e.milvus.proto.index.FieldIndexR\ffieldIndexes\"Z\n" +
	"\x16DropIndexMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12\x1b\n" +
	"\tindex_ids\x18\x02 \x03(\x03R\bindexIds\"\x16\n" +
	"\x14DropIndexMessageBody\"x\n" +
	"\x1bCreateSnapshotMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\"\x1b\n" +
	"\x19CreateSnapshotMessageBody\"/\n" +
	"\x19DropSnapshotMessageHeader\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\x19\n" +
	"\x17DropSnapshotMessageBody\"\x7f\n" +
	"\x1cRestoreSnapshotMessageHeader\x12#\n" +
	"\rsnapshot_name\x18\x01 \x01(\tR\fsnapshotName\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\x12\x15\n" +
	"\x06job_id\x18\x03 \x01(\x03R\x05jobId\"\x1c\n" +
	"\x1aRestoreSnapshotMessageBody\"\xea\x01\n" +
	"\x15AlterWALMessageHeader\x12D\n" +
	"\x0ftarget_wal_name\x18\x01 \x01(\x0e2\x1c.milvus.proto.common.WALNameR\rtargetWalName\x12P\n" +
	"\x06config\x18\x02 \x03(\v28.milvus.proto.messages.AlterWALMessageHeader.ConfigEntryR\x06config\x1a9\n" +
	"\vConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x15\n" +
	"\x13AlterWALMessageBody\"g\n" +
	"\x10CacheExpirations\x12S\n" +
	"\x11cache_expirations\x18\x01 \x03(\v2&.milvus.proto.messages.CacheExpirationR\x10cacheExpirations\"\xa0\x01\n" +
	"\x0fCacheExpiration\x12\x83\x01\n" +
	"\"legacy_proxy_collection_meta_cache\x18\x01 \x01(\v25.milvus.proto.messages.LegacyProxyCollectionMetaCacheH\x00R\x1elegacyProxyCollectionMetaCacheB\a\n" +
	"\x05cache\"\xe7\x01\n" +
	"\x1eLegacyProxyCollectionMetaCache\x12\x17\n" +
	"\adb_name\x18\x01 \x01(\tR\x06dbName\x12'\n" +
	"\x0fcollection_name\x18\x02 \x01(\tR\x0ecollectionName\x12#\n" +
	"\rcollection_id\x18\x03 \x01(\x03R\fcollectionId\x12%\n" +
	"\x0epartition_name\x18\x04 \x01(\tR\rpartitionName\x127\n" +
	"\bmsg_type\x18\x05 \x01(\x0e2\x1c.milvus.proto.common.MsgTypeR\amsgType\";\n" +
	"\x18ManualFlushExtraResponse\x12\x1f\n" +
	"\vsegment_ids\x18\x01 \x03(\x03R\n" +
	"segmentIds\"\x17\n" +
	"\x15FlushAllMessageHeader\"\x15\n" +
	"\x13FlushAllMessageBody\"Z\n" +
	"\n" +
	"TxnContext\x12\x15\n" +
	"\x06txn_id\x18\x01 \x01(\x03R\x05txnId\x125\n" +
	"\x16keepalive_milliseconds\x18\x02 \x01(\x03R\x15keepaliveMilliseconds\"\xc4\x01\n" +
	"\x10RMQMessageLayout\x12\x18\n" +
	"\apayload\x18\x01 \x01(\fR\apayload\x12W\n" +
	"\n" +
	"properties\x18\x02 \x03(\v27.milvus.proto.messages.RMQMessageLayout.PropertiesEntryR\n" +
	"properties\x1a=\n" +
	"\x0fPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xbb\x01\n" +
	"\x0fBroadcastHeader\x12!\n" +
	"\fbroadcast_id\x18\x01 \x01(\x04R\vbroadcastId\x12\x1c\n" +
	"\tvchannels\x18\x02 \x03(\tR\tvchannels\x12G\n" +
	"\rResource_keys\x18\x03 \x03(\v2\".milvus.proto.messages.ResourceKeyR\fResourceKeys\x12\x1e\n" +
	"\vack_sync_up\x18\x04 \x01(\bR\tackSyncUp\"\x83\x02\n" +
	"\x0fReplicateHeader\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\x12=\n" +
	"\n" +
	"message_id\x18\x02 \x01(\v2\x1e.milvus.proto.common.MessageIDR\tmessageId\x12Y\n" +
	"\x19last_confirmed_message_id\x18\x03 \x01(\v2\x1e.milvus.proto.common.MessageIDR\x16lastConfirmedMessageId\x12\x1b\n" +
	"\ttime_tick\x18\x04 \x01(\x04R\btimeTick\x12\x1a\n" +
	"\bvchannel\x18\x05 \x01(\tR\bvchannel\"v\n" +
	"\vResourceKey\x12=\n" +
	"\x06domain\x18\x01 \x01(\x0e2%.milvus.proto.messages.ResourceDomainR\x06domain\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x16\n" +
	"\x06shared\x18\x03 \x01(\bR\x06shared\"\x88\x01\n" +
	"\fCipherHeader\x12\x13\n" +
	"\x05ez_id\x18\x01 \x01(\x03R\x04ezId\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\x12\x19\n" +
	"\bsafe_key\x18\x03 \x01(\fR\asafeKey\x12#\n" +
	"\rpayload_bytes\x18\x04 \x01(\x03R\fpayloadBytes\"|\n" +
	"\x1fTruncateCollectionMessageHeader\x12\x13\n" +
	"\x05db_id\x18\x01 \x01(\x03R\x04dbId\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\x12\x1f\n" +
	"\vsegment_ids\x18\x03 \x03(\x03R\n" +
	"segmentIds\"\x1f\n" +
	"\x1dTruncateCollectionMessageBody\"G\n" +
	" BatchUpdateManifestMessageHeader\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\x03R\fcollectionId\"f\n" +
	"\x1eBatchUpdateManifestMessageBody\x12D\n" +
	"\x05items\x18\x01 \x03(\v2..milvus.proto.messages.BatchUpdateManifestItemR\x05items\"c\n" +
	"\x17BatchUpdateManifestItem\x12\x1d\n" +
	"\n" +
	"segment_id\x18\x01 \x01(\x03R\tsegmentId\x12)\n" +
	"\x10manifest_version\x18\x02 \x01(\x03R\x0fmanifestVersion*\xff\x06\n" +
	"\vMessageType\x12\v\n" +
	"\aUnknown\x10\x00\x12\f\n" +
	"\bTimeTick\x10\x01\x12\n" +
	"\n" +
	"\x06Insert\x10\x02\x12\n" +
	"\n" +
	"\x06Delete\x10\x03\x12\t\n" +
	"\x05Flush\x10\x04\x12\x14\n" +
	"\x10CreateCollection\x10\x05\x12\x12\n" +
	"\x0eDropCollection\x10\x06\x12\x13\n" +
	"\x0fCreatePartition\x10\a\x12\x11\n" +
	"\rDropPartition\x10\b\x12\x0f\n" +
	"\vManualFlush\x10\t\x12\x11\n" +
	"\rCreateSegment\x10\n" +
	"\x12\n" +
	"\n" +
	"\x06Import\x10\v\x12\x14\n" +
	"\fSchemaChange\x10\f\x1a\x02\b\x01\x12\x13\n" +
	"\x0fAlterCollection\x10\r\x12\x13\n" +
	"\x0fAlterLoadConfig\x10\x0e\x12\x12\n" +
	"\x0eDropLoadConfig\x10\x0f\x12\x12\n" +
	"\x0eCreateDatabase\x10\x10\x12\x11\n" +
	"\rAlterDatabase\x10\x11\x12\x10\n" +
	"\fDropDatabase\x10\x12\x12\x0e\n" +
	"\n" +
	"AlterAlias\x10\x13\x12\r\n" +
	"\tDropAlias\x10\x14\x12\x0f\n" +
	"\vRestoreRBAC\x10\x15\x12\r\n" +
	"\tAlterUser\x10\x16\x12\f\n" +
	"\bDropUser\x10\x17\x12\r\n" +
	"\tAlterRole\x10\x18\x12\f\n" +
	"\bDropRole\x10\x19\x12\x11\n" +
	"\rAlterUserRole\x10\x1a\x12\x10\n" +
	"\fDropUserRole\x10\x1b\x12\x12\n" +
	"\x0eAlterPrivilege\x10\x1c\x12\x11\n" +
	"\rDropPrivilege\x10\x1d\x12\x17\n" +
	"\x13AlterPrivilegeGroup\x10\x1e\x12\x16\n" +
	"\x12DropPrivilegeGroup\x10\x1f\x12\x16\n" +
	"\x12AlterResourceGroup\x10 \x12\x15\n" +
	"\x11DropResourceGroup\x10!\x12\x0f\n" +
	"\vCreateIndex\x10\"\x12\x0e\n" +
	"\n" +
	"AlterIndex\x10#\x12\r\n" +
	"\tDropIndex\x10$\x12\f\n" +
	"\bFlushAll\x10%\x12\x16\n" +
	"\x12TruncateCollection\x10&\x12\x13\n" +
	"\x0fRestoreSnapshot\x10'\x12\x12\n" +
	"\x0eCreateSnapshot\x10(\x12\x10\n" +
	"\fDropSnapshot\x10)\x12\x17\n" +
	"\x13BatchUpdateManifest\x10*\x12\r\n" +
	"\bAlterWAL\x10\xbc\x05\x12\x19\n" +
	"\x14AlterReplicateConfig\x10\xa0\x06\x12\r\n" +
	"\bBeginTxn\x10\x84\a\x12\x0e\n" +
	"\tCommitTxn\x10\x85\a\x12\x10\n" +
	"\vRollbackTxn\x10\x86\a\x12\b\n" +
	"\x03Txn\x10\xe7\a*t\n" +
	"\bTxnState\x12\x0e\n" +
	"\n" +
	"TxnUnknown\x10\x00\x12\x0f\n" +
	"\vTxnInFlight\x10\x01\x12\x0f\n" +
	"\vTxnOnCommit\x10\x02\x12\x10\n" +
	"\fTxnCommitted\x10\x03\x12\x11\n" +
	"\rTxnOnRollback\x10\x04\x12\x11\n" +
	"\rTxnRollbacked\x10\x05*\xe2\x01\n" +
	"\x0eResourceDomain\x12\x19\n" +
	"\x15ResourceDomainUnknown\x10\x00\x12!\n" +
	"\x19ResourceDomainImportJobID\x10\x01\x1a\x02\b\x01\x12 \n" +
	"\x1cResourceDomainCollectionName\x10\x02\x12\x18\n" +
	"\x14ResourceDomainDBName\x10\x03\x12\x1b\n" +
	"\x17ResourceDomainPrivilege\x10\x04\x12\x1e\n" +
	"\x1aResourceDomainSnapshotName\x10\x05\x12\x19\n" +
	"\x15ResourceDomainCluster\x10\x7fB5Z3github.com/milvus-io/milvus/pkg/v2/proto/messagespbb\x06proto3"
...
func file_messages_proto_init() {
	...
	file_messages_proto_msgTypes[94].OneofWrappers = []any{
