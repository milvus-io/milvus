...
type AlterCollectionMessageHeader struct {
	...
	// Optional. Present only when this alter adds backfilled (function-output) fields:
	// it declares the field set so the ack callback registers the bump_defence gate
	// (message declares, ack registers -- same pattern as BatchUpdateManifest). Absent
	// for any other alter -> no gate action.
	FieldBackfill *FieldBackfill `protobuf:"bytes,7,opt,name=field_backfill,json=fieldBackfill,proto3" json:"field_backfill,omitempty"`
}
...
func (x *AlterCollectionMessageHeader) GetFieldBackfill() *FieldBackfill {
	if x != nil {
		return x.FieldBackfill
	}
	return nil
}
...
type BatchUpdateManifestMessageBody struct {
	...
	// Optional. Present only when this batch is a field-backfill commit; it declares
	// which fields the batch backfills. The ack callback (where the applied per-segment
	// versions become known) uses it to register the bump_defence gate over the
	// committed segments. Absent for a generic manifest update -- presence is the
	// "is-backfill" signal and the gate step stays a no-op when it is nil.
	FieldBackfill *FieldBackfill `protobuf:"bytes,2,opt,name=field_backfill,json=fieldBackfill,proto3" json:"field_backfill,omitempty"`
}
...
func (x *BatchUpdateManifestMessageBody) GetFieldBackfill() *FieldBackfill {
	if x != nil {
		return x.FieldBackfill
	}
	return nil
...
// FieldBackfill declares the field set a BatchUpdateManifest batch backfills, so the
// batch's ack callback can register the bump_defence gate for those fields.
type FieldBackfill struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	FieldIds []int64 `protobuf:"varint,1,rep,packed,name=field_ids,json=fieldIds,proto3" json:"field_ids,omitempty"`
	// source is the COMMIT-level identity of the backfill (e.g. the result path). One
	// logical commit is split into many batches only for message-size reasons; every
	// batch carries the same source so their registrations dedupe onto ONE gate round.
	// Stable across RPC retries and ack-callback retries.
	Source string `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"`
}

func (x *FieldBackfill) Reset() {
	*x = FieldBackfill{}
	if protoimpl.UnsafeEnabled {
...
func (x *FieldBackfill) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FieldBackfill) ProtoMessage() {}

func (x *FieldBackfill) ProtoReflect() protoreflect.Message {
	mi := &file_messages_proto_msgTypes[117]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FieldBackfill.ProtoReflect.Descriptor instead.
func (*FieldBackfill) Descriptor() ([]byte, []int) {
	return file_messages_proto_rawDescGZIP(), []int{117}
}

func (x *FieldBackfill) GetFieldIds() []int64 {
	if x != nil {
		return x.FieldIds
	}
	return nil
...
func (x *FieldBackfill) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
var file_messages_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x94, 0x03, 0x0a, 0x1c, 0x41, 0x6c, 0x74, 0x65, 0x72,
	...
	0x12, 0x4b, 0x0a, 0x0e, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x66, 0x69,
	0x6c, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75,
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73,
	0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x42, 0x61, 0x63, 0x6b, 0x66, 0x69, 0x6c, 0x6c, 0x52, 0x0d,
	0x66, 0x69, 0x65, 0x6c, 0x64, 0x42, 0x61, 0x63, 0x6b, 0x66, 0x69, 0x6c, 0x6c, 0x22, 0x6c, 0x0a,
	...
	0x72, 0x6f, 0x75, 0x70, 0x73, 0x22, 0x84, 0x03, 0x0a, 0x1c, 0x41, 0x6c, 0x74, 0x65, 0x72, 0x4c,
	...
	0x6f, 0x64, 0x65, 0x12, 0x37, 0x0a, 0x18, 0x75, 0x73, 0x65, 0x5f, 0x6c, 0x6f, 0x63, 0x61, 0x6c,
	0x5f, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x15, 0x75, 0x73, 0x65, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x52,
	0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x1c, 0x0a, 0x1a,
	0x41, 0x6c, 0x74, 0x65, 0x72, 0x4c, 0x6f, 0x61, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x6f, 0x64, 0x79, 0x22, 0x47, 0x0a, 0x0f, 0x4c, 0x6f,
	0x61, 0x64, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x19, 0x0a,
	...
	0x78, 0x49, 0x64, 0x22, 0xa1, 0x01, 0x0a, 0x11, 0x4c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x70, 0x6c,
	0x69, 0x63, 0x61, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x70,
	0x6c, 0x69, 0x63, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72,
	0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64, 0x12, 0x2e, 0x0a, 0x13, 0x72, 0x65, 0x73, 0x6f,
	...
	0x72, 0x6f, 0x75, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x3d, 0x0a, 0x08, 0x70, 0x72, 0x69, 0x6f,
	0x72, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x6d, 0x69, 0x6c,
	...
	,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x64, 0x62, 0x49, 0x64, 0x22, 0x5e, 0x0a, 0x19, 0x43, 0x72,
	...
	0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x22, 0x4a, 0x0a, 0x1a, 0x41, 0x6c,
	...
	0x52, 0x04, 0x64, 0x62, 0x49, 0x64, 0x22, 0xc0, 0x01, 0x0a, 0x18, 0x41, 0x6c, 0x74, 0x65, 0x72,
	...
	0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x12, 0x61, 0x0a, 0x11, 0x61, 0x6c, 0x74, 0x65, 0x72, 0x5f,
	0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x52, 0x0f, 0x61, 0x6c, 0x74, 0x65, 0x72, 0x4c,
	0x6f, 0x61, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x97, 0x01, 0x0a, 0x1e, 0x41, 0x6c,
	0x74, 0x65, 0x72, 0x4c, 0x6f, 0x61, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4f, 0x66, 0x41,
	0x6c, 0x74, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x25, 0x0a, 0x0e,
	...
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x72, 0x65, 0x70,
	...
	0x75, 0x70, 0x73, 0x22, 0x49, 0x0a, 0x19, 0x44, 0x72, 0x6f, 0x70, 0x44, 0x61, 0x74, 0x61, 0x62,
	...
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x64, 0x62, 0x49, 0x64, 0x22, 0x19,
	0x0a, 0x17, 0x44, 0x72, 0x6f, 0x70, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x6f, 0x64, 0x79, 0x22, 0xab, 0x01, 0x0a, 0x17, 0x41, 0x6c,
	0x74, 0x65, 0x72, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48,
	...
	0x52, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x22, 0x17, 0x0a, 0x15, 0x41, 0x6c, 0x74, 0x65, 0x72,
	...
	0x67, 0x65, 0x42, 0x6f, 0x64, 0x79, 0x22, 0xbb, 0x02, 0x0a, 0x1c, 0x52, 0x65, 0x73, 0x74, 0x6f,
	...
	0x53, 0x70, 0x65, 0x63, 0x22, 0x1c, 0x0a, 0x1a, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x53,
	...
	0x67, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6c, 0x6c,
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0c, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0xb3, 0x01,
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0xe3, 0x07, 0x0a, 0x0b,
	...
	0x62, 0x61, 0x63, 0x6b, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x10, 0x2e, 0x12, 0x0d, 0x0a, 0x08,
...
var file_messages_proto_goTypes = []interface{}{
	...
	(*FieldBackfill)(nil),                          // 120: milvus.proto.messages.FieldBackfill
	...
	(*indexpb.FieldIndex)(nil),              // 141: milvus.proto.index.FieldIndex
...
var file_messages_proto_depIdxs = []int32{
	...
	120, // 9: milvus.proto.messages.AlterCollectionMessageHeader.field_backfill:type_name -> milvus.proto.messages.FieldBackfill
	34,  // 10: milvus.proto.messages.AlterCollectionMessageBody.updates:type_name -> milvus.proto.messages.AlterCollectionMessageUpdates
	130, // 11: milvus.proto.messages.AlterCollectionMessageUpdates.schema:type_name -> milvus.proto.schema.CollectionSchema
	132, // 12: milvus.proto.messages.AlterCollectionMessageUpdates.consistency_level:type_name -> milvus.proto.common.ConsistencyLevel
	133, // 13: milvus.proto.messages.AlterCollectionMessageUpdates.properties:type_name -> milvus.proto.common.KeyValuePair
	35,  // 14: milvus.proto.messages.AlterCollectionMessageUpdates.alter_load_config:type_name -> milvus.proto.messages.AlterLoadConfigOfAlterCollection
	...
	141, // 36: milvus.proto.messages.CreateIndexMessageBody.field_index:type_name -> milvus.proto.index.FieldIndex
	141, // 37: milvus.proto.messages.AlterIndexMessageBody.field_indexes:type_name -> milvus.proto.index.FieldIndex
	...
	120, // 49: milvus.proto.messages.BatchUpdateManifestMessageBody.field_backfill:type_name -> milvus.proto.messages.FieldBackfill
	...
	145, // 52: milvus.proto.messages.AlterResourceGroupMessageHeader.ResourceGroupConfigsEntry.value:type_name -> milvus.proto.rg.ResourceGroupConfig
	146, // 53: milvus.proto.messages.BatchUpdateManifestV2ColumnGroups.ColumnGroupsEntry.value:type_name -> milvus.proto.data.FieldBinlog
