...
type ReplicateHeader struct {
	...
	TimeTick  uint64              `protobuf:"varint,3,opt,name=time_tick,json=timeTick,proto3" json:"time_tick,omitempty"`   // the time tick of replicate msg from source cluster
	Vchannel  string              `protobuf:"bytes,4,opt,name=vchannel,proto3" json:"vchannel,omitempty"`                    // the vchannel of replicate msg from source cluster
}
...
var file_messages_proto_rawDesc = []byte{
	...
	0x65, 0x4b, 0x65, 0x79, 0x73, 0x22, 0xa8, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63,
...
var file_messages_proto_goTypes = []interface{}{
	...
	(*ReplicateHeader)(nil),               // 34: milvus.proto.messages.ReplicateHeader
	...
	nil,                                   // 38: milvus.proto.messages.RMQMessageLayout.PropertiesEntry
	(datapb.SegmentLevel)(0),              // 39: milvus.proto.data.SegmentLevel
	(*schemapb.CollectionSchema)(nil),     // 40: milvus.proto.schema.CollectionSchema
	(*commonpb.MessageID)(nil),            // 41: milvus.proto.common.MessageID
}
var file_messages_proto_depIdxs = []int32{
	...
	39, // 4: milvus.proto.messages.CreateSegmentMessageHeader.level:type_name -> milvus.proto.data.SegmentLevel
	40, // 5: milvus.proto.messages.SchemaChangeMessageBody.schema:type_name -> milvus.proto.schema.CollectionSchema
	38, // 6: milvus.proto.messages.RMQMessageLayout.properties:type_name -> milvus.proto.messages.RMQMessageLayout.PropertiesEntry
	35, // 7: milvus.proto.messages.BroadcastHeader.Resource_keys:type_name -> milvus.proto.messages.ResourceKey
	41, // 8: milvus.proto.messages.ReplicateHeader.message_id:type_name -> milvus.proto.common.MessageID
