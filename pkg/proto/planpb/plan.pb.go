...
const (
	DistanceMetric_DISTANCE_METRIC_UNSPECIFIED DistanceMetric = 0 // 未指定
	DistanceMetric_DISTANCE_METRIC_L2          DistanceMetric = 1 // 欧几里得距离
	DistanceMetric_DISTANCE_METRIC_IP          DistanceMetric = 2 // 内积距离
	DistanceMetric_DISTANCE_METRIC_COSINE      DistanceMetric = 3 // 余弦距离
	DistanceMetric_DISTANCE_METRIC_HAMMING     DistanceMetric = 4 // 汉明距离（二进制向量）
	DistanceMetric_DISTANCE_METRIC_JACCARD     DistanceMetric = 5 // 杰卡德距离（二进制向量）
)
...
var (
	DistanceMetric_name = map[int32]string{
		...
		2: "DISTANCE_METRIC_IP",
		3: "DISTANCE_METRIC_COSINE",
		4: "DISTANCE_METRIC_HAMMING",
		5: "DISTANCE_METRIC_JACCARD",
	}
	DistanceMetric_value = map[string]int32{
		...
		"DISTANCE_METRIC_HAMMING":     4,
		"DISTANCE_METRIC_JACCARD":     5,
	}
)
...
type DistanceExpr struct {
	...
	LeftVector  *Expr `protobuf:"bytes,1,opt,name=left_vector,json=leftVector,proto3" json:"left_vector,omitempty"`    // 左侧向量表达式
	RightVector *Expr `protobuf:"bytes,2,opt,name=right_vector,json=rightVector,proto3" json:"right_vector,omitempty"` // 右侧向量表达式
	// 距离度量类型：优先使用枚举，兼容字符串
	//
	// Types that are assignable to Metric:
	//
	//	*DistanceExpr_MetricEnum
	//	*DistanceExpr_MetricString
	Metric     isDistanceExpr_Metric `protobuf_oneof:"metric"`
	Parameters map[string]string     `protobuf:"bytes,5,rep,name=parameters,proto3" json:"parameters,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 算法参数，如 {"p": "2"} for Minkowski距离
	Alias      string                `protobuf:"bytes,6,opt,name=alias,proto3" json:"alias,omitempty"`                                                                                                   // 可选的结果别名，如 "_distance"
	Version    int32                 `protobuf:"varint,7,opt,name=version,proto3" json:"version,omitempty"`                                                                                              // 协议版本，便于兼容性处理
}
...
func (x *DistanceExpr) GetLeftVector() *Expr {
	if x != nil {
		return x.LeftVector
	}
	return nil
...
func (x *DistanceExpr) GetRightVector() *Expr {
	if x != nil {
		return x.RightVector
	}
	return nil
}

func (m *DistanceExpr) GetMetric() isDistanceExpr_Metric {
	if m != nil {
		return m.Metric
	}
	return nil
...
func (x *DistanceExpr) GetMetricEnum() DistanceMetric {
	if x, ok := x.GetMetric().(*DistanceExpr_MetricEnum); ok {
		return x.MetricEnum
	}
	return DistanceMetric_DISTANCE_METRIC_UNSPECIFIED
}

func (x *DistanceExpr) GetMetricString() string {
	if x, ok := x.GetMetric().(*DistanceExpr_MetricString); ok {
		return x.MetricString
	}
	return ""
}

func (x *DistanceExpr) GetParameters() map[string]string {
	if x != nil {
		return x.Parameters
	}
	return nil
...
func (x *DistanceExpr) GetAlias() string {
	if x != nil {
		return x.Alias
	}
	return ""
...
func (x *DistanceExpr) GetVersion() int32 {
	if x != nil {
		return x.Version
	}
	return 0
...
type isDistanceExpr_Metric interface {
	isDistanceExpr_Metric()
}

type DistanceExpr_MetricEnum struct {
	MetricEnum DistanceMetric `protobuf:"varint,3,opt,name=metric_enum,json=metricEnum,proto3,enum=milvus.proto.plan.DistanceMetric,oneof"` // 推荐：使用枚举类型
}

type DistanceExpr_MetricString struct {
	MetricString string `protobuf:"bytes,4,opt,name=metric_string,json=metricString,proto3,oneof"` // 兼容：字符串类型（向后兼容）
}

func (*DistanceExpr_MetricEnum) isDistanceExpr_Metric() {}

func (*DistanceExpr_MetricString) isDistanceExpr_Metric() {}
...
type AliasedExpr struct {
	...
	Expr  *Expr  `protobuf:"bytes,1,opt,name=expr,proto3" json:"expr,omitempty"`   // 原始表达式
	Alias string `protobuf:"bytes,2,opt,name=alias,proto3" json:"alias,omitempty"` // 别名
}

func (x *AliasedExpr) Reset() {
	*x = AliasedExpr{}
	if protoimpl.UnsafeEnabled {
...
func (x *AliasedExpr) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AliasedExpr) ProtoMessage() {}

func (x *AliasedExpr) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AliasedExpr.ProtoReflect.Descriptor instead.
func (*AliasedExpr) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{23}
}

func (x *AliasedExpr) GetExpr() *Expr {
	if x != nil {
		return x.Expr
	}
	return nil
...
func (x *AliasedExpr) GetAlias() string {
	if x != nil {
		return x.Alias
	}
	return ""
...
// 查询数据源定义 - 支持 from 语法
type QueryFromSource struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Alias string `protobuf:"bytes,1,opt,name=alias,proto3" json:"alias,omitempty"` // 数据源别名，如 "a", "b"
	// Types that are assignable to Source:
	//
	//	*QueryFromSource_CollectionName
	//	*QueryFromSource_ExternalVectors
	Source isQueryFromSource_Source `protobuf_oneof:"source"`
	Filter string                   `protobuf:"bytes,4,opt,name=filter,proto3" json:"filter,omitempty"` // 过滤条件，如 "id IN [1,2,3]"
}

func (x *QueryFromSource) Reset() {
	*x = QueryFromSource{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryFromSource) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryFromSource) ProtoMessage() {}

func (x *QueryFromSource) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryFromSource.ProtoReflect.Descriptor instead.
func (*QueryFromSource) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{24}
}

func (x *QueryFromSource) GetAlias() string {
	if x != nil {
		return x.Alias
	}
	return ""
...
func (m *QueryFromSource) GetSource() isQueryFromSource_Source {
	if m != nil {
		return m.Source
	}
	return nil
...
func (x *QueryFromSource) GetCollectionName() string {
	if x, ok := x.GetSource().(*QueryFromSource_CollectionName); ok {
		return x.CollectionName
	}
	return ""
}

func (x *QueryFromSource) GetExternalVectors() *ExternalVectorData {
	if x, ok := x.GetSource().(*QueryFromSource_ExternalVectors); ok {
		return x.ExternalVectors
	}
	return nil
}

func (x *QueryFromSource) GetFilter() string {
	if x != nil {
		return x.Filter
	}
	return ""
...
type isQueryFromSource_Source interface {
	isQueryFromSource_Source()
}

type QueryFromSource_CollectionName struct {
	CollectionName string `protobuf:"bytes,2,opt,name=collection_name,json=collectionName,proto3,oneof"` // 集合名称
}

type QueryFromSource_ExternalVectors struct {
	ExternalVectors *ExternalVectorData `protobuf:"bytes,3,opt,name=external_vectors,json=externalVectors,proto3,oneof"` // 外部向量数据
}

func (*QueryFromSource_CollectionName) isQueryFromSource_Source() {}

func (*QueryFromSource_ExternalVectors) isQueryFromSource_Source() {}

// 外部向量数据
type ExternalVectorData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Vectors    []*GenericValue   `protobuf:"bytes,1,rep,name=vectors,proto3" json:"vectors,omitempty"`                                                                                           // 向量数据
	Dimension  int32             `protobuf:"varint,2,opt,name=dimension,proto3" json:"dimension,omitempty"`                                                                                      // 向量维度
	VectorType VectorType        `protobuf:"varint,3,opt,name=vector_type,json=vectorType,proto3,enum=milvus.proto.plan.VectorType" json:"vector_type,omitempty"`                                // 向量类型
	Metadata   map[string]string `protobuf:"bytes,4,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 元数据，如 {"source": "external", "format": "dense"}
	Version    int32             `protobuf:"varint,5,opt,name=version,proto3" json:"version,omitempty"`                                                                                          // 数据格式版本
	Encoding   string            `protobuf:"bytes,6,opt,name=encoding,proto3" json:"encoding,omitempty"`                                                                                         // 编码格式，如 "float32", "int8"
}

func (x *ExternalVectorData) Reset() {
	*x = ExternalVectorData{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExternalVectorData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExternalVectorData) ProtoMessage() {}

func (x *ExternalVectorData) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExternalVectorData.ProtoReflect.Descriptor instead.
func (*ExternalVectorData) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{25}
}

func (x *ExternalVectorData) GetVectors() []*GenericValue {
	if x != nil {
		return x.Vectors
	}
	return nil
...
func (x *ExternalVectorData) GetDimension() int32 {
	if x != nil {
		return x.Dimension
	}
	return 0
...
func (x *ExternalVectorData) GetVectorType() VectorType {
	if x != nil {
		return x.VectorType
	}
...
func (x *ExternalVectorData) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *ExternalVectorData) GetVersion() int32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *ExternalVectorData) GetEncoding() string {
	if x != nil {
		return x.Encoding
	}
	return ""
...
func (x *Expr) GetDistanceExpr() *DistanceExpr {
	if x, ok := x.GetExpr().(*Expr_DistanceExpr); ok {
		return x.DistanceExpr
	}
	return nil
}

func (x *Expr) GetAliasedExpr() *AliasedExpr {
	if x, ok := x.GetExpr().(*Expr_AliasedExpr); ok {
		return x.AliasedExpr
	}
	return nil
}
...
type Expr_DistanceExpr struct {
	DistanceExpr *DistanceExpr `protobuf:"bytes,17,opt,name=distance_expr,json=distanceExpr,proto3,oneof"` // 新增：距离表达式
}

type Expr_AliasedExpr struct {
	AliasedExpr *AliasedExpr `protobuf:"bytes,18,opt,name=aliased_expr,json=aliasedExpr,proto3,oneof"` // 新增：别名表达式
}
...
func (*Expr_DistanceExpr) isExpr_Expr() {}

func (*Expr_AliasedExpr) isExpr_Expr() {}
...
type QueryPlanNode struct {
	...
	// 距离查询扩展
	IsDistanceQuery bool               `protobuf:"varint,4,opt,name=is_distance_query,json=isDistanceQuery,proto3" json:"is_distance_query,omitempty"` // 是否为距离查询
	FromSources     []*QueryFromSource `protobuf:"bytes,5,rep,name=from_sources,json=fromSources,proto3" json:"from_sources,omitempty"`                // 查询数据源列表
	OutputAliases   []string           `protobuf:"bytes,6,rep,name=output_aliases,json=outputAliases,proto3" json:"output_aliases,omitempty"`          // 输出字段别名
}
...
func (x *QueryPlanNode) GetIsDistanceQuery() bool {
	if x != nil {
...
func (x *QueryPlanNode) GetFromSources() []*QueryFromSource {
	if x != nil {
...
func (x *QueryPlanNode) GetOutputAliases() []string {
	if x != nil {
...
var file_plan_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x44, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x45,
	0x78, 0x70, 0x72, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x45, 0x6e,
	...
	0x61, 0x6c, 0x69, 0x61, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x1a,
	...
	0x0a, 0x06, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x22, 0x50, 0x0a, 0x0b, 0x41, 0x6c, 0x69, 0x61,
	0x73, 0x65, 0x64, 0x45, 0x78, 0x70, 0x72, 0x12, 0x2b, 0x0a, 0x04, 0x65, 0x78, 0x70, 0x72, 0x18,
	...
	0x65, 0x78, 0x70, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x22, 0xc8, 0x01, 0x0a, 0x0f, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x46, 0x72, 0x6f, 0x6d, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x14,
	0x0a, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61,
	0x6c, 0x69, 0x61, 0x73, 0x12, 0x29, 0x0a, 0x0f, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69,
	...
	,
	...
	0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x4f, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x45, 0x78, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x4d,
	...
	,
	...
	,
	...
	0x22, 0x93, 0x02, 0x0a, 0x0d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x6c, 0x61, 0x6e, 0x4e, 0x6f,
	...
	,
	...
	0x61, 0x79, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x10, 0x06, 0x2a, 0x7d, 0x0a, 0x0a, 0x56, 0x65,
	...
	0x38, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x10, 0x05, 0x2a, 0xb7, 0x01, 0x0a, 0x0e, 0x44, 0x69,
	...
	,
...
var file_plan_proto_goTypes = []interface{}{
	...
	(DistanceMetric)(0),                // 3: milvus.proto.plan.DistanceMetric
	(JSONContainsExpr_JSONOp)(0),       // 4: milvus.proto.plan.JSONContainsExpr.JSONOp
	(NullExpr_NullOp)(0),               // 5: milvus.proto.plan.NullExpr.NullOp
	...
	(*UnaryExpr)(nil),                  // 23: milvus.proto.plan.UnaryExpr
	(*BinaryExpr)(nil),                 // 24: milvus.proto.plan.BinaryExpr
	(*BinaryArithOp)(nil),              // 25: milvus.proto.plan.BinaryArithOp
	(*BinaryArithExpr)(nil),            // 26: milvus.proto.plan.BinaryArithExpr
	(*BinaryArithOpEvalRangeExpr)(nil), // 27: milvus.proto.plan.BinaryArithOpEvalRangeExpr
	(*RandomSampleExpr)(nil),           // 28: milvus.proto.plan.RandomSampleExpr
	(*AlwaysTrueExpr)(nil),             // 29: milvus.proto.plan.AlwaysTrueExpr
	(*DistanceExpr)(nil),               // 30: milvus.proto.plan.DistanceExpr
	(*AliasedExpr)(nil),                // 31: milvus.proto.plan.AliasedExpr
	(*QueryFromSource)(nil),            // 32: milvus.proto.plan.QueryFromSource
	(*ExternalVectorData)(nil),         // 33: milvus.proto.plan.ExternalVectorData
	(*Expr)(nil),                       // 34: milvus.proto.plan.Expr
	(*VectorANNS)(nil),                 // 35: milvus.proto.plan.VectorANNS
	(*QueryPlanNode)(nil),              // 36: milvus.proto.plan.QueryPlanNode
	(*PlanNode)(nil),                   // 37: milvus.proto.plan.PlanNode
	nil,                                // 38: milvus.proto.plan.DistanceExpr.ParametersEntry
	nil,                                // 39: milvus.proto.plan.ExternalVectorData.MetadataEntry
	(schemapb.DataType)(0),             // 40: milvus.proto.schema.DataType
}
var file_plan_proto_depIdxs = []int32{
	...
	40, // 2: milvus.proto.plan.Array.element_type:type_name -> milvus.proto.schema.DataType
	10, // 3: milvus.proto.plan.QueryInfo.search_iterator_v2_info:type_name -> milvus.proto.plan.SearchIteratorV2Info
	40, // 4: milvus.proto.plan.ColumnInfo.data_type:type_name -> milvus.proto.schema.DataType
	40, // 5: milvus.proto.plan.ColumnInfo.element_type:type_name -> milvus.proto.schema.DataType
	...
	34, // 16: milvus.proto.plan.CallExpr.function_parameters:type_name -> milvus.proto.plan.Expr
	...
	4,  // 24: milvus.proto.plan.JSONContainsExpr.op:type_name -> milvus.proto.plan.JSONContainsExpr.JSONOp
	12, // 25: milvus.proto.plan.NullExpr.column_info:type_name -> milvus.proto.plan.ColumnInfo
	5,  // 26: milvus.proto.plan.NullExpr.op:type_name -> milvus.proto.plan.NullExpr.NullOp
	6,  // 27: milvus.proto.plan.UnaryExpr.op:type_name -> milvus.proto.plan.UnaryExpr.UnaryOp
	34, // 28: milvus.proto.plan.UnaryExpr.child:type_name -> milvus.proto.plan.Expr
	7,  // 29: milvus.proto.plan.BinaryExpr.op:type_name -> milvus.proto.plan.BinaryExpr.BinaryOp
	34, // 30: milvus.proto.plan.BinaryExpr.left:type_name -> milvus.proto.plan.Expr
	34, // 31: milvus.proto.plan.BinaryExpr.right:type_name -> milvus.proto.plan.Expr
	12, // 32: milvus.proto.plan.BinaryArithOp.column_info:type_name -> milvus.proto.plan.ColumnInfo
	1,  // 33: milvus.proto.plan.BinaryArithOp.arith_op:type_name -> milvus.proto.plan.ArithOpType
	8,  // 34: milvus.proto.plan.BinaryArithOp.right_operand:type_name -> milvus.proto.plan.GenericValue
	34, // 35: milvus.proto.plan.BinaryArithExpr.left:type_name -> milvus.proto.plan.Expr
	34, // 36: milvus.proto.plan.BinaryArithExpr.right:type_name -> milvus.proto.plan.Expr
	1,  // 37: milvus.proto.plan.BinaryArithExpr.op:type_name -> milvus.proto.plan.ArithOpType
	12, // 38: milvus.proto.plan.BinaryArithOpEvalRangeExpr.column_info:type_name -> milvus.proto.plan.ColumnInfo
	1,  // 39: milvus.proto.plan.BinaryArithOpEvalRangeExpr.arith_op:type_name -> milvus.proto.plan.ArithOpType
	8,  // 40: milvus.proto.plan.BinaryArithOpEvalRangeExpr.right_operand:type_name -> milvus.proto.plan.GenericValue
	0,  // 41: milvus.proto.plan.BinaryArithOpEvalRangeExpr.op:type_name -> milvus.proto.plan.OpType
	8,  // 42: milvus.proto.plan.BinaryArithOpEvalRangeExpr.value:type_name -> milvus.proto.plan.GenericValue
	34, // 43: milvus.proto.plan.RandomSampleExpr.predicate:type_name -> milvus.proto.plan.Expr
	34, // 44: milvus.proto.plan.DistanceExpr.left_vector:type_name -> milvus.proto.plan.Expr
	34, // 45: milvus.proto.plan.DistanceExpr.right_vector:type_name -> milvus.proto.plan.Expr
	3,  // 46: milvus.proto.plan.DistanceExpr.metric_enum:type_name -> milvus.proto.plan.DistanceMetric
	38, // 47: milvus.proto.plan.DistanceExpr.parameters:type_name -> milvus.proto.plan.DistanceExpr.ParametersEntry
	34, // 48: milvus.proto.plan.AliasedExpr.expr:type_name -> milvus.proto.plan.Expr
	33, // 49: milvus.proto.plan.QueryFromSource.external_vectors:type_name -> milvus.proto.plan.ExternalVectorData
	8,  // 50: milvus.proto.plan.ExternalVectorData.vectors:type_name -> milvus.proto.plan.GenericValue
	2,  // 51: milvus.proto.plan.ExternalVectorData.vector_type:type_name -> milvus.proto.plan.VectorType
	39, // 52: milvus.proto.plan.ExternalVectorData.metadata:type_name -> milvus.proto.plan.ExternalVectorData.MetadataEntry
	20, // 53: milvus.proto.plan.Expr.term_expr:type_name -> milvus.proto.plan.TermExpr
	23, // 54: milvus.proto.plan.Expr.unary_expr:type_name -> milvus.proto.plan.UnaryExpr
	24, // 55: milvus.proto.plan.Expr.binary_expr:type_name -> milvus.proto.plan.BinaryExpr
	19, // 56: milvus.proto.plan.Expr.compare_expr:type_name -> milvus.proto.plan.CompareExpr
	16, // 57: milvus.proto.plan.Expr.unary_range_expr:type_name -> milvus.proto.plan.UnaryRangeExpr
	17, // 58: milvus.proto.plan.Expr.binary_range_expr:type_name -> milvus.proto.plan.BinaryRangeExpr
	27, // 59: milvus.proto.plan.Expr.binary_arith_op_eval_range_expr:type_name -> milvus.proto.plan.BinaryArithOpEvalRangeExpr
	26, // 60: milvus.proto.plan.Expr.binary_arith_expr:type_name -> milvus.proto.plan.BinaryArithExpr
	15, // 61: milvus.proto.plan.Expr.value_expr:type_name -> milvus.proto.plan.ValueExpr
	13, // 62: milvus.proto.plan.Expr.column_expr:type_name -> milvus.proto.plan.ColumnExpr
	14, // 63: milvus.proto.plan.Expr.exists_expr:type_name -> milvus.proto.plan.ExistsExpr
	29, // 64: milvus.proto.plan.Expr.always_true_expr:type_name -> milvus.proto.plan.AlwaysTrueExpr
	21, // 65: milvus.proto.plan.Expr.json_contains_expr:type_name -> milvus.proto.plan.JSONContainsExpr
	18, // 66: milvus.proto.plan.Expr.call_expr:type_name -> milvus.proto.plan.CallExpr
	22, // 67: milvus.proto.plan.Expr.null_expr:type_name -> milvus.proto.plan.NullExpr
	28, // 68: milvus.proto.plan.Expr.random_sample_expr:type_name -> milvus.proto.plan.RandomSampleExpr
	30, // 69: milvus.proto.plan.Expr.distance_expr:type_name -> milvus.proto.plan.DistanceExpr
	31, // 70: milvus.proto.plan.Expr.aliased_expr:type_name -> milvus.proto.plan.AliasedExpr
	2,  // 71: milvus.proto.plan.VectorANNS.vector_type:type_name -> milvus.proto.plan.VectorType
	34, // 72: milvus.proto.plan.VectorANNS.predicates:type_name -> milvus.proto.plan.Expr
	11, // 73: milvus.proto.plan.VectorANNS.query_info:type_name -> milvus.proto.plan.QueryInfo
	34, // 74: milvus.proto.plan.QueryPlanNode.predicates:type_name -> milvus.proto.plan.Expr
	32, // 75: milvus.proto.plan.QueryPlanNode.from_sources:type_name -> milvus.proto.plan.QueryFromSource
	35, // 76: milvus.proto.plan.PlanNode.vector_anns:type_name -> milvus.proto.plan.VectorANNS
	34, // 77: milvus.proto.plan.PlanNode.predicates:type_name -> milvus.proto.plan.Expr
	36, // 78: milvus.proto.plan.PlanNode.query:type_name -> milvus.proto.plan.QueryPlanNode
...
func file_plan_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_plan_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExternalVectorData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_plan_proto_msgTypes[22].OneofWrappers = []interface{}{
		(*DistanceExpr_MetricEnum)(nil),
		(*DistanceExpr_MetricString)(nil),
	}
	file_plan_proto_msgTypes[24].OneofWrappers = []interface{}{
		(*QueryFromSource_CollectionName)(nil),
		(*QueryFromSource_ExternalVectors)(nil),
	}
	file_plan_proto_msgTypes[26].OneofWrappers = []interface{}{
		...
		(*Expr_DistanceExpr)(nil),
		(*Expr_AliasedExpr)(nil),
	}
