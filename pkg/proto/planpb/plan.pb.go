...
type BinaryArithOpEvalRangeExprWithFields struct {
	state                     protoimpl.MessageState `protogen:"open.v1"`
	LeftColumnInfo            *ColumnInfo            `protobuf:"bytes,1,opt,name=left_column_info,json=leftColumnInfo,proto3" json:"left_column_info,omitempty"`              // left column (e.g., price)
	RightColumnInfo           *ColumnInfo            `protobuf:"bytes,2,opt,name=right_column_info,json=rightColumnInfo,proto3" json:"right_column_info,omitempty"`           // right column (e.g., quantity)
	ArithOp                   ArithOpType            `protobuf:"varint,3,opt,name=arith_op,json=arithOp,proto3,enum=milvus.proto.plan.ArithOpType" json:"arith_op,omitempty"` // arithmetic operation (e.g., Mul)
	Op                        OpType                 `protobuf:"varint,4,opt,name=op,proto3,enum=milvus.proto.plan.OpType" json:"op,omitempty"`                               // comparison operation (e.g., GreaterThan)
	Value                     *GenericValue          `protobuf:"bytes,5,opt,name=value,proto3" json:"value,omitempty"`                                                        // value to compare against (e.g., 100)
	ValueTemplateVariableName string                 `protobuf:"bytes,6,opt,name=value_template_variable_name,json=valueTemplateVariableName,proto3" json:"value_template_variable_name,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}

func (x *BinaryArithOpEvalRangeExprWithFields) Reset() {
	*x = BinaryArithOpEvalRangeExprWithFields{}
	mi := &file_plan_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BinaryArithOpEvalRangeExprWithFields) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BinaryArithOpEvalRangeExprWithFields) ProtoMessage() {}

func (x *BinaryArithOpEvalRangeExprWithFields) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BinaryArithOpEvalRangeExprWithFields.ProtoReflect.Descriptor instead.
func (*BinaryArithOpEvalRangeExprWithFields) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{21}
}

func (x *BinaryArithOpEvalRangeExprWithFields) GetLeftColumnInfo() *ColumnInfo {
	if x != nil {
		return x.LeftColumnInfo
	}
	return nil
...
func (x *BinaryArithOpEvalRangeExprWithFields) GetRightColumnInfo() *ColumnInfo {
	if x != nil {
		return x.RightColumnInfo
	}
	return nil
...
func (x *BinaryArithOpEvalRangeExprWithFields) GetArithOp() ArithOpType {
	if x != nil {
		return x.ArithOp
	}
	return ArithOpType_Unknown
...
func (x *BinaryArithOpEvalRangeExprWithFields) GetOp() OpType {
	if x != nil {
		return x.Op
	}
	return OpType_Invalid
...
func (x *BinaryArithOpEvalRangeExprWithFields) GetValue() *GenericValue {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *BinaryArithOpEvalRangeExprWithFields) GetValueTemplateVariableName() string {
	if x != nil {
		return x.ValueTemplateVariableName
	}
	return ""
...
type Expr struct {
	...
	//	*Expr_MatchExpr
	//	*Expr_BinaryArithOpEvalRangeExprWithFields
...
func (x *Expr) GetBinaryArithOpEvalRangeExprWithFields() *BinaryArithOpEvalRangeExprWithFields {
	if x != nil {
		if x, ok := x.Expr.(*Expr_BinaryArithOpEvalRangeExprWithFields); ok {
			return x.BinaryArithOpEvalRangeExprWithFields
		}
	}
	return nil
}
...
type Expr_BinaryArithOpEvalRangeExprWithFields struct {
	BinaryArithOpEvalRangeExprWithFields *BinaryArithOpEvalRangeExprWithFields `protobuf:"bytes,22,opt,name=binary_arith_op_eval_range_expr_with_fields,json=binaryArithOpEvalRangeExprWithFields,proto3,oneof"`
}
...
func (*Expr_BinaryArithOpEvalRangeExprWithFields) isExpr_Expr() {}
...
const file_plan_proto_rawDesc = "" +
	...
	"\x1cvalue_template_variable_name\x18\a \x01(\tR\x19valueTemplateVariableName\"\x98\x03\n" +
	"$BinaryArithOpEvalRangeExprWithFields\x12G\n" +
	"\x10left_column_info\x18\x01 \x01(\v2\x1d.milvus.proto.plan.ColumnInfoR\x0eleftColumnInfo\x12I\n" +
	"\x11right_column_info\x18\x02 \x01(\v2\x1d.milvus.proto.plan.ColumnInfoR\x0frightColumnInfo\x129\n" +
	"\barith_op\x18\x03 \x01(\x0e2\x1e.milvus.proto.plan.ArithOpTypeR\aarithOp\x12)\n" +
	"\x02op\x18\x04 \x01(\x0e2\x19.milvus.proto.plan.OpTypeR\x02op\x125\n" +
	"\x05value\x18\x05 \x01(\v2\x1f.milvus.proto.plan.GenericValueR\x05value\x12?\n" +
	"\x1cvalue_template_variable_name\x18\x06 \x01(\tR\x19valueTemplateVariableName\"n\n" +
	...
	"\rcompare_value\x18\x05 \x01(\v2\x1f.milvus.proto.plan.GenericValueR\fcompareValue\"\xd7\r\n" +
	"\x04Expr\x12:\n" +
	...
	"\n" +
	"match_expr\x18\x15 \x01(\v2\x1c.milvus.proto.plan.MatchExprH\x00R\tmatchExpr\x12\x94\x01\n" +
	"+binary_arith_op_eval_range_expr_with_fields\x18\x16 \x01(\v27.milvus.proto.plan.BinaryArithOpEvalRangeExprWithFieldsH\x00R$binaryArithOpEvalRangeExprWithFields\x12\x1f\n" +
	...
	"\x0fplaceholder_tag\x18\x05 \x01(\tR\x0eplaceholderTag\"y\n" +
	"\rQueryPlanNode\x127\n" +
	"\n" +
	"predicates\x18\x01 \x01(\v2\x17.milvus.proto.plan.ExprR\n" +
	"predicates\x12\x19\n" +
	"\bis_count\x18\x02 \x01(\bR\aisCount\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x03R\x05limit\"\xc8\x01\n" +
	"\rScoreFunction\x12/\n" +
...
var file_plan_proto_goTypes = []any{
	...
	(*BinaryArithOpEvalRangeExprWithFields)(nil), // 33: milvus.proto.plan.BinaryArithOpEvalRangeExprWithFields
	...
	(*QueryPlanNode)(nil),                        // 42: milvus.proto.plan.QueryPlanNode
	(*ScoreFunction)(nil),                        // 43: milvus.proto.plan.ScoreFunction
	(*ScoreOption)(nil),                          // 44: milvus.proto.plan.ScoreOption
	(*PlanOption)(nil),                           // 45: milvus.proto.plan.PlanOption
	(*PlanNode)(nil),                             // 46: milvus.proto.plan.PlanNode
	(schemapb.DataType)(0),                       // 47: milvus.proto.schema.DataType
	(*commonpb.KeyValuePair)(nil),                // 48: milvus.proto.common.KeyValuePair
}
var file_plan_proto_depIdxs = []int32{
	...
	47, // 2: milvus.proto.plan.Array.element_type:type_name -> milvus.proto.schema.DataType
	14, // 3: milvus.proto.plan.QueryInfo.search_iterator_v2_info:type_name -> milvus.proto.plan.SearchIteratorV2Info
	47, // 4: milvus.proto.plan.QueryInfo.json_type:type_name -> milvus.proto.schema.DataType
	47, // 5: milvus.proto.plan.ColumnInfo.data_type:type_name -> milvus.proto.schema.DataType
	47, // 6: milvus.proto.plan.ColumnInfo.element_type:type_name -> milvus.proto.schema.DataType
	...
	16, // 46: milvus.proto.plan.BinaryArithOpEvalRangeExprWithFields.left_column_info:type_name -> milvus.proto.plan.ColumnInfo
	16, // 47: milvus.proto.plan.BinaryArithOpEvalRangeExprWithFields.right_column_info:type_name -> milvus.proto.plan.ColumnInfo
	1,  // 48: milvus.proto.plan.BinaryArithOpEvalRangeExprWithFields.arith_op:type_name -> milvus.proto.plan.ArithOpType
	0,  // 49: milvus.proto.plan.BinaryArithOpEvalRangeExprWithFields.op:type_name -> milvus.proto.plan.OpType
	12, // 50: milvus.proto.plan.BinaryArithOpEvalRangeExprWithFields.value:type_name -> milvus.proto.plan.GenericValue
	40, // 51: milvus.proto.plan.RandomSampleExpr.predicate:type_name -> milvus.proto.plan.Expr
	40, // 52: milvus.proto.plan.ElementFilterExpr.element_expr:type_name -> milvus.proto.plan.Expr
	40, // 53: milvus.proto.plan.ElementFilterExpr.predicate:type_name -> milvus.proto.plan.Expr
	40, // 54: milvus.proto.plan.MatchExpr.predicate:type_name -> milvus.proto.plan.Expr
	3,  // 55: milvus.proto.plan.MatchExpr.match_type:type_name -> milvus.proto.plan.MatchType
	16, // 56: milvus.proto.plan.TimestamptzArithCompareExpr.timestamptz_column:type_name -> milvus.proto.plan.ColumnInfo
	1,  // 57: milvus.proto.plan.TimestamptzArithCompareExpr.arith_op:type_name -> milvus.proto.plan.ArithOpType
	38, // 58: milvus.proto.plan.TimestamptzArithCompareExpr.interval:type_name -> milvus.proto.plan.Interval
	0,  // 59: milvus.proto.plan.TimestamptzArithCompareExpr.compare_op:type_name -> milvus.proto.plan.OpType
	12, // 60: milvus.proto.plan.TimestamptzArithCompareExpr.compare_value:type_name -> milvus.proto.plan.GenericValue
	24, // 61: milvus.proto.plan.Expr.term_expr:type_name -> milvus.proto.plan.TermExpr
	28, // 62: milvus.proto.plan.Expr.unary_expr:type_name -> milvus.proto.plan.UnaryExpr
	29, // 63: milvus.proto.plan.Expr.binary_expr:type_name -> milvus.proto.plan.BinaryExpr
	23, // 64: milvus.proto.plan.Expr.compare_expr:type_name -> milvus.proto.plan.CompareExpr
	20, // 65: milvus.proto.plan.Expr.unary_range_expr:type_name -> milvus.proto.plan.UnaryRangeExpr
	21, // 66: milvus.proto.plan.Expr.binary_range_expr:type_name -> milvus.proto.plan.BinaryRangeExpr
	32, // 67: milvus.proto.plan.Expr.binary_arith_op_eval_range_expr:type_name -> milvus.proto.plan.BinaryArithOpEvalRangeExpr
	31, // 68: milvus.proto.plan.Expr.binary_arith_expr:type_name -> milvus.proto.plan.BinaryArithExpr
	19, // 69: milvus.proto.plan.Expr.value_expr:type_name -> milvus.proto.plan.ValueExpr
	17, // 70: milvus.proto.plan.Expr.column_expr:type_name -> milvus.proto.plan.ColumnExpr
	18, // 71: milvus.proto.plan.Expr.exists_expr:type_name -> milvus.proto.plan.ExistsExpr
	37, // 72: milvus.proto.plan.Expr.always_true_expr:type_name -> milvus.proto.plan.AlwaysTrueExpr
	25, // 73: milvus.proto.plan.Expr.json_contains_expr:type_name -> milvus.proto.plan.JSONContainsExpr
	22, // 74: milvus.proto.plan.Expr.call_expr:type_name -> milvus.proto.plan.CallExpr
	26, // 75: milvus.proto.plan.Expr.null_expr:type_name -> milvus.proto.plan.NullExpr
	34, // 76: milvus.proto.plan.Expr.random_sample_expr:type_name -> milvus.proto.plan.RandomSampleExpr
	27, // 77: milvus.proto.plan.Expr.gisfunction_filter_expr:type_name -> milvus.proto.plan.GISFunctionFilterExpr
	39, // 78: milvus.proto.plan.Expr.timestamptz_arith_compare_expr:type_name -> milvus.proto.plan.TimestamptzArithCompareExpr
	...
	33, // 81: milvus.proto.plan.Expr.binary_arith_op_eval_range_expr_with_fields:type_name -> milvus.proto.plan.BinaryArithOpEvalRangeExprWithFields
	2,  // 82: milvus.proto.plan.VectorANNS.vector_type:type_name -> milvus.proto.plan.VectorType
	40, // 83: milvus.proto.plan.VectorANNS.predicates:type_name -> milvus.proto.plan.Expr
	15, // 84: milvus.proto.plan.VectorANNS.query_info:type_name -> milvus.proto.plan.QueryInfo
	40, // 85: milvus.proto.plan.QueryPlanNode.predicates:type_name -> milvus.proto.plan.Expr
	40, // 86: milvus.proto.plan.ScoreFunction.filter:type_name -> milvus.proto.plan.Expr
	4,  // 87: milvus.proto.plan.ScoreFunction.type:type_name -> milvus.proto.plan.FunctionType
	48, // 88: milvus.proto.plan.ScoreFunction.params:type_name -> milvus.proto.common.KeyValuePair
	6,  // 89: milvus.proto.plan.ScoreOption.boost_mode:type_name -> milvus.proto.plan.BoostMode
	5,  // 90: milvus.proto.plan.ScoreOption.function_mode:type_name -> milvus.proto.plan.FunctionMode
	41, // 91: milvus.proto.plan.PlanNode.vector_anns:type_name -> milvus.proto.plan.VectorANNS
	40, // 92: milvus.proto.plan.PlanNode.predicates:type_name -> milvus.proto.plan.Expr
	42, // 93: milvus.proto.plan.PlanNode.query:type_name -> milvus.proto.plan.QueryPlanNode
	43, // 94: milvus.proto.plan.PlanNode.scorers:type_name -> milvus.proto.plan.ScoreFunction
	45, // 95: milvus.proto.plan.PlanNode.plan_options:type_name -> milvus.proto.plan.PlanOption
	44, // 96: milvus.proto.plan.PlanNode.score_option:type_name -> milvus.proto.plan.ScoreOption
...
func file_plan_proto_init() {
	...
	file_plan_proto_msgTypes[28].OneofWrappers = []any{
		(*Expr_TermExpr)(nil),
		(*Expr_UnaryExpr)(nil),
		(*Expr_BinaryExpr)(nil),
		...
		(*Expr_MatchExpr)(nil),
		(*Expr_BinaryArithOpEvalRangeExprWithFields)(nil),
	}
