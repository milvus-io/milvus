...
// MatchColumnInfo locates the ARRAY target of a MATCH_* expression. Field ID
// resolves scalar ARRAY fields; field name also supports struct ARRAY lookup.
type MatchColumnInfo struct {
	...
	FieldName string `protobuf:"bytes,2,opt,name=field_name,json=fieldName,proto3" json:"field_name,omitempty"` // Target field name (kept for struct-array lookup)
}
...
var file_plan_proto_rawDesc = []byte{
	...
	0x4b, 0x0a, 0x0f, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x49, 0x6e,
	0x66, 0x6f, 0x12, 0x19, 0x0a, 0x08, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x49, 0x64, 0x12, 0x1d, 0x0a,
	0x0a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xf6, 0x01, 0x0a,
...
var file_plan_proto_depIdxs = []int32{
	...
	36, // 51: milvus.proto.plan.MatchExpr.column:type_name -> milvus.proto.plan.MatchColumnInfo
	17, // 52: milvus.proto.plan.TimestamptzArithCompareExpr.timestamptz_column:type_name -> milvus.proto.plan.ColumnInfo
	...
	16, // 79: milvus.proto.plan.VectorANNS.query_info:type_name -> milvus.proto.plan.QueryInfo
	...
	44, // 83: milvus.proto.plan.QueryPlanNode.order_by_fields:type_name -> milvus.proto.plan.OrderByField
	46, // 84: milvus.proto.plan.QueryPlanNode.query_iterator_cursor:type_name -> milvus.proto.plan.QueryIteratorCursor
	41, // 85: milvus.proto.plan.ScoreFunction.filter:type_name -> milvus.proto.plan.Expr
	5,  // 86: milvus.proto.plan.ScoreFunction.type:type_name -> milvus.proto.plan.FunctionType
	52, // 87: milvus.proto.plan.ScoreFunction.params:type_name -> milvus.proto.common.KeyValuePair
	7,  // 88: milvus.proto.plan.ScoreOption.boost_mode:type_name -> milvus.proto.plan.BoostMode
	6,  // 89: milvus.proto.plan.ScoreOption.function_mode:type_name -> milvus.proto.plan.FunctionMode
	42, // 90: milvus.proto.plan.PlanNode.vector_anns:type_name -> milvus.proto.plan.VectorANNS
	41, // 91: milvus.proto.plan.PlanNode.predicates:type_name -> milvus.proto.plan.Expr
	45, // 92: milvus.proto.plan.PlanNode.query:type_name -> milvus.proto.plan.QueryPlanNode
	47, // 93: milvus.proto.plan.PlanNode.scorers:type_name -> milvus.proto.plan.ScoreFunction
	49, // 94: milvus.proto.plan.PlanNode.plan_options:type_name -> milvus.proto.plan.PlanOption
	48, // 95: milvus.proto.plan.PlanNode.score_option:type_name -> milvus.proto.plan.ScoreOption
	53, // 96: milvus.proto.plan.PlanNode.querynode_function_chains:type_name -> milvus.proto.schema.FunctionChain
