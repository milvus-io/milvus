...
// SegmentPkHint contains filtered PK values for a specific segment.
// Used by Delegator to pass bloom filter results to QueryNode via CGo.
type SegmentPkHint struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SegmentId int64 `protobuf:"varint,1,opt,name=segment_id,json=segmentId,proto3" json:"segment_id,omitempty"`
	// Filtered PK values that may exist in this segment (based on bloom filter).
	// Empty means this segment passed the merged filter and should
	// fallback to original TermExpr PK values.
	FilteredPkValues []*GenericValue `protobuf:"bytes,2,rep,name=filtered_pk_values,json=filteredPkValues,proto3" json:"filtered_pk_values,omitempty"`
}

func (x *SegmentPkHint) Reset() {
	*x = SegmentPkHint{}
	if protoimpl.UnsafeEnabled {
...
func (x *SegmentPkHint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SegmentPkHint) ProtoMessage() {}

func (x *SegmentPkHint) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SegmentPkHint.ProtoReflect.Descriptor instead.
func (*SegmentPkHint) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{34}
}

func (x *SegmentPkHint) GetSegmentId() int64 {
	if x != nil {
		return x.SegmentId
	}
	return 0
...
func (x *SegmentPkHint) GetFilteredPkValues() []*GenericValue {
	if x != nil {
		return x.FilteredPkValues
	}
	return nil
}

// SegmentPkHintList wraps a list of SegmentPkHint for serialization across CGo boundary.
type SegmentPkHintList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Hints []*SegmentPkHint `protobuf:"bytes,1,rep,name=hints,proto3" json:"hints,omitempty"`
}

func (x *SegmentPkHintList) Reset() {
	*x = SegmentPkHintList{}
	if protoimpl.UnsafeEnabled {
...
func (x *SegmentPkHintList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SegmentPkHintList) ProtoMessage() {}

func (x *SegmentPkHintList) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SegmentPkHintList.ProtoReflect.Descriptor instead.
func (*SegmentPkHintList) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{35}
}

func (x *SegmentPkHintList) GetHints() []*SegmentPkHint {
	if x != nil {
		return x.Hints
	}
	return nil
...
var file_plan_proto_rawDesc = []byte{
	...
	,
...
var file_plan_proto_goTypes = []interface{}{
	...
	(*SegmentPkHint)(nil),               // 47: milvus.proto.plan.SegmentPkHint
	(*SegmentPkHintList)(nil),           // 48: milvus.proto.plan.SegmentPkHintList
...
var file_plan_proto_depIdxs = []int32{
	...
	51, // 84: milvus.proto.plan.ScoreFunction.params:type_name -> milvus.proto.common.KeyValuePair
	...
	13, // 87: milvus.proto.plan.SegmentPkHint.filtered_pk_values:type_name -> milvus.proto.plan.GenericValue
	47, // 88: milvus.proto.plan.SegmentPkHintList.hints:type_name -> milvus.proto.plan.SegmentPkHint
	...
	43, // 91: milvus.proto.plan.PlanNode.query:type_name -> milvus.proto.plan.QueryPlanNode
	44, // 92: milvus.proto.plan.PlanNode.scorers:type_name -> milvus.proto.plan.ScoreFunction
	46, // 93: milvus.proto.plan.PlanNode.plan_options:type_name -> milvus.proto.plan.PlanOption
	45, // 94: milvus.proto.plan.PlanNode.score_option:type_name -> milvus.proto.plan.ScoreOption
...
func file_plan_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_plan_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SegmentPkHintList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
