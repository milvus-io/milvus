...
// MatchColumnInfo locates the target collection of a MATCH_* expression.
// It supports three kinds of sources, distinguished by data_type:
//   - ArrayOfStruct  -> struct array field (e.g., MATCH_ALL(structA, $[sub] == x))
//   - Array          -> plain array field  (e.g., MATCH_ALL(arrA,    $ == x))
//   - JSON           -> JSON array path    (e.g., MATCH_ALL(jsonA["p"], $ == x))
type MatchColumnInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	FieldId     int64             `protobuf:"varint,1,opt,name=field_id,json=fieldId,proto3" json:"field_id,omitempty"`                                               // Target field ID
	FieldName   string            `protobuf:"bytes,2,opt,name=field_name,json=fieldName,proto3" json:"field_name,omitempty"`                                          // Target field name (kept for name-based lookup)
	DataType    schemapb.DataType `protobuf:"varint,3,opt,name=data_type,json=dataType,proto3,enum=milvus.proto.schema.DataType" json:"data_type,omitempty"`          // ArrayOfStruct / Array / JSON, used for dispatch
	ElementType schemapb.DataType `protobuf:"varint,4,opt,name=element_type,json=elementType,proto3,enum=milvus.proto.schema.DataType" json:"element_type,omitempty"` // Element scalar type, meaningful for Array
	NestedPath  []string          `protobuf:"bytes,5,rep,name=nested_path,json=nestedPath,proto3" json:"nested_path,omitempty"`                                       // JSON path segments, meaningful for JSON (e.g., ["object","admins"])
}

func (x *MatchColumnInfo) Reset() {
	*x = MatchColumnInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *MatchColumnInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MatchColumnInfo) ProtoMessage() {}

func (x *MatchColumnInfo) ProtoReflect() protoreflect.Message {
	mi := &file_plan_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MatchColumnInfo.ProtoReflect.Descriptor instead.
func (*MatchColumnInfo) Descriptor() ([]byte, []int) {
	return file_plan_proto_rawDescGZIP(), []int{23}
}

func (x *MatchColumnInfo) GetFieldId() int64 {
	if x != nil {
		return x.FieldId
	}
	return 0
...
func (x *MatchColumnInfo) GetFieldName() string {
	if x != nil {
		return x.FieldName
	}
	return ""
...
func (x *MatchColumnInfo) GetDataType() schemapb.DataType {
	if x != nil {
		return x.DataType
	}
	return schemapb.DataType(0)
...
func (x *MatchColumnInfo) GetElementType() schemapb.DataType {
	if x != nil {
		return x.ElementType
	}
	return schemapb.DataType(0)
...
func (x *MatchColumnInfo) GetNestedPath() []string {
	if x != nil {
		return x.NestedPath
	}
	return nil
...
type MatchExpr struct {
	...
	// Deprecated legacy locator: the struct array field name. Tag 1 shipped on
	// the wire with this meaning (struct-array MATCH, #46518), so it must keep
	// its number and type for rolling-upgrade compatibility. New plans use
	// `column`; proxies keep writing struct_name so old querynodes can still
	// resolve struct-array targets, and querynodes fall back to it when
	// `column` is absent (plan produced by an old proxy).
	//
	...
	Predicate  *Expr            `protobuf:"bytes,2,opt,name=predicate,proto3" json:"predicate,omitempty"`                                                    // The condition expression using $ or $[field] accessors
	...
	Count      int64            `protobuf:"varint,4,opt,name=count,proto3" json:"count,omitempty"`                                                           // For MatchLeast/MatchMost/MatchExact: the count parameter (N)
	Column     *MatchColumnInfo `protobuf:"bytes,5,opt,name=column,proto3" json:"column,omitempty"`                                                          // Target column locator (supersedes struct_name)
}
...
func (x *MatchExpr) GetColumn() *MatchColumnInfo {
	if x != nil {
		return x.Column
	}
	return nil
...
var file_plan_proto_rawDesc = []byte{
	...
	0xea, 0x01, 0x0a, 0x0f, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x49,
	0x6e, 0x66, 0x6f, 0x12, 0x19, 0x0a, 0x08, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x49, 0x64, 0x12, 0x1d,
	...
	0x08, 0x64, 0x61, 0x74, 0x61, 0x54, 0x79, 0x70, 0x65, 0x12, 0x40, 0x0a, 0x0c, 0x65, 0x6c, 0x65,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0b,
	0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x6e,
	0x65, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x0a, 0x6e, 0x65, 0x73, 0x74, 0x65, 0x64, 0x50, 0x61, 0x74, 0x68, 0x22, 0xf6, 0x01, 0x0a,
	0x09, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x45, 0x78, 0x70, 0x72, 0x12, 0x23, 0x0a, 0x0b, 0x73, 0x74,
	0x72, 0x75, 0x63, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x02, 0x18, 0x01, 0x52, 0x0a, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12,
	...
	0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x3b, 0x0a, 0x0a, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x6d, 0x69, 0x6c,
	0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x4d,
	...
	0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x3a, 0x0a, 0x06, 0x63, 0x6f, 0x6c,
	0x75, 0x6d, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x6d, 0x69, 0x6c, 0x76,
	0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x4d, 0x61,
	0x74, 0x63, 0x68, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x63,
	0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x22, 0x10, 0x0a, 0x0e, 0x41, 0x6c, 0x77, 0x61, 0x79, 0x73, 0x54,
	...
	0x75, 0x65, 0x22, 0xc0, 0x0c, 0x0a, 0x04, 0x45, 0x78, 0x70, 0x72, 0x12, 0x3a, 0x0a, 0x09, 0x74,
	...
	0x00, 0x52, 0x09, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x45, 0x78, 0x70, 0x72, 0x12, 0x1f, 0x0a, 0x0b,
	...
	0x70, 0x6c, 0x61, 0x63, 0x65, 0x68, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x54, 0x61, 0x67, 0x22, 0x56,
	0x0a, 0x09, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x12, 0x2e, 0x0a, 0x02, 0x6f,
	0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x41, 0x67, 0x67, 0x72,
	0x65, 0x67, 0x61, 0x74, 0x65, 0x4f, 0x70, 0x52, 0x02, 0x6f, 0x70, 0x12, 0x19, 0x0a, 0x08, 0x66,
	0x69, 0x65, 0x6c, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x66,
	0x69, 0x65, 0x6c, 0x64, 0x49, 0x64, 0x22, 0x68, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x42,
	...
	0x1f, 0x0a, 0x0b, 0x6e, 0x75, 0x6c, 0x6c, 0x73, 0x5f, 0x66, 0x69, 0x72, 0x73, 0x74, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x6e, 0x75, 0x6c, 0x6c, 0x73, 0x46, 0x69, 0x72, 0x73, 0x74,
	0x22, 0xa8, 0x03, 0x0a, 0x0d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x6c, 0x61, 0x6e, 0x4e, 0x6f,
	0x64, 0x65, 0x12, 0x37, 0x0a, 0x0a, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73,
	...
	,
	...
	,
	...
	0x73, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x73, 0x22, 0xec, 0x04, 0x0a, 0x08, 0x50, 0x6c, 0x61,
	...
	0x6e, 0x52, 0x0b, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x21,
	...
	0x01, 0x12, 0x5e, 0x0a, 0x19, 0x71, 0x75, 0x65, 0x72, 0x79, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x66,
	0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x73, 0x18, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x52, 0x17, 0x71, 0x75, 0x65, 0x72, 0x79, 0x6e,
	0x6f, 0x64, 0x65, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x69, 0x6e,
	0x73, 0x42, 0x06, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x2a, 0x8e, 0x02, 0x0a, 0x06, 0x4f, 0x70, 0x54, 0x79,
	...
	0x63, 0x68, 0x10, 0x0f, 0x12, 0x0e, 0x0a, 0x0a, 0x52, 0x65, 0x67, 0x65, 0x78, 0x4d, 0x61, 0x74,
	0x63, 0x68, 0x10, 0x10, 0x12, 0x12, 0x0a, 0x0e, 0x54, 0x65, 0x78, 0x74, 0x4d, 0x61, 0x74, 0x63,
	0x68, 0x46, 0x75, 0x7a, 0x7a, 0x79, 0x10, 0x11, 0x2a, 0x7b, 0x0a, 0x0b, 0x41, 0x72, 0x69, 0x74,
	...
	0x10, 0x06, 0x12, 0x0a, 0x0a, 0x06, 0x42, 0x69, 0x74, 0x41, 0x6e, 0x64, 0x10, 0x07, 0x12, 0x09,
	0x0a, 0x05, 0x42, 0x69, 0x74, 0x4f, 0x72, 0x10, 0x08, 0x12, 0x0a, 0x0a, 0x06, 0x42, 0x69, 0x74,
	0x58, 0x6f, 0x72, 0x10, 0x09, 0x2a, 0xfa, 0x01, 0x0a, 0x0a, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72,
	...
	0x2f, 0x76, 0x33, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x6c, 0x61, 0x6e, 0x70, 0x62,
...
var file_plan_proto_goTypes = []interface{}{
	...
	(*MatchColumnInfo)(nil),             // 36: milvus.proto.plan.MatchColumnInfo
...
var file_plan_proto_depIdxs = []int32{
	...
	51, // 49: milvus.proto.plan.MatchColumnInfo.data_type:type_name -> milvus.proto.schema.DataType
	51, // 50: milvus.proto.plan.MatchColumnInfo.element_type:type_name -> milvus.proto.schema.DataType
	41, // 51: milvus.proto.plan.MatchExpr.predicate:type_name -> milvus.proto.plan.Expr
	3,  // 52: milvus.proto.plan.MatchExpr.match_type:type_name -> milvus.proto.plan.MatchType
	36, // 53: milvus.proto.plan.MatchExpr.column:type_name -> milvus.proto.plan.MatchColumnInfo
	...
	39, // 56: milvus.proto.plan.TimestamptzArithCompareExpr.interval:type_name -> milvus.proto.plan.Interval
	...
	25, // 59: milvus.proto.plan.Expr.term_expr:type_name -> milvus.proto.plan.TermExpr
	29, // 60: milvus.proto.plan.Expr.unary_expr:type_name -> milvus.proto.plan.UnaryExpr
	30, // 61: milvus.proto.plan.Expr.binary_expr:type_name -> milvus.proto.plan.BinaryExpr
	24, // 62: milvus.proto.plan.Expr.compare_expr:type_name -> milvus.proto.plan.CompareExpr
	21, // 63: milvus.proto.plan.Expr.unary_range_expr:type_name -> milvus.proto.plan.UnaryRangeExpr
	22, // 64: milvus.proto.plan.Expr.binary_range_expr:type_name -> milvus.proto.plan.BinaryRangeExpr
	33, // 65: milvus.proto.plan.Expr.binary_arith_op_eval_range_expr:type_name -> milvus.proto.plan.BinaryArithOpEvalRangeExpr
	32, // 66: milvus.proto.plan.Expr.binary_arith_expr:type_name -> milvus.proto.plan.BinaryArithExpr
	20, // 67: milvus.proto.plan.Expr.value_expr:type_name -> milvus.proto.plan.ValueExpr
	18, // 68: milvus.proto.plan.Expr.column_expr:type_name -> milvus.proto.plan.ColumnExpr
	19, // 69: milvus.proto.plan.Expr.exists_expr:type_name -> milvus.proto.plan.ExistsExpr
	38, // 70: milvus.proto.plan.Expr.always_true_expr:type_name -> milvus.proto.plan.AlwaysTrueExpr
	26, // 71: milvus.proto.plan.Expr.json_contains_expr:type_name -> milvus.proto.plan.JSONContainsExpr
	23, // 72: milvus.proto.plan.Expr.call_expr:type_name -> milvus.proto.plan.CallExpr
	27, // 73: milvus.proto.plan.Expr.null_expr:type_name -> milvus.proto.plan.NullExpr
	34, // 74: milvus.proto.plan.Expr.random_sample_expr:type_name -> milvus.proto.plan.RandomSampleExpr
	28, // 75: milvus.proto.plan.Expr.gisfunction_filter_expr:type_name -> milvus.proto.plan.GISFunctionFilterExpr
	40, // 76: milvus.proto.plan.Expr.timestamptz_arith_compare_expr:type_name -> milvus.proto.plan.TimestamptzArithCompareExpr
	35, // 77: milvus.proto.plan.Expr.element_filter_expr:type_name -> milvus.proto.plan.ElementFilterExpr
	37, // 78: milvus.proto.plan.Expr.match_expr:type_name -> milvus.proto.plan.MatchExpr
	2,  // 79: milvus.proto.plan.VectorANNS.vector_type:type_name -> milvus.proto.plan.VectorType
	41, // 80: milvus.proto.plan.VectorANNS.predicates:type_name -> milvus.proto.plan.Expr
	16, // 81: milvus.proto.plan.VectorANNS.query_info:type_name -> milvus.proto.plan.QueryInfo
	4,  // 82: milvus.proto.plan.Aggregate.op:type_name -> milvus.proto.plan.AggregateOp
	41, // 83: milvus.proto.plan.QueryPlanNode.predicates:type_name -> milvus.proto.plan.Expr
	43, // 84: milvus.proto.plan.QueryPlanNode.aggregates:type_name -> milvus.proto.plan.Aggregate
	44, // 85: milvus.proto.plan.QueryPlanNode.order_by_fields:type_name -> milvus.proto.plan.OrderByField
	46, // 86: milvus.proto.plan.QueryPlanNode.query_iterator_cursor:type_name -> milvus.proto.plan.QueryIteratorCursor
	41, // 87: milvus.proto.plan.ScoreFunction.filter:type_name -> milvus.proto.plan.Expr
	5,  // 88: milvus.proto.plan.ScoreFunction.type:type_name -> milvus.proto.plan.FunctionType
	52, // 89: milvus.proto.plan.ScoreFunction.params:type_name -> milvus.proto.common.KeyValuePair
	7,  // 90: milvus.proto.plan.ScoreOption.boost_mode:type_name -> milvus.proto.plan.BoostMode
	6,  // 91: milvus.proto.plan.ScoreOption.function_mode:type_name -> milvus.proto.plan.FunctionMode
	42, // 92: milvus.proto.plan.PlanNode.vector_anns:type_name -> milvus.proto.plan.VectorANNS
	41, // 93: milvus.proto.plan.PlanNode.predicates:type_name -> milvus.proto.plan.Expr
	45, // 94: milvus.proto.plan.PlanNode.query:type_name -> milvus.proto.plan.QueryPlanNode
	47, // 95: milvus.proto.plan.PlanNode.scorers:type_name -> milvus.proto.plan.ScoreFunction
	49, // 96: milvus.proto.plan.PlanNode.plan_options:type_name -> milvus.proto.plan.PlanOption
	48, // 97: milvus.proto.plan.PlanNode.score_option:type_name -> milvus.proto.plan.ScoreOption
	53, // 98: milvus.proto.plan.PlanNode.querynode_function_chains:type_name -> milvus.proto.schema.FunctionChain
