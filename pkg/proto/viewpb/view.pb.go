...
type DataViewOfCollection struct {
	...
	DataVersion  *DataViewVersion   `protobuf:"bytes,3,opt,name=data_version,json=dataVersion,proto3" json:"data_version,omitempty"`
}
...
func (x *DataViewOfCollection) GetDataVersion() *DataViewVersion {
	if x != nil {
...
type DataViewOfSegment struct {
	...
	DataVersion *DataViewVersion `protobuf:"bytes,2,opt,name=data_version,json=dataVersion,proto3" json:"data_version,omitempty"` // Data version when this segment join the dataview.
}
...
func (x *DataViewOfSegment) GetDataVersion() *DataViewVersion {
	if x != nil {
		return x.DataVersion
	}
	return nil
...
type DataViewVersion struct {
	...
	StreamingVersion int64 `protobuf:"varint,1,opt,name=streaming_version,json=streamingVersion,proto3" json:"streaming_version,omitempty"` // the streaming version when this view is created.
	CompactVersion   int64 `protobuf:"varint,2,opt,name=compact_version,json=compactVersion,proto3" json:"compact_version,omitempty"`       // the compact version when this view is created.
}
...
func (x *DataViewVersion) GetStreamingVersion() int64 {
	if x != nil {
...
func (x *DataViewVersion) GetCompactVersion() int64 {
	if x != nil {
...
type QueryViewVersion struct {
	...
	DataVersion  *DataViewVersion `protobuf:"bytes,1,opt,name=data_version,json=dataVersion,proto3" json:"data_version,omitempty"`     // the data version of the data view.
...
func (x *QueryViewVersion) GetDataVersion() *DataViewVersion {
	if x != nil {
		return x.DataVersion
	}
	return nil
...
var file_view_proto_rawDesc = []byte{
	...
	0xbe, 0x01, 0x0a, 0x14, 0x44, 0x61, 0x74, 0x61, 0x56, 0x69, 0x65, 0x77, 0x4f, 0x66, 0x43, 0x6f,
	...
	0x64, 0x52, 0x06, 0x73, 0x68, 0x61, 0x72, 0x64, 0x73, 0x12, 0x45, 0x0a, 0x0c, 0x64, 0x61, 0x74,
	0x61, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x22, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x76,
	0x69, 0x65, 0x77, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x56, 0x69, 0x65, 0x77, 0x56, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x22, 0x75, 0x0a, 0x0f, 0x44, 0x61, 0x74, 0x61, 0x56, 0x69, 0x65, 0x77, 0x4f, 0x66, 0x53, 0x68,
	...
	0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x7a, 0x0a, 0x13, 0x44, 0x61, 0x74, 0x61, 0x56,
	...
	,
	...
	,
	...
	0x0b, 0x64, 0x61, 0x74, 0x61, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d,
	0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x0c, 0x71, 0x75, 0x65, 0x72, 0x79, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x22, 0x7c, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x69, 0x65, 0x77, 0x4f, 0x66,
	...
	,
	...
	0x64, 0x69, 0x73, 0x6b, 0x55, 0x73, 0x61, 0x67, 0x65, 0x2a, 0xe7, 0x01, 0x0a, 0x0e, 0x51, 0x75,
	...
	0x64, 0x10, 0x07, 0x2a, 0x7c, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x69, 0x65, 0x77,
	0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x20, 0x0a, 0x1c,
	...
	0x0a, 0x1d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x69, 0x65, 0x77, 0x53, 0x65, 0x67, 0x6d, 0x65,
	0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x74, 0x52, 0x65, 0x61, 0x64, 0x79, 0x10,
	0x01, 0x12, 0x1e, 0x0a, 0x1a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x69, 0x65, 0x77, 0x53, 0x65,
	0x67, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x61, 0x64, 0x79, 0x10,
	0x02, 0x32, 0x65, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x69, 0x65, 0x77, 0x53, 0x79,
	0x6e, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4d, 0x0a, 0x04, 0x53, 0x79, 0x6e,
	0x63, 0x12, 0x1e, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x69, 0x65, 0x77, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_view_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_view_proto_goTypes = []interface{}{
	...
	(*DataViewVersion)(nil),                // 11: milvus.proto.view.DataViewVersion
	...
	(*QueryViewOfSegment)(nil),             // 14: milvus.proto.view.QueryViewOfSegment
	(*SyncRequest)(nil),                    // 15: milvus.proto.view.SyncRequest
	(*SyncQueryViewsRequest)(nil),          // 16: milvus.proto.view.SyncQueryViewsRequest
	(*SyncCloseRequest)(nil),               // 17: milvus.proto.view.SyncCloseRequest
	(*SyncResponse)(nil),                   // 18: milvus.proto.view.SyncResponse
	(*SyncQueryViewsResponse)(nil),         // 19: milvus.proto.view.SyncQueryViewsResponse
	(*SyncCloseResponse)(nil),              // 20: milvus.proto.view.SyncCloseResponse
...
var file_view_proto_depIdxs = []int32{
	...
	11, // 1: milvus.proto.view.DataViewOfCollection.data_version:type_name -> milvus.proto.view.DataViewVersion
	4,  // 2: milvus.proto.view.DataViewOfShard.partitions:type_name -> milvus.proto.view.DataViewOfPartition
	5,  // 3: milvus.proto.view.DataViewOfPartition.segments:type_name -> milvus.proto.view.DataViewOfSegment
	11, // 4: milvus.proto.view.DataViewOfSegment.data_version:type_name -> milvus.proto.view.DataViewVersion
	7,  // 5: milvus.proto.view.QueryViewOfShard.meta:type_name -> milvus.proto.view.QueryViewMeta
	10, // 6: milvus.proto.view.QueryViewOfShard.query_node:type_name -> milvus.proto.view.QueryViewOfQueryNode
	9,  // 7: milvus.proto.view.QueryViewOfShard.streaming_node:type_name -> milvus.proto.view.QueryViewOfStreamingNode
	12, // 8: milvus.proto.view.QueryViewMeta.version:type_name -> milvus.proto.view.QueryViewVersion
	0,  // 9: milvus.proto.view.QueryViewMeta.state:type_name -> milvus.proto.view.QueryViewState
	8,  // 10: milvus.proto.view.QueryViewMeta.settings:type_name -> milvus.proto.view.QueryViewSettings
	13, // 11: milvus.proto.view.QueryViewOfQueryNode.partitions:type_name -> milvus.proto.view.QueryViewOfPartition
	11, // 12: milvus.proto.view.QueryViewVersion.data_version:type_name -> milvus.proto.view.DataViewVersion
	14, // 13: milvus.proto.view.QueryViewOfPartition.segments:type_name -> milvus.proto.view.QueryViewOfSegment
	1,  // 14: milvus.proto.view.QueryViewOfSegment.state:type_name -> milvus.proto.view.QueryViewSegmentState
	16, // 15: milvus.proto.view.SyncRequest.views:type_name -> milvus.proto.view.SyncQueryViewsRequest
	17, // 16: milvus.proto.view.SyncRequest.close:type_name -> milvus.proto.view.SyncCloseRequest
	6,  // 17: milvus.proto.view.SyncQueryViewsRequest.query_views:type_name -> milvus.proto.view.QueryViewOfShard
	19, // 18: milvus.proto.view.SyncResponse.views:type_name -> milvus.proto.view.SyncQueryViewsResponse
	20, // 19: milvus.proto.view.SyncResponse.close:type_name -> milvus.proto.view.SyncCloseResponse
	6,  // 20: milvus.proto.view.SyncQueryViewsResponse.query_views:type_name -> milvus.proto.view.QueryViewOfShard
	21, // 21: milvus.proto.view.SyncQueryViewsResponse.streaming_node:type_name -> milvus.proto.view.StreamingNodeBalanceAttributes
	22, // 22: milvus.proto.view.SyncQueryViewsResponse.query_node:type_name -> milvus.proto.view.QueryNodeBalanceAttributes
	15, // 23: milvus.proto.view.QueryViewSyncService.Sync:input_type -> milvus.proto.view.SyncRequest
	18, // 24: milvus.proto.view.QueryViewSyncService.Sync:output_type -> milvus.proto.view.SyncResponse
...
func file_view_proto_init() {
	...
	file_view_proto_msgTypes[17].OneofWrappers = []interface{}{
