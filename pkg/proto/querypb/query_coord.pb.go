...
type LoadCollectionRequest struct {
	...
	// fieldID -> indexID
	FieldIndexID map[int64]int64 `protobuf:"bytes,6,rep,name=field_indexID,json=fieldIndexID,proto3" json:"field_indexID,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
type LoadPartitionsRequest struct {
	...
	// fieldID -> indexID
	FieldIndexID map[int64]int64 `protobuf:"bytes,7,rep,name=field_indexID,json=fieldIndexID,proto3" json:"field_indexID,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
type UpdateResourceGroupsRequest struct {
	state          protoimpl.MessageState               `protogen:"open.v1"`
	Base           *commonpb.MsgBase                    `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	ResourceGroups map[string]*rgpb.ResourceGroupConfig `protobuf:"bytes,2,rep,name=resource_groups,json=resourceGroups,proto3" json:"resource_groups,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type WatchDmChannelsRequest struct {
	...
	SegmentInfos map[int64]*datapb.SegmentInfo `protobuf:"bytes,10,rep,name=segment_infos,json=segmentInfos,proto3" json:"segment_infos,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Deprecated
	...
	SealedSegmentRowCount map[int64]int64      `protobuf:"bytes,15,rep,name=sealed_segment_row_count,json=sealedSegmentRowCount,proto3" json:"sealed_segment_row_count,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // segmentID -> row count, same as unflushedSegmentIds in vchannelInfo
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type SegmentLoadInfo struct {
	...
	TextStatsLogs    map[int64]*datapb.TextIndexStats `protobuf:"bytes,20,rep,name=textStatsLogs,proto3" json:"textStatsLogs,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Bm25Logs         []*datapb.FieldBinlog            `protobuf:"bytes,21,rep,name=bm25logs,proto3" json:"bm25logs,omitempty"`
	JsonKeyStatsLogs map[int64]*datapb.JsonKeyStats   `protobuf:"bytes,22,rep,name=jsonKeyStatsLogs,proto3" json:"jsonKeyStatsLogs,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type GetDataDistributionRequest struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	Base          *commonpb.MsgBase             `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	Checkpoints   map[string]*msgpb.MsgPosition `protobuf:"bytes,2,rep,name=checkpoints,proto3" json:"checkpoints,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type LeaderView struct {
	...
	SegmentDist            map[int64]*SegmentDist       `protobuf:"bytes,3,rep,name=segment_dist,json=segmentDist,proto3" json:"segment_dist,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	GrowingSegments        map[int64]*msgpb.MsgPosition `protobuf:"bytes,5,rep,name=growing_segments,json=growingSegments,proto3" json:"growing_segments,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	PartitionStatsVersions map[int64]int64              `protobuf:"bytes,8,rep,name=partition_stats_versions,json=partitionStatsVersions,proto3" json:"partition_stats_versions,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
type SegmentVersionInfo struct {
	...
	IndexInfo           map[int64]*FieldIndexInfo `protobuf:"bytes,7,rep,name=index_info,json=indexInfo,proto3" json:"index_info,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	JsonStatsInfo       map[int64]*JsonStatsInfo  `protobuf:"bytes,11,rep,name=json_stats_info,json=jsonStatsInfo,proto3" json:"json_stats_info,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type CollectionLoadInfo struct {
	...
	FieldIndexID             map[int64]int64        `protobuf:"bytes,5,rep,name=field_indexID,json=fieldIndexID,proto3" json:"field_indexID,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
type PartitionLoadInfo struct {
	...
	Status        LoadStatus             `protobuf:"varint,4,opt,name=status,proto3,enum=milvus.proto.query.LoadStatus" json:"status,omitempty"`
	FieldIndexID  map[int64]int64        `protobuf:"bytes,5,rep,name=field_indexID,json=fieldIndexID,proto3" json:"field_indexID,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // Deprecated: No longer used; kept for compatibility.
	RecoverTimes  int32                  `protobuf:"varint,7,opt,name=recover_times,json=recoverTimes,proto3" json:"recover_times,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Replica struct {
	...
	ChannelNodeInfos map[string]*ChannelNodeInfo `protobuf:"bytes,6,rep,name=channel_node_infos,json=channelNodeInfos,proto3" json:"channel_node_infos,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type SyncAction struct {
	...
	PartitionStatsVersions map[int64]int64        `protobuf:"bytes,12,rep,name=partition_stats_versions,json=partitionStatsVersions,proto3" json:"partition_stats_versions,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	DeleteCP               *msgpb.MsgPosition     `protobuf:"bytes,13,opt,name=deleteCP,proto3" json:"deleteCP,omitempty"`
	SealedSegmentRowCount  map[int64]int64        `protobuf:"bytes,14,rep,name=sealed_segment_row_count,json=sealedSegmentRowCount,proto3" json:"sealed_segment_row_count,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // segmentID -> row count, same as sealedInTarget
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type ResourceGroupInfo struct {
	...
	NumLoadedReplica map[int64]int32 `protobuf:"bytes,4,rep,name=num_loaded_replica,json=numLoadedReplica,proto3" json:"num_loaded_replica,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// collection id -> accessed other rg's node num
	NumOutgoingNode map[int64]int32 `protobuf:"bytes,5,rep,name=num_outgoing_node,json=numOutgoingNode,proto3" json:"num_outgoing_node,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// collection id -> be accessed node num by other rg
	NumIncomingNode map[int64]int32 `protobuf:"bytes,6,rep,name=num_incoming_node,json=numIncomingNode,proto3" json:"num_incoming_node,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
func (x *UpdateIndexRequest_Action) GetOp() isUpdateIndexRequest_Action_Op {
	if x != nil {
		return x.Op
	}
	return nil
...
func (x *UpdateIndexRequest_Action) GetAddIndexRequest() *UpdateIndexRequest_AddIndex {
	if x != nil {
		if x, ok := x.Op.(*UpdateIndexRequest_Action_AddIndexRequest); ok {
...
func (x *UpdateIndexRequest_Action) GetDropIndexRequest() *UpdateIndexRequest_DropIndex {
	if x != nil {
		if x, ok := x.Op.(*UpdateIndexRequest_Action_DropIndexRequest); ok {
...
const file_query_coord_proto_rawDesc = "" +
	"\n" +
	"\x11query_coord.proto\x12\x12milvus.proto.query\x1a\fcommon.proto\x1a\fmilvus.proto\x1a\brg.proto\x1a\x0einternal.proto\x1a\fschema.proto\x1a\tmsg.proto\x1a\x10data_coord.proto\x1a\x11index_coord.proto\"\xb8\x01\n" +
	"\x1dComputePhraseMatchSlopRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12'\n" +
	"\x0fanalyzer_params\x18\x02 \x01(\tR\x0eanalyzerParams\x12\x1d\n" +
	"\n" +
	"query_text\x18\x03 \x01(\tR\tqueryText\x12\x1d\n" +
	"\n" +
	"data_texts\x18\x04 \x03(\tR\tdataTexts\"\x86\x01\n" +
	"\x1eComputePhraseMatchSlopResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12\x19\n" +
	"\bis_match\x18\x02 \x03(\bR\aisMatch\x12\x14\n" +
	"\x05slops\x18\x03 \x03(\x03R\x05slops\"\x84\x01\n" +
	"\x16ShowCollectionsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x12\n" +
	"\x04dbID\x18\x02 \x01(\x03R\x04dbID\x12$\n" +
	"\rcollectionIDs\x18\x03 \x03(\x03R\rcollectionIDs\"\xcb\x02\n" +
	"\x17ShowCollectionsResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12$\n" +
	"\rcollectionIDs\x18\x02 \x03(\x03R\rcollectionIDs\x121\n" +
	"\x14inMemory_percentages\x18\x03 \x03(\x03R\x13inMemoryPercentages\x126\n" +
	"\x17query_service_available\x18\x04 \x03(\bR\x15queryServiceAvailable\x12)\n" +
	"\x10refresh_progress\x18\x05 \x03(\x03R\x0frefreshProgress\x12?\n" +
	"\vload_fields\x18\x06 \x03(\v2\x1e.milvus.proto.schema.LongArrayR\n" +
	"loadFields\"\xa5\x01\n" +
	"\x15ShowPartitionsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x12\n" +
	"\x04dbID\x18\x02 \x01(\x03R\x04dbID\x12\"\n" +
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\x12\"\n" +
	"\fpartitionIDs\x18\x04 \x03(\x03R\fpartitionIDs\"\xcf\x01\n" +
	"\x16ShowPartitionsResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12\"\n" +
	"\fpartitionIDs\x18\x02 \x03(\x03R\fpartitionIDs\x121\n" +
	"\x14inMemory_percentages\x18\x03 \x03(\x03R\x13inMemoryPercentages\x12)\n" +
	"\x10refresh_progress\x18\x04 \x03(\x03R\x0frefreshProgress\"\xad\x04\n" +
	"\x15LoadCollectionRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x12\n" +
	"\x04dbID\x18\x02 \x01(\x03R\x04dbID\x12\"\n" +
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\x12=\n" +
	"\x06schema\x18\x04 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x12%\n" +
	"\x0ereplica_number\x18\x05 \x01(\x05R\rreplicaNumber\x12`\n" +
	"\rfield_indexID\x18\x06 \x03(\v2;.milvus.proto.query.LoadCollectionRequest.FieldIndexIDEntryR\ffieldIndexID\x12\x18\n" +
	"\arefresh\x18\a \x01(\bR\arefresh\x12'\n" +
	"\x0fresource_groups\x18\b \x03(\tR\x0eresourceGroups\x12\x1f\n" +
	"\vload_fields\x18\t \x03(\x03R\n" +
	"loadFields\x12=\n" +
	"\bpriority\x18\n" +
	" \x01(\x0e2!.milvus.proto.common.LoadPriorityR\bpriority\x1a?\n" +
	"\x11FieldIndexIDEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\x9c\x01\n" +
	"\x18ReleaseCollectionRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x12\n" +
	"\x04dbID\x18\x02 \x01(\x03R\x04dbID\x12\"\n" +
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\x12\x16\n" +
	"\x06nodeID\x18\x04 \x01(\x03R\x06nodeID\"\xf9\x01\n" +
	"\x14GetStatisticsRequest\x12=\n" +
	"\x03req\x18\x01 \x01(\v2+.milvus.proto.internal.GetStatisticsRequestR\x03req\x12!\n" +
	"\fdml_channels\x18\x02 \x03(\tR\vdmlChannels\x12\x1e\n" +
	"\n" +
	"segmentIDs\x18\x03 \x03(\x03R\n" +
	"segmentIDs\x12*\n" +
	"\x11from_shard_leader\x18\x04 \x01(\bR\x0ffromShardLeader\x123\n" +
	"\x05scope\x18\x05 \x01(\x0e2\x1d.milvus.proto.query.DataScopeR\x05scope\"\x98\x05\n" +
	"\x15LoadPartitionsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x12\n" +
	"\x04dbID\x18\x02 \x01(\x03R\x04dbID\x12\"\n" +
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\x12\"\n" +
	"\fpartitionIDs\x18\x04 \x03(\x03R\fpartitionIDs\x12=\n" +
	"\x06schema\x18\x05 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x12%\n" +
	"\x0ereplica_number\x18\x06 \x01(\x05R\rreplicaNumber\x12`\n" +
	"\rfield_indexID\x18\a \x03(\v2;.milvus.proto.query.LoadPartitionsRequest.FieldIndexIDEntryR\ffieldIndexID\x12\x18\n" +
	"\arefresh\x18\b \x01(\bR\arefresh\x12'\n" +
	"\x0fresource_groups\x18\t \x03(\tR\x0eresourceGroups\x12E\n" +
	"\x0findex_info_list\x18\n" +
	" \x03(\v2\x1d.milvus.proto.index.IndexInfoR\rindexInfoList\x12\x1f\n" +
	"\vload_fields\x18\v \x03(\x03R\n" +
	"loadFields\x12=\n" +
	"\bpriority\x18\f \x01(\x0e2!.milvus.proto.common.LoadPriorityR\bpriority\x1a?\n" +
	"\x11FieldIndexIDEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xc0\x01\n" +
	"\x18ReleasePartitionsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x12\n" +
	"\x04dbID\x18\x02 \x01(\x03R\x04dbID\x12\"\n" +
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\x12\"\n" +
	"\fpartitionIDs\x18\x04 \x03(\x03R\fpartitionIDs\x12\x16\n" +
	"\x06nodeID\x18\x05 \x01(\x03R\x06nodeID\"\xa9\x01\n" +
	"\x19GetPartitionStatesRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x12\n" +
	"\x04dbID\x18\x02 \x01(\x03R\x04dbID\x12\"\n" +
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\x12\"\n" +
	"\fpartitionIDs\x18\x04 \x03(\x03R\fpartitionIDs\"\xad\x01\n" +
	"\x1aGetPartitionStatesResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12Z\n" +
	"\x16partition_descriptions\x18\x02 \x03(\v2#.milvus.proto.query.PartitionStatesR\x15partitionDescriptions\"\x8d\x01\n" +
	...
	"segmentIDs\x12\"\n" +
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\"\x84\x01\n" +
	"\x16GetSegmentInfoResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x125\n" +
	"\x05infos\x18\x02 \x03(\v2\x1f.milvus.proto.query.SegmentInfoR\x05infos\"\xaa\x01\n" +
	"\x16GetShardLeadersRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\"\n" +
	"\fcollectionID\x18\x02 \x01(\x03R\fcollectionID\x12:\n" +
	"\x19with_unserviceable_shards\x18\x03 \x01(\bR\x17withUnserviceableShards\"\x8c\x01\n" +
	"\x17GetShardLeadersResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12<\n" +
	"\x06shards\x18\x02 \x03(\v2$.milvus.proto.query.ShardLeadersListR\x06shards\"\xa6\x02\n" +
	"\x1bUpdateResourceGroupsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12l\n" +
	"\x0fresource_groups\x18\x02 \x03(\v2C.milvus.proto.query.UpdateResourceGroupsRequest.ResourceGroupsEntryR\x0eresourceGroups\x1ag\n" +
	"\x13ResourceGroupsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12:\n" +
	"\x05value\x18\x02 \x01(\v2$.milvus.proto.rg.ResourceGroupConfigR\x05value:\x028\x01\"\x91\x01\n" +
	"\x10ShardLeadersList\x12!\n" +
	"\fchannel_name\x18\x01 \x01(\tR\vchannelName\x12\x19\n" +
	"\bnode_ids\x18\x02 \x03(\x03R\anodeIds\x12\x1d\n" +
	"\n" +
	"node_addrs\x18\x03 \x03(\tR\tnodeAddrs\x12 \n" +
	"\vserviceable\x18\x04 \x03(\bR\vserviceable\"\x98\x01\n" +
	"\x1eSyncNewCreatedPartitionRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\"\n" +
	"\fcollectionID\x18\x02 \x01(\x03R\fcollectionID\x12 \n" +
	"\vpartitionID\x18\x03 \x01(\x03R\vpartitionID\"\x86\x03\n" +
	"\fLoadMetaInfo\x129\n" +
	"\tload_type\x18\x01 \x01(\x0e2\x1c.milvus.proto.query.LoadTypeR\bloadType\x12\"\n" +
	"\fcollectionID\x18\x02 \x01(\x03R\fcollectionID\x12\"\n" +
	"\fpartitionIDs\x18\x03 \x03(\x03R\fpartitionIDs\x12#\n" +
	"\vmetric_type\x18\x04 \x01(\tB\x02\x18\x01R\n" +
	"metricType\x12\x17\n" +
	"\adb_name\x18\x05 \x01(\tR\x06dbName\x12%\n" +
	"\x0eresource_group\x18\x06 \x01(\tR\rresourceGroup\x12\x1f\n" +
	"\vload_fields\x18\a \x03(\x03R\n" +
	"loadFields\x12F\n" +
	"\rdb_properties\x18\b \x03(\v2!.milvus.proto.common.KeyValuePairR\fdbProperties\x12%\n" +
	"\x0eschema_version\x18\t \x01(\x04R\rschemaVersion\"\xfe\a\n" +
	...
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\x12\"\n" +
	"\fpartitionIDs\x18\x04 \x03(\x03R\fpartitionIDs\x125\n" +
	"\x05infos\x18\x05 \x03(\v2\x1f.milvus.proto.data.VchannelInfoR\x05infos\x12=\n" +
	"\x06schema\x18\x06 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x12C\n" +
	"\rexclude_infos\x18\a \x03(\v2\x1e.milvus.proto.data.SegmentInfoR\fexcludeInfos\x12=\n" +
	"\tload_meta\x18\b \x01(\v2 .milvus.proto.query.LoadMetaInfoR\bloadMeta\x12\x1c\n" +
	"\treplicaID\x18\t \x01(\x03R\treplicaID\x12a\n" +
	"\rsegment_infos\x18\n" +
	" \x03(\v2<.milvus.proto.query.WatchDmChannelsRequest.SegmentInfosEntryR\fsegmentInfos\x12$\n" +
	"\rofflineNodeID\x18\v \x01(\x03R\rofflineNodeID\x12\x18\n" +
	"\aversion\x18\f \x01(\x03R\aversion\x12E\n" +
	"\x0findex_info_list\x18\r \x03(\v2\x1d.milvus.proto.index.IndexInfoR\rindexInfoList\x12%\n" +
	"\x0etarget_version\x18\x0e \x01(\x03R\rtargetVersion\x12~\n" +
	"\x18sealed_segment_row_count\x18\x0f \x03(\v2E.milvus.proto.query.WatchDmChannelsRequest.SealedSegmentRowCountEntryR\x15sealedSegmentRowCount\x1a_\n" +
	"\x11SegmentInfosEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.milvus.proto.data.SegmentInfoR\x05value:\x028\x01\x1aH\n" +
	"\x1aSealedSegmentRowCountEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xa8\x01\n" +
	"\x15UnsubDmChannelRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x16\n" +
	"\x06nodeID\x18\x02 \x01(\x03R\x06nodeID\x12\"\n" +
	"\fcollectionID\x18\x03 \x01(\x03R\fcollectionID\x12!\n" +
	"\fchannel_name\x18\x04 \x01(\tR\vchannelName\"\xa4\v\n" +
	...
	"\n" +
	"flush_time\x18\x05 \x01(\x03R\tflushTime\x12A\n" +
	"\fbinlog_paths\x18\x06 \x03(\v2\x1e.milvus.proto.data.FieldBinlogR\vbinlogPaths\x12\x1e\n" +
	"\vnum_of_rows\x18\a \x01(\x03R\tnumOfRows\x12<\n" +
	"\tstatslogs\x18\b \x03(\v2\x1e.milvus.proto.data.FieldBinlogR\tstatslogs\x12<\n" +
	"\tdeltalogs\x18\t \x03(\v2\x1e.milvus.proto.data.FieldBinlogR\tdeltalogs\x12&\n" +
	"\x0ecompactionFrom\x18\n" +
	" \x03(\x03R\x0ecompactionFrom\x12C\n" +
	"\vindex_infos\x18\v \x03(\v2\".milvus.proto.query.FieldIndexInfoR\n" +
	"indexInfos\x12%\n" +
	"\fsegment_size\x18\f \x01(\x03B\x02\x18\x01R\vsegmentSize\x12%\n" +
	"\x0einsert_channel\x18\r \x01(\tR\rinsertChannel\x12D\n" +
	"\x0estart_position\x18\x0e \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\rstartPosition\x12D\n" +
	"\x0edelta_position\x18\x0f \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\rdeltaPosition\x12(\n" +
	"\x0freadableVersion\x18\x10 \x01(\x03R\x0freadableVersion\x125\n" +
	"\x05level\x18\x11 \x01(\x0e2\x1f.milvus.proto.data.SegmentLevelR\x05level\x12&\n" +
	"\x0estorageVersion\x18\x12 \x01(\x03R\x0estorageVersion\x12\x1b\n" +
	"\tis_sorted\x18\x13 \x01(\bR\bisSorted\x12\\\n" +
	"\rtextStatsLogs\x18\x14 \x03(\v26.milvus.proto.query.SegmentLoadInfo.TextStatsLogsEntryR\rtextStatsLogs\x12:\n" +
	"\bbm25logs\x18\x15 \x03(\v2\x1e.milvus.proto.data.FieldBinlogR\bbm25logs\x12e\n" +
	"\x10jsonKeyStatsLogs\x18\x16 \x03(\v29.milvus.proto.query.SegmentLoadInfo.JsonKeyStatsLogsEntryR\x10jsonKeyStatsLogs\x12=\n" +
	"\bpriority\x18\x17 \x01(\x0e2!.milvus.proto.common.LoadPriorityR\bpriority\x12#\n" +
	"\rmanifest_path\x18\x18 \x01(\tR\fmanifestPath\x1ac\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1f.milvus.proto.data.JsonKeyStatsR\x05value:\x028\x01\"\x98\x04\n" +
	"\x0eFieldIndexInfo\x12\x18\n" +
	"\afieldID\x18\x01 \x01(\x03R\afieldID\x12!\n" +
	"\fenable_index\x18\x02 \x01(\bR\venableIndex\x12\x1d\n" +
	"\n" +
	...
	"\x1ccurrent_scalar_index_version\x18\r \x01(\x05R\x19currentScalarIndexVersion\"\xa9\x01\n" +
	"\rJsonStatsInfo\x12\x18\n" +
	"\afieldID\x18\x01 \x01(\x03R\afieldID\x12,\n" +
	"\x11dataFormatVersion\x18\x02 \x01(\x03R\x11dataFormatVersion\x12\x18\n" +
	"\aindexID\x18\x03 \x01(\x03R\aindexID\x12\x18\n" +
	"\abuildID\x18\x04 \x01(\x03R\abuildID\x12\x1c\n" +
	"\tversionID\x18\x05 \x01(\x03R\tversionID\"\xaf\x05\n" +
	"\x13LoadSegmentsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x1d\n" +
	"\n" +
	"dst_nodeID\x18\x02 \x01(\x03R\tdstNodeID\x129\n" +
	"\x05infos\x18\x03 \x03(\v2#.milvus.proto.query.SegmentLoadInfoR\x05infos\x12=\n" +
	"\x06schema\x18\x04 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x12#\n" +
	"\rsource_nodeID\x18\x05 \x01(\x03R\fsourceNodeID\x12\"\n" +
	"\fcollectionID\x18\x06 \x01(\x03R\fcollectionID\x12=\n" +
	"\tload_meta\x18\a \x01(\v2 .milvus.proto.query.LoadMetaInfoR\bloadMeta\x12\x1c\n" +
	"\treplicaID\x18\b \x01(\x03R\treplicaID\x12F\n" +
	"\x0fdelta_positions\x18\t \x03(\v2\x1d.milvus.proto.msg.MsgPositionR\x0edeltaPositions\x12\x18\n" +
	"\aversion\x18\n" +
	" \x01(\x03R\aversion\x12#\n" +
	"\rneed_transfer\x18\v \x01(\bR\fneedTransfer\x12<\n" +
	"\n" +
	"load_scope\x18\f \x01(\x0e2\x1d.milvus.proto.query.LoadScopeR\tloadScope\x12E\n" +
	"\x0findex_info_list\x18\r \x03(\v2\x1d.milvus.proto.index.IndexInfoR\rindexInfoList\x12\x1b\n" +
	"\tlazy_load\x18\x0e \x01(\bR\blazyLoad\"\x8d\x03\n" +
	"\x16ReleaseSegmentsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x16\n" +
	...
	"\fpartitionIDs\x18\x05 \x03(\x03R\fpartitionIDs\x12\x1e\n" +
	"\n" +
	"segmentIDs\x18\x06 \x03(\x03R\n" +
	"segmentIDs\x123\n" +
	"\x05scope\x18\a \x01(\x0e2\x1d.milvus.proto.query.DataScopeR\x05scope\x12\x14\n" +
	"\x05shard\x18\b \x01(\tR\x05shard\x12#\n" +
	"\rneed_transfer\x18\v \x01(\bR\fneedTransfer\x12=\n" +
	"\n" +
	"checkpoint\x18\f \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\n" +
	"checkpoint\"\x97\x02\n" +
	"\rSearchRequest\x126\n" +
	"\x03req\x18\x01 \x01(\v2$.milvus.proto.internal.SearchRequestR\x03req\x12!\n" +
	"\fdml_channels\x18\x02 \x03(\tR\vdmlChannels\x12\x1e\n" +
	"\n" +
	"segmentIDs\x18\x03 \x03(\x03R\n" +
	"segmentIDs\x12*\n" +
	"\x11from_shard_leader\x18\x04 \x01(\bR\x0ffromShardLeader\x123\n" +
	"\x05scope\x18\x05 \x01(\x0e2\x1d.milvus.proto.query.DataScopeR\x05scope\x12*\n" +
	"\x11total_channel_num\x18\x06 \x01(\x05R\x0ftotalChannelNum\"\xec\x01\n" +
	"\fQueryRequest\x128\n" +
	"\x03req\x18\x01 \x01(\v2&.milvus.proto.internal.RetrieveRequestR\x03req\x12!\n" +
	"\fdml_channels\x18\x02 \x03(\tR\vdmlChannels\x12\x1e\n" +
	"\n" +
	"segmentIDs\x18\x03 \x03(\x03R\n" +
	"segmentIDs\x12*\n" +
	"\x11from_shard_leader\x18\x04 \x01(\bR\x0ffromShardLeader\x123\n" +
	"\x05scope\x18\x05 \x01(\x0e2\x1d.milvus.proto.query.DataScopeR\x05scope\"\xc7\x01\n" +
	"\x1aSyncReplicaSegmentsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12#\n" +
	"\rvchannel_name\x18\x02 \x01(\tR\fvchannelName\x12R\n" +
	"\x10replica_segments\x18\x03 \x03(\v2'.milvus.proto.query.ReplicaSegmentsInfoR\x0freplicaSegments\"\x8e\x01\n" +
	"\x13ReplicaSegmentsInfo\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\x03R\x06nodeId\x12!\n" +
	"\fpartition_id\x18\x02 \x01(\x03R\vpartitionId\x12\x1f\n" +
	"\vsegment_ids\x18\x03 \x03(\x03R\n" +
	"segmentIds\x12\x1a\n" +
	"\bversions\x18\x04 \x03(\x03R\bversions\"k\n" +
	"\x12GetLoadInfoRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\"\xe4\x01\n" +
	"\x13GetLoadInfoResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12=\n" +
	"\x06schema\x18\x02 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x129\n" +
	"\tload_type\x18\x03 \x01(\x0e2\x1c.milvus.proto.query.LoadTypeR\bloadType\x12\x1e\n" +
	"\n" +
	"partitions\x18\x04 \x03(\x03R\n" +
	"partitions\"\xbc\x01\n" +
	"\x16HandoffSegmentsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12C\n" +
	"\fsegmentInfos\x18\x02 \x03(\v2\x1f.milvus.proto.query.SegmentInfoR\fsegmentInfos\x12+\n" +
	"\x11released_segments\x18\x03 \x03(\x03R\x10releasedSegments\"\xac\x02\n" +
	"\x12LoadBalanceRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12%\n" +
	"\x0esource_nodeIDs\x18\x02 \x03(\x03R\rsourceNodeIDs\x12K\n" +
	"\x0ebalance_reason\x18\x03 \x01(\x0e2$.milvus.proto.query.TriggerConditionR\rbalanceReason\x12\x1f\n" +
	"\vdst_nodeIDs\x18\x04 \x03(\x03R\n" +
	"dstNodeIDs\x12+\n" +
	"\x11sealed_segmentIDs\x18\x05 \x03(\x03R\x10sealedSegmentIDs\x12\"\n" +
	"\fcollectionID\x18\x06 \x01(\x03R\fcollectionID\"\xb4\x01\n" +
	"\x12DmChannelWatchInfo\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\x03R\fcollectionID\x12\x1c\n" +
	"\tdmChannel\x18\x02 \x01(\tR\tdmChannel\x12#\n" +
	"\rnodeID_loaded\x18\x03 \x01(\x03R\fnodeIDLoaded\x12\x1c\n" +
	"\treplicaID\x18\x04 \x01(\x03R\treplicaID\x12\x19\n" +
	"\bnode_ids\x18\x05 \x03(\x03R\anodeIds\"\xa8\x02\n" +
	"\x10QueryChannelInfo\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\x03R\fcollectionID\x12#\n" +
	"\rquery_channel\x18\x02 \x01(\tR\fqueryChannel\x120\n" +
	"\x14query_result_channel\x18\x03 \x01(\tR\x12queryResultChannel\x12U\n" +
	"\x16global_sealed_segments\x18\x04 \x03(\v2\x1f.milvus.proto.query.SegmentInfoR\x14globalSealedSegments\x12B\n" +
	"\rseek_position\x18\x05 \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\fseekPosition\"\x9e\x01\n" +
	"\x0fPartitionStates\x12 \n" +
	"\vpartitionID\x18\x01 \x01(\x03R\vpartitionID\x128\n" +
	"\x05state\x18\x02 \x01(\x0e2\".milvus.proto.query.PartitionStateR\x05state\x12/\n" +
	"\x13inMemory_percentage\x18\x03 \x01(\x03R\x12inMemoryPercentage\"\xf2\x05\n" +
	"\vSegmentInfo\x12\x1c\n" +
	"\tsegmentID\x18\x01 \x01(\x03R\tsegmentID\x12\"\n" +
	"\fcollectionID\x18\x02 \x01(\x03R\fcollectionID\x12 \n" +
	"\vpartitionID\x18\x03 \x01(\x03R\vpartitionID\x12\x16\n" +
	"\x06nodeID\x18\x04 \x01(\x03R\x06nodeID\x12\x19\n" +
	"\bmem_size\x18\x05 \x01(\x03R\amemSize\x12\x19\n" +
	"\bnum_rows\x18\x06 \x01(\x03R\anumRows\x12\x1d\n" +
	"\n" +
	"index_name\x18\a \x01(\tR\tindexName\x12\x18\n" +
	"\aindexID\x18\b \x01(\x03R\aindexID\x12\x1c\n" +
	"\tdmChannel\x18\t \x01(\tR\tdmChannel\x12&\n" +
	"\x0ecompactionFrom\x18\n" +
	" \x03(\x03R\x0ecompactionFrom\x120\n" +
	"\x13createdByCompaction\x18\v \x01(\bR\x13createdByCompaction\x12F\n" +
	"\rsegment_state\x18\f \x01(\x0e2!.milvus.proto.common.SegmentStateR\fsegmentState\x12C\n" +
	"\vindex_infos\x18\r \x03(\v2\".milvus.proto.query.FieldIndexInfoR\n" +
	"indexInfos\x12\x1f\n" +
	"\vreplica_ids\x18\x0e \x03(\x03R\n" +
	"replicaIds\x12\x19\n" +
	"\bnode_ids\x18\x0f \x03(\x03R\anodeIds\x12!\n" +
	"\fenable_index\x18\x10 \x01(\bR\venableIndex\x12\x17\n" +
	"\ais_fake\x18\x11 \x01(\bR\x06isFake\x125\n" +
	"\x05level\x18\x12 \x01(\x0e2\x1f.milvus.proto.data.SegmentLevelR\x05level\x12\x1b\n" +
	"\tis_sorted\x18\x13 \x01(\bR\bisSorted\x12'\n" +
	"\x0fstorage_version\x18\x14 \x01(\x03R\x0estorageVersion\"\xd0\x03\n" +
	"\x0eCollectionInfo\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\x03R\fcollectionID\x12\"\n" +
	"\fpartitionIDs\x18\x02 \x03(\x03R\fpartitionIDs\x12N\n" +
	"\x10partition_states\x18\x03 \x03(\v2#.milvus.proto.query.PartitionStatesR\x0fpartitionStates\x129\n" +
	"\tload_type\x18\x04 \x01(\x0e2\x1c.milvus.proto.query.LoadTypeR\bloadType\x12=\n" +
	"\x06schema\x18\x05 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x123\n" +
	"\x15released_partitionIDs\x18\x06 \x03(\x03R\x14releasedPartitionIDs\x12/\n" +
	"\x13inMemory_percentage\x18\a \x01(\x03R\x12inMemoryPercentage\x12\x1f\n" +
	"\vreplica_ids\x18\b \x03(\x03R\n" +
	"replicaIds\x12%\n" +
	"\x0ereplica_number\x18\t \x01(\x05R\rreplicaNumber\"U\n" +
	"\x13UnsubscribeChannels\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\x03R\fcollectionID\x12\x1a\n" +
	"\bchannels\x18\x02 \x03(\tR\bchannels\"\x8a\x01\n" +
	"\x16UnsubscribeChannelInfo\x12\x16\n" +
	"\x06nodeID\x18\x01 \x01(\x03R\x06nodeID\x12X\n" +
	"\x13collection_channels\x18\x02 \x03(\v2'.milvus.proto.query.UnsubscribeChannelsR\x12collectionChannels\"\xf5\x01\n" +
	"\x11SegmentChangeInfo\x12#\n" +
	"\ronline_nodeID\x18\x01 \x01(\x03R\fonlineNodeID\x12H\n" +
	"\x0fonline_segments\x18\x02 \x03(\v2\x1f.milvus.proto.query.SegmentInfoR\x0eonlineSegments\x12%\n" +
	"\x0eoffline_nodeID\x18\x03 \x01(\x03R\rofflineNodeID\x12J\n" +
	"\x10offline_segments\x18\x04 \x03(\v2\x1f.milvus.proto.query.SegmentInfoR\x0fofflineSegments\"\x89\x01\n" +
	"\x18SealedSegmentsChangeInfo\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12;\n" +
	"\x05infos\x18\x02 \x03(\v2%.milvus.proto.query.SegmentChangeInfoR\x05infos\"\xb4\x02\n" +
	"\x1aGetDataDistributionRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12a\n" +
	"\vcheckpoints\x18\x02 \x03(\v2?.milvus.proto.query.GetDataDistributionRequest.CheckpointsEntryR\vcheckpoints\x12\"\n" +
	"\flastUpdateTs\x18\x03 \x01(\x03R\flastUpdateTs\x1a]\n" +
	"\x10CheckpointsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\x05value:\x028\x01\"\x9c\x03\n" +
	"\x1bGetDataDistributionResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12\x16\n" +
	"\x06nodeID\x18\x02 \x01(\x03R\x06nodeID\x12B\n" +
	"\bsegments\x18\x03 \x03(\v2&.milvus.proto.query.SegmentVersionInfoR\bsegments\x12B\n" +
	"\bchannels\x18\x04 \x03(\v2&.milvus.proto.query.ChannelVersionInfoR\bchannels\x12A\n" +
	"\fleader_views\x18\x05 \x03(\v2\x1e.milvus.proto.query.LeaderViewR\vleaderViews\x12\"\n" +
	"\flastModifyTs\x18\x06 \x01(\x03R\flastModifyTs\x12(\n" +
	"\x0fmemCapacityInMB\x18\a \x01(\x01R\x0fmemCapacityInMB\x12\x17\n" +
	"\acpu_num\x18\b \x01(\x03R\x06cpuNum\"\xc1\x06\n" +
	"\n" +
	"LeaderView\x12\x1e\n" +
	"\n" +
	"collection\x18\x01 \x01(\x03R\n" +
	"collection\x12\x18\n" +
	"\achannel\x18\x02 \x01(\tR\achannel\x12R\n" +
	"\fsegment_dist\x18\x03 \x03(\v2/.milvus.proto.query.LeaderView.SegmentDistEntryR\vsegmentDist\x12-\n" +
	"\x12growing_segmentIDs\x18\x04 \x03(\x03R\x11growingSegmentIDs\x12^\n" +
	"\x10growing_segments\x18\x05 \x03(\v23.milvus.proto.query.LeaderView.GrowingSegmentsEntryR\x0fgrowingSegments\x12$\n" +
	"\rTargetVersion\x18\x06 \x01(\x03R\rTargetVersion\x12-\n" +
	"\x13num_of_growing_rows\x18\a \x01(\x03R\x10numOfGrowingRows\x12t\n" +
	"\x18partition_stats_versions\x18\b \x03(\v2:.milvus.proto.query.LeaderView.PartitionStatsVersionsEntryR\x16partitionStatsVersions\x12<\n" +
	"\x06status\x18\t \x01(\v2$.milvus.proto.query.LeaderViewStatusR\x06status\x1a_\n" +
	"\x10SegmentDistEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x125\n" +
	"\x05value\x18\x02 \x01(\v2\x1f.milvus.proto.query.SegmentDistR\x05value:\x028\x01\x1aa\n" +
	"\x14GrowingSegmentsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\x05value:\x028\x01\x1aI\n" +
	"\x1bPartitionStatsVersionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"q\n" +
	"\x10LeaderViewStatus\x12 \n" +
	"\vserviceable\x18\x01 \x01(\bR\vserviceable\x12;\n" +
	"\x1acatching_up_streaming_data\x18\x02 \x01(\bR\x17catchingUpStreamingData\"?\n" +
	"\vSegmentDist\x12\x16\n" +
	"\x06nodeID\x18\x01 \x01(\x03R\x06nodeID\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x03R\aversion\"\xf6\x05\n" +
	"\x12SegmentVersionInfo\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\x03R\x02ID\x12\x1e\n" +
	"\n" +
	"collection\x18\x02 \x01(\x03R\n" +
	"collection\x12\x1c\n" +
	"\tpartition\x18\x03 \x01(\x03R\tpartition\x12\x18\n" +
	"\achannel\x18\x04 \x01(\tR\achannel\x12\x18\n" +
	"\aversion\x18\x05 \x01(\x03R\aversion\x120\n" +
	"\x14last_delta_timestamp\x18\x06 \x01(\x04R\x12lastDeltaTimestamp\x12T\n" +
	"\n" +
	"index_info\x18\a \x03(\v25.milvus.proto.query.SegmentVersionInfo.IndexInfoEntryR\tindexInfo\x125\n" +
	"\x05level\x18\b \x01(\x0e2\x1f.milvus.proto.data.SegmentLevelR\x05level\x12\x1b\n" +
	"\tis_sorted\x18\t \x01(\bR\bisSorted\x123\n" +
	"\x16field_json_index_stats\x18\n" +
	" \x03(\x03R\x13fieldJsonIndexStats\x12a\n" +
	"\x0fjson_stats_info\x18\v \x03(\v29.milvus.proto.query.SegmentVersionInfo.JsonStatsInfoEntryR\rjsonStatsInfo\x12#\n" +
	"\rmanifest_path\x18\f \x01(\tR\fmanifestPath\x1a`\n" +
	"\x0eIndexInfoEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x128\n" +
	"\x05value\x18\x02 \x01(\v2\".milvus.proto.query.FieldIndexInfoR\x05value:\x028\x01\x1ac\n" +
	"\x12JsonStatsInfoEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x127\n" +
	"\x05value\x18\x02 \x01(\v2!.milvus.proto.query.JsonStatsInfoR\x05value:\x028\x01\"h\n" +
	"\x12ChannelVersionInfo\x12\x18\n" +
	"\achannel\x18\x01 \x01(\tR\achannel\x12\x1e\n" +
	"\n" +
	"collection\x18\x02 \x01(\x03R\n" +
	"collection\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x03R\aversion\"\xbc\x04\n" +
	"\x12CollectionLoadInfo\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\x03R\fcollectionID\x12/\n" +
	"\x13released_partitions\x18\x02 \x03(\x03R\x12releasedPartitions\x12%\n" +
	"\x0ereplica_number\x18\x03 \x01(\x05R\rreplicaNumber\x126\n" +
	"\x06status\x18\x04 \x01(\x0e2\x1e.milvus.proto.query.LoadStatusR\x06status\x12]\n" +
	"\rfield_indexID\x18\x05 \x03(\v28.milvus.proto.query.CollectionLoadInfo.FieldIndexIDEntryR\ffieldIndexID\x129\n" +
	"\tload_type\x18\x06 \x01(\x0e2\x1c.milvus.proto.query.LoadTypeR\bloadType\x12#\n" +
	"\rrecover_times\x18\a \x01(\x05R\frecoverTimes\x12\x1f\n" +
	"\vload_fields\x18\b \x03(\x03R\n" +
	"loadFields\x12\x12\n" +
	"\x04dbID\x18\t \x01(\x03R\x04dbID\x12=\n" +
	"\x1buser_specified_replica_mode\x18\n" +
	" \x01(\bR\x18userSpecifiedReplicaMode\x1a?\n" +
	"\x11FieldIndexIDEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xfc\x02\n" +
	"\x11PartitionLoadInfo\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\x03R\fcollectionID\x12 \n" +
	"\vpartitionID\x18\x02 \x01(\x03R\vpartitionID\x12%\n" +
	"\x0ereplica_number\x18\x03 \x01(\x05R\rreplicaNumber\x126\n" +
	"\x06status\x18\x04 \x01(\x0e2\x1e.milvus.proto.query.LoadStatusR\x06status\x12\\\n" +
	"\rfield_indexID\x18\x05 \x03(\v27.milvus.proto.query.PartitionLoadInfo.FieldIndexIDEntryR\ffieldIndexID\x12#\n" +
	"\rrecover_times\x18\a \x01(\x05R\frecoverTimes\x1a?\n" +
	"\x11FieldIndexIDEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\",\n" +
	"\x0fChannelNodeInfo\x12\x19\n" +
	"\brw_nodes\x18\x06 \x03(\x03R\arwNodes\"\xa0\x03\n" +
	"\aReplica\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\x03R\x02ID\x12\"\n" +
	"\fcollectionID\x18\x02 \x01(\x03R\fcollectionID\x12\x14\n" +
	"\x05nodes\x18\x03 \x03(\x03R\x05nodes\x12%\n" +
	"\x0eresource_group\x18\x04 \x01(\tR\rresourceGroup\x12\x19\n" +
	"\bro_nodes\x18\x05 \x03(\x03R\aroNodes\x12_\n" +
	"\x12channel_node_infos\x18\x06 \x03(\v21.milvus.proto.query.Replica.ChannelNodeInfosEntryR\x10channelNodeInfos\x12\x1e\n" +
	"\vrw_sq_nodes\x18\a \x03(\x03R\trwSqNodes\x12\x1e\n" +
	"\vro_sq_nodes\x18\b \x03(\x03R\troSqNodes\x1ah\n" +
	"\x15ChannelNodeInfosEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x129\n" +
	"\x05value\x18\x02 \x01(\v2#.milvus.proto.query.ChannelNodeInfoR\x05value:\x028\x01\"\x84\a\n" +
	"\n" +
	"SyncAction\x120\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1c.milvus.proto.query.SyncTypeR\x04type\x12 \n" +
	"\vpartitionID\x18\x02 \x01(\x03R\vpartitionID\x12\x1c\n" +
	"\tsegmentID\x18\x03 \x01(\x03R\tsegmentID\x12\x16\n" +
	"\x06nodeID\x18\x04 \x01(\x03R\x06nodeID\x12\x18\n" +
	"\aversion\x18\x05 \x01(\x03R\aversion\x127\n" +
	"\x04info\x18\x06 \x01(\v2#.milvus.proto.query.SegmentLoadInfoR\x04info\x12(\n" +
	"\x0fgrowingInTarget\x18\a \x03(\x03R\x0fgrowingInTarget\x12&\n" +
	"\x0esealedInTarget\x18\b \x03(\x03R\x0esealedInTarget\x12$\n" +
	"\rTargetVersion\x18\t \x01(\x03R\rTargetVersion\x12(\n" +
	"\x0fdroppedInTarget\x18\n" +
	" \x03(\x03R\x0fdroppedInTarget\x12=\n" +
	"\n" +
	"checkpoint\x18\v \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\n" +
	"checkpoint\x12t\n" +
	"\x18partition_stats_versions\x18\f \x03(\v2:.milvus.proto.query.SyncAction.PartitionStatsVersionsEntryR\x16partitionStatsVersions\x129\n" +
	"\bdeleteCP\x18\r \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\bdeleteCP\x12r\n" +
	"\x18sealed_segment_row_count\x18\x0e \x03(\v29.milvus.proto.query.SyncAction.SealedSegmentRowCountEntryR\x15sealedSegmentRowCount\x1aI\n" +
	"\x1bPartitionStatsVersionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\x1aH\n" +
	"\x1aSealedSegmentRowCountEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xc0\x03\n" +
	"\x17SyncDistributionRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\"\n" +
	"\fcollectionID\x18\x02 \x01(\x03R\fcollectionID\x12\x18\n" +
	"\achannel\x18\x03 \x01(\tR\achannel\x128\n" +
	"\aactions\x18\x04 \x03(\v2\x1e.milvus.proto.query.SyncActionR\aactions\x12=\n" +
	"\x06schema\x18\x05 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x12=\n" +
	"\tload_meta\x18\x06 \x01(\v2 .milvus.proto.query.LoadMetaInfoR\bloadMeta\x12\x1c\n" +
	"\treplicaID\x18\a \x01(\x03R\treplicaID\x12\x18\n" +
	"\aversion\x18\b \x01(\x03R\aversion\x12E\n" +
	"\x0findex_info_list\x18\t \x03(\v2\x1d.milvus.proto.index.IndexInfoR\rindexInfoList\"\x97\x01\n" +
	"\rResourceGroup\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1e\n" +
	"\bcapacity\x18\x02 \x01(\x05B\x02\x18\x01R\bcapacity\x12\x14\n" +
	"\x05nodes\x18\x03 \x03(\x03R\x05nodes\x12<\n" +
	"\x06config\x18\x04 \x01(\v2$.milvus.proto.rg.ResourceGroupConfigR\x06config\"\xf7\x01\n" +
	"\x16TransferReplicaRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x122\n" +
	"\x15source_resource_group\x18\x02 \x01(\tR\x13sourceResourceGroup\x122\n" +
	"\x15target_resource_group\x18\x03 \x01(\tR\x13targetResourceGroup\x12\"\n" +
	"\fcollectionID\x18\x04 \x01(\x03R\fcollectionID\x12\x1f\n" +
	"\vnum_replica\x18\x05 \x01(\x03R\n" +
	"numReplica\"w\n" +
	"\x1cDescribeResourceGroupRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12%\n" +
	"\x0eresource_group\x18\x02 \x01(\tR\rresourceGroup\"\xa2\x01\n" +
	"\x1dDescribeResourceGroupResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12L\n" +
	"\x0eresource_group\x18\x02 \x01(\v2%.milvus.proto.query.ResourceGroupInfoR\rresourceGroup\"\xf0\x05\n" +
	"\x11ResourceGroupInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1e\n" +
	"\bcapacity\x18\x02 \x01(\x05B\x02\x18\x01R\bcapacity\x12,\n" +
	"\x12num_available_node\x18\x03 \x01(\x05R\x10numAvailableNode\x12i\n" +
	"\x12num_loaded_replica\x18\x04 \x03(\v2;.milvus.proto.query.ResourceGroupInfo.NumLoadedReplicaEntryR\x10numLoadedReplica\x12f\n" +
	"\x11num_outgoing_node\x18\x05 \x03(\v2:.milvus.proto.query.ResourceGroupInfo.NumOutgoingNodeEntryR\x0fnumOutgoingNode\x12f\n" +
	"\x11num_incoming_node\x18\x06 \x03(\v2:.milvus.proto.query.ResourceGroupInfo.NumIncomingNodeEntryR\x0fnumIncomingNode\x12<\n" +
	"\x06config\x18\a \x01(\v2$.milvus.proto.rg.ResourceGroupConfigR\x06config\x123\n" +
	"\x05nodes\x18\b \x03(\v2\x1d.milvus.proto.common.NodeInfoR\x05nodes\x1aC\n" +
	"\x15NumLoadedReplicaEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\x1aB\n" +
	"\x14NumOutgoingNodeEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\x1aB\n" +
	"\x14NumIncomingNodeEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	...
	"\rvchannel_name\x18\x04 \x01(\tR\fvchannelName\x12\x1d\n" +
	"\n" +
	"segment_id\x18\x05 \x01(\x03R\tsegmentId\x12;\n" +
	"\fprimary_keys\x18\x06 \x01(\v2\x18.milvus.proto.schema.IDsR\vprimaryKeys\x12\x1e\n" +
	"\n" +
	"timestamps\x18\a \x03(\x04R\n" +
	"timestamps\x123\n" +
	"\x05scope\x18\b \x01(\x0e2\x1d.milvus.proto.query.DataScopeR\x05scope\x12\x19\n" +
	"\buse_load\x18\t \x01(\bR\auseLoad\"\xe6\x02\n" +
	"\x12DeleteBatchRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\x03R\fcollectionId\x12!\n" +
	"\fpartition_id\x18\x03 \x01(\x03R\vpartitionId\x12#\n" +
	"\rvchannel_name\x18\x04 \x01(\tR\fvchannelName\x12\x1f\n" +
	"\vsegment_ids\x18\x05 \x03(\x03R\n" +
	"segmentIds\x12;\n" +
	"\fprimary_keys\x18\x06 \x01(\v2\x18.milvus.proto.schema.IDsR\vprimaryKeys\x12\x1e\n" +
	"\n" +
	"timestamps\x18\a \x03(\x04R\n" +
	"timestamps\x123\n" +
	"\x05scope\x18\b \x01(\x0e2\x1d.milvus.proto.query.DataScopeR\x05scope\"\x8a\x01\n" +
	"\x13DeleteBatchResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12\x1d\n" +
	"\n" +
	"failed_ids\x18\x02 \x03(\x03R\tfailedIds\x12\x1f\n" +
	"\vmissing_ids\x18\x03 \x03(\x03R\n" +
	"missingIds\"h\n" +
	"\x16ActivateCheckerRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x1c\n" +
	"\tcheckerID\x18\x02 \x01(\x05R\tcheckerID\"j\n" +
	"\x18DeactivateCheckerRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x1c\n" +
	"\tcheckerID\x18\x02 \x01(\x05R\tcheckerID\"g\n" +
	"\x13ListCheckersRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x1e\n" +
	"\n" +
	"checkerIDs\x18\x02 \x03(\x05R\n" +
	"checkerIDs\"\x90\x01\n" +
	"\x14ListCheckersResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12C\n" +
	"\fcheckerInfos\x18\x02 \x03(\v2\x1f.milvus.proto.query.CheckerInfoR\fcheckerInfos\"e\n" +
	"\vCheckerInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x12\n" +
	"\x04desc\x18\x02 \x01(\tR\x04desc\x12\x1c\n" +
	"\tactivated\x18\x03 \x01(\bR\tactivated\x12\x14\n" +
	"\x05found\x18\x04 \x01(\bR\x05found\"v\n" +
	"\rSegmentTarget\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\x03R\x02ID\x125\n" +
	"\x05level\x18\x02 \x01(\x0e2\x1f.milvus.proto.data.SegmentLevelR\x05level\x12\x1e\n" +
	"\vnum_of_rows\x18\x03 \x01(\x03R\tnumOfRows\"r\n" +
	"\x0fPartitionTarget\x12 \n" +
	"\vpartitionID\x18\x01 \x01(\x03R\vpartitionID\x12=\n" +
	"\bsegments\x18\x02 \x03(\v2!.milvus.proto.query.SegmentTargetR\bsegments\"\xf1\x02\n" +
	"\rChannelTarget\x12 \n" +
	"\vchannelName\x18\x01 \x01(\tR\vchannelName\x12-\n" +
	"\x12dropped_segmentIDs\x18\x02 \x03(\x03R\x11droppedSegmentIDs\x12-\n" +
	"\x12growing_segmentIDs\x18\x03 \x03(\x03R\x11growingSegmentIDs\x12P\n" +
	"\x11partition_targets\x18\x04 \x03(\v2#.milvus.proto.query.PartitionTargetR\x10partitionTargets\x12B\n" +
	"\rseek_position\x18\x05 \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\fseekPosition\x12J\n" +
	"\x11delete_checkpoint\x18\x06 \x01(\v2\x1d.milvus.proto.msg.MsgPositionR\x10deleteCheckpoint\"\x9c\x01\n" +
	"\x10CollectionTarget\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\x03R\fcollectionID\x12J\n" +
	"\x0fChannel_targets\x18\x02 \x03(\v2!.milvus.proto.query.ChannelTargetR\x0eChannelTargets\x12\x18\n" +
	...
	"\x14ListQueryNodeRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\"\x88\x01\n" +
	"\x15ListQueryNodeResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12:\n" +
	"\tnodeInfos\x18\x02 \x03(\v2\x1c.milvus.proto.query.NodeInfoR\tnodeInfos\"k\n" +
	"\x1fGetQueryNodeDistributionRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x16\n" +
	"\x06nodeID\x18\x02 \x01(\x03R\x06nodeID\"\xb9\x01\n" +
	" GetQueryNodeDistributionResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12\x0e\n" +
	"\x02ID\x18\x02 \x01(\x03R\x02ID\x12#\n" +
	"\rchannel_names\x18\x03 \x03(\tR\fchannelNames\x12+\n" +
	"\x11sealed_segmentIDs\x18\x04 \x03(\x03R\x10sealedSegmentIDs\"I\n" +
	"\x15SuspendBalanceRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\"H\n" +
	"\x14ResumeBalanceRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\"M\n" +
	"\x19CheckBalanceStatusRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\"n\n" +
	"\x1aCheckBalanceStatusResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12\x1b\n" +
	"\tis_active\x18\x02 \x01(\bR\bisActive\"^\n" +
	"\x12SuspendNodeRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x16\n" +
	"\x06nodeID\x18\x02 \x01(\x03R\x06nodeID\"]\n" +
	"\x11ResumeNodeRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x16\n" +
	"\x06nodeID\x18\x02 \x01(\x03R\x06nodeID\"\x94\x02\n" +
	"\x16TransferSegmentRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x1c\n" +
	"\tsegmentID\x18\x02 \x01(\x03R\tsegmentID\x12#\n" +
	"\rsource_nodeID\x18\x03 \x01(\x03R\fsourceNodeID\x12#\n" +
	"\rtarget_nodeID\x18\x04 \x01(\x03R\ftargetNodeID\x12!\n" +
	"\ftransfer_all\x18\x05 \x01(\bR\vtransferAll\x12 \n" +
	"\fto_all_nodes\x18\x06 \x01(\bR\n" +
	"toAllNodes\x12\x1b\n" +
	"\tcopy_mode\x18\a \x01(\bR\bcopyMode\"\x99\x02\n" +
	"\x16TransferChannelRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12!\n" +
	...
	"\fto_all_nodes\x18\x06 \x01(\bR\n" +
	"toAllNodes\x12\x1b\n" +
	"\tcopy_mode\x18\a \x01(\bR\bcopyMode\"\x9f\x01\n" +
	"!CheckQueryNodeDistributionRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12#\n" +
	"\rsource_nodeID\x18\x03 \x01(\x03R\fsourceNodeID\x12#\n" +
	"\rtarget_nodeID\x18\x04 \x01(\x03R\ftargetNodeID\"\xd5\x01\n" +
	"\x17UpdateLoadConfigRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x12\n" +
	"\x04dbID\x18\x02 \x01(\x03R\x04dbID\x12$\n" +
	"\rcollectionIDs\x18\x03 \x03(\x03R\rcollectionIDs\x12%\n" +
	"\x0ereplica_number\x18\x04 \x01(\x05R\rreplicaNumber\x12'\n" +
	"\x0fresource_groups\x18\x05 \x03(\tR\x0eresourceGroups\"\xc4\x01\n" +
	"\x13UpdateSchemaRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\"\n" +
	"\fcollectionID\x18\x02 \x01(\x03R\fcollectionID\x12=\n" +
	"\x06schema\x18\x03 \x01(\v2%.milvus.proto.schema.CollectionSchemaR\x06schema\x12\x18\n" +
	"\aversion\x18\x04 \x01(\x04R\aversion\"\xf5\x03\n" +
	"\x12UpdateIndexRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\"\n" +
	"\fcollectionID\x18\x02 \x01(\x03R\fcollectionID\x12E\n" +
	"\x06action\x18\x03 \x01(\v2-.milvus.proto.query.UpdateIndexRequest.ActionR\x06action\x1aH\n" +
	"\bAddIndex\x12<\n" +
	"\n" +
	"index_info\x18\x01 \x01(\v2\x1d.milvus.proto.index.IndexInfoR\tindexInfo\x1a&\n" +
	"\tDropIndex\x12\x19\n" +
	"\bindex_id\x18\x01 \x01(\x03R\aindexId\x1a\xcf\x01\n" +
	"\x06Action\x12]\n" +
	"\x11add_index_request\x18\x01 \x01(\v2/.milvus.proto.query.UpdateIndexRequest.AddIndexH\x00R\x0faddIndexRequest\x12`\n" +
	"\x12drop_index_request\x18\x02 \x01(\v20.milvus.proto.query.UpdateIndexRequest.DropIndexH\x00R\x10dropIndexRequestB\x04\n" +
	"\x02op\"\xab\x02\n" +
	"\x12RunAnalyzerRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x18\n" +
	"\achannel\x18\x02 \x01(\tR\achannel\x12\x19\n" +
	"\bfield_id\x18\x03 \x01(\x03R\afieldId\x12%\n" +
	"\x0eanalyzer_names\x18\x04 \x03(\tR\ranalyzerNames\x12 \n" +
	"\vplaceholder\x18\x05 \x03(\fR\vplaceholder\x12\x1f\n" +
	"\vwith_detail\x18\x06 \x01(\bR\n" +
	"withDetail\x12\x1b\n" +
	"\twith_hash\x18\a \x01(\bR\bwithHash\x12'\n" +
	"\x0fanalyzer_params\x18\b \x01(\tR\x0eanalyzerParams\"P\n" +
	"\fAnalyzerInfo\x12\x16\n" +
	"\x06params\x18\x01 \x01(\tR\x06params\x12\x14\n" +
	"\x05field\x18\x02 \x01(\tR\x05field\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"\x94\x01\n" +
	"\x17ValidateAnalyzerRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12G\n" +
	"\x0eanalyzer_infos\x18\x02 \x03(\v2 .milvus.proto.query.AnalyzerInfoR\ranalyzerInfos\"r\n" +
	"\x18ValidateAnalyzerResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12!\n" +
	"\fresource_ids\x18\x02 \x03(\x03R\vresourceIds\"\x8a\x01\n" +
	"\x10HighlightOptions\x12#\n" +
	"\rfragment_size\x18\x01 \x01(\x03R\ffragmentSize\x12'\n" +
	"\x0ffragment_offset\x18\x02 \x01(\x03R\x0efragmentOffset\x12(\n" +
	"\x10num_of_fragments\x18\x03 \x01(\x03R\x0enumOfFragments\"L\n" +
	"\x0eHighlightQuery\x12:\n" +
	"\x04type\x18\x01 \x01(\x0e2&.milvus.proto.query.HighlightQueryTypeR\x04type\"\xd4\x02\n" +
	"\rHighlightTask\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x19\n" +
	"\bfield_id\x18\x02 \x01(\x03R\afieldId\x12\x14\n" +
	"\x05texts\x18\x03 \x03(\tR\x05texts\x12%\n" +
	"\x0eanalyzer_names\x18\x04 \x03(\tR\ranalyzerNames\x12&\n" +
	"\x0fsearch_text_num\x18\x05 \x01(\x03R\rsearchTextNum\x12&\n" +
	"\x0fcorpus_text_num\x18\x06 \x01(\x03R\rcorpusTextNum\x12>\n" +
	"\aoptions\x18\a \x01(\v2$.milvus.proto.query.HighlightOptionsR\aoptions\x12<\n" +
	"\aqueries\x18\b \x03(\v2\".milvus.proto.query.HighlightQueryR\aqueries\"\xb0\x01\n" +
	"\x13GetHighlightRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x18\n" +
	"\achannel\x18\x02 \x01(\tR\achannel\x12\x14\n" +
	"\x05topks\x18\x03 \x03(\x03R\x05topks\x127\n" +
	"\x05tasks\x18\x04 \x03(\v2!.milvus.proto.query.HighlightTaskR\x05tasks\"o\n" +
	"\x11HighlightFragment\x12!\n" +
	"\fstart_offset\x18\x01 \x01(\x03R\vstartOffset\x12\x1d\n" +
	"\n" +
	"end_offset\x18\x02 \x01(\x03R\tendOffset\x12\x18\n" +
	"\aoffsets\x18\x03 \x03(\x03R\aoffsets\"V\n" +
	"\x0fHighlightResult\x12C\n" +
	"\tfragments\x18\x02 \x03(\v2%.milvus.proto.query.HighlightFragmentR\tfragments\"\x8a\x01\n" +
	"\x14GetHighlightResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12=\n" +
	"\aresults\x18\x02 \x03(\v2#.milvus.proto.query.HighlightResultR\aresults\"M\n" +
	"\x19ListLoadedSegmentsRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\"q\n" +
	"\x1aListLoadedSegmentsResponse\x123\n" +
	"\x06status\x18\x01 \x01(\v2\x1b.milvus.proto.common.StatusR\x06status\x12\x1e\n" +
	"\n" +
	"segmentIDs\x18\x02 \x03(\x03R\n" +
	"segmentIDs\"\xbd\x01\n" +
	"\x10DropIndexRequest\x120\n" +
	"\x04base\x18\x01 \x01(\v2\x1c.milvus.proto.common.MsgBaseR\x04base\x12\x1c\n" +
	"\tsegmentID\x18\x02 \x01(\x03R\tsegmentID\x12\x1a\n" +
	"\bindexIDs\x18\x03 \x03(\x03R\bindexIDs\x12\x18\n" +
	"\achannel\x18\x04 \x01(\tR\achannel\x12#\n" +
	"\rneed_transfer\x18\x05 \x01(\bR\fneedTransfer*B\n" +
	"\tLoadScope\x12\b\n" +
	"\x04Full\x10\x00\x12\t\n" +
	...
	"\x0ePartitionState\x12\f\n" +
	"\bNotExist\x10\x00\x12\x0e\n" +
	"\n" +
	"NotPresent\x10\x01\x12\n" +
	"\n" +
	"\x06OnDisk\x10\x02\x12\x13\n" +
	"\x0fPartialInMemory\x10\x03\x12\f\n" +
	"\bInMemory\x10\x04\x12\x10\n" +
	"\fPartialInGPU\x10\x05\x12\t\n" +
	"\x05InGPU\x10\x06*d\n" +
	"\x10TriggerCondition\x12\x13\n" +
	"\x0fUnKnowCondition\x10\x00\x12\v\n" +
	"\aHandoff\x10\x01\x12\x0f\n" +
	"\vLoadBalance\x10\x02\x12\x0f\n" +
	"\vGrpcRequest\x10\x03\x12\f\n" +
	"\bNodeDown\x10\x04*B\n" +
	"\bLoadType\x12\x0f\n" +
	"\vUnKnownType\x10\x00\x12\x11\n" +
	...
	"\x03Set\x10\x01\x12\t\n" +
	"\x05Amend\x10\x02\x12\x11\n" +
	"\rUpdateVersion\x10\x03\x12\x18\n" +
	"\x14UpdatePartitionStats\x10\x04*#\n" +
	"\x12HighlightQueryType\x12\r\n" +
	"\tTextMatch\x10\x002\xd9 \n" +
	"\n" +
	"QueryCoord\x12p\n" +
	"\x13ShowLoadCollections\x12*.milvus.proto.query.ShowCollectionsRequest\x1a+.milvus.proto.query.ShowCollectionsResponse\"\x00\x12m\n" +
	"\x12ShowLoadPartitions\x12).milvus.proto.query.ShowPartitionsRequest\x1a*.milvus.proto.query.ShowPartitionsResponse\"\x00\x12Z\n" +
	...
	"\x17SyncNewCreatedPartition\x122.milvus.proto.query.SyncNewCreatedPartitionRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12u\n" +
	"\x12GetPartitionStates\x12-.milvus.proto.query.GetPartitionStatesRequest\x1a..milvus.proto.query.GetPartitionStatesResponse\"\x00\x12m\n" +
	"\x12GetLoadSegmentInfo\x12).milvus.proto.query.GetSegmentInfoRequest\x1a*.milvus.proto.query.GetSegmentInfoResponse\"\x00\x12T\n" +
	"\vLoadBalance\x12&.milvus.proto.query.LoadBalanceRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12{\n" +
	...
	"\vGetReplicas\x12'.milvus.proto.milvus.GetReplicasRequest\x1a(.milvus.proto.milvus.GetReplicasResponse\"\x00\x12l\n" +
	"\x0fGetShardLeaders\x12*.milvus.proto.query.GetShardLeadersRequest\x1a+.milvus.proto.query.GetShardLeadersResponse\"\x00\x12b\n" +
	"\vCheckHealth\x12'.milvus.proto.milvus.CheckHealthRequest\x1a(.milvus.proto.milvus.CheckHealthResponse\"\x00\x12e\n" +
	"\x13CreateResourceGroup\x12/.milvus.proto.milvus.CreateResourceGroupRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12f\n" +
	"\x14UpdateResourceGroups\x12/.milvus.proto.query.UpdateResourceGroupsRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12a\n" +
	"\x11DropResourceGroup\x12-.milvus.proto.milvus.DropResourceGroupRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12Z\n" +
	"\fTransferNode\x12(.milvus.proto.milvus.TransferNodeRequest\x1a\x1b.milvus.proto.common.Status\"\x03\x88\x02\x01\x12\\\n" +
	...
	"\x15DescribeResourceGroup\x120.milvus.proto.query.DescribeResourceGroupRequest\x1a1.milvus.proto.query.DescribeResourceGroupResponse\"\x00\x12u\n" +
	"\x12ListLoadedSegments\x12-.milvus.proto.query.ListLoadedSegmentsRequest\x1a..milvus.proto.query.ListLoadedSegmentsResponse\"\x00\x12c\n" +
	"\fListCheckers\x12'.milvus.proto.query.ListCheckersRequest\x1a(.milvus.proto.query.ListCheckersResponse\"\x00\x12\\\n" +
	"\x0fActivateChecker\x12*.milvus.proto.query.ActivateCheckerRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12`\n" +
	"\x11DeactivateChecker\x12,.milvus.proto.query.DeactivateCheckerRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12f\n" +
	"\rListQueryNode\x12(.milvus.proto.query.ListQueryNodeRequest\x1a).milvus.proto.query.ListQueryNodeResponse\"\x00\x12\x87\x01\n" +
	"\x18GetQueryNodeDistribution\x123.milvus.proto.query.GetQueryNodeDistributionRequest\x1a4.milvus.proto.query.GetQueryNodeDistributionResponse\"\x00\x12Z\n" +
	"\x0eSuspendBalance\x12).milvus.proto.query.SuspendBalanceRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12X\n" +
	"\rResumeBalance\x12(.milvus.proto.query.ResumeBalanceRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12u\n" +
	"\x12CheckBalanceStatus\x12-.milvus.proto.query.CheckBalanceStatusRequest\x1a..milvus.proto.query.CheckBalanceStatusResponse\"\x00\x12T\n" +
	"\vSuspendNode\x12&.milvus.proto.query.SuspendNodeRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12R\n" +
	"\n" +
	"ResumeNode\x12%.milvus.proto.query.ResumeNodeRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12\\\n" +
	"\x0fTransferSegment\x12*.milvus.proto.query.TransferSegmentRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12\\\n" +
	"\x0fTransferChannel\x12*.milvus.proto.query.TransferChannelRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12r\n" +
	"\x1aCheckQueryNodeDistribution\x125.milvus.proto.query.CheckQueryNodeDistributionRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12^\n" +
	"\x10UpdateLoadConfig\x12+.milvus.proto.query.UpdateLoadConfigRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12a\n" +
	"\vRunAnalyzer\x12&.milvus.proto.query.RunAnalyzerRequest\x1a(.milvus.proto.milvus.RunAnalyzerResponse\"\x00\x12\x81\x01\n" +
	"\x16ComputePhraseMatchSlop\x121.milvus.proto.query.ComputePhraseMatchSlopRequest\x1a2.milvus.proto.query.ComputePhraseMatchSlopResponse\"\x00\x12o\n" +
	"\x10ValidateAnalyzer\x12+.milvus.proto.query.ValidateAnalyzerRequest\x1a,.milvus.proto.query.ValidateAnalyzerResponse\"\x002\xd3\x19\n" +
	"\tQueryNode\x12l\n" +
	...
	"\fLoadSegments\x12'.milvus.proto.query.LoadSegmentsRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12`\n" +
	...
	"\x0eGetSegmentInfo\x12).milvus.proto.query.GetSegmentInfoRequest\x1a*.milvus.proto.query.GetSegmentInfoResponse\"\x00\x12d\n" +
	...
	"\x06Search\x12!.milvus.proto.query.SearchRequest\x1a$.milvus.proto.internal.SearchResults\"\x00\x12[\n" +
	...
	"\vQueryStream\x12 .milvus.proto.query.QueryRequest\x1a&.milvus.proto.internal.RetrieveResults\"\x000\x01\x12[\n" +
	"\rQuerySegments\x12 .milvus.proto.query.QueryRequest\x1a&.milvus.proto.internal.RetrieveResults\"\x00\x12c\n" +
	"\x13QueryStreamSegments\x12 .milvus.proto.query.QueryRequest\x1a&.milvus.proto.internal.RetrieveResults\"\x000\x01\x12{\n" +
	"\x12ShowConfigurations\x120.milvus.proto.internal.ShowConfigurationsRequest\x1a1.milvus.proto.internal.ShowConfigurationsResponse\"\x00\x12_\n" +
	"\n" +
	...
	"\x06Delete\x12!.milvus.proto.query.DeleteRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12`\n" +
	"\vDeleteBatch\x12&.milvus.proto.query.DeleteBatchRequest\x1a'.milvus.proto.query.DeleteBatchResponse\"\x00\x12V\n" +
	"\fUpdateSchema\x12'.milvus.proto.query.UpdateSchemaRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12T\n" +
	"\vUpdateIndex\x12&.milvus.proto.query.UpdateIndexRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12a\n" +
	"\vRunAnalyzer\x12&.milvus.proto.query.RunAnalyzerRequest\x1a(.milvus.proto.milvus.RunAnalyzerResponse\"\x00\x12c\n" +
	"\fGetHighlight\x12'.milvus.proto.query.GetHighlightRequest\x1a(.milvus.proto.query.GetHighlightResponse\"\x00\x12P\n" +
	"\tDropIndex\x12$.milvus.proto.query.DropIndexRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12o\n" +
	"\x10ValidateAnalyzer\x12+.milvus.proto.query.ValidateAnalyzerRequest\x1a,.milvus.proto.query.ValidateAnalyzerResponse\"\x00\x12a\n" +
	"\x10SyncFileResource\x12..milvus.proto.internal.SyncFileResourceRequest\x1a\x1b.milvus.proto.common.Status\"\x00\x12\x81\x01\n" +
	"\x16ComputePhraseMatchSlop\x121.milvus.proto.query.ComputePhraseMatchSlopRequest\x1a2.milvus.proto.query.ComputePhraseMatchSlopResponse\"\x00B2Z0github.com/milvus-io/milvus/pkg/v2/proto/querypbb\x06proto3"

var (
	file_query_coord_proto_rawDescOnce sync.Once
	file_query_coord_proto_rawDescData []byte
)

func file_query_coord_proto_rawDescGZIP() []byte {
	file_query_coord_proto_rawDescOnce.Do(func() {
		file_query_coord_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_query_coord_proto_rawDesc), len(file_query_coord_proto_rawDesc)))
	})
...
var file_query_coord_proto_goTypes = []any{
...
func file_query_coord_proto_init() {
	...
	file_query_coord_proto_msgTypes[129].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_query_coord_proto_rawDesc), len(file_query_coord_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   130,
			NumExtensions: 0,
			NumServices:   2,
