...
type ChannelTarget struct {
	...
	// The split target vchannels DataCoord reported for this channel when the target was pulled
	// (data.VchannelInfo.split_target_channels). Kept so a QueryCoord restart hands the QueryNode the
	// same split signal the seek position was pulled with.
	SplitTargetChannels []string `protobuf:"bytes,7,rep,name=split_target_channels,json=splitTargetChannels,proto3" json:"split_target_channels,omitempty"`
}
...
func (x *ChannelTarget) GetSplitTargetChannels() []string {
	if x != nil {
		return x.SplitTargetChannels
	}
	return nil
}
...
var file_query_coord_proto_rawDesc = []byte{
	...
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xa5, 0x03, 0x0a, 0x0d, 0x43, 0x68, 0x61, 0x6e,
	...
	0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x32, 0x0a, 0x15, 0x73,
	0x70, 0x6c, 0x69, 0x74, 0x5f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x63, 0x68, 0x61, 0x6e,
	0x6e, 0x65, 0x6c, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x13, 0x73, 0x70, 0x6c, 0x69,
	0x74, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x73, 0x22,
