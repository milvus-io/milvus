...
type LeaderView struct {
	...
	// Sealed segments that are loaded under this delegator but are no longer part of its
	// readable snapshot, i.e. the delegator is not serving them and they can be released
	// as far as the delegator is concerned. Only meaningful when
	// LeaderViewStatus.reports_serving_set is true.
	NotServingSegmentIDs []int64 `protobuf:"varint,10,rep,packed,name=not_serving_segmentIDs,json=notServingSegmentIDs,proto3" json:"not_serving_segmentIDs,omitempty"`
}
...
type LeaderViewStatus struct {
	...
	// true = this delegator reports not_serving_segmentIDs, so QueryCoord can decide
	// segment release from the reported fact instead of inferring it from target versions.
	// Absent on QueryNodes older than this feature, where coord falls back to the
	// target-version guard.
	ReportsServingSet bool `protobuf:"varint,3,opt,name=reports_serving_set,json=reportsServingSet,proto3" json:"reports_serving_set,omitempty"`
}
...
var file_query_coord_proto_rawDesc = []byte{
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x63, 0x70, 0x75, 0x4e, 0x75, 0x6d, 0x22, 0xf7,
	...
	0x74, 0x75, 0x73, 0x12, 0x34, 0x0a, 0x16, 0x6e, 0x6f, 0x74, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x6e, 0x67, 0x5f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x18, 0x0a, 0x20,
	0x03, 0x28, 0x03, 0x52, 0x14, 0x6e, 0x6f, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x53,
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x1a, 0x5f, 0x0a, 0x10, 0x53, 0x65, 0x67,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa1, 0x01, 0x0a, 0x10, 0x4c, 0x65, 0x61,
	...
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2e, 0x0a, 0x13,
	0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x5f,
	0x73, 0x65, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x72, 0x65, 0x70, 0x6f, 0x72,
	0x74, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x74, 0x22, 0x3f, 0x0a, 0x0b,
	...
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x2a, 0x3d, 0x0a, 0x09, 0x4c, 0x6f, 0x61, 0x64, 0x53, 0x63, 0x6f,
