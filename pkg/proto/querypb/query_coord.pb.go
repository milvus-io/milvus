...
type UpdateIndexRequest struct {
	...
	// index_barrier_ts is the WAL BeginTs of the CreateIndex message; it is a
	// monotonic apply cursor so a stale (older-ts) index update is skipped after a
	// newer one has been applied (mirrors UpdateSchemaRequest.schema_barrier_ts).
	IndexBarrierTs uint64 `protobuf:"varint,4,opt,name=index_barrier_ts,json=indexBarrierTs,proto3" json:"index_barrier_ts,omitempty"`
}
...
func (x *UpdateIndexRequest) GetIndexBarrierTs() uint64 {
	if x != nil {
		return x.IndexBarrierTs
	}
	return 0
}
...
var file_query_coord_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x61, 0x42, 0x61, 0x72, 0x72, 0x69, 0x65, 0x72, 0x54, 0x73, 0x22, 0x9f, 0x04, 0x0a,
	...
	0x12, 0x28, 0x0a, 0x10, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x62, 0x61, 0x72, 0x72, 0x69, 0x65,
	0x72, 0x5f, 0x74, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x69, 0x6e, 0x64, 0x65,
	0x78, 0x42, 0x61, 0x72, 0x72, 0x69, 0x65, 0x72, 0x54, 0x73, 0x1a, 0x48, 0x0a, 0x08, 0x41, 0x64,
