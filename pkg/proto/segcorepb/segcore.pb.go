...
type SegmentLoadInfo struct {
	...
	// max_index_row_count is the expected row capacity of a segment of this
	// collection: segment max size * seal proportion / estimated row size. It only
	// scales the interim-index build threshold (VecIndexConfig::GetBuildThreshold).
	// It travels with the segment because it is derived from DataCoord config that
	// segcore cannot read, and it used to arrive on the collection-wide index meta.
	MaxIndexRowCount int64 `protobuf:"varint,25,opt,name=max_index_row_count,json=maxIndexRowCount,proto3" json:"max_index_row_count,omitempty"`
}
...
func (x *SegmentLoadInfo) GetMaxIndexRowCount() int64 {
	if x != nil {
		return x.MaxIndexRowCount
	}
	return 0
...
var file_segcore_proto_rawDesc = []byte{
	...
	0xb9, 0x0b, 0x0a, 0x0f, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x61, 0x64, 0x49,
	...
	0x69, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x2d, 0x0a, 0x13, 0x6d,
	0x61, 0x78, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x72, 0x6f, 0x77, 0x5f, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x18, 0x19, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x6d, 0x61, 0x78, 0x49, 0x6e, 0x64,
	0x65, 0x78, 0x52, 0x6f, 0x77, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x66, 0x0a, 0x12, 0x54, 0x65,
	...
	0x33, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x65, 0x67, 0x63, 0x6f, 0x72, 0x65, 0x70,
