...
type CollectionInfo struct {
	...
	RoutingMode schemapb.RoutingMode `protobuf:"varint,19,opt,name=routing_mode,json=routingMode,proto3,enum=milvus.proto.schema.RoutingMode" json:"routing_mode,omitempty"`
}
...
func (x *CollectionInfo) GetRoutingMode() schemapb.RoutingMode {
	if x != nil {
		return x.RoutingMode
	}
	return schemapb.RoutingMode(0)
}
...
var file_etcd_meta_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x49, 0x44, 0x22, 0xca,
	...
	0x64, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x12, 0x43, 0x0a, 0x0c, 0x72, 0x6f, 0x75, 0x74, 0x69, 0x6e,
	0x67, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x6d,
	0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x64, 0x65, 0x52, 0x0b,
	0x72, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0xf5, 0x01, 0x0a, 0x0d,
...
var file_etcd_meta_proto_goTypes = []interface{}{
	...
	(schemapb.RoutingMode)(0),            // 18: milvus.proto.schema.RoutingMode
}
var file_etcd_meta_proto_depIdxs = []int32{
	...
	18, // 8: milvus.proto.etcd.CollectionInfo.routing_mode:type_name -> milvus.proto.schema.RoutingMode
	2,  // 9: milvus.proto.etcd.PartitionInfo.state:type_name -> milvus.proto.etcd.PartitionState
	3,  // 10: milvus.proto.etcd.AliasInfo.state:type_name -> milvus.proto.etcd.AliasState
	0,  // 11: milvus.proto.etcd.DatabaseInfo.state:type_name -> milvus.proto.etcd.DatabaseState
	13, // 12: milvus.proto.etcd.DatabaseInfo.properties:type_name -> milvus.proto.common.KeyValuePair
	14, // 13: milvus.proto.etcd.CollectionMeta.schema:type_name -> milvus.proto.schema.CollectionSchema
