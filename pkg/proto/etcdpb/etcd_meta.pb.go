...
// ShardState is the lifecycle state of a shard during shard split.
type ShardState int32

const (
	ShardState_ShardNormal    ShardState = 0 // serving reads and writes, the default for compatibility.
	ShardState_ShardCreating  ShardState = 1 // split target: created but not yet adopted, invisible to querycoord.
	ShardState_ShardSplitting ShardState = 2 // split source: fenced at T_switch, rejecting new writes.
	ShardState_ShardDropped   ShardState = 3 // split source: released after all targets are adopted.
)
...
func (ShardState) Descriptor() protoreflect.EnumDescriptor {
	return file_etcd_meta_proto_enumTypes[4].Descriptor()
}

func (ShardState) Type() protoreflect.EnumType {
	return &file_etcd_meta_proto_enumTypes[4]
}
...
// RoutingMode is the algorithm mapping a routing key to a shard.
type RoutingMode int32

const (
	RoutingMode_RoutingModeHash  RoutingMode = 0 // hash(key) % shardNum, the default, bit-for-bit compatible with legacy collections.
	RoutingMode_RoutingModeRange RoutingMode = 1 // binary search over the shards' byte-comparable key ranges.
)
...
func (RoutingMode) Descriptor() protoreflect.EnumDescriptor {
	return file_etcd_meta_proto_enumTypes[5].Descriptor()
}

func (RoutingMode) Type() protoreflect.EnumType {
	return &file_etcd_meta_proto_enumTypes[5]
}
...
type CollectionInfo struct {
	...
	// routing_mode decides how a routing key maps to a shard, RoutingModeHash for legacy collections.
	// Routing changes are driven by per-shard state + fence, not a version counter.
	RoutingMode RoutingMode `protobuf:"varint,19,opt,name=routing_mode,json=routingMode,proto3,enum=milvus.proto.etcd.RoutingMode" json:"routing_mode,omitempty"`
}
...
func (x *CollectionInfo) GetRoutingMode() RoutingMode {
	if x != nil {
		return x.RoutingMode
	}
	return RoutingMode_RoutingModeHash
}
...
type CollectionShardInfo struct {
	...
	// The routing key range [routing_key_lower, routing_key_upper) owned by the shard.
	// Keys are byte-comparable (byte order = logical order), an empty value means unbounded.
	// Only meaningful when the collection's routing_mode is RoutingModeRange.
	...
	State           ShardState `protobuf:"varint,4,opt,name=state,proto3,enum=milvus.proto.etcd.ShardState" json:"state,omitempty"` // the default ShardNormal keeps legacy shards serving.
}
...
func (x *CollectionShardInfo) GetRoutingKeyLower() []byte {
	if x != nil {
...
func (x *CollectionShardInfo) GetRoutingKeyUpper() []byte {
	if x != nil {
...
var file_etcd_meta_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x49, 0x44, 0x22, 0xc6,
	...
	,
	...
	,
	...
	0x49, 0x64, 0x12, 0x37, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x21, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x65, 0x74, 0x63, 0x64, 0x2e, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xbc, 0x01, 0x0a, 0x09,
	0x41, 0x6c, 0x69, 0x61, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x6c, 0x69,
	0x61, 0x73, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61,
	0x6c, 0x69, 0x61, 0x73, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6c, 0x6c,
	...
	0x1d, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x65,
	0x74, 0x63, 0x64, 0x2e, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x13, 0x0a, 0x05, 0x64, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x64, 0x62, 0x49, 0x64, 0x22, 0xed, 0x01, 0x0a, 0x0c, 0x44,
	0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1b, 0x0a, 0x09, 0x74,
	...
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x36, 0x0a, 0x05,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x6d, 0x69,
	0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x65, 0x74, 0x63, 0x64, 0x2e,
	0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f,
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x63, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x41, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x65,
	...
	0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x22, 0x88, 0x02, 0x0a, 0x10, 0x53,
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x74, 0x49, 0x44, 0x12, 0x18, 0x0a, 0x07, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x49, 0x44, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x49, 0x44, 0x12, 0x18, 0x0a,
	0x07, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x49, 0x44, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07,
	...
	0x78, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x49,
	0x6e, 0x64, 0x65, 0x78, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x74,
	0x69, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xeb, 0x01, 0x0a, 0x0e, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x49, 0x44, 0x12, 0x3d, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x65,
	...
	0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x73, 0x65, 0x67, 0x6d,
	0x65, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0a, 0x73, 0x65,
	0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x70, 0x61, 0x72, 0x74,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x61, 0x67, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x0d, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x61, 0x67, 0x73, 0x12,
	...
	0x49, 0x44, 0x73, 0x22, 0xb7, 0x01, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69,
	...
	0x09, 0x52, 0x06, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f,
	...
	,
	...
	,
	...
	0x70, 0x6b, 0x67, 0x2f, 0x76, 0x33, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x74, 0x63,
...
var file_etcd_meta_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
...
var file_etcd_meta_proto_goTypes = []interface{}{
	...
	(ShardState)(0),                   // 4: milvus.proto.etcd.ShardState
	(RoutingMode)(0),                  // 5: milvus.proto.etcd.RoutingMode
	(*IndexInfo)(nil),                 // 6: milvus.proto.etcd.IndexInfo
	(*FieldIndexInfo)(nil),            // 7: milvus.proto.etcd.FieldIndexInfo
	(*CollectionInfo)(nil),            // 8: milvus.proto.etcd.CollectionInfo
	(*CollectionShardInfo)(nil),       // 9: milvus.proto.etcd.CollectionShardInfo
	(*PartitionInfo)(nil),             // 10: milvus.proto.etcd.PartitionInfo
	(*AliasInfo)(nil),                 // 11: milvus.proto.etcd.AliasInfo
	(*DatabaseInfo)(nil),              // 12: milvus.proto.etcd.DatabaseInfo
	(*SegmentIndexInfo)(nil),          // 13: milvus.proto.etcd.SegmentIndexInfo
	(*CollectionMeta)(nil),            // 14: milvus.proto.etcd.CollectionMeta
	(*CredentialInfo)(nil),            // 15: milvus.proto.etcd.CredentialInfo
	(*commonpb.KeyValuePair)(nil),     // 16: milvus.proto.common.KeyValuePair
	(*schemapb.CollectionSchema)(nil), // 17: milvus.proto.schema.CollectionSchema
	(*commonpb.KeyDataPair)(nil),      // 18: milvus.proto.common.KeyDataPair
	(commonpb.ConsistencyLevel)(0),    // 19: milvus.proto.common.ConsistencyLevel
}
var file_etcd_meta_proto_depIdxs = []int32{
	16, // 0: milvus.proto.etcd.IndexInfo.index_params:type_name -> milvus.proto.common.KeyValuePair
	17, // 1: milvus.proto.etcd.CollectionInfo.schema:type_name -> milvus.proto.schema.CollectionSchema
	7,  // 2: milvus.proto.etcd.CollectionInfo.field_indexes:type_name -> milvus.proto.etcd.FieldIndexInfo
	18, // 3: milvus.proto.etcd.CollectionInfo.start_positions:type_name -> milvus.proto.common.KeyDataPair
	19, // 4: milvus.proto.etcd.CollectionInfo.consistency_level:type_name -> milvus.proto.common.ConsistencyLevel
	1,  // 5: milvus.proto.etcd.CollectionInfo.state:type_name -> milvus.proto.etcd.CollectionState
	16, // 6: milvus.proto.etcd.CollectionInfo.properties:type_name -> milvus.proto.common.KeyValuePair
	9,  // 7: milvus.proto.etcd.CollectionInfo.shard_infos:type_name -> milvus.proto.etcd.CollectionShardInfo
	5,  // 8: milvus.proto.etcd.CollectionInfo.routing_mode:type_name -> milvus.proto.etcd.RoutingMode
	4,  // 9: milvus.proto.etcd.CollectionShardInfo.state:type_name -> milvus.proto.etcd.ShardState
	2,  // 10: milvus.proto.etcd.PartitionInfo.state:type_name -> milvus.proto.etcd.PartitionState
	3,  // 11: milvus.proto.etcd.AliasInfo.state:type_name -> milvus.proto.etcd.AliasState
	0,  // 12: milvus.proto.etcd.DatabaseInfo.state:type_name -> milvus.proto.etcd.DatabaseState
	16, // 13: milvus.proto.etcd.DatabaseInfo.properties:type_name -> milvus.proto.common.KeyValuePair
	17, // 14: milvus.proto.etcd.CollectionMeta.schema:type_name -> milvus.proto.schema.CollectionSchema
