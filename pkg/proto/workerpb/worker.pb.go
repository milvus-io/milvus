...
type CreateStatsRequest struct {
	...
	// Reserved for a post-upgrade cutover to V3 task-attempt subdirectories.
	// Current DataCoords leave it false; older DataCoords also omit it and older
	// DataNodes ignore the unknown field, so rolling upgrades keep the legacy path.
