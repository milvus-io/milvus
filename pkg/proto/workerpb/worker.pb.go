...
type CreateStatsRequest struct {
	...
	// Write StorageV3 stats under a task-ID subdirectory. The coordinator checks
	// the writer capability and reader compatibility before requesting this layout.
	// False preserves the legacy layout for requests from older coordinators.
	UseV3StatsAttemptPath bool `protobuf:"varint,34,opt,name=use_v3_stats_attempt_path,json=useV3StatsAttemptPath,proto3" json:"use_v3_stats_attempt_path,omitempty"`
}
...
func (x *CreateStatsRequest) GetUseV3StatsAttemptPath() bool {
	if x != nil {
		return x.UseV3StatsAttemptPath
	}
	return false
}
...
var file_worker_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xab, 0x0d, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61,
	...
	0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x44, 0x65, 0x6c, 0x74, 0x61, 0x12, 0x38, 0x0a, 0x19, 0x75,
	0x73, 0x65, 0x5f, 0x76, 0x33, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x5f, 0x61, 0x74, 0x74, 0x65,
	0x6d, 0x70, 0x74, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x22, 0x20, 0x01, 0x28, 0x08, 0x52, 0x15,
	0x75, 0x73, 0x65, 0x56, 0x33, 0x53, 0x74, 0x61, 0x74, 0x73, 0x41, 0x74, 0x74, 0x65, 0x6d, 0x70,
	0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0xf8, 0x02, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
