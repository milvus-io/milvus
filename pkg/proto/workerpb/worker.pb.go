...
var file_worker_proto_depIdxs = []int32{
	...
	29, // 12: milvus.proto.index.QueryJobsResponse.status:type_name -> milvus.proto.common.Status
	14, // 13: milvus.proto.index.QueryJobsResponse.index_infos:type_name -> milvus.proto.index.IndexTaskInfo
	29, // 14: milvus.proto.index.GetJobStatsResponse.status:type_name -> milvus.proto.common.Status
	36, // 15: milvus.proto.index.GetJobStatsResponse.job_infos:type_name -> milvus.proto.index.JobInfo
	32, // 16: milvus.proto.index.AnalyzeRequest.field_type:type_name -> milvus.proto.schema.DataType
	26, // 17: milvus.proto.index.AnalyzeRequest.segment_stats:type_name -> milvus.proto.index.AnalyzeRequest.SegmentStatsEntry
	30, // 18: milvus.proto.index.AnalyzeRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	34, // 19: milvus.proto.index.AnalyzeRequest.field:type_name -> milvus.proto.schema.FieldSchema
	35, // 20: milvus.proto.index.CreateStatsRequest.insert_logs:type_name -> milvus.proto.data.FieldBinlog
	35, // 21: milvus.proto.index.CreateStatsRequest.delta_logs:type_name -> milvus.proto.data.FieldBinlog
	30, // 22: milvus.proto.index.CreateStatsRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	37, // 23: milvus.proto.index.CreateStatsRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	38, // 24: milvus.proto.index.CreateStatsRequest.subJobType:type_name -> milvus.proto.index.StatsSubJob
	39, // 25: milvus.proto.index.CreateJobV2Request.job_type:type_name -> milvus.proto.index.JobType
	...
	39, // 29: milvus.proto.index.QueryJobsV2Request.job_type:type_name -> milvus.proto.index.JobType
	40, // 30: milvus.proto.index.IndexTaskInfo.state:type_name -> milvus.proto.common.IndexState
	14, // 31: milvus.proto.index.IndexJobResults.results:type_name -> milvus.proto.index.IndexTaskInfo
	41, // 32: milvus.proto.index.AnalyzeResult.state:type_name -> milvus.proto.index.JobState
	16, // 33: milvus.proto.index.AnalyzeResults.results:type_name -> milvus.proto.index.AnalyzeResult
	41, // 34: milvus.proto.index.StatsResult.state:type_name -> milvus.proto.index.JobState
	35, // 35: milvus.proto.index.StatsResult.insert_logs:type_name -> milvus.proto.data.FieldBinlog
	35, // 36: milvus.proto.index.StatsResult.stats_logs:type_name -> milvus.proto.data.FieldBinlog
	27, // 37: milvus.proto.index.StatsResult.text_stats_logs:type_name -> milvus.proto.index.StatsResult.TextStatsLogsEntry
	35, // 38: milvus.proto.index.StatsResult.bm25_logs:type_name -> milvus.proto.data.FieldBinlog
	28, // 39: milvus.proto.index.StatsResult.json_key_stats_logs:type_name -> milvus.proto.index.StatsResult.JsonKeyStatsLogsEntry
	18, // 40: milvus.proto.index.StatsResults.results:type_name -> milvus.proto.index.StatsResult
	29, // 41: milvus.proto.index.QueryJobsV2Response.status:type_name -> milvus.proto.common.Status
	15, // 42: milvus.proto.index.QueryJobsV2Response.index_job_results:type_name -> milvus.proto.index.IndexJobResults
	17, // 43: milvus.proto.index.QueryJobsV2Response.analyze_job_results:type_name -> milvus.proto.index.AnalyzeResults
	19, // 44: milvus.proto.index.QueryJobsV2Response.stats_job_results:type_name -> milvus.proto.index.StatsResults
	39, // 45: milvus.proto.index.DropJobsV2Request.job_type:type_name -> milvus.proto.index.JobType
	42, // 46: milvus.proto.index.AnalyzeRequest.SegmentStatsEntry.value:type_name -> milvus.proto.index.SegmentStats
	43, // 47: milvus.proto.index.StatsResult.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	44, // 48: milvus.proto.index.StatsResult.JsonKeyStatsLogsEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	4,  // 49: milvus.proto.index.IndexNode.CreateJob:input_type -> milvus.proto.index.CreateJobRequest
	5,  // 50: milvus.proto.index.IndexNode.QueryJobs:input_type -> milvus.proto.index.QueryJobsRequest
	7,  // 51: milvus.proto.index.IndexNode.DropJobs:input_type -> milvus.proto.index.DropJobsRequest
	8,  // 52: milvus.proto.index.IndexNode.GetJobStats:input_type -> milvus.proto.index.GetJobStatsRequest
	12, // 53: milvus.proto.index.IndexNode.CreateJobV2:input_type -> milvus.proto.index.CreateJobV2Request
	13, // 54: milvus.proto.index.IndexNode.QueryJobsV2:input_type -> milvus.proto.index.QueryJobsV2Request
	21, // 55: milvus.proto.index.IndexNode.DropJobsV2:input_type -> milvus.proto.index.DropJobsV2Request
	0,  // 56: milvus.proto.index.IndexNode.CreateTask:input_type -> milvus.proto.index.CreateTaskRequest
	1,  // 57: milvus.proto.index.IndexNode.QueryTask:input_type -> milvus.proto.index.QueryTaskRequest
	3,  // 58: milvus.proto.index.IndexNode.DropTask:input_type -> milvus.proto.index.DropTaskRequest
	29, // 59: milvus.proto.index.IndexNode.CreateJob:output_type -> milvus.proto.common.Status
	6,  // 60: milvus.proto.index.IndexNode.QueryJobs:output_type -> milvus.proto.index.QueryJobsResponse
	29, // 61: milvus.proto.index.IndexNode.DropJobs:output_type -> milvus.proto.common.Status
	9,  // 62: milvus.proto.index.IndexNode.GetJobStats:output_type -> milvus.proto.index.GetJobStatsResponse
	29, // 63: milvus.proto.index.IndexNode.CreateJobV2:output_type -> milvus.proto.common.Status
	20, // 64: milvus.proto.index.IndexNode.QueryJobsV2:output_type -> milvus.proto.index.QueryJobsV2Response
	29, // 65: milvus.proto.index.IndexNode.DropJobsV2:output_type -> milvus.proto.common.Status
	29, // 66: milvus.proto.index.IndexNode.CreateTask:output_type -> milvus.proto.common.Status
	2,  // 67: milvus.proto.index.IndexNode.QueryTask:output_type -> milvus.proto.index.QueryTaskResponse
	29, // 68: milvus.proto.index.IndexNode.DropTask:output_type -> milvus.proto.common.Status
