...
type CopySegmentRequest struct {
	...
	// Dispatch epoch. DataCoord bumps it before every CreateCopySegment RPC and
	// DataNode binds the accepted task to it, so a drop issued for an earlier
	// dispatch can be recognized as stale. Zero means the coordinator predates
	// the epoch fence (rolling upgrade).
...
func (x *CopySegmentRequest) GetTaskVersion() int64 {
	if x != nil {
...
type DropCopySegmentRequest struct {
	...
	// Dispatch epoch this drop was issued for. DataNode ignores the request when
	// it no longer matches the tracked task, so a stale abort cannot delete the
	// output of a later dispatch. Zero means unversioned (rolling upgrade).
...
func (x *DropCopySegmentRequest) GetTaskVersion() int64 {
	if x != nil {
		return x.TaskVersion
	}
	return 0
...
var file_data_coord_proto_rawDesc = []byte{
	...
	0x22, 0x8f, 0x03, 0x0a, 0x12, 0x43, 0x6f, 0x70, 0x79, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x74, 0x61, 0x73, 0x6b, 0x56, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x22, 0x65, 0x0a, 0x17, 0x51, 0x75, 0x65, 0x72, 0x79, 0x43, 0x6f, 0x70, 0x79, 0x53,
	...
	0x9d, 0x01, 0x0a, 0x16, 0x44, 0x72, 0x6f, 0x70, 0x43, 0x6f, 0x70, 0x79, 0x53, 0x65, 0x67, 0x6d,
	...
	0x74, 0x61, 0x73, 0x6b, 0x49, 0x44, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x12, 0x21, 0x0a, 0x0c,
	0x74, 0x61, 0x73, 0x6b, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0b, 0x74, 0x61, 0x73, 0x6b, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22,
	...
	0x2a, 0xba, 0x01, 0x0a, 0x13, 0x43, 0x6f, 0x70, 0x79, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x4a, 0x6f, 0x62, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x10, 0x04, 0x12,
	0x1c, 0x0a, 0x18, 0x43, 0x6f, 0x70, 0x79, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x4a, 0x6f,
	0x62, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x10, 0x05, 0x2a, 0xa3, 0x01,
