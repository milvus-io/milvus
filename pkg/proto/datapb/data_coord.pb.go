...
var file_data_coord_proto_depIdxs = []int32{
	...
	122, // 117: milvus.proto.data.CompactionSegment.text_stats_logs:type_name -> milvus.proto.data.CompactionSegment.TextStatsLogsEntry
	...
	127, // 121: milvus.proto.data.CompactionStateResponse.status:type_name -> milvus.proto.common.Status
	68,  // 122: milvus.proto.data.CompactionStateResponse.results:type_name -> milvus.proto.data.CompactionPlanResult
	133, // 123: milvus.proto.data.WatchChannelsRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	132, // 124: milvus.proto.data.WatchChannelsRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	131, // 125: milvus.proto.data.WatchChannelsRequest.db_properties:type_name -> milvus.proto.common.KeyValuePair
	127, // 126: milvus.proto.data.WatchChannelsResponse.status:type_name -> milvus.proto.common.Status
	126, // 127: milvus.proto.data.SetSegmentStateRequest.base:type_name -> milvus.proto.common.MsgBase
	128, // 128: milvus.proto.data.SetSegmentStateRequest.new_state:type_name -> milvus.proto.common.SegmentState
	127, // 129: milvus.proto.data.SetSegmentStateResponse.status:type_name -> milvus.proto.common.Status
	126, // 130: milvus.proto.data.DropVirtualChannelRequest.base:type_name -> milvus.proto.common.MsgBase
	...
	129, // 135: milvus.proto.data.DropVirtualChannelSegment.startPosition:type_name -> milvus.proto.msg.MsgPosition
	129, // 136: milvus.proto.data.DropVirtualChannelSegment.checkPoint:type_name -> milvus.proto.msg.MsgPosition
	127, // 137: milvus.proto.data.DropVirtualChannelResponse.status:type_name -> milvus.proto.common.Status
	126, // 138: milvus.proto.data.UpdateSegmentStatisticsRequest.base:type_name -> milvus.proto.common.MsgBase
	134, // 139: milvus.proto.data.UpdateSegmentStatisticsRequest.stats:type_name -> milvus.proto.common.SegmentStats
	126, // 140: milvus.proto.data.UpdateChannelCheckpointRequest.base:type_name -> milvus.proto.common.MsgBase
	129, // 141: milvus.proto.data.UpdateChannelCheckpointRequest.position:type_name -> milvus.proto.msg.MsgPosition
	129, // 142: milvus.proto.data.UpdateChannelCheckpointRequest.channel_checkpoints:type_name -> milvus.proto.msg.MsgPosition
	126, // 143: milvus.proto.data.ResendSegmentStatsRequest.base:type_name -> milvus.proto.common.MsgBase
	127, // 144: milvus.proto.data.ResendSegmentStatsResponse.status:type_name -> milvus.proto.common.Status
	126, // 145: milvus.proto.data.MarkSegmentsDroppedRequest.base:type_name -> milvus.proto.common.MsgBase
	132, // 146: milvus.proto.data.AlterCollectionRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	133, // 147: milvus.proto.data.AlterCollectionRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	131, // 148: milvus.proto.data.AlterCollectionRequest.properties:type_name -> milvus.proto.common.KeyValuePair
	135, // 149: milvus.proto.data.AddCollectionFieldRequest.field_schema:type_name -> milvus.proto.schema.FieldSchema
	132, // 150: milvus.proto.data.AddCollectionFieldRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	133, // 151: milvus.proto.data.AddCollectionFieldRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	131, // 152: milvus.proto.data.AddCollectionFieldRequest.properties:type_name -> milvus.proto.common.KeyValuePair
	127, // 153: milvus.proto.data.GcConfirmResponse.status:type_name -> milvus.proto.common.Status
	126, // 154: milvus.proto.data.ReportDataNodeTtMsgsRequest.base:type_name -> milvus.proto.common.MsgBase
	136, // 155: milvus.proto.data.ReportDataNodeTtMsgsRequest.msgs:type_name -> milvus.proto.msg.DataNodeTtMsg
	61,  // 156: milvus.proto.data.ChannelOperationsRequest.infos:type_name -> milvus.proto.data.ChannelWatchInfo
	127, // 157: milvus.proto.data.ChannelOperationProgressResponse.status:type_name -> milvus.proto.common.Status
	2,   // 158: milvus.proto.data.ChannelOperationProgressResponse.state:type_name -> milvus.proto.data.ChannelWatchState
	132, // 159: milvus.proto.data.PreImportRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	137, // 160: milvus.proto.data.PreImportRequest.import_files:type_name -> milvus.proto.internal.ImportFile
	131, // 161: milvus.proto.data.PreImportRequest.options:type_name -> milvus.proto.common.KeyValuePair
	138, // 162: milvus.proto.data.PreImportRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	132, // 163: milvus.proto.data.ImportRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	137, // 164: milvus.proto.data.ImportRequest.files:type_name -> milvus.proto.internal.ImportFile
	131, // 165: milvus.proto.data.ImportRequest.options:type_name -> milvus.proto.common.KeyValuePair
	...
	138, // 168: milvus.proto.data.ImportRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	123, // 169: milvus.proto.data.PartitionImportStats.partition_rows:type_name -> milvus.proto.data.PartitionImportStats.PartitionRowsEntry
	124, // 170: milvus.proto.data.PartitionImportStats.partition_data_size:type_name -> milvus.proto.data.PartitionImportStats.PartitionDataSizeEntry
	137, // 171: milvus.proto.data.ImportFileStats.import_file:type_name -> milvus.proto.internal.ImportFile
	125, // 172: milvus.proto.data.ImportFileStats.hashed_stats:type_name -> milvus.proto.data.ImportFileStats.HashedStatsEntry
	127, // 173: milvus.proto.data.QueryPreImportResponse.status:type_name -> milvus.proto.common.Status
	...
	127, // 180: milvus.proto.data.QueryImportResponse.status:type_name -> milvus.proto.common.Status
	...
	132, // 183: milvus.proto.data.ImportJob.schema:type_name -> milvus.proto.schema.CollectionSchema
	139, // 184: milvus.proto.data.ImportJob.state:type_name -> milvus.proto.internal.ImportJobState
	137, // 185: milvus.proto.data.ImportJob.files:type_name -> milvus.proto.internal.ImportFile
	131, // 186: milvus.proto.data.ImportJob.options:type_name -> milvus.proto.common.KeyValuePair
	...
	126, // 192: milvus.proto.data.GcControlRequest.base:type_name -> milvus.proto.common.MsgBase
	6,   // 193: milvus.proto.data.GcControlRequest.command:type_name -> milvus.proto.data.GcCommand
	131, // 194: milvus.proto.data.GcControlRequest.params:type_name -> milvus.proto.common.KeyValuePair
	127, // 195: milvus.proto.data.QuerySlotResponse.status:type_name -> milvus.proto.common.Status
	...
	129, // 198: milvus.proto.data.CompactionTask.pos:type_name -> milvus.proto.msg.MsgPosition
	132, // 199: milvus.proto.data.CompactionTask.schema:type_name -> milvus.proto.schema.CollectionSchema
	135, // 200: milvus.proto.data.CompactionTask.clustering_key_field:type_name -> milvus.proto.schema.FieldSchema
	93,  // 201: milvus.proto.data.CompactionTask.pre_allocated_segmentIDs:type_name -> milvus.proto.data.IDRange
	140, // 202: milvus.proto.data.FileResourceInfo.type:type_name -> milvus.proto.common.FileResourceType
	129, // 203: milvus.proto.data.FlushResponse.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	129, // 204: milvus.proto.data.FlushResult.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	129, // 205: milvus.proto.data.GetSegmentInfoResponse.ChannelCheckpointEntry.value:type_name -> milvus.proto.msg.MsgPosition
	...
	141, // 228: milvus.proto.data.DataCoord.GetFlushAllState:input_type -> milvus.proto.milvus.GetFlushAllStateRequest
	142, // 229: milvus.proto.data.DataCoord.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	143, // 230: milvus.proto.data.DataCoord.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	144, // 231: milvus.proto.data.DataCoord.ManualCompaction:input_type -> milvus.proto.milvus.ManualCompactionRequest
	145, // 232: milvus.proto.data.DataCoord.GetCompactionState:input_type -> milvus.proto.milvus.GetCompactionStateRequest
	146, // 233: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:input_type -> milvus.proto.milvus.GetCompactionPlansRequest
	...
	147, // 242: milvus.proto.data.DataCoord.CheckHealth:input_type -> milvus.proto.milvus.CheckHealthRequest
	148, // 243: milvus.proto.data.DataCoord.CreateIndex:input_type -> milvus.proto.index.CreateIndexRequest
	149, // 244: milvus.proto.data.DataCoord.AlterIndex:input_type -> milvus.proto.index.AlterIndexRequest
	150, // 245: milvus.proto.data.DataCoord.GetIndexState:input_type -> milvus.proto.index.GetIndexStateRequest
	151, // 246: milvus.proto.data.DataCoord.GetSegmentIndexState:input_type -> milvus.proto.index.GetSegmentIndexStateRequest
	152, // 247: milvus.proto.data.DataCoord.GetIndexInfos:input_type -> milvus.proto.index.GetIndexInfoRequest
	153, // 248: milvus.proto.data.DataCoord.DropIndex:input_type -> milvus.proto.index.DropIndexRequest
	154, // 249: milvus.proto.data.DataCoord.DescribeIndex:input_type -> milvus.proto.index.DescribeIndexRequest
	155, // 250: milvus.proto.data.DataCoord.GetIndexStatistics:input_type -> milvus.proto.index.GetIndexStatisticsRequest
	156, // 251: milvus.proto.data.DataCoord.GetIndexBuildProgress:input_type -> milvus.proto.index.GetIndexBuildProgressRequest
	157, // 252: milvus.proto.data.DataCoord.ListIndexes:input_type -> milvus.proto.index.ListIndexesRequest
	...
	158, // 256: milvus.proto.data.DataCoord.ImportV2:input_type -> milvus.proto.internal.ImportRequestInternal
	159, // 257: milvus.proto.data.DataCoord.GetImportProgress:input_type -> milvus.proto.internal.GetImportProgressRequest
	160, // 258: milvus.proto.data.DataCoord.ListImports:input_type -> milvus.proto.internal.ListImportsRequestInternal
	161, // 259: milvus.proto.data.DataCoord.AddFileResource:input_type -> milvus.proto.milvus.AddFileResourceRequest
	162, // 260: milvus.proto.data.DataCoord.RemoveFileResource:input_type -> milvus.proto.milvus.RemoveFileResourceRequest
	163, // 261: milvus.proto.data.DataCoord.ListFileResources:input_type -> milvus.proto.milvus.ListFileResourcesRequest
	164, // 262: milvus.proto.data.DataNode.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	165, // 263: milvus.proto.data.DataNode.GetStatisticsChannel:input_type -> milvus.proto.internal.GetStatisticsChannelRequest
	34,  // 264: milvus.proto.data.DataNode.WatchDmChannels:input_type -> milvus.proto.data.WatchDmChannelsRequest
	35,  // 265: milvus.proto.data.DataNode.FlushSegments:input_type -> milvus.proto.data.FlushSegmentsRequest
	142, // 266: milvus.proto.data.DataNode.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	143, // 267: milvus.proto.data.DataNode.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	66,  // 268: milvus.proto.data.DataNode.CompactionV2:input_type -> milvus.proto.data.CompactionPlan
	62,  // 269: milvus.proto.data.DataNode.GetCompactionState:input_type -> milvus.proto.data.CompactionStateRequest
	64,  // 270: milvus.proto.data.DataNode.SyncSegments:input_type -> milvus.proto.data.SyncSegmentsRequest
	80,  // 271: milvus.proto.data.DataNode.ResendSegmentStats:input_type -> milvus.proto.data.ResendSegmentStatsRequest
	14,  // 272: milvus.proto.data.DataNode.FlushChannels:input_type -> milvus.proto.data.FlushChannelsRequest
	90,  // 273: milvus.proto.data.DataNode.NotifyChannelOperation:input_type -> milvus.proto.data.ChannelOperationsRequest
	61,  // 274: milvus.proto.data.DataNode.CheckChannelOperationProgress:input_type -> milvus.proto.data.ChannelWatchInfo
	92,  // 275: milvus.proto.data.DataNode.PreImport:input_type -> milvus.proto.data.PreImportRequest
	95,  // 276: milvus.proto.data.DataNode.ImportV2:input_type -> milvus.proto.data.ImportRequest
	96,  // 277: milvus.proto.data.DataNode.QueryPreImport:input_type -> milvus.proto.data.QueryPreImportRequest
	100, // 278: milvus.proto.data.DataNode.QueryImport:input_type -> milvus.proto.data.QueryImportRequest
	103, // 279: milvus.proto.data.DataNode.DropImport:input_type -> milvus.proto.data.DropImportRequest
	108, // 280: milvus.proto.data.DataNode.QuerySlot:input_type -> milvus.proto.data.QuerySlotRequest
	112, // 281: milvus.proto.data.DataNode.DropCompactionPlan:input_type -> milvus.proto.data.DropCompactionPlanRequest
	10,  // 282: milvus.proto.data.DataCoord.Flush:output_type -> milvus.proto.data.FlushResponse
	13,  // 283: milvus.proto.data.DataCoord.FlushAll:output_type -> milvus.proto.data.FlushAllResponse
	17,  // 284: milvus.proto.data.DataCoord.AllocSegment:output_type -> milvus.proto.data.AllocSegmentResponse
	20,  // 285: milvus.proto.data.DataCoord.AssignSegmentID:output_type -> milvus.proto.data.AssignSegmentIDResponse
	25,  // 286: milvus.proto.data.DataCoord.GetSegmentInfo:output_type -> milvus.proto.data.GetSegmentInfoResponse
	23,  // 287: milvus.proto.data.DataCoord.GetSegmentStates:output_type -> milvus.proto.data.GetSegmentStatesResponse
	27,  // 288: milvus.proto.data.DataCoord.GetInsertBinlogPaths:output_type -> milvus.proto.data.GetInsertBinlogPathsResponse
	29,  // 289: milvus.proto.data.DataCoord.GetCollectionStatistics:output_type -> milvus.proto.data.GetCollectionStatisticsResponse
	31,  // 290: milvus.proto.data.DataCoord.GetPartitionStatistics:output_type -> milvus.proto.data.GetPartitionStatisticsResponse
	166, // 291: milvus.proto.data.DataCoord.GetSegmentInfoChannel:output_type -> milvus.proto.milvus.StringResponse
	127, // 292: milvus.proto.data.DataCoord.SaveBinlogPaths:output_type -> milvus.proto.common.Status
	49,  // 293: milvus.proto.data.DataCoord.GetRecoveryInfo:output_type -> milvus.proto.data.GetRecoveryInfoResponse
	51,  // 294: milvus.proto.data.DataCoord.GetRecoveryInfoV2:output_type -> milvus.proto.data.GetRecoveryInfoResponseV2
	54,  // 295: milvus.proto.data.DataCoord.GetChannelRecoveryInfo:output_type -> milvus.proto.data.GetChannelRecoveryInfoResponse
	59,  // 296: milvus.proto.data.DataCoord.GetFlushedSegments:output_type -> milvus.proto.data.GetFlushedSegmentsResponse
	57,  // 297: milvus.proto.data.DataCoord.GetSegmentsByStates:output_type -> milvus.proto.data.GetSegmentsByStatesResponse
	167, // 298: milvus.proto.data.DataCoord.GetFlushAllState:output_type -> milvus.proto.milvus.GetFlushAllStateResponse
	168, // 299: milvus.proto.data.DataCoord.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	169, // 300: milvus.proto.data.DataCoord.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	170, // 301: milvus.proto.data.DataCoord.ManualCompaction:output_type -> milvus.proto.milvus.ManualCompactionResponse
	171, // 302: milvus.proto.data.DataCoord.GetCompactionState:output_type -> milvus.proto.milvus.GetCompactionStateResponse
	172, // 303: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:output_type -> milvus.proto.milvus.GetCompactionPlansResponse
	72,  // 304: milvus.proto.data.DataCoord.WatchChannels:output_type -> milvus.proto.data.WatchChannelsResponse
	173, // 305: milvus.proto.data.DataCoord.GetFlushState:output_type -> milvus.proto.milvus.GetFlushStateResponse
	77,  // 306: milvus.proto.data.DataCoord.DropVirtualChannel:output_type -> milvus.proto.data.DropVirtualChannelResponse
	74,  // 307: milvus.proto.data.DataCoord.SetSegmentState:output_type -> milvus.proto.data.SetSegmentStateResponse
	127, // 308: milvus.proto.data.DataCoord.UpdateSegmentStatistics:output_type -> milvus.proto.common.Status
	127, // 309: milvus.proto.data.DataCoord.UpdateChannelCheckpoint:output_type -> milvus.proto.common.Status
	127, // 310: milvus.proto.data.DataCoord.MarkSegmentsDropped:output_type -> milvus.proto.common.Status
	127, // 311: milvus.proto.data.DataCoord.BroadcastAlteredCollection:output_type -> milvus.proto.common.Status
	174, // 312: milvus.proto.data.DataCoord.CheckHealth:output_type -> milvus.proto.milvus.CheckHealthResponse
	127, // 313: milvus.proto.data.DataCoord.CreateIndex:output_type -> milvus.proto.common.Status
	127, // 314: milvus.proto.data.DataCoord.AlterIndex:output_type -> milvus.proto.common.Status
	175, // 315: milvus.proto.data.DataCoord.GetIndexState:output_type -> milvus.proto.index.GetIndexStateResponse
	176, // 316: milvus.proto.data.DataCoord.GetSegmentIndexState:output_type -> milvus.proto.index.GetSegmentIndexStateResponse
	177, // 317: milvus.proto.data.DataCoord.GetIndexInfos:output_type -> milvus.proto.index.GetIndexInfoResponse
	127, // 318: milvus.proto.data.DataCoord.DropIndex:output_type -> milvus.proto.common.Status
	178, // 319: milvus.proto.data.DataCoord.DescribeIndex:output_type -> milvus.proto.index.DescribeIndexResponse
	179, // 320: milvus.proto.data.DataCoord.GetIndexStatistics:output_type -> milvus.proto.index.GetIndexStatisticsResponse
	180, // 321: milvus.proto.data.DataCoord.GetIndexBuildProgress:output_type -> milvus.proto.index.GetIndexBuildProgressResponse
	181, // 322: milvus.proto.data.DataCoord.ListIndexes:output_type -> milvus.proto.index.ListIndexesResponse
	87,  // 323: milvus.proto.data.DataCoord.GcConfirm:output_type -> milvus.proto.data.GcConfirmResponse
	127, // 324: milvus.proto.data.DataCoord.ReportDataNodeTtMsgs:output_type -> milvus.proto.common.Status
	127, // 325: milvus.proto.data.DataCoord.GcControl:output_type -> milvus.proto.common.Status
	182, // 326: milvus.proto.data.DataCoord.ImportV2:output_type -> milvus.proto.internal.ImportResponse
	183, // 327: milvus.proto.data.DataCoord.GetImportProgress:output_type -> milvus.proto.internal.GetImportProgressResponse
	184, // 328: milvus.proto.data.DataCoord.ListImports:output_type -> milvus.proto.internal.ListImportsResponse
	127, // 329: milvus.proto.data.DataCoord.AddFileResource:output_type -> milvus.proto.common.Status
	127, // 330: milvus.proto.data.DataCoord.RemoveFileResource:output_type -> milvus.proto.common.Status
	185, // 331: milvus.proto.data.DataCoord.ListFileResources:output_type -> milvus.proto.milvus.ListFileResourcesResponse
	186, // 332: milvus.proto.data.DataNode.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	166, // 333: milvus.proto.data.DataNode.GetStatisticsChannel:output_type -> milvus.proto.milvus.StringResponse
	127, // 334: milvus.proto.data.DataNode.WatchDmChannels:output_type -> milvus.proto.common.Status
	127, // 335: milvus.proto.data.DataNode.FlushSegments:output_type -> milvus.proto.common.Status
	168, // 336: milvus.proto.data.DataNode.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	169, // 337: milvus.proto.data.DataNode.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	127, // 338: milvus.proto.data.DataNode.CompactionV2:output_type -> milvus.proto.common.Status
	69,  // 339: milvus.proto.data.DataNode.GetCompactionState:output_type -> milvus.proto.data.CompactionStateResponse
	127, // 340: milvus.proto.data.DataNode.SyncSegments:output_type -> milvus.proto.common.Status
	81,  // 341: milvus.proto.data.DataNode.ResendSegmentStats:output_type -> milvus.proto.data.ResendSegmentStatsResponse
	127, // 342: milvus.proto.data.DataNode.FlushChannels:output_type -> milvus.proto.common.Status
	127, // 343: milvus.proto.data.DataNode.NotifyChannelOperation:output_type -> milvus.proto.common.Status
	91,  // 344: milvus.proto.data.DataNode.CheckChannelOperationProgress:output_type -> milvus.proto.data.ChannelOperationProgressResponse
	127, // 345: milvus.proto.data.DataNode.PreImport:output_type -> milvus.proto.common.Status
	127, // 346: milvus.proto.data.DataNode.ImportV2:output_type -> milvus.proto.common.Status
	99,  // 347: milvus.proto.data.DataNode.QueryPreImport:output_type -> milvus.proto.data.QueryPreImportResponse
	102, // 348: milvus.proto.data.DataNode.QueryImport:output_type -> milvus.proto.data.QueryImportResponse
	127, // 349: milvus.proto.data.DataNode.DropImport:output_type -> milvus.proto.common.Status
	109, // 350: milvus.proto.data.DataNode.QuerySlot:output_type -> milvus.proto.data.QuerySlotResponse
	127, // 351: milvus.proto.data.DataNode.DropCompactionPlan:output_type -> milvus.proto.common.Status
	282, // [282:352] is the sub-list for method output_type
	212, // [212:282] is the sub-list for method input_type
