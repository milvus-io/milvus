...
type CopySegmentSource struct {
	...
	// Snapshot create timestamp used as restore cutoff. When set,
	// StorageV2/StorageV3 restore only carries data whose timestamp is no
	// greater than this value.
	CutoffTs uint64 `protobuf:"varint,14,opt,name=cutoff_ts,json=cutoffTs,proto3" json:"cutoff_ts,omitempty"`
}
...
func (x *CopySegmentSource) GetCutoffTs() uint64 {
	if x != nil {
		return x.CutoffTs
	}
	return 0
...
func (x *CopySegmentRequest) GetSchema() *schemapb.CollectionSchema {
	if x != nil {
		return x.Schema
	}
	return nil
...
type CopySegmentJob struct {
	...
	// Snapshot create timestamp used as restore cutoff.
	CutoffTs uint64 `protobuf:"varint,19,opt,name=cutoff_ts,json=cutoffTs,proto3" json:"cutoff_ts,omitempty"`
}
...
func (x *CopySegmentJob) GetCutoffTs() uint64 {
	if x != nil {
		return x.CutoffTs
	}
	return 0
...
var file_data_coord_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x44, 0x22, 0x96, 0x08, 0x0a, 0x11,
	...
	0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x75,
	0x74, 0x6f, 0x66, 0x66, 0x5f, 0x74, 0x73, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x63,
	0x75, 0x74, 0x6f, 0x66, 0x66, 0x54, 0x73, 0x1a, 0x64, 0x0a, 0x13, 0x54, 0x65, 0x78, 0x74, 0x49,
	...
	0x03, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x86, 0x03, 0x0a,
	...
	0x73, 0x6b, 0x53, 0x6c, 0x6f, 0x74, 0x12, 0x3d, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x43, 0x6f, 0x6c,
	0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x06, 0x73,
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x65, 0x0a, 0x17, 0x51, 0x75, 0x65, 0x72, 0x79, 0x43, 0x6f,
	...
	0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0xdb, 0x05, 0x0a, 0x0e, 0x43, 0x6f, 0x70, 0x79, 0x53, 0x65,
	...
	0x05, 0x70, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x75, 0x74, 0x6f, 0x66, 0x66,
	0x5f, 0x74, 0x73, 0x18, 0x13, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x63, 0x75, 0x74, 0x6f, 0x66,
	0x66, 0x54, 0x73, 0x22, 0x94, 0x06, 0x0a, 0x09, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x4a, 0x6f,
	...
	0x0d, 0x0a, 0x09, 0x73, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x10, 0x0a, 0x32, 0xf0,
...
var file_data_coord_proto_depIdxs = []int32{
	...
	202, // 205: milvus.proto.data.CopySegmentRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	196, // 206: milvus.proto.data.QueryCopySegmentResponse.status:type_name -> milvus.proto.common.Status
	5,   // 207: milvus.proto.data.QueryCopySegmentResponse.state:type_name -> milvus.proto.data.CopySegmentTaskState
	116, // 208: milvus.proto.data.QueryCopySegmentResponse.segment_results:type_name -> milvus.proto.data.CopySegmentResult
	212, // 209: milvus.proto.data.VectorScalarIndexInfo.index_store_path_version:type_name -> milvus.proto.index.IndexStorePathVersion
	50,  // 210: milvus.proto.data.CopySegmentResult.binlogs:type_name -> milvus.proto.data.FieldBinlog
	50,  // 211: milvus.proto.data.CopySegmentResult.statslogs:type_name -> milvus.proto.data.FieldBinlog
	50,  // 212: milvus.proto.data.CopySegmentResult.deltalogs:type_name -> milvus.proto.data.FieldBinlog
	50,  // 213: milvus.proto.data.CopySegmentResult.bm25logs:type_name -> milvus.proto.data.FieldBinlog
	188, // 214: milvus.proto.data.CopySegmentResult.index_infos:type_name -> milvus.proto.data.CopySegmentResult.IndexInfosEntry
	189, // 215: milvus.proto.data.CopySegmentResult.text_index_infos:type_name -> milvus.proto.data.CopySegmentResult.TextIndexInfosEntry
	190, // 216: milvus.proto.data.CopySegmentResult.json_key_index_infos:type_name -> milvus.proto.data.CopySegmentResult.JsonKeyIndexInfosEntry
	5,   // 217: milvus.proto.data.CopySegmentTask.state:type_name -> milvus.proto.data.CopySegmentTaskState
	118, // 218: milvus.proto.data.CopySegmentTask.id_mappings:type_name -> milvus.proto.data.CopySegmentIDMapping
	4,   // 219: milvus.proto.data.CopySegmentJob.state:type_name -> milvus.proto.data.CopySegmentJobState
	118, // 220: milvus.proto.data.CopySegmentJob.id_mappings:type_name -> milvus.proto.data.CopySegmentIDMapping
	201, // 221: milvus.proto.data.CopySegmentJob.options:type_name -> milvus.proto.common.KeyValuePair
	202, // 222: milvus.proto.data.ImportJob.schema:type_name -> milvus.proto.schema.CollectionSchema
	213, // 223: milvus.proto.data.ImportJob.state:type_name -> milvus.proto.internal.ImportJobState
	209, // 224: milvus.proto.data.ImportJob.files:type_name -> milvus.proto.internal.ImportFile
	201, // 225: milvus.proto.data.ImportJob.options:type_name -> milvus.proto.common.KeyValuePair
	8,   // 226: milvus.proto.data.PreImportTask.state:type_name -> milvus.proto.data.ImportTaskStateV2
	103, // 227: milvus.proto.data.PreImportTask.file_stats:type_name -> milvus.proto.data.ImportFileStats
	8,   // 228: milvus.proto.data.ImportTaskV2.state:type_name -> milvus.proto.data.ImportTaskStateV2
	103, // 229: milvus.proto.data.ImportTaskV2.file_stats:type_name -> milvus.proto.data.ImportFileStats
	9,   // 230: milvus.proto.data.ImportTaskV2.source:type_name -> milvus.proto.data.ImportTaskSourceV2
	195, // 231: milvus.proto.data.GcControlRequest.base:type_name -> milvus.proto.common.MsgBase
	10,  // 232: milvus.proto.data.GcControlRequest.command:type_name -> milvus.proto.data.GcCommand
	201, // 233: milvus.proto.data.GcControlRequest.params:type_name -> milvus.proto.common.KeyValuePair
	196, // 234: milvus.proto.data.QuerySlotResponse.status:type_name -> milvus.proto.common.Status
	3,   // 235: milvus.proto.data.CompactionTask.type:type_name -> milvus.proto.data.CompactionType
	11,  // 236: milvus.proto.data.CompactionTask.state:type_name -> milvus.proto.data.CompactionTaskState
	199, // 237: milvus.proto.data.CompactionTask.pos:type_name -> milvus.proto.msg.MsgPosition
	202, // 238: milvus.proto.data.CompactionTask.schema:type_name -> milvus.proto.schema.CollectionSchema
	207, // 239: milvus.proto.data.CompactionTask.clustering_key_field:type_name -> milvus.proto.schema.FieldSchema
	98,  // 240: milvus.proto.data.CompactionTask.pre_allocated_segmentIDs:type_name -> milvus.proto.data.IDRange
	204, // 241: milvus.proto.data.CompactionTask.diff_functions:type_name -> milvus.proto.schema.FunctionSchema
	195, // 242: milvus.proto.data.RefreshExternalCollectionTaskRequest.base:type_name -> milvus.proto.common.MsgBase
	42,  // 243: milvus.proto.data.RefreshExternalCollectionTaskRequest.currentSegments:type_name -> milvus.proto.data.SegmentInfo
	210, // 244: milvus.proto.data.RefreshExternalCollectionTaskRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	202, // 245: milvus.proto.data.RefreshExternalCollectionTaskRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	98,  // 246: milvus.proto.data.RefreshExternalCollectionTaskRequest.pre_allocated_segment_ids:type_name -> milvus.proto.data.IDRange
	196, // 247: milvus.proto.data.RefreshExternalCollectionTaskResponse.status:type_name -> milvus.proto.common.Status
	42,  // 248: milvus.proto.data.RefreshExternalCollectionTaskResponse.updatedSegments:type_name -> milvus.proto.data.SegmentInfo
	214, // 249: milvus.proto.data.RefreshExternalCollectionTaskResponse.state:type_name -> milvus.proto.index.JobState
	195, // 250: milvus.proto.data.RefreshExternalCollectionRequest.base:type_name -> milvus.proto.common.MsgBase
	196, // 251: milvus.proto.data.RefreshExternalCollectionResponse.status:type_name -> milvus.proto.common.Status
	195, // 252: milvus.proto.data.GetRefreshExternalCollectionProgressRequest.base:type_name -> milvus.proto.common.MsgBase
	214, // 253: milvus.proto.data.ExternalCollectionRefreshJob.state:type_name -> milvus.proto.index.JobState
	214, // 254: milvus.proto.data.ExternalCollectionRefreshTask.state:type_name -> milvus.proto.index.JobState
	42,  // 255: milvus.proto.data.ExternalCollectionRefreshTask.updated_segments:type_name -> milvus.proto.data.SegmentInfo
	196, // 256: milvus.proto.data.GetRefreshExternalCollectionProgressResponse.status:type_name -> milvus.proto.common.Status
	135, // 257: milvus.proto.data.GetRefreshExternalCollectionProgressResponse.job_info:type_name -> milvus.proto.data.ExternalCollectionRefreshJob
	195, // 258: milvus.proto.data.ListRefreshExternalCollectionJobsRequest.base:type_name -> milvus.proto.common.MsgBase
	196, // 259: milvus.proto.data.ListRefreshExternalCollectionJobsResponse.status:type_name -> milvus.proto.common.Status
	135, // 260: milvus.proto.data.ListRefreshExternalCollectionJobsResponse.jobs:type_name -> milvus.proto.data.ExternalCollectionRefreshJob
	195, // 261: milvus.proto.data.CreateSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	195, // 262: milvus.proto.data.DropSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	195, // 263: milvus.proto.data.ListSnapshotsRequest.base:type_name -> milvus.proto.common.MsgBase
	196, // 264: milvus.proto.data.ListSnapshotsResponse.status:type_name -> milvus.proto.common.Status
	1,   // 265: milvus.proto.data.SegmentDescription.segment_level:type_name -> milvus.proto.data.SegmentLevel
	50,  // 266: milvus.proto.data.SegmentDescription.binlogs:type_name -> milvus.proto.data.FieldBinlog
	50,  // 267: milvus.proto.data.SegmentDescription.deltalogs:type_name -> milvus.proto.data.FieldBinlog
	50,  // 268: milvus.proto.data.SegmentDescription.statslogs:type_name -> milvus.proto.data.FieldBinlog
	50,  // 269: milvus.proto.data.SegmentDescription.bm25_statslogs:type_name -> milvus.proto.data.FieldBinlog
	191, // 270: milvus.proto.data.SegmentDescription.text_index_files:type_name -> milvus.proto.data.SegmentDescription.TextIndexFilesEntry
	192, // 271: milvus.proto.data.SegmentDescription.json_key_index_files:type_name -> milvus.proto.data.SegmentDescription.JsonKeyIndexFilesEntry
	211, // 272: milvus.proto.data.SegmentDescription.index_files:type_name -> milvus.proto.index.IndexFilePathInfo
	199, // 273: milvus.proto.data.SegmentDescription.start_position:type_name -> milvus.proto.msg.MsgPosition
	199, // 274: milvus.proto.data.SegmentDescription.dml_position:type_name -> milvus.proto.msg.MsgPosition
	202, // 275: milvus.proto.data.CollectionDescription.schema:type_name -> milvus.proto.schema.CollectionSchema
	215, // 276: milvus.proto.data.CollectionDescription.consistency_level:type_name -> milvus.proto.common.ConsistencyLevel
	201, // 277: milvus.proto.data.CollectionDescription.properties:type_name -> milvus.proto.common.KeyValuePair
	193, // 278: milvus.proto.data.CollectionDescription.partitions:type_name -> milvus.proto.data.CollectionDescription.PartitionsEntry
	6,   // 279: milvus.proto.data.SnapshotInfo.state:type_name -> milvus.proto.data.SnapshotState
	194, // 280: milvus.proto.data.SnapshotInfo.pin_expire_at_ms:type_name -> milvus.proto.data.SnapshotInfo.PinExpireAtMsEntry
