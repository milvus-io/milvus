...
// SplitShardTaskState is the state of a shard split task.
// The task rolls forward only: before the fence (Preparing) it can be
// aborted, after the fence it can only advance.
type SplitShardTaskState int32
...
const (
	...
	SplitShardTaskState_SplitShardTaskRedistributing SplitShardTaskState = 3 // window: targets initialized, relabel rounds in progress.
	...
	SplitShardTaskState_SplitShardTaskAborted        SplitShardTaskState = 6
)

// Enum value maps for SplitShardTaskState.
var (
	SplitShardTaskState_name = map[int32]string{
		0: "SplitShardTaskUnknown",
		1: "SplitShardTaskPreparing",
		2: "SplitShardTaskFencing",
		3: "SplitShardTaskRedistributing",
		4: "SplitShardTaskAdopting",
		5: "SplitShardTaskDone",
		6: "SplitShardTaskAborted",
	}
	SplitShardTaskState_value = map[string]int32{
		"SplitShardTaskUnknown":        0,
		"SplitShardTaskPreparing":      1,
		"SplitShardTaskFencing":        2,
		"SplitShardTaskRedistributing": 3,
		"SplitShardTaskAdopting":       4,
		"SplitShardTaskDone":           5,
		"SplitShardTaskAborted":        6,
	}
)

func (x SplitShardTaskState) Enum() *SplitShardTaskState {
	p := new(SplitShardTaskState)
	*p = x
	return p
}

func (x SplitShardTaskState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SplitShardTaskState) Descriptor() protoreflect.EnumDescriptor {
	return file_data_coord_proto_enumTypes[12].Descriptor()
}

func (SplitShardTaskState) Type() protoreflect.EnumType {
	return &file_data_coord_proto_enumTypes[12]
}

func (x SplitShardTaskState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SplitShardTaskState.Descriptor instead.
func (SplitShardTaskState) EnumDescriptor() ([]byte, []int) {
...
// SplitShardTaskTarget is one target shard of a shard split task.
// The routing key range is byte-comparable, an empty bound means unbounded.
// (datapb cannot import messages.proto, so the range is flattened here.)
type SplitShardTaskTarget struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Vchannel        string `protobuf:"bytes,1,opt,name=vchannel,proto3" json:"vchannel,omitempty"`
	RoutingKeyLower []byte `protobuf:"bytes,2,opt,name=routing_key_lower,json=routingKeyLower,proto3" json:"routing_key_lower,omitempty"`
	RoutingKeyUpper []byte `protobuf:"bytes,3,opt,name=routing_key_upper,json=routingKeyUpper,proto3" json:"routing_key_upper,omitempty"`
	// start_position is the marshaled consume start position (the
	// LastConfirmedMessageID of the target's CreateVChannel append). The child
	// delegators consume the new WAL from here. Empty until the target is created.
	StartPosition string `protobuf:"bytes,4,opt,name=start_position,json=startPosition,proto3" json:"start_position,omitempty"`
}

func (x *SplitShardTaskTarget) Reset() {
	*x = SplitShardTaskTarget{}
	if protoimpl.UnsafeEnabled {
...
func (x *SplitShardTaskTarget) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SplitShardTaskTarget) ProtoMessage() {}

func (x *SplitShardTaskTarget) ProtoReflect() protoreflect.Message {
	mi := &file_data_coord_proto_msgTypes[158]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SplitShardTaskTarget.ProtoReflect.Descriptor instead.
func (*SplitShardTaskTarget) Descriptor() ([]byte, []int) {
	return file_data_coord_proto_rawDescGZIP(), []int{158}
}

func (x *SplitShardTaskTarget) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *SplitShardTaskTarget) GetRoutingKeyLower() []byte {
	if x != nil {
		return x.RoutingKeyLower
	}
	return nil
}

func (x *SplitShardTaskTarget) GetRoutingKeyUpper() []byte {
	if x != nil {
		return x.RoutingKeyUpper
	}
	return nil
}

func (x *SplitShardTaskTarget) GetStartPosition() string {
	if x != nil {
		return x.StartPosition
	}
	return ""
...
// SplitShardTask is the persisted state of a shard split task,
// driven by the datacoord shard split manager.
type SplitShardTask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	TaskId         int64                   `protobuf:"varint,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	CollectionId   int64                   `protobuf:"varint,2,opt,name=collection_id,json=collectionId,proto3" json:"collection_id,omitempty"`
	SourceVchannel string                  `protobuf:"bytes,3,opt,name=source_vchannel,json=sourceVchannel,proto3" json:"source_vchannel,omitempty"`
	Targets        []*SplitShardTaskTarget `protobuf:"bytes,4,rep,name=targets,proto3" json:"targets,omitempty"`
	State          SplitShardTaskState     `protobuf:"varint,5,opt,name=state,proto3,enum=milvus.proto.data.SplitShardTaskState" json:"state,omitempty"`
	// fenced is set once the SplitShard fence has been appended to the source
	// vchannel (the append succeeded or returned already-fenced). A fenced task
	// is forward-only and can no longer be aborted. DataCoord does not record
	// T_switch: the target vchannels are created with a freshly allocated
	// barrier (always greater than T_switch), and what is recorded is each
	// target's consume start position.
	Fenced     bool   `protobuf:"varint,6,opt,name=fenced,proto3" json:"fenced,omitempty"`
	StartTime  uint64 `protobuf:"varint,7,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"` // unix seconds.
	EndTime    uint64 `protobuf:"varint,8,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`       // unix seconds.
	FailReason string `protobuf:"bytes,9,opt,name=fail_reason,json=failReason,proto3" json:"fail_reason,omitempty"`
}

func (x *SplitShardTask) Reset() {
	*x = SplitShardTask{}
	if protoimpl.UnsafeEnabled {
...
func (x *SplitShardTask) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SplitShardTask) ProtoMessage() {}

func (x *SplitShardTask) ProtoReflect() protoreflect.Message {
	mi := &file_data_coord_proto_msgTypes[159]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SplitShardTask.ProtoReflect.Descriptor instead.
func (*SplitShardTask) Descriptor() ([]byte, []int) {
	return file_data_coord_proto_rawDescGZIP(), []int{159}
}

func (x *SplitShardTask) GetTaskId() int64 {
	if x != nil {
		return x.TaskId
	}
	return 0
...
func (x *SplitShardTask) GetCollectionId() int64 {
	if x != nil {
		return x.CollectionId
	}
	return 0
...
func (x *SplitShardTask) GetSourceVchannel() string {
	if x != nil {
		return x.SourceVchannel
	}
	return ""
}

func (x *SplitShardTask) GetTargets() []*SplitShardTaskTarget {
	if x != nil {
		return x.Targets
	}
	return nil
...
func (x *SplitShardTask) GetState() SplitShardTaskState {
	if x != nil {
		return x.State
	}
	return SplitShardTaskState_SplitShardTaskUnknown
}

func (x *SplitShardTask) GetFenced() bool {
	if x != nil {
		return x.Fenced
	}
	return false
...
func (x *SplitShardTask) GetStartTime() uint64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *SplitShardTask) GetEndTime() uint64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
func (x *SplitShardTask) GetFailReason() string {
	if x != nil {
		return x.FailReason
	}
	return ""
...
var file_data_coord_proto_rawDesc = []byte{
	...
	0x7f, 0x0a, 0x0b, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x42, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x12, 0x18,
	...
	0x6e, 0x6c, 0x6f, 0x67, 0x52, 0x07, 0x62, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x73, 0x12, 0x21, 0x0a,
	0x0c, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x03, 0x52, 0x0b, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73,
	0x22, 0xf1, 0x01, 0x0a, 0x0e, 0x54, 0x65, 0x78, 0x74, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x53, 0x74,
	...
	0x64, 0x49, 0x44, 0x12, 0x3f, 0x0a, 0x1c, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x73,
	0x63, 0x61, 0x6c, 0x61, 0x72, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x19, 0x63, 0x75, 0x72, 0x72, 0x65,
	0x6e, 0x74, 0x53, 0x63, 0x61, 0x6c, 0x61, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x56, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x22, 0xea, 0x01, 0x0a, 0x0c, 0x4a, 0x73, 0x6f, 0x6e, 0x4b, 0x65, 0x79,
	...
	0x74, 0x22, 0x80, 0x03, 0x0a, 0x06, 0x42, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x12, 0x1f, 0x0a, 0x0b,
	...
	0
 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x57, 0x61, 0x74,
	0x63, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x33, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e,
	...
	0x65, 0x73, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4f, 0x0a,
	0x09, 0x50, 0x72, 0x65, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x23, 0x2e, 0x6d, 0x69, 0x6c,
	...
	,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x5e, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x49, 0x6d, 0x70,
	...
	,
	...
	,
...
var file_data_coord_proto_goTypes = []interface{}{
	...
	(SplitShardTaskState)(0),                             // 12: milvus.proto.data.SplitShardTaskState
	...
	(*SegmentDescription)(nil),                           // 146: milvus.proto.data.SegmentDescription
	(*CollectionDescription)(nil),                        // 147: milvus.proto.data.CollectionDescription
	(*SnapshotInfo)(nil),                                 // 148: milvus.proto.data.SnapshotInfo
	(*StorageV2SegmentManifest)(nil),                     // 149: milvus.proto.data.StorageV2SegmentManifest
	(*SnapshotMetadata)(nil),                             // 150: milvus.proto.data.SnapshotMetadata
	(*RestoreSnapshotInfo)(nil),                          // 151: milvus.proto.data.RestoreSnapshotInfo
	(*DescribeSnapshotRequest)(nil),                      // 152: milvus.proto.data.DescribeSnapshotRequest
	(*DescribeSnapshotResponse)(nil),                     // 153: milvus.proto.data.DescribeSnapshotResponse
	(*RestoreSnapshotRequest)(nil),                       // 154: milvus.proto.data.RestoreSnapshotRequest
	(*RestoreSnapshotResponse)(nil),                      // 155: milvus.proto.data.RestoreSnapshotResponse
	(*GetRestoreSnapshotStateRequest)(nil),               // 156: milvus.proto.data.GetRestoreSnapshotStateRequest
	(*GetRestoreSnapshotStateResponse)(nil),              // 157: milvus.proto.data.GetRestoreSnapshotStateResponse
	(*ListRestoreSnapshotJobsRequest)(nil),               // 158: milvus.proto.data.ListRestoreSnapshotJobsRequest
	(*ListRestoreSnapshotJobsResponse)(nil),              // 159: milvus.proto.data.ListRestoreSnapshotJobsResponse
	(*BatchUpdateManifestRequest)(nil),                   // 160: milvus.proto.data.BatchUpdateManifestRequest
	(*BatchUpdateManifestItem)(nil),                      // 161: milvus.proto.data.BatchUpdateManifestItem
	(*CommitBackfillResultRequest)(nil),                  // 162: milvus.proto.data.CommitBackfillResultRequest
	(*CommitBackfillResultSegmentStatus)(nil),            // 163: milvus.proto.data.CommitBackfillResultSegmentStatus
	(*CommitBackfillResultResponse)(nil),                 // 164: milvus.proto.data.CommitBackfillResultResponse
	(*PinSnapshotDataRequest)(nil),                       // 165: milvus.proto.data.PinSnapshotDataRequest
	(*PinSnapshotDataResponse)(nil),                      // 166: milvus.proto.data.PinSnapshotDataResponse
	(*UnpinSnapshotDataRequest)(nil),                     // 167: milvus.proto.data.UnpinSnapshotDataRequest
	(*CommitImportRequest)(nil),                          // 168: milvus.proto.data.CommitImportRequest
	(*AbortImportRequest)(nil),                           // 169: milvus.proto.data.AbortImportRequest
	(*HandleCommitVchannelRequest)(nil),                  // 170: milvus.proto.data.HandleCommitVchannelRequest
	(*SplitShardTaskTarget)(nil),                         // 171: milvus.proto.data.SplitShardTaskTarget
	(*SplitShardTask)(nil),                               // 172: milvus.proto.data.SplitShardTask
...
var file_data_coord_proto_depIdxs = []int32{
	...
	51,  // 265: milvus.proto.data.SegmentDescription.binlogs:type_name -> milvus.proto.data.FieldBinlog
	51,  // 266: milvus.proto.data.SegmentDescription.deltalogs:type_name -> milvus.proto.data.FieldBinlog
	51,  // 267: milvus.proto.data.SegmentDescription.statslogs:type_name -> milvus.proto.data.FieldBinlog
	51,  // 268: milvus.proto.data.SegmentDescription.bm25_statslogs:type_name -> milvus.proto.data.FieldBinlog
	194, // 269: milvus.proto.data.SegmentDescription.text_index_files:type_name -> milvus.proto.data.SegmentDescription.TextIndexFilesEntry
	195, // 270: milvus.proto.data.SegmentDescription.json_key_index_files:type_name -> milvus.proto.data.SegmentDescription.JsonKeyIndexFilesEntry
	214, // 271: milvus.proto.data.SegmentDescription.index_files:type_name -> milvus.proto.index.IndexFilePathInfo
	202, // 272: milvus.proto.data.SegmentDescription.start_position:type_name -> milvus.proto.msg.MsgPosition
	202, // 273: milvus.proto.data.SegmentDescription.dml_position:type_name -> milvus.proto.msg.MsgPosition
	205, // 274: milvus.proto.data.CollectionDescription.schema:type_name -> milvus.proto.schema.CollectionSchema
	218, // 275: milvus.proto.data.CollectionDescription.consistency_level:type_name -> milvus.proto.common.ConsistencyLevel
	204, // 276: milvus.proto.data.CollectionDescription.properties:type_name -> milvus.proto.common.KeyValuePair
	196, // 277: milvus.proto.data.CollectionDescription.partitions:type_name -> milvus.proto.data.CollectionDescription.PartitionsEntry
	6,   // 278: milvus.proto.data.SnapshotInfo.state:type_name -> milvus.proto.data.SnapshotState
	197, // 279: milvus.proto.data.SnapshotInfo.pin_expire_at_ms:type_name -> milvus.proto.data.SnapshotInfo.PinExpireAtMsEntry
	148, // 280: milvus.proto.data.SnapshotMetadata.snapshot_info:type_name -> milvus.proto.data.SnapshotInfo
	147, // 281: milvus.proto.data.SnapshotMetadata.collection:type_name -> milvus.proto.data.CollectionDescription
	219, // 282: milvus.proto.data.SnapshotMetadata.indexes:type_name -> milvus.proto.index.IndexInfo
	149, // 283: milvus.proto.data.SnapshotMetadata.storagev2_manifest_list:type_name -> milvus.proto.data.StorageV2SegmentManifest
	7,   // 284: milvus.proto.data.RestoreSnapshotInfo.state:type_name -> milvus.proto.data.RestoreSnapshotState
	198, // 285: milvus.proto.data.DescribeSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	199, // 286: milvus.proto.data.DescribeSnapshotResponse.status:type_name -> milvus.proto.common.Status
	148, // 287: milvus.proto.data.DescribeSnapshotResponse.snapshot_info:type_name -> milvus.proto.data.SnapshotInfo
	147, // 288: milvus.proto.data.DescribeSnapshotResponse.collection_info:type_name -> milvus.proto.data.CollectionDescription
	219, // 289: milvus.proto.data.DescribeSnapshotResponse.index_infos:type_name -> milvus.proto.index.IndexInfo
	198, // 290: milvus.proto.data.RestoreSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	199, // 291: milvus.proto.data.RestoreSnapshotResponse.status:type_name -> milvus.proto.common.Status
	198, // 292: milvus.proto.data.GetRestoreSnapshotStateRequest.base:type_name -> milvus.proto.common.MsgBase
	199, // 293: milvus.proto.data.GetRestoreSnapshotStateResponse.status:type_name -> milvus.proto.common.Status
	151, // 294: milvus.proto.data.GetRestoreSnapshotStateResponse.info:type_name -> milvus.proto.data.RestoreSnapshotInfo
	198, // 295: milvus.proto.data.ListRestoreSnapshotJobsRequest.base:type_name -> milvus.proto.common.MsgBase
	199, // 296: milvus.proto.data.ListRestoreSnapshotJobsResponse.status:type_name -> milvus.proto.common.Status
	151, // 297: milvus.proto.data.ListRestoreSnapshotJobsResponse.jobs:type_name -> milvus.proto.data.RestoreSnapshotInfo
	198, // 298: milvus.proto.data.BatchUpdateManifestRequest.base:type_name -> milvus.proto.common.MsgBase
	161, // 299: milvus.proto.data.BatchUpdateManifestRequest.items:type_name -> milvus.proto.data.BatchUpdateManifestItem
	198, // 300: milvus.proto.data.CommitBackfillResultRequest.base:type_name -> milvus.proto.common.MsgBase
	199, // 301: milvus.proto.data.CommitBackfillResultResponse.status:type_name -> milvus.proto.common.Status
	163, // 302: milvus.proto.data.CommitBackfillResultResponse.segment_statuses:type_name -> milvus.proto.data.CommitBackfillResultSegmentStatus
	198, // 303: milvus.proto.data.PinSnapshotDataRequest.base:type_name -> milvus.proto.common.MsgBase
	199, // 304: milvus.proto.data.PinSnapshotDataResponse.status:type_name -> milvus.proto.common.Status
	198, // 305: milvus.proto.data.UnpinSnapshotDataRequest.base:type_name -> milvus.proto.common.MsgBase
	198, // 306: milvus.proto.data.CommitImportRequest.base:type_name -> milvus.proto.common.MsgBase
	198, // 307: milvus.proto.data.AbortImportRequest.base:type_name -> milvus.proto.common.MsgBase
	198, // 308: milvus.proto.data.HandleCommitVchannelRequest.base:type_name -> milvus.proto.common.MsgBase
	171, // 309: milvus.proto.data.SplitShardTask.targets:type_name -> milvus.proto.data.SplitShardTaskTarget
	12,  // 310: milvus.proto.data.SplitShardTask.state:type_name -> milvus.proto.data.SplitShardTaskState
	202, // 311: milvus.proto.data.FlushResponse.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	202, // 312: milvus.proto.data.FlushResult.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	220, // 313: milvus.proto.data.FlushAllResponse.FlushAllMsgsEntry.value:type_name -> milvus.proto.common.ImmutableMessage
	202, // 314: milvus.proto.data.GetSegmentInfoResponse.ChannelCheckpointEntry.value:type_name -> milvus.proto.msg.MsgPosition
	52,  // 315: milvus.proto.data.SegmentInfo.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	53,  // 316: milvus.proto.data.SegmentInfo.JsonKeyStatsEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	52,  // 317: milvus.proto.data.SegmentBinlogs.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	69,  // 318: milvus.proto.data.SyncSegmentsRequest.SegmentInfosEntry.value:type_name -> milvus.proto.data.SyncSegmentInfo
	52,  // 319: milvus.proto.data.CompactionSegment.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	221, // 320: milvus.proto.data.WatchChannelsRequest.ChannelWalNamesEntry.value:type_name -> milvus.proto.common.WALName
	103, // 321: milvus.proto.data.ImportFileStats.HashedStatsEntry.value:type_name -> milvus.proto.data.PartitionImportStats
	52,  // 322: milvus.proto.data.CopySegmentSource.TextIndexFilesEntry.value:type_name -> milvus.proto.data.TextIndexStats
	53,  // 323: milvus.proto.data.CopySegmentSource.JsonKeyIndexFilesEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	116, // 324: milvus.proto.data.CopySegmentResult.IndexInfosEntry.value:type_name -> milvus.proto.data.VectorScalarIndexInfo
	52,  // 325: milvus.proto.data.CopySegmentResult.TextIndexInfosEntry.value:type_name -> milvus.proto.data.TextIndexStats
	53,  // 326: milvus.proto.data.CopySegmentResult.JsonKeyIndexInfosEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	52,  // 327: milvus.proto.data.SegmentDescription.TextIndexFilesEntry.value:type_name -> milvus.proto.data.TextIndexStats
	53,  // 328: milvus.proto.data.SegmentDescription.JsonKeyIndexFilesEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	14,  // 329: milvus.proto.data.DataCoord.Flush:input_type -> milvus.proto.data.FlushRequest
	17,  // 330: milvus.proto.data.DataCoord.FlushAll:input_type -> milvus.proto.data.FlushAllRequest
	22,  // 331: milvus.proto.data.DataCoord.AllocSegment:input_type -> milvus.proto.data.AllocSegmentRequest
	24,  // 332: milvus.proto.data.DataCoord.AssignSegmentID:input_type -> milvus.proto.data.AssignSegmentIDRequest
	30,  // 333: milvus.proto.data.DataCoord.GetSegmentInfo:input_type -> milvus.proto.data.GetSegmentInfoRequest
	27,  // 334: milvus.proto.data.DataCoord.GetSegmentStates:input_type -> milvus.proto.data.GetSegmentStatesRequest
	32,  // 335: milvus.proto.data.DataCoord.GetInsertBinlogPaths:input_type -> milvus.proto.data.GetInsertBinlogPathsRequest
	34,  // 336: milvus.proto.data.DataCoord.GetCollectionStatistics:input_type -> milvus.proto.data.GetCollectionStatisticsRequest
	36,  // 337: milvus.proto.data.DataCoord.GetPartitionStatistics:input_type -> milvus.proto.data.GetPartitionStatisticsRequest
	38,  // 338: milvus.proto.data.DataCoord.GetSegmentInfoChannel:input_type -> milvus.proto.data.GetSegmentInfoChannelRequest
	45,  // 339: milvus.proto.data.DataCoord.SaveBinlogPaths:input_type -> milvus.proto.data.SaveBinlogPathsRequest
	56,  // 340: milvus.proto.data.DataCoord.GetRecoveryInfo:input_type -> milvus.proto.data.GetRecoveryInfoRequest
	58,  // 341: milvus.proto.data.DataCoord.GetRecoveryInfoV2:input_type -> milvus.proto.data.GetRecoveryInfoRequestV2
	59,  // 342: milvus.proto.data.DataCoord.GetChannelRecoveryInfo:input_type -> milvus.proto.data.GetChannelRecoveryInfoRequest
	64,  // 343: milvus.proto.data.DataCoord.GetFlushedSegments:input_type -> milvus.proto.data.GetFlushedSegmentsRequest
	62,  // 344: milvus.proto.data.DataCoord.GetSegmentsByStates:input_type -> milvus.proto.data.GetSegmentsByStatesRequest
	222, // 345: milvus.proto.data.DataCoord.GetFlushAllState:input_type -> milvus.proto.milvus.GetFlushAllStateRequest
	223, // 346: milvus.proto.data.DataCoord.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	224, // 347: milvus.proto.data.DataCoord.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	225, // 348: milvus.proto.data.DataCoord.ManualCompaction:input_type -> milvus.proto.milvus.ManualCompactionRequest
	226, // 349: milvus.proto.data.DataCoord.GetCompactionState:input_type -> milvus.proto.milvus.GetCompactionStateRequest
	227, // 350: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:input_type -> milvus.proto.milvus.GetCompactionPlansRequest
	77,  // 351: milvus.proto.data.DataCoord.WatchChannels:input_type -> milvus.proto.data.WatchChannelsRequest
	95,  // 352: milvus.proto.data.DataCoord.GetFlushState:input_type -> milvus.proto.data.GetFlushStateRequest
	81,  // 353: milvus.proto.data.DataCoord.DropVirtualChannel:input_type -> milvus.proto.data.DropVirtualChannelRequest
	79,  // 354: milvus.proto.data.DataCoord.SetSegmentState:input_type -> milvus.proto.data.SetSegmentStateRequest
	84,  // 355: milvus.proto.data.DataCoord.UpdateSegmentStatistics:input_type -> milvus.proto.data.UpdateSegmentStatisticsRequest
	85,  // 356: milvus.proto.data.DataCoord.UpdateChannelCheckpoint:input_type -> milvus.proto.data.UpdateChannelCheckpointRequest
	88,  // 357: milvus.proto.data.DataCoord.MarkSegmentsDropped:input_type -> milvus.proto.data.MarkSegmentsDroppedRequest
	90,  // 358: milvus.proto.data.DataCoord.BroadcastAlteredCollection:input_type -> milvus.proto.data.AlterCollectionRequest
	228, // 359: milvus.proto.data.DataCoord.CheckHealth:input_type -> milvus.proto.milvus.CheckHealthRequest
	229, // 360: milvus.proto.data.DataCoord.CreateIndex:input_type -> milvus.proto.index.CreateIndexRequest
	230, // 361: milvus.proto.data.DataCoord.AlterIndex:input_type -> milvus.proto.index.AlterIndexRequest
	231, // 362: milvus.proto.data.DataCoord.GetIndexState:input_type -> milvus.proto.index.GetIndexStateRequest
	232, // 363: milvus.proto.data.DataCoord.GetSegmentIndexState:input_type -> milvus.proto.index.GetSegmentIndexStateRequest
	233, // 364: milvus.proto.data.DataCoord.GetIndexInfos:input_type -> milvus.proto.index.GetIndexInfoRequest
	234, // 365: milvus.proto.data.DataCoord.DropIndex:input_type -> milvus.proto.index.DropIndexRequest
	235, // 366: milvus.proto.data.DataCoord.DescribeIndex:input_type -> milvus.proto.index.DescribeIndexRequest
	236, // 367: milvus.proto.data.DataCoord.GetIndexStatistics:input_type -> milvus.proto.index.GetIndexStatisticsRequest
	237, // 368: milvus.proto.data.DataCoord.GetIndexBuildProgress:input_type -> milvus.proto.index.GetIndexBuildProgressRequest
	238, // 369: milvus.proto.data.DataCoord.ListIndexes:input_type -> milvus.proto.index.ListIndexesRequest
	92,  // 370: milvus.proto.data.DataCoord.GcConfirm:input_type -> milvus.proto.data.GcConfirmRequest
	94,  // 371: milvus.proto.data.DataCoord.ReportDataNodeTtMsgs:input_type -> milvus.proto.data.ReportDataNodeTtMsgsRequest
	124, // 372: milvus.proto.data.DataCoord.GcControl:input_type -> milvus.proto.data.GcControlRequest
	239, // 373: milvus.proto.data.DataCoord.ImportV2:input_type -> milvus.proto.internal.ImportRequestInternal
	240, // 374: milvus.proto.data.DataCoord.GetImportProgress:input_type -> milvus.proto.internal.GetImportProgressRequest
	241, // 375: milvus.proto.data.DataCoord.ListImports:input_type -> milvus.proto.internal.ListImportsRequestInternal
	142, // 376: milvus.proto.data.DataCoord.CreateSnapshot:input_type -> milvus.proto.data.CreateSnapshotRequest
	143, // 377: milvus.proto.data.DataCoord.DropSnapshot:input_type -> milvus.proto.data.DropSnapshotRequest
	144, // 378: milvus.proto.data.DataCoord.ListSnapshots:input_type -> milvus.proto.data.ListSnapshotsRequest
	152, // 379: milvus.proto.data.DataCoord.DescribeSnapshot:input_type -> milvus.proto.data.DescribeSnapshotRequest
	154, // 380: milvus.proto.data.DataCoord.RestoreSnapshot:input_type -> milvus.proto.data.RestoreSnapshotRequest
	156, // 381: milvus.proto.data.DataCoord.GetRestoreSnapshotState:input_type -> milvus.proto.data.GetRestoreSnapshotStateRequest
	158, // 382: milvus.proto.data.DataCoord.ListRestoreSnapshotJobs:input_type -> milvus.proto.data.ListRestoreSnapshotJobsRequest
	165, // 383: milvus.proto.data.DataCoord.PinSnapshotData:input_type -> milvus.proto.data.PinSnapshotDataRequest
	167, // 384: milvus.proto.data.DataCoord.UnpinSnapshotData:input_type -> milvus.proto.data.UnpinSnapshotDataRequest
	160, // 385: milvus.proto.data.DataCoord.BatchUpdateManifest:input_type -> milvus.proto.data.BatchUpdateManifestRequest
	162, // 386: milvus.proto.data.DataCoord.CommitBackfillResult:input_type -> milvus.proto.data.CommitBackfillResultRequest
	133, // 387: milvus.proto.data.DataCoord.RefreshExternalCollection:input_type -> milvus.proto.data.RefreshExternalCollectionRequest
	135, // 388: milvus.proto.data.DataCoord.GetRefreshExternalCollectionProgress:input_type -> milvus.proto.data.GetRefreshExternalCollectionProgressRequest
	140, // 389: milvus.proto.data.DataCoord.ListRefreshExternalCollectionJobs:input_type -> milvus.proto.data.ListRefreshExternalCollectionJobsRequest
	168, // 390: milvus.proto.data.DataCoord.CommitImport:input_type -> milvus.proto.data.CommitImportRequest
	169, // 391: milvus.proto.data.DataCoord.AbortImport:input_type -> milvus.proto.data.AbortImportRequest
	170, // 392: milvus.proto.data.DataCoord.HandleCommitVchannel:input_type -> milvus.proto.data.HandleCommitVchannelRequest
	242, // 393: milvus.proto.data.DataNode.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	243, // 394: milvus.proto.data.DataNode.GetStatisticsChannel:input_type -> milvus.proto.internal.GetStatisticsChannelRequest
	40,  // 395: milvus.proto.data.DataNode.WatchDmChannels:input_type -> milvus.proto.data.WatchDmChannelsRequest
	41,  // 396: milvus.proto.data.DataNode.FlushSegments:input_type -> milvus.proto.data.FlushSegmentsRequest
	223, // 397: milvus.proto.data.DataNode.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	224, // 398: milvus.proto.data.DataNode.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	72,  // 399: milvus.proto.data.DataNode.CompactionV2:input_type -> milvus.proto.data.CompactionPlan
	68,  // 400: milvus.proto.data.DataNode.GetCompactionState:input_type -> milvus.proto.data.CompactionStateRequest
	70,  // 401: milvus.proto.data.DataNode.SyncSegments:input_type -> milvus.proto.data.SyncSegmentsRequest
	86,  // 402: milvus.proto.data.DataNode.ResendSegmentStats:input_type -> milvus.proto.data.ResendSegmentStatsRequest
	20,  // 403: milvus.proto.data.DataNode.FlushChannels:input_type -> milvus.proto.data.FlushChannelsRequest
	96,  // 404: milvus.proto.data.DataNode.NotifyChannelOperation:input_type -> milvus.proto.data.ChannelOperationsRequest
	67,  // 405: milvus.proto.data.DataNode.CheckChannelOperationProgress:input_type -> milvus.proto.data.ChannelWatchInfo
	98,  // 406: milvus.proto.data.DataNode.PreImport:input_type -> milvus.proto.data.PreImportRequest
	101, // 407: milvus.proto.data.DataNode.ImportV2:input_type -> milvus.proto.data.ImportRequest
	102, // 408: milvus.proto.data.DataNode.QueryPreImport:input_type -> milvus.proto.data.QueryPreImportRequest
	106, // 409: milvus.proto.data.DataNode.QueryImport:input_type -> milvus.proto.data.QueryImportRequest
	109, // 410: milvus.proto.data.DataNode.DropImport:input_type -> milvus.proto.data.DropImportRequest
	126, // 411: milvus.proto.data.DataNode.QuerySlot:input_type -> milvus.proto.data.QuerySlotRequest
	130, // 412: milvus.proto.data.DataNode.DropCompactionPlan:input_type -> milvus.proto.data.DropCompactionPlanRequest
	244, // 413: milvus.proto.data.DataNode.SyncFileResource:input_type -> milvus.proto.internal.SyncFileResourceRequest
	15,  // 414: milvus.proto.data.DataCoord.Flush:output_type -> milvus.proto.data.FlushResponse
	19,  // 415: milvus.proto.data.DataCoord.FlushAll:output_type -> milvus.proto.data.FlushAllResponse
	23,  // 416: milvus.proto.data.DataCoord.AllocSegment:output_type -> milvus.proto.data.AllocSegmentResponse
	26,  // 417: milvus.proto.data.DataCoord.AssignSegmentID:output_type -> milvus.proto.data.AssignSegmentIDResponse
	31,  // 418: milvus.proto.data.DataCoord.GetSegmentInfo:output_type -> milvus.proto.data.GetSegmentInfoResponse
	29,  // 419: milvus.proto.data.DataCoord.GetSegmentStates:output_type -> milvus.proto.data.GetSegmentStatesResponse
	33,  // 420: milvus.proto.data.DataCoord.GetInsertBinlogPaths:output_type -> milvus.proto.data.GetInsertBinlogPathsResponse
	35,  // 421: milvus.proto.data.DataCoord.GetCollectionStatistics:output_type -> milvus.proto.data.GetCollectionStatisticsResponse
	37,  // 422: milvus.proto.data.DataCoord.GetPartitionStatistics:output_type -> milvus.proto.data.GetPartitionStatisticsResponse
	245, // 423: milvus.proto.data.DataCoord.GetSegmentInfoChannel:output_type -> milvus.proto.milvus.StringResponse
	199, // 424: milvus.proto.data.DataCoord.SaveBinlogPaths:output_type -> milvus.proto.common.Status
	55,  // 425: milvus.proto.data.DataCoord.GetRecoveryInfo:output_type -> milvus.proto.data.GetRecoveryInfoResponse
	57,  // 426: milvus.proto.data.DataCoord.GetRecoveryInfoV2:output_type -> milvus.proto.data.GetRecoveryInfoResponseV2
	60,  // 427: milvus.proto.data.DataCoord.GetChannelRecoveryInfo:output_type -> milvus.proto.data.GetChannelRecoveryInfoResponse
	65,  // 428: milvus.proto.data.DataCoord.GetFlushedSegments:output_type -> milvus.proto.data.GetFlushedSegmentsResponse
	63,  // 429: milvus.proto.data.DataCoord.GetSegmentsByStates:output_type -> milvus.proto.data.GetSegmentsByStatesResponse
	246, // 430: milvus.proto.data.DataCoord.GetFlushAllState:output_type -> milvus.proto.milvus.GetFlushAllStateResponse
	247, // 431: milvus.proto.data.DataCoord.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	248, // 432: milvus.proto.data.DataCoord.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	249, // 433: milvus.proto.data.DataCoord.ManualCompaction:output_type -> milvus.proto.milvus.ManualCompactionResponse
	250, // 434: milvus.proto.data.DataCoord.GetCompactionState:output_type -> milvus.proto.milvus.GetCompactionStateResponse
	251, // 435: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:output_type -> milvus.proto.milvus.GetCompactionPlansResponse
	78,  // 436: milvus.proto.data.DataCoord.WatchChannels:output_type -> milvus.proto.data.WatchChannelsResponse
	252, // 437: milvus.proto.data.DataCoord.GetFlushState:output_type -> milvus.proto.milvus.GetFlushStateResponse
	83,  // 438: milvus.proto.data.DataCoord.DropVirtualChannel:output_type -> milvus.proto.data.DropVirtualChannelResponse
	80,  // 439: milvus.proto.data.DataCoord.SetSegmentState:output_type -> milvus.proto.data.SetSegmentStateResponse
	199, // 440: milvus.proto.data.DataCoord.UpdateSegmentStatistics:output_type -> milvus.proto.common.Status
	199, // 441: milvus.proto.data.DataCoord.UpdateChannelCheckpoint:output_type -> milvus.proto.common.Status
	199, // 442: milvus.proto.data.DataCoord.MarkSegmentsDropped:output_type -> milvus.proto.common.Status
	199, // 443: milvus.proto.data.DataCoord.BroadcastAlteredCollection:output_type -> milvus.proto.common.Status
	253, // 444: milvus.proto.data.DataCoord.CheckHealth:output_type -> milvus.proto.milvus.CheckHealthResponse
	199, // 445: milvus.proto.data.DataCoord.CreateIndex:output_type -> milvus.proto.common.Status
	199, // 446: milvus.proto.data.DataCoord.AlterIndex:output_type -> milvus.proto.common.Status
	254, // 447: milvus.proto.data.DataCoord.GetIndexState:output_type -> milvus.proto.index.GetIndexStateResponse
	255, // 448: milvus.proto.data.DataCoord.GetSegmentIndexState:output_type -> milvus.proto.index.GetSegmentIndexStateResponse
	256, // 449: milvus.proto.data.DataCoord.GetIndexInfos:output_type -> milvus.proto.index.GetIndexInfoResponse
	199, // 450: milvus.proto.data.DataCoord.DropIndex:output_type -> milvus.proto.common.Status
	257, // 451: milvus.proto.data.DataCoord.DescribeIndex:output_type -> milvus.proto.index.DescribeIndexResponse
	258, // 452: milvus.proto.data.DataCoord.GetIndexStatistics:output_type -> milvus.proto.index.GetIndexStatisticsResponse
	259, // 453: milvus.proto.data.DataCoord.GetIndexBuildProgress:output_type -> milvus.proto.index.GetIndexBuildProgressResponse
	260, // 454: milvus.proto.data.DataCoord.ListIndexes:output_type -> milvus.proto.index.ListIndexesResponse
	93,  // 455: milvus.proto.data.DataCoord.GcConfirm:output_type -> milvus.proto.data.GcConfirmResponse
	199, // 456: milvus.proto.data.DataCoord.ReportDataNodeTtMsgs:output_type -> milvus.proto.common.Status
	199, // 457: milvus.proto.data.DataCoord.GcControl:output_type -> milvus.proto.common.Status
	261, // 458: milvus.proto.data.DataCoord.ImportV2:output_type -> milvus.proto.internal.ImportResponse
	262, // 459: milvus.proto.data.DataCoord.GetImportProgress:output_type -> milvus.proto.internal.GetImportProgressResponse
	263, // 460: milvus.proto.data.DataCoord.ListImports:output_type -> milvus.proto.internal.ListImportsResponse
	199, // 461: milvus.proto.data.DataCoord.CreateSnapshot:output_type -> milvus.proto.common.Status
	199, // 462: milvus.proto.data.DataCoord.DropSnapshot:output_type -> milvus.proto.common.Status
	145, // 463: milvus.proto.data.DataCoord.ListSnapshots:output_type -> milvus.proto.data.ListSnapshotsResponse
	153, // 464: milvus.proto.data.DataCoord.DescribeSnapshot:output_type -> milvus.proto.data.DescribeSnapshotResponse
	155, // 465: milvus.proto.data.DataCoord.RestoreSnapshot:output_type -> milvus.proto.data.RestoreSnapshotResponse
	157, // 466: milvus.proto.data.DataCoord.GetRestoreSnapshotState:output_type -> milvus.proto.data.GetRestoreSnapshotStateResponse
	159, // 467: milvus.proto.data.DataCoord.ListRestoreSnapshotJobs:output_type -> milvus.proto.data.ListRestoreSnapshotJobsResponse
	166, // 468: milvus.proto.data.DataCoord.PinSnapshotData:output_type -> milvus.proto.data.PinSnapshotDataResponse
	199, // 469: milvus.proto.data.DataCoord.UnpinSnapshotData:output_type -> milvus.proto.common.Status
	199, // 470: milvus.proto.data.DataCoord.BatchUpdateManifest:output_type -> milvus.proto.common.Status
	164, // 471: milvus.proto.data.DataCoord.CommitBackfillResult:output_type -> milvus.proto.data.CommitBackfillResultResponse
	134, // 472: milvus.proto.data.DataCoord.RefreshExternalCollection:output_type -> milvus.proto.data.RefreshExternalCollectionResponse
	139, // 473: milvus.proto.data.DataCoord.GetRefreshExternalCollectionProgress:output_type -> milvus.proto.data.GetRefreshExternalCollectionProgressResponse
	141, // 474: milvus.proto.data.DataCoord.ListRefreshExternalCollectionJobs:output_type -> milvus.proto.data.ListRefreshExternalCollectionJobsResponse
	199, // 475: milvus.proto.data.DataCoord.CommitImport:output_type -> milvus.proto.common.Status
	199, // 476: milvus.proto.data.DataCoord.AbortImport:output_type -> milvus.proto.common.Status
	199, // 477: milvus.proto.data.DataCoord.HandleCommitVchannel:output_type -> milvus.proto.common.Status
	264, // 478: milvus.proto.data.DataNode.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	245, // 479: milvus.proto.data.DataNode.GetStatisticsChannel:output_type -> milvus.proto.milvus.StringResponse
	199, // 480: milvus.proto.data.DataNode.WatchDmChannels:output_type -> milvus.proto.common.Status
	199, // 481: milvus.proto.data.DataNode.FlushSegments:output_type -> milvus.proto.common.Status
	247, // 482: milvus.proto.data.DataNode.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	248, // 483: milvus.proto.data.DataNode.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	199, // 484: milvus.proto.data.DataNode.CompactionV2:output_type -> milvus.proto.common.Status
	75,  // 485: milvus.proto.data.DataNode.GetCompactionState:output_type -> milvus.proto.data.CompactionStateResponse
	199, // 486: milvus.proto.data.DataNode.SyncSegments:output_type -> milvus.proto.common.Status
	87,  // 487: milvus.proto.data.DataNode.ResendSegmentStats:output_type -> milvus.proto.data.ResendSegmentStatsResponse
	199, // 488: milvus.proto.data.DataNode.FlushChannels:output_type -> milvus.proto.common.Status
	199, // 489: milvus.proto.data.DataNode.NotifyChannelOperation:output_type -> milvus.proto.common.Status
	97,  // 490: milvus.proto.data.DataNode.CheckChannelOperationProgress:output_type -> milvus.proto.data.ChannelOperationProgressResponse
	199, // 491: milvus.proto.data.DataNode.PreImport:output_type -> milvus.proto.common.Status
	199, // 492: milvus.proto.data.DataNode.ImportV2:output_type -> milvus.proto.common.Status
	105, // 493: milvus.proto.data.DataNode.QueryPreImport:output_type -> milvus.proto.data.QueryPreImportResponse
	108, // 494: milvus.proto.data.DataNode.QueryImport:output_type -> milvus.proto.data.QueryImportResponse
	199, // 495: milvus.proto.data.DataNode.DropImport:output_type -> milvus.proto.common.Status
	127, // 496: milvus.proto.data.DataNode.QuerySlot:output_type -> milvus.proto.data.QuerySlotResponse
	199, // 497: milvus.proto.data.DataNode.DropCompactionPlan:output_type -> milvus.proto.common.Status
	199, // 498: milvus.proto.data.DataNode.SyncFileResource:output_type -> milvus.proto.common.Status
	414, // [414:499] is the sub-list for method output_type
	329, // [329:414] is the sub-list for method input_type
...
func file_data_coord_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_data_coord_proto_msgTypes[158].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SplitShardTaskTarget); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
