...
type SegmentInfo struct {
	...
	// predicate_deltalogs records predicate delete log summaries separately from
	// primary-key deltalogs so schedulers can distinguish them from etcd metadata
	// without opening object-store manifests or data files.
