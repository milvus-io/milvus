...
type RefreshExternalCollectionTaskResponse struct {
	...
	// The single segment upsert payload used by both old and new coordinators.
	// DataCoord only consumes worker-owned result fields and materializes
	// collection / partition / channel / state / level itself.
	...
	// Optional worker echo of the dispatch-time manifest for each in-place patch,
	// keyed by segment ID. New DataCoord verifies an echo against its own persisted
	// dispatch snapshot but never trusts it as the CAS expectation. Old workers
	// may omit it; old coordinators ignore it and continue reading updatedSegments.
	// New segments have no entry.
	BaseManifests map[int64]string `protobuf:"bytes,6,rep,name=base_manifests,json=baseManifests,proto3" json:"base_manifests,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *RefreshExternalCollectionTaskResponse) GetBaseManifests() map[int64]string {
	if x != nil {
...
type ExternalCollectionRefreshTask struct {
	...
	// The single persisted segment payload. Keeping the original field lets a
	// new DataCoord reload old tasks and an old DataCoord recover or roll back
	// tasks written by the new version without losing updated segments.
	UpdatedSegments []*SegmentInfo `protobuf:"bytes,16,rep,name=updated_segments,json=updatedSegments,proto3" json:"updated_segments,omitempty"`
	...
	// DataCoord-owned dispatch snapshot, keyed by existing segment ID. It stores
	// the manifest sent in currentSegments for this exact attempt, so adoption
	// does not trust a worker to report its own CAS expectation. Old tasks have
	// no entries; a new coordinator fails closed and rebuilds before adopting an
	// unverifiable existing-segment result. New segments have no entry.
	BaseManifests map[int64]string `protobuf:"bytes,19,rep,name=base_manifests,json=baseManifests,proto3" json:"base_manifests,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// IDs reserved by DataCoord for this exact dispatch attempt. Persisting the
	// range binds every birth result to coordinator-owned allocation state across
	// restart/failover; a task restored without it is rebuilt before adoption.
	PreallocatedSegmentIds *IDRange `protobuf:"bytes,20,opt,name=preallocated_segment_ids,json=preallocatedSegmentIds,proto3" json:"preallocated_segment_ids,omitempty"`
	// Coordinator-owned parent path for birth segment manifests:
	// {root}/insert_log/{collection}/{partition}. The result's segment ID is
	// appended and must match exactly before the birth is adopted.
	TargetSegmentBase string `protobuf:"bytes,21,opt,name=target_segment_base,json=targetSegmentBase,proto3" json:"target_segment_base,omitempty"`
}
...
func (x *ExternalCollectionRefreshTask) GetPreallocatedSegmentIds() *IDRange {
	if x != nil {
		return x.PreallocatedSegmentIds
	}
	return nil
...
func (x *ExternalCollectionRefreshTask) GetTargetSegmentBase() string {
	if x != nil {
		return x.TargetSegmentBase
	}
	return ""
}
...
var file_data_coord_proto_rawDesc = []byte{
	...
	0x52, 0x6f, 0x77, 0x73, 0x50, 0x65, 0x72, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xd5,
	0x03, 0x0a, 0x25, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e,
	...
	0x12, 0x72, 0x0a, 0x0e, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73,
	0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x4b, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75,
	...
	0x73, 0x65, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x73,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xf0, 0x01, 0x0a, 0x20, 0x52, 0x65, 0x66, 0x72, 0x65,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x6e, 0x75, 0x6d, 0x52, 0x6f, 0x77, 0x73, 0x22, 0xbd,
	0x07, 0x0a, 0x1d, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x43, 0x6f, 0x6c, 0x6c, 0x65,
	...
	0x08, 0x52, 0x0b, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x65, 0x61, 0x64, 0x79, 0x12, 0x6a,
	0x0a, 0x0e, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x73,
	0x18, 0x13, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e,
	...
	,
	...
	0x52, 0x0c, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x53, 0x70, 0x65, 0x63, 0x22, 0x81,
	...
	0x61, 0x74, 0x61, 0x5f, 0x75, 0x72, 0x69, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x73,
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x55,
	0x72, 0x69, 0x22, 0xe3, 0x09, 0x0a, 0x12, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x44, 0x65,
	...
	0x61, 0x6d, 0x70, 0x2a, 0x3e, 0x0a, 0x0b, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79,
...
var file_data_coord_proto_goTypes = []interface{}{
	...
	nil,                                                  // 196: milvus.proto.data.RefreshExternalCollectionTaskResponse.BaseManifestsEntry
	nil,                                                  // 197: milvus.proto.data.ExternalCollectionRefreshTask.BaseManifestsEntry
...
var file_data_coord_proto_depIdxs = []int32{
	...
	206, // 63: milvus.proto.data.SegmentStartPosition.start_position:type_name -> milvus.proto.msg.MsgPosition
	202, // 64: milvus.proto.data.SaveBinlogPathsRequest.base:type_name -> milvus.proto.common.MsgBase
	...
	206, // 73: milvus.proto.data.CheckPoint.position:type_name -> milvus.proto.msg.MsgPosition
	...
	203, // 82: milvus.proto.data.GetRecoveryInfoResponse.status:type_name -> milvus.proto.common.Status
	...
	202, // 85: milvus.proto.data.GetRecoveryInfoRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 86: milvus.proto.data.GetRecoveryInfoResponseV2.status:type_name -> milvus.proto.common.Status
	...
	202, // 89: milvus.proto.data.GetRecoveryInfoRequestV2.base:type_name -> milvus.proto.common.MsgBase
	202, // 90: milvus.proto.data.GetChannelRecoveryInfoRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 91: milvus.proto.data.GetChannelRecoveryInfoResponse.status:type_name -> milvus.proto.common.Status
	39,  // 92: milvus.proto.data.GetChannelRecoveryInfoResponse.info:type_name -> milvus.proto.data.VchannelInfo
	209, // 93: milvus.proto.data.GetChannelRecoveryInfoResponse.schema:type_name -> milvus.proto.schema.CollectionSchema
	...
	202, // 95: milvus.proto.data.GetSegmentsByStatesRequest.base:type_name -> milvus.proto.common.MsgBase
	205, // 96: milvus.proto.data.GetSegmentsByStatesRequest.states:type_name -> milvus.proto.common.SegmentState
	203, // 97: milvus.proto.data.GetSegmentsByStatesResponse.status:type_name -> milvus.proto.common.Status
	202, // 98: milvus.proto.data.GetFlushedSegmentsRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 99: milvus.proto.data.GetFlushedSegmentsResponse.status:type_name -> milvus.proto.common.Status
	202, // 100: milvus.proto.data.SegmentFlushCompletedMsg.base:type_name -> milvus.proto.common.MsgBase
	...
	209, // 104: milvus.proto.data.ChannelWatchInfo.schema:type_name -> milvus.proto.schema.CollectionSchema
	208, // 105: milvus.proto.data.ChannelWatchInfo.dbProperties:type_name -> milvus.proto.common.KeyValuePair
	202, // 106: milvus.proto.data.CompactionStateRequest.base:type_name -> milvus.proto.common.MsgBase
	52,  // 107: milvus.proto.data.SyncSegmentInfo.pk_stats_log:type_name -> milvus.proto.data.FieldBinlog
	205, // 108: milvus.proto.data.SyncSegmentInfo.state:type_name -> milvus.proto.common.SegmentState
	...
	209, // 118: milvus.proto.data.CompactionPlan.schema:type_name -> milvus.proto.schema.CollectionSchema
	...
	208, // 121: milvus.proto.data.CompactionPlan.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	210, // 122: milvus.proto.data.CompactionPlan.file_resources:type_name -> milvus.proto.internal.FileResourceInfo
	211, // 123: milvus.proto.data.CompactionPlan.functions:type_name -> milvus.proto.schema.FunctionSchema
	...
	203, // 133: milvus.proto.data.CompactionStateResponse.status:type_name -> milvus.proto.common.Status
	75,  // 134: milvus.proto.data.CompactionStateResponse.results:type_name -> milvus.proto.data.CompactionPlanResult
	212, // 135: milvus.proto.data.WatchChannelsRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	209, // 136: milvus.proto.data.WatchChannelsRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	208, // 137: milvus.proto.data.WatchChannelsRequest.db_properties:type_name -> milvus.proto.common.KeyValuePair
	...
	203, // 139: milvus.proto.data.WatchChannelsResponse.status:type_name -> milvus.proto.common.Status
	202, // 140: milvus.proto.data.SetSegmentStateRequest.base:type_name -> milvus.proto.common.MsgBase
	205, // 141: milvus.proto.data.SetSegmentStateRequest.new_state:type_name -> milvus.proto.common.SegmentState
	203, // 142: milvus.proto.data.SetSegmentStateResponse.status:type_name -> milvus.proto.common.Status
	202, // 143: milvus.proto.data.DropVirtualChannelRequest.base:type_name -> milvus.proto.common.MsgBase
	...
	206, // 148: milvus.proto.data.DropVirtualChannelSegment.startPosition:type_name -> milvus.proto.msg.MsgPosition
	206, // 149: milvus.proto.data.DropVirtualChannelSegment.checkPoint:type_name -> milvus.proto.msg.MsgPosition
	203, // 150: milvus.proto.data.DropVirtualChannelResponse.status:type_name -> milvus.proto.common.Status
	202, // 151: milvus.proto.data.UpdateSegmentStatisticsRequest.base:type_name -> milvus.proto.common.MsgBase
	213, // 152: milvus.proto.data.UpdateSegmentStatisticsRequest.stats:type_name -> milvus.proto.common.SegmentStats
	202, // 153: milvus.proto.data.UpdateChannelCheckpointRequest.base:type_name -> milvus.proto.common.MsgBase
	206, // 154: milvus.proto.data.UpdateChannelCheckpointRequest.position:type_name -> milvus.proto.msg.MsgPosition
	206, // 155: milvus.proto.data.UpdateChannelCheckpointRequest.channel_checkpoints:type_name -> milvus.proto.msg.MsgPosition
	202, // 156: milvus.proto.data.ResendSegmentStatsRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 157: milvus.proto.data.ResendSegmentStatsResponse.status:type_name -> milvus.proto.common.Status
	202, // 158: milvus.proto.data.MarkSegmentsDroppedRequest.base:type_name -> milvus.proto.common.MsgBase
	209, // 159: milvus.proto.data.AlterCollectionRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	212, // 160: milvus.proto.data.AlterCollectionRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	208, // 161: milvus.proto.data.AlterCollectionRequest.properties:type_name -> milvus.proto.common.KeyValuePair
	214, // 162: milvus.proto.data.AddCollectionFieldRequest.field_schema:type_name -> milvus.proto.schema.FieldSchema
	209, // 163: milvus.proto.data.AddCollectionFieldRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	212, // 164: milvus.proto.data.AddCollectionFieldRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	208, // 165: milvus.proto.data.AddCollectionFieldRequest.properties:type_name -> milvus.proto.common.KeyValuePair
	203, // 166: milvus.proto.data.GcConfirmResponse.status:type_name -> milvus.proto.common.Status
	202, // 167: milvus.proto.data.ReportDataNodeTtMsgsRequest.base:type_name -> milvus.proto.common.MsgBase
	215, // 168: milvus.proto.data.ReportDataNodeTtMsgsRequest.msgs:type_name -> milvus.proto.msg.DataNodeTtMsg
	68,  // 169: milvus.proto.data.ChannelOperationsRequest.infos:type_name -> milvus.proto.data.ChannelWatchInfo
	203, // 170: milvus.proto.data.ChannelOperationProgressResponse.status:type_name -> milvus.proto.common.Status
	2,   // 171: milvus.proto.data.ChannelOperationProgressResponse.state:type_name -> milvus.proto.data.ChannelWatchState
	209, // 172: milvus.proto.data.PreImportRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	216, // 173: milvus.proto.data.PreImportRequest.import_files:type_name -> milvus.proto.internal.ImportFile
	208, // 174: milvus.proto.data.PreImportRequest.options:type_name -> milvus.proto.common.KeyValuePair
	217, // 175: milvus.proto.data.PreImportRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	208, // 176: milvus.proto.data.PreImportRequest.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	209, // 177: milvus.proto.data.ImportRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	216, // 178: milvus.proto.data.ImportRequest.files:type_name -> milvus.proto.internal.ImportFile
	208, // 179: milvus.proto.data.ImportRequest.options:type_name -> milvus.proto.common.KeyValuePair
	...
	217, // 182: milvus.proto.data.ImportRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	208, // 183: milvus.proto.data.ImportRequest.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	...
	216, // 186: milvus.proto.data.ImportFileStats.import_file:type_name -> milvus.proto.internal.ImportFile
	189, // 187: milvus.proto.data.ImportFileStats.hashed_stats:type_name -> milvus.proto.data.ImportFileStats.HashedStatsEntry
	203, // 188: milvus.proto.data.QueryPreImportResponse.status:type_name -> milvus.proto.common.Status
	...
	203, // 196: milvus.proto.data.QueryImportResponse.status:type_name -> milvus.proto.common.Status
	...
	218, // 202: milvus.proto.data.CopySegmentSource.index_files:type_name -> milvus.proto.index.IndexFilePathInfo
	...
	217, // 209: milvus.proto.data.CopySegmentRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	203, // 210: milvus.proto.data.QueryCopySegmentResponse.status:type_name -> milvus.proto.common.Status
	...
	219, // 213: milvus.proto.data.VectorScalarIndexInfo.index_store_path_version:type_name -> milvus.proto.index.IndexStorePathVersion
	...
	208, // 225: milvus.proto.data.CopySegmentJob.options:type_name -> milvus.proto.common.KeyValuePair
	209, // 226: milvus.proto.data.ImportJob.schema:type_name -> milvus.proto.schema.CollectionSchema
	220, // 227: milvus.proto.data.ImportJob.state:type_name -> milvus.proto.internal.ImportJobState
	216, // 228: milvus.proto.data.ImportJob.files:type_name -> milvus.proto.internal.ImportFile
	208, // 229: milvus.proto.data.ImportJob.options:type_name -> milvus.proto.common.KeyValuePair
	...
	202, // 235: milvus.proto.data.GcControlRequest.base:type_name -> milvus.proto.common.MsgBase
	10,  // 236: milvus.proto.data.GcControlRequest.command:type_name -> milvus.proto.data.GcCommand
	208, // 237: milvus.proto.data.GcControlRequest.params:type_name -> milvus.proto.common.KeyValuePair
	203, // 238: milvus.proto.data.QuerySlotResponse.status:type_name -> milvus.proto.common.Status
	...
	206, // 241: milvus.proto.data.CompactionTask.pos:type_name -> milvus.proto.msg.MsgPosition
	209, // 242: milvus.proto.data.CompactionTask.schema:type_name -> milvus.proto.schema.CollectionSchema
	214, // 243: milvus.proto.data.CompactionTask.clustering_key_field:type_name -> milvus.proto.schema.FieldSchema
	100, // 244: milvus.proto.data.CompactionTask.pre_allocated_segmentIDs:type_name -> milvus.proto.data.IDRange
	211, // 245: milvus.proto.data.CompactionTask.diff_functions:type_name -> milvus.proto.schema.FunctionSchema
	202, // 246: milvus.proto.data.RefreshExternalCollectionTaskRequest.base:type_name -> milvus.proto.common.MsgBase
	43,  // 247: milvus.proto.data.RefreshExternalCollectionTaskRequest.currentSegments:type_name -> milvus.proto.data.SegmentInfo
	217, // 248: milvus.proto.data.RefreshExternalCollectionTaskRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	209, // 249: milvus.proto.data.RefreshExternalCollectionTaskRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	...
	203, // 251: milvus.proto.data.RefreshExternalCollectionTaskResponse.status:type_name -> milvus.proto.common.Status
	43,  // 252: milvus.proto.data.RefreshExternalCollectionTaskResponse.updatedSegments:type_name -> milvus.proto.data.SegmentInfo
	221, // 253: milvus.proto.data.RefreshExternalCollectionTaskResponse.state:type_name -> milvus.proto.index.JobState
	196, // 254: milvus.proto.data.RefreshExternalCollectionTaskResponse.base_manifests:type_name -> milvus.proto.data.RefreshExternalCollectionTaskResponse.BaseManifestsEntry
	202, // 255: milvus.proto.data.RefreshExternalCollectionRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 256: milvus.proto.data.RefreshExternalCollectionResponse.status:type_name -> milvus.proto.common.Status
	202, // 257: milvus.proto.data.GetRefreshExternalCollectionProgressRequest.base:type_name -> milvus.proto.common.MsgBase
	221, // 258: milvus.proto.data.ExternalCollectionRefreshJob.state:type_name -> milvus.proto.index.JobState
	221, // 259: milvus.proto.data.ExternalCollectionRefreshTask.state:type_name -> milvus.proto.index.JobState
	43,  // 260: milvus.proto.data.ExternalCollectionRefreshTask.updated_segments:type_name -> milvus.proto.data.SegmentInfo
	197, // 261: milvus.proto.data.ExternalCollectionRefreshTask.base_manifests:type_name -> milvus.proto.data.ExternalCollectionRefreshTask.BaseManifestsEntry
	100, // 262: milvus.proto.data.ExternalCollectionRefreshTask.preallocated_segment_ids:type_name -> milvus.proto.data.IDRange
	203, // 263: milvus.proto.data.GetRefreshExternalCollectionProgressResponse.status:type_name -> milvus.proto.common.Status
	137, // 264: milvus.proto.data.GetRefreshExternalCollectionProgressResponse.job_info:type_name -> milvus.proto.data.ExternalCollectionRefreshJob
	202, // 265: milvus.proto.data.ListRefreshExternalCollectionJobsRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 266: milvus.proto.data.ListRefreshExternalCollectionJobsResponse.status:type_name -> milvus.proto.common.Status
	137, // 267: milvus.proto.data.ListRefreshExternalCollectionJobsResponse.jobs:type_name -> milvus.proto.data.ExternalCollectionRefreshJob
	202, // 268: milvus.proto.data.CreateSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	202, // 269: milvus.proto.data.DropSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	202, // 270: milvus.proto.data.ListSnapshotsRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 271: milvus.proto.data.ListSnapshotsResponse.status:type_name -> milvus.proto.common.Status
	202, // 272: milvus.proto.data.ExportSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 273: milvus.proto.data.ExportSnapshotResponse.status:type_name -> milvus.proto.common.Status
	1,   // 274: milvus.proto.data.SegmentDescription.segment_level:type_name -> milvus.proto.data.SegmentLevel
	52,  // 275: milvus.proto.data.SegmentDescription.binlogs:type_name -> milvus.proto.data.FieldBinlog
	52,  // 276: milvus.proto.data.SegmentDescription.deltalogs:type_name -> milvus.proto.data.FieldBinlog
	52,  // 277: milvus.proto.data.SegmentDescription.statslogs:type_name -> milvus.proto.data.FieldBinlog
	52,  // 278: milvus.proto.data.SegmentDescription.bm25_statslogs:type_name -> milvus.proto.data.FieldBinlog
	198, // 279: milvus.proto.data.SegmentDescription.text_index_files:type_name -> milvus.proto.data.SegmentDescription.TextIndexFilesEntry
	199, // 280: milvus.proto.data.SegmentDescription.json_key_index_files:type_name -> milvus.proto.data.SegmentDescription.JsonKeyIndexFilesEntry
	218, // 281: milvus.proto.data.SegmentDescription.index_files:type_name -> milvus.proto.index.IndexFilePathInfo
	206, // 282: milvus.proto.data.SegmentDescription.start_position:type_name -> milvus.proto.msg.MsgPosition
	206, // 283: milvus.proto.data.SegmentDescription.dml_position:type_name -> milvus.proto.msg.MsgPosition
	209, // 284: milvus.proto.data.CollectionDescription.schema:type_name -> milvus.proto.schema.CollectionSchema
	222, // 285: milvus.proto.data.CollectionDescription.consistency_level:type_name -> milvus.proto.common.ConsistencyLevel
	208, // 286: milvus.proto.data.CollectionDescription.properties:type_name -> milvus.proto.common.KeyValuePair
	200, // 287: milvus.proto.data.CollectionDescription.partitions:type_name -> milvus.proto.data.CollectionDescription.PartitionsEntry
	6,   // 288: milvus.proto.data.SnapshotInfo.state:type_name -> milvus.proto.data.SnapshotState
	201, // 289: milvus.proto.data.SnapshotInfo.pin_expire_at_ms:type_name -> milvus.proto.data.SnapshotInfo.PinExpireAtMsEntry
	206, // 290: milvus.proto.data.SnapshotInfo.channel_seek_positions:type_name -> milvus.proto.msg.MsgPosition
	151, // 291: milvus.proto.data.SnapshotMetadata.snapshot_info:type_name -> milvus.proto.data.SnapshotInfo
	150, // 292: milvus.proto.data.SnapshotMetadata.collection:type_name -> milvus.proto.data.CollectionDescription
	223, // 293: milvus.proto.data.SnapshotMetadata.indexes:type_name -> milvus.proto.index.IndexInfo
	152, // 294: milvus.proto.data.SnapshotMetadata.storagev2_manifest_list:type_name -> milvus.proto.data.StorageV2SegmentManifest
	12,  // 295: milvus.proto.data.SnapshotMetadata.layout:type_name -> milvus.proto.data.SnapshotLayout
	7,   // 296: milvus.proto.data.RestoreSnapshotInfo.state:type_name -> milvus.proto.data.RestoreSnapshotState
	202, // 297: milvus.proto.data.DescribeSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 298: milvus.proto.data.DescribeSnapshotResponse.status:type_name -> milvus.proto.common.Status
	151, // 299: milvus.proto.data.DescribeSnapshotResponse.snapshot_info:type_name -> milvus.proto.data.SnapshotInfo
	150, // 300: milvus.proto.data.DescribeSnapshotResponse.collection_info:type_name -> milvus.proto.data.CollectionDescription
	223, // 301: milvus.proto.data.DescribeSnapshotResponse.index_infos:type_name -> milvus.proto.index.IndexInfo
	202, // 302: milvus.proto.data.RestoreSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 303: milvus.proto.data.RestoreSnapshotResponse.status:type_name -> milvus.proto.common.Status
	202, // 304: milvus.proto.data.GetRestoreSnapshotStateRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 305: milvus.proto.data.GetRestoreSnapshotStateResponse.status:type_name -> milvus.proto.common.Status
	154, // 306: milvus.proto.data.GetRestoreSnapshotStateResponse.info:type_name -> milvus.proto.data.RestoreSnapshotInfo
	202, // 307: milvus.proto.data.ListRestoreSnapshotJobsRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 308: milvus.proto.data.ListRestoreSnapshotJobsResponse.status:type_name -> milvus.proto.common.Status
	154, // 309: milvus.proto.data.ListRestoreSnapshotJobsResponse.jobs:type_name -> milvus.proto.data.RestoreSnapshotInfo
	202, // 310: milvus.proto.data.BatchUpdateManifestRequest.base:type_name -> milvus.proto.common.MsgBase
	164, // 311: milvus.proto.data.BatchUpdateManifestRequest.items:type_name -> milvus.proto.data.BatchUpdateManifestItem
	202, // 312: milvus.proto.data.CommitBackfillResultRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 313: milvus.proto.data.CommitBackfillResultResponse.status:type_name -> milvus.proto.common.Status
	166, // 314: milvus.proto.data.CommitBackfillResultResponse.segment_statuses:type_name -> milvus.proto.data.CommitBackfillResultSegmentStatus
	202, // 315: milvus.proto.data.PinSnapshotDataRequest.base:type_name -> milvus.proto.common.MsgBase
	203, // 316: milvus.proto.data.PinSnapshotDataResponse.status:type_name -> milvus.proto.common.Status
	202, // 317: milvus.proto.data.UnpinSnapshotDataRequest.base:type_name -> milvus.proto.common.MsgBase
	202, // 318: milvus.proto.data.CommitImportRequest.base:type_name -> milvus.proto.common.MsgBase
	202, // 319: milvus.proto.data.AbortImportRequest.base:type_name -> milvus.proto.common.MsgBase
	202, // 320: milvus.proto.data.HandleCommitVchannelRequest.base:type_name -> milvus.proto.common.MsgBase
	206, // 321: milvus.proto.data.FlushResponse.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	206, // 322: milvus.proto.data.FlushResult.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	224, // 323: milvus.proto.data.FlushAllResponse.FlushAllMsgsEntry.value:type_name -> milvus.proto.common.ImmutableMessage
	206, // 324: milvus.proto.data.GetSegmentInfoResponse.ChannelCheckpointEntry.value:type_name -> milvus.proto.msg.MsgPosition
	...
	225, // 330: milvus.proto.data.WatchChannelsRequest.ChannelWalNamesEntry.value:type_name -> milvus.proto.common.WALName
	...
	226, // 355: milvus.proto.data.DataCoord.GetFlushAllState:input_type -> milvus.proto.milvus.GetFlushAllStateRequest
	227, // 356: milvus.proto.data.DataCoord.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	228, // 357: milvus.proto.data.DataCoord.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	229, // 358: milvus.proto.data.DataCoord.ManualCompaction:input_type -> milvus.proto.milvus.ManualCompactionRequest
	230, // 359: milvus.proto.data.DataCoord.GetCompactionState:input_type -> milvus.proto.milvus.GetCompactionStateRequest
	231, // 360: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:input_type -> milvus.proto.milvus.GetCompactionPlansRequest
	...
	232, // 369: milvus.proto.data.DataCoord.CheckHealth:input_type -> milvus.proto.milvus.CheckHealthRequest
	233, // 370: milvus.proto.data.DataCoord.CreateIndex:input_type -> milvus.proto.index.CreateIndexRequest
	234, // 371: milvus.proto.data.DataCoord.AlterIndex:input_type -> milvus.proto.index.AlterIndexRequest
	235, // 372: milvus.proto.data.DataCoord.GetIndexState:input_type -> milvus.proto.index.GetIndexStateRequest
	236, // 373: milvus.proto.data.DataCoord.GetSegmentIndexState:input_type -> milvus.proto.index.GetSegmentIndexStateRequest
	237, // 374: milvus.proto.data.DataCoord.GetIndexInfos:input_type -> milvus.proto.index.GetIndexInfoRequest
	238, // 375: milvus.proto.data.DataCoord.DropIndex:input_type -> milvus.proto.index.DropIndexRequest
	239, // 376: milvus.proto.data.DataCoord.DescribeIndex:input_type -> milvus.proto.index.DescribeIndexRequest
	240, // 377: milvus.proto.data.DataCoord.GetIndexStatistics:input_type -> milvus.proto.index.GetIndexStatisticsRequest
	241, // 378: milvus.proto.data.DataCoord.GetIndexBuildProgress:input_type -> milvus.proto.index.GetIndexBuildProgressRequest
	242, // 379: milvus.proto.data.DataCoord.ListIndexes:input_type -> milvus.proto.index.ListIndexesRequest
	...
	243, // 383: milvus.proto.data.DataCoord.ImportV2:input_type -> milvus.proto.internal.ImportRequestInternal
	244, // 384: milvus.proto.data.DataCoord.GetImportProgress:input_type -> milvus.proto.internal.GetImportProgressRequest
	245, // 385: milvus.proto.data.DataCoord.ListImports:input_type -> milvus.proto.internal.ListImportsRequestInternal
	...
	246, // 404: milvus.proto.data.DataNode.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	247, // 405: milvus.proto.data.DataNode.GetStatisticsChannel:input_type -> milvus.proto.internal.GetStatisticsChannelRequest
	...
	227, // 408: milvus.proto.data.DataNode.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	228, // 409: milvus.proto.data.DataNode.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	...
	248, // 424: milvus.proto.data.DataNode.SyncFileResource:input_type -> milvus.proto.internal.SyncFileResourceRequest
	...
	249, // 434: milvus.proto.data.DataCoord.GetSegmentInfoChannel:output_type -> milvus.proto.milvus.StringResponse
	203, // 435: milvus.proto.data.DataCoord.SaveBinlogPaths:output_type -> milvus.proto.common.Status
	...
	250, // 441: milvus.proto.data.DataCoord.GetFlushAllState:output_type -> milvus.proto.milvus.GetFlushAllStateResponse
	251, // 442: milvus.proto.data.DataCoord.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	252, // 443: milvus.proto.data.DataCoord.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	253, // 444: milvus.proto.data.DataCoord.ManualCompaction:output_type -> milvus.proto.milvus.ManualCompactionResponse
	254, // 445: milvus.proto.data.DataCoord.GetCompactionState:output_type -> milvus.proto.milvus.GetCompactionStateResponse
	255, // 446: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:output_type -> milvus.proto.milvus.GetCompactionPlansResponse
	79,  // 447: milvus.proto.data.DataCoord.WatchChannels:output_type -> milvus.proto.data.WatchChannelsResponse
	256, // 448: milvus.proto.data.DataCoord.GetFlushState:output_type -> milvus.proto.milvus.GetFlushStateResponse
	...
	203, // 451: milvus.proto.data.DataCoord.UpdateSegmentStatistics:output_type -> milvus.proto.common.Status
	203, // 452: milvus.proto.data.DataCoord.UpdateChannelCheckpoint:output_type -> milvus.proto.common.Status
	203, // 453: milvus.proto.data.DataCoord.MarkSegmentsDropped:output_type -> milvus.proto.common.Status
	203, // 454: milvus.proto.data.DataCoord.BroadcastAlteredCollection:output_type -> milvus.proto.common.Status
	257, // 455: milvus.proto.data.DataCoord.CheckHealth:output_type -> milvus.proto.milvus.CheckHealthResponse
	203, // 456: milvus.proto.data.DataCoord.CreateIndex:output_type -> milvus.proto.common.Status
	203, // 457: milvus.proto.data.DataCoord.AlterIndex:output_type -> milvus.proto.common.Status
	258, // 458: milvus.proto.data.DataCoord.GetIndexState:output_type -> milvus.proto.index.GetIndexStateResponse
	259, // 459: milvus.proto.data.DataCoord.GetSegmentIndexState:output_type -> milvus.proto.index.GetSegmentIndexStateResponse
	260, // 460: milvus.proto.data.DataCoord.GetIndexInfos:output_type -> milvus.proto.index.GetIndexInfoResponse
	203, // 461: milvus.proto.data.DataCoord.DropIndex:output_type -> milvus.proto.common.Status
	261, // 462: milvus.proto.data.DataCoord.DescribeIndex:output_type -> milvus.proto.index.DescribeIndexResponse
	262, // 463: milvus.proto.data.DataCoord.GetIndexStatistics:output_type -> milvus.proto.index.GetIndexStatisticsResponse
	263, // 464: milvus.proto.data.DataCoord.GetIndexBuildProgress:output_type -> milvus.proto.index.GetIndexBuildProgressResponse
	264, // 465: milvus.proto.data.DataCoord.ListIndexes:output_type -> milvus.proto.index.ListIndexesResponse
	94,  // 466: milvus.proto.data.DataCoord.GcConfirm:output_type -> milvus.proto.data.GcConfirmResponse
	203, // 467: milvus.proto.data.DataCoord.ReportDataNodeTtMsgs:output_type -> milvus.proto.common.Status
	203, // 468: milvus.proto.data.DataCoord.GcControl:output_type -> milvus.proto.common.Status
	265, // 469: milvus.proto.data.DataCoord.ImportV2:output_type -> milvus.proto.internal.ImportResponse
	266, // 470: milvus.proto.data.DataCoord.GetImportProgress:output_type -> milvus.proto.internal.GetImportProgressResponse
	267, // 471: milvus.proto.data.DataCoord.ListImports:output_type -> milvus.proto.internal.ListImportsResponse
	203, // 472: milvus.proto.data.DataCoord.CreateSnapshot:output_type -> milvus.proto.common.Status
	203, // 473: milvus.proto.data.DataCoord.DropSnapshot:output_type -> milvus.proto.common.Status
	...
	203, // 481: milvus.proto.data.DataCoord.UnpinSnapshotData:output_type -> milvus.proto.common.Status
	203, // 482: milvus.proto.data.DataCoord.BatchUpdateManifest:output_type -> milvus.proto.common.Status
	...
	203, // 487: milvus.proto.data.DataCoord.CommitImport:output_type -> milvus.proto.common.Status
	203, // 488: milvus.proto.data.DataCoord.AbortImport:output_type -> milvus.proto.common.Status
	203, // 489: milvus.proto.data.DataCoord.HandleCommitVchannel:output_type -> milvus.proto.common.Status
	268, // 490: milvus.proto.data.DataNode.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	249, // 491: milvus.proto.data.DataNode.GetStatisticsChannel:output_type -> milvus.proto.milvus.StringResponse
	203, // 492: milvus.proto.data.DataNode.WatchDmChannels:output_type -> milvus.proto.common.Status
	203, // 493: milvus.proto.data.DataNode.FlushSegments:output_type -> milvus.proto.common.Status
	251, // 494: milvus.proto.data.DataNode.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	252, // 495: milvus.proto.data.DataNode.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	203, // 496: milvus.proto.data.DataNode.CompactionV2:output_type -> milvus.proto.common.Status
	76,  // 497: milvus.proto.data.DataNode.GetCompactionState:output_type -> milvus.proto.data.CompactionStateResponse
	203, // 498: milvus.proto.data.DataNode.SyncSegments:output_type -> milvus.proto.common.Status
	88,  // 499: milvus.proto.data.DataNode.ResendSegmentStats:output_type -> milvus.proto.data.ResendSegmentStatsResponse
	203, // 500: milvus.proto.data.DataNode.FlushChannels:output_type -> milvus.proto.common.Status
	203, // 501: milvus.proto.data.DataNode.NotifyChannelOperation:output_type -> milvus.proto.common.Status
	...
	203, // 503: milvus.proto.data.DataNode.PreImport:output_type -> milvus.proto.common.Status
	203, // 504: milvus.proto.data.DataNode.ImportV2:output_type -> milvus.proto.common.Status
	...
	203, // 507: milvus.proto.data.DataNode.DropImport:output_type -> milvus.proto.common.Status
	128, // 508: milvus.proto.data.DataNode.QuerySlot:output_type -> milvus.proto.data.QuerySlotResponse
	203, // 509: milvus.proto.data.DataNode.DropCompactionPlan:output_type -> milvus.proto.common.Status
	203, // 510: milvus.proto.data.DataNode.SyncFileResource:output_type -> milvus.proto.common.Status
