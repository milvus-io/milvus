...
type ManifestSource int32

const (
	ManifestSource_LegacyManifest ManifestSource = 0 // before manifest introduced
	ManifestSource_EtcdManifest   ManifestSource = 1
	ManifestSource_FileManifest   ManifestSource = 2
)

// Enum value maps for ManifestSource.
var (
	ManifestSource_name = map[int32]string{
		0: "LegacyManifest",
		1: "EtcdManifest",
		2: "FileManifest",
	}
	ManifestSource_value = map[string]int32{
		"LegacyManifest": 0,
		"EtcdManifest":   1,
		"FileManifest":   2,
	}
...
func (x ManifestSource) Enum() *ManifestSource {
	p := new(ManifestSource)
	*p = x
	return p
}
...
func (ManifestSource) Descriptor() protoreflect.EnumDescriptor {
	return file_data_coord_proto_enumTypes[2].Descriptor()
}

func (ManifestSource) Type() protoreflect.EnumType {
	return &file_data_coord_proto_enumTypes[2]
}

func (x ManifestSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ManifestSource.Descriptor instead.
func (ManifestSource) EnumDescriptor() ([]byte, []int) {
...
type SegmentInfo struct {
	...
	ManifestSource       ManifestSource `protobuf:"varint,31,opt,name=manifest_source,json=manifestSource,proto3,enum=milvus.proto.data.ManifestSource" json:"manifest_source,omitempty"` // flag indicates storage v2 manifest source.
}
...
func (x *SegmentInfo) GetManifestSource() ManifestSource {
	if x != nil {
		return x.ManifestSource
	}
	return ManifestSource_LegacyManifest
}
...
type SaveBinlogPathsRequest struct {
	...
	ManifestSource      ManifestSource          `protobuf:"varint,18,opt,name=manifest_source,json=manifestSource,proto3,enum=milvus.proto.data.ManifestSource" json:"manifest_source,omitempty"` // storage v2 manifest source
}
...
func (x *SaveBinlogPathsRequest) GetManifestSource() ManifestSource {
	if x != nil {
		return x.ManifestSource
	}
	return ManifestSource_LegacyManifest
...
var file_data_coord_proto_rawDesc = []byte{
	...
	0x6f, 0x52, 0x07, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xda, 0x0d, 0x0a, 0x0b, 0x53,
	...
	0x6d, 0x69, 0x6e, 0x67, 0x12, 0x4a, 0x0a, 0x0f, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74,
	0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e,
	0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x64, 0x61, 0x74,
	0x61, 0x2e, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x52, 0x0e, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x74, 0x49, 0x44, 0x22, 0xb9, 0x07, 0x0a, 0x16, 0x53, 0x61, 0x76, 0x65, 0x42, 0x69, 0x6e, 0x6c,
	0x6f, 0x67, 0x50, 0x61, 0x74, 0x68, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x30,
	0x0a, 0x04, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6d,
	0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x2e, 0x4d, 0x73, 0x67, 0x42, 0x61, 0x73, 0x65, 0x52, 0x04, 0x62, 0x61, 0x73, 0x65,
	...
	0x6f, 0x67, 0x73, 0x12, 0x4a, 0x0a, 0x0f, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x5f,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x6d,
	0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x64, 0x61, 0x74, 0x61,
	0x2e, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52,
	0x0e, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x7f, 0x0a, 0x0b, 0x46, 0x69, 0x65, 0x6c, 0x64,
	...
	0x6c, 0x64, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0xb0, 0x01, 0x0a, 0x0e, 0x54, 0x65, 0x78,
	...
	0x61, 0x67, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xed, 0x08, 0x0a, 0x0e, 0x43,
	...
	0x6c, 0x65, 0x53, 0x6c, 0x6f, 0x74, 0x73, 0x22, 0xa0, 0x09, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x70,
	...
	0x02, 0x4c, 0x32, 0x10, 0x03, 0x2a, 0x48, 0x0a, 0x0e, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73,
	0x74, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x0e, 0x4c, 0x65, 0x67, 0x61, 0x63,
	0x79, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x10, 0x00, 0x12, 0x10, 0x0a, 0x0c, 0x45,
	0x74, 0x63, 0x64, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x10, 0x01, 0x12, 0x10, 0x0a,
	0x0c, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x10, 0x02, 0x2a,
	...
	0x73, 0x65, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x10, 0x07, 0x2a, 0xe1, 0x01, 0x0a, 0x0e,
	...
	0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x10, 0x09, 0x22, 0x04, 0x08, 0x01, 0x10, 0x01, 0x2a,
...
var file_data_coord_proto_goTypes = []interface{}{
	...
	(ManifestSource)(0),                            // 2: milvus.proto.data.ManifestSource
	...
	(*FlushRequest)(nil),                           // 10: milvus.proto.data.FlushRequest
	(*FlushResponse)(nil),                          // 11: milvus.proto.data.FlushResponse
	(*FlushResult)(nil),                            // 12: milvus.proto.data.FlushResult
	(*FlushAllRequest)(nil),                        // 13: milvus.proto.data.FlushAllRequest
...
var file_data_coord_proto_depIdxs = []int32{
	...
	38,  // 8: milvus.proto.data.AllocSegmentResponse.segment_info:type_name -> milvus.proto.data.SegmentInfo
	128, // 9: milvus.proto.data.AllocSegmentResponse.status:type_name -> milvus.proto.common.Status
	16,  // 10: milvus.proto.data.AssignSegmentIDRequest.segmentIDRequests:type_name -> milvus.proto.data.SegmentIDRequest
	128, // 11: milvus.proto.data.SegmentIDAssignment.status:type_name -> milvus.proto.common.Status
	20,  // 12: milvus.proto.data.AssignSegmentIDResponse.segIDAssignments:type_name -> milvus.proto.data.SegmentIDAssignment
	...
	23,  // 20: milvus.proto.data.GetSegmentStatesResponse.states:type_name -> milvus.proto.data.SegmentStateInfo
	...
	38,  // 23: milvus.proto.data.GetSegmentInfoResponse.infos:type_name -> milvus.proto.data.SegmentInfo
	...
	38,  // 35: milvus.proto.data.VchannelInfo.unflushedSegments:type_name -> milvus.proto.data.SegmentInfo
	38,  // 36: milvus.proto.data.VchannelInfo.flushedSegments:type_name -> milvus.proto.data.SegmentInfo
	38,  // 37: milvus.proto.data.VchannelInfo.dropped_segments:type_name -> milvus.proto.data.SegmentInfo
	38,  // 38: milvus.proto.data.VchannelInfo.indexed_segments:type_name -> milvus.proto.data.SegmentInfo
	...
	34,  // 42: milvus.proto.data.WatchDmChannelsRequest.vchannels:type_name -> milvus.proto.data.VchannelInfo
	...
	38,  // 45: milvus.proto.data.SegmentMsg.segment:type_name -> milvus.proto.data.SegmentInfo
	...
	46,  // 49: milvus.proto.data.SegmentInfo.binlogs:type_name -> milvus.proto.data.FieldBinlog
	46,  // 50: milvus.proto.data.SegmentInfo.statslogs:type_name -> milvus.proto.data.FieldBinlog
	46,  // 51: milvus.proto.data.SegmentInfo.deltalogs:type_name -> milvus.proto.data.FieldBinlog
	...
	46,  // 55: milvus.proto.data.SegmentInfo.bm25statslogs:type_name -> milvus.proto.data.FieldBinlog
	120, // 56: milvus.proto.data.SegmentInfo.jsonKeyStats:type_name -> milvus.proto.data.SegmentInfo.JsonKeyStatsEntry
	2,   // 57: milvus.proto.data.SegmentInfo.manifest_source:type_name -> milvus.proto.data.ManifestSource
	130, // 58: milvus.proto.data.SegmentStartPosition.start_position:type_name -> milvus.proto.msg.MsgPosition
	127, // 59: milvus.proto.data.SaveBinlogPathsRequest.base:type_name -> milvus.proto.common.MsgBase
	46,  // 60: milvus.proto.data.SaveBinlogPathsRequest.field2BinlogPaths:type_name -> milvus.proto.data.FieldBinlog
	41,  // 61: milvus.proto.data.SaveBinlogPathsRequest.checkPoints:type_name -> milvus.proto.data.CheckPoint
	39,  // 62: milvus.proto.data.SaveBinlogPathsRequest.start_positions:type_name -> milvus.proto.data.SegmentStartPosition
	46,  // 63: milvus.proto.data.SaveBinlogPathsRequest.field2StatslogPaths:type_name -> milvus.proto.data.FieldBinlog
	46,  // 64: milvus.proto.data.SaveBinlogPathsRequest.deltalogs:type_name -> milvus.proto.data.FieldBinlog
	1,   // 65: milvus.proto.data.SaveBinlogPathsRequest.seg_level:type_name -> milvus.proto.data.SegmentLevel
	46,  // 66: milvus.proto.data.SaveBinlogPathsRequest.field2Bm25logPaths:type_name -> milvus.proto.data.FieldBinlog
	2,   // 67: milvus.proto.data.SaveBinlogPathsRequest.manifest_source:type_name -> milvus.proto.data.ManifestSource
	130, // 68: milvus.proto.data.CheckPoint.position:type_name -> milvus.proto.msg.MsgPosition
	3,   // 69: milvus.proto.data.ChannelStatus.state:type_name -> milvus.proto.data.ChannelWatchState
	...
	3,   // 97: milvus.proto.data.ChannelWatchInfo.state:type_name -> milvus.proto.data.ChannelWatchState
	...
	4,   // 111: milvus.proto.data.CompactionPlan.type:type_name -> milvus.proto.data.CompactionType
	...
	5,   // 179: milvus.proto.data.QueryPreImportResponse.state:type_name -> milvus.proto.data.ImportTaskStateV2
	...
	5,   // 186: milvus.proto.data.QueryImportResponse.state:type_name -> milvus.proto.data.ImportTaskStateV2
	...
	5,   // 192: milvus.proto.data.PreImportTask.state:type_name -> milvus.proto.data.ImportTaskStateV2
	99,  // 193: milvus.proto.data.PreImportTask.file_stats:type_name -> milvus.proto.data.ImportFileStats
	5,   // 194: milvus.proto.data.ImportTaskV2.state:type_name -> milvus.proto.data.ImportTaskStateV2
	99,  // 195: milvus.proto.data.ImportTaskV2.file_stats:type_name -> milvus.proto.data.ImportFileStats
	6,   // 196: milvus.proto.data.ImportTaskV2.source:type_name -> milvus.proto.data.ImportTaskSourceV2
	127, // 197: milvus.proto.data.GcControlRequest.base:type_name -> milvus.proto.common.MsgBase
	7,   // 198: milvus.proto.data.GcControlRequest.command:type_name -> milvus.proto.data.GcCommand
	...
	4,   // 201: milvus.proto.data.CompactionTask.type:type_name -> milvus.proto.data.CompactionType
	8,   // 202: milvus.proto.data.CompactionTask.state:type_name -> milvus.proto.data.CompactionTaskState
	...
	10,  // 217: milvus.proto.data.DataCoord.Flush:input_type -> milvus.proto.data.FlushRequest
	13,  // 218: milvus.proto.data.DataCoord.FlushAll:input_type -> milvus.proto.data.FlushAllRequest
	...
	11,  // 287: milvus.proto.data.DataCoord.Flush:output_type -> milvus.proto.data.FlushResponse
