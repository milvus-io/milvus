...
type SegmentInfo struct {
	...
	// manifest_has_index records that this segment's manifest has carried at
	// least one index entry (written in the same commit as the entry). It is
	// sticky - set-only, never cleared by retraction - so reload can decide
	// which manifests to read without depending on configuration: a false
	// marker proves no entry was ever published, a stale true only costs one
	// extra manifest read at startup. Clearing it wrongly would silently drop
	// indexes, so no writer clears it.
...
type CopySegmentTarget struct {
	...
	TargetIndexes map[string]*CopySegmentTargetIndex `protobuf:"bytes,6,rep,name=target_indexes,json=targetIndexes,proto3" json:"target_indexes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Authoritative row count from the pre-registered target segment. StorageV3
	// bundles omit legacy PB insert binlogs, so it cannot be derived from the
	// copied files.
	NumRows int64 `protobuf:"varint,7,opt,name=num_rows,json=numRows,proto3" json:"num_rows,omitempty"`
	// Index IDs recorded in the SOURCE manifest. The target manifest is copied
	// byte-for-byte, so it inherits these entries, and every one of them encodes
	// the source collection/partition/segment/build IDs in its stored path. The
	// worker retracts exactly these before recording the target's own entries.
	InheritedIndexIds []int64 `protobuf:"varint,8,rep,packed,name=inherited_index_ids,json=inheritedIndexIds,proto3" json:"inherited_index_ids,omitempty"`
}
...
func (x *CopySegmentTarget) GetTargetIndexes() map[string]*CopySegmentTargetIndex {
	if x != nil {
...
func (x *CopySegmentTarget) GetNumRows() int64 {
	if x != nil {
		return x.NumRows
	}
	return 0
...
func (x *CopySegmentTarget) GetInheritedIndexIds() []int64 {
	if x != nil {
		return x.InheritedIndexIds
	}
	return nil
}
...
type CopySegmentTargetIndex struct {
	...
	IndexId    int64             `protobuf:"varint,1,opt,name=index_id,json=indexId,proto3" json:"index_id,omitempty"`         // target collection's index ID
	FieldId    int64             `protobuf:"varint,2,opt,name=field_id,json=fieldId,proto3" json:"field_id,omitempty"`         // target collection's field ID
	ColumnName string            `protobuf:"bytes,3,opt,name=column_name,json=columnName,proto3" json:"column_name,omitempty"` // target collection's schema field name
	IndexType  string            `protobuf:"bytes,4,opt,name=index_type,json=indexType,proto3" json:"index_type,omitempty"`
	Properties map[string]string `protobuf:"bytes,5,rep,name=properties,proto3" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // type params merged with index params
}
...
type SegmentDescription struct {
	...
	// manifest_has_index mirrors SegmentInfo.manifest_has_index: the segment's
	// manifest has carried at least one index entry. It is captured from the
	// same record as manifest_path, and the marker is set in the same catalog
	// transaction as the first entry-carrying revision, so false proves the
	// captured revision holds no index entries and restore can skip reading the
	// manifest for them. A snapshot written before this field existed reads
	// false and is equally safe: its manifest predates index publication.
	ManifestHasIndex bool `protobuf:"varint,19,opt,name=manifest_has_index,json=manifestHasIndex,proto3" json:"manifest_has_index,omitempty"`
}
...
var file_data_coord_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd7,
	0x04, 0x0a, 0x11, 0x43, 0x6f, 0x70, 0x79, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x0a, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x61, 0x73,
	...
	0x73, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x73, 0x18, 0x1e,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x73, 0x22, 0xf6,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x70, 0x6c, 0x61, 0x6e, 0x49, 0x44, 0x22, 0xb9, 0x06, 0x0a,
	0x24, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x30, 0x0a, 0x04, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x73, 0x67, 0x42, 0x61, 0x73,
	...
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x53, 0x70, 0x65, 0x63, 0x12, 0x48, 0x0a, 0x0e, 0x73, 0x74, 0x6f,
	0x72, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x66, 0x69, 0x67, 0x12, 0x3d, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x08, 0x20,
	...
	0x6d, 0x61, 0x12, 0x55, 0x0a, 0x19, 0x70, 0x72, 0x65, 0x5f, 0x61, 0x6c, 0x6c, 0x6f, 0x63, 0x61,
	0x74, 0x65, 0x64, 0x5f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x73, 0x18,
	0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70,
	...
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x12, 0x32, 0x0a, 0x15, 0x6e, 0x75, 0x6d,
	0x5f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x5f, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74,
	0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x13, 0x6e, 0x75, 0x6d, 0x53, 0x65, 0x67,
	0x6d, 0x65, 0x6e, 0x74, 0x73, 0x45, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x12, 0x32, 0x0a,
	0x15, 0x65, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x5f, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73,
	0x74, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x65, 0x78,
	...
	,
	...
	0x66, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xf0, 0x01, 0x0a, 0x20, 0x52,
	...
	0x0c, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x53, 0x70, 0x65, 0x63, 0x22, 0x6f, 0x0a,
	0x21, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x22, 0x76,
	0x0a, 0x2b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x45, 0x78, 0x74, 0x65,
	...
	0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x22, 0xd4, 0x03, 0x0a, 0x1c, 0x45, 0x78, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x66,
	0x72, 0x65, 0x73, 0x68, 0x4a, 0x6f, 0x62, 0x12, 0x15, 0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69,
	...
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x53, 0x70, 0x65, 0x63, 0x12, 0x32, 0x0a, 0x05, 0x73, 0x74,
	...
	,
	...
	0x52, 0x07, 0x6e, 0x75, 0x6d, 0x52, 0x6f, 0x77, 0x73, 0x22, 0xeb, 0x06, 0x0a, 0x1d, 0x45, 0x78,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x17, 0x0a, 0x07, 0x74,
	...
	0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x6e, 0x6f,
	0x64, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6e, 0x6f, 0x64,
	0x65, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01,
	...
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x66, 0x61,
	0x69, 0x6c, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x0f, 0x65, 0x78, 0x74, 0x65,
	...
	0x65, 0x63, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x53, 0x70, 0x65, 0x63, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x12, 0x32, 0x0a, 0x15, 0x65, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x5f, 0x6d, 0x61,
	0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x0c, 0x20, 0x01, 0x28,
	...
	0x6e, 0x64, 0x65, 0x78, 0x5f, 0x62, 0x65, 0x67, 0x69, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x03,
	...
	0x6e, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x6e,
	0x64, 0x65, 0x78, 0x45, 0x6e, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x6b, 0x65, 0x70, 0x74, 0x5f, 0x73,
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0c, 0x6b,
	...
	,
	...
	0x08, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x52, 0x07, 0x6a, 0x6f, 0x62, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x81, 0x01, 0x0a, 0x28, 0x4c, 0x69,
	...
	0x0a, 0x29, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x45, 0x78, 0x74,
	...
	0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x12, 0x43, 0x0a, 0x04, 0x6a, 0x6f, 0x62, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f,
	0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x64, 0x61,
	...
	0x04, 0x6a, 0x6f, 0x62, 0x73, 0x22, 0xe8, 0x01, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x42, 0x0a, 0x1d,
	0x63, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x18, 0x05, 0x20,
	...
	0x22, 0x80, 0x01, 0x0a, 0x13, 0x44, 0x72, 0x6f, 0x70, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f,
	...
	0x6e, 0x49, 0x64, 0x22, 0xa5, 0x01, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x6e, 0x61, 0x70,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x13, 0x0a, 0x05, 0x64, 0x62, 0x5f, 0x69, 0x64, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x64, 0x62, 0x49, 0x64, 0x22, 0x6a, 0x0a, 0x15, 0x4c,
	...
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x6e, 0x61,
	0x70, 0x73, 0x68, 0x6f, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x73, 0x6e,
	0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x73, 0x22, 0xcd, 0x01, 0x0a, 0x15, 0x45, 0x78, 0x70, 0x6f,
	...
	,
	...
	0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x22, 0x91, 0x0a, 0x0a, 0x12, 0x53, 0x65, 0x67, 0x6d, 0x65,
	0x6e, 0x74, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a,
	0x0a, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x09, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c,
	...
	0x44, 0x0a, 0x0d, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x53, 0x65, 0x67, 0x6d, 0x65,
	0x6e, 0x74, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x52, 0x0c, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74,
	0x4c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x68, 0x61,
	0x6e, 0x6e, 0x65, 0x6c, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x38, 0x0a, 0x07, 0x62, 0x69, 0x6e, 0x6c,
	...
	,
	...
	0x6e, 0x64, 0x65, 0x78, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x46, 0x0a, 0x0b, 0x69, 0x6e, 0x64,
	0x65, 0x78, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25,
	0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x69, 0x6e,
	...
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x6e, 0x75, 0x6d, 0x4f, 0x66, 0x52, 0x6f, 0x77,
	0x73, 0x12, 0x44, 0x0a, 0x0e, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6d, 0x69, 0x6c, 0x76,
	0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x4d, 0x73, 0x67,
	...
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e,
	0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x6d, 0x73, 0x67,
	0x2e, 0x4d, 0x73, 0x67, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x64, 0x6d,
	0x6c, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x74, 0x6f,
	...
	,
...
var file_data_coord_proto_msgTypes = make([]protoimpl.MessageInfo, 205)
var file_data_coord_proto_goTypes = []interface{}{
	...
	(*CopySegmentTargetIndex)(nil),                       // 120: milvus.proto.data.CopySegmentTargetIndex
	(*CopySegmentRequest)(nil),                           // 121: milvus.proto.data.CopySegmentRequest
	(*QueryCopySegmentRequest)(nil),                      // 122: milvus.proto.data.QueryCopySegmentRequest
	(*QueryCopySegmentResponse)(nil),                     // 123: milvus.proto.data.QueryCopySegmentResponse
	(*DropCopySegmentRequest)(nil),                       // 124: milvus.proto.data.DropCopySegmentRequest
	(*VectorScalarIndexInfo)(nil),                        // 125: milvus.proto.data.VectorScalarIndexInfo
	(*CopySegmentResult)(nil),                            // 126: milvus.proto.data.CopySegmentResult
	(*CopySegmentTask)(nil),                              // 127: milvus.proto.data.CopySegmentTask
	(*CopySegmentIDMapping)(nil),                         // 128: milvus.proto.data.CopySegmentIDMapping
	(*CopySegmentJob)(nil),                               // 129: milvus.proto.data.CopySegmentJob
	(*ImportJob)(nil),                                    // 130: milvus.proto.data.ImportJob
	(*PreImportTask)(nil),                                // 131: milvus.proto.data.PreImportTask
	(*ImportTaskV2)(nil),                                 // 132: milvus.proto.data.ImportTaskV2
	(*GcControlRequest)(nil),                             // 133: milvus.proto.data.GcControlRequest
	(*GetGcStatusResponse)(nil),                          // 134: milvus.proto.data.GetGcStatusResponse
	(*QuerySlotRequest)(nil),                             // 135: milvus.proto.data.QuerySlotRequest
	(*QuerySlotResponse)(nil),                            // 136: milvus.proto.data.QuerySlotResponse
	(*CompactionTarget)(nil),                             // 137: milvus.proto.data.CompactionTarget
	(*CompactionTask)(nil),                               // 138: milvus.proto.data.CompactionTask
	(*PartitionStatsInfo)(nil),                           // 139: milvus.proto.data.PartitionStatsInfo
	(*DropCompactionPlanRequest)(nil),                    // 140: milvus.proto.data.DropCompactionPlanRequest
	(*RefreshExternalCollectionTaskRequest)(nil),         // 141: milvus.proto.data.RefreshExternalCollectionTaskRequest
	(*RefreshExternalCollectionTaskResponse)(nil),        // 142: milvus.proto.data.RefreshExternalCollectionTaskResponse
	(*RefreshExternalCollectionRequest)(nil),             // 143: milvus.proto.data.RefreshExternalCollectionRequest
	(*RefreshExternalCollectionResponse)(nil),            // 144: milvus.proto.data.RefreshExternalCollectionResponse
	(*GetRefreshExternalCollectionProgressRequest)(nil),  // 145: milvus.proto.data.GetRefreshExternalCollectionProgressRequest
	(*ExternalCollectionRefreshJob)(nil),                 // 146: milvus.proto.data.ExternalCollectionRefreshJob
	(*ExternalFileInfo)(nil),                             // 147: milvus.proto.data.ExternalFileInfo
	(*ExternalCollectionRefreshTask)(nil),                // 148: milvus.proto.data.ExternalCollectionRefreshTask
	(*GetRefreshExternalCollectionProgressResponse)(nil), // 149: milvus.proto.data.GetRefreshExternalCollectionProgressResponse
	(*ListRefreshExternalCollectionJobsRequest)(nil),     // 150: milvus.proto.data.ListRefreshExternalCollectionJobsRequest
	(*ListRefreshExternalCollectionJobsResponse)(nil),    // 151: milvus.proto.data.ListRefreshExternalCollectionJobsResponse
	(*CreateSnapshotRequest)(nil),                        // 152: milvus.proto.data.CreateSnapshotRequest
	(*DropSnapshotRequest)(nil),                          // 153: milvus.proto.data.DropSnapshotRequest
	(*ListSnapshotsRequest)(nil),                         // 154: milvus.proto.data.ListSnapshotsRequest
	(*ListSnapshotsResponse)(nil),                        // 155: milvus.proto.data.ListSnapshotsResponse
	(*ExportSnapshotRequest)(nil),                        // 156: milvus.proto.data.ExportSnapshotRequest
	(*ExportSnapshotResponse)(nil),                       // 157: milvus.proto.data.ExportSnapshotResponse
	(*SegmentDescription)(nil),                           // 158: milvus.proto.data.SegmentDescription
	(*CollectionDescription)(nil),                        // 159: milvus.proto.data.CollectionDescription
	(*SnapshotInfo)(nil),                                 // 160: milvus.proto.data.SnapshotInfo
	(*StorageV2SegmentManifest)(nil),                     // 161: milvus.proto.data.StorageV2SegmentManifest
	(*SnapshotMetadata)(nil),                             // 162: milvus.proto.data.SnapshotMetadata
	(*RestoreSnapshotInfo)(nil),                          // 163: milvus.proto.data.RestoreSnapshotInfo
	(*DescribeSnapshotRequest)(nil),                      // 164: milvus.proto.data.DescribeSnapshotRequest
	(*DescribeSnapshotResponse)(nil),                     // 165: milvus.proto.data.DescribeSnapshotResponse
	(*RestoreSnapshotRequest)(nil),                       // 166: milvus.proto.data.RestoreSnapshotRequest
	(*RestoreSnapshotResponse)(nil),                      // 167: milvus.proto.data.RestoreSnapshotResponse
	(*GetRestoreSnapshotStateRequest)(nil),               // 168: milvus.proto.data.GetRestoreSnapshotStateRequest
	(*GetRestoreSnapshotStateResponse)(nil),              // 169: milvus.proto.data.GetRestoreSnapshotStateResponse
	(*ListRestoreSnapshotJobsRequest)(nil),               // 170: milvus.proto.data.ListRestoreSnapshotJobsRequest
	(*ListRestoreSnapshotJobsResponse)(nil),              // 171: milvus.proto.data.ListRestoreSnapshotJobsResponse
	(*BatchUpdateManifestRequest)(nil),                   // 172: milvus.proto.data.BatchUpdateManifestRequest
	(*BatchUpdateManifestItem)(nil),                      // 173: milvus.proto.data.BatchUpdateManifestItem
	(*CommitBackfillResultRequest)(nil),                  // 174: milvus.proto.data.CommitBackfillResultRequest
	(*CommitBackfillResultSegmentStatus)(nil),            // 175: milvus.proto.data.CommitBackfillResultSegmentStatus
	(*CommitBackfillResultResponse)(nil),                 // 176: milvus.proto.data.CommitBackfillResultResponse
	(*PinSnapshotDataRequest)(nil),                       // 177: milvus.proto.data.PinSnapshotDataRequest
	(*PinSnapshotDataResponse)(nil),                      // 178: milvus.proto.data.PinSnapshotDataResponse
	(*UnpinSnapshotDataRequest)(nil),                     // 179: milvus.proto.data.UnpinSnapshotDataRequest
	(*CommitImportRequest)(nil),                          // 180: milvus.proto.data.CommitImportRequest
	(*AbortImportRequest)(nil),                           // 181: milvus.proto.data.AbortImportRequest
	(*HandleCommitVchannelRequest)(nil),                  // 182: milvus.proto.data.HandleCommitVchannelRequest
	(*ExternalCollectionRefreshTaskResult)(nil),          // 183: milvus.proto.data.ExternalCollectionRefreshTaskResult
	(*ColumnGroupStatistics)(nil),                        // 184: milvus.proto.data.ColumnGroupStatistics
	(*LoadResourceStatistics)(nil),                       // 185: milvus.proto.data.LoadResourceStatistics
	(*ExportSnapshotJob)(nil),                            // 186: milvus.proto.data.ExportSnapshotJob
	(*ExportSnapshotJobInfo)(nil),                        // 187: milvus.proto.data.ExportSnapshotJobInfo
	(*GetExportSnapshotStateRequest)(nil),                // 188: milvus.proto.data.GetExportSnapshotStateRequest
	(*GetExportSnapshotStateResponse)(nil),               // 189: milvus.proto.data.GetExportSnapshotStateResponse
	...
	nil,                                                  // 211: milvus.proto.data.CopySegmentTarget.TargetIndexesEntry
	nil,                                                  // 212: milvus.proto.data.CopySegmentTargetIndex.PropertiesEntry
	nil,                                                  // 213: milvus.proto.data.CopySegmentResult.IndexInfosEntry
	nil,                                                  // 214: milvus.proto.data.CopySegmentResult.TextIndexInfosEntry
	nil,                                                  // 215: milvus.proto.data.CopySegmentResult.JsonKeyIndexInfosEntry
	nil,                                                  // 216: milvus.proto.data.CompactionTarget.PropertiesEntry
	nil,                                                  // 217: milvus.proto.data.SegmentDescription.TextIndexFilesEntry
	nil,                                                  // 218: milvus.proto.data.SegmentDescription.JsonKeyIndexFilesEntry
	nil,                                                  // 219: milvus.proto.data.CollectionDescription.PartitionsEntry
	nil,                                                  // 220: milvus.proto.data.SnapshotInfo.PinExpireAtMsEntry
	(*commonpb.MsgBase)(nil),                             // 221: milvus.proto.common.MsgBase
	(*commonpb.Status)(nil),                              // 222: milvus.proto.common.Status
	(*milvuspb.ClusterInfo)(nil),                         // 223: milvus.proto.milvus.ClusterInfo
	(commonpb.SegmentState)(0),                           // 224: milvus.proto.common.SegmentState
	(*msgpb.MsgPosition)(nil),                            // 225: milvus.proto.msg.MsgPosition
	(*internalpb.StringList)(nil),                        // 226: milvus.proto.internal.StringList
	(*commonpb.KeyValuePair)(nil),                        // 227: milvus.proto.common.KeyValuePair
	(*schemapb.CollectionSchema)(nil),                    // 228: milvus.proto.schema.CollectionSchema
	(*internalpb.FileResourceInfo)(nil),                  // 229: milvus.proto.internal.FileResourceInfo
	(*schemapb.FunctionSchema)(nil),                      // 230: milvus.proto.schema.FunctionSchema
	(*commonpb.KeyDataPair)(nil),                         // 231: milvus.proto.common.KeyDataPair
	(*commonpb.SegmentStats)(nil),                        // 232: milvus.proto.common.SegmentStats
	(*schemapb.FieldSchema)(nil),                         // 233: milvus.proto.schema.FieldSchema
	(*msgpb.DataNodeTtMsg)(nil),                          // 234: milvus.proto.msg.DataNodeTtMsg
	(*internalpb.ImportFile)(nil),                        // 235: milvus.proto.internal.ImportFile
	(*indexpb.StorageConfig)(nil),                        // 236: milvus.proto.index.StorageConfig
	(*indexpb.IndexFilePathInfo)(nil),                    // 237: milvus.proto.index.IndexFilePathInfo
	(indexpb.IndexStorePathVersion)(0),                   // 238: milvus.proto.index.IndexStorePathVersion
	(internalpb.ImportJobState)(0),                       // 239: milvus.proto.internal.ImportJobState
	(indexpb.JobState)(0),                                // 240: milvus.proto.index.JobState
	(commonpb.ConsistencyLevel)(0),                       // 241: milvus.proto.common.ConsistencyLevel
	(*indexpb.IndexInfo)(nil),                            // 242: milvus.proto.index.IndexInfo
	(*commonpb.ImmutableMessage)(nil),                    // 243: milvus.proto.common.ImmutableMessage
	(commonpb.WALName)(0),                                // 244: milvus.proto.common.WALName
	(*milvuspb.GetFlushAllStateRequest)(nil),             // 245: milvus.proto.milvus.GetFlushAllStateRequest
	(*internalpb.ShowConfigurationsRequest)(nil),         // 246: milvus.proto.internal.ShowConfigurationsRequest
	(*milvuspb.GetMetricsRequest)(nil),                   // 247: milvus.proto.milvus.GetMetricsRequest
	(*milvuspb.ManualCompactionRequest)(nil),             // 248: milvus.proto.milvus.ManualCompactionRequest
	(*milvuspb.GetCompactionStateRequest)(nil),           // 249: milvus.proto.milvus.GetCompactionStateRequest
	(*milvuspb.GetCompactionPlansRequest)(nil),           // 250: milvus.proto.milvus.GetCompactionPlansRequest
	(*milvuspb.CheckHealthRequest)(nil),                  // 251: milvus.proto.milvus.CheckHealthRequest
	(*indexpb.CreateIndexRequest)(nil),                   // 252: milvus.proto.index.CreateIndexRequest
	(*indexpb.AlterIndexRequest)(nil),                    // 253: milvus.proto.index.AlterIndexRequest
	(*indexpb.GetIndexStateRequest)(nil),                 // 254: milvus.proto.index.GetIndexStateRequest
	(*indexpb.GetSegmentIndexStateRequest)(nil),          // 255: milvus.proto.index.GetSegmentIndexStateRequest
	(*indexpb.GetIndexInfoRequest)(nil),                  // 256: milvus.proto.index.GetIndexInfoRequest
	(*indexpb.DropIndexRequest)(nil),                     // 257: milvus.proto.index.DropIndexRequest
	(*indexpb.DescribeIndexRequest)(nil),                 // 258: milvus.proto.index.DescribeIndexRequest
	(*indexpb.GetIndexStatisticsRequest)(nil),            // 259: milvus.proto.index.GetIndexStatisticsRequest
	(*indexpb.GetIndexBuildProgressRequest)(nil),         // 260: milvus.proto.index.GetIndexBuildProgressRequest
	(*indexpb.ListIndexesRequest)(nil),                   // 261: milvus.proto.index.ListIndexesRequest
	(*internalpb.ImportRequestInternal)(nil),             // 262: milvus.proto.internal.ImportRequestInternal
	(*internalpb.GetImportProgressRequest)(nil),          // 263: milvus.proto.internal.GetImportProgressRequest
	(*internalpb.ListImportsRequestInternal)(nil),        // 264: milvus.proto.internal.ListImportsRequestInternal
	(*milvuspb.GetComponentStatesRequest)(nil),           // 265: milvus.proto.milvus.GetComponentStatesRequest
	(*internalpb.GetStatisticsChannelRequest)(nil),       // 266: milvus.proto.internal.GetStatisticsChannelRequest
	(*internalpb.SyncFileResourceRequest)(nil),           // 267: milvus.proto.internal.SyncFileResourceRequest
	(*milvuspb.StringResponse)(nil),                      // 268: milvus.proto.milvus.StringResponse
	(*milvuspb.GetFlushAllStateResponse)(nil),            // 269: milvus.proto.milvus.GetFlushAllStateResponse
	(*internalpb.ShowConfigurationsResponse)(nil),        // 270: milvus.proto.internal.ShowConfigurationsResponse
	(*milvuspb.GetMetricsResponse)(nil),                  // 271: milvus.proto.milvus.GetMetricsResponse
	(*milvuspb.ManualCompactionResponse)(nil),            // 272: milvus.proto.milvus.ManualCompactionResponse
	(*milvuspb.GetCompactionStateResponse)(nil),          // 273: milvus.proto.milvus.GetCompactionStateResponse
	(*milvuspb.GetCompactionPlansResponse)(nil),          // 274: milvus.proto.milvus.GetCompactionPlansResponse
	(*milvuspb.GetFlushStateResponse)(nil),               // 275: milvus.proto.milvus.GetFlushStateResponse
	(*milvuspb.CheckHealthResponse)(nil),                 // 276: milvus.proto.milvus.CheckHealthResponse
	(*indexpb.GetIndexStateResponse)(nil),                // 277: milvus.proto.index.GetIndexStateResponse
	(*indexpb.GetSegmentIndexStateResponse)(nil),         // 278: milvus.proto.index.GetSegmentIndexStateResponse
	(*indexpb.GetIndexInfoResponse)(nil),                 // 279: milvus.proto.index.GetIndexInfoResponse
	(*indexpb.DescribeIndexResponse)(nil),                // 280: milvus.proto.index.DescribeIndexResponse
	(*indexpb.GetIndexStatisticsResponse)(nil),           // 281: milvus.proto.index.GetIndexStatisticsResponse
	(*indexpb.GetIndexBuildProgressResponse)(nil),        // 282: milvus.proto.index.GetIndexBuildProgressResponse
	(*indexpb.ListIndexesResponse)(nil),                  // 283: milvus.proto.index.ListIndexesResponse
	(*internalpb.ImportResponse)(nil),                    // 284: milvus.proto.internal.ImportResponse
	(*internalpb.GetImportProgressResponse)(nil),         // 285: milvus.proto.internal.GetImportProgressResponse
	(*internalpb.ListImportsResponse)(nil),               // 286: milvus.proto.internal.ListImportsResponse
	(*milvuspb.ComponentStates)(nil),                     // 287: milvus.proto.milvus.ComponentStates
}
var file_data_coord_proto_depIdxs = []int32{
	221, // 0: milvus.proto.data.FlushRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 1: milvus.proto.data.FlushResponse.status:type_name -> milvus.proto.common.Status
	...
	221, // 4: milvus.proto.data.FlushAllRequest.base:type_name -> milvus.proto.common.MsgBase
	21,  // 5: milvus.proto.data.FlushAllRequest.flush_targets:type_name -> milvus.proto.data.FlushAllTarget
	222, // 6: milvus.proto.data.FlushAllResponse.status:type_name -> milvus.proto.common.Status
	...
	223, // 9: milvus.proto.data.FlushAllResponse.cluster_info:type_name -> milvus.proto.milvus.ClusterInfo
	221, // 10: milvus.proto.data.FlushChannelsRequest.base:type_name -> milvus.proto.common.MsgBase
	...
	222, // 13: milvus.proto.data.AllocSegmentResponse.status:type_name -> milvus.proto.common.Status
	24,  // 14: milvus.proto.data.AssignSegmentIDRequest.segmentIDRequests:type_name -> milvus.proto.data.SegmentIDRequest
	222, // 15: milvus.proto.data.SegmentIDAssignment.status:type_name -> milvus.proto.common.Status
	28,  // 16: milvus.proto.data.AssignSegmentIDResponse.segIDAssignments:type_name -> milvus.proto.data.SegmentIDAssignment
	222, // 17: milvus.proto.data.AssignSegmentIDResponse.status:type_name -> milvus.proto.common.Status
	221, // 18: milvus.proto.data.GetSegmentStatesRequest.base:type_name -> milvus.proto.common.MsgBase
	224, // 19: milvus.proto.data.SegmentStateInfo.state:type_name -> milvus.proto.common.SegmentState
	225, // 20: milvus.proto.data.SegmentStateInfo.start_position:type_name -> milvus.proto.msg.MsgPosition
	225, // 21: milvus.proto.data.SegmentStateInfo.end_position:type_name -> milvus.proto.msg.MsgPosition
	222, // 22: milvus.proto.data.SegmentStateInfo.status:type_name -> milvus.proto.common.Status
	222, // 23: milvus.proto.data.GetSegmentStatesResponse.status:type_name -> milvus.proto.common.Status
	31,  // 24: milvus.proto.data.GetSegmentStatesResponse.states:type_name -> milvus.proto.data.SegmentStateInfo
	221, // 25: milvus.proto.data.GetSegmentInfoRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 26: milvus.proto.data.GetSegmentInfoResponse.status:type_name -> milvus.proto.common.Status
	...
	221, // 29: milvus.proto.data.GetInsertBinlogPathsRequest.base:type_name -> milvus.proto.common.MsgBase
	226, // 30: milvus.proto.data.GetInsertBinlogPathsResponse.paths:type_name -> milvus.proto.internal.StringList
	222, // 31: milvus.proto.data.GetInsertBinlogPathsResponse.status:type_name -> milvus.proto.common.Status
	221, // 32: milvus.proto.data.GetCollectionStatisticsRequest.base:type_name -> milvus.proto.common.MsgBase
	227, // 33: milvus.proto.data.GetCollectionStatisticsResponse.stats:type_name -> milvus.proto.common.KeyValuePair
	222, // 34: milvus.proto.data.GetCollectionStatisticsResponse.status:type_name -> milvus.proto.common.Status
	221, // 35: milvus.proto.data.GetPartitionStatisticsRequest.base:type_name -> milvus.proto.common.MsgBase
	227, // 36: milvus.proto.data.GetPartitionStatisticsResponse.stats:type_name -> milvus.proto.common.KeyValuePair
	222, // 37: milvus.proto.data.GetPartitionStatisticsResponse.status:type_name -> milvus.proto.common.Status
	225, // 38: milvus.proto.data.VchannelInfo.seek_position:type_name -> milvus.proto.msg.MsgPosition
	...
	225, // 44: milvus.proto.data.VchannelInfo.delete_checkpoint:type_name -> milvus.proto.msg.MsgPosition
	221, // 45: milvus.proto.data.WatchDmChannelsRequest.base:type_name -> milvus.proto.common.MsgBase
	42,  // 46: milvus.proto.data.WatchDmChannelsRequest.vchannels:type_name -> milvus.proto.data.VchannelInfo
	221, // 47: milvus.proto.data.FlushSegmentsRequest.base:type_name -> milvus.proto.common.MsgBase
	221, // 48: milvus.proto.data.SegmentMsg.base:type_name -> milvus.proto.common.MsgBase
	46,  // 49: milvus.proto.data.SegmentMsg.segment:type_name -> milvus.proto.data.SegmentInfo
	224, // 50: milvus.proto.data.SegmentInfo.state:type_name -> milvus.proto.common.SegmentState
	225, // 51: milvus.proto.data.SegmentInfo.start_position:type_name -> milvus.proto.msg.MsgPosition
	225, // 52: milvus.proto.data.SegmentInfo.dml_position:type_name -> milvus.proto.msg.MsgPosition
	...
	185, // 63: milvus.proto.data.Statistics.load_resource:type_name -> milvus.proto.data.LoadResourceStatistics
	225, // 64: milvus.proto.data.SegmentStartPosition.start_position:type_name -> milvus.proto.msg.MsgPosition
	221, // 65: milvus.proto.data.SaveBinlogPathsRequest.base:type_name -> milvus.proto.common.MsgBase
	...
	225, // 74: milvus.proto.data.CheckPoint.position:type_name -> milvus.proto.msg.MsgPosition
	...
	222, // 83: milvus.proto.data.GetRecoveryInfoResponse.status:type_name -> milvus.proto.common.Status
	...
	221, // 86: milvus.proto.data.GetRecoveryInfoRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 87: milvus.proto.data.GetRecoveryInfoResponseV2.status:type_name -> milvus.proto.common.Status
	...
	221, // 90: milvus.proto.data.GetRecoveryInfoRequestV2.base:type_name -> milvus.proto.common.MsgBase
	221, // 91: milvus.proto.data.GetChannelRecoveryInfoRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 92: milvus.proto.data.GetChannelRecoveryInfoResponse.status:type_name -> milvus.proto.common.Status
	42,  // 93: milvus.proto.data.GetChannelRecoveryInfoResponse.info:type_name -> milvus.proto.data.VchannelInfo
	228, // 94: milvus.proto.data.GetChannelRecoveryInfoResponse.schema:type_name -> milvus.proto.schema.CollectionSchema
	...
	221, // 96: milvus.proto.data.GetSegmentsByStatesRequest.base:type_name -> milvus.proto.common.MsgBase
	224, // 97: milvus.proto.data.GetSegmentsByStatesRequest.states:type_name -> milvus.proto.common.SegmentState
	222, // 98: milvus.proto.data.GetSegmentsByStatesResponse.status:type_name -> milvus.proto.common.Status
	221, // 99: milvus.proto.data.GetFlushedSegmentsRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 100: milvus.proto.data.GetFlushedSegmentsResponse.status:type_name -> milvus.proto.common.Status
	221, // 101: milvus.proto.data.SegmentFlushCompletedMsg.base:type_name -> milvus.proto.common.MsgBase
	...
	228, // 105: milvus.proto.data.ChannelWatchInfo.schema:type_name -> milvus.proto.schema.CollectionSchema
	227, // 106: milvus.proto.data.ChannelWatchInfo.dbProperties:type_name -> milvus.proto.common.KeyValuePair
	221, // 107: milvus.proto.data.CompactionStateRequest.base:type_name -> milvus.proto.common.MsgBase
	55,  // 108: milvus.proto.data.SyncSegmentInfo.pk_stats_log:type_name -> milvus.proto.data.FieldBinlog
	224, // 109: milvus.proto.data.SyncSegmentInfo.state:type_name -> milvus.proto.common.SegmentState
	...
	228, // 119: milvus.proto.data.CompactionPlan.schema:type_name -> milvus.proto.schema.CollectionSchema
	...
	227, // 122: milvus.proto.data.CompactionPlan.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	229, // 123: milvus.proto.data.CompactionPlan.file_resources:type_name -> milvus.proto.internal.FileResourceInfo
	230, // 124: milvus.proto.data.CompactionPlan.functions:type_name -> milvus.proto.schema.FunctionSchema
	...
	222, // 140: milvus.proto.data.CompactionStateResponse.status:type_name -> milvus.proto.common.Status
	82,  // 141: milvus.proto.data.CompactionStateResponse.results:type_name -> milvus.proto.data.CompactionPlanResult
	231, // 142: milvus.proto.data.WatchChannelsRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	228, // 143: milvus.proto.data.WatchChannelsRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	227, // 144: milvus.proto.data.WatchChannelsRequest.db_properties:type_name -> milvus.proto.common.KeyValuePair
	204, // 145: milvus.proto.data.WatchChannelsRequest.channel_wal_names:type_name -> milvus.proto.data.WatchChannelsRequest.ChannelWalNamesEntry
	222, // 146: milvus.proto.data.WatchChannelsResponse.status:type_name -> milvus.proto.common.Status
	221, // 147: milvus.proto.data.SetSegmentStateRequest.base:type_name -> milvus.proto.common.MsgBase
	224, // 148: milvus.proto.data.SetSegmentStateRequest.new_state:type_name -> milvus.proto.common.SegmentState
	222, // 149: milvus.proto.data.SetSegmentStateResponse.status:type_name -> milvus.proto.common.Status
	221, // 150: milvus.proto.data.DropVirtualChannelRequest.base:type_name -> milvus.proto.common.MsgBase
	...
	225, // 155: milvus.proto.data.DropVirtualChannelSegment.startPosition:type_name -> milvus.proto.msg.MsgPosition
	225, // 156: milvus.proto.data.DropVirtualChannelSegment.checkPoint:type_name -> milvus.proto.msg.MsgPosition
	222, // 157: milvus.proto.data.DropVirtualChannelResponse.status:type_name -> milvus.proto.common.Status
	221, // 158: milvus.proto.data.UpdateSegmentStatisticsRequest.base:type_name -> milvus.proto.common.MsgBase
	232, // 159: milvus.proto.data.UpdateSegmentStatisticsRequest.stats:type_name -> milvus.proto.common.SegmentStats
	221, // 160: milvus.proto.data.UpdateChannelCheckpointRequest.base:type_name -> milvus.proto.common.MsgBase
	225, // 161: milvus.proto.data.UpdateChannelCheckpointRequest.position:type_name -> milvus.proto.msg.MsgPosition
	225, // 162: milvus.proto.data.UpdateChannelCheckpointRequest.channel_checkpoints:type_name -> milvus.proto.msg.MsgPosition
	221, // 163: milvus.proto.data.ResendSegmentStatsRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 164: milvus.proto.data.ResendSegmentStatsResponse.status:type_name -> milvus.proto.common.Status
	221, // 165: milvus.proto.data.MarkSegmentsDroppedRequest.base:type_name -> milvus.proto.common.MsgBase
	228, // 166: milvus.proto.data.AlterCollectionRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	231, // 167: milvus.proto.data.AlterCollectionRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	227, // 168: milvus.proto.data.AlterCollectionRequest.properties:type_name -> milvus.proto.common.KeyValuePair
	233, // 169: milvus.proto.data.AddCollectionFieldRequest.field_schema:type_name -> milvus.proto.schema.FieldSchema
	228, // 170: milvus.proto.data.AddCollectionFieldRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	231, // 171: milvus.proto.data.AddCollectionFieldRequest.start_positions:type_name -> milvus.proto.common.KeyDataPair
	227, // 172: milvus.proto.data.AddCollectionFieldRequest.properties:type_name -> milvus.proto.common.KeyValuePair
	222, // 173: milvus.proto.data.GcConfirmResponse.status:type_name -> milvus.proto.common.Status
	221, // 174: milvus.proto.data.ReportDataNodeTtMsgsRequest.base:type_name -> milvus.proto.common.MsgBase
	234, // 175: milvus.proto.data.ReportDataNodeTtMsgsRequest.msgs:type_name -> milvus.proto.msg.DataNodeTtMsg
	71,  // 176: milvus.proto.data.ChannelOperationsRequest.infos:type_name -> milvus.proto.data.ChannelWatchInfo
	222, // 177: milvus.proto.data.ChannelOperationProgressResponse.status:type_name -> milvus.proto.common.Status
	2,   // 178: milvus.proto.data.ChannelOperationProgressResponse.state:type_name -> milvus.proto.data.ChannelWatchState
	228, // 179: milvus.proto.data.PreImportRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	235, // 180: milvus.proto.data.PreImportRequest.import_files:type_name -> milvus.proto.internal.ImportFile
	227, // 181: milvus.proto.data.PreImportRequest.options:type_name -> milvus.proto.common.KeyValuePair
	236, // 182: milvus.proto.data.PreImportRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	227, // 183: milvus.proto.data.PreImportRequest.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	228, // 184: milvus.proto.data.ImportRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	235, // 185: milvus.proto.data.ImportRequest.files:type_name -> milvus.proto.internal.ImportFile
	227, // 186: milvus.proto.data.ImportRequest.options:type_name -> milvus.proto.common.KeyValuePair
	...
	236, // 189: milvus.proto.data.ImportRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	227, // 190: milvus.proto.data.ImportRequest.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	205, // 191: milvus.proto.data.PartitionImportStats.partition_rows:type_name -> milvus.proto.data.PartitionImportStats.PartitionRowsEntry
	206, // 192: milvus.proto.data.PartitionImportStats.partition_data_size:type_name -> milvus.proto.data.PartitionImportStats.PartitionDataSizeEntry
	235, // 193: milvus.proto.data.ImportFileStats.import_file:type_name -> milvus.proto.internal.ImportFile
	207, // 194: milvus.proto.data.ImportFileStats.hashed_stats:type_name -> milvus.proto.data.ImportFileStats.HashedStatsEntry
	222, // 195: milvus.proto.data.QueryPreImportResponse.status:type_name -> milvus.proto.common.Status
	...
	222, // 203: milvus.proto.data.QueryImportResponse.status:type_name -> milvus.proto.common.Status
	...
	237, // 209: milvus.proto.data.CopySegmentSource.index_files:type_name -> milvus.proto.index.IndexFilePathInfo
	55,  // 210: milvus.proto.data.CopySegmentSource.bm25_binlogs:type_name -> milvus.proto.data.FieldBinlog
	208, // 211: milvus.proto.data.CopySegmentSource.text_index_files:type_name -> milvus.proto.data.CopySegmentSource.TextIndexFilesEntry
	209, // 212: milvus.proto.data.CopySegmentSource.json_key_index_files:type_name -> milvus.proto.data.CopySegmentSource.JsonKeyIndexFilesEntry
	210, // 213: milvus.proto.data.CopySegmentTarget.new_build_ids:type_name -> milvus.proto.data.CopySegmentTarget.NewBuildIdsEntry
	211, // 214: milvus.proto.data.CopySegmentTarget.target_indexes:type_name -> milvus.proto.data.CopySegmentTarget.TargetIndexesEntry
	212, // 215: milvus.proto.data.CopySegmentTargetIndex.properties:type_name -> milvus.proto.data.CopySegmentTargetIndex.PropertiesEntry
	...
	236, // 218: milvus.proto.data.CopySegmentRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	222, // 219: milvus.proto.data.QueryCopySegmentResponse.status:type_name -> milvus.proto.common.Status
	5,   // 220: milvus.proto.data.QueryCopySegmentResponse.state:type_name -> milvus.proto.data.CopySegmentTaskState
	126, // 221: milvus.proto.data.QueryCopySegmentResponse.segment_results:type_name -> milvus.proto.data.CopySegmentResult
	238, // 222: milvus.proto.data.VectorScalarIndexInfo.index_store_path_version:type_name -> milvus.proto.index.IndexStorePathVersion
	55,  // 223: milvus.proto.data.CopySegmentResult.binlogs:type_name -> milvus.proto.data.FieldBinlog
	55,  // 224: milvus.proto.data.CopySegmentResult.statslogs:type_name -> milvus.proto.data.FieldBinlog
	55,  // 225: milvus.proto.data.CopySegmentResult.deltalogs:type_name -> milvus.proto.data.FieldBinlog
	55,  // 226: milvus.proto.data.CopySegmentResult.bm25logs:type_name -> milvus.proto.data.FieldBinlog
	213, // 227: milvus.proto.data.CopySegmentResult.index_infos:type_name -> milvus.proto.data.CopySegmentResult.IndexInfosEntry
	214, // 228: milvus.proto.data.CopySegmentResult.text_index_infos:type_name -> milvus.proto.data.CopySegmentResult.TextIndexInfosEntry
	215, // 229: milvus.proto.data.CopySegmentResult.json_key_index_infos:type_name -> milvus.proto.data.CopySegmentResult.JsonKeyIndexInfosEntry
	5,   // 230: milvus.proto.data.CopySegmentTask.state:type_name -> milvus.proto.data.CopySegmentTaskState
	128, // 231: milvus.proto.data.CopySegmentTask.id_mappings:type_name -> milvus.proto.data.CopySegmentIDMapping
	4,   // 232: milvus.proto.data.CopySegmentJob.state:type_name -> milvus.proto.data.CopySegmentJobState
	128, // 233: milvus.proto.data.CopySegmentJob.id_mappings:type_name -> milvus.proto.data.CopySegmentIDMapping
	227, // 234: milvus.proto.data.CopySegmentJob.options:type_name -> milvus.proto.common.KeyValuePair
	228, // 235: milvus.proto.data.ImportJob.schema:type_name -> milvus.proto.schema.CollectionSchema
	239, // 236: milvus.proto.data.ImportJob.state:type_name -> milvus.proto.internal.ImportJobState
	235, // 237: milvus.proto.data.ImportJob.files:type_name -> milvus.proto.internal.ImportFile
	227, // 238: milvus.proto.data.ImportJob.options:type_name -> milvus.proto.common.KeyValuePair
	8,   // 239: milvus.proto.data.PreImportTask.state:type_name -> milvus.proto.data.ImportTaskStateV2
	112, // 240: milvus.proto.data.PreImportTask.file_stats:type_name -> milvus.proto.data.ImportFileStats
	8,   // 241: milvus.proto.data.ImportTaskV2.state:type_name -> milvus.proto.data.ImportTaskStateV2
	112, // 242: milvus.proto.data.ImportTaskV2.file_stats:type_name -> milvus.proto.data.ImportFileStats
	9,   // 243: milvus.proto.data.ImportTaskV2.source:type_name -> milvus.proto.data.ImportTaskSourceV2
	221, // 244: milvus.proto.data.GcControlRequest.base:type_name -> milvus.proto.common.MsgBase
	10,  // 245: milvus.proto.data.GcControlRequest.command:type_name -> milvus.proto.data.GcCommand
	227, // 246: milvus.proto.data.GcControlRequest.params:type_name -> milvus.proto.common.KeyValuePair
	222, // 247: milvus.proto.data.QuerySlotResponse.status:type_name -> milvus.proto.common.Status
	13,  // 248: milvus.proto.data.CompactionTarget.intent:type_name -> milvus.proto.data.TargetIntent
	216, // 249: milvus.proto.data.CompactionTarget.properties:type_name -> milvus.proto.data.CompactionTarget.PropertiesEntry
	12,  // 250: milvus.proto.data.CompactionTarget.state:type_name -> milvus.proto.data.TargetState
	3,   // 251: milvus.proto.data.CompactionTask.type:type_name -> milvus.proto.data.CompactionType
	11,  // 252: milvus.proto.data.CompactionTask.state:type_name -> milvus.proto.data.CompactionTaskState
	225, // 253: milvus.proto.data.CompactionTask.pos:type_name -> milvus.proto.msg.MsgPosition
	228, // 254: milvus.proto.data.CompactionTask.schema:type_name -> milvus.proto.schema.CollectionSchema
	233, // 255: milvus.proto.data.CompactionTask.clustering_key_field:type_name -> milvus.proto.schema.FieldSchema
	107, // 256: milvus.proto.data.CompactionTask.pre_allocated_segmentIDs:type_name -> milvus.proto.data.IDRange
	230, // 257: milvus.proto.data.CompactionTask.diff_functions:type_name -> milvus.proto.schema.FunctionSchema
	221, // 258: milvus.proto.data.RefreshExternalCollectionTaskRequest.base:type_name -> milvus.proto.common.MsgBase
	46,  // 259: milvus.proto.data.RefreshExternalCollectionTaskRequest.currentSegments:type_name -> milvus.proto.data.SegmentInfo
	236, // 260: milvus.proto.data.RefreshExternalCollectionTaskRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	228, // 261: milvus.proto.data.RefreshExternalCollectionTaskRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	107, // 262: milvus.proto.data.RefreshExternalCollectionTaskRequest.pre_allocated_segment_ids:type_name -> milvus.proto.data.IDRange
	222, // 263: milvus.proto.data.RefreshExternalCollectionTaskResponse.status:type_name -> milvus.proto.common.Status
	46,  // 264: milvus.proto.data.RefreshExternalCollectionTaskResponse.updatedSegments:type_name -> milvus.proto.data.SegmentInfo
	240, // 265: milvus.proto.data.RefreshExternalCollectionTaskResponse.state:type_name -> milvus.proto.index.JobState
	221, // 266: milvus.proto.data.RefreshExternalCollectionRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 267: milvus.proto.data.RefreshExternalCollectionResponse.status:type_name -> milvus.proto.common.Status
	221, // 268: milvus.proto.data.GetRefreshExternalCollectionProgressRequest.base:type_name -> milvus.proto.common.MsgBase
	240, // 269: milvus.proto.data.ExternalCollectionRefreshJob.state:type_name -> milvus.proto.index.JobState
	240, // 270: milvus.proto.data.ExternalCollectionRefreshTask.state:type_name -> milvus.proto.index.JobState
	46,  // 271: milvus.proto.data.ExternalCollectionRefreshTask.updated_segments:type_name -> milvus.proto.data.SegmentInfo
	222, // 272: milvus.proto.data.GetRefreshExternalCollectionProgressResponse.status:type_name -> milvus.proto.common.Status
	146, // 273: milvus.proto.data.GetRefreshExternalCollectionProgressResponse.job_info:type_name -> milvus.proto.data.ExternalCollectionRefreshJob
	221, // 274: milvus.proto.data.ListRefreshExternalCollectionJobsRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 275: milvus.proto.data.ListRefreshExternalCollectionJobsResponse.status:type_name -> milvus.proto.common.Status
	146, // 276: milvus.proto.data.ListRefreshExternalCollectionJobsResponse.jobs:type_name -> milvus.proto.data.ExternalCollectionRefreshJob
	221, // 277: milvus.proto.data.CreateSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	221, // 278: milvus.proto.data.DropSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	221, // 279: milvus.proto.data.ListSnapshotsRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 280: milvus.proto.data.ListSnapshotsResponse.status:type_name -> milvus.proto.common.Status
	221, // 281: milvus.proto.data.ExportSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 282: milvus.proto.data.ExportSnapshotResponse.status:type_name -> milvus.proto.common.Status
	1,   // 283: milvus.proto.data.SegmentDescription.segment_level:type_name -> milvus.proto.data.SegmentLevel
	55,  // 284: milvus.proto.data.SegmentDescription.binlogs:type_name -> milvus.proto.data.FieldBinlog
	55,  // 285: milvus.proto.data.SegmentDescription.deltalogs:type_name -> milvus.proto.data.FieldBinlog
	55,  // 286: milvus.proto.data.SegmentDescription.statslogs:type_name -> milvus.proto.data.FieldBinlog
	55,  // 287: milvus.proto.data.SegmentDescription.bm25_statslogs:type_name -> milvus.proto.data.FieldBinlog
	217, // 288: milvus.proto.data.SegmentDescription.text_index_files:type_name -> milvus.proto.data.SegmentDescription.TextIndexFilesEntry
	218, // 289: milvus.proto.data.SegmentDescription.json_key_index_files:type_name -> milvus.proto.data.SegmentDescription.JsonKeyIndexFilesEntry
	237, // 290: milvus.proto.data.SegmentDescription.index_files:type_name -> milvus.proto.index.IndexFilePathInfo
	225, // 291: milvus.proto.data.SegmentDescription.start_position:type_name -> milvus.proto.msg.MsgPosition
	225, // 292: milvus.proto.data.SegmentDescription.dml_position:type_name -> milvus.proto.msg.MsgPosition
	228, // 293: milvus.proto.data.CollectionDescription.schema:type_name -> milvus.proto.schema.CollectionSchema
	241, // 294: milvus.proto.data.CollectionDescription.consistency_level:type_name -> milvus.proto.common.ConsistencyLevel
	227, // 295: milvus.proto.data.CollectionDescription.properties:type_name -> milvus.proto.common.KeyValuePair
	219, // 296: milvus.proto.data.CollectionDescription.partitions:type_name -> milvus.proto.data.CollectionDescription.PartitionsEntry
	6,   // 297: milvus.proto.data.SnapshotInfo.state:type_name -> milvus.proto.data.SnapshotState
	220, // 298: milvus.proto.data.SnapshotInfo.pin_expire_at_ms:type_name -> milvus.proto.data.SnapshotInfo.PinExpireAtMsEntry
	225, // 299: milvus.proto.data.SnapshotInfo.channel_seek_positions:type_name -> milvus.proto.msg.MsgPosition
	160, // 300: milvus.proto.data.SnapshotMetadata.snapshot_info:type_name -> milvus.proto.data.SnapshotInfo
	159, // 301: milvus.proto.data.SnapshotMetadata.collection:type_name -> milvus.proto.data.CollectionDescription
	242, // 302: milvus.proto.data.SnapshotMetadata.indexes:type_name -> milvus.proto.index.IndexInfo
	161, // 303: milvus.proto.data.SnapshotMetadata.storagev2_manifest_list:type_name -> milvus.proto.data.StorageV2SegmentManifest
	14,  // 304: milvus.proto.data.SnapshotMetadata.layout:type_name -> milvus.proto.data.SnapshotLayout
	7,   // 305: milvus.proto.data.RestoreSnapshotInfo.state:type_name -> milvus.proto.data.RestoreSnapshotState
	221, // 306: milvus.proto.data.DescribeSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 307: milvus.proto.data.DescribeSnapshotResponse.status:type_name -> milvus.proto.common.Status
	160, // 308: milvus.proto.data.DescribeSnapshotResponse.snapshot_info:type_name -> milvus.proto.data.SnapshotInfo
	159, // 309: milvus.proto.data.DescribeSnapshotResponse.collection_info:type_name -> milvus.proto.data.CollectionDescription
	242, // 310: milvus.proto.data.DescribeSnapshotResponse.index_infos:type_name -> milvus.proto.index.IndexInfo
	221, // 311: milvus.proto.data.RestoreSnapshotRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 312: milvus.proto.data.RestoreSnapshotResponse.status:type_name -> milvus.proto.common.Status
	221, // 313: milvus.proto.data.GetRestoreSnapshotStateRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 314: milvus.proto.data.GetRestoreSnapshotStateResponse.status:type_name -> milvus.proto.common.Status
	163, // 315: milvus.proto.data.GetRestoreSnapshotStateResponse.info:type_name -> milvus.proto.data.RestoreSnapshotInfo
	221, // 316: milvus.proto.data.ListRestoreSnapshotJobsRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 317: milvus.proto.data.ListRestoreSnapshotJobsResponse.status:type_name -> milvus.proto.common.Status
	163, // 318: milvus.proto.data.ListRestoreSnapshotJobsResponse.jobs:type_name -> milvus.proto.data.RestoreSnapshotInfo
	221, // 319: milvus.proto.data.BatchUpdateManifestRequest.base:type_name -> milvus.proto.common.MsgBase
	173, // 320: milvus.proto.data.BatchUpdateManifestRequest.items:type_name -> milvus.proto.data.BatchUpdateManifestItem
	221, // 321: milvus.proto.data.CommitBackfillResultRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 322: milvus.proto.data.CommitBackfillResultResponse.status:type_name -> milvus.proto.common.Status
	175, // 323: milvus.proto.data.CommitBackfillResultResponse.segment_statuses:type_name -> milvus.proto.data.CommitBackfillResultSegmentStatus
	221, // 324: milvus.proto.data.PinSnapshotDataRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 325: milvus.proto.data.PinSnapshotDataResponse.status:type_name -> milvus.proto.common.Status
	221, // 326: milvus.proto.data.UnpinSnapshotDataRequest.base:type_name -> milvus.proto.common.MsgBase
	221, // 327: milvus.proto.data.CommitImportRequest.base:type_name -> milvus.proto.common.MsgBase
	221, // 328: milvus.proto.data.AbortImportRequest.base:type_name -> milvus.proto.common.MsgBase
	221, // 329: milvus.proto.data.HandleCommitVchannelRequest.base:type_name -> milvus.proto.common.MsgBase
	46,  // 330: milvus.proto.data.ExternalCollectionRefreshTaskResult.updated_segments:type_name -> milvus.proto.data.SegmentInfo
	184, // 331: milvus.proto.data.LoadResourceStatistics.column_groups:type_name -> milvus.proto.data.ColumnGroupStatistics
	15,  // 332: milvus.proto.data.ExportSnapshotJob.state:type_name -> milvus.proto.data.ExportSnapshotJobState
	15,  // 333: milvus.proto.data.ExportSnapshotJobInfo.state:type_name -> milvus.proto.data.ExportSnapshotJobState
	221, // 334: milvus.proto.data.GetExportSnapshotStateRequest.base:type_name -> milvus.proto.common.MsgBase
	222, // 335: milvus.proto.data.GetExportSnapshotStateResponse.status:type_name -> milvus.proto.common.Status
	187, // 336: milvus.proto.data.GetExportSnapshotStateResponse.info:type_name -> milvus.proto.data.ExportSnapshotJobInfo
	225, // 337: milvus.proto.data.FlushResponse.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	225, // 338: milvus.proto.data.FlushResult.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	243, // 339: milvus.proto.data.FlushAllResponse.FlushAllMsgsEntry.value:type_name -> milvus.proto.common.ImmutableMessage
	225, // 340: milvus.proto.data.GetSegmentInfoResponse.ChannelCheckpointEntry.value:type_name -> milvus.proto.msg.MsgPosition
	56,  // 341: milvus.proto.data.SegmentInfo.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	57,  // 342: milvus.proto.data.SegmentInfo.JsonKeyStatsEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	56,  // 343: milvus.proto.data.SegmentBinlogs.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	73,  // 344: milvus.proto.data.SyncSegmentsRequest.SegmentInfosEntry.value:type_name -> milvus.proto.data.SyncSegmentInfo
	56,  // 345: milvus.proto.data.CompactionSegment.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	244, // 346: milvus.proto.data.WatchChannelsRequest.ChannelWalNamesEntry.value:type_name -> milvus.proto.common.WALName
	111, // 347: milvus.proto.data.ImportFileStats.HashedStatsEntry.value:type_name -> milvus.proto.data.PartitionImportStats
	56,  // 348: milvus.proto.data.CopySegmentSource.TextIndexFilesEntry.value:type_name -> milvus.proto.data.TextIndexStats
	57,  // 349: milvus.proto.data.CopySegmentSource.JsonKeyIndexFilesEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	120, // 350: milvus.proto.data.CopySegmentTarget.TargetIndexesEntry.value:type_name -> milvus.proto.data.CopySegmentTargetIndex
	125, // 351: milvus.proto.data.CopySegmentResult.IndexInfosEntry.value:type_name -> milvus.proto.data.VectorScalarIndexInfo
	56,  // 352: milvus.proto.data.CopySegmentResult.TextIndexInfosEntry.value:type_name -> milvus.proto.data.TextIndexStats
	57,  // 353: milvus.proto.data.CopySegmentResult.JsonKeyIndexInfosEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	56,  // 354: milvus.proto.data.SegmentDescription.TextIndexFilesEntry.value:type_name -> milvus.proto.data.TextIndexStats
	57,  // 355: milvus.proto.data.SegmentDescription.JsonKeyIndexFilesEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	17,  // 356: milvus.proto.data.DataCoord.Flush:input_type -> milvus.proto.data.FlushRequest
	20,  // 357: milvus.proto.data.DataCoord.FlushAll:input_type -> milvus.proto.data.FlushAllRequest
	25,  // 358: milvus.proto.data.DataCoord.AllocSegment:input_type -> milvus.proto.data.AllocSegmentRequest
	27,  // 359: milvus.proto.data.DataCoord.AssignSegmentID:input_type -> milvus.proto.data.AssignSegmentIDRequest
	33,  // 360: milvus.proto.data.DataCoord.GetSegmentInfo:input_type -> milvus.proto.data.GetSegmentInfoRequest
	30,  // 361: milvus.proto.data.DataCoord.GetSegmentStates:input_type -> milvus.proto.data.GetSegmentStatesRequest
	35,  // 362: milvus.proto.data.DataCoord.GetInsertBinlogPaths:input_type -> milvus.proto.data.GetInsertBinlogPathsRequest
	37,  // 363: milvus.proto.data.DataCoord.GetCollectionStatistics:input_type -> milvus.proto.data.GetCollectionStatisticsRequest
	39,  // 364: milvus.proto.data.DataCoord.GetPartitionStatistics:input_type -> milvus.proto.data.GetPartitionStatisticsRequest
	41,  // 365: milvus.proto.data.DataCoord.GetSegmentInfoChannel:input_type -> milvus.proto.data.GetSegmentInfoChannelRequest
	49,  // 366: milvus.proto.data.DataCoord.SaveBinlogPaths:input_type -> milvus.proto.data.SaveBinlogPathsRequest
	60,  // 367: milvus.proto.data.DataCoord.GetRecoveryInfo:input_type -> milvus.proto.data.GetRecoveryInfoRequest
	62,  // 368: milvus.proto.data.DataCoord.GetRecoveryInfoV2:input_type -> milvus.proto.data.GetRecoveryInfoRequestV2
	63,  // 369: milvus.proto.data.DataCoord.GetChannelRecoveryInfo:input_type -> milvus.proto.data.GetChannelRecoveryInfoRequest
	68,  // 370: milvus.proto.data.DataCoord.GetFlushedSegments:input_type -> milvus.proto.data.GetFlushedSegmentsRequest
	66,  // 371: milvus.proto.data.DataCoord.GetSegmentsByStates:input_type -> milvus.proto.data.GetSegmentsByStatesRequest
	245, // 372: milvus.proto.data.DataCoord.GetFlushAllState:input_type -> milvus.proto.milvus.GetFlushAllStateRequest
	246, // 373: milvus.proto.data.DataCoord.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	247, // 374: milvus.proto.data.DataCoord.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	248, // 375: milvus.proto.data.DataCoord.ManualCompaction:input_type -> milvus.proto.milvus.ManualCompactionRequest
	249, // 376: milvus.proto.data.DataCoord.GetCompactionState:input_type -> milvus.proto.milvus.GetCompactionStateRequest
	250, // 377: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:input_type -> milvus.proto.milvus.GetCompactionPlansRequest
	85,  // 378: milvus.proto.data.DataCoord.WatchChannels:input_type -> milvus.proto.data.WatchChannelsRequest
	103, // 379: milvus.proto.data.DataCoord.GetFlushState:input_type -> milvus.proto.data.GetFlushStateRequest
	89,  // 380: milvus.proto.data.DataCoord.DropVirtualChannel:input_type -> milvus.proto.data.DropVirtualChannelRequest
	87,  // 381: milvus.proto.data.DataCoord.SetSegmentState:input_type -> milvus.proto.data.SetSegmentStateRequest
	92,  // 382: milvus.proto.data.DataCoord.UpdateSegmentStatistics:input_type -> milvus.proto.data.UpdateSegmentStatisticsRequest
	93,  // 383: milvus.proto.data.DataCoord.UpdateChannelCheckpoint:input_type -> milvus.proto.data.UpdateChannelCheckpointRequest
	96,  // 384: milvus.proto.data.DataCoord.MarkSegmentsDropped:input_type -> milvus.proto.data.MarkSegmentsDroppedRequest
	98,  // 385: milvus.proto.data.DataCoord.BroadcastAlteredCollection:input_type -> milvus.proto.data.AlterCollectionRequest
	251, // 386: milvus.proto.data.DataCoord.CheckHealth:input_type -> milvus.proto.milvus.CheckHealthRequest
	252, // 387: milvus.proto.data.DataCoord.CreateIndex:input_type -> milvus.proto.index.CreateIndexRequest
	253, // 388: milvus.proto.data.DataCoord.AlterIndex:input_type -> milvus.proto.index.AlterIndexRequest
	254, // 389: milvus.proto.data.DataCoord.GetIndexState:input_type -> milvus.proto.index.GetIndexStateRequest
	255, // 390: milvus.proto.data.DataCoord.GetSegmentIndexState:input_type -> milvus.proto.index.GetSegmentIndexStateRequest
	256, // 391: milvus.proto.data.DataCoord.GetIndexInfos:input_type -> milvus.proto.index.GetIndexInfoRequest
	257, // 392: milvus.proto.data.DataCoord.DropIndex:input_type -> milvus.proto.index.DropIndexRequest
	258, // 393: milvus.proto.data.DataCoord.DescribeIndex:input_type -> milvus.proto.index.DescribeIndexRequest
	259, // 394: milvus.proto.data.DataCoord.GetIndexStatistics:input_type -> milvus.proto.index.GetIndexStatisticsRequest
	260, // 395: milvus.proto.data.DataCoord.GetIndexBuildProgress:input_type -> milvus.proto.index.GetIndexBuildProgressRequest
	261, // 396: milvus.proto.data.DataCoord.ListIndexes:input_type -> milvus.proto.index.ListIndexesRequest
	100, // 397: milvus.proto.data.DataCoord.GcConfirm:input_type -> milvus.proto.data.GcConfirmRequest
	102, // 398: milvus.proto.data.DataCoord.ReportDataNodeTtMsgs:input_type -> milvus.proto.data.ReportDataNodeTtMsgsRequest
	133, // 399: milvus.proto.data.DataCoord.GcControl:input_type -> milvus.proto.data.GcControlRequest
	262, // 400: milvus.proto.data.DataCoord.ImportV2:input_type -> milvus.proto.internal.ImportRequestInternal
	263, // 401: milvus.proto.data.DataCoord.GetImportProgress:input_type -> milvus.proto.internal.GetImportProgressRequest
	264, // 402: milvus.proto.data.DataCoord.ListImports:input_type -> milvus.proto.internal.ListImportsRequestInternal
	152, // 403: milvus.proto.data.DataCoord.CreateSnapshot:input_type -> milvus.proto.data.CreateSnapshotRequest
	153, // 404: milvus.proto.data.DataCoord.DropSnapshot:input_type -> milvus.proto.data.DropSnapshotRequest
	154, // 405: milvus.proto.data.DataCoord.ListSnapshots:input_type -> milvus.proto.data.ListSnapshotsRequest
	164, // 406: milvus.proto.data.DataCoord.DescribeSnapshot:input_type -> milvus.proto.data.DescribeSnapshotRequest
	166, // 407: milvus.proto.data.DataCoord.RestoreSnapshot:input_type -> milvus.proto.data.RestoreSnapshotRequest
	156, // 408: milvus.proto.data.DataCoord.ExportSnapshot:input_type -> milvus.proto.data.ExportSnapshotRequest
	188, // 409: milvus.proto.data.DataCoord.GetExportSnapshotState:input_type -> milvus.proto.data.GetExportSnapshotStateRequest
	168, // 410: milvus.proto.data.DataCoord.GetRestoreSnapshotState:input_type -> milvus.proto.data.GetRestoreSnapshotStateRequest
	170, // 411: milvus.proto.data.DataCoord.ListRestoreSnapshotJobs:input_type -> milvus.proto.data.ListRestoreSnapshotJobsRequest
	177, // 412: milvus.proto.data.DataCoord.PinSnapshotData:input_type -> milvus.proto.data.PinSnapshotDataRequest
	179, // 413: milvus.proto.data.DataCoord.UnpinSnapshotData:input_type -> milvus.proto.data.UnpinSnapshotDataRequest
	172, // 414: milvus.proto.data.DataCoord.BatchUpdateManifest:input_type -> milvus.proto.data.BatchUpdateManifestRequest
	174, // 415: milvus.proto.data.DataCoord.CommitBackfillResult:input_type -> milvus.proto.data.CommitBackfillResultRequest
	143, // 416: milvus.proto.data.DataCoord.RefreshExternalCollection:input_type -> milvus.proto.data.RefreshExternalCollectionRequest
	145, // 417: milvus.proto.data.DataCoord.GetRefreshExternalCollectionProgress:input_type -> milvus.proto.data.GetRefreshExternalCollectionProgressRequest
	150, // 418: milvus.proto.data.DataCoord.ListRefreshExternalCollectionJobs:input_type -> milvus.proto.data.ListRefreshExternalCollectionJobsRequest
	180, // 419: milvus.proto.data.DataCoord.CommitImport:input_type -> milvus.proto.data.CommitImportRequest
	181, // 420: milvus.proto.data.DataCoord.AbortImport:input_type -> milvus.proto.data.AbortImportRequest
	182, // 421: milvus.proto.data.DataCoord.HandleCommitVchannel:input_type -> milvus.proto.data.HandleCommitVchannelRequest
	265, // 422: milvus.proto.data.DataNode.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	266, // 423: milvus.proto.data.DataNode.GetStatisticsChannel:input_type -> milvus.proto.internal.GetStatisticsChannelRequest
	43,  // 424: milvus.proto.data.DataNode.WatchDmChannels:input_type -> milvus.proto.data.WatchDmChannelsRequest
	44,  // 425: milvus.proto.data.DataNode.FlushSegments:input_type -> milvus.proto.data.FlushSegmentsRequest
	246, // 426: milvus.proto.data.DataNode.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	247, // 427: milvus.proto.data.DataNode.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	76,  // 428: milvus.proto.data.DataNode.CompactionV2:input_type -> milvus.proto.data.CompactionPlan
	72,  // 429: milvus.proto.data.DataNode.GetCompactionState:input_type -> milvus.proto.data.CompactionStateRequest
	74,  // 430: milvus.proto.data.DataNode.SyncSegments:input_type -> milvus.proto.data.SyncSegmentsRequest
	94,  // 431: milvus.proto.data.DataNode.ResendSegmentStats:input_type -> milvus.proto.data.ResendSegmentStatsRequest
	23,  // 432: milvus.proto.data.DataNode.FlushChannels:input_type -> milvus.proto.data.FlushChannelsRequest
	104, // 433: milvus.proto.data.DataNode.NotifyChannelOperation:input_type -> milvus.proto.data.ChannelOperationsRequest
	71,  // 434: milvus.proto.data.DataNode.CheckChannelOperationProgress:input_type -> milvus.proto.data.ChannelWatchInfo
	106, // 435: milvus.proto.data.DataNode.PreImport:input_type -> milvus.proto.data.PreImportRequest
	109, // 436: milvus.proto.data.DataNode.ImportV2:input_type -> milvus.proto.data.ImportRequest
	110, // 437: milvus.proto.data.DataNode.QueryPreImport:input_type -> milvus.proto.data.QueryPreImportRequest
	114, // 438: milvus.proto.data.DataNode.QueryImport:input_type -> milvus.proto.data.QueryImportRequest
	117, // 439: milvus.proto.data.DataNode.DropImport:input_type -> milvus.proto.data.DropImportRequest
	135, // 440: milvus.proto.data.DataNode.QuerySlot:input_type -> milvus.proto.data.QuerySlotRequest
	140, // 441: milvus.proto.data.DataNode.DropCompactionPlan:input_type -> milvus.proto.data.DropCompactionPlanRequest
	267, // 442: milvus.proto.data.DataNode.SyncFileResource:input_type -> milvus.proto.internal.SyncFileResourceRequest
	18,  // 443: milvus.proto.data.DataCoord.Flush:output_type -> milvus.proto.data.FlushResponse
	22,  // 444: milvus.proto.data.DataCoord.FlushAll:output_type -> milvus.proto.data.FlushAllResponse
	26,  // 445: milvus.proto.data.DataCoord.AllocSegment:output_type -> milvus.proto.data.AllocSegmentResponse
	29,  // 446: milvus.proto.data.DataCoord.AssignSegmentID:output_type -> milvus.proto.data.AssignSegmentIDResponse
	34,  // 447: milvus.proto.data.DataCoord.GetSegmentInfo:output_type -> milvus.proto.data.GetSegmentInfoResponse
	32,  // 448: milvus.proto.data.DataCoord.GetSegmentStates:output_type -> milvus.proto.data.GetSegmentStatesResponse
	36,  // 449: milvus.proto.data.DataCoord.GetInsertBinlogPaths:output_type -> milvus.proto.data.GetInsertBinlogPathsResponse
	38,  // 450: milvus.proto.data.DataCoord.GetCollectionStatistics:output_type -> milvus.proto.data.GetCollectionStatisticsResponse
	40,  // 451: milvus.proto.data.DataCoord.GetPartitionStatistics:output_type -> milvus.proto.data.GetPartitionStatisticsResponse
	268, // 452: milvus.proto.data.DataCoord.GetSegmentInfoChannel:output_type -> milvus.proto.milvus.StringResponse
	222, // 453: milvus.proto.data.DataCoord.SaveBinlogPaths:output_type -> milvus.proto.common.Status
	59,  // 454: milvus.proto.data.DataCoord.GetRecoveryInfo:output_type -> milvus.proto.data.GetRecoveryInfoResponse
	61,  // 455: milvus.proto.data.DataCoord.GetRecoveryInfoV2:output_type -> milvus.proto.data.GetRecoveryInfoResponseV2
	64,  // 456: milvus.proto.data.DataCoord.GetChannelRecoveryInfo:output_type -> milvus.proto.data.GetChannelRecoveryInfoResponse
	69,  // 457: milvus.proto.data.DataCoord.GetFlushedSegments:output_type -> milvus.proto.data.GetFlushedSegmentsResponse
	67,  // 458: milvus.proto.data.DataCoord.GetSegmentsByStates:output_type -> milvus.proto.data.GetSegmentsByStatesResponse
	269, // 459: milvus.proto.data.DataCoord.GetFlushAllState:output_type -> milvus.proto.milvus.GetFlushAllStateResponse
	270, // 460: milvus.proto.data.DataCoord.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	271, // 461: milvus.proto.data.DataCoord.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	272, // 462: milvus.proto.data.DataCoord.ManualCompaction:output_type -> milvus.proto.milvus.ManualCompactionResponse
	273, // 463: milvus.proto.data.DataCoord.GetCompactionState:output_type -> milvus.proto.milvus.GetCompactionStateResponse
	274, // 464: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:output_type -> milvus.proto.milvus.GetCompactionPlansResponse
	86,  // 465: milvus.proto.data.DataCoord.WatchChannels:output_type -> milvus.proto.data.WatchChannelsResponse
	275, // 466: milvus.proto.data.DataCoord.GetFlushState:output_type -> milvus.proto.milvus.GetFlushStateResponse
	91,  // 467: milvus.proto.data.DataCoord.DropVirtualChannel:output_type -> milvus.proto.data.DropVirtualChannelResponse
	88,  // 468: milvus.proto.data.DataCoord.SetSegmentState:output_type -> milvus.proto.data.SetSegmentStateResponse
	222, // 469: milvus.proto.data.DataCoord.UpdateSegmentStatistics:output_type -> milvus.proto.common.Status
	222, // 470: milvus.proto.data.DataCoord.UpdateChannelCheckpoint:output_type -> milvus.proto.common.Status
	222, // 471: milvus.proto.data.DataCoord.MarkSegmentsDropped:output_type -> milvus.proto.common.Status
	222, // 472: milvus.proto.data.DataCoord.BroadcastAlteredCollection:output_type -> milvus.proto.common.Status
	276, // 473: milvus.proto.data.DataCoord.CheckHealth:output_type -> milvus.proto.milvus.CheckHealthResponse
	222, // 474: milvus.proto.data.DataCoord.CreateIndex:output_type -> milvus.proto.common.Status
	222, // 475: milvus.proto.data.DataCoord.AlterIndex:output_type -> milvus.proto.common.Status
	277, // 476: milvus.proto.data.DataCoord.GetIndexState:output_type -> milvus.proto.index.GetIndexStateResponse
	278, // 477: milvus.proto.data.DataCoord.GetSegmentIndexState:output_type -> milvus.proto.index.GetSegmentIndexStateResponse
	279, // 478: milvus.proto.data.DataCoord.GetIndexInfos:output_type -> milvus.proto.index.GetIndexInfoResponse
	222, // 479: milvus.proto.data.DataCoord.DropIndex:output_type -> milvus.proto.common.Status
	280, // 480: milvus.proto.data.DataCoord.DescribeIndex:output_type -> milvus.proto.index.DescribeIndexResponse
	281, // 481: milvus.proto.data.DataCoord.GetIndexStatistics:output_type -> milvus.proto.index.GetIndexStatisticsResponse
	282, // 482: milvus.proto.data.DataCoord.GetIndexBuildProgress:output_type -> milvus.proto.index.GetIndexBuildProgressResponse
	283, // 483: milvus.proto.data.DataCoord.ListIndexes:output_type -> milvus.proto.index.ListIndexesResponse
	101, // 484: milvus.proto.data.DataCoord.GcConfirm:output_type -> milvus.proto.data.GcConfirmResponse
	222, // 485: milvus.proto.data.DataCoord.ReportDataNodeTtMsgs:output_type -> milvus.proto.common.Status
	222, // 486: milvus.proto.data.DataCoord.GcControl:output_type -> milvus.proto.common.Status
	284, // 487: milvus.proto.data.DataCoord.ImportV2:output_type -> milvus.proto.internal.ImportResponse
	285, // 488: milvus.proto.data.DataCoord.GetImportProgress:output_type -> milvus.proto.internal.GetImportProgressResponse
	286, // 489: milvus.proto.data.DataCoord.ListImports:output_type -> milvus.proto.internal.ListImportsResponse
	222, // 490: milvus.proto.data.DataCoord.CreateSnapshot:output_type -> milvus.proto.common.Status
	222, // 491: milvus.proto.data.DataCoord.DropSnapshot:output_type -> milvus.proto.common.Status
	155, // 492: milvus.proto.data.DataCoord.ListSnapshots:output_type -> milvus.proto.data.ListSnapshotsResponse
	165, // 493: milvus.proto.data.DataCoord.DescribeSnapshot:output_type -> milvus.proto.data.DescribeSnapshotResponse
	167, // 494: milvus.proto.data.DataCoord.RestoreSnapshot:output_type -> milvus.proto.data.RestoreSnapshotResponse
	157, // 495: milvus.proto.data.DataCoord.ExportSnapshot:output_type -> milvus.proto.data.ExportSnapshotResponse
	189, // 496: milvus.proto.data.DataCoord.GetExportSnapshotState:output_type -> milvus.proto.data.GetExportSnapshotStateResponse
	169, // 497: milvus.proto.data.DataCoord.GetRestoreSnapshotState:output_type -> milvus.proto.data.GetRestoreSnapshotStateResponse
	171, // 498: milvus.proto.data.DataCoord.ListRestoreSnapshotJobs:output_type -> milvus.proto.data.ListRestoreSnapshotJobsResponse
	178, // 499: milvus.proto.data.DataCoord.PinSnapshotData:output_type -> milvus.proto.data.PinSnapshotDataResponse
	222, // 500: milvus.proto.data.DataCoord.UnpinSnapshotData:output_type -> milvus.proto.common.Status
	222, // 501: milvus.proto.data.DataCoord.BatchUpdateManifest:output_type -> milvus.proto.common.Status
	176, // 502: milvus.proto.data.DataCoord.CommitBackfillResult:output_type -> milvus.proto.data.CommitBackfillResultResponse
	144, // 503: milvus.proto.data.DataCoord.RefreshExternalCollection:output_type -> milvus.proto.data.RefreshExternalCollectionResponse
	149, // 504: milvus.proto.data.DataCoord.GetRefreshExternalCollectionProgress:output_type -> milvus.proto.data.GetRefreshExternalCollectionProgressResponse
	151, // 505: milvus.proto.data.DataCoord.ListRefreshExternalCollectionJobs:output_type -> milvus.proto.data.ListRefreshExternalCollectionJobsResponse
	222, // 506: milvus.proto.data.DataCoord.CommitImport:output_type -> milvus.proto.common.Status
	222, // 507: milvus.proto.data.DataCoord.AbortImport:output_type -> milvus.proto.common.Status
	222, // 508: milvus.proto.data.DataCoord.HandleCommitVchannel:output_type -> milvus.proto.common.Status
	287, // 509: milvus.proto.data.DataNode.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	268, // 510: milvus.proto.data.DataNode.GetStatisticsChannel:output_type -> milvus.proto.milvus.StringResponse
	222, // 511: milvus.proto.data.DataNode.WatchDmChannels:output_type -> milvus.proto.common.Status
	222, // 512: milvus.proto.data.DataNode.FlushSegments:output_type -> milvus.proto.common.Status
	270, // 513: milvus.proto.data.DataNode.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	271, // 514: milvus.proto.data.DataNode.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	222, // 515: milvus.proto.data.DataNode.CompactionV2:output_type -> milvus.proto.common.Status
	83,  // 516: milvus.proto.data.DataNode.GetCompactionState:output_type -> milvus.proto.data.CompactionStateResponse
	222, // 517: milvus.proto.data.DataNode.SyncSegments:output_type -> milvus.proto.common.Status
	95,  // 518: milvus.proto.data.DataNode.ResendSegmentStats:output_type -> milvus.proto.data.ResendSegmentStatsResponse
	222, // 519: milvus.proto.data.DataNode.FlushChannels:output_type -> milvus.proto.common.Status
	222, // 520: milvus.proto.data.DataNode.NotifyChannelOperation:output_type -> milvus.proto.common.Status
	105, // 521: milvus.proto.data.DataNode.CheckChannelOperationProgress:output_type -> milvus.proto.data.ChannelOperationProgressResponse
	222, // 522: milvus.proto.data.DataNode.PreImport:output_type -> milvus.proto.common.Status
	222, // 523: milvus.proto.data.DataNode.ImportV2:output_type -> milvus.proto.common.Status
	113, // 524: milvus.proto.data.DataNode.QueryPreImport:output_type -> milvus.proto.data.QueryPreImportResponse
	116, // 525: milvus.proto.data.DataNode.QueryImport:output_type -> milvus.proto.data.QueryImportResponse
	222, // 526: milvus.proto.data.DataNode.DropImport:output_type -> milvus.proto.common.Status
	136, // 527: milvus.proto.data.DataNode.QuerySlot:output_type -> milvus.proto.data.QuerySlotResponse
	222, // 528: milvus.proto.data.DataNode.DropCompactionPlan:output_type -> milvus.proto.common.Status
	222, // 529: milvus.proto.data.DataNode.SyncFileResource:output_type -> milvus.proto.common.Status
	443, // [443:530] is the sub-list for method output_type
	356, // [356:443] is the sub-list for method input_type
