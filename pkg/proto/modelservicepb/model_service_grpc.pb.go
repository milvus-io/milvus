...
func (c *textEmbeddingServiceClient) Embedding(ctx context.Context, in *TextEmbeddingRequest, opts ...grpc.CallOption) (*TextEmbeddingResponse, error) {
	...
	err := c.cc.Invoke(ctx, TextEmbeddingService_Embedding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTextEmbeddingServiceServer should be embedded to have
...
func (UnimplementedTextEmbeddingServiceServer) testEmbeddedByValue() {}
...
func RegisterTextEmbeddingServiceServer(s grpc.ServiceRegistrar, srv TextEmbeddingServiceServer) {
	// If the following call panics, it indicates UnimplementedTextEmbeddingServiceServer was
...
// UnimplementedRerankServiceServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (c *highlightServiceClient) Highlight(ctx context.Context, in *HighlightRequest, opts ...grpc.CallOption) (*HighlightResponse, error) {
	...
	err := c.cc.Invoke(ctx, HighlightService_Highlight_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedHighlightServiceServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedHighlightServiceServer) Highlight(context.Context, *HighlightRequest) (*HighlightResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Highlight not implemented")
}
func (UnimplementedHighlightServiceServer) testEmbeddedByValue() {}
...
func RegisterHighlightServiceServer(s grpc.ServiceRegistrar, srv HighlightServiceServer) {
	// If the following call panics, it indicates UnimplementedHighlightServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
