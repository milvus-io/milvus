...
// GetPrefixPath returns a normalized prefix path ending with exactly one trailing "/".
func GetPrefixPath(rootPath string) string {
	return fmt.Sprintf("%s/", strings.TrimSuffix(rootPath, "/"))
}
