...
const (
	...
	// MaxEstimatedDecodedBytes bounds one bitmap and is also the aggregate
	// roaring_match decoded-memory budget for one logical request/plan. The
	// estimate includes the portable body plus conservative fixed overhead for
	// every high-32 child and every Roaring32 container.
