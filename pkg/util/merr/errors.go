...
var (
	...
	ErrClusteringCompactionCollectionNotSupport   = newMilvusError("collection not support clustering compaction", 2305, false)
	ErrClusteringCompactionCollectionIsCompacting = newMilvusError("collection is compacting", 2306, false)
	ErrClusteringCompactionNotSupportVector       = newMilvusError("vector field clustering compaction is not supported", 2307, false)
	ErrClusteringCompactionSubmitTaskFail         = newMilvusError("fail to submit task", 2308, true)
	ErrClusteringCompactionMetaError              = newMilvusError("fail to update meta in clustering compaction", 2309, true)
	ErrClusteringCompactionGetCollectionFail      = newMilvusError("fail to get collection in compaction", 2310, true)
	ErrCompactionResultNotFound                   = newMilvusError("compaction result not found", 2311, false)
	ErrAnalyzeTaskNotFound                        = newMilvusError("analyze task not found", 2312, true)
	ErrBuildCompactionRequestFail                 = newMilvusError("fail to build CompactionRequest", 2313, true)
	ErrGetCompactionPlanResultFail                = newMilvusError("fail to get compaction plan", 2314, true)
	ErrCompactionResult                           = newMilvusError("illegal compaction results", 2315, false)
	ErrDuplicatedCompactionTask                   = newMilvusError("duplicated compaction task", 2316, false)
	ErrCleanPartitionStatsFail                    = newMilvusError("fail to clean partition Stats", 2317, true)
