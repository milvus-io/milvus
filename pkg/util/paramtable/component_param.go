...
type queryNodeConfig struct {
	...
	ExprResCacheMemAdmissionThreshold ParamItem `refreshable:"true"`
	ExprResCacheMemMinEvalDurationUs  ParamItem `refreshable:"true"`
	ExprResCacheDiskMaxFileSizeBytes  ParamItem `refreshable:"true"`
	ExprResCacheDiskMinEvalDurationUs ParamItem `refreshable:"true"`
