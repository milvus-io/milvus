...
Set to 0 to disable the penalty period.`,
	...
	p.AutoscalePrecheckEnabled = ParamItem{
		...
		Version:      "3.0.0",
		DefaultValue: "false",
		Doc:          "Whether QueryCoord performs load resource precheck before committing load configuration changes and publishes demand counters after successful broadcasts.",
		Export:       true,
	}
