...
func TestParamItemGetAsSize(t *testing.T) {
	tests := []struct {
		...
		{name: "hex integer", value: "0x10KB", expected: 0},
		{name: "hex float", value: "0x1p2MB", expected: 0},
		{name: "binary integer", value: "0b10KB", expected: 0},
		{name: "octal integer", value: "0o10KB", expected: 0},
		{name: "underscore separator", value: "1_000KB", expected: 0},
		{name: "fraction", value: "1/2KB", expected: 0},
		...
		{name: "truncate to max int64", value: "9223372036854775807.9", expected: 9223372036854775807},
		{name: "truncate to min int64", value: "-9223372036854775808.9", expected: -9223372036854775808},
