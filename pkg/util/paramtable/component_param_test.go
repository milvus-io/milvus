...
func TestComponentParam(t *testing.T) {
	...
	t.Run("test dataNodeConfig", func(t *testing.T) {
		...
		assert.Equal(t, 0.1, Params.SlotProtectFreeMemoryRatio.GetAsFloat())
		params.Save("dataNode.memory.slotProtectFreeMemoryRatio", "0.2")
		assert.Equal(t, 0.2, Params.SlotProtectFreeMemoryRatio.GetAsFloat())
