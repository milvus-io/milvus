...
func TestComponentParam(t *testing.T) {
	...
	t.Run("test streamingConfig", func(t *testing.T) {
		...
		assert.Equal(t, int64(0), params.StreamingCfg.WALAppendBatchMaxSize.GetAsSize())
		assert.Equal(t, 0*time.Second, params.StreamingCfg.WALAppendBatchMaxDelay.GetAsDurationByParse())
		assert.Equal(t, 3, params.StreamingCfg.WALAppendBatchCooldownThreshold.GetAsInt())
		assert.Equal(t, 1*time.Second, params.StreamingCfg.WALAppendBatchCooldownDuration.GetAsDurationByParse())
		...
		params.Save(params.StreamingCfg.WALAppendBatchSmallMessageThreshold.Key, "4k")
		params.Save(params.StreamingCfg.WALAppendBatchMaxSize.Key, "16k")
		params.Save(params.StreamingCfg.WALAppendBatchMaxDelay.Key, "5ms")
		params.Save(params.StreamingCfg.WALAppendBatchCooldownThreshold.Key, "2")
		params.Save(params.StreamingCfg.WALAppendBatchCooldownDuration.Key, "500ms")
		...
		assert.Equal(t, int64(4*1024), params.StreamingCfg.WALAppendBatchSmallMessageThreshold.GetAsSize())
		assert.Equal(t, int64(16*1024), params.StreamingCfg.WALAppendBatchMaxSize.GetAsSize())
		assert.Equal(t, 5*time.Millisecond, params.StreamingCfg.WALAppendBatchMaxDelay.GetAsDurationByParse())
		assert.Equal(t, 2, params.StreamingCfg.WALAppendBatchCooldownThreshold.GetAsInt())
		assert.Equal(t, 500*time.Millisecond, params.StreamingCfg.WALAppendBatchCooldownDuration.GetAsDurationByParse())
