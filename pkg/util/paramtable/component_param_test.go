...
func TestComponentParam(t *testing.T) {
	...
	t.Run("test streamingConfig", func(t *testing.T) {
		...
		assert.Equal(t, int64(64*1024*1024), params.StreamingCfg.IdempotencyMinRetainedBytes.GetAsSize())
		...
		params.Save(params.StreamingCfg.IdempotencyMinRetainedBytes.Key, "134217728")
		...
		assert.Equal(t, int64(128*1024*1024), params.StreamingCfg.IdempotencyMinRetainedBytes.GetAsSize())
