...
func TestComponentParam(t *testing.T) {
	...
	t.Run("test streamingConfig", func(t *testing.T) {
		...
		params.Save(params.StreamingCfg.IdempotencyWindowTTL.Key, "15m")
		params.Save(params.StreamingCfg.IdempotencyMinEntriesPerWindow.Key, "64")
		params.Save(params.StreamingCfg.IdempotencyMaxEntriesPerWindow.Key, "4096")
		...
		assert.Equal(t, 15*time.Minute, params.StreamingCfg.IdempotencyWindowTTL.GetAsDurationByParse())
		assert.Equal(t, 64, params.StreamingCfg.IdempotencyMinEntriesPerWindow.GetAsInt())
		assert.Equal(t, 4096, params.StreamingCfg.IdempotencyMaxEntriesPerWindow.GetAsInt())
		assert.Equal(t, 2*time.Second, params.StreamingCfg.IdempotencySnapshotInterval.GetAsDurationByParse())
