...
func TestComponentParam(t *testing.T) {
	...
	t.Run("test streamingConfig", func(t *testing.T) {
		...
		// Test FlowControl configurations
		assert.Equal(t, 0.85, params.StreamingCfg.FlowControlThrottlingHwmMemoryThreshold.GetAsFloat())
		assert.Equal(t, 0.95, params.StreamingCfg.FlowControlDenyMemoryThreshold.GetAsFloat())
		assert.Equal(t, 0.8, params.StreamingCfg.FlowControlThrottlingLwmMemoryThreshold.GetAsFloat())
		assert.Equal(t, int64(2*1024*1024), params.StreamingCfg.FlowControlThrottlingWriteRate.GetAsSize())
		assert.Equal(t, int64(-1), params.StreamingCfg.FlowControlDefaultWriteRate.GetAsSize())
		...
		params.Save(params.StreamingCfg.FlowControlThrottlingHwmMemoryThreshold.Key, "0.8")
		params.Save(params.StreamingCfg.FlowControlDenyMemoryThreshold.Key, "0.9")
		params.Save(params.StreamingCfg.FlowControlThrottlingLwmMemoryThreshold.Key, "0.75")
		params.Save(params.StreamingCfg.FlowControlThrottlingWriteRate.Key, "3m")
		params.Save(params.StreamingCfg.FlowControlDefaultWriteRate.Key, "5m")

		params.Save(params.StreamingCfg.FlushMemoryThreshold.Key, "0.7")
		params.Save(params.StreamingCfg.FlushGrowingSegmentHwmBytesThreshold.Key, "0.25")
		params.Save(params.StreamingCfg.FlushGrowingSegmentLwmBytesThreshold.Key, "0.15")
		...
		assert.Equal(t, 0.8, params.StreamingCfg.FlowControlThrottlingHwmMemoryThreshold.GetAsFloat())
		assert.Equal(t, 0.9, params.StreamingCfg.FlowControlDenyMemoryThreshold.GetAsFloat())
		assert.Equal(t, 0.75, params.StreamingCfg.FlowControlThrottlingLwmMemoryThreshold.GetAsFloat())
		assert.Equal(t, int64(3*1024*1024), params.StreamingCfg.FlowControlThrottlingWriteRate.GetAsSize())
		assert.Equal(t, int64(5*1024*1024), params.StreamingCfg.FlowControlDefaultWriteRate.GetAsSize())
		assert.Equal(t, float64(0.7), params.StreamingCfg.FlushMemoryThreshold.GetAsFloat())
		assert.Equal(t, float64(0.25), params.StreamingCfg.FlushGrowingSegmentHwmBytesThreshold.GetAsFloat())
		assert.Equal(t, float64(0.15), params.StreamingCfg.FlushGrowingSegmentLwmBytesThreshold.GetAsFloat())
	})
