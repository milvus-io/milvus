...
var hashStringBenchmarkSink uint32

func BenchmarkHashString2Uint32(b *testing.B) {
	inputs := map[string]string{
		"short": "abcdef",
		"long":  "Milvus was created in 2019 with a singular goal: store, index, and manage massive embedding vectors generated by deep neural networks and other machine learning models.",
	}
	...
	for name, input := range inputs {
		b.Run(name, func(b *testing.B) {
			b.ReportAllocs()
			for i := 0; i < b.N; i++ {
				hashStringBenchmarkSink = HashString2Uint32(input)
			}
		})
	}
}
