...
// partial_update (9), namespace (10), field_ops (11), rls_principal (12) and
// skip_rls (13) are folded into the official merge via the default→rest→protoMerge
// fallback, so they decode via the standard codec and stay wire-equivalent.
