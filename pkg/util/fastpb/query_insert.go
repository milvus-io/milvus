...
// partial_update (9), namespace (10), field_ops (11) and RLS fields (12/13)
// are folded into the official merge, so they decode via the standard codec
// and stay wire-equivalent.
