 ...
 * Add back partially because clustering feature needs to calculate distance between search vector and clustering center
 */
const (
	...
	IP = "IP"
	// COSINE represents the cosine distance, todo not supported yet
	COSINE = "COSINE"
)
...
// it will check input, and calculate the distance concurrently
