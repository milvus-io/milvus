...
const (
	StreamingCoordStateService_GetComponentStates_FullMethodName = "/milvus.proto.streaming.StreamingCoordStateService/GetComponentStates"
)

// StreamingCoordStateServiceClient is the client API for StreamingCoordStateService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type StreamingCoordStateServiceClient interface {
	GetComponentStates(ctx context.Context, in *milvuspb.GetComponentStatesRequest, opts ...grpc.CallOption) (*milvuspb.ComponentStates, error)
}

type streamingCoordStateServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewStreamingCoordStateServiceClient(cc grpc.ClientConnInterface) StreamingCoordStateServiceClient {
	return &streamingCoordStateServiceClient{cc}
}

func (c *streamingCoordStateServiceClient) GetComponentStates(ctx context.Context, in *milvuspb.GetComponentStatesRequest, opts ...grpc.CallOption) (*milvuspb.ComponentStates, error) {
	out := new(milvuspb.ComponentStates)
	err := c.cc.Invoke(ctx, StreamingCoordStateService_GetComponentStates_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// StreamingCoordStateServiceServer is the server API for StreamingCoordStateService service.
// All implementations should embed UnimplementedStreamingCoordStateServiceServer
// for forward compatibility
type StreamingCoordStateServiceServer interface {
	GetComponentStates(context.Context, *milvuspb.GetComponentStatesRequest) (*milvuspb.ComponentStates, error)
}

// UnimplementedStreamingCoordStateServiceServer should be embedded to have forward compatible implementations.
type UnimplementedStreamingCoordStateServiceServer struct {
}

func (UnimplementedStreamingCoordStateServiceServer) GetComponentStates(context.Context, *milvuspb.GetComponentStatesRequest) (*milvuspb.ComponentStates, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetComponentStates not implemented")
}

// UnsafeStreamingCoordStateServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to StreamingCoordStateServiceServer will
// result in compilation errors.
type UnsafeStreamingCoordStateServiceServer interface {
	mustEmbedUnimplementedStreamingCoordStateServiceServer()
}

func RegisterStreamingCoordStateServiceServer(s grpc.ServiceRegistrar, srv StreamingCoordStateServiceServer) {
	s.RegisterService(&StreamingCoordStateService_ServiceDesc, srv)
}

func _StreamingCoordStateService_GetComponentStates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(milvuspb.GetComponentStatesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamingCoordStateServiceServer).GetComponentStates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamingCoordStateService_GetComponentStates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamingCoordStateServiceServer).GetComponentStates(ctx, req.(*milvuspb.GetComponentStatesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// StreamingCoordStateService_ServiceDesc is the grpc.ServiceDesc for StreamingCoordStateService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var StreamingCoordStateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "milvus.proto.streaming.StreamingCoordStateService",
	HandlerType: (*StreamingCoordStateServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetComponentStates",
			Handler:    _StreamingCoordStateService_GetComponentStates_Handler,
		},
	},
