...
func TestNewWALProducerCreatesExclusiveProducer(t *testing.T) {
	...
	p, err := newWALProducer(context.Background(), c.factory(), testProducerTopic, log.With())
...
func TestNewWALProducerUsesConfiguredAccessMode(t *testing.T) {
	...
	_, err := newWALProducer(context.Background(), c.factory(), testProducerTopic, log.With())
...
func TestNewWALProducerClosesClientWhenContextDone(t *testing.T) {
	...
	p, err := newWALProducer(ctx, c.factory(), testProducerTopic, log.With())
