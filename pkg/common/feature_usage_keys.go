...
var officialFeatureKeys = func() map[string]struct{} {
	keys := []string{
		...
		CollectionInsertIdempotencyEnabledKey,
		...
		// scalar index parameters without a constant in this package: NGRAM
		// and FMINDEX (internal/util/indexparamcheck)
		"min_gram", "max_gram",
		"fm_sa_sample_rate", "fm_block_bytes",
	}
