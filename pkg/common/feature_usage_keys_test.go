...
func TestIsOfficialFeatureKey(t *testing.T) {
	...
	assert.True(t, IsOfficialFeatureKey("min_gram"))
	assert.True(t, IsOfficialFeatureKey("fm_sa_sample_rate"))
...
func TestOfficialFeatureKeysCoverDottedConstants(t *testing.T) {
	...
	exempt := map[string]struct{}{
		...
		// A message property the Proxy and RootCoord pass between them for
		// row-level security, not a collection or database property.
		RLSPrincipalNameKey: {},
	}
