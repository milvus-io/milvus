...
const (
	...
	// local chunk cache, bm25), written under
...
// as LoadJsonKeyIndexInfo.mmap_dir_path (internal/querynodev2/segments/segment.go),
// and the terminal consumer JsonKeyStats::Load ignores it, taking the local
