...
func IsEvictableEnabled(kvs ...*commonpb.KeyValuePair) (bool, bool) {
	return GetEvictableByKey(EvictableKey, kvs...)
}
...
// ValidateEvictableEnabled accepts true or false case-insensitively.
func ValidateEvictableEnabled(value string) error {
	if !strings.EqualFold(value, "true") && !strings.EqualFold(value, "false") {
		return merr.WrapErrParameterInvalidMsg("invalid evictable enabled value: %s, must be true or false", value)
	}
	return nil
}
