...
const (
	...
	//   Keep the advertised default at V5 while readers/writers support V6.
	//   The 3.0.2 cluster version gate advances the build target to V6, including
	//   background migration, only after standby coordinators also upgrade.
