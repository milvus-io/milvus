...
// WithContext returns a logger with traceID extracted from the OpenTelemetry
// span carried by ctx. If ctx has no valid span, the logger is returned unchanged.
