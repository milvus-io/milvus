...
- [Standalone Quick Start Guide](https://milvus.io/docs/v2.1.x/install_standalone-docker.md)

- [Cluster Quick Start Guide](https://milvus.io/docs/v2.1.x/install_cluster-docker.md)
...
<img src="https://img.shields.io/badge/all--contributors-253-orange"><br>
