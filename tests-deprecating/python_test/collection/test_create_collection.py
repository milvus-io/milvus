...
class TestCreateCollection:
    ...
    ******************************************************************
    ...
    def test_create_collection_fields(
    ...
    def test_create_collection_after_insert(self, connect, collection):
        ...
        try:
            ...
            assert (
                message
                == "Create collection failed: meta table add collection failed,error = collection %s exist"
                % collection
            )
...
class TestCreateCollectionInvalid(object):
    ...
    @pytest.mark.tags(CaseLabel.L2)
    def test_create_collection_with_invalid_collection_name(
        self, connect, get_invalid_string
    ):
    ...
    def test_create_collection_with_empty_or_None_collection_name(
