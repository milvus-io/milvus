...
class Cell : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.Cell) */ {
 public:
  Cell();
  virtual ~Cell();
  ...
  bool has_vec() const;
  void clear_vec();
  static const int kVecFieldNumber = 5;
...
class RowValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.RowValue) */ {
 public:
  RowValue();
  virtual ~RowValue();
  ...
  inline RowValue* New() const { return New(NULL); }

  RowValue* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  bool _is_default_instance_;
  ::google::protobuf::RepeatedPtrField< ::pb::Cell > cell_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_pulsar_2eproto();
  friend void protobuf_AssignDesc_pulsar_2eproto();
  friend void protobuf_ShutdownFile_pulsar_2eproto();
...
inline ::google::protobuf::int32 Cell::int32_value() const {
...
inline void Cell::set_int32_value(::google::protobuf::int32 value) {
  if (!has_int32_value()) {
    clear_value();
    set_has_int32_value();
  }
...
inline ::google::protobuf::int64 Cell::int64_value() const {
...
inline void Cell::set_int64_value(::google::protobuf::int64 value) {
  if (!has_int64_value()) {
    clear_value();
    set_has_int64_value();
  }
...
// optional .pb.VectorRowRecord vec = 5;
inline bool Cell::has_vec() const {
  return value_case() == kVec;
}
inline void Cell::set_has_vec() {
  _oneof_case_[0] = kVec;
}
inline void Cell::clear_vec() {
  if (has_vec()) {
    delete value_.vec_;
    clear_has_value();
  }
}
inline  const ::pb::VectorRowRecord& Cell::vec() const {
  // @@protoc_insertion_point(field_get:pb.Cell.vec)
  return has_vec()
      ? *value_.vec_
      : ::pb::VectorRowRecord::default_instance();
}
inline ::pb::VectorRowRecord* Cell::mutable_vec() {
  if (!has_vec()) {
    clear_value();
    set_has_vec();
...
inline ::pb::VectorRowRecord* Cell::release_vec() {
...
inline void Cell::set_allocated_vec(::pb::VectorRowRecord* vec) {
  clear_value();
  if (vec) {
    set_has_vec();
    value_.vec_ = vec;
...
inline ::google::protobuf::RepeatedPtrField< ::pb::Cell >*
RowValue::mutable_cell() {
  // @@protoc_insertion_point(field_mutable_list:pb.RowValue.cell)
  return &cell_;
}
inline const ::google::protobuf::RepeatedPtrField< ::pb::Cell >&
RowValue::cell() const {
