...
struct IndexBinaryIVF : IndexBinary {
    ...
    void search(idx_t n, const uint8_t *x, idx_t k,
                int32_t *distances, idx_t *labels, const BitsetViewPtr bitset = nullptr) const override;


#if 0
    /** get raw vectors by ids */
    void get_vector_by_id(idx_t n, const idx_t *xid, uint8_t *x, const BitsetViewPtr bitset = nullptr) override;

    void search_by_id (idx_t n, const idx_t *xid, idx_t k, int32_t *distances, idx_t *labels,
                       const BitsetViewPtr bitset = nullptr) override;
#endif
