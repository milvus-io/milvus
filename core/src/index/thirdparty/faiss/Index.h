...
struct Index {
    ...
    virtual void search (idx_t n, const float *x, idx_t k,
                         ...
                         const BitsetViewPtr bitset = nullptr) const = 0;
     ...
     * @param bitset      flags to check the validity of vectors
     */
    virtual void get_vector_by_id (idx_t n, const idx_t *xid, float *x, const BitsetViewPtr bitset = nullptr);
    ...
    virtual void range_search (idx_t n, const float *x, float radius,
                               ...
                               const BitsetViewPtr bitset = nullptr) const;
