...
void DynamicResultSet::do_alloction() {
    if (count <= 0) {
...
void DynamicResultSet::do_sort(ResultSetPostProcessType postProcessType) {
...
DynamicResultSet DynamicResultCollector::Merge(size_t limit, ResultSetPostProcessType postProcessType) {
    if (limit <= 0) {
