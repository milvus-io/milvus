...
# define CORS_SUPPORT(RESPONSE)                                                                                                 \
    do {                                                                                                                        \
        ...
        (RESPONSE)->putHeaderIfNotExists(OString("Access-Control-Allow-Headers"), \
            OString("DNT, User-Agent, X-Requested-With, If-Modified-Since, Cache-Control, Content-Type, Range, Authorization"));                                     \
