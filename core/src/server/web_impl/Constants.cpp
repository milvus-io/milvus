...
const std::unordered_map<std::string, engine::EngineType> IndexNameMap = {
    {milvus::knowhere::IndexEnum::INDEX_FAISS_IDMAP, engine::EngineType::FAISS_IDMAP},
    {milvus::knowhere::IndexEnum::INDEX_FAISS_IVFFLAT, engine::EngineType::FAISS_IVFFLAT},
    {milvus::knowhere::IndexEnum::INDEX_FAISS_IVFSQ8, engine::EngineType::FAISS_IVFSQ8},
    {milvus::knowhere::IndexEnum::INDEX_FAISS_IVFSQ8H, engine::EngineType::FAISS_IVFSQ8H},
    {milvus::knowhere::IndexEnum::INDEX_NSG, engine::EngineType::NSG_MIX},
    {milvus::knowhere::IndexEnum::INDEX_FAISS_IVFPQ, engine::EngineType::FAISS_PQ},
    {milvus::knowhere::IndexEnum::INDEX_HNSW, engine::EngineType::HNSW},
    {milvus::knowhere::IndexEnum::INDEX_ANNOY, engine::EngineType::ANNOY},
    {milvus::knowhere::IndexEnum::INDEX_FAISS_IVFSQ8NR, engine::EngineType::FAISS_IVFSQ8NR},
    {milvus::knowhere::IndexEnum::INDEX_HNSW_SQ8NR, engine::EngineType::HNSW_SQ8NR}};
