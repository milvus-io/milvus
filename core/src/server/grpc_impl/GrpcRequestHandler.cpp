...
GrpcRequestHandler::CreateCollection(::grpc::ServerContext* context, const ::milvus::grpc::CollectionSchema* request,
    ...
    LOG_SERVER_INFO_ << LogOut("[reqid:%s] %s begin.", GetContext(context)->RequestID().c_str(), __func__);
    ...
    LOG_SERVER_INFO_ << LogOut("[reqid:%s] %s end.", GetContext(context)->RequestID().c_str(), __func__);
