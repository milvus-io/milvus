...
DropPartitionRequest::DropPartitionRequest(const std::shared_ptr<Context>& context, const ::milvus::grpc::PartitionParam* partition_param)
    : GrpcBaseRequest(context, DDL_DML_REQUEST_GROUP), partition_param_(partition_param) {
}

BaseRequestPtr
DropPartitionRequest::Create(const std::shared_ptr<Context>& context, const ::milvus::grpc::PartitionParam* partition_param) {
