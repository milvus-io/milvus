...
class MemManager {
 public:
    ...
    virtual Status
    DeleteEntity(int64_t collection_id, const std::vector<int64_t>& partition_ids, IDNumber vector_id, uint64_t lsn) = 0;

    virtual Status
    DeleteEntities(int64_t collection_id, const std::vector<int64_t>& partition_ids, int64_t length, const IDNumber* vector_ids, uint64_t lsn) = 0;
