...
GetEntityByIdSegmentHandler::Handle(const snapshot::SegmentPtr& segment) {
    ...
    STATUS_CHECK(snapshot::GetResPath(uid_blf_path, dir_root_, uid_blf_visitor));
    ...
    STATUS_CHECK(snapshot::GetResPath(uid_raw_path, dir_root_, uid_raw_visitor));
    ...
    STATUS_CHECK(snapshot::GetResPath(uid_del_path, dir_root_, uid_del_visitor));
