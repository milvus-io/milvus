...
using MetaFieldIntegralHelperTuple =
    std::tuple<MetaFieldIntegralHelper<snapshot::MappingsField>, MetaFieldIntegralHelper<snapshot::StateField>,
               ...
               MetaFieldIntegralHelper<snapshot::FieldElementIdField>,
               MetaFieldIntegralHelper<snapshot::PartitionIdField>, MetaFieldIntegralHelper<snapshot::SegmentIdField>,
               MetaFieldIntegralHelper<snapshot::TypeNameField>, MetaFieldIntegralHelper<snapshot::NameField>,
               MetaFieldIntegralHelper<snapshot::ParamsField>, MetaFieldIntegralHelper<snapshot::SizeField>,
               MetaFieldIntegralHelper<snapshot::RowCountField> >;
