...
void
DefaultIdBloomFilterFormat::read(const storage::OperationPtr& operation_ptr,
...
void
DefaultIdBloomFilterFormat::write(const storage::OperationPtr& operation_ptr,
...
void
DefaultIdBloomFilterFormat::create(const storage::OperationPtr& operation_ptr,
                                   segment::IdBloomFilterPtr& id_bloom_filter_ptr) {
    std::string dir_path = operation_ptr->GetDirectory();
    const std::string bloom_filter_file_path = dir_path + "/" + bloom_filter_filename_;
    scaling_bloom_t* bloom_filter =
