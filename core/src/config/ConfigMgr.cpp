...
ConfigMgr::ConfigMgr() {
    config_list_ = {
        ...
        {"storage.s3_enable",
         CreateBoolConfig("storage.s3_enable", false, &config.storage.s3_enable.value, true, nullptr, nullptr)},
        {"storage.s3_address", CreateStringConfig("storage.s3_address", false, &config.storage.s3_address.value,
                                                  "127.0.0.1", nullptr, nullptr)},
        {"storage.s3_port", CreateStringConfig("storage.s3_port", false, &config.storage.s3_port.value,
                                               "9000", nullptr, nullptr)},
        {"storage.s3_access_key",
         CreateStringConfig("storage.s3_access_key", false, &config.storage.s3_access_key.value,
                            "minioadmin", nullptr, nullptr)},
        {"storage.s3_secret_key",
         CreateStringConfig("storage.s3_secret_key", false, &config.storage.s3_secret_key.value,
                            "minioadmin", nullptr, nullptr)},
        {"storage.s3_bucket",
         CreateStringConfig("storage.s3_bucket", false, &config.storage.s3_bucket.value,
                            "milvus-bucket", nullptr, nullptr)},
