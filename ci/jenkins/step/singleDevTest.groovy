timeout(time: 120, unit: 'MINUTES') {
	...
	sh 'python3 -m pip install git+https://github.com/BossZou/pymilvus.git@master'
        sh "export GRPC_VERBOSITY=DEBUG && export GRPC_TRACE=call_error,op_failure,client_channel_call,client_channel_routing && pytest . --alluredir=\"test_out/dev/single/mysql\" --level=1 --ip ${env.HELM_RELEASE_NAME}.milvus.svc.cluster.local --service ${env.HELM_RELEASE_NAME}"
