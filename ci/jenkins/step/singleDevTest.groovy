timeout(time: 120, unit: 'MINUTES') {
    ...
    dir ("tests/milvus_python_test") {
        ...
        sh "pytest . --alluredir=\"test_out/dev/single/mysql\" --tag pr --ip ${env.HELM_RELEASE_NAME}.milvus.svc.cluster.local --service ${env.HELM_RELEASE_NAME} >> ${WORKSPACE}/${env.DEV_TEST_ARTIFACTS}/milvus_${BINARY_VERSION}_mysql_dev_test.log"
