timeout(time: 120, unit: 'MINUTES') {
    ...
    dir ("tests/milvus_python_test") {
        ...
        sh "pytest . --alluredir=\"test_out/dev/single/mysql\" --level=1 --ip ${env.HELM_RELEASE_NAME}.milvus.svc.cluster.local --service ${env.HELM_RELEASE_NAME} >> milvus_mysql_dev_test.log"
