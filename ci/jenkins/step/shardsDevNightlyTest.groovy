timeout(time: 180, unit: 'MINUTES') {
    ...
    dir ("tests/milvus_python_test") {
        ...
        sh "pytest . --alluredir=\"test_out/dev/shards/\" --ip ${env.SHARDS_HELM_RELEASE_NAME}.milvus.svc.cluster.local >> ${WORKSPACE}/${env.DEV_TEST_ARTIFACTS}/milvus_${BINARY_VERSION}_shards_dev_test.log"
    }
}
