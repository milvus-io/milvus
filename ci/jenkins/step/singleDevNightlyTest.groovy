timeout(time: 180, unit: 'MINUTES') {
    ...
    dir ("tests/milvus_python_test") {
        ...
        sh "pytest . --level=2 --alluredir=\"test_out/dev/single/mysql\" --ip ${env.HELM_RELEASE_NAME}.milvus.svc.cluster.local >> milvus_mysql_dev_test.log"
    }
    ...
    dir ("tests/milvus_python_test") {
        sh "pytest . --level=2 --alluredir=\"test_out/dev/single/sqlite\" --ip ${env.HELM_RELEASE_NAME}.milvus.svc.cluster.local >> milvus_sqlite_dev_test.log"
