...
require (
	...
	github.com/milvus-io/milvus-storage/go v0.1.0
...
replace (
	...
	github.com/milvus-io/milvus-storage/go => github.com/shaoting-huang/milvus-storage/go v0.0.0-20250117065452-0d60d5ddc149
