...
class ApiIndexWrapper:
    ...
    def init_index(self, collection, field_name, index_params, name="",check_task=None, check_params=None, **kwargs):
        ...
        check_result = ResponseChecker(res, func_name, check_task, check_params, is_succ, collection=collection, field_name=field_name,
    ...
    def drop(self, check_task=None, check_params=None, **kwargs):
        ...
        check_result = ResponseChecker(res, func_name, check_task, check_params, is_succ, **kwargs).run()
        return res, check_result
