...
func (suite *CollectionObserverSuite) isCollectionLoaded(collection int64) bool {
	...
	segments := suite.targetMgr.GetSealedSegmentByCollection(collection, meta.CurrentTarget)
...
func (suite *CollectionObserverSuite) isPartitionLoaded(partitionID int64) bool {
	...
	channels := suite.targetMgr.GetDmChannelsByCollection(collection, meta.CurrentTarget)
	segments := suite.targetMgr.GetSealedSegmentByPartition(collection, partitionID, meta.CurrentTarget)
...
func (suite *CollectionObserverSuite) loadAll() {
	...
	suite.targetMgr.UpdateCurrentTarget(suite.collections[0])
	suite.targetMgr.UpdateNextTarget(suite.collections[0])
	suite.targetMgr.UpdateCurrentTarget(suite.collections[2])
	suite.targetMgr.UpdateNextTarget(suite.collections[2])
}
...
func (suite *CollectionObserverSuite) load(collection int64) {
	...
	suite.targetMgr.UpdateNextTarget(collection)
}
