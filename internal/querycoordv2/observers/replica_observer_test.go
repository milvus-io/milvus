...
func (suite *ReplicaObserverSuite) TestCheckNodesInReplica() {
	...
	suite.Eventually(func() bool {
		...
		return (replica0.Contains(3) || replica0.ContainOutboundNode(3)) && suite.NotContains(replica1.GetNodes(), int64(3)) && suite.Len(replica1.GetNodes(), 1)
	...
	suite.Eventually(func() bool {
		replica0 := suite.meta.ReplicaManager.Get(10000)
		replica1 := suite.meta.ReplicaManager.Get(10001)
		return (!replica0.Contains(3) && !replica0.ContainOutboundNode(3)) && suite.Contains(replica1.GetNodes(), int64(3)) && suite.Len(replica1.GetNodes(), 2)
	}, 6*time.Second, 2*time.Second)
}
