...
func (action *SegmentAction) Desc() string {
	return fmt.Sprintf("type:%s nodeID: %d, scope:%s", action.Type().String(), action.Node(), action.Scope.String())
}
...
func (action *ChannelAction) Desc() string {
	return fmt.Sprintf("type:%s nodeID: %d", action.Type().String(), action.Node())
}
...
func (action *LeaderAction) Desc() string {
	return fmt.Sprintf("type:%s nodeID: %d segmentID:%d version:%d",
		action.Type().String(), action.Node(), action.SegmentID(), action.Version())
}
