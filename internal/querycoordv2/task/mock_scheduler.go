...
// WaitCollectionIdle provides a mock function with given fields: ctx, collectionID
func (_m *MockScheduler) WaitCollectionIdle(ctx context.Context, collectionID int64) error {
	ret := _m.Called(ctx, collectionID)

	if len(ret) == 0 {
		panic("no return value specified for WaitCollectionIdle")
	}
...
// MockScheduler_WaitCollectionIdle_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WaitCollectionIdle'
type MockScheduler_WaitCollectionIdle_Call struct {
	*mock.Call
}

// WaitCollectionIdle is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
func (_e *MockScheduler_Expecter) WaitCollectionIdle(ctx interface{}, collectionID interface{}) *MockScheduler_WaitCollectionIdle_Call {
	return &MockScheduler_WaitCollectionIdle_Call{Call: _e.mock.On("WaitCollectionIdle", ctx, collectionID)}
}

func (_c *MockScheduler_WaitCollectionIdle_Call) Run(run func(ctx context.Context, collectionID int64)) *MockScheduler_WaitCollectionIdle_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockScheduler_WaitCollectionIdle_Call) Return(_a0 error) *MockScheduler_WaitCollectionIdle_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockScheduler_WaitCollectionIdle_Call) RunAndReturn(run func(context.Context, int64) error) *MockScheduler_WaitCollectionIdle_Call {
	_c.Call.Return(run)
	return _c
}
