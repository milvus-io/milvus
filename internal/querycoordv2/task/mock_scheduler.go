...
// RemoveByCollection provides a mock function with given fields: collection
func (_m *MockScheduler) RemoveByCollection(collection int64) {
	_m.Called(collection)
}

// MockScheduler_RemoveByCollection_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoveByCollection'
type MockScheduler_RemoveByCollection_Call struct {
	*mock.Call
}

// RemoveByCollection is a helper method to define mock.On call
//  - collection int64
func (_e *MockScheduler_Expecter) RemoveByCollection(collection interface{}) *MockScheduler_RemoveByCollection_Call {
	return &MockScheduler_RemoveByCollection_Call{Call: _e.mock.On("RemoveByCollection", collection)}
}

func (_c *MockScheduler_RemoveByCollection_Call) Run(run func(collection int64)) *MockScheduler_RemoveByCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64))
	})
	return _c
...
func (_c *MockScheduler_RemoveByCollection_Call) Return() *MockScheduler_RemoveByCollection_Call {
	_c.Call.Return()
	return _c
}
