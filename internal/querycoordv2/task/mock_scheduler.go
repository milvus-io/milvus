...
import (
	autoscale "github.com/milvus-io/milvus/internal/querycoordv2/autoscale"
...
// GetAutoscaleInflightLoadResource provides a mock function with given fields: nodeIDs
func (_m *MockScheduler) GetAutoscaleInflightLoadResource(nodeIDs []int64) autoscale.ResourceUsage {
	ret := _m.Called(nodeIDs)

	if len(ret) == 0 {
		panic("no return value specified for GetAutoscaleInflightLoadResource")
	}

	var r0 autoscale.ResourceUsage
	if rf, ok := ret.Get(0).(func([]int64) autoscale.ResourceUsage); ok {
		r0 = rf(nodeIDs)
	} else {
		r0 = ret.Get(0).(autoscale.ResourceUsage)
	}

	return r0
}

// MockScheduler_GetAutoscaleInflightLoadResource_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAutoscaleInflightLoadResource'
type MockScheduler_GetAutoscaleInflightLoadResource_Call struct {
	*mock.Call
}

// GetAutoscaleInflightLoadResource is a helper method to define mock.On call
//   - nodeIDs []int64
func (_e *MockScheduler_Expecter) GetAutoscaleInflightLoadResource(nodeIDs interface{}) *MockScheduler_GetAutoscaleInflightLoadResource_Call {
	return &MockScheduler_GetAutoscaleInflightLoadResource_Call{Call: _e.mock.On("GetAutoscaleInflightLoadResource", nodeIDs)}
}

func (_c *MockScheduler_GetAutoscaleInflightLoadResource_Call) Run(run func(nodeIDs []int64)) *MockScheduler_GetAutoscaleInflightLoadResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]int64))
	})
	return _c
...
func (_c *MockScheduler_GetAutoscaleInflightLoadResource_Call) Return(_a0 autoscale.ResourceUsage) *MockScheduler_GetAutoscaleInflightLoadResource_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockScheduler_GetAutoscaleInflightLoadResource_Call) RunAndReturn(run func([]int64) autoscale.ResourceUsage) *MockScheduler_GetAutoscaleInflightLoadResource_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetSegmentTaskDeltaSnapshot provides a mock function with given fields: nodeIDs, collectionID
func (_m *MockScheduler) GetSegmentTaskDeltaSnapshot(nodeIDs []int64, collectionID int64) *SegmentTaskDeltaSnapshot {
	ret := _m.Called(nodeIDs, collectionID)

	if len(ret) == 0 {
		panic("no return value specified for GetSegmentTaskDeltaSnapshot")
	}

	var r0 *SegmentTaskDeltaSnapshot
	if rf, ok := ret.Get(0).(func([]int64, int64) *SegmentTaskDeltaSnapshot); ok {
		r0 = rf(nodeIDs, collectionID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*SegmentTaskDeltaSnapshot)
		}
	}
...
// MockScheduler_GetSegmentTaskDeltaSnapshot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetSegmentTaskDeltaSnapshot'
type MockScheduler_GetSegmentTaskDeltaSnapshot_Call struct {
	*mock.Call
}

// GetSegmentTaskDeltaSnapshot is a helper method to define mock.On call
//   - nodeIDs []int64
//   - collectionID int64
func (_e *MockScheduler_Expecter) GetSegmentTaskDeltaSnapshot(nodeIDs interface{}, collectionID interface{}) *MockScheduler_GetSegmentTaskDeltaSnapshot_Call {
	return &MockScheduler_GetSegmentTaskDeltaSnapshot_Call{Call: _e.mock.On("GetSegmentTaskDeltaSnapshot", nodeIDs, collectionID)}
}

func (_c *MockScheduler_GetSegmentTaskDeltaSnapshot_Call) Run(run func(nodeIDs []int64, collectionID int64)) *MockScheduler_GetSegmentTaskDeltaSnapshot_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]int64), args[1].(int64))
	})
	return _c
...
func (_c *MockScheduler_GetSegmentTaskDeltaSnapshot_Call) Return(_a0 *SegmentTaskDeltaSnapshot) *MockScheduler_GetSegmentTaskDeltaSnapshot_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockScheduler_GetSegmentTaskDeltaSnapshot_Call) RunAndReturn(run func([]int64, int64) *SegmentTaskDeltaSnapshot) *MockScheduler_GetSegmentTaskDeltaSnapshot_Call {
	_c.Call.Return(run)
	return _c
}
