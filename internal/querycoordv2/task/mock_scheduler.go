...
// ResetExecutorPending provides a mock function with given fields: nodeID, loadedSegments
func (_m *MockScheduler) ResetExecutorPending(nodeID int64, loadedSegments typeutil.Set[int64]) {
	_m.Called(nodeID, loadedSegments)
}
...
func (_e *MockScheduler_Expecter) ResetExecutorPending(nodeID interface{}, loadedSegments interface{}) *MockScheduler_ResetExecutorPending_Call {
	return &MockScheduler_ResetExecutorPending_Call{Call: _e.mock.On("ResetExecutorPending", nodeID, loadedSegments)}
}

func (_c *MockScheduler_ResetExecutorPending_Call) Run(run func(nodeID int64, loadedSegments typeutil.Set[int64])) *MockScheduler_ResetExecutorPending_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64), args[1].(typeutil.Set[int64]))
	})
	return _c
}
...
func (_c *MockScheduler_ResetExecutorPending_Call) RunAndReturn(run func(int64, typeutil.Set[int64])) *MockScheduler_ResetExecutorPending_Call {
	_c.Call.Return(run)
	return _c
}
