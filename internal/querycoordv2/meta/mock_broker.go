...
func (_m *MockBroker) ListIndexes(ctx context.Context, collectionID int64) ([]*indexpb.IndexInfo, uint64, error) {
	ret := _m.Called(ctx, collectionID)
	...
	var r1 uint64
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) ([]*indexpb.IndexInfo, uint64, error)); ok {
		return rf(ctx, collectionID)
	}
...
func (_c *MockBroker_ListIndexes_Call) Return(_a0 []*indexpb.IndexInfo, _a1 uint64, _a2 error) *MockBroker_ListIndexes_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockBroker_ListIndexes_Call) RunAndReturn(run func(context.Context, int64) ([]*indexpb.IndexInfo, uint64, error)) *MockBroker_ListIndexes_Call {
	_c.Call.Return(run)
	return _c
}
