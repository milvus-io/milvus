...
func (_m *MockChannelDistManager) Update(nodeID int64, channels ...*DmChannel) {
...
func (_c *MockChannelDistManager_Update_Call) Return() *MockChannelDistManager_Update_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockChannelDistManager_Update_Call) RunAndReturn(run func(int64, ...*DmChannel)) *MockChannelDistManager_Update_Call {
	_c.Call.Return(run)
	return _c
}
