...
// GCLiveVersions provides a mock function with given fields: collectionID, channel, readableVersions
func (_m *MockTargetManager) GCLiveVersions(collectionID int64, channel string, readableVersions typeutil.Set[int64]) {
	_m.Called(collectionID, channel, readableVersions)
}

// MockTargetManager_GCLiveVersions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GCLiveVersions'
type MockTargetManager_GCLiveVersions_Call struct {
	*mock.Call
}

// GCLiveVersions is a helper method to define mock.On call
//   - collectionID int64
//   - channel string
//   - readableVersions typeutil.Set[int64]
func (_e *MockTargetManager_Expecter) GCLiveVersions(collectionID interface{}, channel interface{}, readableVersions interface{}) *MockTargetManager_GCLiveVersions_Call {
	return &MockTargetManager_GCLiveVersions_Call{Call: _e.mock.On("GCLiveVersions", collectionID, channel, readableVersions)}
}

func (_c *MockTargetManager_GCLiveVersions_Call) Run(run func(collectionID int64, channel string, readableVersions typeutil.Set[int64])) *MockTargetManager_GCLiveVersions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64), args[1].(string), args[2].(typeutil.Set[int64]))
	})
	return _c
}

func (_c *MockTargetManager_GCLiveVersions_Call) Return() *MockTargetManager_GCLiveVersions_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockTargetManager_GCLiveVersions_Call) RunAndReturn(run func(int64, string, typeutil.Set[int64])) *MockTargetManager_GCLiveVersions_Call {
	_c.Run(run)
	return _c
}

// GetChannelTargetVersion provides a mock function with given fields: ctx, collectionID, channel, scope
func (_m *MockTargetManager) GetChannelTargetVersion(ctx context.Context, collectionID int64, channel string, scope int32) int64 {
	ret := _m.Called(ctx, collectionID, channel, scope)

	if len(ret) == 0 {
		panic("no return value specified for GetChannelTargetVersion")
	}
...
// MockTargetManager_GetChannelTargetVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetChannelTargetVersion'
type MockTargetManager_GetChannelTargetVersion_Call struct {
	*mock.Call
}

// GetChannelTargetVersion is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
//   - channel string
//   - scope int32
func (_e *MockTargetManager_Expecter) GetChannelTargetVersion(ctx interface{}, collectionID interface{}, channel interface{}, scope interface{}) *MockTargetManager_GetChannelTargetVersion_Call {
	return &MockTargetManager_GetChannelTargetVersion_Call{Call: _e.mock.On("GetChannelTargetVersion", ctx, collectionID, channel, scope)}
}

func (_c *MockTargetManager_GetChannelTargetVersion_Call) Run(run func(ctx context.Context, collectionID int64, channel string, scope int32)) *MockTargetManager_GetChannelTargetVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTargetManager_GetChannelTargetVersion_Call) Return(_a0 int64) *MockTargetManager_GetChannelTargetVersion_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTargetManager_GetChannelTargetVersion_Call) RunAndReturn(run func(context.Context, int64, string, int32) int64) *MockTargetManager_GetChannelTargetVersion_Call {
	_c.Call.Return(run)
	return _c
}
...
// IsSegmentInLiveVersion provides a mock function with given fields: collectionID, channel, version, segmentID
func (_m *MockTargetManager) IsSegmentInLiveVersion(collectionID int64, channel string, version int64, segmentID int64) (bool, bool) {
	ret := _m.Called(collectionID, channel, version, segmentID)

	if len(ret) == 0 {
		panic("no return value specified for IsSegmentInLiveVersion")
	}

	var r0 bool
	var r1 bool
	if rf, ok := ret.Get(0).(func(int64, string, int64, int64) (bool, bool)); ok {
		return rf(collectionID, channel, version, segmentID)
	}
	if rf, ok := ret.Get(0).(func(int64, string, int64, int64) bool); ok {
		r0 = rf(collectionID, channel, version, segmentID)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(int64, string, int64, int64) bool); ok {
		r1 = rf(collectionID, channel, version, segmentID)
	} else {
		r1 = ret.Get(1).(bool)
	}
...
// MockTargetManager_IsSegmentInLiveVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsSegmentInLiveVersion'
type MockTargetManager_IsSegmentInLiveVersion_Call struct {
	*mock.Call
}

// IsSegmentInLiveVersion is a helper method to define mock.On call
//   - collectionID int64
//   - channel string
//   - version int64
//   - segmentID int64
func (_e *MockTargetManager_Expecter) IsSegmentInLiveVersion(collectionID interface{}, channel interface{}, version interface{}, segmentID interface{}) *MockTargetManager_IsSegmentInLiveVersion_Call {
	return &MockTargetManager_IsSegmentInLiveVersion_Call{Call: _e.mock.On("IsSegmentInLiveVersion", collectionID, channel, version, segmentID)}
}

func (_c *MockTargetManager_IsSegmentInLiveVersion_Call) Run(run func(collectionID int64, channel string, version int64, segmentID int64)) *MockTargetManager_IsSegmentInLiveVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64), args[1].(string), args[2].(int64), args[3].(int64))
	})
	return _c
}

func (_c *MockTargetManager_IsSegmentInLiveVersion_Call) Return(_a0 bool, _a1 bool) *MockTargetManager_IsSegmentInLiveVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTargetManager_IsSegmentInLiveVersion_Call) RunAndReturn(run func(int64, string, int64, int64) (bool, bool)) *MockTargetManager_IsSegmentInLiveVersion_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateChannelCurrentTarget provides a mock function with given fields: ctx, collectionID, channel
func (_m *MockTargetManager) UpdateChannelCurrentTarget(ctx context.Context, collectionID int64, channel string) bool {
	ret := _m.Called(ctx, collectionID, channel)

	if len(ret) == 0 {
		panic("no return value specified for UpdateChannelCurrentTarget")
	}
...
// MockTargetManager_UpdateChannelCurrentTarget_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateChannelCurrentTarget'
type MockTargetManager_UpdateChannelCurrentTarget_Call struct {
	*mock.Call
}

// UpdateChannelCurrentTarget is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
//   - channel string
func (_e *MockTargetManager_Expecter) UpdateChannelCurrentTarget(ctx interface{}, collectionID interface{}, channel interface{}) *MockTargetManager_UpdateChannelCurrentTarget_Call {
	return &MockTargetManager_UpdateChannelCurrentTarget_Call{Call: _e.mock.On("UpdateChannelCurrentTarget", ctx, collectionID, channel)}
}

func (_c *MockTargetManager_UpdateChannelCurrentTarget_Call) Run(run func(ctx context.Context, collectionID int64, channel string)) *MockTargetManager_UpdateChannelCurrentTarget_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTargetManager_UpdateChannelCurrentTarget_Call) Return(_a0 bool) *MockTargetManager_UpdateChannelCurrentTarget_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTargetManager_UpdateChannelCurrentTarget_Call) RunAndReturn(run func(context.Context, int64, string) bool) *MockTargetManager_UpdateChannelCurrentTarget_Call {
	_c.Call.Return(run)
	return _c
}
