...
// GetSealedSegmentIDsByChannel provides a mock function with given fields: ctx, collectionID, channelName, scope
func (_m *MockTargetManager) GetSealedSegmentIDsByChannel(ctx context.Context, collectionID int64, channelName string, scope int32) typeutil.Set[int64] {
	ret := _m.Called(ctx, collectionID, channelName, scope)

	if len(ret) == 0 {
		panic("no return value specified for GetSealedSegmentIDsByChannel")
	}
...
// MockTargetManager_GetSealedSegmentIDsByChannel_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetSealedSegmentIDsByChannel'
type MockTargetManager_GetSealedSegmentIDsByChannel_Call struct {
	*mock.Call
}

// GetSealedSegmentIDsByChannel is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
//   - channelName string
//   - scope int32
func (_e *MockTargetManager_Expecter) GetSealedSegmentIDsByChannel(ctx interface{}, collectionID interface{}, channelName interface{}, scope interface{}) *MockTargetManager_GetSealedSegmentIDsByChannel_Call {
	return &MockTargetManager_GetSealedSegmentIDsByChannel_Call{Call: _e.mock.On("GetSealedSegmentIDsByChannel", ctx, collectionID, channelName, scope)}
}

func (_c *MockTargetManager_GetSealedSegmentIDsByChannel_Call) Run(run func(ctx context.Context, collectionID int64, channelName string, scope int32)) *MockTargetManager_GetSealedSegmentIDsByChannel_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(string), args[3].(int32))
	})
	return _c
...
func (_c *MockTargetManager_GetSealedSegmentIDsByChannel_Call) Return(_a0 typeutil.Set[int64]) *MockTargetManager_GetSealedSegmentIDsByChannel_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTargetManager_GetSealedSegmentIDsByChannel_Call) RunAndReturn(run func(context.Context, int64, string, int32) typeutil.Set[int64]) *MockTargetManager_GetSealedSegmentIDsByChannel_Call {
	_c.Call.Return(run)
	return _c
}

// GetSealedSegmentIDsByCollection provides a mock function with given fields: ctx, collectionID, scope
func (_m *MockTargetManager) GetSealedSegmentIDsByCollection(ctx context.Context, collectionID int64, scope int32) typeutil.Set[int64] {
	ret := _m.Called(ctx, collectionID, scope)

	if len(ret) == 0 {
		panic("no return value specified for GetSealedSegmentIDsByCollection")
	}
...
// MockTargetManager_GetSealedSegmentIDsByCollection_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetSealedSegmentIDsByCollection'
type MockTargetManager_GetSealedSegmentIDsByCollection_Call struct {
	*mock.Call
}

// GetSealedSegmentIDsByCollection is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
//   - scope int32
func (_e *MockTargetManager_Expecter) GetSealedSegmentIDsByCollection(ctx interface{}, collectionID interface{}, scope interface{}) *MockTargetManager_GetSealedSegmentIDsByCollection_Call {
	return &MockTargetManager_GetSealedSegmentIDsByCollection_Call{Call: _e.mock.On("GetSealedSegmentIDsByCollection", ctx, collectionID, scope)}
}

func (_c *MockTargetManager_GetSealedSegmentIDsByCollection_Call) Run(run func(ctx context.Context, collectionID int64, scope int32)) *MockTargetManager_GetSealedSegmentIDsByCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(int32))
	})
	return _c
...
func (_c *MockTargetManager_GetSealedSegmentIDsByCollection_Call) Return(_a0 typeutil.Set[int64]) *MockTargetManager_GetSealedSegmentIDsByCollection_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTargetManager_GetSealedSegmentIDsByCollection_Call) RunAndReturn(run func(context.Context, int64, int32) typeutil.Set[int64]) *MockTargetManager_GetSealedSegmentIDsByCollection_Call {
	_c.Call.Return(run)
	return _c
}

// GetSealedSegmentIDsByPartition provides a mock function with given fields: ctx, collectionID, partitionID, scope
func (_m *MockTargetManager) GetSealedSegmentIDsByPartition(ctx context.Context, collectionID int64, partitionID int64, scope int32) typeutil.Set[int64] {
	ret := _m.Called(ctx, collectionID, partitionID, scope)

	if len(ret) == 0 {
		panic("no return value specified for GetSealedSegmentIDsByPartition")
	}

	var r0 typeutil.Set[int64]
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, int32) typeutil.Set[int64]); ok {
...
// MockTargetManager_GetSealedSegmentIDsByPartition_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetSealedSegmentIDsByPartition'
type MockTargetManager_GetSealedSegmentIDsByPartition_Call struct {
	*mock.Call
}

// GetSealedSegmentIDsByPartition is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
//   - partitionID int64
//   - scope int32
func (_e *MockTargetManager_Expecter) GetSealedSegmentIDsByPartition(ctx interface{}, collectionID interface{}, partitionID interface{}, scope interface{}) *MockTargetManager_GetSealedSegmentIDsByPartition_Call {
	return &MockTargetManager_GetSealedSegmentIDsByPartition_Call{Call: _e.mock.On("GetSealedSegmentIDsByPartition", ctx, collectionID, partitionID, scope)}
}

func (_c *MockTargetManager_GetSealedSegmentIDsByPartition_Call) Run(run func(ctx context.Context, collectionID int64, partitionID int64, scope int32)) *MockTargetManager_GetSealedSegmentIDsByPartition_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(int64), args[3].(int32))
	})
	return _c
...
func (_c *MockTargetManager_GetSealedSegmentIDsByPartition_Call) Return(_a0 typeutil.Set[int64]) *MockTargetManager_GetSealedSegmentIDsByPartition_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTargetManager_GetSealedSegmentIDsByPartition_Call) RunAndReturn(run func(context.Context, int64, int64, int32) typeutil.Set[int64]) *MockTargetManager_GetSealedSegmentIDsByPartition_Call {
	_c.Call.Return(run)
	return _c
}
...
// HasSealedSegment provides a mock function with given fields: ctx, collectionID, id, scope
func (_m *MockTargetManager) HasSealedSegment(ctx context.Context, collectionID int64, id int64, scope int32) bool {
	ret := _m.Called(ctx, collectionID, id, scope)

	if len(ret) == 0 {
		panic("no return value specified for HasSealedSegment")
	}

	var r0 bool
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, int32) bool); ok {
		r0 = rf(ctx, collectionID, id, scope)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
// MockTargetManager_HasSealedSegment_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasSealedSegment'
type MockTargetManager_HasSealedSegment_Call struct {
	*mock.Call
}

// HasSealedSegment is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
//   - id int64
//   - scope int32
func (_e *MockTargetManager_Expecter) HasSealedSegment(ctx interface{}, collectionID interface{}, id interface{}, scope interface{}) *MockTargetManager_HasSealedSegment_Call {
	return &MockTargetManager_HasSealedSegment_Call{Call: _e.mock.On("HasSealedSegment", ctx, collectionID, id, scope)}
}

func (_c *MockTargetManager_HasSealedSegment_Call) Run(run func(ctx context.Context, collectionID int64, id int64, scope int32)) *MockTargetManager_HasSealedSegment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(int64), args[3].(int32))
	})
	return _c
...
func (_c *MockTargetManager_HasSealedSegment_Call) Return(_a0 bool) *MockTargetManager_HasSealedSegment_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTargetManager_HasSealedSegment_Call) RunAndReturn(run func(context.Context, int64, int64, int32) bool) *MockTargetManager_HasSealedSegment_Call {
	_c.Call.Return(run)
	return _c
}
