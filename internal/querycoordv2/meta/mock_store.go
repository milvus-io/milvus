...
// SaveResourceGroup provides a mock function with given fields: rgName, rg
func (_m *MockStore) SaveResourceGroup(rgName string, rg *querypb.ResourceGroup) error {
	ret := _m.Called(rgName, rg)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, *querypb.ResourceGroup) error); ok {
		r0 = rf(rgName, rg)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockStore_Expecter) SaveResourceGroup(rgName interface{}, rg interface{}) *MockStore_SaveResourceGroup_Call {
	return &MockStore_SaveResourceGroup_Call{Call: _e.mock.On("SaveResourceGroup", rgName, rg)}
}

func (_c *MockStore_SaveResourceGroup_Call) Run(run func(rgName string, rg *querypb.ResourceGroup)) *MockStore_SaveResourceGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*querypb.ResourceGroup))
	})
	return _c
}
