...
func (suite *ResourceManagerSuite) TestValidateConfiguration() {
	...
	cfg.From = []*rgpb.ResourceGroupTransfer{{ResourceGroup: DefaultResourceGroupName}}
	err = suite.manager.validateResourceGroupConfig("rg1", cfg)
	suite.ErrorIs(err, ErrIllegalRGConfig)

	cfg = createResourceGroupConfig(0, 0)
	cfg.From = []*rgpb.ResourceGroupTransfer{{ResourceGroup: "rg1"}}
	err = suite.manager.validateResourceGroupConfig("rg1", cfg)
	suite.ErrorIs(err, ErrIllegalRGConfig)

	cfg = createResourceGroupConfig(0, 0)
	cfg.From = []*rgpb.ResourceGroupTransfer{{ResourceGroup: "rg2"}}
	err = suite.manager.validateResourceGroupConfig("rg1", cfg)
	suite.ErrorIs(err, ErrIllegalRGConfig)

	cfg = createResourceGroupConfig(0, 0)
	cfg.To = []*rgpb.ResourceGroupTransfer{{ResourceGroup: DefaultResourceGroupName}}
	err = suite.manager.validateResourceGroupConfig("rg1", cfg)
	suite.ErrorIs(err, ErrIllegalRGConfig)

	cfg = createResourceGroupConfig(0, 0)
	cfg.To = []*rgpb.ResourceGroupTransfer{{ResourceGroup: "rg1"}}
	err = suite.manager.validateResourceGroupConfig("rg1", cfg)
	suite.ErrorIs(err, ErrIllegalRGConfig)

	cfg = createResourceGroupConfig(0, 0)
	cfg.To = []*rgpb.ResourceGroupTransfer{{ResourceGroup: "rg2"}}
	err = suite.manager.validateResourceGroupConfig("rg1", cfg)
	suite.ErrorIs(err, ErrIllegalRGConfig)
