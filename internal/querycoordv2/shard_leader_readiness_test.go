...
func (f *shardLeaderReadinessFixture) readiness(t *testing.T, collectionID int64, rgName string) extension.ShardLeaderReadiness {
	t.Helper()
...
func TestShardLeaderReadinessByRG_LeaderInOneRGDoesNotMakeAnotherReady(t *testing.T) {
	...
	assert.Equal(t, extension.ShardLeadersReasonShardsWithoutLeader, rgB.Reason)
...
func TestShardLeaderReadinessByRG_NoReplicaInRG(t *testing.T) {
	...
	assert.Equal(t, extension.ShardLeadersReasonNoReplicaInResourceGroup, got.Reason,
...
func TestShardLeaderReadinessByRG_UnserviceableLeaderIsNotReady(t *testing.T) {
	...
	assert.Equal(t, extension.ShardLeadersReasonShardsWithoutLeader, got.Reason)
...
func TestShardLeaderReadinessByRG_NoChannelTarget(t *testing.T) {
	...
	assert.Equal(t, extension.ShardLeadersReasonNoChannelTarget, got.Reason)
	assert.Zero(t, got.TotalShards)
}
...
func TestShardLeaderReadinessByRG_FailedLoadIsSurfaced(t *testing.T) {
	...
	assert.False(t, got.Ready)
	assert.Equal(t, extension.ShardLeadersReasonCollectionNotLoaded, got.Reason)
}
...
func TestShardLeaderReadinessByRG_UninitializedServer(t *testing.T) {
	...
	assert.NotPanics(t, func() {
		...
		assert.False(t, got.Ready)
		assert.Equal(t, extension.ShardLeadersReasonCoordinatorNotReady, got.Reason)
	})
}
