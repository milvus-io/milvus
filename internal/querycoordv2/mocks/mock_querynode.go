...
func (_m *MockQueryNodeServer) ClearReadTaskQueue(_a0 context.Context, _a1 *internalpb.ClearReadTaskQueueRequest) (*internalpb.ClearReadTaskQueueResponse, error) {
...
// MockQueryNodeServer_ClearReadTaskQueue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ClearReadTaskQueue'
type MockQueryNodeServer_ClearReadTaskQueue_Call struct {
	*mock.Call
}
...
func (_e *MockQueryNodeServer_Expecter) ClearReadTaskQueue(_a0 interface{}, _a1 interface{}) *MockQueryNodeServer_ClearReadTaskQueue_Call {
	return &MockQueryNodeServer_ClearReadTaskQueue_Call{Call: _e.mock.On("ClearReadTaskQueue", _a0, _a1)}
}

func (_c *MockQueryNodeServer_ClearReadTaskQueue_Call) Run(run func(_a0 context.Context, _a1 *internalpb.ClearReadTaskQueueRequest)) *MockQueryNodeServer_ClearReadTaskQueue_Call {
...
func (_c *MockQueryNodeServer_ClearReadTaskQueue_Call) Return(_a0 *internalpb.ClearReadTaskQueueResponse, _a1 error) *MockQueryNodeServer_ClearReadTaskQueue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNodeServer_ClearReadTaskQueue_Call) RunAndReturn(run func(context.Context, *internalpb.ClearReadTaskQueueRequest) (*internalpb.ClearReadTaskQueueResponse, error)) *MockQueryNodeServer_ClearReadTaskQueue_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockQueryNodeServer) Prewarm(_a0 context.Context, _a1 *querypb.PrewarmRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
...
// MockQueryNodeServer_Prewarm_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Prewarm'
type MockQueryNodeServer_Prewarm_Call struct {
	*mock.Call
}
...
func (_e *MockQueryNodeServer_Expecter) Prewarm(_a0 interface{}, _a1 interface{}) *MockQueryNodeServer_Prewarm_Call {
	return &MockQueryNodeServer_Prewarm_Call{Call: _e.mock.On("Prewarm", _a0, _a1)}
}

func (_c *MockQueryNodeServer_Prewarm_Call) Run(run func(_a0 context.Context, _a1 *querypb.PrewarmRequest)) *MockQueryNodeServer_Prewarm_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueryNodeServer_Prewarm_Call) Return(_a0 *commonpb.Status, _a1 error) *MockQueryNodeServer_Prewarm_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNodeServer_Prewarm_Call) RunAndReturn(run func(context.Context, *querypb.PrewarmRequest) (*commonpb.Status, error)) *MockQueryNodeServer_Prewarm_Call {
	_c.Call.Return(run)
	return _c
}
