...
func (_m *MockQueryNodeServer) DescribeSegmentIndexData(_a0 context.Context, _a1 *querypb.DescribeSegmentIndexDataRequest) (*querypb.DescribeSegmentIndexDataResponse, error) {
...
// MockQueryNodeServer_DescribeSegmentIndexData_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DescribeSegmentIndexData'
type MockQueryNodeServer_DescribeSegmentIndexData_Call struct {
	*mock.Call
}

// DescribeSegmentIndexData is a helper method to define mock.On call
//  - _a0 context.Context
//  - _a1 *querypb.DescribeSegmentIndexDataRequest
func (_e *MockQueryNodeServer_Expecter) DescribeSegmentIndexData(_a0 interface{}, _a1 interface{}) *MockQueryNodeServer_DescribeSegmentIndexData_Call {
	return &MockQueryNodeServer_DescribeSegmentIndexData_Call{Call: _e.mock.On("DescribeSegmentIndexData", _a0, _a1)}
}

func (_c *MockQueryNodeServer_DescribeSegmentIndexData_Call) Run(run func(_a0 context.Context, _a1 *querypb.DescribeSegmentIndexDataRequest)) *MockQueryNodeServer_DescribeSegmentIndexData_Call {
...
func (_c *MockQueryNodeServer_DescribeSegmentIndexData_Call) Return(_a0 *querypb.DescribeSegmentIndexDataResponse, _a1 error) *MockQueryNodeServer_DescribeSegmentIndexData_Call {
