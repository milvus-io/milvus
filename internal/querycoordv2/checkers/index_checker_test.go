...
func (suite *IndexCheckerSuite) TestJSONStatsRequiresSupportedFormat() {
	...
	segment := &meta.Segment{
		...
		JSONStatsField: map[int64]*querypb.JsonStatsInfo{
			fieldID: {DataFormatVersion: common.JSONStatsDataFormatV3},
		},
	}

	suite.Empty(suite.checker.checkSegmentStats(segment, schema, []int64{fieldID}))
	segment.JSONStatsField[fieldID].DataFormatVersion = common.JSONStatsDataFormatV4
	suite.Empty(suite.checker.checkSegmentStats(segment, schema, []int64{fieldID}))

	segment.JSONStatsField[fieldID].DataFormatVersion = common.JSONStatsDataFormatV3 - 1
	suite.Equal([]int64{fieldID},
		suite.checker.checkSegmentStats(segment, schema, []int64{fieldID}))
	segment.JSONStatsField[fieldID].DataFormatVersion = common.JSONStatsDataFormatV4 + 1
	suite.Equal([]int64{fieldID},
		suite.checker.checkSegmentStats(segment, schema, []int64{fieldID}))
}
