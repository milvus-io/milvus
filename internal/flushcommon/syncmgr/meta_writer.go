...
type MetaWriter interface {
	...
	NotifyDropPartition(context.Context, string, []int64) error
}
...
func (b *brokerMetaWriter) NotifyDropPartition(ctx context.Context, channelName string, partitionIDs []int64) error {
