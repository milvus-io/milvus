...
func (t *SyncTask) getColumnGroups(segmentInfo *metacache.SegmentInfo) []storagecommon.ColumnGroup {
	...
	switch segmentInfo.GetManifestSource() {
	case datapb.ManifestSource_EtcdManifest:
	...
	case datapb.ManifestSource_LegacyManifest:
		fallthrough
	default:
