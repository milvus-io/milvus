...
// CreateNewGrowingSegment provides a mock function with given fields: ctx, msg
func (_m *MockBufferManager) CreateNewGrowingSegment(ctx context.Context, msg message.ImmutableCreateSegmentMessageV2) error {
...
//   - ctx context.Context
//   - msg message.specializedImmutableMessage[*messagespb.CreateSegmentMessageHeader,*messagespb.CreateSegmentMessageBody]
func (_e *MockBufferManager_Expecter) CreateNewGrowingSegment(ctx interface{}, msg interface{}) *MockBufferManager_CreateNewGrowingSegment_Call {
	return &MockBufferManager_CreateNewGrowingSegment_Call{Call: _e.mock.On("CreateNewGrowingSegment", ctx, msg)}
}

func (_c *MockBufferManager_CreateNewGrowingSegment_Call) Run(run func(ctx context.Context, msg message.ImmutableCreateSegmentMessageV2)) *MockBufferManager_CreateNewGrowingSegment_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBufferManager_CreateNewGrowingSegment_Call) RunAndReturn(run func(context.Context, message.ImmutableCreateSegmentMessageV2) error) *MockBufferManager_CreateNewGrowingSegment_Call {
	_c.Call.Return(run)
	return _c
}
