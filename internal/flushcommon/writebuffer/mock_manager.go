...
func (_m *MockBufferManager) AllowGrowingSourceFlush(channel string) (bool, bool) {
...
func (_c *MockBufferManager_AllowGrowingSourceFlush_Call) Return(enabled bool, found bool) *MockBufferManager_AllowGrowingSourceFlush_Call {
	_c.Call.Return(enabled, found)
	return _c
}

func (_c *MockBufferManager_AllowGrowingSourceFlush_Call) RunAndReturn(run func(string) (bool, bool)) *MockBufferManager_AllowGrowingSourceFlush_Call {
	_c.Call.Return(run)
	return _c
}
