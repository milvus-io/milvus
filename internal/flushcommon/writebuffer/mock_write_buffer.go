...
func (_m *MockWriteBuffer) SealAllSegments(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_c *MockWriteBuffer_SealAllSegments_Call) Return(_a0 error) *MockWriteBuffer_SealAllSegments_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWriteBuffer_SealAllSegments_Call) RunAndReturn(run func(context.Context) error) *MockWriteBuffer_SealAllSegments_Call {
	_c.Call.Return(run)
	return _c
}
