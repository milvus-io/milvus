...
// CreateNewGrowingSegment provides a mock function with given fields: msg
func (_m *MockWriteBuffer) CreateNewGrowingSegment(msg message.ImmutableCreateSegmentMessageV2) {
	_m.Called(msg)
}
...
func (_e *MockWriteBuffer_Expecter) CreateNewGrowingSegment(msg interface{}) *MockWriteBuffer_CreateNewGrowingSegment_Call {
	return &MockWriteBuffer_CreateNewGrowingSegment_Call{Call: _e.mock.On("CreateNewGrowingSegment", msg)}
}

func (_c *MockWriteBuffer_CreateNewGrowingSegment_Call) Run(run func(msg message.ImmutableCreateSegmentMessageV2)) *MockWriteBuffer_CreateNewGrowingSegment_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWriteBuffer_CreateNewGrowingSegment_Call) RunAndReturn(run func(message.ImmutableCreateSegmentMessageV2)) *MockWriteBuffer_CreateNewGrowingSegment_Call {
	_c.Run(run)
	return _c
}
