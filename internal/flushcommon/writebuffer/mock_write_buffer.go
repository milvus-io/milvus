...
// EvictableMemorySize provides a mock function with no fields
func (_m *MockWriteBuffer) EvictableMemorySize() int64 {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for EvictableMemorySize")
	}
...
// MockWriteBuffer_EvictableMemorySize_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EvictableMemorySize'
type MockWriteBuffer_EvictableMemorySize_Call struct {
	*mock.Call
}

// EvictableMemorySize is a helper method to define mock.On call
func (_e *MockWriteBuffer_Expecter) EvictableMemorySize() *MockWriteBuffer_EvictableMemorySize_Call {
	return &MockWriteBuffer_EvictableMemorySize_Call{Call: _e.mock.On("EvictableMemorySize")}
}

func (_c *MockWriteBuffer_EvictableMemorySize_Call) Run(run func()) *MockWriteBuffer_EvictableMemorySize_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockWriteBuffer_EvictableMemorySize_Call) Return(_a0 int64) *MockWriteBuffer_EvictableMemorySize_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWriteBuffer_EvictableMemorySize_Call) RunAndReturn(run func() int64) *MockWriteBuffer_EvictableMemorySize_Call {
	_c.Call.Return(run)
	return _c
}

// FenceGrowingSourceAdmission provides a mock function with no fields
func (_m *MockWriteBuffer) FenceGrowingSourceAdmission() {
	_m.Called()
}

// MockWriteBuffer_FenceGrowingSourceAdmission_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FenceGrowingSourceAdmission'
type MockWriteBuffer_FenceGrowingSourceAdmission_Call struct {
	*mock.Call
}

// FenceGrowingSourceAdmission is a helper method to define mock.On call
func (_e *MockWriteBuffer_Expecter) FenceGrowingSourceAdmission() *MockWriteBuffer_FenceGrowingSourceAdmission_Call {
	return &MockWriteBuffer_FenceGrowingSourceAdmission_Call{Call: _e.mock.On("FenceGrowingSourceAdmission")}
}

func (_c *MockWriteBuffer_FenceGrowingSourceAdmission_Call) Run(run func()) *MockWriteBuffer_FenceGrowingSourceAdmission_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockWriteBuffer_FenceGrowingSourceAdmission_Call) Return() *MockWriteBuffer_FenceGrowingSourceAdmission_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockWriteBuffer_FenceGrowingSourceAdmission_Call) RunAndReturn(run func()) *MockWriteBuffer_FenceGrowingSourceAdmission_Call {
	_c.Run(run)
	return _c
}
...
// GetGrowingFlushProgress provides a mock function with given fields: ctx, segmentIDs
func (_m *MockWriteBuffer) GetGrowingFlushProgress(ctx context.Context, segmentIDs []int64) ([]GrowingFlushSegmentProgress, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []int64) ([]GrowingFlushSegmentProgress, error)); ok {
		return rf(ctx, segmentIDs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []int64) []GrowingFlushSegmentProgress); ok {
...
//   - ctx context.Context
//   - segmentIDs []int64
func (_e *MockWriteBuffer_Expecter) GetGrowingFlushProgress(ctx interface{}, segmentIDs interface{}) *MockWriteBuffer_GetGrowingFlushProgress_Call {
	return &MockWriteBuffer_GetGrowingFlushProgress_Call{Call: _e.mock.On("GetGrowingFlushProgress", ctx, segmentIDs)}
}

func (_c *MockWriteBuffer_GetGrowingFlushProgress_Call) Run(run func(ctx context.Context, segmentIDs []int64)) *MockWriteBuffer_GetGrowingFlushProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWriteBuffer_GetGrowingFlushProgress_Call) RunAndReturn(run func(context.Context, []int64) ([]GrowingFlushSegmentProgress, error)) *MockWriteBuffer_GetGrowingFlushProgress_Call {
	_c.Call.Return(run)
	return _c
}
...
// WaitGrowingFlushDrained provides a mock function with given fields: ctx, segmentIDs
func (_m *MockWriteBuffer) WaitGrowingFlushDrained(ctx context.Context, segmentIDs []int64) error {
	ret := _m.Called(ctx, segmentIDs)
...
// MockWriteBuffer_WaitGrowingFlushDrained_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WaitGrowingFlushDrained'
type MockWriteBuffer_WaitGrowingFlushDrained_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - segmentIDs []int64
func (_e *MockWriteBuffer_Expecter) WaitGrowingFlushDrained(ctx interface{}, segmentIDs interface{}) *MockWriteBuffer_WaitGrowingFlushDrained_Call {
	return &MockWriteBuffer_WaitGrowingFlushDrained_Call{Call: _e.mock.On("WaitGrowingFlushDrained", ctx, segmentIDs)}
}

func (_c *MockWriteBuffer_WaitGrowingFlushDrained_Call) Run(run func(ctx context.Context, segmentIDs []int64)) *MockWriteBuffer_WaitGrowingFlushDrained_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]int64))
	})
	return _c
...
func (_c *MockWriteBuffer_WaitGrowingFlushDrained_Call) Return(_a0 error) *MockWriteBuffer_WaitGrowingFlushDrained_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWriteBuffer_WaitGrowingFlushDrained_Call) RunAndReturn(run func(context.Context, []int64) error) *MockWriteBuffer_WaitGrowingFlushDrained_Call {
	_c.Call.Return(run)
	return _c
}
