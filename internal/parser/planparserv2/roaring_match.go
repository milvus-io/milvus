...
func validateRoaringBitmapBlob(blob []byte) (validatedRoaringBitmapBlob, error) {
	...
	// bounds aggregate serialized plan bytes and aggregate estimated decoded bytes.
	// This per-blob gate rejects one oversized bitmap before decode; the aggregate
