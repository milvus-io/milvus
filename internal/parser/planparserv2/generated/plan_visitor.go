...
type PlanVisitor interface {
	...
	// Visit a parse tree produced by PlanParser#MolSuperstructure.
	VisitMolSuperstructure(ctx *MolSuperstructureContext) interface{}
	...
	// Visit a parse tree produced by PlanParser#MolSubstructure.
	VisitMolSubstructure(ctx *MolSubstructureContext) interface{}
