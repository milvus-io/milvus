...
func (v *BasePlanVisitor) VisitMolSuperstructure(ctx *MolSuperstructureContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasePlanVisitor) VisitMolSubstructure(ctx *MolSubstructureContext) interface{} {
	return v.VisitChildren(ctx)
}
