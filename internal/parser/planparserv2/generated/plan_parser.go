...
var symbolicNames = []string{
	...
	"IntegerConstant", "FloatingConstant", "Identifier", "StringLiteral", "JsonFiled",
	"Whitespace", "Newline",
}
...
func (s *JSONContext) JsonFiled() antlr.TerminalNode {
	return s.GetToken(PlanParserJsonFiled, 0)
}
...
func (s *ReverseRangeContext) JsonFiled() antlr.TerminalNode {
	return s.GetToken(PlanParserJsonFiled, 0)
}
...
func (s *RangeContext) JsonFiled() antlr.TerminalNode {
	return s.GetToken(PlanParserJsonFiled, 0)
}
		...
		if _alt == 1 {
			...
			case 5:
				...
				}
				{
					...
					if !(_la == PlanParserIdentifier || _la == PlanParserJsonFiled) {
