...
func planParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		52, 52, 55, 55, 1, 0, 58, 64, 3, 0, 70, 70, 73, 73, 75, 75, 2, 0, 70, 70,
		73, 73, 1, 0, 33, 35, 1, 0, 37, 38, 1, 0, 8, 9, 3, 0, 70, 70, 73, 74, 76,
		...
		177, 5, 72, 0, 0, 27, 177, 7, 2, 0, 0, 28, 177, 5, 73, 0, 0, 29, 177, 5,
		75, 0, 0, 30, 177, 5, 74, 0, 0, 31, 177, 5, 76, 0, 0, 32, 177, 5, 77, 0,
		...
		if _alt == 1 {
			...
			case 9:
				...
				}
				{
					...
					if !((int64((_la-70)) & ^0x3f) == 0 && ((int64(1)<<(_la-70))&217) != 0) {
						p.GetErrorHandler().RecoverInline(p)
					} else {
						p.GetErrorHandler().ReportMatch(p)
						p.Consume()
