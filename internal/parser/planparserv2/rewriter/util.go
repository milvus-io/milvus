...
func equalsGeneric(a, b *planpb.GenericValue) bool {
	switch {
	case a.GetVal() != nil && b.GetVal() != nil && a.GetVal().(*planpb.GenericValue_BoolVal) != nil:
		return a.GetBoolVal() == b.GetBoolVal()
	case a.GetVal() != nil && b.GetVal() != nil && a.GetVal().(*planpb.GenericValue_Int64Val) != nil:
		return a.GetInt64Val() == b.GetInt64Val()
	case a.GetVal() != nil && b.GetVal() != nil && a.GetVal().(*planpb.GenericValue_FloatVal) != nil:
