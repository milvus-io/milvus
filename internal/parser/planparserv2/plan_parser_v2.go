...
func ParseExpr(schema *typeutil.SchemaHelper, exprStr string, exprTemplateValues []*schemapb.FieldData) (*planpb.Expr, error) {
...
func CreateRetrievePlan(schema *typeutil.SchemaHelper, exprStr string, exprTemplateValues []*schemapb.FieldData) (*planpb.PlanNode, error) {
...
func CreateSearchPlan(schema *typeutil.SchemaHelper, exprStr string, vectorFieldName string, queryInfo *planpb.QueryInfo, exprTemplateValues []*schemapb.FieldData) (*planpb.PlanNode, error) {
