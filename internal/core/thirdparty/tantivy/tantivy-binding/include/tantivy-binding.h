...
void
free_rust_string_array(RustStringArray array);
...
RustResult
tantivy_ngram_tokenize(void* ptr,
...
RustResult
tantivy_ngram_term_posting_list(void* ptr, const char* term, void* bitset);
...
RustResult
tantivy_create_analyzer(const char* analyzer_params, const char* extra_info);

RustResult
tantivy_validate_analyzer(const char* analyzer_params, const char* extra_info);
...
RustResult
tantivy_compute_phrase_match_slop(const char* tokenizer_params,
                                  const char* query,
                                  const char* data,
                                  uint32_t* slop);
