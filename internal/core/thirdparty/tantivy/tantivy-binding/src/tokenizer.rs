...
impl AnalyzerBuilder<'_>{
    ...
    fn add_costom_filter(&mut self, name: &String, params: &json::Map<String, json::Value>) -> Result<(),TantivyError>{
    ...
    fn add_costom_filters(&mut self, params:&json::Map<String, json::Value>) -> Result<(),TantivyError>{
