...
DECLARE_PROMETHEUS_HISTOGRAM_FAMILY(internal_core_growing_index_latency);
DECLARE_PROMETHEUS_HISTOGRAM(internal_core_growing_index_build_latency);
DECLARE_PROMETHEUS_HISTOGRAM(internal_core_growing_index_catchup_latency);
// rows, not ms -- deliberately a separate family from the latency one above.
DECLARE_PROMETHEUS_HISTOGRAM_FAMILY(internal_core_growing_index_rows);
DECLARE_PROMETHEUS_HISTOGRAM(internal_core_growing_index_catchup_rows);
DECLARE_PROMETHEUS_GAUGE_FAMILY(internal_core_growing_index_inflight);
DECLARE_PROMETHEUS_GAUGE(internal_core_growing_index_inflight_builds);
DECLARE_PROMETHEUS_COUNTER_FAMILY(internal_core_growing_index_failures);
DECLARE_PROMETHEUS_COUNTER(internal_core_growing_index_build_failures);
DECLARE_PROMETHEUS_COUNTER(internal_core_growing_index_deadline_failures);
DECLARE_PROMETHEUS_GAUGE_FAMILY(internal_core_growing_index_pool);
DECLARE_PROMETHEUS_GAUGE(internal_core_growing_index_pool_capacity);
DECLARE_PROMETHEUS_GAUGE(internal_core_growing_index_pool_active_threads);
DECLARE_PROMETHEUS_GAUGE(internal_core_growing_index_pool_idle_threads);
DECLARE_PROMETHEUS_GAUGE(internal_core_growing_index_pool_queue_depth);
