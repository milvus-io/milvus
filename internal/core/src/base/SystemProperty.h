...
template <>
struct fmt::formatter<milvus::base::SystemFieldType> : formatter<string_view> {
    auto
    format(milvus::base::SystemFieldType c, format_context& ctx) const {
        string_view name = "unknown";
        switch (c) {
            case milvus::base::SystemFieldType::Invalid:
                name = "Invalid";
                break;
