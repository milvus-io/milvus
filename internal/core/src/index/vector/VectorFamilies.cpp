...
ParseVectorBuilderParams(const BuildParams& params, bool disk) {
    ...
    auto index_type = vector_params::ReadRequiredString(
        params, INDEX_TYPE, "normalized vector build parameter");
    auto metric_type = vector_params::ReadRequiredString(
        params, METRIC_TYPE, "normalized vector build parameter");
...
CreateDiskBuilder(const BuildParams& params) {
    ...
    auto local_dir = vector_params::ReadRequiredString(
        params, "local_dir", "normalized vector build parameter");
