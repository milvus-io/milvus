 ...
 * supply these values and Open validates them. Owns the opened input and fixed
 * load options; each Load creates a new reader.
 */
class NgramIndexLoader final : public IndexLoader {
 ...
 private:
    ...
    NgramIndexLoader(OpenedIndexInput input, storage::LoadOptions options)
