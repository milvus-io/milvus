...
InvertedIndexArtifact::InvertedIndexArtifact(
    ...
    : directory_(std::move(directory)), null_offsets_(std::move(null_offsets)) {
...
void
InvertedIndexArtifact::Serialize(storage::IndexEntryWriter& sink) const {
    SerializeImpl(sink);
}

template <typename Output>
void
InvertedIndexArtifact::SerializeImpl(Output& sink) const {
