...
// Boost binary serialization for R-tree archives. Save and load either
// complete or throw a typed Milvus error; a failed archive must not publish an
// empty tree or a partial build.
