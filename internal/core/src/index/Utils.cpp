...
CompactIndexDatas(
    ...
    LOG_INFO(
        "hc==index_datas HAS_SLICE_META:{}, HAS_BITMAP_DATA:{}, "
        "HAS_BITMAP_META:{}, index_data_size:{}, index_file_slices_size:{}",
        index_datas.count(INDEX_FILE_SLICE_META) > 0,
        index_datas.count(BITMAP_INDEX_DATA) > 0,
        index_datas.count(BITMAP_INDEX_META) > 0,
        index_datas.size(),
        index_file_slices.size());
