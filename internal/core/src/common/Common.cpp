...
int32_t DELETE_DUMP_BATCH_SIZE = DEFAULT_DELETE_DUMP_BATCH_SIZE;
...
SetDefaultDeleteDumpBatchSize(int32_t val) {
    DELETE_DUMP_BATCH_SIZE = val;
    LOG_INFO("set default delete dump batch size: {}", DELETE_DUMP_BATCH_SIZE);
}
