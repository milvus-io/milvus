...
FieldIndexMeta::FieldIndexMeta(FieldId fieldId,
...
FieldIndexMeta::FieldIndexMeta(const milvus::proto::segcore::FieldIndexMeta& fieldIndexMeta) {
...
CollectionIndexMeta::CollectionIndexMeta(int64_t max_index_row_cnt, std::map<FieldId, FieldIndexMeta>&& fieldMetas)
    : max_index_row_cnt_(max_index_row_cnt), fieldMetas_(std::move(fieldMetas)) {
}

CollectionIndexMeta::CollectionIndexMeta(const milvus::proto::segcore::CollectionIndexMeta& collectionIndexMeta) {
