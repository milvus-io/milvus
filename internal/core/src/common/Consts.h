...
const int64_t DEFAULT_HIGH_PRIORITY_THREAD_CORE_COEFFICIENT = 100;
const int64_t DEFAULT_MIDDLE_PRIORITY_THREAD_CORE_COEFFICIENT = 50;
const int64_t DEFAULT_LOW_PRIORITY_THREAD_CORE_COEFFICIENT = 10;
