...
// store (shredding_column_name, key_name) in parquet file metadata
inline constexpr const char* JSON_STATS_META_SHREDDING_COLUMN_KEY_MAP =
    "shredding_column_key_map";
