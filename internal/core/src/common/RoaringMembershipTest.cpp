...
TEST(RoaringMembershipTest, ParsesGoGeneratedPortableFixture) {
    // Generated by client/v3/roaringfilter.Build in Go from:
...
// exists to keep true. Regenerate with client/v3/roaringfilter.Build over the
// listed values and hex-encode the result.
TEST(RoaringMembershipTest, ParsesGoGeneratedEmptyFixture) {
    // Generated by client/v3/roaringfilter.Build in Go from: no values.
    const auto blob = FromHex(
...
TEST(RoaringMembershipTest, ParsesGoGeneratedRunFixture) {
    // Generated by client/v3/roaringfilter.Build in Go from: 0..299, which
...
TEST(RoaringMembershipTest, ParsesGoGeneratedBitmapFixture) {
    // Generated by client/v3/roaringfilter.Build in Go from: the 5000 even
