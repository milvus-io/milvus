...
void
SearchOnSealedIndex(const milvus::base::Schema& schema,
                    const milvus::index::SealedIndexingRecord& record,
                    const milvus::base::SearchInfo& search_info,
                    const void* query_data,
                    int64_t num_queries,
                    const BitsetView& bitset,
                    milvus::base::SearchResult& result) {
...
void
SearchOnSealed(const milvus::base::Schema& schema,
               const void* vec_data,
               const milvus::base::SearchInfo& search_info,
               const void* query_data,
               int64_t num_queries,
    ...
    segment::dataset::SearchDataset dataset{search_info.metric_type_,
                                            num_queries,
                                            search_info.topk_,
