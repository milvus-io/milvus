...
class SegmentInterface {
 public:
    ...
    FillPrimaryKeys(const query::Plan* plan,
                    milvus::base::SearchResult& results) const = 0;
    ...
    virtual const milvus::base::Schema&
    get_schema() const = 0;
    ...
    virtual void
    LoadDeletedRecord(const milvus::base::LoadDeletedRecordInfo& info) = 0;

    virtual void
    LoadFieldData(const milvus::base::LoadFieldDataInfo& info) = 0;

    virtual void
    LoadFieldDataV2(const milvus::base::LoadFieldDataInfo& info) = 0;
...
class SegmentInternalInterface : public SegmentInterface {
 public:
    ...
    void
    FillPrimaryKeys(const query::Plan* plan,
                    milvus::base::SearchResult& results) const override;
 ...
 public:
    virtual void
    vector_search(milvus::base::SearchInfo& search_info,
                  const void* query_data,
                  int64_t query_count,
                  Timestamp timestamp,
                  const BitsetView& bitset,
                  milvus::base::SearchResult& output) const = 0;
     ...
     */
    virtual std::vector<milvus::base::OffsetMap::OffsetType>
    ...
    virtual void
    bulk_subscript(milvus::base::SystemFieldType system_type,
 ...
 protected:
    ...
    virtual const milvus::base::ConcurrentVector<Timestamp>&
