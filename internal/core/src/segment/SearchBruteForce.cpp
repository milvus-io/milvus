...
void
CheckBruteForceSearchParam(const milvus::base::FieldMeta& field,
...
BruteForceSearch(const dataset::SearchDataset& dataset,
    ...
    if (conf.contains(RADIUS)) {
        ...
        if (conf.contains(RANGE_FILTER)) {
            ...
            milvus::base::CheckRangeSearchParam(
        ...
        milvus::tracer::AddEvent("milvus::base::ReGenRangeSearchResult");
        std::copy_n(
