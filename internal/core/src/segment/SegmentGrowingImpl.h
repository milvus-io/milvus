...
class SegmentGrowingImpl : public SegmentGrowing {
 ...
 public:
    const milvus::base::InsertRecord<>&
    get_insert_record() const {
        return insert_record_;
    }

    const milvus::index::IndexingRecord&
    ...
    const milvus::index::SealedIndexingRecord&
 ...
 public:
    ...
    void
    bulk_subscript_impl(const milvus::base::VectorBase* vec_raw,
    ...
    template <typename S, typename T = S>
    void
    bulk_subscript_ptr_impl(const milvus::base::VectorBase* vec_raw,
                            const int64_t* seg_offsets,
                            int64_t count,
    ...
    template <typename T>
    void
    bulk_subscript_array_impl(const milvus::base::VectorBase& vec_raw,
                              const int64_t* seg_offsets,
                              int64_t count,
                              google::protobuf::RepeatedPtrField<T>* dst) const;
 ...
 private:
    ...
    milvus::index::IndexingRecord indexing_record_;
    milvus::index::SealedIndexingRecord sealed_indexing_record_;  // not used

    // inserted fields data and row_ids, timestamps
    milvus::base::InsertRecord<false> insert_record_;
...
const static milvus::base::IndexMetaPtr empty_index_meta =
    std::make_shared<milvus::base::CollectionIndexMeta>(
        1024, std::map<FieldId, milvus::base::FieldIndexMeta>());

inline SegmentGrowingPtr
CreateGrowingSegment(milvus::base::SchemaPtr schema,
                     milvus::base::IndexMetaPtr indexMeta,
                     int64_t segment_id = -1,
                     const milvus::base::SegcoreConfig& conf =
