...
class IndexFactory {
 ...
 public:
    ...
    IndexCreatorBasePtr
    CreateIndex(DataType type, Config& config, storage::FileManagerImplPtr file_manager) {
        auto invalid_dtype_msg = std::string("invalid data type: ") + std::to_string(int(type));
        ...
        switch (type) {
            ...
            case DataType::VECTOR_BINARY:
                return std::make_unique<VecIndexCreator>(type, config, file_manager);
            default:
