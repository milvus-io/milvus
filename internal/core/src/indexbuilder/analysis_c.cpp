...
Analysis(CAnalysis* res_analysis, CAnalysisInfo c_analysis_info) {
    try {
        ...
        if (analysis_info->opt_fields.size()) {
            config["opt_fields"] = analysis_info->opt_fields;
        }
        ...
        milvus::storage::FieldDataMeta field_meta{analysis_info->collection_id,
                                                  ...
                                                  analysis_info->segment_ids[0],
                                                  analysis_info->field_id};

        milvus::storage::IndexMeta index_meta{analysis_info->segment_ids[0],
                                              analysis_info->field_id,
