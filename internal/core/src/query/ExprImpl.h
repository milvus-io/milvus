...
struct TermExprImpl : TermExpr {
    ...
    TermExprImpl(ColumnInfo column, const std::vector<T>& terms, const proto::plan::GenericValue::ValCase val_case)
...
struct UnaryRangeExprImpl : UnaryRangeExpr {
    ...
    UnaryRangeExprImpl(ColumnInfo column,
                       ...
                       const T value,
                       const proto::plan::GenericValue::ValCase val_case)
        : UnaryRangeExpr(std::forward<ColumnInfo>(column), op_type, val_case), value_(value) {
    }
};
...
struct ExistsExprImpl : ExistsExpr {
    explicit ExistsExprImpl(ColumnInfo column) : ExistsExpr(std::forward<ColumnInfo>(column)) {
    }
};
