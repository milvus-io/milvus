...
// the failure mode this design is most exposed to. A row-level predicate must
// leave the element-level fields clear.
//
...
// without all_rows_visible being carried across the two phases.
