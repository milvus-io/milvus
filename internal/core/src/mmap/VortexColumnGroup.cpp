...
VortexColumnGroup::VortexColumnGroup(
    ...
    for (size_t file_index = 0; file_index < files.size(); ++file_index) {
        ...
        // backing for the ColumnGroup lifetime because footer planning and
        // later Cell fills share it. Add pooling and resource accounting before
        // targeting segments with very large file counts.
