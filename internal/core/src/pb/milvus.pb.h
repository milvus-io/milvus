...
class SetTimeTickIntervalRequest;
class SetTimeTickIntervalRequestDefaultTypeInternal;
extern SetTimeTickIntervalRequestDefaultTypeInternal _SetTimeTickIntervalRequest_default_instance_;
...
template<> ::milvus::proto::milvus::SetTimeTickIntervalRequest* Arena::CreateMaybeMessage<::milvus::proto::milvus::SetTimeTickIntervalRequest>(Arena*);
...
class SearchRequest :
 ...
 public:
  ...
  // repeated int64 nqs = 13;
  int nqs_size() const;
  void clear_nqs();
  ::PROTOBUF_NAMESPACE_ID::int64 nqs(int index) const;
  void set_nqs(int index, ::PROTOBUF_NAMESPACE_ID::int64 value);
  void add_nqs(::PROTOBUF_NAMESPACE_ID::int64 value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 >&
      nqs() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 >*
      mutable_nqs();

  // repeated int64 msg_ids = 14;
  int msg_ids_size() const;
  void clear_msg_ids();
  ::PROTOBUF_NAMESPACE_ID::int64 msg_ids(int index) const;
  void set_msg_ids(int index, ::PROTOBUF_NAMESPACE_ID::int64 value);
  void add_msg_ids(::PROTOBUF_NAMESPACE_ID::int64 value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 >&
      msg_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 >*
      mutable_msg_ids();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 > nqs_;
  mutable std::atomic<int> _nqs_cached_byte_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 > msg_ids_;
  mutable std::atomic<int> _msg_ids_cached_byte_size_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr db_name_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr collection_name_;
...
class SetTimeTickIntervalRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:milvus.proto.milvus.SetTimeTickIntervalRequest) */ {
 public:
  SetTimeTickIntervalRequest();
  virtual ~SetTimeTickIntervalRequest();

  SetTimeTickIntervalRequest(const SetTimeTickIntervalRequest& from);
  SetTimeTickIntervalRequest(SetTimeTickIntervalRequest&& from) noexcept
    : SetTimeTickIntervalRequest() {
    *this = ::std::move(from);
  }

  inline SetTimeTickIntervalRequest& operator=(const SetTimeTickIntervalRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline SetTimeTickIntervalRequest& operator=(SetTimeTickIntervalRequest&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const SetTimeTickIntervalRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const SetTimeTickIntervalRequest* internal_default_instance() {
    return reinterpret_cast<const SetTimeTickIntervalRequest*>(
               &_SetTimeTickIntervalRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    68;

  friend void swap(SetTimeTickIntervalRequest& a, SetTimeTickIntervalRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(SetTimeTickIntervalRequest* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline SetTimeTickIntervalRequest* New() const final {
    return CreateMaybeMessage<SetTimeTickIntervalRequest>(nullptr);
  }

  SetTimeTickIntervalRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<SetTimeTickIntervalRequest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const SetTimeTickIntervalRequest& from);
  void MergeFrom(const SetTimeTickIntervalRequest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SetTimeTickIntervalRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "milvus.proto.milvus.SetTimeTickIntervalRequest";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kBaseFieldNumber = 1,
    kTimeTickIntervalFieldNumber = 2,
  };
  // .milvus.proto.common.MsgBase base = 1;
  bool has_base() const;
  void clear_base();
  ...
  // int64 time_tick_interval = 2;
  void clear_time_tick_interval();
  ::PROTOBUF_NAMESPACE_ID::int64 time_tick_interval() const;
  void set_time_tick_interval(::PROTOBUF_NAMESPACE_ID::int64 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::milvus::proto::common::MsgBase* base_;
  ::PROTOBUF_NAMESPACE_ID::int64 time_tick_interval_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_milvus_2eproto;
};
// ===================================================================
...
// bool merged = 12;
inline void SearchRequest::clear_merged() {
  merged_ = false;
}
inline bool SearchRequest::merged() const {
  // @@protoc_insertion_point(field_get:milvus.proto.milvus.SearchRequest.merged)
  return merged_;
}
inline void SearchRequest::set_merged(bool value) {
  
  merged_ = value;
  // @@protoc_insertion_point(field_set:milvus.proto.milvus.SearchRequest.merged)
}

// repeated int64 nqs = 13;
inline int SearchRequest::nqs_size() const {
  return nqs_.size();
}
inline void SearchRequest::clear_nqs() {
  nqs_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::int64 SearchRequest::nqs(int index) const {
  // @@protoc_insertion_point(field_get:milvus.proto.milvus.SearchRequest.nqs)
  return nqs_.Get(index);
}
inline void SearchRequest::set_nqs(int index, ::PROTOBUF_NAMESPACE_ID::int64 value) {
  nqs_.Set(index, value);
  // @@protoc_insertion_point(field_set:milvus.proto.milvus.SearchRequest.nqs)
}
inline void SearchRequest::add_nqs(::PROTOBUF_NAMESPACE_ID::int64 value) {
  nqs_.Add(value);
  // @@protoc_insertion_point(field_add:milvus.proto.milvus.SearchRequest.nqs)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 >&
SearchRequest::nqs() const {
  // @@protoc_insertion_point(field_list:milvus.proto.milvus.SearchRequest.nqs)
  return nqs_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 >*
SearchRequest::mutable_nqs() {
  // @@protoc_insertion_point(field_mutable_list:milvus.proto.milvus.SearchRequest.nqs)
  return &nqs_;
}

// repeated int64 msg_ids = 14;
inline int SearchRequest::msg_ids_size() const {
  return msg_ids_.size();
}
inline void SearchRequest::clear_msg_ids() {
  msg_ids_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::int64 SearchRequest::msg_ids(int index) const {
  // @@protoc_insertion_point(field_get:milvus.proto.milvus.SearchRequest.msg_ids)
  return msg_ids_.Get(index);
}
inline void SearchRequest::set_msg_ids(int index, ::PROTOBUF_NAMESPACE_ID::int64 value) {
  msg_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:milvus.proto.milvus.SearchRequest.msg_ids)
}
inline void SearchRequest::add_msg_ids(::PROTOBUF_NAMESPACE_ID::int64 value) {
  msg_ids_.Add(value);
  // @@protoc_insertion_point(field_add:milvus.proto.milvus.SearchRequest.msg_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 >&
SearchRequest::msg_ids() const {
  // @@protoc_insertion_point(field_list:milvus.proto.milvus.SearchRequest.msg_ids)
  return msg_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int64 >*
SearchRequest::mutable_msg_ids() {
  // @@protoc_insertion_point(field_mutable_list:milvus.proto.milvus.SearchRequest.msg_ids)
  return &msg_ids_;
}
...
// .milvus.proto.common.MsgBase base = 1;
inline bool SetTimeTickIntervalRequest::has_base() const {
  return this != internal_default_instance() && base_ != nullptr;
}
inline const ::milvus::proto::common::MsgBase& SetTimeTickIntervalRequest::base() const {
  const ::milvus::proto::common::MsgBase* p = base_;
  // @@protoc_insertion_point(field_get:milvus.proto.milvus.SetTimeTickIntervalRequest.base)
  return p != nullptr ? *p : *reinterpret_cast<const ::milvus::proto::common::MsgBase*>(
      &::milvus::proto::common::_MsgBase_default_instance_);
}
inline ::milvus::proto::common::MsgBase* SetTimeTickIntervalRequest::release_base() {
  // @@protoc_insertion_point(field_release:milvus.proto.milvus.SetTimeTickIntervalRequest.base)
  
  ::milvus::proto::common::MsgBase* temp = base_;
  base_ = nullptr;
  return temp;
}
inline ::milvus::proto::common::MsgBase* SetTimeTickIntervalRequest::mutable_base() {
  
  if (base_ == nullptr) {
    auto* p = CreateMaybeMessage<::milvus::proto::common::MsgBase>(GetArenaNoVirtual());
    base_ = p;
  }
  // @@protoc_insertion_point(field_mutable:milvus.proto.milvus.SetTimeTickIntervalRequest.base)
  return base_;
}
inline void SetTimeTickIntervalRequest::set_allocated_base(::milvus::proto::common::MsgBase* base) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(base_);
  }
  ...
  base_ = base;
  // @@protoc_insertion_point(field_set_allocated:milvus.proto.milvus.SetTimeTickIntervalRequest.base)
}

// int64 time_tick_interval = 2;
inline void SetTimeTickIntervalRequest::clear_time_tick_interval() {
  time_tick_interval_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 SetTimeTickIntervalRequest::time_tick_interval() const {
  // @@protoc_insertion_point(field_get:milvus.proto.milvus.SetTimeTickIntervalRequest.time_tick_interval)
  return time_tick_interval_;
}
inline void SetTimeTickIntervalRequest::set_time_tick_interval(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  time_tick_interval_ = value;
  // @@protoc_insertion_point(field_set:milvus.proto.milvus.SetTimeTickIntervalRequest.time_tick_interval)
}
