...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_plan_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::milvus::proto::plan::TermExpr, is_in_field_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_plan_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ilvus.proto.plan.ExprH\000\022\030\n\020output_field_"
  "ids\030\003 \003(\003B\006\n\004node*\272\001\n\006OpType\022\013\n\007Invalid\020"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_plan_2eproto = {
  &descriptor_table_plan_2eproto_initialized, descriptor_table_protodef_plan_2eproto, "plan.proto", 3540,
...
TermExpr::TermExpr(const TermExpr& from)
  ...
  is_in_field_ = from.is_in_field_;
...
void TermExpr::SharedCtor() {
  ...
  ::memset(&column_info_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&is_in_field_) -
      reinterpret_cast<char*>(&column_info_)) + sizeof(is_in_field_));
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          is_in_field_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void TermExpr::SerializeWithCachedSizes(
  ...
  // bool is_in_field = 3;
  if (this->is_in_field() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBool(3, this->is_in_field(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* TermExpr::InternalSerializeWithCachedSizesToArray(
  ...
  // bool is_in_field = 3;
  if (this->is_in_field() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(3, this->is_in_field(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:milvus.proto.plan.TermExpr)
  ...
  if (from.is_in_field() != 0) {
    set_is_in_field(from.is_in_field());
  }
}
...
void TermExpr::InternalSwap(TermExpr* other) {
  ...
  swap(column_info_, other->column_info_);
  swap(is_in_field_, other->is_in_field_);
}
