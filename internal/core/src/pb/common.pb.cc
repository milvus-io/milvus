...
const ::_pbi::DescriptorTable descriptor_table_common_2eproto = {
    false, false, 7385, descriptor_table_protodef_common_2eproto,
    "common.proto",
