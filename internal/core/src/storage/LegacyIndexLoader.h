...
// File targets must be prepared by the caller and remain alive until completion.
...
// Raw ranges and whole encoded objects acquire global bytes/slots before dispatch.
// Destination ranges may be written concurrently at disjoint offsets.
// File targets must already be prepared. All issued work drains before return/throw.
// Files, source, and target must outlive the returned task.
[[nodiscard]] folly::coro::Task<void>
