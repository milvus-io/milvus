...
get_default_storage_config(bool useIam) {
    ...
    if (!std::getenv("AZURE_STORAGE_CONNECTION_STRING")) {
        setenv("AZURE_STORAGE_CONNECTION_STRING",
               ...
               "BlobEndpoint=http://127.0.0.1:10000/devstoreaccount1;", 1);
    }

    auto endpoint = "127.0.0.1:10000";  // Not actually used in azure chunk managerwhen connection string is set
