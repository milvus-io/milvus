...
IndexData::serialize_to_remote_file() {
    ...
    AssertInfo(payload_slice_.has_value(), "empty payload slice");
    ...
    des_fix_part.data_type = milvus::proto::schema::DataType(
        milvus::proto::schema::DataType::Binary);
    ...
    des_event_data.extras[ORIGIN_SIZE_KEY] =
        std::to_string(payload_slice_.value().Size());
    ...
    index_event_data.payload_slice_ = payload_slice_;
