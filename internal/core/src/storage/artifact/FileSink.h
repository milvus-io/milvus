...
// Legacy write side of artifact persistence. Artifacts emit logical named
...
enum class ArtifactStorageNamespace {
    Index,
    TextLog,
};
...
class V1DiskSink final : public FileSink {
 public:
    explicit V1DiskSink(const FileManagerContext& context,
                        ArtifactStorageNamespace storage_namespace =
                            ArtifactStorageNamespace::Index);
    ~V1DiskSink() override;
