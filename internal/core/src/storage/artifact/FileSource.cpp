...
#include "storage/LegacyIndexFileIO.h"
...
class V1RemoteSource::Impl {
 public:
    ...
    void
    NormalizePaths() {
        auto prefix = storage_namespace == ArtifactStorageNamespace::TextLog
        ...
        for (const auto& path : remote_paths) {
            if (storage_namespace == ArtifactStorageNamespace::TextLog) {
