...
std::unique_ptr<proto::segcore::RetrieveResults>
SegmentInternalInteSegmentInternalInterface::Retrieve(tracer::TraceContext* trace_ctx,
...
SegmentInternalInterface::Retrieve(tracer::TraceContext* trace_ctx,
                                   const query::RetrievePlan* Plan,::Retrieve(const query::RetrievePlan* Plan,
                                   const int64_t* offsets,
                                   int64_t size) const {
    std::shared_lock lck(mutex_);
