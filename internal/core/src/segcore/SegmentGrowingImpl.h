...
class SegmentGrowingImpl : public SegmentGrowing {
 ...
 protected:
    ...
    chunk_string_view_impl(FieldId field_id, int64_t chunk_id, std::optional<std::pair<int64_t, int64_t>> offset_len) const override;

    std::pair<std::vector<ArrayView>, FixedVector<bool>>
    chunk_array_view_impl(FieldId field_id, int64_t chunk_id, std::optional<std::pair<int64_t, int64_t>> offset_len) const override;
