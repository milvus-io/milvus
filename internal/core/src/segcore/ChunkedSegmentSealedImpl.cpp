...
ChunkedSegmentSealedImpl::Reopen(
    ...
    // Refresh the segment's collection-level index meta so a field added after
    // the segment was created (e.g. a backfilled BM25 sparse field) becomes
    // searchable; a null incoming meta keeps the current one.
