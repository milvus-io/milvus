...
class SegmentInterface {
 public:
    ...
    Retrieve(const query::RetrievePlan* Plan, Timestamp timestamp, int64_t limit_size) const = 0;
    ...
    virtual void
    set_field_avg_size(FieldId field_id, int64_t num_rows, int64_t field_size) = 0;
...
class SegmentInternalInterface : public SegmentInterface {
 public:
    ...
    Retrieve(const query::RetrievePlan* plan, Timestamp timestamp, int64_t limit_size) const override;
    ...
    void
    set_field_avg_size(FieldId field_id, int64_t num_rows, int64_t field_size) override;
 ...
 protected:
    ...
    std::unordered_map<FieldId, std::pair<int64_t, int64_t>> variable_fields_avg_size_;  // bytes
};
