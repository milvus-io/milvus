...
class SegmentInternalInterface : public SegmentInterface {
 public:
    ...
    chunk_view(FieldId field_id, int64_t chunk_id, std::optional<std::pair<int64_t, int64_t>> offset_len = std::nullopt) const {
    ...
    get_batch_views(FieldId field_id,
        ...
        return chunk_view<ViewType>(field_id, chunk_id, std::make_pair(start_offset, length));
    }
 ...
 protected:
    ...
    chunk_string_view_impl(FieldId field_id, int64_t chunk_id, std::optional<std::pair<int64_t, int64_t>> offset_len = std::nullopt) const = 0;

    virtual std::pair<std::vector<ArrayView>, FixedVector<bool>>
    chunk_array_view_impl(FieldId field_id, int64_t chunk_id, std::optional<std::pair<int64_t, int64_t>> offset_len = std::nullopt) const = 0;
