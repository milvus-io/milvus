...
class StreamReducerHelper {
 ...
 protected:
    //Search results from multiple segments may contain null, emtpy results and also
    //some padding single entities, it's needed to filtered out these unwanted data beforehand
    void
    FilterSearchResults();
