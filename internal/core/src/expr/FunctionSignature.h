...
protected:
    FunctionSignature(DataType returnType, std::vector<DataType>&& argumentTypes, bool variableArity):
    returnType_(returnType), argumentTypes_(std::move(argumentTypes)), variableArity_(variableArity){}
...
public:
    AggregateFunctionSignature(DataType returnType,
                               ...
                               bool variableArity):
                               FunctionSignature(returnType, std::move(argumentTypes), variableArity), intermediateType_(intermediateType){

    }

    const DataType& intermediateType() const {
...
public:
    ...
    AggregateFunctionSignatureBuilder& intermediateType(DataType interType) {
        intermediateType_.emplace(interType);
        return *this;
    }

    AggregateFunctionSignatureBuilder& argumentType(DataType argType) {
