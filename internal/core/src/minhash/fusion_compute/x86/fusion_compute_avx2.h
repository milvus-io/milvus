...
linear_and_find_min_batch8_avx2(const uint64_t* base,
    ...
    for (int batch = 0; batch < 2; batch++) {
        ...
        for (; j + 8 <= shingle_count; j += 8) {
            ...
            for (int rot = 0; rot < 4; rot++) {
                // Process first 4 hashes
                {
                    ...
                    __m256i vec_result = _mm256_mul_epu32(vec_a, vec_hashes1);

                    // Handle high 32 bits separately for 64-bit multiplication
                    __m256i a_high = _mm256_srli_epi64(vec_a, 32);
                    __m256i h_high = _mm256_srli_epi64(vec_hashes1, 32);
                    __m256i mul_high = _mm256_mul_epu32(a_high, h_high);
                    mul_high = _mm256_slli_epi64(mul_high, 32);
                    vec_result = _mm256_add_epi64(vec_result, mul_high);

                    // Cross products for full 64-bit multiplication
                    __m256i cross1 = _mm256_mul_epu32(vec_a, h_high);
                    __m256i cross2 = _mm256_mul_epu32(a_high, vec_hashes1);
                    ...
                    __m256i cmp = _mm256_cmpgt_epi64(vec_result, vec_mersenne);
                    ...
                    // Update minimum
                    vec_min = _mm256_min_epu64(vec_min, vec_result);
                ...
                {
                    __m256i vec_result = _mm256_mul_epu32(vec_a, vec_hashes2);
                    ...
                    __m256i cross1 = _mm256_mul_epu32(vec_a, h_high);
                    __m256i cross2 = _mm256_mul_epu32(a_high, vec_hashes2);
                    cross1 = _mm256_slli_epi64(cross1, 32);
                    cross2 = _mm256_slli_epi64(cross2, 32);
                    vec_result = _mm256_add_epi64(vec_result, cross1);
                    vec_result = _mm256_add_epi64(vec_result, cross2);
        ...
        for (; j + 4 <= shingle_count; j += 4) {
            ...
            for (int rot = 0; rot < 4; rot++) {
                __m256i vec_result = _mm256_mul_epu32(vec_a, vec_hashes);
                ...
                __m256i cross1 = _mm256_mul_epu32(vec_a, h_high);
                __m256i cross2 = _mm256_mul_epu32(a_high, vec_hashes);
                cross1 = _mm256_slli_epi64(cross1, 32);
                cross2 = _mm256_slli_epi64(cross2, 32);
                vec_result = _mm256_add_epi64(vec_result, cross1);
                vec_result = _mm256_add_epi64(vec_result, cross2);
        ...
        for (; j < shingle_count; j++) {
            ...
            __m256i vec_result = _mm256_mul_epu32(vec_a, vec_hash);
            ...
            __m256i cross1 = _mm256_mul_epu32(vec_a, h_high);
            __m256i cross2 = _mm256_mul_epu32(a_high, vec_hash);
            cross1 = _mm256_slli_epi64(cross1, 32);
            cross2 = _mm256_slli_epi64(cross2, 32);
            vec_result = _mm256_add_epi64(vec_result, cross1);
            vec_result = _mm256_add_epi64(vec_result, cross2);
...
linear_and_find_min_avx2(const uint64_t* base,
    ...
    for (; j + 4 <= shingle_count; j += 4) {
        ...
        // Handle high 32 bits for full 64-bit multiplication
        __m256i a_high = _mm256_srli_epi64(vec_a, 32);
        __m256i h_high = _mm256_srli_epi64(vec_hashes, 32);
        __m256i mul_high = _mm256_mul_epu32(a_high, h_high);
        mul_high = _mm256_slli_epi64(mul_high, 32);
