...
class MilvusConan(ConanFile):
    ...
    default_options = {
        ...
        "aws-c-s3:shared": True,
        "aws-c-auth:shared": True,
        "aws-c-io:shared": True,
        "aws-c-http:shared": True,
        "aws-c-cal:shared": True,
        "aws-c-compression:shared": True,
        "aws-c-sdkutils:shared": True,
        "aws-c-event-stream:shared": True,
        "aws-c-mqtt:shared": True,
