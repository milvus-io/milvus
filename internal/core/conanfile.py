...
class MilvusConan(ConanFile):
    ...
    requires = (
        ...
        "folly/2024.08.12.00@milvus/dev#5b757647ed9c1961f857c5afaae133b1",
        ...
        "libavrocpp/1.12.1.1@milvus/dev#6c3d7759dee2aaf4589961736087f5da",
    )
    ...
    def requirements(self):
        ...
        self.requires("grpc/1.67.1@milvus/dev#e05fe4470d8577922d7cb0a4356dc082", force=True)
