...
TEST(GroupBYJSON, SealedData) {
    ...
    // 9. search group by json_field.string without json_cast_type
    {
        const char* raw_plan = R"(vector_anns: <
                                        field_id: 101
                                        query_info: <
...
TEST(GroupBYJSON, GrowingRawData) {
    ...
    // 8. Search group by json_field.string without json_cast_type
    {
        const char* raw_plan = R"(vector_anns: <
                                        field_id: 102
                                        query_info: <
...
TEST(GroupBYJSON, Reduce) {
    ...
    // Test Case: Group by JSON field string without json_cast_type
