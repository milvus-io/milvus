...
TEST_F(JsonKeyIndexTest, TestTermInFunc) {
    struct Testcase {
...
TEST_F(JsonKeyIndexTest, TestUnaryRangeInFunc) {
    struct Testcase {
        int64_t val;
        std::vector<std::string> nested_path;
    };
...
TEST_F(JsonKeyIndexTest, TestBinaryRangeInFunc) {
    struct Testcase {
...
TEST_F(JsonKeyIndexTest, TestExistInFunc) {
    struct Testcase {
        std::vector<std::string> nested_path;
    };
    std::vector<Testcase> testcases{
...
TEST_F(JsonKeyIndexTest, TestJsonContainsAllFunc) {
    struct Testcase {
        std::vector<int64_t> term;
        std::vector<std::string> nested_path;
    };
