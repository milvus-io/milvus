...
func (s *InsertDataSuite) TestMemorySize() {
	...
	s.Equal(s.iDataEmpty.Data[BinaryVectorField].GetMemorySize(), 13)
	s.Equal(s.iDataEmpty.Data[FloatVectorField].GetMemorySize(), 13)
	s.Equal(s.iDataEmpty.Data[Float16VectorField].GetMemorySize(), 13)
	...
	s.Equal(s.iDataOneRow.Data[BinaryVectorField].GetMemorySize(), 14)
	s.Equal(s.iDataOneRow.Data[FloatVectorField].GetMemorySize(), 29)
	s.Equal(s.iDataOneRow.Data[Float16VectorField].GetMemorySize(), 21)
	...
	s.Equal(s.iDataTwoRows.Data[BinaryVectorField].GetMemorySize(), 15)
	s.Equal(s.iDataTwoRows.Data[FloatVectorField].GetMemorySize(), 45)
	s.Equal(s.iDataTwoRows.Data[Float16VectorField].GetMemorySize(), 29)
