...
func TestInsertlogIterator(t *testing.T) {
	...
	t.Run("test dispose", func(t *testing.T) {
		...
		itr, err := NewInsertBinlogIterator(blobs, common.RowIDField)
		assert.Nil(t, err)
...
func TestMergeIterator(t *testing.T) {
	...
	t.Run("empty and non-empty iterators", func(t *testing.T) {
		blobs := generateTestData(t, 3)
		insertItr, err := NewInsertBinlogIterator(blobs, common.RowIDField)
		assert.Nil(t, err)
		iterators := []Iterator{
	...
	t.Run("non-empty iterators", func(t *testing.T) {
		blobs := generateTestData(t, 3)
		itr1, err := NewInsertBinlogIterator(blobs, common.RowIDField)
		assert.Nil(t, err)
		itr2, err := NewInsertBinlogIterator(blobs, common.RowIDField)
		assert.Nil(t, err)
