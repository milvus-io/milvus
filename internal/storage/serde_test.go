...
func TestSerDe(t *testing.T) {
	...
	tests := []struct {
		...
		{"test uuid", args{dt: schemapb.DataType_UUID, v: []byte{0xa0, 0xee, 0xbc, 0x99, 0x9c, 0x0b, 0x4e, 0xf8, 0xbb, 0x6d, 0x6b, 0xb9, 0xbd, 0x38, 0x0a, 0x11}}, []byte{0xa0, 0xee, 0xbc, 0x99, 0x9c, 0x0b, 0x4e, 0xf8, 0xbb, 0x6d, 0x6b, 0xb9, 0xbd, 0x38, 0x0a, 0x11}, true},
		{"test uuid null", args{dt: schemapb.DataType_UUID, v: nil}, nil, true},
		{"test uuid negative", args{dt: schemapb.DataType_UUID, v: -1}, nil, false},
