...
type LOBFieldMetadata struct {
	...
	// the list of LOB file IDs for this field (string representation of int64)
	// Use metautil.BuildLOBLogPath to reconstruct full path when needed
...
func (m *LOBSegmentMetadata) BuildLOBFilePath(rootPath string, fieldID int64, fileIDStr string) (string, error) {
	...
	return metautil.BuildLOBLogPath(rootPath, m.CollectionID, m.PartitionID, m.SegmentID, fieldID, fileID), nil
}
