...
func TestBumpUTAdditiveDefaultColumn(t *testing.T) {
	...
	seg := runCompact(t, fix)
	// #52781/#52807 (merged): the packed reader default-fills absent default-valued
	// fields, so the added column materializes its declared default (42), not NULL.
...
// materializes its declared default (#52781/#52807), old columns stay golden.
