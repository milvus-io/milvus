...
// Submit provides a mock function with given fields: ctx, info
func (_m *MockChannelManager) Submit(ctx context.Context, info *datapb.ChannelWatchInfo) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.ChannelWatchInfo) error); ok {
		r0 = rf(ctx, info)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - info *datapb.ChannelWatchInfo
func (_e *MockChannelManager_Expecter) Submit(ctx interface{}, info interface{}) *MockChannelManager_Submit_Call {
	return &MockChannelManager_Submit_Call{Call: _e.mock.On("Submit", ctx, info)}
}

func (_c *MockChannelManager_Submit_Call) Run(run func(ctx context.Context, info *datapb.ChannelWatchInfo)) *MockChannelManager_Submit_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockChannelManager_Submit_Call) RunAndReturn(run func(context.Context, *datapb.ChannelWatchInfo) error) *MockChannelManager_Submit_Call {
	_c.Call.Return(run)
	return _c
}
