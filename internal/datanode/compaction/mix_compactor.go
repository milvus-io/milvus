...
func (t *mixCompactionTask) writeSegment(ctx context.Context,
	...
	metrics.DataNodeCompactionDeleteCount.WithLabelValues(fmt.Sprint(paramtable.GetNodeID())).Add(float64(deltalogDeleteEntriesCount))
	metrics.DataNodeCompactionMissingDeleteCount.WithLabelValues(fmt.Sprint(paramtable.GetNodeID())).Add(float64(entityFilter.GetMissingDeleteCount()))
