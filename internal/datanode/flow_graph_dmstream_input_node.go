...
// DmInputNode receives messages from message stream and passes all messages to the following flowgraph node.
//
//	In DataNode, the following flow graph node is flowgraph ddNode.
