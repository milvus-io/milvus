...
func (_m *MockTask) GetResource() taskcommon.Resource {
	ret := _m.Called()
...
// MockTask_GetResource_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetResource'
type MockTask_GetResource_Call struct {
	*mock.Call
}

// GetResource is a helper method to define mock.On call
func (_e *MockTask_Expecter) GetResource() *MockTask_GetResource_Call {
	return &MockTask_GetResource_Call{Call: _e.mock.On("GetResource")}
}

func (_c *MockTask_GetResource_Call) Run(run func()) *MockTask_GetResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockTask_GetResource_Call) Return(_a0 taskcommon.Resource) *MockTask_GetResource_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTask_GetResource_Call) RunAndReturn(run func() taskcommon.Resource) *MockTask_GetResource_Call {
	_c.Call.Return(run)
	return _c
}
