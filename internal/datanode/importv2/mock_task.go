...
// GetRoutingMode provides a mock function with no fields
func (_m *MockTask) GetRoutingModulus() uint64 {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetRoutingMode")
	}
...
// MockTask_GetRoutingMode_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetRoutingMode'
type MockTask_GetRoutingMode_Call struct {
	*mock.Call
}

// GetRoutingMode is a helper method to define mock.On call
func (_e *MockTask_Expecter) GetRoutingMode() *MockTask_GetRoutingMode_Call {
	return &MockTask_GetRoutingMode_Call{Call: _e.mock.On("GetRoutingMode")}
}

func (_c *MockTask_GetRoutingMode_Call) Run(run func()) *MockTask_GetRoutingMode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockTask_GetRoutingMode_Call) Return(_a0 uint64) *MockTask_GetRoutingMode_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTask_GetRoutingMode_Call) RunAndReturn(run func() uint64) *MockTask_GetRoutingMode_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetShardInfos provides a mock function with no fields
func (_m *MockTask) GetShardInfos() []*schemapb.CollectionShardInfo {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetShardInfos")
	}

	var r0 []*schemapb.CollectionShardInfo
	if rf, ok := ret.Get(0).(func() []*schemapb.CollectionShardInfo); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*schemapb.CollectionShardInfo)
		}
	}
...
// MockTask_GetShardInfos_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetShardInfos'
type MockTask_GetShardInfos_Call struct {
	*mock.Call
}

// GetShardInfos is a helper method to define mock.On call
func (_e *MockTask_Expecter) GetShardInfos() *MockTask_GetShardInfos_Call {
	return &MockTask_GetShardInfos_Call{Call: _e.mock.On("GetShardInfos")}
}

func (_c *MockTask_GetShardInfos_Call) Run(run func()) *MockTask_GetShardInfos_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockTask_GetShardInfos_Call) Return(_a0 []*schemapb.CollectionShardInfo) *MockTask_GetShardInfos_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTask_GetShardInfos_Call) RunAndReturn(run func() []*schemapb.CollectionShardInfo) *MockTask_GetShardInfos_Call {
	_c.Call.Return(run)
	return _c
}
