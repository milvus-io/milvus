...
func (t *ImportTask) Execute() []*conc.Future[any] {
	...
	fn := func(file *internalpb.ImportFile, rowBuffer, deleteBudget int64) error {
		reader, err := importutilv2.NewReader(t.ctx, t.cm, t.GetSchema(), file, req.GetOptions(), int(rowBuffer), t.req.GetStorageConfig(), deleteBudget)
		if err != nil {
