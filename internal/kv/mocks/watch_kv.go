...
func (_m *WatchKV) LoadWithModRevision(ctx context.Context, key string) (string, int64, error) {
	ret := _m.Called(ctx, key)
...
// WatchKV_LoadWithModRevision_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LoadWithModRevision'
type WatchKV_LoadWithModRevision_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - key string
func (_e *WatchKV_Expecter) LoadWithModRevision(ctx interface{}, key interface{}) *WatchKV_LoadWithModRevision_Call {
	return &WatchKV_LoadWithModRevision_Call{Call: _e.mock.On("LoadWithModRevision", ctx, key)}
}

func (_c *WatchKV_LoadWithModRevision_Call) Run(run func(ctx context.Context, key string)) *WatchKV_LoadWithModRevision_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *WatchKV_LoadWithModRevision_Call) Return(_a0 string, _a1 int64, _a2 error) *WatchKV_LoadWithModRevision_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *WatchKV_LoadWithModRevision_Call) RunAndReturn(run func(context.Context, string) (string, int64, error)) *WatchKV_LoadWithModRevision_Call {
	_c.Call.Return(run)
	return _c
}
