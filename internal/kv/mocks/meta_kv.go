...
// MetaKv_MaxTxnOps_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MaxTxnOps'
type MetaKv_MaxTxnOps_Call struct {
	*mock.Call
}

// MaxTxnOps is a helper method to define mock.On call
func (_e *MetaKv_Expecter) MaxTxnOps() *MetaKv_MaxTxnOps_Call {
	return &MetaKv_MaxTxnOps_Call{Call: _e.mock.On("MaxTxnOps")}
}

func (_c *MetaKv_MaxTxnOps_Call) Run(run func()) *MetaKv_MaxTxnOps_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MetaKv_MaxTxnOps_Call) Return(_a0 int) *MetaKv_MaxTxnOps_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MetaKv_MaxTxnOps_Call) RunAndReturn(run func() int) *MetaKv_MaxTxnOps_Call {
	_c.Call.Return(run)
	return _c
}
