...
// TxnKV_MaxTxnOps_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MaxTxnOps'
type TxnKV_MaxTxnOps_Call struct {
	*mock.Call
}

// MaxTxnOps is a helper method to define mock.On call
func (_e *TxnKV_Expecter) MaxTxnOps() *TxnKV_MaxTxnOps_Call {
	return &TxnKV_MaxTxnOps_Call{Call: _e.mock.On("MaxTxnOps")}
}

func (_c *TxnKV_MaxTxnOps_Call) Run(run func()) *TxnKV_MaxTxnOps_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *TxnKV_MaxTxnOps_Call) Return(_a0 int) *TxnKV_MaxTxnOps_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *TxnKV_MaxTxnOps_Call) RunAndReturn(run func() int) *TxnKV_MaxTxnOps_Call {
	_c.Call.Return(run)
	return _c
}
