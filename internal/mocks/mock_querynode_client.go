...
// QuerySegmentsOffset provides a mock function with given fields: ctx, in, opts
func (_m *MockQueryNodeClient) QuerySegmentsOffset(ctx context.Context, in *querypb.QueryOffsetsRequest, opts ...grpc.CallOption) (*internalpb.RetrieveResults, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *internalpb.RetrieveResults
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *querypb.QueryOffsetsRequest, ...grpc.CallOption) (*internalpb.RetrieveResults, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *querypb.QueryOffsetsRequest, ...grpc.CallOption) *internalpb.RetrieveResults); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*internalpb.RetrieveResults)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *querypb.QueryOffsetsRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockQueryNodeClient_QuerySegmentsOffset_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'QuerySegmentsOffset'
type MockQueryNodeClient_QuerySegmentsOffset_Call struct {
	*mock.Call
}

// QuerySegmentsOffset is a helper method to define mock.On call
//   - ctx context.Context
//   - in *querypb.QueryOffsetsRequest
//   - opts ...grpc.CallOption
func (_e *MockQueryNodeClient_Expecter) QuerySegmentsOffset(ctx interface{}, in interface{}, opts ...interface{}) *MockQueryNodeClient_QuerySegmentsOffset_Call {
	return &MockQueryNodeClient_QuerySegmentsOffset_Call{Call: _e.mock.On("QuerySegmentsOffset",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockQueryNodeClient_QuerySegmentsOffset_Call) Run(run func(ctx context.Context, in *querypb.QueryOffsetsRequest, opts ...grpc.CallOption)) *MockQueryNodeClient_QuerySegmentsOffset_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*querypb.QueryOffsetsRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockQueryNodeClient_QuerySegmentsOffset_Call) Return(_a0 *internalpb.RetrieveResults, _a1 error) *MockQueryNodeClient_QuerySegmentsOffset_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNodeClient_QuerySegmentsOffset_Call) RunAndReturn(run func(context.Context, *querypb.QueryOffsetsRequest, ...grpc.CallOption) (*internalpb.RetrieveResults, error)) *MockQueryNodeClient_QuerySegmentsOffset_Call {
	_c.Call.Return(run)
	return _c
}
