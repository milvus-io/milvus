...
func (_m *MockQueryNodeClient) GetFeatureUsage(ctx context.Context, in *internalpb.GetFeatureUsageRequest, opts ...grpc.CallOption) (*internalpb.GetFeatureUsageResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockQueryNodeClient_GetFeatureUsage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetFeatureUsage'
type MockQueryNodeClient_GetFeatureUsage_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockQueryNodeClient_Expecter) GetFeatureUsage(ctx interface{}, in interface{}, opts ...interface{}) *MockQueryNodeClient_GetFeatureUsage_Call {
	return &MockQueryNodeClient_GetFeatureUsage_Call{Call: _e.mock.On("GetFeatureUsage",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockQueryNodeClient_GetFeatureUsage_Call) Run(run func(ctx context.Context, in *internalpb.GetFeatureUsageRequest, opts ...grpc.CallOption)) *MockQueryNodeClient_GetFeatureUsage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockQueryNodeClient_GetFeatureUsage_Call) Return(_a0 *internalpb.GetFeatureUsageResponse, _a1 error) *MockQueryNodeClient_GetFeatureUsage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNodeClient_GetFeatureUsage_Call) RunAndReturn(run func(context.Context, *internalpb.GetFeatureUsageRequest, ...grpc.CallOption) (*internalpb.GetFeatureUsageResponse, error)) *MockQueryNodeClient_GetFeatureUsage_Call {
	_c.Call.Return(run)
	return _c
}
