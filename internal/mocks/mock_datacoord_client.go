...
func (_m *MockDataCoordClient) GetExportSnapshotState(ctx context.Context, in *datapb.GetExportSnapshotStateRequest, opts ...grpc.CallOption) (*datapb.GetExportSnapshotStateResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockDataCoordClient_GetExportSnapshotState_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetExportSnapshotState'
type MockDataCoordClient_GetExportSnapshotState_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockDataCoordClient_Expecter) GetExportSnapshotState(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_GetExportSnapshotState_Call {
	return &MockDataCoordClient_GetExportSnapshotState_Call{Call: _e.mock.On("GetExportSnapshotState",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockDataCoordClient_GetExportSnapshotState_Call) Run(run func(ctx context.Context, in *datapb.GetExportSnapshotStateRequest, opts ...grpc.CallOption)) *MockDataCoordClient_GetExportSnapshotState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockDataCoordClient_GetExportSnapshotState_Call) Return(_a0 *datapb.GetExportSnapshotStateResponse, _a1 error) *MockDataCoordClient_GetExportSnapshotState_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataCoordClient_GetExportSnapshotState_Call) RunAndReturn(run func(context.Context, *datapb.GetExportSnapshotStateRequest, ...grpc.CallOption) (*datapb.GetExportSnapshotStateResponse, error)) *MockDataCoordClient_GetExportSnapshotState_Call {
	_c.Call.Return(run)
	return _c
}
