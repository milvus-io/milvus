...
func (_m *MockDataCoordClient) CreateIndexesForTemp(ctx context.Context, in *indexpb.CollectionWithTempRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	...
	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *indexpb.CollectionWithTempRequest, ...grpc.CallOption) (*commonpb.Status, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *indexpb.CollectionWithTempRequest, ...grpc.CallOption) *commonpb.Status); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *indexpb.CollectionWithTempRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateIndexesForTemp is a helper method to define mock.On call
//   - ctx context.Context
//   - in *indexpb.CollectionWithTempRequest
//   - opts ...grpc.CallOption
func (_e *MockDataCoordClient_Expecter) CreateIndexesForTemp(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_CreateIndexesForTemp_Call {
	return &MockDataCoordClient_CreateIndexesForTemp_Call{Call: _e.mock.On("CreateIndexesForTemp",
		append([]interface{}{ctx, in}, opts...)...)}
}
...
func (_e *MockDataCoordClient_Expecter) DropIndexesForTemp(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_DropIndexesForTemp_Call {
	return &MockDataCoordClient_DropIndexesForTemp_Call{Call: _e.mock.On("DropIndexesForTemp",
		append([]interface{}{ctx, in}, opts...)...)}
}
