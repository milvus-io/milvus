...
// ListChannelSegmentInfo provides a mock function with given fields: ctx, in, opts
func (_m *MockDataCoordClient) ListChannelSegmentInfo(ctx context.Context, in *datapb.ChannelSegmentInfoRequest, opts ...grpc.CallOption) (datapb.DataCoord_ListChannelSegmentInfoClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 datapb.DataCoord_ListChannelSegmentInfoClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.ChannelSegmentInfoRequest, ...grpc.CallOption) (datapb.DataCoord_ListChannelSegmentInfoClient, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.ChannelSegmentInfoRequest, ...grpc.CallOption) datapb.DataCoord_ListChannelSegmentInfoClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(datapb.DataCoord_ListChannelSegmentInfoClient)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *datapb.ChannelSegmentInfoRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockDataCoordClient_ListChannelSegmentInfo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListChannelSegmentInfo'
type MockDataCoordClient_ListChannelSegmentInfo_Call struct {
	*mock.Call
}

// ListChannelSegmentInfo is a helper method to define mock.On call
//   - ctx context.Context
//   - in *datapb.ChannelSegmentInfoRequest
//   - opts ...grpc.CallOption
func (_e *MockDataCoordClient_Expecter) ListChannelSegmentInfo(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_ListChannelSegmentInfo_Call {
	return &MockDataCoordClient_ListChannelSegmentInfo_Call{Call: _e.mock.On("ListChannelSegmentInfo",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockDataCoordClient_ListChannelSegmentInfo_Call) Run(run func(ctx context.Context, in *datapb.ChannelSegmentInfoRequest, opts ...grpc.CallOption)) *MockDataCoordClient_ListChannelSegmentInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*datapb.ChannelSegmentInfoRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockDataCoordClient_ListChannelSegmentInfo_Call) Return(_a0 datapb.DataCoord_ListChannelSegmentInfoClient, _a1 error) *MockDataCoordClient_ListChannelSegmentInfo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataCoordClient_ListChannelSegmentInfo_Call) RunAndReturn(run func(context.Context, *datapb.ChannelSegmentInfoRequest, ...grpc.CallOption) (datapb.DataCoord_ListChannelSegmentInfoClient, error)) *MockDataCoordClient_ListChannelSegmentInfo_Call {
	_c.Call.Return(run)
	return _c
}
