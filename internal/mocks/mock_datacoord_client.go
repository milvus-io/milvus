...
func (_m *MockDataCoordClient) DropCollection(ctx context.Context, in *datapb.DropCollectionRequest, opts ...grpc.CallOption) (*datapb.DropCollectionResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.DropCollectionRequest, ...grpc.CallOption) (*datapb.DropCollectionResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.DropCollectionRequest, ...grpc.CallOption) *datapb.DropCollectionResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *datapb.DropCollectionRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockDataCoordClient_DropCollection_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DropCollection'
type MockDataCoordClient_DropCollection_Call struct {
	*mock.Call
}

// DropCollection is a helper method to define mock.On call
//   - ctx context.Context
//   - in *datapb.DropCollectionRequest
//   - opts ...grpc.CallOption
func (_e *MockDataCoordClient_Expecter) DropCollection(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_DropCollection_Call {
	return &MockDataCoordClient_DropCollection_Call{Call: _e.mock.On("DropCollection",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockDataCoordClient_DropCollection_Call) Run(run func(ctx context.Context, in *datapb.DropCollectionRequest, opts ...grpc.CallOption)) *MockDataCoordClient_DropCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*datapb.DropCollectionRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockDataCoordClient_DropCollection_Call) Return(_a0 *datapb.DropCollectionResponse, _a1 error) *MockDataCoordClient_DropCollection_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataCoordClient_DropCollection_Call) RunAndReturn(run func(context.Context, *datapb.DropCollectionRequest, ...grpc.CallOption) (*datapb.DropCollectionResponse, error)) *MockDataCoordClient_DropCollection_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDataCoordClient) DropPartition(ctx context.Context, in *datapb.DropPartitionRequest, opts ...grpc.CallOption) (*datapb.DropPartitionResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.DropPartitionRequest, ...grpc.CallOption) (*datapb.DropPartitionResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.DropPartitionRequest, ...grpc.CallOption) *datapb.DropPartitionResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *datapb.DropPartitionRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockDataCoordClient_DropPartition_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DropPartition'
type MockDataCoordClient_DropPartition_Call struct {
	*mock.Call
}

// DropPartition is a helper method to define mock.On call
//   - ctx context.Context
//   - in *datapb.DropPartitionRequest
//   - opts ...grpc.CallOption
func (_e *MockDataCoordClient_Expecter) DropPartition(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_DropPartition_Call {
	return &MockDataCoordClient_DropPartition_Call{Call: _e.mock.On("DropPartition",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockDataCoordClient_DropPartition_Call) Run(run func(ctx context.Context, in *datapb.DropPartitionRequest, opts ...grpc.CallOption)) *MockDataCoordClient_DropPartition_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*datapb.DropPartitionRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockDataCoordClient_DropPartition_Call) Return(_a0 *datapb.DropPartitionResponse, _a1 error) *MockDataCoordClient_DropPartition_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataCoordClient_DropPartition_Call) RunAndReturn(run func(context.Context, *datapb.DropPartitionRequest, ...grpc.CallOption) (*datapb.DropPartitionResponse, error)) *MockDataCoordClient_DropPartition_Call {
	_c.Call.Return(run)
	return _c
}
