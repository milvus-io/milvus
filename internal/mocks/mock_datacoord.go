...
// GcControl provides a mock function with given fields: ctx, request
func (_m *DataCoord) GcControl(ctx context.Context, request *datapb.GcControlRequest) (*commonpb.Status, error) {
	ret := _m.Called(ctx, request)
...
// DataCoord_GcControl_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GcControl'
type DataCoord_GcControl_Call struct {
	*mock.Call
}
...
func (_e *DataCoord_Expecter) GcControl(ctx interface{}, request interface{}) *DataCoord_GcControl_Call {
	return &DataCoord_GcControl_Call{Call: _e.mock.On("GcControl", ctx, request)}
}

func (_c *DataCoord_GcControl_Call) Run(run func(ctx context.Context, request *datapb.GcControlRequest)) *DataCoord_GcControl_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DataCoord_GcControl_Call) Return(_a0 *commonpb.Status, _a1 error) *DataCoord_GcControl_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DataCoord_GcControl_Call) RunAndReturn(run func(context.Context, *datapb.GcControlRequest) (*commonpb.Status, error)) *DataCoord_GcControl_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *DataCoord_ReportDataNodeTtMsgs_Call) RunAndReturn(run func(context.Context, *datapb.ReportDataNodeTtMsgsRequest) (*commonpb.Status, error)) *DataCoord_ReportDataNodeTtMsgs_Call {
	_c.Call.Return(run)
	return _c
}
