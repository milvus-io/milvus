...
// ListIndexedSegment provides a mock function with given fields: ctx, req
func (_m *DataCoord) ListIndexedSegment(ctx context.Context, req *datapb.ListIndexedSegmentRequest) (*datapb.ListIndexedSegmentResponse, error) {
	ret := _m.Called(ctx, req)

	var r0 *datapb.ListIndexedSegmentResponse
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.ListIndexedSegmentRequest) *datapb.ListIndexedSegmentResponse); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*datapb.ListIndexedSegmentResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *datapb.ListIndexedSegmentRequest) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
...
// DataCoord_ListIndexedSegment_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListIndexedSegment'
type DataCoord_ListIndexedSegment_Call struct {
	*mock.Call
}
...
func (_e *DataCoord_Expecter) ListIndexedSegment(ctx interface{}, req interface{}) *DataCoord_ListIndexedSegment_Call {
	return &DataCoord_ListIndexedSegment_Call{Call: _e.mock.On("ListIndexedSegment", ctx, req)}
}

func (_c *DataCoord_ListIndexedSegment_Call) Run(run func(ctx context.Context, req *datapb.ListIndexedSegmentRequest)) *DataCoord_ListIndexedSegment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*datapb.ListIndexedSegmentRequest))
	})
	return _c
}

func (_c *DataCoord_ListIndexedSegment_Call) Return(_a0 *datapb.ListIndexedSegmentResponse, _a1 error) *DataCoord_ListIndexedSegment_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
