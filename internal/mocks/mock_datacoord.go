...
// DataCoord is an autogenerated mock type for the DataCoordComponent type
...
func (_m *DataCoord) SetAddress(address string) {
	_m.Called(address)
}

// DataCoord_SetAddress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetAddress'
type DataCoord_SetAddress_Call struct {
	*mock.Call
}

// SetAddress is a helper method to define mock.On call
//   - address string
func (_e *DataCoord_Expecter) SetAddress(address interface{}) *DataCoord_SetAddress_Call {
	return &DataCoord_SetAddress_Call{Call: _e.mock.On("SetAddress", address)}
}

func (_c *DataCoord_SetAddress_Call) Run(run func(address string)) *DataCoord_SetAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *DataCoord_SetAddress_Call) Return() *DataCoord_SetAddress_Call {
	_c.Call.Return()
	return _c
}

// SetDataNodeCreator provides a mock function with given fields: _a0
func (_m *DataCoord) SetDataNodeCreator(_a0 func(context.Context, string) (types.DataNode, error)) {
	_m.Called(_a0)
}

// DataCoord_SetDataNodeCreator_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetDataNodeCreator'
type DataCoord_SetDataNodeCreator_Call struct {
	*mock.Call
}

// SetDataNodeCreator is a helper method to define mock.On call
//   - _a0 func(context.Context , string)(types.DataNode , error)
func (_e *DataCoord_Expecter) SetDataNodeCreator(_a0 interface{}) *DataCoord_SetDataNodeCreator_Call {
	return &DataCoord_SetDataNodeCreator_Call{Call: _e.mock.On("SetDataNodeCreator", _a0)}
}

func (_c *DataCoord_SetDataNodeCreator_Call) Run(run func(_a0 func(context.Context, string) (types.DataNode, error))) *DataCoord_SetDataNodeCreator_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DataCoord_SetDataNodeCreator_Call) Return() *DataCoord_SetDataNodeCreator_Call {
	_c.Call.Return()
	return _c
}

// SetEtcdClient provides a mock function with given fields: etcdClient
func (_m *DataCoord) SetEtcdClient(etcdClient *clientv3.Client) {
	_m.Called(etcdClient)
}

// DataCoord_SetEtcdClient_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetEtcdClient'
type DataCoord_SetEtcdClient_Call struct {
	*mock.Call
}

// SetEtcdClient is a helper method to define mock.On call
//   - etcdClient *clientv3.Client
func (_e *DataCoord_Expecter) SetEtcdClient(etcdClient interface{}) *DataCoord_SetEtcdClient_Call {
	return &DataCoord_SetEtcdClient_Call{Call: _e.mock.On("SetEtcdClient", etcdClient)}
}

func (_c *DataCoord_SetEtcdClient_Call) Run(run func(etcdClient *clientv3.Client)) *DataCoord_SetEtcdClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DataCoord_SetEtcdClient_Call) Return() *DataCoord_SetEtcdClient_Call {
	_c.Call.Return()
	return _c
}

// SetIndexNodeCreator provides a mock function with given fields: _a0
func (_m *DataCoord) SetIndexNodeCreator(_a0 func(context.Context, string) (types.IndexNode, error)) {
	_m.Called(_a0)
}

// DataCoord_SetIndexNodeCreator_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetIndexNodeCreator'
type DataCoord_SetIndexNodeCreator_Call struct {
	*mock.Call
}

// SetIndexNodeCreator is a helper method to define mock.On call
//   - _a0 func(context.Context , string)(types.IndexNode , error)
func (_e *DataCoord_Expecter) SetIndexNodeCreator(_a0 interface{}) *DataCoord_SetIndexNodeCreator_Call {
	return &DataCoord_SetIndexNodeCreator_Call{Call: _e.mock.On("SetIndexNodeCreator", _a0)}
}

func (_c *DataCoord_SetIndexNodeCreator_Call) Run(run func(_a0 func(context.Context, string) (types.IndexNode, error))) *DataCoord_SetIndexNodeCreator_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DataCoord_SetIndexNodeCreator_Call) Return() *DataCoord_SetIndexNodeCreator_Call {
	_c.Call.Return()
	return _c
}

// SetRootCoord provides a mock function with given fields: rootCoord
func (_m *DataCoord) SetRootCoord(rootCoord types.RootCoord) {
	_m.Called(rootCoord)
}

// DataCoord_SetRootCoord_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetRootCoord'
type DataCoord_SetRootCoord_Call struct {
	*mock.Call
}

// SetRootCoord is a helper method to define mock.On call
//   - rootCoord types.RootCoord
func (_e *DataCoord_Expecter) SetRootCoord(rootCoord interface{}) *DataCoord_SetRootCoord_Call {
	return &DataCoord_SetRootCoord_Call{Call: _e.mock.On("SetRootCoord", rootCoord)}
}

func (_c *DataCoord_SetRootCoord_Call) Run(run func(rootCoord types.RootCoord)) *DataCoord_SetRootCoord_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DataCoord_SetRootCoord_Call) Return() *DataCoord_SetRootCoord_Call {
	_c.Call.Return()
	return _c
}
