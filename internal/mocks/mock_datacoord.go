...
func (_m *MockDataCoord) UpdateSegmentColumnGroups(_a0 context.Context, _a1 *datapb.UpdateSegmentColumnGroupsRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
...
// MockDataCoord_UpdateSegmentColumnGroups_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateSegmentColumnGroups'
type MockDataCoord_UpdateSegmentColumnGroups_Call struct {
	*mock.Call
}
...
func (_e *MockDataCoord_Expecter) UpdateSegmentColumnGroups(_a0 interface{}, _a1 interface{}) *MockDataCoord_UpdateSegmentColumnGroups_Call {
	return &MockDataCoord_UpdateSegmentColumnGroups_Call{Call: _e.mock.On("UpdateSegmentColumnGroups", _a0, _a1)}
}

func (_c *MockDataCoord_UpdateSegmentColumnGroups_Call) Run(run func(_a0 context.Context, _a1 *datapb.UpdateSegmentColumnGroupsRequest)) *MockDataCoord_UpdateSegmentColumnGroups_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDataCoord_UpdateSegmentColumnGroups_Call) Return(_a0 *commonpb.Status, _a1 error) *MockDataCoord_UpdateSegmentColumnGroups_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataCoord_UpdateSegmentColumnGroups_Call) RunAndReturn(run func(context.Context, *datapb.UpdateSegmentColumnGroupsRequest) (*commonpb.Status, error)) *MockDataCoord_UpdateSegmentColumnGroups_Call {
	_c.Call.Return(run)
	return _c
}
