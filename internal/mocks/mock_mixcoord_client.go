...
func (_m *MockMixCoordClient) CommitShardSplitRouting(ctx context.Context, in *rootcoordpb.CommitShardSplitRoutingRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockMixCoordClient_CommitShardSplitRouting_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CommitShardSplitRouting'
type MockMixCoordClient_CommitShardSplitRouting_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockMixCoordClient_Expecter) CommitShardSplitRouting(ctx interface{}, in interface{}, opts ...interface{}) *MockMixCoordClient_CommitShardSplitRouting_Call {
	return &MockMixCoordClient_CommitShardSplitRouting_Call{Call: _e.mock.On("CommitShardSplitRouting",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockMixCoordClient_CommitShardSplitRouting_Call) Run(run func(ctx context.Context, in *rootcoordpb.CommitShardSplitRoutingRequest, opts ...grpc.CallOption)) *MockMixCoordClient_CommitShardSplitRouting_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockMixCoordClient_CommitShardSplitRouting_Call) Return(_a0 *commonpb.Status, _a1 error) *MockMixCoordClient_CommitShardSplitRouting_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_CommitShardSplitRouting_Call) RunAndReturn(run func(context.Context, *rootcoordpb.CommitShardSplitRoutingRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockMixCoordClient_CommitShardSplitRouting_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockMixCoordClient) CommitShardSplit(ctx context.Context, in *datapb.CommitShardSplitRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockMixCoordClient_CommitShardSplit_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CommitShardSplit'
type MockMixCoordClient_CommitShardSplit_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockMixCoordClient_Expecter) CommitShardSplit(ctx interface{}, in interface{}, opts ...interface{}) *MockMixCoordClient_CommitShardSplit_Call {
	return &MockMixCoordClient_CommitShardSplit_Call{Call: _e.mock.On("CommitShardSplit",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockMixCoordClient_CommitShardSplit_Call) Run(run func(ctx context.Context, in *datapb.CommitShardSplitRequest, opts ...grpc.CallOption)) *MockMixCoordClient_CommitShardSplit_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockMixCoordClient_CommitShardSplit_Call) Return(_a0 *commonpb.Status, _a1 error) *MockMixCoordClient_CommitShardSplit_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_CommitShardSplit_Call) RunAndReturn(run func(context.Context, *datapb.CommitShardSplitRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockMixCoordClient_CommitShardSplit_Call {
	_c.Call.Return(run)
	return _c
}

// CheckShardSplitDrained provides a mock function with given fields: ctx, in, opts
func (_m *MockMixCoordClient) CheckShardSplitDrained(ctx context.Context, in *datapb.CheckShardSplitDrainedRequest, opts ...grpc.CallOption) (*datapb.CheckShardSplitDrainedResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockMixCoordClient_CheckShardSplitDrained_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckShardSplitDrained'
type MockMixCoordClient_CheckShardSplitDrained_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockMixCoordClient_Expecter) CheckShardSplitDrained(ctx interface{}, in interface{}, opts ...interface{}) *MockMixCoordClient_CheckShardSplitDrained_Call {
	return &MockMixCoordClient_CheckShardSplitDrained_Call{Call: _e.mock.On("CheckShardSplitDrained",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockMixCoordClient_CheckShardSplitDrained_Call) Run(run func(ctx context.Context, in *datapb.CheckShardSplitDrainedRequest, opts ...grpc.CallOption)) *MockMixCoordClient_CheckShardSplitDrained_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockMixCoordClient_CheckShardSplitDrained_Call) Return(_a0 *datapb.CheckShardSplitDrainedResponse, _a1 error) *MockMixCoordClient_CheckShardSplitDrained_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_CheckShardSplitDrained_Call) RunAndReturn(run func(context.Context, *datapb.CheckShardSplitDrainedRequest, ...grpc.CallOption) (*datapb.CheckShardSplitDrainedResponse, error)) *MockMixCoordClient_CheckShardSplitDrained_Call {
	_c.Call.Return(run)
	return _c
}
