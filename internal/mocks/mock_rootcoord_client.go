...
func (_m *MockRootCoordClient) TruncateCollection(ctx context.Context, in *rootcoordpb.TruncateCollectionRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *rootcoordpb.TruncateCollectionRequest, ...grpc.CallOption) (*commonpb.Status, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *rootcoordpb.TruncateCollectionRequest, ...grpc.CallOption) *commonpb.Status); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *rootcoordpb.TruncateCollectionRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - in *rootcoordpb.TruncateCollectionRequest
//   - opts ...grpc.CallOption
...
func (_c *MockRootCoordClient_TruncateCollection_Call) Run(run func(ctx context.Context, in *rootcoordpb.TruncateCollectionRequest, opts ...grpc.CallOption)) *MockRootCoordClient_TruncateCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*rootcoordpb.TruncateCollectionRequest), variadicArgs...)
	})
	return _c
}
...
func (_c *MockRootCoordClient_TruncateCollection_Call) RunAndReturn(run func(context.Context, *rootcoordpb.TruncateCollectionRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockRootCoordClient_TruncateCollection_Call {
	_c.Call.Return(run)
	return _c
}
