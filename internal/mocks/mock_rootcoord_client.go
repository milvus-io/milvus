...
// AlterCollectionOrField provides a mock function with given fields: ctx, in, opts
func (_m *MockRootCoordClient) AlterCollectionOrField(ctx context.Context, in *milvuspb.AlterCollectionRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockRootCoordClient_AlterCollection_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AlterCollection'
type MockRootCoordClient_AlterCollectionOrField_Call struct {
	*mock.Call
}
...
//   - in *milvuspb.AlterCollectionRequest
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) AlterCollectionOrField(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_AlterCollectionOrField_Call {
	return &MockRootCoordClient_AlterCollectionOrField_Call{Call: _e.mock.On("AlterCollectionOrField",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_AlterCollectionOrField_Call) Run(run func(ctx context.Context, in *milvuspb.AlterCollectionRequest, opts ...grpc.CallOption)) *MockRootCoordClient_AlterCollectionOrField_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_AlterCollectionOrField_Call) Return(_a0 *commonpb.Status, _a1 error) *MockRootCoordClient_AlterCollectionOrField_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_AlterCollectionOrField_Call) RunAndReturn(run func(context.Context, *milvuspb.AlterCollectionRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockRootCoordClient_AlterCollectionOrField_Call {
	_c.Call.Return(run)
	return _c
}
