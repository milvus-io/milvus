...
func (_m *MockRootCoordClient) TruncateCollection(ctx context.Context, in *milvuspb.DropCollectionRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *MockRootCoordClient_TruncateCollection_Call) Run(run func(ctx context.Context, in *milvuspb.DropCollectionRequest, opts ...grpc.CallOption)) *MockRootCoordClient_TruncateCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_TruncateCollection_Call) RunAndReturn(run func(context.Context, *milvuspb.DropCollectionRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockRootCoordClient_TruncateCollection_Call {
	_c.Call.Return(run)
	return _c
}

// DescribeCollectionWithState provides a mock function with given fields: ctx, in, opts
func (_m *MockRootCoordClient) DescribeCollectionWithState(ctx context.Context, in *milvuspb.DescribeCollectionRequest, opts ...grpc.CallOption) (*rootcoordpb.DescribeCollectionResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *rootcoordpb.DescribeCollectionResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *milvuspb.DescribeCollectionRequest, ...grpc.CallOption) (*rootcoordpb.DescribeCollectionResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *milvuspb.DescribeCollectionRequest, ...grpc.CallOption) *rootcoordpb.DescribeCollectionResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*rootcoordpb.DescribeCollectionResponse)
		}
	}
...
// MockRootCoordClient_DescribeCollection_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DescribeCollection'
type MockRootCoordClient_DescribeCollectionWithState_Call struct {
	*mock.Call
}

// DescribeCollectionWithState is a helper method to define mock.On call
//   - ctx context.Context
//   - in *milvuspb.DescribeCollectionRequest
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) DescribeCollectionWithState(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_DescribeCollectionWithState_Call {
	return &MockRootCoordClient_DescribeCollectionWithState_Call{Call: _e.mock.On("DescribeCollectionWithState",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_DescribeCollectionWithState_Call) Run(run func(ctx context.Context, in *milvuspb.DescribeCollectionRequest, opts ...grpc.CallOption)) *MockRootCoordClient_DescribeCollectionWithState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_DescribeCollectionWithState_Call) Return(_a0 *rootcoordpb.DescribeCollectionResponse, _a1 error) *MockRootCoordClient_DescribeCollectionWithState_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_DescribeCollectionWithState_Call) RunAndReturn(run func(context.Context, *milvuspb.DescribeCollectionRequest, ...grpc.CallOption) (*rootcoordpb.DescribeCollectionResponse, error)) *MockRootCoordClient_DescribeCollectionWithState_Call {
	_c.Call.Return(run)
	return _c
}
