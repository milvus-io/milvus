...
func (_m *MockRootCoordClient) RestoreSnapshot(ctx context.Context, in *milvuspb.RestoreSnapshotRequest, opts ...grpc.CallOption) (*milvuspb.RestoreSnapshotResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockRootCoordClient_RestoreSnapshot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RestoreSnapshot'
type MockRootCoordClient_RestoreSnapshot_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) RestoreSnapshot(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_RestoreSnapshot_Call {
	return &MockRootCoordClient_RestoreSnapshot_Call{Call: _e.mock.On("RestoreSnapshot",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_RestoreSnapshot_Call) Run(run func(ctx context.Context, in *milvuspb.RestoreSnapshotRequest, opts ...grpc.CallOption)) *MockRootCoordClient_RestoreSnapshot_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_RestoreSnapshot_Call) Return(_a0 *milvuspb.RestoreSnapshotResponse, _a1 error) *MockRootCoordClient_RestoreSnapshot_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_RestoreSnapshot_Call) RunAndReturn(run func(context.Context, *milvuspb.RestoreSnapshotRequest, ...grpc.CallOption) (*milvuspb.RestoreSnapshotResponse, error)) *MockRootCoordClient_RestoreSnapshot_Call {
	_c.Call.Return(run)
	return _c
}
