...
// GetFeatureUsage provides a mock function with given fields: ctx, in, opts
func (_m *MockRootCoordClient) GetFeatureUsage(ctx context.Context, in *internalpb.GetFeatureUsageRequest, opts ...grpc.CallOption) (*internalpb.FeatureUsageReport, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *internalpb.GetFeatureUsageRequest, ...grpc.CallOption) (*internalpb.FeatureUsageReport, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *internalpb.GetFeatureUsageRequest, ...grpc.CallOption) *internalpb.FeatureUsageReport); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *internalpb.GetFeatureUsageRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockRootCoordClient_GetFeatureUsage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetFeatureUsage'
type MockRootCoordClient_GetFeatureUsage_Call struct {
	*mock.Call
}

// GetFeatureUsage is a helper method to define mock.On call
//   - ctx context.Context
//   - in *internalpb.GetFeatureUsageRequest
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) GetFeatureUsage(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_GetFeatureUsage_Call {
	return &MockRootCoordClient_GetFeatureUsage_Call{Call: _e.mock.On("GetFeatureUsage",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_GetFeatureUsage_Call) Run(run func(ctx context.Context, in *internalpb.GetFeatureUsageRequest, opts ...grpc.CallOption)) *MockRootCoordClient_GetFeatureUsage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*internalpb.GetFeatureUsageRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockRootCoordClient_GetFeatureUsage_Call) Return(_a0 *internalpb.FeatureUsageReport, _a1 error) *MockRootCoordClient_GetFeatureUsage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_GetFeatureUsage_Call) RunAndReturn(run func(context.Context, *internalpb.GetFeatureUsageRequest, ...grpc.CallOption) (*internalpb.FeatureUsageReport, error)) *MockRootCoordClient_GetFeatureUsage_Call {
	_c.Call.Return(run)
	return _c
}
