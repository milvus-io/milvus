...
func (_m *MockRootCoordClient) ForceReleaseDataViewGate(ctx context.Context, in *rootcoordpb.ForceReleaseDataViewGateRequest, opts ...grpc.CallOption) (*rootcoordpb.ForceReleaseDataViewGateResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockRootCoordClient_ForceReleaseDataViewGate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ForceReleaseDataViewGate'
type MockRootCoordClient_ForceReleaseDataViewGate_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) ForceReleaseDataViewGate(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_ForceReleaseDataViewGate_Call {
	return &MockRootCoordClient_ForceReleaseDataViewGate_Call{Call: _e.mock.On("ForceReleaseDataViewGate",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_ForceReleaseDataViewGate_Call) Run(run func(ctx context.Context, in *rootcoordpb.ForceReleaseDataViewGateRequest, opts ...grpc.CallOption)) *MockRootCoordClient_ForceReleaseDataViewGate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_ForceReleaseDataViewGate_Call) Return(_a0 *rootcoordpb.ForceReleaseDataViewGateResponse, _a1 error) *MockRootCoordClient_ForceReleaseDataViewGate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_ForceReleaseDataViewGate_Call) RunAndReturn(run func(context.Context, *rootcoordpb.ForceReleaseDataViewGateRequest, ...grpc.CallOption) (*rootcoordpb.ForceReleaseDataViewGateResponse, error)) *MockRootCoordClient_ForceReleaseDataViewGate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRootCoordClient) GetDataViewGate(ctx context.Context, in *rootcoordpb.GetDataViewGateRequest, opts ...grpc.CallOption) (*rootcoordpb.GetDataViewGateResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockRootCoordClient_GetDataViewGate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDataViewGate'
type MockRootCoordClient_GetDataViewGate_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) GetDataViewGate(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_GetDataViewGate_Call {
	return &MockRootCoordClient_GetDataViewGate_Call{Call: _e.mock.On("GetDataViewGate",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_GetDataViewGate_Call) Run(run func(ctx context.Context, in *rootcoordpb.GetDataViewGateRequest, opts ...grpc.CallOption)) *MockRootCoordClient_GetDataViewGate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_GetDataViewGate_Call) Return(_a0 *rootcoordpb.GetDataViewGateResponse, _a1 error) *MockRootCoordClient_GetDataViewGate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_GetDataViewGate_Call) RunAndReturn(run func(context.Context, *rootcoordpb.GetDataViewGateRequest, ...grpc.CallOption) (*rootcoordpb.GetDataViewGateResponse, error)) *MockRootCoordClient_GetDataViewGate_Call {
	_c.Call.Return(run)
	return _c
}
