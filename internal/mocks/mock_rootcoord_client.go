...
func (_m *MockRootCoordClient) CatalogTransferAbort(ctx context.Context, in *rootcoordpb.CatalogTransferAbortRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockRootCoordClient_CatalogTransferAbort_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CatalogTransferAbort'
type MockRootCoordClient_CatalogTransferAbort_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) CatalogTransferAbort(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_CatalogTransferAbort_Call {
	return &MockRootCoordClient_CatalogTransferAbort_Call{Call: _e.mock.On("CatalogTransferAbort",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_CatalogTransferAbort_Call) Run(run func(ctx context.Context, in *rootcoordpb.CatalogTransferAbortRequest, opts ...grpc.CallOption)) *MockRootCoordClient_CatalogTransferAbort_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_CatalogTransferAbort_Call) Return(_a0 *commonpb.Status, _a1 error) *MockRootCoordClient_CatalogTransferAbort_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_CatalogTransferAbort_Call) RunAndReturn(run func(context.Context, *rootcoordpb.CatalogTransferAbortRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockRootCoordClient_CatalogTransferAbort_Call {
	_c.Call.Return(run)
	return _c
}

// CatalogTransferApply provides a mock function with given fields: ctx, in, opts
func (_m *MockRootCoordClient) CatalogTransferApply(ctx context.Context, in *rootcoordpb.CatalogTransferApplyRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockRootCoordClient_CatalogTransferApply_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CatalogTransferApply'
type MockRootCoordClient_CatalogTransferApply_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) CatalogTransferApply(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_CatalogTransferApply_Call {
	return &MockRootCoordClient_CatalogTransferApply_Call{Call: _e.mock.On("CatalogTransferApply",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_CatalogTransferApply_Call) Run(run func(ctx context.Context, in *rootcoordpb.CatalogTransferApplyRequest, opts ...grpc.CallOption)) *MockRootCoordClient_CatalogTransferApply_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_CatalogTransferApply_Call) Return(_a0 *commonpb.Status, _a1 error) *MockRootCoordClient_CatalogTransferApply_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_CatalogTransferApply_Call) RunAndReturn(run func(context.Context, *rootcoordpb.CatalogTransferApplyRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockRootCoordClient_CatalogTransferApply_Call {
	_c.Call.Return(run)
	return _c
}

// CatalogTransferDeactivate provides a mock function with given fields: ctx, in, opts
func (_m *MockRootCoordClient) CatalogTransferDeactivate(ctx context.Context, in *rootcoordpb.CatalogTransferDeactivateRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockRootCoordClient_CatalogTransferDeactivate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CatalogTransferDeactivate'
type MockRootCoordClient_CatalogTransferDeactivate_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) CatalogTransferDeactivate(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_CatalogTransferDeactivate_Call {
	return &MockRootCoordClient_CatalogTransferDeactivate_Call{Call: _e.mock.On("CatalogTransferDeactivate",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_CatalogTransferDeactivate_Call) Run(run func(ctx context.Context, in *rootcoordpb.CatalogTransferDeactivateRequest, opts ...grpc.CallOption)) *MockRootCoordClient_CatalogTransferDeactivate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_CatalogTransferDeactivate_Call) Return(_a0 *commonpb.Status, _a1 error) *MockRootCoordClient_CatalogTransferDeactivate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_CatalogTransferDeactivate_Call) RunAndReturn(run func(context.Context, *rootcoordpb.CatalogTransferDeactivateRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockRootCoordClient_CatalogTransferDeactivate_Call {
	_c.Call.Return(run)
	return _c
}

// CatalogTransferPrepare provides a mock function with given fields: ctx, in, opts
func (_m *MockRootCoordClient) CatalogTransferPrepare(ctx context.Context, in *rootcoordpb.CatalogTransferPrepareRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockRootCoordClient_CatalogTransferPrepare_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CatalogTransferPrepare'
type MockRootCoordClient_CatalogTransferPrepare_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) CatalogTransferPrepare(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_CatalogTransferPrepare_Call {
	return &MockRootCoordClient_CatalogTransferPrepare_Call{Call: _e.mock.On("CatalogTransferPrepare",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockRootCoordClient_CatalogTransferPrepare_Call) Run(run func(ctx context.Context, in *rootcoordpb.CatalogTransferPrepareRequest, opts ...grpc.CallOption)) *MockRootCoordClient_CatalogTransferPrepare_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockRootCoordClient_CatalogTransferPrepare_Call) Return(_a0 *commonpb.Status, _a1 error) *MockRootCoordClient_CatalogTransferPrepare_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoordClient_CatalogTransferPrepare_Call) RunAndReturn(run func(context.Context, *rootcoordpb.CatalogTransferPrepareRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockRootCoordClient_CatalogTransferPrepare_Call {
	_c.Call.Return(run)
	return _c
}
