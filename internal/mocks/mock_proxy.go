...
// SyncDataViewGate provides a mock function with given fields: _a0, _a1
func (_m *MockProxy) SyncDataViewGate(_a0 context.Context, _a1 *proxypb.SyncDataViewGateRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *proxypb.SyncDataViewGateRequest) (*commonpb.Status, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *proxypb.SyncDataViewGateRequest) *commonpb.Status); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *proxypb.SyncDataViewGateRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MockProxy_SyncDataViewGate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncDataViewGate'
type MockProxy_SyncDataViewGate_Call struct {
	*mock.Call
}

// SyncDataViewGate is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *proxypb.SyncDataViewGateRequest
func (_e *MockProxy_Expecter) SyncDataViewGate(_a0 interface{}, _a1 interface{}) *MockProxy_SyncDataViewGate_Call {
	return &MockProxy_SyncDataViewGate_Call{Call: _e.mock.On("SyncDataViewGate", _a0, _a1)}
}

func (_c *MockProxy_SyncDataViewGate_Call) Run(run func(_a0 context.Context, _a1 *proxypb.SyncDataViewGateRequest)) *MockProxy_SyncDataViewGate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*proxypb.SyncDataViewGateRequest))
	})
	return _c
}

func (_c *MockProxy_SyncDataViewGate_Call) Return(_a0 *commonpb.Status, _a1 error) *MockProxy_SyncDataViewGate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProxy_SyncDataViewGate_Call) RunAndReturn(run func(context.Context, *proxypb.SyncDataViewGateRequest) (*commonpb.Status, error)) *MockProxy_SyncDataViewGate_Call {
	_c.Call.Return(run)
	return _c
}
