...
func (_m *MockDataNode) CheckChannelOperationProgress(ctx context.Context, req *datapb.ChannelOperationProgressRequest) (*datapb.ChannelOperationProgressResponse, error) {
	ret := _m.Called(ctx, req)

	var r0 *datapb.ChannelOperationProgressResponse
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.ChannelOperationProgressRequest) *datapb.ChannelOperationProgressResponse); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *datapb.ChannelOperationProgressRequest) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
...
//  - ctx context.Context
//  - req *datapb.ChannelOperationProgressRequest
...
func (_c *MockDataNode_CheckChannelOperationProgress_Call) Run(run func(ctx context.Context, req *datapb.ChannelOperationProgressRequest)) *MockDataNode_CheckChannelOperationProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*datapb.ChannelOperationProgressRequest))
	})
	return _c
}
...
func (_m *MockDataNode) NotifyChannelOperation(ctx context.Context, req *datapb.ChannelWatchInfo) (*commonpb.Status, error) {
	ret := _m.Called(ctx, req)

	var r0 *commonpb.Status
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.ChannelWatchInfo) *commonpb.Status); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
...
func (_c *MockDataNode_NotifyChannelOperation_Call) Run(run func(ctx context.Context, req *datapb.ChannelWatchInfo)) *MockDataNode_NotifyChannelOperation_Call {
	_c.Call.Run(func(args mock.Arguments) {
