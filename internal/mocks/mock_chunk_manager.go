...
func (_m *ChunkManager) ListWithPrefix(ctx context.Context, prefix string, recursive bool) <-chan storage.ObjectPathHolder {
	ret := _m.Called(ctx, prefix, recursive)

	var r0 <-chan storage.ObjectPathHolder
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) <-chan storage.ObjectPathHolder); ok {
		r0 = rf(ctx, prefix, recursive)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan storage.ObjectPathHolder)
		}
	}
...
func (_c *ChunkManager_ListWithPrefix_Call) Return(_a0 <-chan storage.ObjectPathHolder) *ChunkManager_ListWithPrefix_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ChunkManager_ListWithPrefix_Call) RunAndReturn(run func(context.Context, string, bool) <-chan storage.ObjectPathHolder) *ChunkManager_ListWithPrefix_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ChunkManager) MultiRead(ctx context.Context, filePaths []string) <-chan storage.ObjectDataHolder {
	ret := _m.Called(ctx, filePaths)

	var r0 <-chan storage.ObjectDataHolder
	if rf, ok := ret.Get(0).(func(context.Context, []string) <-chan storage.ObjectDataHolder); ok {
		r0 = rf(ctx, filePaths)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan storage.ObjectDataHolder)
		}
	}
...
func (_c *ChunkManager_MultiRead_Call) Return(_a0 <-chan storage.ObjectDataHolder) *ChunkManager_MultiRead_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ChunkManager_MultiRead_Call) RunAndReturn(run func(context.Context, []string) <-chan storage.ObjectDataHolder) *ChunkManager_MultiRead_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ChunkManager) ReadWithPrefix(ctx context.Context, prefix string) <-chan storage.ObjectDataHolder {
...
func (_c *ChunkManager_ReadWithPrefix_Call) Return(_a0 <-chan storage.ObjectDataHolder) *ChunkManager_ReadWithPrefix_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ChunkManager_ReadWithPrefix_Call) RunAndReturn(run func(context.Context, string) <-chan storage.ObjectDataHolder) *ChunkManager_ReadWithPrefix_Call {
	_c.Call.Return(run)
	return _c
}
