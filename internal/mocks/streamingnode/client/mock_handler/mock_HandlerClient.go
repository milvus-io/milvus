...
func (_m *MockHandlerClient) GetGrowingFlushProgress(ctx context.Context, vchannel string, segmentIDs []int64, fenceTs uint64) ([]writebuffer.GrowingFlushSegmentProgress, error) {
...
// MockHandlerClient_GetGrowingFlushProgress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetGrowingFlushProgress'
type MockHandlerClient_GetGrowingFlushProgress_Call struct {
	*mock.Call
}
...
//   - segmentIDs []int64
//   - fenceTs uint64
func (_e *MockHandlerClient_Expecter) GetGrowingFlushProgress(ctx interface{}, vchannel interface{}, segmentIDs interface{}, fenceTs interface{}) *MockHandlerClient_GetGrowingFlushProgress_Call {
	return &MockHandlerClient_GetGrowingFlushProgress_Call{Call: _e.mock.On("GetGrowingFlushProgress", ctx, vchannel, segmentIDs, fenceTs)}
}

func (_c *MockHandlerClient_GetGrowingFlushProgress_Call) Run(run func(ctx context.Context, vchannel string, segmentIDs []int64, fenceTs uint64)) *MockHandlerClient_GetGrowingFlushProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockHandlerClient_GetGrowingFlushProgress_Call) Return(_a0 []writebuffer.GrowingFlushSegmentProgress, _a1 error) *MockHandlerClient_GetGrowingFlushProgress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockHandlerClient_GetGrowingFlushProgress_Call) RunAndReturn(run func(context.Context, string, []int64, uint64) ([]writebuffer.GrowingFlushSegmentProgress, error)) *MockHandlerClient_GetGrowingFlushProgress_Call {
	_c.Call.Return(run)
	return _c
}
