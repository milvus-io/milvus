...
func (_m *MockHandlerClient) PrepareReleaseManualFlushIfLocal(ctx context.Context, collectionID int64, vchannel string, releaseSegmentIDs []int64) error {
...
func (_c *MockHandlerClient_PrepareReleaseManualFlushIfLocal_Call) Return(_a0 error) *MockHandlerClient_PrepareReleaseManualFlushIfLocal_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockHandlerClient_PrepareReleaseManualFlushIfLocal_Call) RunAndReturn(run func(context.Context, int64, string, []int64) error) *MockHandlerClient_PrepareReleaseManualFlushIfLocal_Call {
	_c.Call.Return(run)
	return _c
}

// PrepareReleaseSegmentsIfLocal provides a mock function with given fields: ctx, collectionID, vchannel, segmentIDs
func (_m *MockHandlerClient) PrepareReleaseSegmentsIfLocal(ctx context.Context, collectionID int64, vchannel string, segmentIDs []int64) (bool, error) {
...
// MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PrepareReleaseSegmentsIfLocal'
type MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call struct {
	*mock.Call
}
...
//   - vchannel string
//   - segmentIDs []int64
func (_e *MockHandlerClient_Expecter) PrepareReleaseSegmentsIfLocal(ctx interface{}, collectionID interface{}, vchannel interface{}, segmentIDs interface{}) *MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call {
	return &MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call{Call: _e.mock.On("PrepareReleaseSegmentsIfLocal", ctx, collectionID, vchannel, segmentIDs)}
}

func (_c *MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call) Run(run func(ctx context.Context, collectionID int64, vchannel string, segmentIDs []int64)) *MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(string), args[3].([]int64))
	})
	return _c
...
func (_c *MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call) Return(_a0 bool, _a1 error) *MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call) RunAndReturn(run func(context.Context, int64, string, []int64) (bool, error)) *MockHandlerClient_PrepareReleaseSegmentsIfLocal_Call {
	_c.Call.Return(run)
	return _c
}
