...
func (_m *MockWAL) TransformLog() transformlog.Accesser {
	ret := _m.Called()
...
func (_c *MockWAL_TransformLog_Call) Return(_a0 transformlog.Accesser) *MockWAL_TransformLog_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWAL_TransformLog_Call) RunAndReturn(run func() transformlog.Accesser) *MockWAL_TransformLog_Call {
	_c.Call.Return(run)
	return _c
}
