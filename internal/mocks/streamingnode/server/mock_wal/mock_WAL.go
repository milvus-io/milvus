...
func (_m *MockWAL) TransformLog() wal.TransformLogAccesser {
	ret := _m.Called()
...
// MockWAL_TransformLog_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TransformLog'
type MockWAL_TransformLog_Call struct {
	*mock.Call
}

// TransformLog is a helper method to define mock.On call
func (_e *MockWAL_Expecter) TransformLog() *MockWAL_TransformLog_Call {
	return &MockWAL_TransformLog_Call{Call: _e.mock.On("TransformLog")}
}

func (_c *MockWAL_TransformLog_Call) Run(run func()) *MockWAL_TransformLog_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockWAL_TransformLog_Call) Return(_a0 wal.TransformLogAccesser) *MockWAL_TransformLog_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWAL_TransformLog_Call) RunAndReturn(run func() wal.TransformLogAccesser) *MockWAL_TransformLog_Call {
	_c.Call.Return(run)
	return _c
}
