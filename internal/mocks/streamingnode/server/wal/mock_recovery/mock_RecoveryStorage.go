...
// GetFlusherCheckpointByTimeTick provides a mock function with no fields
func (_m *MockRecoveryStorage) GetFlusherCheckpointByTimeTick() *utility.WALCheckpoint {
	ret := _m.Called()
...
func (_e *MockRecoveryStorage_Expecter) GetFlusherCheckpointByTimeTick() *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call {
	return &MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call{Call: _e.mock.On("GetFlusherCheckpointByTimeTick")}
}

func (_c *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call) Run(run func()) *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call) Return(_a0 *utility.WALCheckpoint) *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call) RunAndReturn(run func() *utility.WALCheckpoint) *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRecoveryStorage) UpdateFlusherCheckpoint(vchannel string, checkpoint *utility.WALCheckpoint) {
...
func (_c *MockRecoveryStorage_UpdateFlusherCheckpoint_Call) Run(run func(vchannel string, checkpoint *utility.WALCheckpoint)) *MockRecoveryStorage_UpdateFlusherCheckpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*utility.WALCheckpoint))
	})
	return _c
}
...
func (_c *MockRecoveryStorage_UpdateFlusherCheckpoint_Call) RunAndReturn(run func(string, *utility.WALCheckpoint)) *MockRecoveryStorage_UpdateFlusherCheckpoint_Call {
	_c.Run(run)
	return _c
}
