...
func (_m *MockRecoveryStorage) GetFlusherCheckpointByTimeTick(ctx context.Context) *utility.WALCheckpoint {
	ret := _m.Called(ctx)
...
func (_c *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call) RunAndReturn(run func(context.Context) *utility.WALCheckpoint) *MockRecoveryStorage_GetFlusherCheckpointByTimeTick_Call {
	_c.Call.Return(run)
	return _c
}
