...
import (
	...
	mlog "github.com/milvus-io/milvus/pkg/v3/mlog"
...
func (_m *MockShardManager) SplitShard(msg message.MutableSplitShardMessageV2) {
	_m.Called(msg)
}
...
//   - msg message.MutableSplitShardMessageV2
...
func (_c *MockShardManager_SplitShard_Call) Run(run func(msg message.MutableSplitShardMessageV2)) *MockShardManager_SplitShard_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(message.MutableSplitShardMessageV2))
	})
	return _c
}
...
func (_c *MockShardManager_SplitShard_Call) RunAndReturn(run func(message.MutableSplitShardMessageV2)) *MockShardManager_SplitShard_Call {
	_c.Run(run)
	return _c
}
