...
// MockReplicatesManager is an autogenerated mock type for the ReplicateManager type
...
func (_m *MockReplicatesManager) SwitchReplicateMode(ctx context.Context, msg message.specializedMutableMessage[*messagespb.AlterReplicateConfigMessageHeader, *messagespb.AlterReplicateConfigMessageBody]) error {
	ret := _m.Called(ctx, msg)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.specializedMutableMessage[*messagespb.AlterReplicateConfigMessageHeader, *messagespb.AlterReplicateConfigMessageBody]) error); ok {
		r0 = rf(ctx, msg)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockReplicatesManager_SwitchReplicateMode_Call) Run(run func(ctx context.Context, msg message.specializedMutableMessage[*messagespb.AlterReplicateConfigMessageHeader, *messagespb.AlterReplicateConfigMessageBody])) *MockReplicatesManager_SwitchReplicateMode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.specializedMutableMessage[*messagespb.AlterReplicateConfigMessageHeader, *messagespb.AlterReplicateConfigMessageBody]))
	})
	return _c
}
...
func (_c *MockReplicatesManager_SwitchReplicateMode_Call) RunAndReturn(run func(context.Context, message.specializedMutableMessage[*messagespb.AlterReplicateConfigMessageHeader, *messagespb.AlterReplicateConfigMessageBody]) error) *MockReplicatesManager_SwitchReplicateMode_Call {
	_c.Call.Return(run)
	return _c
}
