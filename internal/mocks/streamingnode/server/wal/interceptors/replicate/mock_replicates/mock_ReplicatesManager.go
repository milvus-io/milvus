...
func (_m *MockReplicatesManager) SwitchReplicateMode(ctx context.Context, msg message.MutablePutReplicateConfigMessageV2) error {
	ret := _m.Called(ctx, msg)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.MutablePutReplicateConfigMessageV2) error); ok {
		r0 = rf(ctx, msg)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - msg message.MutablePutReplicateConfigMessageV2
...
func (_c *MockReplicatesManager_SwitchReplicateMode_Call) Run(run func(ctx context.Context, msg message.MutablePutReplicateConfigMessageV2)) *MockReplicatesManager_SwitchReplicateMode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.MutablePutReplicateConfigMessageV2))
	})
	return _c
}
...
func (_c *MockReplicatesManager_SwitchReplicateMode_Call) RunAndReturn(run func(context.Context, message.MutablePutReplicateConfigMessageV2) error) *MockReplicatesManager_SwitchReplicateMode_Call {
	_c.Call.Return(run)
	return _c
}
