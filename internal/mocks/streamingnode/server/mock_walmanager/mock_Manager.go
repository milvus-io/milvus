...
func (_m *MockManager) GetAvailableRawWALByPChannel(pchannel string) (wal.WAL, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetAvailableRawWALByPChannel")
	}
	...
	if rf, ok := ret.Get(0).(func(string) wal.WAL); ok {
		r0 = rf(pchannel)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(wal.WAL)
...
// MockManager_GetAvailableRawWALByPChannel_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAvailableRawWALByPChannel'
type MockManager_GetAvailableRawWALByPChannel_Call struct {
	*mock.Call
}

// GetAvailableRawWALByPChannel is a helper method to define mock.On call
//   - pchannel string
func (_e *MockManager_Expecter) GetAvailableRawWALByPChannel(pchannel interface{}) *MockManager_GetAvailableRawWALByPChannel_Call {
	return &MockManager_GetAvailableRawWALByPChannel_Call{Call: _e.mock.On("GetAvailableRawWALByPChannel", pchannel)}
}

func (_c *MockManager_GetAvailableRawWALByPChannel_Call) Run(run func(pchannel string)) *MockManager_GetAvailableRawWALByPChannel_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockManager_GetAvailableRawWALByPChannel_Call) Return(_a0 wal.WAL, _a1 error) *MockManager_GetAvailableRawWALByPChannel_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockManager_GetAvailableRawWALByPChannel_Call) RunAndReturn(run func(string) (wal.WAL, error)) *MockManager_GetAvailableRawWALByPChannel_Call {
	_c.Call.Return(run)
	return _c
}
