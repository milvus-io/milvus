...
// MockProxyClient_ClearReadTaskQueue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ClearReadTaskQueue'
type MockProxyClient_ClearReadTaskQueue_Call struct {
	*mock.Call
}
...
func (_e *MockProxyClient_Expecter) ClearReadTaskQueue(ctx interface{}, in interface{}, opts ...interface{}) *MockProxyClient_ClearReadTaskQueue_Call {
	return &MockProxyClient_ClearReadTaskQueue_Call{Call: _e.mock.On("ClearReadTaskQueue",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockProxyClient_ClearReadTaskQueue_Call) Run(run func(ctx context.Context, in *internalpb.ClearReadTaskQueueRequest, opts ...grpc.CallOption)) *MockProxyClient_ClearReadTaskQueue_Call {
...
func (_c *MockProxyClient_ClearReadTaskQueue_Call) Return(_a0 *internalpb.ClearReadTaskQueueResponse, _a1 error) *MockProxyClient_ClearReadTaskQueue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProxyClient_ClearReadTaskQueue_Call) RunAndReturn(run func(context.Context, *internalpb.ClearReadTaskQueueRequest, ...grpc.CallOption) (*internalpb.ClearReadTaskQueueResponse, error)) *MockProxyClient_ClearReadTaskQueue_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockProxyClient) GetFeatureUsage(ctx context.Context, in *internalpb.GetFeatureUsageRequest, opts ...grpc.CallOption) (*internalpb.GetFeatureUsageResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *internalpb.GetFeatureUsageRequest, ...grpc.CallOption) (*internalpb.GetFeatureUsageResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *internalpb.GetFeatureUsageRequest, ...grpc.CallOption) *internalpb.GetFeatureUsageResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
...
// MockProxyClient_GetFeatureUsage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetFeatureUsage'
type MockProxyClient_GetFeatureUsage_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockProxyClient_Expecter) GetFeatureUsage(ctx interface{}, in interface{}, opts ...interface{}) *MockProxyClient_GetFeatureUsage_Call {
	return &MockProxyClient_GetFeatureUsage_Call{Call: _e.mock.On("GetFeatureUsage",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockProxyClient_GetFeatureUsage_Call) Run(run func(ctx context.Context, in *internalpb.GetFeatureUsageRequest, opts ...grpc.CallOption)) *MockProxyClient_GetFeatureUsage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockProxyClient_GetFeatureUsage_Call) Return(_a0 *internalpb.GetFeatureUsageResponse, _a1 error) *MockProxyClient_GetFeatureUsage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProxyClient_GetFeatureUsage_Call) RunAndReturn(run func(context.Context, *internalpb.GetFeatureUsageRequest, ...grpc.CallOption) (*internalpb.GetFeatureUsageResponse, error)) *MockProxyClient_GetFeatureUsage_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockProxyClient) SyncFileResource(ctx context.Context, in *internalpb.SyncFileResourceRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockProxyClient_SyncFileResource_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncFileResource'
type MockProxyClient_SyncFileResource_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockProxyClient_Expecter) SyncFileResource(ctx interface{}, in interface{}, opts ...interface{}) *MockProxyClient_SyncFileResource_Call {
	return &MockProxyClient_SyncFileResource_Call{Call: _e.mock.On("SyncFileResource",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockProxyClient_SyncFileResource_Call) Run(run func(ctx context.Context, in *internalpb.SyncFileResourceRequest, opts ...grpc.CallOption)) *MockProxyClient_SyncFileResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockProxyClient_SyncFileResource_Call) Return(_a0 *commonpb.Status, _a1 error) *MockProxyClient_SyncFileResource_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProxyClient_SyncFileResource_Call) RunAndReturn(run func(context.Context, *internalpb.SyncFileResourceRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockProxyClient_SyncFileResource_Call {
	_c.Call.Return(run)
	return _c
}
