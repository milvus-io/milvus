...
// SyncDataViewGate provides a mock function with given fields: ctx, in, opts
func (_m *MockProxyClient) SyncDataViewGate(ctx context.Context, in *proxypb.SyncDataViewGateRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for SyncDataViewGate")
	}

	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *proxypb.SyncDataViewGateRequest, ...grpc.CallOption) (*commonpb.Status, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *proxypb.SyncDataViewGateRequest, ...grpc.CallOption) *commonpb.Status); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *proxypb.SyncDataViewGateRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockProxyClient_SyncDataViewGate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncDataViewGate'
type MockProxyClient_SyncDataViewGate_Call struct {
	*mock.Call
}

// SyncDataViewGate is a helper method to define mock.On call
//   - ctx context.Context
//   - in *proxypb.SyncDataViewGateRequest
//   - opts ...grpc.CallOption
func (_e *MockProxyClient_Expecter) SyncDataViewGate(ctx interface{}, in interface{}, opts ...interface{}) *MockProxyClient_SyncDataViewGate_Call {
	return &MockProxyClient_SyncDataViewGate_Call{Call: _e.mock.On("SyncDataViewGate",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockProxyClient_SyncDataViewGate_Call) Run(run func(ctx context.Context, in *proxypb.SyncDataViewGateRequest, opts ...grpc.CallOption)) *MockProxyClient_SyncDataViewGate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*proxypb.SyncDataViewGateRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockProxyClient_SyncDataViewGate_Call) Return(_a0 *commonpb.Status, _a1 error) *MockProxyClient_SyncDataViewGate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProxyClient_SyncDataViewGate_Call) RunAndReturn(run func(context.Context, *proxypb.SyncDataViewGateRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockProxyClient_SyncDataViewGate_Call {
	_c.Call.Return(run)
	return _c
}
