...
func (_m *MockQueryCoord) DescribePrewarmTask(_a0 context.Context, _a1 *querypb.DescribePrewarmTaskRequest) (*querypb.DescribePrewarmTaskResponse, error) {
	ret := _m.Called(_a0, _a1)
...
// MockQueryCoord_DescribePrewarmTask_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DescribePrewarmTask'
type MockQueryCoord_DescribePrewarmTask_Call struct {
	*mock.Call
}
...
func (_e *MockQueryCoord_Expecter) DescribePrewarmTask(_a0 interface{}, _a1 interface{}) *MockQueryCoord_DescribePrewarmTask_Call {
	return &MockQueryCoord_DescribePrewarmTask_Call{Call: _e.mock.On("DescribePrewarmTask", _a0, _a1)}
}

func (_c *MockQueryCoord_DescribePrewarmTask_Call) Run(run func(_a0 context.Context, _a1 *querypb.DescribePrewarmTaskRequest)) *MockQueryCoord_DescribePrewarmTask_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueryCoord_DescribePrewarmTask_Call) Return(_a0 *querypb.DescribePrewarmTaskResponse, _a1 error) *MockQueryCoord_DescribePrewarmTask_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryCoord_DescribePrewarmTask_Call) RunAndReturn(run func(context.Context, *querypb.DescribePrewarmTaskRequest) (*querypb.DescribePrewarmTaskResponse, error)) *MockQueryCoord_DescribePrewarmTask_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockQueryCoord) Prewarm(_a0 context.Context, _a1 *querypb.PrewarmRequest) (*querypb.PrewarmResponse, error) {
	ret := _m.Called(_a0, _a1)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *querypb.PrewarmRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MockQueryCoord_Prewarm_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Prewarm'
type MockQueryCoord_Prewarm_Call struct {
	*mock.Call
}

// Prewarm is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *querypb.PrewarmRequest
func (_e *MockQueryCoord_Expecter) Prewarm(_a0 interface{}, _a1 interface{}) *MockQueryCoord_Prewarm_Call {
	return &MockQueryCoord_Prewarm_Call{Call: _e.mock.On("Prewarm", _a0, _a1)}
}

func (_c *MockQueryCoord_Prewarm_Call) Run(run func(_a0 context.Context, _a1 *querypb.PrewarmRequest)) *MockQueryCoord_Prewarm_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*querypb.PrewarmRequest))
	})
	return _c
}

func (_c *MockQueryCoord_Prewarm_Call) Return(_a0 *querypb.PrewarmResponse, _a1 error) *MockQueryCoord_Prewarm_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryCoord_Prewarm_Call) RunAndReturn(run func(context.Context, *querypb.PrewarmRequest) (*querypb.PrewarmResponse, error)) *MockQueryCoord_Prewarm_Call {
	_c.Call.Return(run)
	return _c
}
