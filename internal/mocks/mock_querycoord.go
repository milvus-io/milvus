...
func (_m *MockQueryCoord) Prewarm(_a0 context.Context, _a1 *querypb.PrewarmRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *MockQueryCoord_Prewarm_Call) Return(_a0 *commonpb.Status, _a1 error) *MockQueryCoord_Prewarm_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryCoord_Prewarm_Call) RunAndReturn(run func(context.Context, *querypb.PrewarmRequest) (*commonpb.Status, error)) *MockQueryCoord_Prewarm_Call {
	_c.Call.Return(run)
	return _c
}
