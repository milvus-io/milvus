...
func (_m *MockMessageID) EQ(_a0 mqwrapper.MessageID) bool {
	ret := _m.Called(_a0)

	var r0 bool
	if rf, ok := ret.Get(0).(func(mqwrapper.MessageID) bool); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
//   - _a0 mqwrapper.MessageID
func (_e *MockMessageID_Expecter) EQ(_a0 interface{}) *MockMessageID_EQ_Call {
	return &MockMessageID_EQ_Call{Call: _e.mock.On("EQ", _a0)}
}

func (_c *MockMessageID_EQ_Call) Run(run func(_a0 mqwrapper.MessageID)) *MockMessageID_EQ_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(mqwrapper.MessageID))
	})
	return _c
}
...
func (_c *MockMessageID_EQ_Call) RunAndReturn(run func(mqwrapper.MessageID) bool) *MockMessageID_EQ_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockMessageID) LT(_a0 mqwrapper.MessageID) bool {
	ret := _m.Called(_a0)
...
func (_c *MockMessageID_LT_Call) Run(run func(_a0 mqwrapper.MessageID)) *MockMessageID_LT_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(mqwrapper.MessageID))
	})
	return _c
...
func (_c *MockMessageID_LT_Call) RunAndReturn(run func(mqwrapper.MessageID) bool) *MockMessageID_LT_Call {
	_c.Call.Return(run)
	return _c
}

// LTE provides a mock function with given fields: _a0
func (_m *MockMessageID) LTE(_a0 mqwrapper.MessageID) bool {
	ret := _m.Called(_a0)
...
func (_c *MockMessageID_LTE_Call) Run(run func(_a0 mqwrapper.MessageID)) *MockMessageID_LTE_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(mqwrapper.MessageID))
	})
	return _c
...
func (_c *MockMessageID_LTE_Call) RunAndReturn(run func(mqwrapper.MessageID) bool) *MockMessageID_LTE_Call {
	_c.Call.Return(run)
	return _c
}
