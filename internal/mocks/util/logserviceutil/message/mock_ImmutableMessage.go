...
func (_m *MockImmutableMessage) MessageID() mqwrapper.MessageID {
	ret := _m.Called()

	var r0 mqwrapper.MessageID
	if rf, ok := ret.Get(0).(func() mqwrapper.MessageID); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockImmutableMessage_MessageID_Call) Return(_a0 mqwrapper.MessageID) *MockImmutableMessage_MessageID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockImmutableMessage_MessageID_Call) RunAndReturn(run func() mqwrapper.MessageID) *MockImmutableMessage_MessageID_Call {
	_c.Call.Return(run)
	return _c
}
