...
// SyncSchema provides a mock function with given fields: colSchmea
func (_m *MockCSegment) SyncSchema(colSchmea *schemapb.CollectionSchema) error {
	ret := _m.Called(colSchmea)

	if len(ret) == 0 {
		panic("no return value specified for SyncSchema")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(*schemapb.CollectionSchema) error); ok {
		r0 = rf(colSchmea)
	} else {
		r0 = ret.Error(0)
	}
...
// MockCSegment_SyncSchema_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncSchema'
type MockCSegment_SyncSchema_Call struct {
	*mock.Call
}

// SyncSchema is a helper method to define mock.On call
//   - colSchmea *schemapb.CollectionSchema
func (_e *MockCSegment_Expecter) SyncSchema(colSchmea interface{}) *MockCSegment_SyncSchema_Call {
	return &MockCSegment_SyncSchema_Call{Call: _e.mock.On("SyncSchema", colSchmea)}
}

func (_c *MockCSegment_SyncSchema_Call) Run(run func(colSchmea *schemapb.CollectionSchema)) *MockCSegment_SyncSchema_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCSegment_SyncSchema_Call) Return(_a0 error) *MockCSegment_SyncSchema_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockCSegment_SyncSchema_Call) RunAndReturn(run func(*schemapb.CollectionSchema) error) *MockCSegment_SyncSchema_Call {
	_c.Call.Return(run)
	return _c
}
