...
func (_m *MockQueryCoordClient) GetQueryViewLoadInfo(ctx context.Context, in *querypb.GetQueryViewLoadInfoRequest, opts ...grpc.CallOption) (*querypb.GetQueryViewLoadInfoResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockQueryCoordClient_GetQueryViewLoadInfo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetQueryViewLoadInfo'
type MockQueryCoordClient_GetQueryViewLoadInfo_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockQueryCoordClient_Expecter) GetQueryViewLoadInfo(ctx interface{}, in interface{}, opts ...interface{}) *MockQueryCoordClient_GetQueryViewLoadInfo_Call {
	return &MockQueryCoordClient_GetQueryViewLoadInfo_Call{Call: _e.mock.On("GetQueryViewLoadInfo",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockQueryCoordClient_GetQueryViewLoadInfo_Call) Run(run func(ctx context.Context, in *querypb.GetQueryViewLoadInfoRequest, opts ...grpc.CallOption)) *MockQueryCoordClient_GetQueryViewLoadInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockQueryCoordClient_GetQueryViewLoadInfo_Call) Return(_a0 *querypb.GetQueryViewLoadInfoResponse, _a1 error) *MockQueryCoordClient_GetQueryViewLoadInfo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
