...
func (_m *MockQueryCoordClient) Prewarm(ctx context.Context, in *querypb.PrewarmRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *MockQueryCoordClient_Prewarm_Call) Return(_a0 *commonpb.Status, _a1 error) *MockQueryCoordClient_Prewarm_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryCoordClient_Prewarm_Call) RunAndReturn(run func(context.Context, *querypb.PrewarmRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockQueryCoordClient_Prewarm_Call {
	_c.Call.Return(run)
	return _c
}
