...
// CommitShardSplitRouting provides a mock function with given fields: _a0, _a1
func (_m *MixCoord) CommitShardSplitRouting(_a0 context.Context, _a1 *rootcoordpb.CommitShardSplitRoutingRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *rootcoordpb.CommitShardSplitRoutingRequest) (*commonpb.Status, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *rootcoordpb.CommitShardSplitRoutingRequest) *commonpb.Status); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *rootcoordpb.CommitShardSplitRoutingRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MixCoord_CommitShardSplitRouting_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CommitShardSplitRouting'
type MixCoord_CommitShardSplitRouting_Call struct {
	*mock.Call
}

// CommitShardSplitRouting is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *rootcoordpb.CommitShardSplitRoutingRequest
func (_e *MixCoord_Expecter) CommitShardSplitRouting(_a0 interface{}, _a1 interface{}) *MixCoord_CommitShardSplitRouting_Call {
	return &MixCoord_CommitShardSplitRouting_Call{Call: _e.mock.On("CommitShardSplitRouting", _a0, _a1)}
}

func (_c *MixCoord_CommitShardSplitRouting_Call) Run(run func(_a0 context.Context, _a1 *rootcoordpb.CommitShardSplitRoutingRequest)) *MixCoord_CommitShardSplitRouting_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MixCoord_CommitShardSplitRouting_Call) Return(_a0 *commonpb.Status, _a1 error) *MixCoord_CommitShardSplitRouting_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MixCoord_CommitShardSplitRouting_Call) RunAndReturn(run func(context.Context, *rootcoordpb.CommitShardSplitRoutingRequest) (*commonpb.Status, error)) *MixCoord_CommitShardSplitRouting_Call {
	_c.Call.Return(run)
	return _c
}
