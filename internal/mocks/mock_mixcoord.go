...
// UpdateSegmentColumnGroups provides a mock function with given fields: _a0, _a1
func (_m *MixCoord) UpdateSegmentColumnGroups(_a0 context.Context, _a1 *datapb.UpdateSegmentColumnGroupsRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for UpdateSegmentColumnGroups")
	}

	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.UpdateSegmentColumnGroupsRequest) (*commonpb.Status, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.UpdateSegmentColumnGroupsRequest) *commonpb.Status); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *datapb.UpdateSegmentColumnGroupsRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MixCoord_UpdateSegmentColumnGroups_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateSegmentColumnGroups'
type MixCoord_UpdateSegmentColumnGroups_Call struct {
	*mock.Call
}

// UpdateSegmentColumnGroups is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *datapb.UpdateSegmentColumnGroupsRequest
func (_e *MixCoord_Expecter) UpdateSegmentColumnGroups(_a0 interface{}, _a1 interface{}) *MixCoord_UpdateSegmentColumnGroups_Call {
	return &MixCoord_UpdateSegmentColumnGroups_Call{Call: _e.mock.On("UpdateSegmentColumnGroups", _a0, _a1)}
}

func (_c *MixCoord_UpdateSegmentColumnGroups_Call) Run(run func(_a0 context.Context, _a1 *datapb.UpdateSegmentColumnGroupsRequest)) *MixCoord_UpdateSegmentColumnGroups_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*datapb.UpdateSegmentColumnGroupsRequest))
	})
	return _c
}

func (_c *MixCoord_UpdateSegmentColumnGroups_Call) Return(_a0 *commonpb.Status, _a1 error) *MixCoord_UpdateSegmentColumnGroups_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MixCoord_UpdateSegmentColumnGroups_Call) RunAndReturn(run func(context.Context, *datapb.UpdateSegmentColumnGroupsRequest) (*commonpb.Status, error)) *MixCoord_UpdateSegmentColumnGroups_Call {
	_c.Call.Return(run)
	return _c
}
