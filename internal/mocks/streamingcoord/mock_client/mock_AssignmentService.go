...
// ReportWALReplicaAssignmentError provides a mock function with given fields: ctx, assignment, err
func (_m *MockAssignmentService) ReportWALReplicaAssignmentError(ctx context.Context, assignment types.PChannelInfoAssigned, err error) error {
	ret := _m.Called(ctx, assignment, err)

	if len(ret) == 0 {
		panic("no return value specified for ReportWALReplicaAssignmentError")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.PChannelInfoAssigned, error) error); ok {
		r0 = rf(ctx, assignment, err)
	} else {
		r0 = ret.Error(0)
	}
...
// MockAssignmentService_ReportWALReplicaAssignmentError_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReportWALReplicaAssignmentError'
type MockAssignmentService_ReportWALReplicaAssignmentError_Call struct {
	*mock.Call
}

// ReportWALReplicaAssignmentError is a helper method to define mock.On call
//   - ctx context.Context
//   - assignment types.PChannelInfoAssigned
//   - err error
func (_e *MockAssignmentService_Expecter) ReportWALReplicaAssignmentError(ctx interface{}, assignment interface{}, err interface{}) *MockAssignmentService_ReportWALReplicaAssignmentError_Call {
	return &MockAssignmentService_ReportWALReplicaAssignmentError_Call{Call: _e.mock.On("ReportWALReplicaAssignmentError", ctx, assignment, err)}
}

func (_c *MockAssignmentService_ReportWALReplicaAssignmentError_Call) Run(run func(ctx context.Context, assignment types.PChannelInfoAssigned, err error)) *MockAssignmentService_ReportWALReplicaAssignmentError_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.PChannelInfoAssigned), args[2].(error))
	})
	return _c
}

func (_c *MockAssignmentService_ReportWALReplicaAssignmentError_Call) Return(_a0 error) *MockAssignmentService_ReportWALReplicaAssignmentError_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAssignmentService_ReportWALReplicaAssignmentError_Call) RunAndReturn(run func(context.Context, types.PChannelInfoAssigned, error) error) *MockAssignmentService_ReportWALReplicaAssignmentError_Call {
	_c.Call.Return(run)
	return _c
}
