...
// GetPendingSchemaInstallCollectionIDs provides a mock function with no fields
func (_m *MockBroadcaster) GetPendingSchemaInstallCollectionIDs() []int64 {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetPendingSchemaInstallCollectionIDs")
	}
...
// MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPendingSchemaInstallCollectionIDs'
type MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call struct {
	*mock.Call
}

// GetPendingSchemaInstallCollectionIDs is a helper method to define mock.On call
func (_e *MockBroadcaster_Expecter) GetPendingSchemaInstallCollectionIDs() *MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call {
	return &MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call{Call: _e.mock.On("GetPendingSchemaInstallCollectionIDs")}
}

func (_c *MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call) Run(run func()) *MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call) Return(_a0 []int64) *MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call) RunAndReturn(run func() []int64) *MockBroadcaster_GetPendingSchemaInstallCollectionIDs_Call {
	_c.Call.Return(run)
	return _c
}
