...
func (_m *MockManager) GetAllAvailableChannels() ([]*logpb.PChannelInfo, error) {
	ret := _m.Called()

	var r0 []*logpb.PChannelInfo
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]*logpb.PChannelInfo, error)); ok {
		return rf()
	}
...
func (_c *MockManager_GetAllAvailableChannels_Call) Return(_a0 []*logpb.PChannelInfo, _a1 error) *MockManager_GetAllAvailableChannels_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockManager_GetAllAvailableChannels_Call) RunAndReturn(run func() ([]*logpb.PChannelInfo, error)) *MockManager_GetAllAvailableChannels_Call {
	_c.Call.Return(run)
	return _c
}

// GetAvailableWAL provides a mock function with given fields: channelName, term
func (_m *MockManager) GetAvailableWAL(channelName string, term int64) (wal.WAL, error) {
	ret := _m.Called(channelName, term)

	var r0 wal.WAL
	var r1 error
	if rf, ok := ret.Get(0).(func(string, int64) (wal.WAL, error)); ok {
		return rf(channelName, term)
	}
	if rf, ok := ret.Get(0).(func(string, int64) wal.WAL); ok {
		r0 = rf(channelName, term)
	} else {
		if ret.Get(0) != nil {
...
//   - channelName string
//   - term int64
func (_e *MockManager_Expecter) GetAvailableWAL(channelName interface{}, term interface{}) *MockManager_GetAvailableWAL_Call {
	return &MockManager_GetAvailableWAL_Call{Call: _e.mock.On("GetAvailableWAL", channelName, term)}
}

func (_c *MockManager_GetAvailableWAL_Call) Run(run func(channelName string, term int64)) *MockManager_GetAvailableWAL_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockManager_GetAvailableWAL_Call) RunAndReturn(run func(string, int64) (wal.WAL, error)) *MockManager_GetAvailableWAL_Call {
	_c.Call.Return(run)
	return _c
}

// Open provides a mock function with given fields: ctx, channel
func (_m *MockManager) Open(ctx context.Context, channel *logpb.PChannelInfo) error {
...
func (_c *MockManager_Open_Call) Run(run func(ctx context.Context, channel *logpb.PChannelInfo)) *MockManager_Open_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockManager_Open_Call) RunAndReturn(run func(context.Context, *logpb.PChannelInfo) error) *MockManager_Open_Call {
	_c.Call.Return(run)
	return _c
}

// Remove provides a mock function with given fields: ctx, channel, term
func (_m *MockManager) Remove(ctx context.Context, channel string, term int64) error {
	ret := _m.Called(ctx, channel, term)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) error); ok {
		r0 = rf(ctx, channel, term)
	} else {
		r0 = ret.Error(0)
	}
...
//   - channel string
//   - term int64
func (_e *MockManager_Expecter) Remove(ctx interface{}, channel interface{}, term interface{}) *MockManager_Remove_Call {
	return &MockManager_Remove_Call{Call: _e.mock.On("Remove", ctx, channel, term)}
}

func (_c *MockManager_Remove_Call) Run(run func(ctx context.Context, channel string, term int64)) *MockManager_Remove_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockManager_Remove_Call) RunAndReturn(run func(context.Context, string, int64) error) *MockManager_Remove_Call {
	_c.Call.Return(run)
	return _c
}
