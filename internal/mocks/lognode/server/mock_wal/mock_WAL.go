...
func (_m *MockWAL) Channel() *logpb.PChannelInfo {
	ret := _m.Called()
...
func (_c *MockWAL_Channel_Call) Return(_a0 *logpb.PChannelInfo) *MockWAL_Channel_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWAL_Channel_Call) RunAndReturn(run func() *logpb.PChannelInfo) *MockWAL_Channel_Call {
	_c.Call.Return(run)
	return _c
}
