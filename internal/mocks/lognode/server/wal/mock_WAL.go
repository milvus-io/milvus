...
func (_m *MockWAL) Append(ctx context.Context, msg message.MutableMessage) (mqwrapper.MessageID, error) {
...
func (_c *MockWAL_Append_Call) Return(_a0 mqwrapper.MessageID, _a1 error) *MockWAL_Append_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWAL_Append_Call) RunAndReturn(run func(context.Context, message.MutableMessage) (mqwrapper.MessageID, error)) *MockWAL_Append_Call {
	_c.Call.Return(run)
	return _c
}

// AppendAsync provides a mock function with given fields: ctx, msg, cb
func (_m *MockWAL) AppendAsync(ctx context.Context, msg message.MutableMessage, cb func(mqwrapper.MessageID, error)) {
...
//   - ctx context.Context
//   - msg message.MutableMessage
//   - cb func(mqwrapper.MessageID , error)
...
func (_c *MockWAL_AppendAsync_Call) Run(run func(ctx context.Context, msg message.MutableMessage, cb func(mqwrapper.MessageID, error))) *MockWAL_AppendAsync_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.MutableMessage), args[2].(func(mqwrapper.MessageID, error)))
	})
	return _c
}
...
func (_c *MockWAL_AppendAsync_Call) RunAndReturn(run func(context.Context, message.MutableMessage, func(mqwrapper.MessageID, error))) *MockWAL_AppendAsync_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockWAL) GetLatestMessageID(ctx context.Context) (mqwrapper.MessageID, error) {
	ret := _m.Called(ctx)
...
// MockWAL_GetLatestMessageID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetLatestMessageID'
type MockWAL_GetLatestMessageID_Call struct {
	*mock.Call
}

// GetLatestMessageID is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockWAL_Expecter) GetLatestMessageID(ctx interface{}) *MockWAL_GetLatestMessageID_Call {
	return &MockWAL_GetLatestMessageID_Call{Call: _e.mock.On("GetLatestMessageID", ctx)}
}

func (_c *MockWAL_GetLatestMessageID_Call) Run(run func(ctx context.Context)) *MockWAL_GetLatestMessageID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWAL_GetLatestMessageID_Call) Return(_a0 mqwrapper.MessageID, _a1 error) *MockWAL_GetLatestMessageID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWAL_GetLatestMessageID_Call) RunAndReturn(run func(context.Context) (mqwrapper.MessageID, error)) *MockWAL_GetLatestMessageID_Call {
	_c.Call.Return(run)
	return _c
}
