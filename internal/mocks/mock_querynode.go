...
func (_m *MockQueryNode) ClearReadTaskQueue(_a0 context.Context, _a1 *internalpb.ClearReadTaskQueueRequest) (*internalpb.ClearReadTaskQueueResponse, error) {
...
// MockQueryNode_ClearReadTaskQueue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ClearReadTaskQueue'
type MockQueryNode_ClearReadTaskQueue_Call struct {
	*mock.Call
}
...
func (_e *MockQueryNode_Expecter) ClearReadTaskQueue(_a0 interface{}, _a1 interface{}) *MockQueryNode_ClearReadTaskQueue_Call {
	return &MockQueryNode_ClearReadTaskQueue_Call{Call: _e.mock.On("ClearReadTaskQueue", _a0, _a1)}
}

func (_c *MockQueryNode_ClearReadTaskQueue_Call) Run(run func(_a0 context.Context, _a1 *internalpb.ClearReadTaskQueueRequest)) *MockQueryNode_ClearReadTaskQueue_Call {
...
func (_c *MockQueryNode_ClearReadTaskQueue_Call) Return(_a0 *internalpb.ClearReadTaskQueueResponse, _a1 error) *MockQueryNode_ClearReadTaskQueue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNode_ClearReadTaskQueue_Call) RunAndReturn(run func(context.Context, *internalpb.ClearReadTaskQueueRequest) (*internalpb.ClearReadTaskQueueResponse, error)) *MockQueryNode_ClearReadTaskQueue_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockQueryNode) GetFeatureUsage(_a0 context.Context, _a1 *internalpb.GetFeatureUsageRequest) (*internalpb.GetFeatureUsageResponse, error) {
	ret := _m.Called(_a0, _a1)
...
// MockQueryNode_GetFeatureUsage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetFeatureUsage'
type MockQueryNode_GetFeatureUsage_Call struct {
	*mock.Call
}
...
func (_e *MockQueryNode_Expecter) GetFeatureUsage(_a0 interface{}, _a1 interface{}) *MockQueryNode_GetFeatureUsage_Call {
	return &MockQueryNode_GetFeatureUsage_Call{Call: _e.mock.On("GetFeatureUsage", _a0, _a1)}
}

func (_c *MockQueryNode_GetFeatureUsage_Call) Run(run func(_a0 context.Context, _a1 *internalpb.GetFeatureUsageRequest)) *MockQueryNode_GetFeatureUsage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueryNode_GetFeatureUsage_Call) Return(_a0 *internalpb.GetFeatureUsageResponse, _a1 error) *MockQueryNode_GetFeatureUsage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNode_GetFeatureUsage_Call) RunAndReturn(run func(context.Context, *internalpb.GetFeatureUsageRequest) (*internalpb.GetFeatureUsageResponse, error)) *MockQueryNode_GetFeatureUsage_Call {
	_c.Call.Return(run)
	return _c
}
