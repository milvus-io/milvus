...
func (_m *MockQueryNode) Prewarm(_a0 context.Context, _a1 *querypb.PrewarmRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
...
// MockQueryNode_Prewarm_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Prewarm'
type MockQueryNode_Prewarm_Call struct {
	*mock.Call
}
...
func (_e *MockQueryNode_Expecter) Prewarm(_a0 interface{}, _a1 interface{}) *MockQueryNode_Prewarm_Call {
	return &MockQueryNode_Prewarm_Call{Call: _e.mock.On("Prewarm", _a0, _a1)}
}

func (_c *MockQueryNode_Prewarm_Call) Run(run func(_a0 context.Context, _a1 *querypb.PrewarmRequest)) *MockQueryNode_Prewarm_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueryNode_Prewarm_Call) Return(_a0 *commonpb.Status, _a1 error) *MockQueryNode_Prewarm_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNode_Prewarm_Call) RunAndReturn(run func(context.Context, *querypb.PrewarmRequest) (*commonpb.Status, error)) *MockQueryNode_Prewarm_Call {
	_c.Call.Return(run)
	return _c
}
