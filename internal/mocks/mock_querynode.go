...
func (_m *MockQueryNode) SetTiKVClient(client *txnkv.Client) {
	_m.Called(client)
}

// MockQueryNode_SetTiKVClient_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetTiKVClient'
type MockQueryNode_SetTiKVClient_Call struct {
	*mock.Call
}

// SetTiKVClient is a helper method to define mock.On call
//   - client *txnkv.Client
func (_e *MockQueryNode_Expecter) SetTiKVClient(client interface{}) *MockQueryNode_SetTiKVClient_Call {
	return &MockQueryNode_SetTiKVClient_Call{Call: _e.mock.On("SetTiKVClient", client)}
}

func (_c *MockQueryNode_SetTiKVClient_Call) Run(run func(client *txnkv.Client)) *MockQueryNode_SetTiKVClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueryNode_SetTiKVClient_Call) Return() *MockQueryNode_SetTiKVClient_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockQueryNode_SetTiKVClient_Call) RunAndReturn(run func(*txnkv.Client)) *MockQueryNode_SetTiKVClient_Call {
	_c.Call.Return(run)
	return _c
}
