...
func (_m *MockMsgHandler) HandleAlterWAL(ctx context.Context, alterWALMsg message.SpecializedImmutableMessage[*messagespb.AlterWALMessageHeader, *messagespb.AlterWALMessageBody], vchannel string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, message.SpecializedImmutableMessage[*messagespb.AlterWALMessageHeader, *messagespb.AlterWALMessageBody], string) error); ok {
...
func (_c *MockMsgHandler_HandleAlterWAL_Call) Run(run func(ctx context.Context, alterWALMsg message.SpecializedImmutableMessage[*messagespb.AlterWALMessageHeader, *messagespb.AlterWALMessageBody], vchannel string)) *MockMsgHandler_HandleAlterWAL_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(message.SpecializedImmutableMessage[*messagespb.AlterWALMessageHeader, *messagespb.AlterWALMessageBody]), args[2].(string))
	})
	return _c
}
...
func (_c *MockMsgHandler_HandleAlterWAL_Call) RunAndReturn(run func(context.Context, message.SpecializedImmutableMessage[*messagespb.AlterWALMessageHeader, *messagespb.AlterWALMessageBody], string) error) *MockMsgHandler_HandleAlterWAL_Call {
	_c.Call.Return(run)
	return _c
}
...
// HandleCreateSnapshot provides a mock function with given fields: vchannel, createSnapshotMsg
func (_m *MockMsgHandler) HandleCreateSnapshot(vchannel string, createSnapshotMsg message.SpecializedImmutableMessage[*messagespb.CreateSnapshotMessageHeader, *messagespb.CreateSnapshotMessageBody]) error {
	ret := _m.Called(vchannel, createSnapshotMsg)

	if len(ret) == 0 {
		panic("no return value specified for HandleCreateSnapshot")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(string, message.SpecializedImmutableMessage[*messagespb.CreateSnapshotMessageHeader, *messagespb.CreateSnapshotMessageBody]) error); ok {
		r0 = rf(vchannel, createSnapshotMsg)
	} else {
		r0 = ret.Error(0)
	}
...
// MockMsgHandler_HandleCreateSnapshot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HandleCreateSnapshot'
type MockMsgHandler_HandleCreateSnapshot_Call struct {
	*mock.Call
}

// HandleCreateSnapshot is a helper method to define mock.On call
//   - vchannel string
//   - createSnapshotMsg message.SpecializedImmutableMessage[*messagespb.CreateSnapshotMessageHeader,*messagespb.CreateSnapshotMessageBody]
func (_e *MockMsgHandler_Expecter) HandleCreateSnapshot(vchannel interface{}, createSnapshotMsg interface{}) *MockMsgHandler_HandleCreateSnapshot_Call {
	return &MockMsgHandler_HandleCreateSnapshot_Call{Call: _e.mock.On("HandleCreateSnapshot", vchannel, createSnapshotMsg)}
}

func (_c *MockMsgHandler_HandleCreateSnapshot_Call) Run(run func(vchannel string, createSnapshotMsg message.SpecializedImmutableMessage[*messagespb.CreateSnapshotMessageHeader, *messagespb.CreateSnapshotMessageBody])) *MockMsgHandler_HandleCreateSnapshot_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(message.SpecializedImmutableMessage[*messagespb.CreateSnapshotMessageHeader, *messagespb.CreateSnapshotMessageBody]))
	})
	return _c
}

func (_c *MockMsgHandler_HandleCreateSnapshot_Call) Return(_a0 error) *MockMsgHandler_HandleCreateSnapshot_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockMsgHandler_HandleCreateSnapshot_Call) RunAndReturn(run func(string, message.SpecializedImmutableMessage[*messagespb.CreateSnapshotMessageHeader, *messagespb.CreateSnapshotMessageBody]) error) *MockMsgHandler_HandleCreateSnapshot_Call {
	_c.Call.Return(run)
	return _c
}
