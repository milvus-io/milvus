...
func (_c *DataCoordCatalog_AlterSegments_Call) RunAndReturn(run func(context.Context, []*datapb.SegmentInfo) error) *DataCoordCatalog_AlterSegments_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetGlobalMaxSegmentExpireTs provides a mock function with given fields:
func (_m *DataCoordCatalog) GetGlobalMaxSegmentExpireTs() (uint64, error) {
	ret := _m.Called()
...
// DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetGlobalMaxSegmentExpireTs'
type DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call struct {
	*mock.Call
}

// GetGlobalMaxSegmentExpireTs is a helper method to define mock.On call
func (_e *DataCoordCatalog_Expecter) GetGlobalMaxSegmentExpireTs() *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call {
	return &DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call{Call: _e.mock.On("GetGlobalMaxSegmentExpireTs")}
}

func (_c *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call) Run(run func()) *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call) Return(_a0 uint64, _a1 error) *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call) RunAndReturn(run func() (uint64, error)) *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call {
	_c.Call.Return(run)
	return _c
}
