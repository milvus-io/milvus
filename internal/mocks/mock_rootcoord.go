...
func (_m *MockRootCoord) ForceReleaseDataViewGate(_a0 context.Context, _a1 *rootcoordpb.ForceReleaseDataViewGateRequest) (*rootcoordpb.ForceReleaseDataViewGateResponse, error) {
	ret := _m.Called(_a0, _a1)
...
// MockRootCoord_ForceReleaseDataViewGate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ForceReleaseDataViewGate'
type MockRootCoord_ForceReleaseDataViewGate_Call struct {
	*mock.Call
}
...
func (_e *MockRootCoord_Expecter) ForceReleaseDataViewGate(_a0 interface{}, _a1 interface{}) *MockRootCoord_ForceReleaseDataViewGate_Call {
	return &MockRootCoord_ForceReleaseDataViewGate_Call{Call: _e.mock.On("ForceReleaseDataViewGate", _a0, _a1)}
}

func (_c *MockRootCoord_ForceReleaseDataViewGate_Call) Run(run func(_a0 context.Context, _a1 *rootcoordpb.ForceReleaseDataViewGateRequest)) *MockRootCoord_ForceReleaseDataViewGate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRootCoord_ForceReleaseDataViewGate_Call) Return(_a0 *rootcoordpb.ForceReleaseDataViewGateResponse, _a1 error) *MockRootCoord_ForceReleaseDataViewGate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoord_ForceReleaseDataViewGate_Call) RunAndReturn(run func(context.Context, *rootcoordpb.ForceReleaseDataViewGateRequest) (*rootcoordpb.ForceReleaseDataViewGateResponse, error)) *MockRootCoord_ForceReleaseDataViewGate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRootCoord) GetDataViewGate(_a0 context.Context, _a1 *rootcoordpb.GetDataViewGateRequest) (*rootcoordpb.GetDataViewGateResponse, error) {
	ret := _m.Called(_a0, _a1)
...
// MockRootCoord_GetDataViewGate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDataViewGate'
type MockRootCoord_GetDataViewGate_Call struct {
	*mock.Call
}
...
func (_e *MockRootCoord_Expecter) GetDataViewGate(_a0 interface{}, _a1 interface{}) *MockRootCoord_GetDataViewGate_Call {
	return &MockRootCoord_GetDataViewGate_Call{Call: _e.mock.On("GetDataViewGate", _a0, _a1)}
}

func (_c *MockRootCoord_GetDataViewGate_Call) Run(run func(_a0 context.Context, _a1 *rootcoordpb.GetDataViewGateRequest)) *MockRootCoord_GetDataViewGate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRootCoord_GetDataViewGate_Call) Return(_a0 *rootcoordpb.GetDataViewGateResponse, _a1 error) *MockRootCoord_GetDataViewGate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoord_GetDataViewGate_Call) RunAndReturn(run func(context.Context, *rootcoordpb.GetDataViewGateRequest) (*rootcoordpb.GetDataViewGateResponse, error)) *MockRootCoord_GetDataViewGate_Call {
	_c.Call.Return(run)
	return _c
}
