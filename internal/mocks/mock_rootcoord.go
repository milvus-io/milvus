...
func (_m *RootCoord) TruncateCollection(_a0 context.Context, _a1 *rootcoordpb.TruncateCollectionRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *RootCoord_TruncateCollection_Call) Run(run func(_a0 context.Context, _a1 *rootcoordpb.TruncateCollectionRequest)) *RootCoord_TruncateCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RootCoord_TruncateCollection_Call) RunAndReturn(run func(context.Context, *rootcoordpb.TruncateCollectionRequest) (*commonpb.Status, error)) *RootCoord_TruncateCollection_Call {
	_c.Call.Return(run)
	return _c
}
