...
func (_m *RootCoord) SetProxyCreator(_a0 func(context.Context, string) (types.Proxy, error)) {
	_m.Called(_a0)
}
...
//   - _a0 func(context.Context , string)(types.Proxy , error)
...
func (_c *RootCoord_SetProxyCreator_Call) Run(run func(_a0 func(context.Context, string) (types.Proxy, error))) *RootCoord_SetProxyCreator_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(func(context.Context, string) (types.Proxy, error)))
	})
	return _c
}
