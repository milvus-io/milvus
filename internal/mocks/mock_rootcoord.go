...
func (_m *RootCoord) AddField(_a0 context.Context, _a1 *milvuspb.AddFieldRequest) (*commonpb.Status, error) {
...
// RootCoord_AddField_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddField'
type RootCoord_AddField_Call struct {
	*mock.Call
}
...
func (_e *RootCoord_Expecter) AddField(_a0 interface{}, _a1 interface{}) *RootCoord_AddField_Call {
	return &RootCoord_AddField_Call{Call: _e.mock.On("AddField", _a0, _a1)}
}

func (_c *RootCoord_AddField_Call) Run(run func(_a0 context.Context, _a1 *milvuspb.AddFieldRequest)) *RootCoord_AddField_Call {
...
func (_c *RootCoord_AddField_Call) Return(_a0 *commonpb.Status, _a1 error) *RootCoord_AddField_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RootCoord_AddField_Call) RunAndReturn(run func(context.Context, *milvuspb.AddFieldRequest) (*commonpb.Status, error)) *RootCoord_AddField_Call {
	_c.Call.Return(run)
	return _c
}
