...
func newDataSyncService(ctx context.Context, streamingReplica ReplicaInterface, factory msgstream.Factory, collectionID UniqueID) *dataSyncService {
...
func (dsService *dataSyncService) addFlowGraph() {
