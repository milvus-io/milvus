...
type ShardDelegator interface {
	...
	TruncateDeleteBuffer(pos *internalpb.MsgPosition)
...
func NewShardDelegator(collectionID UniqueID, replicaID UniqueID, channel string, version int64,
	workerManager cluster.Manager, manager *segments.Manager, tsafeManager tsafe.Manager, loader segments.Loader) (ShardDelegator, error) {
