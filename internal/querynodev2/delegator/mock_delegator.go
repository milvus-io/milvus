...
func (_m *MockShardDelegator) UpdateIndex(ctx context.Context, fieldIndex *indexpb.FieldIndex, indexBarrierTs uint64) error {
	ret := _m.Called(ctx, fieldIndex, indexBarrierTs)
	...
	if rf, ok := ret.Get(0).(func(context.Context, *indexpb.FieldIndex, uint64) error); ok {
		r0 = rf(ctx, fieldIndex, indexBarrierTs)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockShardDelegator_Expecter) UpdateIndex(ctx interface{}, fieldIndex interface{}, indexBarrierTs interface{}) *MockShardDelegator_UpdateIndex_Call {
	return &MockShardDelegator_UpdateIndex_Call{Call: _e.mock.On("UpdateIndex", ctx, fieldIndex, indexBarrierTs)}
}

func (_c *MockShardDelegator_UpdateIndex_Call) Run(run func(ctx context.Context, fieldIndex *indexpb.FieldIndex, indexBarrierTs uint64)) *MockShardDelegator_UpdateIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
