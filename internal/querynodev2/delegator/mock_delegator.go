...
func (_m *MockShardDelegator) ProcessSplitShard(ctx context.Context, targets []*messagespb.SplitShardTarget) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []*messagespb.SplitShardTarget) error); ok {
		r0 = rf(ctx, targets)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockShardDelegator_ProcessSplitShard_Call) Run(run func(ctx context.Context, targets []*messagespb.SplitShardTarget)) *MockShardDelegator_ProcessSplitShard_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]*messagespb.SplitShardTarget))
	})
	return _c
}
...
func (_c *MockShardDelegator_ProcessSplitShard_Call) RunAndReturn(run func(context.Context, []*messagespb.SplitShardTarget) error) *MockShardDelegator_ProcessSplitShard_Call {
	_c.Call.Return(run)
	return _c
}
