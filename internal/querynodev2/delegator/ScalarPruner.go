...
func (lue *LogicalUnaryExpr) Eval(evalCtx *EvalCtx) *bitset.BitSet {
	// segment prune based on min-max range is not correct, so disable unary expr here and just keep a place holder
