...
func (s *DelegatorDataSuite) TestReleaseGrowingSourceAfterFencePreparedHandoffRejectedBeyondFence() {
	ctx := context.Background()
	s.workerManager = &cluster.MockManager{}
	s.manager = segments.NewManager()
	s.loader = &segments.MockLoader{}
...
func (s *DelegatorDataSuite) TestReleaseGrowingSourceWithoutPreparedHandoffRejected() {
	ctx := context.Background()
	s.workerManager = &cluster.MockManager{}
	s.manager = segments.NewManager()
	s.loader = &segments.MockLoader{}
