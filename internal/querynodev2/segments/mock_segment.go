...
func (_m *MockSegment) StartPosition() *internalpb.MsgPosition {
	ret := _m.Called()

	var r0 *internalpb.MsgPosition
	if rf, ok := ret.Get(0).(func() *internalpb.MsgPosition); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*internalpb.MsgPosition)
		}
	}
...
func (_c *MockSegment_StartPosition_Call) Return(_a0 *internalpb.MsgPosition) *MockSegment_StartPosition_Call {
	_c.Call.Return(_a0)
	return _c
}
