...
// UpdateIndexMeta provides a mock function with given fields: indexMeta, version
func (_m *MockSegment) UpdateIndexMeta(indexMeta *segcorepb.CollectionIndexMeta, version uint64) error {
	ret := _m.Called(indexMeta, version)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*segcorepb.CollectionIndexMeta, uint64) error); ok {
		r0 = rf(indexMeta, version)
	} else {
		r0 = ret.Error(0)
	}
...
// MockSegment_UpdateIndexMeta_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateIndexMeta'
type MockSegment_UpdateIndexMeta_Call struct {
	*mock.Call
}
...
//   - version uint64
func (_e *MockSegment_Expecter) UpdateIndexMeta(indexMeta interface{}, version interface{}) *MockSegment_UpdateIndexMeta_Call {
	return &MockSegment_UpdateIndexMeta_Call{Call: _e.mock.On("UpdateIndexMeta", indexMeta, version)}
}

func (_c *MockSegment_UpdateIndexMeta_Call) Run(run func(indexMeta *segcorepb.CollectionIndexMeta, version uint64)) *MockSegment_UpdateIndexMeta_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*segcorepb.CollectionIndexMeta), args[1].(uint64))
	})
	return _c
}

func (_c *MockSegment_UpdateIndexMeta_Call) Return(_a0 error) *MockSegment_UpdateIndexMeta_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSegment_UpdateIndexMeta_Call) RunAndReturn(run func(*segcorepb.CollectionIndexMeta, uint64) error) *MockSegment_UpdateIndexMeta_Call {
	_c.Call.Return(run)
	return _c
}
