...
func (_m *MockSegment) DropIndex(ctx context.Context, fieldID int64) error {
...
//   - ctx context.Context
//   - fieldID int64
func (_e *MockSegment_Expecter) DropIndex(ctx interface{}, fieldID interface{}) *MockSegment_DropIndex_Call {
	return &MockSegment_DropIndex_Call{Call: _e.mock.On("DropIndex", ctx, fieldID)}
}

func (_c *MockSegment_DropIndex_Call) Run(run func(ctx context.Context, fieldID int64)) *MockSegment_DropIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
