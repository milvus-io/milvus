...
// SearchGrouped provides a mock function with given fields: ctx, searchReqs, limiter
func (_m *MockSegment) SearchGrouped(ctx context.Context, searchReqs []*segcore.SearchRequest, limiter *semaphore.Weighted) ([]*segcore.SearchResult, error) {
	ret := _m.Called(ctx, searchReqs, limiter)
	...
	var r0 []*segcore.SearchResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []*segcore.SearchRequest, *semaphore.Weighted) ([]*segcore.SearchResult, error)); ok {
		return rf(ctx, searchReqs, limiter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []*segcore.SearchRequest, *semaphore.Weighted) []*segcore.SearchResult); ok {
		r0 = rf(ctx, searchReqs, limiter)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*segcore.SearchResult)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, []*segcore.SearchRequest, *semaphore.Weighted) error); ok {
		r1 = rf(ctx, searchReqs, limiter)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockSegment_Expecter) SearchGrouped(ctx interface{}, searchReqs interface{}, limiter interface{}) *MockSegment_SearchGrouped_Call {
	return &MockSegment_SearchGrouped_Call{Call: _e.mock.On("SearchGrouped", ctx, searchReqs, limiter)}
}

func (_c *MockSegment_SearchGrouped_Call) Run(run func(ctx context.Context, searchReqs []*segcore.SearchRequest, limiter *semaphore.Weighted)) *MockSegment_SearchGrouped_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]*segcore.SearchRequest), args[2].(*semaphore.Weighted))
	})
	return _c
}
...
func (_c *MockSegment_SearchGrouped_Call) RunAndReturn(run func(context.Context, []*segcore.SearchRequest, *semaphore.Weighted) ([]*segcore.SearchResult, error)) *MockSegment_SearchGrouped_Call {
	_c.Call.Return(run)
	return _c
}
