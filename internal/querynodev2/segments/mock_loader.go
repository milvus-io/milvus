...
func (_m *MockLoader) LoadDeltaLogs(ctx context.Context, segment *cgo.LocalSegment, deltaLogs []*datapb.FieldBinlog) error {
	ret := _m.Called(ctx, segment, deltaLogs)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *cgo.LocalSegment, []*datapb.FieldBinlog) error); ok {
...
func (_c *MockLoader_LoadDeltaLogs_Call) Run(run func(ctx context.Context, segment *cgo.LocalSegment, deltaLogs []*datapb.FieldBinlog)) *MockLoader_LoadDeltaLogs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*cgo.LocalSegment), args[2].([]*datapb.FieldBinlog))
	})
	return _c
}
...
func (_c *MockLoader_LoadDeltaLogs_Call) RunAndReturn(run func(context.Context, *cgo.LocalSegment, []*datapb.FieldBinlog) error) *MockLoader_LoadDeltaLogs_Call {
	_c.Call.Return(run)
	return _c
}

// LoadIndex provides a mock function with given fields: ctx, segment, info, version
func (_m *MockLoader) LoadIndex(ctx context.Context, segment *cgo.LocalSegment, info *querypb.SegmentLoadInfo, version int64) error {
	ret := _m.Called(ctx, segment, info, version)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *cgo.LocalSegment, *querypb.SegmentLoadInfo, int64) error); ok {
...
func (_c *MockLoader_LoadIndex_Call) Run(run func(ctx context.Context, segment *cgo.LocalSegment, info *querypb.SegmentLoadInfo, version int64)) *MockLoader_LoadIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*cgo.LocalSegment), args[2].(*querypb.SegmentLoadInfo), args[3].(int64))
	})
	return _c
}
...
func (_c *MockLoader_LoadIndex_Call) RunAndReturn(run func(context.Context, *cgo.LocalSegment, *querypb.SegmentLoadInfo, int64) error) *MockLoader_LoadIndex_Call {
	_c.Call.Return(run)
	return _c
}
