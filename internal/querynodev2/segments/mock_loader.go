...
// ReopenLoadedSealedSegmentsForSchemaUpdate provides a mock function with given fields: ctx, collectionID
func (_m *MockLoader) ReopenLoadedSealedSegmentsForSchemaUpdate(ctx context.Context, collectionID int64) error {
	ret := _m.Called(ctx, collectionID)

	if len(ret) == 0 {
		panic("no return value specified for ReopenLoadedSealedSegmentsForSchemaUpdate")
	}
...
// MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReopenLoadedSealedSegmentsForSchemaUpdate'
type MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call struct {
	*mock.Call
}

// ReopenLoadedSealedSegmentsForSchemaUpdate is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
func (_e *MockLoader_Expecter) ReopenLoadedSealedSegmentsForSchemaUpdate(ctx interface{}, collectionID interface{}) *MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call {
	return &MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call{Call: _e.mock.On("ReopenLoadedSealedSegmentsForSchemaUpdate", ctx, collectionID)}
}

func (_c *MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call) Run(run func(ctx context.Context, collectionID int64)) *MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call) Return(_a0 error) *MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call) RunAndReturn(run func(context.Context, int64) error) *MockLoader_ReopenLoadedSealedSegmentsForSchemaUpdate_Call {
	_c.Call.Return(run)
	return _c
}
