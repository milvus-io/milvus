...
func (_m *MockCollectionManager) Get(collectionID int64) *cgo.Collection {
	ret := _m.Called(collectionID)

	var r0 *cgo.Collection
	if rf, ok := ret.Get(0).(func(int64) *cgo.Collection); ok {
		r0 = rf(collectionID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cgo.Collection)
		}
	}
...
func (_c *MockCollectionManager_Get_Call) Return(_a0 *cgo.Collection) *MockCollectionManager_Get_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockCollectionManager_Get_Call) RunAndReturn(run func(int64) *cgo.Collection) *MockCollectionManager_Get_Call {
	_c.Call.Return(run)
	return _c
}
