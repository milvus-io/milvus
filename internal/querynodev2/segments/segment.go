...
//
// The width is the core count. This bounds the branch goroutines and queued
// C++ searches owned by one admitted task. The segment-level errgroup limit in
// searchSegmentsGroupedAttempt separately bounds how many segments may retain
// a filter bitset while waiting for phase 2.
//
