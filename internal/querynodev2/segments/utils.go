...
func isDataMmmapEnable(fieldSchema *schemapb.FieldSchema) bool {
...
func hasRowData(indexInfo *querypb.FieldIndexInfo) bool {
	log.Warn("hasRowData is not implemented, please check it", zap.Int64("field_id", indexInfo.FieldID))
	return true
}
