...
func newSegmentLoader(ctx context.Context, rootCoord types.RootCoord, indexService types.IndexService, dataService types.DataService, replica ReplicaInterface, etcdKV *etcdkv.EtcdKV) *segmentLoader {
	...
	iLoader := newIndexLoader(ctx, rootCoord, indexService, replica)
