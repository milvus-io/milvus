...
type Segment struct {
	...
	indexedFieldInfos sync.Map // UniqueID => *IndexedFieldInfo
...
func (s *Segment) hasLoadIndexForIndexedField(fieldID int64) bool {
	...
	fieldInfo := value.(*IndexedFieldInfo)
