...
const (
	...
	ListResourceGroupTaskName     = "ListResourceGroupTask"
...
func (t *TransferReplicaTask) Execute(ctx context.Context) error {
	...
	t.result, err = t.queryCoord.TransferReplica(ctx, &querypb.TransferReplicaRequest{
		...
		TargetResourceGroups: t.TargetResourceGroups,
		CollectionID:         collID,
...
type ListResourceGroupTask struct {
	Condition
	*milvuspb.ListResourceGroupRequest
	ctx        context.Context
	queryCoord types.QueryCoord
	result     *milvuspb.ListResourceGroupResponse
}

func (t *ListResourceGroupTask) TraceCtx() context.Context {
	return t.ctx
}

func (t *ListResourceGroupTask) ID() UniqueID {
	return t.Base.MsgID
}

func (t *ListResourceGroupTask) SetID(uid UniqueID) {
	t.Base.MsgID = uid
}

func (t *ListResourceGroupTask) Name() string {
	return ListResourceGroupTaskName
}

func (t *ListResourceGroupTask) Type() commonpb.MsgType {
	return t.Base.MsgType
}

func (t *ListResourceGroupTask) BeginTs() Timestamp {
	return t.Base.Timestamp
}

func (t *ListResourceGroupTask) EndTs() Timestamp {
	return t.Base.Timestamp
}

func (t *ListResourceGroupTask) SetTs(ts Timestamp) {
	t.Base.Timestamp = ts
}

func (t *ListResourceGroupTask) OnEnqueue() error {
	t.Base = commonpbutil.NewMsgBase()
	return nil
}

func (t *ListResourceGroupTask) PreExecute(ctx context.Context) error {
	// todo: set proper msg type
	t.Base.MsgType = commonpb.MsgType_ListResourceGroup
	t.Base.SourceID = paramtable.GetNodeID()

	return nil
}

func (t *ListResourceGroupTask) Execute(ctx context.Context) error {
	var err error
	t.result, err = t.queryCoord.ListResourceGroup(ctx, t.ListResourceGroupRequest)
	return err
}

func (t *ListResourceGroupTask) PostExecute(ctx context.Context) error {
	return nil
}
