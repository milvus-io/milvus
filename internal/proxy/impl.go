...
func (node *Proxy) getCollectionProgress(ctx context.Context, request *milvuspb.GetLoadingProgressRequest, collectionID int64) (int64, error) {
	resp, err := node.queryCoord.ShowCollections(ctx, &querypb.ShowCollectionsRequest{
		Base: common.NewMsgBase(
			...
			request.Base.MsgID,
			request.Base.Timestamp,
			request.Base.SourceID,
		),
...
func (node *Proxy) Search(ctx context.Context, request *milvuspb.SearchRequest) (*milvuspb.SearchResults, error) {
	...
	qt := &searchTask{
		...
		SearchRequest: &internalpb.SearchRequest{
			Base:  common.NewMsgBase(commonpb.MsgType_Search, common.MsgIDNeedFill, common.GetNowTimestamp(), Params.ProxyCfg.GetNodeID()),
...
func (node *Proxy) Query(ctx context.Context, request *milvuspb.QueryRequest) (*milvuspb.QueryResults, error) {
	...
	qt := &queryTask{
		...
		RetrieveRequest: &internalpb.RetrieveRequest{
			Base:  common.NewMsgBase(commonpb.MsgType_Retrieve, common.MsgIDNeedFill, common.GetNowTimestamp(), Params.ProxyCfg.GetNodeID()),
			ReqID: Params.ProxyCfg.GetNodeID(),
		},
		request:          request,
		qc:               node.queryCoord,
...
func (node *Proxy) GetPersistentSegmentInfo(ctx context.Context, req *milvuspb.GetPersistentSegmentInfoRequest) (*milvuspb.GetPersistentSegmentInfoResponse, error) {
	...
	infoResp, err := node.dataCoord.GetSegmentInfo(ctx, &datapb.GetSegmentInfoRequest{
		Base:       common.NewMsgBase(commonpb.MsgType_SegmentInfo, 0, 0, Params.ProxyCfg.GetNodeID()),
		SegmentIDs: segments,
	})
	if err != nil {
...
func (node *Proxy) getSegmentsOfCollection(ctx context.Context, dbName string, collectionName string) ([]UniqueID, error) {
	describeCollectionResponse, err := node.rootCoord.DescribeCollection(ctx, &milvuspb.DescribeCollectionRequest{
		Base:           common.NewMsgBase(commonpb.MsgType_DescribeCollection, 0, 0, Params.ProxyCfg.GetNodeID()),
		DbName:         dbName,
	...
	showPartitionsResp, err := node.rootCoord.ShowPartitions(ctx, &milvuspb.ShowPartitionsRequest{
		Base:           common.NewMsgBase(commonpb.MsgType_ShowPartitions, 0, 0, Params.ProxyCfg.GetNodeID()),
		DbName:         dbName,
		CollectionName: collectionName,
		CollectionID:   collectionID,
	})
...
func (node *Proxy) GetMetrics(ctx context.Context, req *milvuspb.GetMetricsRequest) (*milvuspb.GetMetricsResponse, error) {
	...
	req.Base = common.NewMsgBase(commonpb.MsgType_SystemInfo, 0, 0, Params.ProxyCfg.GetNodeID())
...
func (node *Proxy) LoadBalance(ctx context.Context, req *milvuspb.LoadBalanceRequest) (*commonpb.Status, error) {
	...
	infoResp, err := node.queryCoord.LoadBalance(ctx, &querypb.LoadBalanceRequest{
		Base:             common.NewMsgBase(commonpb.MsgType_LoadBalanceSegments, 0, 0, Params.ProxyCfg.GetNodeID()),
...
func (node *Proxy) GetReplicas(ctx context.Context, req *milvuspb.GetReplicasRequest) (*milvuspb.GetReplicasResponse, error) {
	...
	req.Base = common.NewMsgBase(commonpb.MsgType_GetReplicas, common.MsgIDNeedFill, common.GetNowTimestamp, Params.ProxyCfg.GetNodeID())
...
func (node *Proxy) ListCredUsers(ctx context.Context, req *milvuspb.ListCredUsersRequest) (*milvuspb.ListCredUsersResponse, error) {
	...
	rootCoordReq := &milvuspb.ListCredUsersRequest{
		Base: common.NewMsgBase(commonpb.MsgType_ListCredUsernames, common.MsgIDNeedFill, common.GetNowTimestamp, Params.ProxyCfg.GetNodeID()),
	}
