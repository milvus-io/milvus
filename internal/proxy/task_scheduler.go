...
func (sched *taskScheduler) collectResultLoop() {
	...
	queryResultMsgStream.AsConsumerWithPosition(Params.ProxyCfg.SearchResultChannelNames, Params.MsgChannelCfg.ProxySubNamePrefix, mqclient.SubscriptionPositionLatest)
	log.Debug("Proxy", zap.Strings("SearchResultChannelNames", Params.ProxyCfg.SearchResultChannelNames),
		zap.Any("ProxySubName", Params.MsgChannelCfg.ProxySubNamePrefix))
