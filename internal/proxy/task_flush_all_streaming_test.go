...
func createTestFlushAllTaskByStreamingService(t *testing.T, dbName string) (*flushAllTaskbyStreamingService, *mocks.MockRootCoordClient, *mocks.MockDataCoordClient, *msgstream.MockMsgStream, *MockChannelsMgr, context.Context) {
	...
	return task, mockRC, mockDC, replicateMsgStream, chMgr, ctx
}

func TestFlushAllTask_WithSpecificDB(t *testing.T) {
	task, mockRC, mockDC, replicateMsgStream, chMgr, ctx := createTestFlushAllTaskByStreamingService(t, "test_db")
	...
	mockDC.EXPECT().FlushAll(mock.Anything, mock.MatchedBy(func(req *datapb.FlushAllRequest) bool {
...
func TestFlushAllTask_WithoutSpecificDB(t *testing.T) {
	task, mockRC, mockDC, replicateMsgStream, chMgr, ctx := createTestFlushAllTaskByStreamingService(t, "")
	defer mockRC.AssertExpectations(t)
	defer mockDC.AssertExpectations(t)
	defer replicateMsgStream.AssertExpectations(t)
	defer chMgr.AssertExpectations(t)
	...
	mockRC.EXPECT().ShowCollections(mock.Anything, mock.MatchedBy(func(req *milvuspb.ShowCollectionsRequest) bool {
...
func TestFlushAllStreamingTask_WithFlushTargets(t *testing.T) {
	...
	t.Run("streaming FlushAll with flush_targets filtering", func(t *testing.T) {
		task, mockRC, mockDC, _, chMgr, ctx := createTestFlushAllTaskByStreamingService(t, "test_db")
		defer mockRC.AssertExpectations(t)
		defer mockDC.AssertExpectations(t)
		defer chMgr.AssertExpectations(t)
	...
	t.Run("streaming FlushAll with database-only filtering", func(t *testing.T) {
		task, mockRC, mockDC, _, chMgr, ctx := createTestFlushAllTaskByStreamingService(t, "")
		defer mockRC.AssertExpectations(t)
		defer mockDC.AssertExpectations(t)
		defer chMgr.AssertExpectations(t)
