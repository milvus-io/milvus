...
func getConfigs(configs map[string]string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// c.JSON(http.StatusOK, string(bs))
	}
}
...
func getClusterInfo(node *Proxy) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Data(http.StatusOK, "application/json", []byte(resp.GetResponse()))
		// c.JSON(http.StatusOK, resp.GetResponse())
	}
}
...
func getConnectedClients(c *gin.Context) {
	...
	// c.JSON(http.StatusOK, string(ret))
}
