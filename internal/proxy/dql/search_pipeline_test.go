...
func (s *SearchPipelineSuite) TestRequeryOp() {
	...
	mocker := mockTest(s.T(), (*requeryOperator).requery, &milvuspb.QueryResults{
...
func (s *SearchPipelineSuite) TestHighlightOp() {
	...
	sched, err := scheduler.NewTaskScheduler(ctx, &mockTsoAllocator{})
	s.Require().NoError(err)
...
func (s *SearchPipelineSuite) TestSemanticHighlightOp() {
	...
	mockFieldIDs := mockTestTo(s.T(), (*highlight.SemanticHighlight).FieldIDs, func(h *highlight.SemanticHighlight) []int64 {
		return []int64{101}
	})
	defer mockFieldIDs.UnPatch()

	mockGetFieldName := mockTestTo(s.T(), (*highlight.SemanticHighlight).GetFieldName, func(h *highlight.SemanticHighlight, id int64) string {
...
func (s *SearchPipelineSuite) TestSemanticHighlightOpNullableStringAlignsRows() {
	...
	mockFieldIDs := mockTest(s.T(), (*highlight.SemanticHighlight).FieldIDs, []int64{101})
	defer mockFieldIDs.UnPatch()

	mockGetFieldName := mockTest(s.T(), (*highlight.SemanticHighlight).GetFieldName, testVarCharField)
	defer mockGetFieldName.UnPatch()
...
func (s *SearchPipelineSuite) TestSemanticHighlightOpMissingField() {
	...
	mockFieldIDs := mockTest(s.T(), (*highlight.SemanticHighlight).FieldIDs, []int64{999})
	defer mockFieldIDs.UnPatch()
...
func (s *SearchPipelineSuite) TestSemanticHighlightOpMultipleFields() {
	...
	mockFieldIDs := mockTest(s.T(), (*highlight.SemanticHighlight).FieldIDs, []int64{101, 102})
	defer mockFieldIDs.UnPatch()
...
func (s *SearchPipelineSuite) TestSemanticHighlightOpDynamicField() {
	...
	mockFieldIDs := mockTest(s.T(), (*highlight.SemanticHighlight).FieldIDs, []int64{})
	defer mockFieldIDs.UnPatch()

	mockHasDynamicFields := mockTest(s.T(), (*highlight.SemanticHighlight).HasDynamicFields, true)
	defer mockHasDynamicFields.UnPatch()

	mockDynamicFieldNames := mockTest(s.T(), (*highlight.SemanticHighlight).DynamicFieldNames, []string{"dyn_content"})
	defer mockDynamicFieldNames.UnPatch()

	mockDynamicFieldID := mockTest(s.T(), (*highlight.SemanticHighlight).DynamicFieldID, int64(102))
...
func (s *SearchPipelineSuite) TestSearchPipelineWithRequery() {
	...
	}, segcore.StorageCost{ScannedRemoteBytes: 100, ScannedTotalBytes: 200}, nil)
	defer mocker.UnPatch()
...
func (s *SearchPipelineSuite) TestNewRequeryOperator_WithHighlightDynamicFields() {
	...
	mockDynFields := mockTestTo(s.T(), (*SemanticHighlighter).DynamicFieldNames, func(h *SemanticHighlighter) []string {
