...
func Test_CheckFieldsDataBySchema(t *testing.T) {
	paramtable.Init()
	log.Info("Test_CheckFieldsDataBySchema", zap.Bool("enable", Params.ProxyCfg.SkipAutoIDCheck.GetAsBool()))
	var err error
	// though won't happen in system
	t.Run("schema is empty", func(t *testing.T) {
		task := insertTask{
			schema: &schemapb.CollectionSchema{
			...
			insertMsg: &BaseInsertTask{
				InsertRequest: msgpb.InsertRequest{
					...
					DbName:         "Test_CheckFieldsDataBySchema",
					CollectionName: "Test_CheckFieldsDataBySchema",
					PartitionName:  "Test_CheckFieldsDataBySchema",
				},
			},
		}
	...
	t.Run("not pk, but autoid == true", func(t *testing.T) {
		task := insertTask{
			schema: &schemapb.CollectionSchema{
				Name:        "Test_CheckFieldsDataBySchema",
				Description: "Test_CheckFieldsDataBySchema",
	...
	t.Run("more than one pk", func(t *testing.T) {
		task := insertTask{
			schema: &schemapb.CollectionSchema{
				Name:        "Test_CheckFieldsDataBySchema",
				Description: "Test_CheckFieldsDataBySchema",
	...
	t.Run("normal when insert", func(t *testing.T) {
		task := insertTask{
			schema: &schemapb.CollectionSchema{
				Name:        "Test_CheckFieldsDataBySchema",
				Description: "Test_CheckFieldsDataBySchema",
