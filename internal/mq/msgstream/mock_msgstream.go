...
func (_m *MockMsgStream) Seek(offset []*internalpb.MsgPosition) error {
	ret := _m.Called(offset)

	var r0 error
	if rf, ok := ret.Get(0).(func([]*internalpb.MsgPosition) error); ok {
		r0 = rf(offset)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockMsgStream_Seek_Call) Run(run func(offset []*internalpb.MsgPosition)) *MockMsgStream_Seek_Call {
	_c.Call.Run(func(args mock.Arguments) {
