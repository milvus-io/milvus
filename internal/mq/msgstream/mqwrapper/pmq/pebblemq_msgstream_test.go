...
func TestMqMsgStream_AsConsumer(t *testing.T) {
	...
	m.AsConsumer(ctx, []string{"a"}, "b", mqwrapper.SubscriptionPositionUnknown)
	m.AsConsumer(ctx, []string{"a"}, "b", mqwrapper.SubscriptionPositionUnknown)
...
func initPmqStream(ctx context.Context,
	...
	pmqClient, _ := NewClientWithDefaultOptions(ctx)
	inputStream, _ := msgstream.NewMqMsgStream(ctx, 100, 100, pmqClient, factory.NewUnmarshalDispatcher())
	...
	pmqClient2, _ := NewClientWithDefaultOptions(ctx)
	outputStream, _ := msgstream.NewMqMsgStream(ctx, 100, 100, pmqClient2, factory.NewUnmarshalDispatcher())
...
func initPmqTtStream(ctx context.Context,
	producerChannels []string,
	consumerChannels []string,
	consumerGroupName string,
	opts ...msgstream.RepackFunc,
	...
	pmqClient2, _ := NewClientWithDefaultOptions(ctx)
	outputStream, _ := msgstream.NewMqTtMsgStream(ctx, 100, 100, pmqClient2, factory.NewUnmarshalDispatcher())
	outputStream.AsConsumer(ctx, consumerChannels, consumerGroupName, mqwrapper.SubscriptionPositionEarliest)
	var output msgstream.MsgStream = outputStream
...
func TestStream_PmqMsgStream_Insert(t *testing.T) {
	...
	ctx := context.Background()
	inputStream, outputStream := initPmqStream(ctx, producerChannels, consumerChannels, consumerGroupName)
...
func TestStream_PmqTtMsgStream_Insert(t *testing.T) {
	producerChannels := []string{"insert1", "insert2"}
	consumerChannels := []string{"insert1", "insert2"}
	...
	ctx := context.Background()
	inputStream, outputStream := initPmqTtStream(ctx, producerChannels, consumerChannels, consumerSubName)
...
func TestStream_PmqTtMsgStream_DuplicatedIDs(t *testing.T) {
	...
	pmqClient, _ := NewClientWithDefaultOptions(ctx)
	outputStream, _ = msgstream.NewMqTtMsgStream(context.Background(), 100, 100, pmqClient, factory.NewUnmarshalDispatcher())
	consumerSubName = funcutil.RandomString(8)
...
func TestStream_PmqTtMsgStream_Seek(t *testing.T) {
	c1 := funcutil.RandomString(8)
	producerChannels := []string{c1}
	consumerChannels := []string{c1}
	consumerSubName := funcutil.RandomString(8)
...
func TestStream_qMsgStream_SeekInvalidMessage(t *testing.T) {
	c := funcutil.RandomString(8)
	producerChannels := []string{c}
	consumerChannels := []string{c}
	consumerSubName := funcutil.RandomString(8)
	ctx := context.Background()
	inputStream, outputStream := initPmqStream(ctx, producerChannels, consumerChannels, consumerSubName)
	...
	factory := msgstream.ProtoUDFactory{}
	pmqClient2, _ := NewClientWithDefaultOptions(ctx)
	outputStream2, _ := msgstream.NewMqMsgStream(ctx, 100, 100, pmqClient2, factory.NewUnmarshalDispatcher())
...
func TestStream_PmqTtMsgStream_AsConsumerWithPosition(t *testing.T) {
	...
	otherInputStream, _ := msgstream.NewMqMsgStream(context.Background(), 100, 100, pmqClient, factory.NewUnmarshalDispatcher())
	otherInputStream.AsProducer([]string{"root_timetick"})
	otherInputStream.Produce(getTimeTickMsgPack(999))

	inputStream, _ := msgstream.NewMqMsgStream(context.Background(), 100, 100, pmqClient, factory.NewUnmarshalDispatcher())
	inputStream.AsProducer(producerChannels)
	...
	pmqClient2, _ := NewClientWithDefaultOptions(ctx)
	outputStream, _ := msgstream.NewMqMsgStream(context.Background(), 100, 100, pmqClient2, factory.NewUnmarshalDispatcher())
	outputStream.AsConsumer(ctx, consumerChannels, consumerSubName, mqwrapper.SubscriptionPositionLatest)
