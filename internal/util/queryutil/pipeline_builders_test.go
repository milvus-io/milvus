...
func TestComputeGroupByOrderPositions(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := ComputeGroupByOrderPositions(tt.orderBy, tt.groupBy, tt.aggs)
...
func TestBuildQueryReducePipeline(t *testing.T) {
	...
	t.Run("plain", func(t *testing.T) {
		pipeline := BuildQueryReducePipeline(
...
func TestGetPKOrderByField(t *testing.T) {
	t.Run("int64 pk", func(t *testing.T) {
		schema := testSchemaForPipelineBuilders(schemapb.DataType_Int64)
		pk := getPKOrderByField(schema)
		assert.Equal(t, int64(100), pk.FieldID)
		assert.Equal(t, schemapb.DataType_Int64, pk.DataType)
	})

	t.Run("varchar pk", func(t *testing.T) {
		schema := testSchemaForPipelineBuilders(schemapb.DataType_VarChar)
		pk := getPKOrderByField(schema)
		assert.Equal(t, int64(100), pk.FieldID)
		assert.Equal(t, schemapb.DataType_VarChar, pk.DataType)
	})
}
