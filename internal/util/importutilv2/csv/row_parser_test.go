...
// 	suite.runValid(&testCase{name: "A/N/D no $meta", content: suite.genAllTypesRowData("int32", "2", "x", "$meta")})
// 	suite.runValid(&testCase{name: "A/N/D no nullable field", content: suite.genAllTypesRowData("$meta", "{\"a\": 666}", "int32")})
...
func (suite *RowParserSuite) runParseError(c *testCase) {
	...
	schema := suite.createAllTypesSchema()
	header, rowContent := suite.genRowContent(schema, c.content)
	log.Info("==========", zap.Any("header", header), zap.Any("content", c.content))
	parser, err := NewRowParser(schema, header, suite.nullKey)
	suite.NoError(err)
...
func (suite *RowParserSuite) TestParseError() {
	...
	cases := []*testCase{
		&testCase{name: "duplicate key for dynamic", content: suite.genAllTypesRowData("$meta", "{\"x\": 8}")},
		// &testCase{name: "illegal JSON content for dynamic", content: suite.genAllTypesRowData("$meta", "{*&%%&$*(&}")},
		// &testCase{name: "not a JSON for dynamic", content: suite.genAllTypesRowData("$meta", "][")},
		// &testCase{name: "exceeds max length varchar", content: suite.genAllTypesRowData("varchar", "aaaaaaaaaa")},
		// &testCase{name: "exceeds max capacity", content: suite.genAllTypesRowData("array_int8", "[1, 2, 3, 4, 5]")},
		// &testCase{name: "type error bool", content: suite.genAllTypesRowData("bool", "0.2")},
		// &testCase{name: "type error int8", content: suite.genAllTypesRowData("int8", "illegal")},
		// &testCase{name: "type error int16", content: suite.genAllTypesRowData("int16", "illegal")},
		// &testCase{name: "type error int32", content: suite.genAllTypesRowData("int32", "illegal")},
		// &testCase{name: "type error int64", content: suite.genAllTypesRowData("int64", "illegal")},
		// &testCase{name: "type error float", content: suite.genAllTypesRowData("float", "illegal")},
		// &testCase{name: "type error double", content: suite.genAllTypesRowData("double", "illegal")},
		// &testCase{name: "illegal json", content: suite.genAllTypesRowData("json", "][")},
		// &testCase{name: "not utf8 varchar", content: suite.genAllTypesRowData("varchar", string([]byte{0xC0, 0xAF}))},
		// &testCase{name: "type error array_int8", content: suite.genAllTypesRowData("array_int8", "illegal")},
		// &testCase{name: "element parse error array_bool", content: suite.genAllTypesRowData("array_bool", "[\"0.2\"]")},
		// &testCase{name: "element parse error array_int8", content: suite.genAllTypesRowData("array_int8", "[\"0.2\"]")},
		// &testCase{name: "element parse error array_int16", content: suite.genAllTypesRowData("array_int16", "[\"0.2\"]")},
		// &testCase{name: "element parse error array_int32", content: suite.genAllTypesRowData("array_int32", "[\"0.2\"]")},
		// &testCase{name: "element parse error array_int64", content: suite.genAllTypesRowData("array_int64", "[\"0.2\"]")},
		// &testCase{name: "element parse error array_float", content: suite.genAllTypesRowData("array_float", "[\"illegal\"]")},
		// &testCase{name: "element parse error array_double", content: suite.genAllTypesRowData("array_double", "[\"illegal\"]")},
		&testCase{name: "exceeds max length array_varchar", content: suite.genAllTypesRowData("array_varchar", "[\"aaaaaaaaaa\"]")},
		// &testCase{name: "illegal JSON content", content: suite.genAllTypesRowData("json", "{*&%%&$*(&}")},
		// &testCase{name: "invalid float", content: suite.genAllTypesRowData("float", "Infinity")},
		// &testCase{name: "invalid double", content: suite.genAllTypesRowData("double", "NaN")},
		// &testCase{name: "element range error bin_vector", content: suite.genAllTypesRowData("bin_vector", "[256, 0]")},
		// &testCase{name: "type error float_vector", content: suite.genAllTypesRowData("float_vector", "illegal")},
		// &testCase{name: "type error bin_vector", content: suite.genAllTypesRowData("bin_vector", "illegal")},
		// &testCase{name: "type error f16_vector", content: suite.genAllTypesRowData("f16_vector", "illegal")},
		// &testCase{name: "type error bf16_vector", content: suite.genAllTypesRowData("bf16_vector", "illegal")},
		// &testCase{name: "type error int8_vector", content: suite.genAllTypesRowData("int8_vector", "illegal")},
		// &testCase{name: "type error sparse_vector", content: suite.genAllTypesRowData("sparse_vector", "illegal")},
		// &testCase{name: "dim error float_vector", content: suite.genAllTypesRowData("float_vector", "[0.1]")},
		// &testCase{name: "dim error bin_vector", content: suite.genAllTypesRowData("bin_vector", "[55]")},
		// &testCase{name: "dim error f16_vector", content: suite.genAllTypesRowData("f16_vector", "[0.2]")},
		// &testCase{name: "dim error bf16_vector", content: suite.genAllTypesRowData("bf16_vector", "[0.3]")},
		// &testCase{name: "dim error int8_vector", content: suite.genAllTypesRowData("int8_vector", "[1]")},
		// &testCase{name: "format error sparse_vector", content: suite.genAllTypesRowData("sparse_vector", "{\"indices\": 3}")},
	}
