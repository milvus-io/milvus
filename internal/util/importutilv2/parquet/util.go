...
func IsValidSparseVectorSchema(arrowType arrow.DataType) (bool, bool) {
	...
	if arrowID == arrow.STRUCT {
		...
		return (isValidType(indicesFinger, arrow.PrimitiveTypes.Uint32) || isValidType(indicesFinger, arrow.PrimitiveTypes.Int64)) &&
			(isValidType(valuesFinger, arrow.PrimitiveTypes.Float32) || isValidType(valuesFinger, arrow.PrimitiveTypes.Float64)), false
	}
