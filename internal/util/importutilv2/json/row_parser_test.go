...
func (suite *RowParserSuite) TestParseError() {
	...
	genCases := func() []*testCase {
		return []*testCase{
			&testCase{name: "duplicate key for dynamic 1", content: suite.genAllTypesRowData("$meta", map[string]any{"x": 8})},
			&testCase{name: "duplicate key  or dynamic 2", content: suite.genAllTypesRowData("$meta", "{\"x\": 8}")},
			&testCase{name: "illegal JSON content for dynamic", content: suite.genAllTypesRowData("$meta", "{*&%%&$*(&}")},
			&testCase{name: "not a JSON for dynamic", content: suite.genAllTypesRowData("$meta", []int{})},
			&testCase{name: "exceeds max length varchar", content: suite.genAllTypesRowData("varchar", "aaaaaaaaaa")},
			&testCase{name: "exceeds max capacity", content: suite.genAllTypesRowData("array_int8", []int{1, 2, 3, 4, 5})},
			&testCase{name: "field value missed", content: suite.genAllTypesRowData("x", 2, "float_vector")},
			&testCase{name: "type error bool", content: suite.genAllTypesRowData("bool", 0.2)},
			&testCase{name: "type error int8", content: suite.genAllTypesRowData("int8", []int32{})},
			&testCase{name: "type error int16", content: suite.genAllTypesRowData("int16", []int32{})},
			&testCase{name: "type error int32", content: suite.genAllTypesRowData("int32", []int32{})},
			&testCase{name: "type error int64", content: suite.genAllTypesRowData("int64", []int32{})},
			&testCase{name: "type error float", content: suite.genAllTypesRowData("float", []int32{})},
			&testCase{name: "type error double", content: suite.genAllTypesRowData("double", []int32{})},
			&testCase{name: "type error varchar", content: suite.genAllTypesRowData("varchar", []int32{})},
			&testCase{name: "type error json", content: suite.genAllTypesRowData("json", []int32{})},
			&testCase{name: "type error array_int8", content: suite.genAllTypesRowData("array_int8", "illegal")},
			&testCase{name: "element type error array_bool", content: suite.genAllTypesRowData("array_bool", []string{"illegal"})},
			&testCase{name: "element type error array_int8", content: suite.genAllTypesRowData("array_int8", []string{"illegal"})},
			&testCase{name: "element type error array_int16", content: suite.genAllTypesRowData("array_int16", []string{"illegal"})},
			&testCase{name: "element type error array_int32", content: suite.genAllTypesRowData("array_int32", []string{"illegal"})},
			&testCase{name: "element type error array_int64", content: suite.genAllTypesRowData("array_int64", []string{"illegal"})},
			&testCase{name: "element type error array_float", content: suite.genAllTypesRowData("array_float", []string{"illegal"})},
			&testCase{name: "element type error array_double", content: suite.genAllTypesRowData("array_double", []string{"illegal"})},
			&testCase{name: "element type error array_varchar", content: suite.genAllTypesRowData("array_varchar", []bool{false})},
			&testCase{name: "exceeds max length array_varchar", content: suite.genAllTypesRowData("array_varchar", []string{"aaaaaaaaaa"})},
			&testCase{name: "element parse error bool", content: suite.genAllTypesRowData("array_int8", []any{json.Number("0.2")})},
			&testCase{name: "element parse error bool", content: suite.genAllTypesRowData("array_int16", []any{json.Number("0.2")})},
			&testCase{name: "element parse error bool", content: suite.genAllTypesRowData("array_int32", []any{json.Number("0.2")})},
			&testCase{name: "element parse error bool", content: suite.genAllTypesRowData("array_int64", []any{json.Number("0.2")})},
			&testCase{name: "illegal JSON content", content: suite.genAllTypesRowData("json", "{*&%%&$*(&}")},
			&testCase{name: "parse error int8", content: suite.genAllTypesRowData("int8", 0.2)},
			&testCase{name: "parse error int16", content: suite.genAllTypesRowData("int16", 0.2)},
			&testCase{name: "parse error int32", content: suite.genAllTypesRowData("int32", 0.2)},
			&testCase{name: "parse error int64", content: suite.genAllTypesRowData("int64", 0.2)},
			...
			&testCase{name: "element parse error float_vector", content: suite.genAllTypesRowData("float_vector", []any{false, true})},
			&testCase{name: "type error bin_vector", content: suite.genAllTypesRowData("bin_vector", "illegal")},
			&testCase{name: "element parse error bin_vector", content: suite.genAllTypesRowData("bin_vector", []any{true, false})},
			&testCase{name: "element range error bin_vector", content: suite.genAllTypesRowData("bin_vector", []any{json.Number("256"), json.Number("0")})},
			&testCase{name: "type error f16_vector", content: suite.genAllTypesRowData("f16_vector", "illegal")},
			&testCase{name: "element parse error f16_vector", content: suite.genAllTypesRowData("f16_vector", []any{true, false})},
			&testCase{name: "type error bf16_vector", content: suite.genAllTypesRowData("bf16_vector", "illegal")},
			&testCase{name: "element parse error bf16_vector", content: suite.genAllTypesRowData("bf16_vector", []any{true, false})},
			&testCase{name: "type error int8_vector", content: suite.genAllTypesRowData("int8_vector", "illegal")},
			&testCase{name: "element parse error int8_vector", content: suite.genAllTypesRowData("int8_vector", []any{true, false})},
			&testCase{name: "type error sparse_vector", content: suite.genAllTypesRowData("sparse_vector", "illegal")},
			&testCase{name: "dim error float_vector", content: suite.genAllTypesRowData("float_vector", []float32{0.1})},
			&testCase{name: "dim error bin_vector", content: suite.genAllTypesRowData("bin_vector", []any{json.Number("44")})},
			&testCase{name: "dim error f16_vector", content: suite.genAllTypesRowData("f16_vector", []any{json.Number("0.2")})},
			&testCase{name: "dim error bf16_vector", content: suite.genAllTypesRowData("bf16_vector", []any{json.Number("0.3")})},
			&testCase{name: "dim error int8_vector", content: suite.genAllTypesRowData("int8_vector", []any{json.Number("1")})},
			&testCase{name: "format error sparse_vector", content: suite.genAllTypesRowData("sparse_vector", map[string]any{"indices": []int64{}})},
			&testCase{name: "function output no need provide", content: suite.genAllTypesRowData("function_sparse_vector", map[string]float64{"1": 0.1, "2": 0.2})},
		}
	}
