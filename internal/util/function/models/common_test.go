...
func (s *CommonSuite) TestParseAKAndURL() {
	...
	{
		apiKey, _, _ := ParseAKAndURL(&credentials.Credentials{}, []*commonpb.KeyValuePair{{Key: "integration_id", Value: "test-integration"}}, map[string]string{}, OpenaiAKEnvStr, "test-cluster")
		s.Equal(apiKey, "test-integration|test-cluster")
	}
}
