...
func newZillizProvider(params []*commonpb.KeyValuePair, conf map[string]string, extralInfo map[string]string) (modelProvider, error) {
	...
	c, err := zilliz.NewZilliClient(modelDeploymentID, cluster, conf)
	if err != nil {
		return nil, err
	}
