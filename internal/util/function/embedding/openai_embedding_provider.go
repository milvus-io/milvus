...
func newOpenAIEmbeddingProvider(fieldSchema *schemapb.FieldSchema, functionSchema *schemapb.FunctionSchema, params map[string]string, isAzure bool, credentials *credentials.Credentials, extralInfo map[string]string) (*OpenAIEmbeddingProvider, error) {
	...
	if !isAzure {
		apiKey, url, err := models.ParseAKAndURL(credentials, functionSchema.Params, params, models.OpenaiAKEnvStr, extralInfo[models.ClusterIDKey])
		if err != nil {
			return nil, err
		}
		...
		apiKey, url, err := models.ParseAKAndURL(credentials, functionSchema.Params, params, models.AzureOpenaiAKEnvStr, extralInfo[models.ClusterIDKey])
		if err != nil {
			return nil, err
		}
...
func NewOpenAIEmbeddingProvider(fieldSchema *schemapb.FieldSchema, functionSchema *schemapb.FunctionSchema, params map[string]string, credentials *credentials.Credentials, extralInfo map[string]string) (*OpenAIEmbeddingProvider, error) {
	return newOpenAIEmbeddingProvider(fieldSchema, functionSchema, params, false, credentials, extralInfo)
}

func NewAzureOpenAIEmbeddingProvider(fieldSchema *schemapb.FieldSchema, functionSchema *schemapb.FunctionSchema, params map[string]string, credentials *credentials.Credentials, extralInfo map[string]string) (*OpenAIEmbeddingProvider, error) {
	return newOpenAIEmbeddingProvider(fieldSchema, functionSchema, params, true, credentials, extralInfo)
}
