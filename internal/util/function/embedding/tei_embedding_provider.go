...
func NewTEIEmbeddingProvider(fieldSchema *schemapb.FieldSchema, functionSchema *schemapb.FunctionSchema, params map[string]string, credentials *credentials.Credentials, extralInfo map[string]string) (*TeiEmbeddingProvider, error) {
	...
	apiKey, _, err := models.ParseAKAndURL(credentials, functionSchema.Params, params, "", extralInfo[models.ClusterIDKey])
	if err != nil {
		return nil, err
	}
