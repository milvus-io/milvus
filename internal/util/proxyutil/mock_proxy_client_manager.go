...
// SyncDataViewGate provides a mock function with given fields: ctx, request
func (_m *MockProxyClientManager) SyncDataViewGate(ctx context.Context, request *proxypb.SyncDataViewGateRequest) error {
	ret := _m.Called(ctx, request)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *proxypb.SyncDataViewGateRequest) error); ok {
		r0 = rf(ctx, request)
	} else {
		r0 = ret.Error(0)
	}
...
// MockProxyClientManager_SyncDataViewGate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncDataViewGate'
type MockProxyClientManager_SyncDataViewGate_Call struct {
	*mock.Call
}

// SyncDataViewGate is a helper method to define mock.On call
//   - ctx context.Context
//   - request *proxypb.SyncDataViewGateRequest
func (_e *MockProxyClientManager_Expecter) SyncDataViewGate(ctx interface{}, request interface{}) *MockProxyClientManager_SyncDataViewGate_Call {
	return &MockProxyClientManager_SyncDataViewGate_Call{Call: _e.mock.On("SyncDataViewGate", ctx, request)}
}

func (_c *MockProxyClientManager_SyncDataViewGate_Call) Run(run func(ctx context.Context, request *proxypb.SyncDataViewGateRequest)) *MockProxyClientManager_SyncDataViewGate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockProxyClientManager_SyncDataViewGate_Call) Return(_a0 error) *MockProxyClientManager_SyncDataViewGate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockProxyClientManager_SyncDataViewGate_Call) RunAndReturn(run func(context.Context, *proxypb.SyncDataViewGateRequest) error) *MockProxyClientManager_SyncDataViewGate_Call {
	_c.Call.Return(run)
	return _c
}
