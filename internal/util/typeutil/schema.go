...
// GetPartitionFieldSchema get partition field schema from collection schema
func GetPartitionFieldSchema(schema *schemapb.CollectionSchema) (*schemapb.FieldSchema, error) {
	for _, fieldSchema := range schema.Fields {
