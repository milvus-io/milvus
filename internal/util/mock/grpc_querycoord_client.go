...
func (m *GrpcQueryCoordClient) ListResourceGroup(ctx context.Context, req *milvuspb.ListResourceGroupRequest, opts ...grpc.CallOption) (*milvuspb.ListResourceGroupResponse, error) {
	return &milvuspb.ListResourceGroupResponse{}, m.Err
}
