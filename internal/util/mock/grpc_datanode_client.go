...
func (m *GrpcDataNodeClient) NotifyChannelOperation(ctx context.Context, req *datapb.ChannelWatchInfo, opts ...grpc.CallOption) (*commonpb.Status, error) {
	return &commonpb.Status{}, m.Err
}

func (m *GrpcDataNodeClient) CheckChannelOperationProgress(ctx context.Context, req *datapb.ChannelOperationProgressRequest, opts ...grpc.CallOption) (*datapb.ChannelOperationProgressResponse, error) {
