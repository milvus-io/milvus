...
func (q QueryNodeClient) ChangeReplicaSegments(ctx context.Context, req *querypb.ChangeReplicaSegmentsRequest) (*commonpb.Status, error) {
	return q.grpcClient.ChangeReplicaSegments(ctx, req)
}
