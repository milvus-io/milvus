...
func (p *dataCoordConfig) initDiskAnnSegmentMaxSize() {
	p.DiskAnnSegmentMaxSize = p.Base.ParseFloatWithDefault("dataCoord.segment.diskAnnMaxSize", 512.0*3)
}
