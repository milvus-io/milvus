...
func InitRemoteArrowFileSystem(params *paramtable.ComponentParam) error {
	...
	storageConfig := C.CStorageConfig{
		...
		connectTimeoutMs:       C.int64_t(params.MinioCfg.ConnectTimeoutMs.GetAsInt64()),
		maxRetries:             C.int32_t(params.MinioCfg.MaxRetries.GetAsInt()),
		retryBaseDelayMs:       C.int64_t(params.MinioCfg.RetryBaseDelayMs.GetAsInt64()),
