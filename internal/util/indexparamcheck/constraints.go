...
var (
	...
	EmbListMetrics           = []string{metric.MaxSimIP, metric.MaxSimL2, metric.MaxSimCosine}                                        // const
	BinaryEmbListMetrics     = []string{metric.MaxSimHamming, metric.MaxSimJaccard}                                                   // const
)
