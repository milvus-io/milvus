...
// createNewSplitShardBroadcastMsg builds a SplitShard broadcast message naming
// its source vchannel append-first via OptBuildBroadcastAppendFirst.
func createNewSplitShardBroadcastMsg(vchannels []string, source string) message.BroadcastMutableMessage {
	...
	opts := []message.OptBuildBroadcast{message.OptBuildBroadcastAppendFirst(source)}
