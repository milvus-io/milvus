...
// DescribeSegmentIndexData provides a mock function with given fields: ctx, req
func (_m *MockQueryNode) DescribeSegmentIndexData(ctx context.Context, req *querypb.DescribeSegmentIndexDataRequest) (*querypb.DescribeSegmentIndexDataResponse, error) {
	ret := _m.Called(ctx, req)

	var r0 *querypb.DescribeSegmentIndexDataResponse
	if rf, ok := ret.Get(0).(func(context.Context, *querypb.DescribeSegmentIndexDataRequest) *querypb.DescribeSegmentIndexDataResponse); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*querypb.DescribeSegmentIndexDataResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *querypb.DescribeSegmentIndexDataRequest) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
...
// MockQueryNode_DescribeSegmentIndexData_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DescribeSegmentIndexData'
type MockQueryNode_DescribeSegmentIndexData_Call struct {
	*mock.Call
}
...
func (_e *MockQueryNode_Expecter) DescribeSegmentIndexData(ctx interface{}, req interface{}) *MockQueryNode_DescribeSegmentIndexData_Call {
	return &MockQueryNode_DescribeSegmentIndexData_Call{Call: _e.mock.On("DescribeSegmentIndexData", ctx, req)}
}

func (_c *MockQueryNode_DescribeSegmentIndexData_Call) Run(run func(ctx context.Context, req *querypb.DescribeSegmentIndexDataRequest)) *MockQueryNode_DescribeSegmentIndexData_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*querypb.DescribeSegmentIndexDataRequest))
	})
	return _c
}

func (_c *MockQueryNode_DescribeSegmentIndexData_Call) Return(_a0 *querypb.DescribeSegmentIndexDataResponse, _a1 error) *MockQueryNode_DescribeSegmentIndexData_Call {
