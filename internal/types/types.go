...
type ProxyComponent interface {
	...
	SetGracefulTime(ctx context.Context, request *milvuspb.SetGracefulTimeRequest) (*commonpb.Status, error)

	SetTimeTickInterval(ctx context.Context, request *milvuspb.SetTimeTickIntervalRequest) (*commonpb.Status, error)
}
