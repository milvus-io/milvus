...
func (_m *MockQueryCoord) SetDataCoord(dataCoord DataCoord) error {
	ret := _m.Called(dataCoord)

	var r0 error
	if rf, ok := ret.Get(0).(func(DataCoord) error); ok {
		r0 = rf(dataCoord)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockQueryCoord_SetDataCoord_Call) Run(run func(dataCoord DataCoord)) *MockQueryCoord_SetDataCoord_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueryCoord_SetDataCoord_Call) RunAndReturn(run func(DataCoord) error) *MockQueryCoord_SetDataCoord_Call {
	_c.Call.Return(run)
	return _c
}
...
// SetIndexCoord provides a mock function with given fields: indexCoord
func (_m *MockQueryCoord) SetIndexCoord(indexCoord IndexCoord) error {
	ret := _m.Called(indexCoord)

	var r0 error
	if rf, ok := ret.Get(0).(func(IndexCoord) error); ok {
		r0 = rf(indexCoord)
	} else {
		r0 = ret.Error(0)
	}
...
// MockQueryCoord_SetIndexCoord_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetIndexCoord'
type MockQueryCoord_SetIndexCoord_Call struct {
	*mock.Call
}

// SetIndexCoord is a helper method to define mock.On call
//   - indexCoord IndexCoord
func (_e *MockQueryCoord_Expecter) SetIndexCoord(indexCoord interface{}) *MockQueryCoord_SetIndexCoord_Call {
	return &MockQueryCoord_SetIndexCoord_Call{Call: _e.mock.On("SetIndexCoord", indexCoord)}
}

func (_c *MockQueryCoord_SetIndexCoord_Call) Run(run func(indexCoord IndexCoord)) *MockQueryCoord_SetIndexCoord_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(IndexCoord))
	})
	return _c
}

func (_c *MockQueryCoord_SetIndexCoord_Call) Return(_a0 error) *MockQueryCoord_SetIndexCoord_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockQueryCoord_SetIndexCoord_Call) RunAndReturn(run func(IndexCoord) error) *MockQueryCoord_SetIndexCoord_Call {
	_c.Call.Return(run)
	return _c
}

// SetRootCoord provides a mock function with given fields: rootCoord
func (_m *MockQueryCoord) SetRootCoord(rootCoord RootCoord) error {
	ret := _m.Called(rootCoord)

	var r0 error
	if rf, ok := ret.Get(0).(func(RootCoord) error); ok {
		r0 = rf(rootCoord)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockQueryCoord_SetRootCoord_Call) Run(run func(rootCoord RootCoord)) *MockQueryCoord_SetRootCoord_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueryCoord_SetRootCoord_Call) RunAndReturn(run func(RootCoord) error) *MockQueryCoord_SetRootCoord_Call {
	_c.Call.Return(run)
	return _c
}
...
type mockConstructorTestingTNewMockQueryCoord interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockQueryCoord(t mockConstructorTestingTNewMockQueryCoord) *MockQueryCoord {
	mock := &MockQueryCoord{}
	mock.Mock.Test(t)
