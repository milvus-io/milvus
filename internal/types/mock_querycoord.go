...
func (_m *MockQueryCoord) SetQueryNodeCreator(_a0 func(context.Context, string) (QueryNode, error)) {
	_m.Called(_a0)
}
...
func (_c *MockQueryCoord_SetQueryNodeCreator_Call) Run(run func(_a0 func(context.Context, string) (QueryNode, error))) *MockQueryCoord_SetQueryNodeCreator_Call {
	_c.Call.Run(func(args mock.Arguments) {
