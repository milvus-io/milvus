...
func (_m *MockProxy) GetRateLimiter() (Limiter, error) {
	ret := _m.Called()

	var r0 Limiter
	var r1 error
	if rf, ok := ret.Get(0).(func() (Limiter, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() Limiter); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockProxy_GetRateLimiter_Call) Return(_a0 Limiter, _a1 error) *MockProxy_GetRateLimiter_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProxy_GetRateLimiter_Call) RunAndReturn(run func() (Limiter, error)) *MockProxy_GetRateLimiter_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockProxy) SetDataCoordClient(dataCoord DataCoord) {
	_m.Called(dataCoord)
}
...
func (_c *MockProxy_SetDataCoordClient_Call) Run(run func(dataCoord DataCoord)) *MockProxy_SetDataCoordClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(DataCoord))
	})
	return _c
}
...
func (_c *MockProxy_SetDataCoordClient_Call) RunAndReturn(run func(DataCoord)) *MockProxy_SetDataCoordClient_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockProxy) SetQueryCoordClient(queryCoord QueryCoord) {
...
func (_c *MockProxy_SetQueryCoordClient_Call) Run(run func(queryCoord QueryCoord)) *MockProxy_SetQueryCoordClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(QueryCoord))
	})
	return _c
}
...
func (_c *MockProxy_SetQueryCoordClient_Call) RunAndReturn(run func(QueryCoord)) *MockProxy_SetQueryCoordClient_Call {
	_c.Call.Return(run)
	return _c
}

// SetQueryNodeCreator provides a mock function with given fields: _a0
func (_m *MockProxy) SetQueryNodeCreator(_a0 func(context.Context, string) (QueryNode, error)) {
	_m.Called(_a0)
}
...
func (_c *MockProxy_SetQueryNodeCreator_Call) Run(run func(_a0 func(context.Context, string) (QueryNode, error))) *MockProxy_SetQueryNodeCreator_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(func(context.Context, string) (QueryNode, error)))
	})
	return _c
}
...
func (_c *MockProxy_SetQueryNodeCreator_Call) RunAndReturn(run func(func(context.Context, string) (QueryNode, error))) *MockProxy_SetQueryNodeCreator_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockProxy) SetRootCoordClient(rootCoord RootCoord) {
	_m.Called(rootCoord)
}
...
func (_c *MockProxy_SetRootCoordClient_Call) Run(run func(rootCoord RootCoord)) *MockProxy_SetRootCoordClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(RootCoord))
	})
	return _c
}
...
func (_c *MockProxy_SetRootCoordClient_Call) RunAndReturn(run func(RootCoord)) *MockProxy_SetRootCoordClient_Call {
	_c.Call.Return(run)
	return _c
}
