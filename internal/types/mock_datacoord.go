...
func (_m *MockDataCoord) SetDataNodeCreator(_a0 func(context.Context, string) (DataNode, error)) {
	_m.Called(_a0)
}
...
//   - _a0 func(context.Context , string)(DataNode , error)
...
func (_c *MockDataCoord_SetDataNodeCreator_Call) Run(run func(_a0 func(context.Context, string) (DataNode, error))) *MockDataCoord_SetDataNodeCreator_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(func(context.Context, string) (DataNode, error)))
	})
	return _c
}
...
func (_c *MockDataCoord_SetDataNodeCreator_Call) RunAndReturn(run func(func(context.Context, string) (DataNode, error))) *MockDataCoord_SetDataNodeCreator_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDataCoord) SetIndexNodeCreator(_a0 func(context.Context, string) (IndexNode, error)) {
	_m.Called(_a0)
}
...
//   - _a0 func(context.Context , string)(IndexNode , error)
...
func (_c *MockDataCoord_SetIndexNodeCreator_Call) Run(run func(_a0 func(context.Context, string) (IndexNode, error))) *MockDataCoord_SetIndexNodeCreator_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(func(context.Context, string) (IndexNode, error)))
	})
	return _c
}
...
func (_c *MockDataCoord_SetIndexNodeCreator_Call) RunAndReturn(run func(func(context.Context, string) (IndexNode, error))) *MockDataCoord_SetIndexNodeCreator_Call {
	_c.Call.Return(run)
	return _c
}

// SetRootCoord provides a mock function with given fields: rootCoord
func (_m *MockDataCoord) SetRootCoord(rootCoord RootCoord) {
	_m.Called(rootCoord)
}
...
func (_c *MockDataCoord_SetRootCoord_Call) Run(run func(rootCoord RootCoord)) *MockDataCoord_SetRootCoord_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDataCoord_SetRootCoord_Call) RunAndReturn(run func(RootCoord)) *MockDataCoord_SetRootCoord_Call {
	_c.Call.Return(run)
	return _c
}
...
type mockConstructorTestingTNewMockDataCoord interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDataCoord(t mockConstructorTestingTNewMockDataCoord) *MockDataCoord {
	mock := &MockDataCoord{}
	mock.Mock.Test(t)
