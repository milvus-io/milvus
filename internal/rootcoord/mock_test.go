...
type mockMetaTable struct {
	...
	AlterCollectionFunc              func(ctx context.Context, oldColl *model.Collection, newColl *model.Collection, ts Timestamp, fieldModify bool, functionModify bool) error
...
func (m mockMetaTable) AlterCollection(ctx context.Context, oldColl *model.Collection, newColl *model.Collection, ts Timestamp, fieldModify bool, functionModify bool) error {
	return m.AlterCollectionFunc(ctx, oldColl, newColl, ts, fieldModify, functionModify)
}
