...
func BenchmarkAllocTimestamp(b *testing.B) {
	...
	Params.MsgChannelCfg.TimeTickChannel = fmt.Sprintf("master-time-tick-%d", randVal)
	Params.MsgChannelCfg.StatisticsChannel = fmt.Sprintf("master-statistics-%d", randVal)
