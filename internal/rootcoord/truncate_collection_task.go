...
func (t *truncateCollectionTask) Execute(ctx context.Context) error {
	err := t.core.ExpireMetaCache(t.ctx, t.mt.Req.GetDbName(), []string{}, t.mt.collection.CollectionID, "", t.GetTs(), proxyutil.SetMsgType(commonpb.MsgType_DropCollection))
	if err != nil {
		return err
	}
...
func (t *markCollectionTask) Execute(ctx context.Context) error {
	...
	// todo MsgType_TruncateCollection
	err = t.core.ExpireMetaCache(t.ctx, t.Req.GetDbName(), []string{}, t.collection.CollectionID, "", t.GetTs(), proxyutil.SetMsgType(commonpb.MsgType_DropCollection))
	if err != nil {
		return err
	}
