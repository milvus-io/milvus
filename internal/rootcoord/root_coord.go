...
func (c *Core) DescribeAlias(ctx context.Context, in *milvuspb.DescribeAliasRequest) (*milvuspb.DescribeAliasResponse, error) {
	...
	collectionName, err := c.meta.DescribeAlias(ctx, in.GetAlias(), 0)
...
func (c *Core) ListAliases(ctx context.Context, in *milvuspb.ListAliasRequest) (*milvuspb.ListAliasesResponse, error) {
	if code, ok := c.checkHealthy(); !ok {
	...
	aliases, err := c.meta.ListAliases(ctx, 0)
