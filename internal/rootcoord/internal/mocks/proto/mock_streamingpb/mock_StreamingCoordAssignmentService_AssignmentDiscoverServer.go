...
func (_m *MockStreamingCoordAssignmentService_AssignmentDiscoverServer) Recv() (*AssignmentDiscoverRequest, error) {
	ret := _m.Called()

	var r0 *AssignmentDiscoverRequest
	var r1 error
	if rf, ok := ret.Get(0).(func() (*AssignmentDiscoverRequest, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *AssignmentDiscoverRequest); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*AssignmentDiscoverRequest)
		}
	}
...
func (_c *MockStreamingCoordAssignmentService_AssignmentDiscoverServer_Recv_Call) Return(_a0 *AssignmentDiscoverRequest, _a1 error) *MockStreamingCoordAssignmentService_AssignmentDiscoverServer_Recv_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStreamingCoordAssignmentService_AssignmentDiscoverServer_Recv_Call) RunAndReturn(run func() (*AssignmentDiscoverRequest, error)) *MockStreamingCoordAssignmentService_AssignmentDiscoverServer_Recv_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockStreamingCoordAssignmentService_AssignmentDiscoverServer) Send(_a0 *AssignmentDiscoverResponse) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(*AssignmentDiscoverResponse) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
//  - _a0 *AssignmentDiscoverResponse
...
func (_c *MockStreamingCoordAssignmentService_AssignmentDiscoverServer_Send_Call) Run(run func(_a0 *AssignmentDiscoverResponse)) *MockStreamingCoordAssignmentService_AssignmentDiscoverServer_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*AssignmentDiscoverResponse))
	})
	return _c
}
...
func (_c *MockStreamingCoordAssignmentService_AssignmentDiscoverServer_Send_Call) RunAndReturn(run func(*AssignmentDiscoverResponse) error) *MockStreamingCoordAssignmentService_AssignmentDiscoverServer_Send_Call {
	_c.Call.Return(run)
	return _c
}
