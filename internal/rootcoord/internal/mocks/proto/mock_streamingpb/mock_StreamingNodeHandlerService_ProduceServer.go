...
func (_m *MockStreamingNodeHandlerService_ProduceServer) Recv() (*ProduceRequest, error) {
	ret := _m.Called()

	var r0 *ProduceRequest
	var r1 error
	if rf, ok := ret.Get(0).(func() (*ProduceRequest, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *ProduceRequest); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ProduceRequest)
		}
	}
...
func (_c *MockStreamingNodeHandlerService_ProduceServer_Recv_Call) Return(_a0 *ProduceRequest, _a1 error) *MockStreamingNodeHandlerService_ProduceServer_Recv_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStreamingNodeHandlerService_ProduceServer_Recv_Call) RunAndReturn(run func() (*ProduceRequest, error)) *MockStreamingNodeHandlerService_ProduceServer_Recv_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockStreamingNodeHandlerService_ProduceServer) Send(_a0 *ProduceResponse) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(*ProduceResponse) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockStreamingNodeHandlerService_ProduceServer_Send_Call) Run(run func(_a0 *ProduceResponse)) *MockStreamingNodeHandlerService_ProduceServer_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*ProduceResponse))
	})
	return _c
}
...
func (_c *MockStreamingNodeHandlerService_ProduceServer_Send_Call) RunAndReturn(run func(*ProduceResponse) error) *MockStreamingNodeHandlerService_ProduceServer_Send_Call {
	_c.Call.Return(run)
	return _c
}
