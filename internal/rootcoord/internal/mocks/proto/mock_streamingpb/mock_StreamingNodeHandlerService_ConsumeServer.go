...
func (_m *MockStreamingNodeHandlerService_ConsumeServer) Recv() (*ConsumeRequest, error) {
	ret := _m.Called()

	var r0 *ConsumeRequest
	var r1 error
	if rf, ok := ret.Get(0).(func() (*ConsumeRequest, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *ConsumeRequest); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ConsumeRequest)
		}
	}
...
func (_c *MockStreamingNodeHandlerService_ConsumeServer_Recv_Call) Return(_a0 *ConsumeRequest, _a1 error) *MockStreamingNodeHandlerService_ConsumeServer_Recv_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStreamingNodeHandlerService_ConsumeServer_Recv_Call) RunAndReturn(run func() (*ConsumeRequest, error)) *MockStreamingNodeHandlerService_ConsumeServer_Recv_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockStreamingNodeHandlerService_ConsumeServer) Send(_a0 *ConsumeResponse) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(*ConsumeResponse) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockStreamingNodeHandlerService_ConsumeServer_Send_Call) Run(run func(_a0 *ConsumeResponse)) *MockStreamingNodeHandlerService_ConsumeServer_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*ConsumeResponse))
	})
	return _c
}
...
func (_c *MockStreamingNodeHandlerService_ConsumeServer_Send_Call) RunAndReturn(run func(*ConsumeResponse) error) *MockStreamingNodeHandlerService_ConsumeServer_Send_Call {
	_c.Call.Return(run)
	return _c
}
