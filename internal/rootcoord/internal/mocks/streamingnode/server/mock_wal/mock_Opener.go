...
func (_m *MockOpener) Open(ctx context.Context, opt *OpenOption) (WAL, error) {
	ret := _m.Called(ctx, opt)

	var r0 WAL
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *OpenOption) (WAL, error)); ok {
		return rf(ctx, opt)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *OpenOption) WAL); ok {
		r0 = rf(ctx, opt)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(WAL)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *OpenOption) error); ok {
		r1 = rf(ctx, opt)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockOpener_Open_Call) Run(run func(ctx context.Context, opt *OpenOption)) *MockOpener_Open_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*OpenOption))
	})
	return _c
}

func (_c *MockOpener_Open_Call) Return(_a0 WAL, _a1 error) *MockOpener_Open_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockOpener_Open_Call) RunAndReturn(run func(context.Context, *OpenOption) (WAL, error)) *MockOpener_Open_Call {
	_c.Call.Return(run)
	return _c
}
