...
func (_m *MockOpenerBuilder) Build() (Opener, error) {
	ret := _m.Called()

	var r0 Opener
	var r1 error
	if rf, ok := ret.Get(0).(func() (Opener, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() Opener); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Opener)
...
func (_c *MockOpenerBuilder_Build_Call) Return(_a0 Opener, _a1 error) *MockOpenerBuilder_Build_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockOpenerBuilder_Build_Call) RunAndReturn(run func() (Opener, error)) *MockOpenerBuilder_Build_Call {
	_c.Call.Return(run)
	return _c
}
