...
func (_m *MockWAL) Read(ctx context.Context, deliverPolicy ReadOption) (Scanner, error) {
	ret := _m.Called(ctx, deliverPolicy)

	var r0 Scanner
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ReadOption) (Scanner, error)); ok {
		return rf(ctx, deliverPolicy)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ReadOption) Scanner); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, ReadOption) error); ok {
...
func (_c *MockWAL_Read_Call) Run(run func(ctx context.Context, deliverPolicy ReadOption)) *MockWAL_Read_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(ReadOption))
	})
	return _c
}

func (_c *MockWAL_Read_Call) Return(_a0 Scanner, _a1 error) *MockWAL_Read_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWAL_Read_Call) RunAndReturn(run func(context.Context, ReadOption) (Scanner, error)) *MockWAL_Read_Call {
	_c.Call.Return(run)
	return _c
}
