...
func (_c *MockClientConn_NewAddress_Call) Run(run func(addresses []Address)) *MockClientConn_NewAddress_Call {
...
func (_c *MockClientConn_NewAddress_Call) RunAndReturn(run func([]Address)) *MockClientConn_NewAddress_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClientConn) UpdateState(_a0 State) error {
	ret := _m.Called(_a0)
...
func (_c *MockClientConn_UpdateState_Call) Run(run func(_a0 State)) *MockClientConn_UpdateState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(State))
	})
	return _c
...
func (_c *MockClientConn_UpdateState_Call) RunAndReturn(run func(State) error) *MockClientConn_UpdateState_Call {
	_c.Call.Return(run)
	return _c
}
