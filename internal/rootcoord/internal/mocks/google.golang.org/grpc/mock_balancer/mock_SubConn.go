...
func (_m *MockSubConn) GetOrBuildProducer(_a0 ProducerBuilder) (Producer, func()) {
	ret := _m.Called(_a0)

	var r0 Producer
	var r1 func()
	if rf, ok := ret.Get(0).(func(ProducerBuilder) (Producer, func())); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(ProducerBuilder) Producer); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Producer)
		}
	}

	if rf, ok := ret.Get(1).(func(ProducerBuilder) func()); ok {
		r1 = rf(_a0)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(func())
...
func (_c *MockSubConn_GetOrBuildProducer_Call) Run(run func(_a0 ProducerBuilder)) *MockSubConn_GetOrBuildProducer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ProducerBuilder))
	})
	return _c
}

func (_c *MockSubConn_GetOrBuildProducer_Call) Return(p Producer, close func()) *MockSubConn_GetOrBuildProducer_Call {
	_c.Call.Return(p, close)
	return _c
}

func (_c *MockSubConn_GetOrBuildProducer_Call) RunAndReturn(run func(ProducerBuilder) (Producer, func())) *MockSubConn_GetOrBuildProducer_Call {
	_c.Call.Return(run)
	return _c
}
