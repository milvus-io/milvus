...
func (_m *MockDiscoverer) Discover(ctx context.Context, cb func(VersionedState) error) error {
	ret := _m.Called(ctx, cb)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(VersionedState) error) error); ok {
		r0 = rf(ctx, cb)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockDiscoverer_Discover_Call) Run(run func(ctx context.Context, cb func(VersionedState) error)) *MockDiscoverer_Discover_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(VersionedState) error))
	})
	return _c
}
...
func (_c *MockDiscoverer_Discover_Call) RunAndReturn(run func(context.Context, func(VersionedState) error) error) *MockDiscoverer_Discover_Call {
	_c.Call.Return(run)
	return _c
}

// NewVersionedState provides a mock function with given fields:
func (_m *MockDiscoverer) NewVersionedState() VersionedState {
	ret := _m.Called()

	var r0 VersionedState
	if rf, ok := ret.Get(0).(func() VersionedState); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(VersionedState)
	}
...
func (_c *MockDiscoverer_NewVersionedState_Call) Return(_a0 VersionedState) *MockDiscoverer_NewVersionedState_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockDiscoverer_NewVersionedState_Call) RunAndReturn(run func() VersionedState) *MockDiscoverer_NewVersionedState_Call {
	_c.Call.Return(run)
	return _c
}
