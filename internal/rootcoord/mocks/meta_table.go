...
// DescribeAlias provides a mock function with given fields: ctx, alias, ts
func (_m *IMetaTable) DescribeAlias(ctx context.Context, alias string, ts uint64) (string, error) {
...
//   - alias string
//   - ts uint64
func (_e *IMetaTable_Expecter) DescribeAlias(ctx interface{}, alias interface{}, ts interface{}) *IMetaTable_DescribeAlias_Call {
	return &IMetaTable_DescribeAlias_Call{Call: _e.mock.On("DescribeAlias", ctx, alias, ts)}
}

func (_c *IMetaTable_DescribeAlias_Call) Run(run func(ctx context.Context, alias string, ts uint64)) *IMetaTable_DescribeAlias_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *IMetaTable) ListAliases(ctx context.Context, ts uint64) ([]string, error) {
	ret := _m.Called(ctx, ts)
...
//   - ctx context.Context
//   - ts uint64
func (_e *IMetaTable_Expecter) ListAliases(ctx interface{}, ts interface{}) *IMetaTable_ListAliases_Call {
	return &IMetaTable_ListAliases_Call{Call: _e.mock.On("ListAliases", ctx, ts)}
}

func (_c *IMetaTable_ListAliases_Call) Run(run func(ctx context.Context, ts uint64)) *IMetaTable_ListAliases_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64))
	})
	return _c
