...
// ApplyShardSplitRouting provides a mock function with given fields: ctx, collectionID, updates, timetick
func (_m *IMetaTable) ApplyShardSplitRouting(ctx context.Context, collectionID int64, updates *messagespb.AlterCollectionMessageUpdates, timetick uint64) error {
	ret := _m.Called(ctx, collectionID, updates, timetick)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, *messagespb.AlterCollectionMessageUpdates, uint64) error); ok {
		r0 = rf(ctx, collectionID, updates, timetick)
	} else {
		r0 = ret.Error(0)
	}
...
//   - timetick uint64
func (_e *IMetaTable_Expecter) ApplyShardSplitRouting(ctx interface{}, collectionID interface{}, updates interface{}, timetick interface{}) *IMetaTable_ApplyShardSplitRouting_Call {
	return &IMetaTable_ApplyShardSplitRouting_Call{Call: _e.mock.On("ApplyShardSplitRouting", ctx, collectionID, updates, timetick)}
}

func (_c *IMetaTable_ApplyShardSplitRouting_Call) Run(run func(ctx context.Context, collectionID int64, updates *messagespb.AlterCollectionMessageUpdates, timetick uint64)) *IMetaTable_ApplyShardSplitRouting_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(*messagespb.AlterCollectionMessageUpdates), args[3].(uint64))
	})
	return _c
}
...
func (_c *IMetaTable_ApplyShardSplitRouting_Call) RunAndReturn(run func(context.Context, int64, *messagespb.AlterCollectionMessageUpdates, uint64) error) *IMetaTable_ApplyShardSplitRouting_Call {
	_c.Call.Return(run)
	return _c
}
