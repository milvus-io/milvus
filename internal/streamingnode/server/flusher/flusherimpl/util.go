...
// getRecoveryInfos gets the recovery info of the vchannels.
func (impl *WALFlusherImpl) getRecoveryInfos(ctx context.Context, vchannel []string) (map[string]*datapb.GetChannelRecoveryInfoResponse, error) {
	...
	for i, future := range futures {
		...
		return nil, errors.Wrapf(err, "when get recovery info of vchannel %s", vchannel[i])
	}
