...
func TestConcurrentStasManager(t *testing.T) {
	...
	params.Save(params.StreamingCfg.FlushGrowingSegmentHwmBytesThreshold.Key, "0.000002")
	params.Save(params.StreamingCfg.FlushGrowingSegmentLwmBytesThreshold.Key, "0.000001")
