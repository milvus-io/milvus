...
// SealSegment seals the segment with the specified segmentID.
func (m *partitionSegmentManager) SealSegment(segmentID int64) (sealedSegment *segmentAllocManager) {
	m.mu.Lock()
	defer m.mu.Unlock()
