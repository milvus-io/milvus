...
type GetDataDistributionResponse struct {
	...
	Segments             []*SegmentVersionInfo `protobuf:"bytes,4,rep,name=segments,proto3" json:"segments,omitempty"`
	Channels             []*ChannelVersionInfo `protobuf:"bytes,5,rep,name=channels,proto3" json:"channels,omitempty"`
	LeaderViews          []*LeaderView         `protobuf:"bytes,6,rep,name=leaderViews,proto3" json:"leaderViews,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *GetDataDistributionResponse) GetGrowingSegmentIDs() []int64 {
	if m != nil {
...
type LeaderView struct {
	...
	SegmentNodePairs     map[int64]int64 `protobuf:"bytes,3,rep,name=segmentNodePairs,proto3" json:"segmentNodePairs,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
