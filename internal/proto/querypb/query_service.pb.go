...
type WatchDmChannelsRequest struct {
	...
	ChannelIDs           []string                   `protobuf:"bytes,5,rep,name=channelIDs,proto3" json:"channelIDs,omitempty"`
	Infos                []*WatchDmChannelInfo      `protobuf:"bytes,6,rep,name=infos,proto3" json:"infos,omitempty"`
	Schema               *schemapb.CollectionSchema `protobuf:"bytes,7,opt,name=schema,proto3" json:"schema,omitempty"`
	ExcludeInfos         []*ExcludedSegmentInfo     `protobuf:"bytes,8,rep,name=exclude_infos,json=excludeInfos,proto3" json:"exclude_infos,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *WatchDmChannelsRequest) GetExcludeInfos() []*ExcludedSegmentInfo {
	if m != nil {
...
func (*FieldBinlog) Descriptor() ([]byte, []int) {
	return fileDescriptor_5fcb6756dc1afb8d, []int{36}
}
...
func (*GetRecoveryInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5fcb6756dc1afb8d, []int{37}
}
...
func (*GetRecoveryInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5fcb6756dc1afb8d, []int{38}
}
...
var fileDescriptor_5fcb6756dc1afb8d = []byte{
	...
	,
}
