...
func (m *IndexStateInfo) Reset()         { *m = IndexStateInfo{} }
...
func (m *IndexStateInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IndexStateInfo.Unmarshal(m, b)
}
func (m *IndexStateInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IndexStateInfo.Marshal(b, m, deterministic)
}
func (m *IndexStateInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IndexStateInfo.Merge(m, src)
}
func (m *IndexStateInfo) XXX_Size() int {
	return xxx_messageInfo_IndexStateInfo.Size(m)
}
func (m *IndexStateInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_IndexStateInfo.DiscardUnknown(m)
}

var xxx_messageInfo_IndexStateInfo proto.InternalMessageInfo

func (m *IndexStateInfo) GetBuildID() int64 {
	if m != nil {
		return m.BuildID
	}
	return 0
...
func (m *IndexStateInfo) GetState() commonpb.IndexState {
	if m != nil {
		return m.State
	}
	return commonpb.IndexState_IndexStateNone
...
func (m *IndexStateInfo) GetIndexFiles() []string {
	if m != nil {
		return m.IndexFiles
	}
	return nil
...
type QueryJobsResponse struct {
	...
	IndexInfos           []*IndexStateInfo `protobuf:"bytes,3,rep,name=index_infos,json=indexInfos,proto3" json:"index_infos,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *QueryJobsResponse) GetIndexInfos() []*IndexStateInfo {
	if m != nil {
		return m.IndexInfos
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*IndexStateInfo)(nil), "milvus.proto.index.IndexStateInfo")
