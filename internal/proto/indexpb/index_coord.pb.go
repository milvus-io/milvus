...
type CreateJobRequest struct {
	ClusterID            int64                    `protobuf:"varint,1,opt,name=clusterID,proto3" json:"clusterID,omitempty"`
	StorageAccessKey     string                   `protobuf:"bytes,2,opt,name=storage_access_key,json=storageAccessKey,proto3" json:"storage_access_key,omitempty"`
	...
	IndexVersion         int64                    `protobuf:"varint,7,opt,name=index_version,json=indexVersion,proto3" json:"index_version,omitempty"`
	...
	TypeParams           []*commonpb.KeyValuePair `protobuf:"bytes,9,rep,name=type_params,json=typeParams,proto3" json:"type_params,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *CreateJobRequest) GetStoragePrefix() string {
	if m != nil {
...
func (m *QueryJobsResponse) GetIndexInfos() []*IndexInfo {
	if m != nil {
		return m.IndexInfos
	}
	return nil
...
var fileDescriptor_f9e019eb3fda53c2 = []byte{
	...
	,
}
