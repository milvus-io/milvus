...
type CollectionSchema struct {
	...
	Alias2Name           map[string]string `protobuf:"bytes,5,rep,name=Alias2Name,proto3" json:"Alias2Name,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	AliasTimestamp       uint64            `protobuf:"varint,6,opt,name=AliasTimestamp,proto3" json:"AliasTimestamp,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *CollectionSchema) GetAlias2Name() map[string]string {
	if m != nil {
		return m.Alias2Name
	}
	return nil
...
func (m *CollectionSchema) GetAliasTimestamp() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "milvus.proto.schema.CollectionSchema.Alias2NameEntry")
...
var fileDescriptor_1c5fb4d8cc22d66a = []byte{
	...
	,
}
