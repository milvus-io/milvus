...
type LoadCollectionRequest struct {
	...
	CollectionName       string   `protobuf:"bytes,3,opt,name=collection_name,json=collectionName,proto3" json:"collection_name,omitempty"`
	SeekToLatest         bool     `protobuf:"varint,4,opt,name=seek_to_latest,json=seekToLatest,proto3" json:"seek_to_latest,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LoadCollectionRequest) GetSeekToLatest() bool {
	if m != nil {
		return m.SeekToLatest
	}
	return false
}
...
type LoadPartitionsRequest struct {
	...
	SeekToLatest         bool     `protobuf:"varint,5,opt,name=seek_to_latest,json=seekToLatest,proto3" json:"seek_to_latest,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LoadPartitionsRequest) GetSeekToLatest() bool {
	if m != nil {
		return m.SeekToLatest
	}
	return false
...
type SearchRequest struct {
	...
	Nqs                  []int64                  `protobuf:"varint,13,rep,packed,name=nqs,proto3" json:"nqs,omitempty"`
	MsgIds               []int64                  `protobuf:"varint,14,rep,packed,name=msg_ids,json=msgIds,proto3" json:"msg_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *SearchRequest) GetMerged() bool {
	if m != nil {
		return m.Merged
	}
	return false
...
func (m *SearchRequest) GetNqs() []int64 {
	if m != nil {
		return m.Nqs
	}
	return nil
...
func (m *SearchRequest) GetMsgIds() []int64 {
	if m != nil {
		return m.MsgIds
	}
	return nil
...
type SetGracefulTimeRequest struct {
	Base                 *commonpb.MsgBase `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	GracefulTime         int64             `protobuf:"varint,2,opt,name=graceful_time,json=gracefulTime,proto3" json:"graceful_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}

func (m *SetGracefulTimeRequest) Reset()         { *m = SetGracefulTimeRequest{} }
func (m *SetGracefulTimeRequest) String() string { return proto.CompactTextString(m) }
func (*SetGracefulTimeRequest) ProtoMessage()    {}
func (*SetGracefulTimeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_02345ba45cc0e303, []int{66}
}

func (m *SetGracefulTimeRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetGracefulTimeRequest.Unmarshal(m, b)
}
func (m *SetGracefulTimeRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetGracefulTimeRequest.Marshal(b, m, deterministic)
}
func (m *SetGracefulTimeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetGracefulTimeRequest.Merge(m, src)
}
func (m *SetGracefulTimeRequest) XXX_Size() int {
	return xxx_messageInfo_SetGracefulTimeRequest.Size(m)
}
func (m *SetGracefulTimeRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SetGracefulTimeRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SetGracefulTimeRequest proto.InternalMessageInfo

func (m *SetGracefulTimeRequest) GetBase() *commonpb.MsgBase {
	if m != nil {
		return m.Base
	}
	return nil
...
func (m *SetGracefulTimeRequest) GetGracefulTime() int64 {
	if m != nil {
		return m.GracefulTime
	}
	return 0
}

type SetTimeTickIntervalRequest struct {
	Base                 *commonpb.MsgBase `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	TimeTickInterval     int64             `protobuf:"varint,2,opt,name=time_tick_interval,json=timeTickInterval,proto3" json:"time_tick_interval,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}

func (m *SetTimeTickIntervalRequest) Reset()         { *m = SetTimeTickIntervalRequest{} }
func (m *SetTimeTickIntervalRequest) String() string { return proto.CompactTextString(m) }
func (*SetTimeTickIntervalRequest) ProtoMessage()    {}
func (*SetTimeTickIntervalRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_02345ba45cc0e303, []int{67}
}

func (m *SetTimeTickIntervalRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetTimeTickIntervalRequest.Unmarshal(m, b)
}
func (m *SetTimeTickIntervalRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetTimeTickIntervalRequest.Marshal(b, m, deterministic)
}
func (m *SetTimeTickIntervalRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetTimeTickIntervalRequest.Merge(m, src)
}
func (m *SetTimeTickIntervalRequest) XXX_Size() int {
	return xxx_messageInfo_SetTimeTickIntervalRequest.Size(m)
}
func (m *SetTimeTickIntervalRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SetTimeTickIntervalRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SetTimeTickIntervalRequest proto.InternalMessageInfo

func (m *SetTimeTickIntervalRequest) GetBase() *commonpb.MsgBase {
	if m != nil {
		return m.Base
	}
	return nil
...
func (m *SetTimeTickIntervalRequest) GetTimeTickInterval() int64 {
	if m != nil {
		return m.TimeTickInterval
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*SetGracefulTimeRequest)(nil), "milvus.proto.milvus.SetGracefulTimeRequest")
	proto.RegisterType((*SetTimeTickIntervalRequest)(nil), "milvus.proto.milvus.SetTimeTickIntervalRequest")
}
...
var fileDescriptor_02345ba45cc0e303 = []byte{
	...
	,
}
...
type MilvusServiceClient interface {
	...
	SetGracefulTime(ctx context.Context, in *SetGracefulTimeRequest, opts ...grpc.CallOption) (*commonpb.Status, error)
	SetTimeTickInterval(ctx context.Context, in *SetTimeTickIntervalRequest, opts ...grpc.CallOption) (*commonpb.Status, error)
}
...
func (c *milvusServiceClient) SetGracefulTime(ctx context.Context, in *SetGracefulTimeRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	out := new(commonpb.Status)
	err := c.cc.Invoke(ctx, "/milvus.proto.milvus.MilvusService/SetGracefulTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *milvusServiceClient) SetTimeTickInterval(ctx context.Context, in *SetTimeTickIntervalRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	out := new(commonpb.Status)
	err := c.cc.Invoke(ctx, "/milvus.proto.milvus.MilvusService/SetTimeTickInterval", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MilvusServiceServer interface {
	...
	SetGracefulTime(context.Context, *SetGracefulTimeRequest) (*commonpb.Status, error)
	SetTimeTickInterval(context.Context, *SetTimeTickIntervalRequest) (*commonpb.Status, error)
}
...
func (*UnimplementedMilvusServiceServer) SetGracefulTime(ctx context.Context, req *SetGracefulTimeRequest) (*commonpb.Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetGracefulTime not implemented")
}
func (*UnimplementedMilvusServiceServer) SetTimeTickInterval(ctx context.Context, req *SetTimeTickIntervalRequest) (*commonpb.Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetTimeTickInterval not implemented")
}
...
func _MilvusService_SetGracefulTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetGracefulTimeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MilvusServiceServer).SetGracefulTime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/milvus.proto.milvus.MilvusService/SetGracefulTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MilvusServiceServer).SetGracefulTime(ctx, req.(*SetGracefulTimeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MilvusService_SetTimeTickInterval_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetTimeTickIntervalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MilvusServiceServer).SetTimeTickInterval(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/milvus.proto.milvus.MilvusService/SetTimeTickInterval",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MilvusServiceServer).SetTimeTickInterval(ctx, req.(*SetTimeTickIntervalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MilvusService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetGracefulTime",
			Handler:    _MilvusService_SetGracefulTime_Handler,
		},
		{
			MethodName: "SetTimeTickInterval",
			Handler:    _MilvusService_SetTimeTickInterval_Handler,
		},
	},
