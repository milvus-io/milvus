...
type PositionPair struct {
	StartPositions       []*internalpb.MsgPosition `protobuf:"bytes,1,rep,name=start_positions,json=startPositions,proto3" json:"start_positions,omitempty"`
	EndPositions         []*internalpb.MsgPosition `protobuf:"bytes,2,rep,name=end_positions,json=endPositions,proto3" json:"end_positions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *PositionPair) GetStartPositions() []*internalpb.MsgPosition {
	if m != nil {
...
func (m *PositionPair) GetEndPositions() []*internalpb.MsgPosition {
	if m != nil {
...
type VchannelPair struct {
	...
	StartEndPositions    *PositionPair `protobuf:"bytes,4,opt,name=start_end_positions,json=startEndPositions,proto3" json:"start_end_positions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *VchannelPair) GetStartEndPositions() *PositionPair {
	if m != nil {
		return m.StartEndPositions
	}
	return nil
}
...
type SaveBinlogPathsRequest struct {
	...
	StartEndPositions    *PositionPair     `protobuf:"bytes,6,opt,name=start_end_positions,json=startEndPositions,proto3" json:"start_end_positions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *SaveBinlogPathsRequest) GetStartEndPositions() *PositionPair {
	if m != nil {
		return m.StartEndPositions
	}
	return nil
...
var fileDescriptor_3385cd32ad6cfe64 = []byte{
	...
	,
}
