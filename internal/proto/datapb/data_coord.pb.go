...
type ImportRequestInternal struct {
	...
	Schema               *schemapb.CollectionSchema `protobuf:"bytes,4,opt,name=schema,proto3" json:"schema,omitempty"`
	Files                []*milvuspb.ImportFile     `protobuf:"bytes,5,rep,name=files,proto3" json:"files,omitempty"`
...
func (m *ImportRequestInternal) GetFiles() []*milvuspb.ImportFile {
	if m != nil {
		return m.Files
	}
	return nil
...
type PreImportRequest struct {
	...
	ImportFiles          []*milvuspb.ImportFile     `protobuf:"bytes,8,rep,name=import_files,json=importFiles,proto3" json:"import_files,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *PreImportRequest) GetImportFiles() []*milvuspb.ImportFile {
	if m != nil {
...
type ImportRequestSegment struct {
	...
	AutoIDRanges         *AutoIDRange `protobuf:"bytes,5,opt,name=autoID_ranges,json=autoIDRanges,proto3" json:"autoID_ranges,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}

func (m *ImportRequestSegment) Reset()         { *m = ImportRequestSegment{} }
func (m *ImportRequestSegment) String() string { return proto.CompactTextString(m) }
...
func (m *ImportRequestSegment) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ImportRequestSegment.Unmarshal(m, b)
}
func (m *ImportRequestSegment) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ImportRequestSegment.Marshal(b, m, deterministic)
}
func (m *ImportRequestSegment) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ImportRequestSegment.Merge(m, src)
}
func (m *ImportRequestSegment) XXX_Size() int {
	return xxx_messageInfo_ImportRequestSegment.Size(m)
}
func (m *ImportRequestSegment) XXX_DiscardUnknown() {
	xxx_messageInfo_ImportRequestSegment.DiscardUnknown(m)
}

var xxx_messageInfo_ImportRequestSegment proto.InternalMessageInfo

func (m *ImportRequestSegment) GetSegmentID() int64 {
	if m != nil {
		return m.SegmentID
	}
	return 0
...
func (m *ImportRequestSegment) GetPartitionID() int64 {
	if m != nil {
		return m.PartitionID
	}
	return 0
...
func (m *ImportRequestSegment) GetVchannel() string {
	if m != nil {
		return m.Vchannel
	}
	return ""
...
func (m *ImportRequestSegment) GetTs() uint64 {
	if m != nil {
		return m.Ts
	}
	return 0
...
func (m *ImportRequestSegment) GetAutoIDRanges() *AutoIDRange {
	if m != nil {
...
type ImportRequest struct {
	...
	CollectionID         int64                           `protobuf:"varint,4,opt,name=collectionID,proto3" json:"collectionID,omitempty"`
	Schema               *schemapb.CollectionSchema      `protobuf:"bytes,5,opt,name=schema,proto3" json:"schema,omitempty"`
	Files                []*milvuspb.ImportFile          `protobuf:"bytes,6,rep,name=files,proto3" json:"files,omitempty"`
	Ts                   uint64                          `protobuf:"varint,7,opt,name=ts,proto3" json:"ts,omitempty"`
	AutoIDRange          *AutoIDRange                    `protobuf:"bytes,8,opt,name=autoID_range,json=autoIDRange,proto3" json:"autoID_range,omitempty"`
	RequestSegments      map[int64]*ImportRequestSegment `protobuf:"bytes,9,rep,name=request_segments,json=requestSegments,proto3" json:"request_segments,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                        `json:"-"`
	XXX_unrecognized     []byte                          `json:"-"`
	XXX_sizecache        int32                           `json:"-"`
}
...
func (m *ImportRequest) GetFiles() []*milvuspb.ImportFile {
	if m != nil {
		return m.Files
	}
	return nil
...
func (m *ImportRequest) GetTs() uint64 {
	if m != nil {
		return m.Ts
	}
	return 0
...
func (m *ImportRequest) GetAutoIDRange() *AutoIDRange {
	if m != nil {
		return m.AutoIDRange
	}
	return nil
}

func (m *ImportRequest) GetRequestSegments() map[int64]*ImportRequestSegment {
	if m != nil {
		return m.RequestSegments
	}
	return nil
}
...
type ImportFileStats struct {
	ImportFile           *milvuspb.ImportFile      `protobuf:"bytes,1,opt,name=import_file,json=importFile,proto3" json:"import_file,omitempty"`
...
func (m *ImportFileStats) GetImportFile() *milvuspb.ImportFile {
	if m != nil {
		return m.ImportFile
	}
	return nil
...
type QueryPreImportResponse struct {
	...
	State                milvuspb.ImportState `protobuf:"varint,3,opt,name=state,proto3,enum=milvus.proto.milvus.ImportState" json:"state,omitempty"`
...
func (m *QueryPreImportResponse) GetState() milvuspb.ImportState {
	if m != nil {
		return m.State
	}
	return milvuspb.ImportState_None
}
...
func (m *QueryImportResponse) GetState() milvuspb.ImportState {
	if m != nil {
		return m.State
	}
	return milvuspb.ImportState_None
...
type PreImportTask struct {
	...
	State                milvuspb.ImportState `protobuf:"varint,7,opt,name=state,proto3,enum=milvus.proto.milvus.ImportState" json:"state,omitempty"`
...
func (m *PreImportTask) GetState() milvuspb.ImportState {
	if m != nil {
		return m.State
	}
	return milvuspb.ImportState_None
...
type ImportTaskV2 struct {
	...
	State                milvuspb.ImportState `protobuf:"varint,6,opt,name=state,proto3,enum=milvus.proto.milvus.ImportState" json:"state,omitempty"`
...
func (m *ImportTaskV2) GetState() milvuspb.ImportState {
	if m != nil {
		return m.State
	}
	return milvuspb.ImportState_None
...
func init() {
	...
	proto.RegisterType((*ImportRequestInternal)(nil), "milvus.proto.data.ImportRequestInternal")
	...
	proto.RegisterType((*ImportRequestSegment)(nil), "milvus.proto.data.ImportRequestSegment")
	proto.RegisterType((*ImportRequest)(nil), "milvus.proto.data.ImportRequest")
	proto.RegisterMapType((map[int64]*ImportRequestSegment)(nil), "milvus.proto.data.ImportRequest.RequestSegmentsEntry")
...
var fileDescriptor_82cd95f524594f49 = []byte{
	// 6110 bytes of a gzipped FileDescriptorProto
	,
}
...
type DataCoordClient interface {
	...
	// importV2
	ImportV2(ctx context.Context, in *ImportRequestInternal, opts ...grpc.CallOption) (*milvuspb.ImportResponseV2, error)
	GetImportProgress(ctx context.Context, in *milvuspb.GetImportProgressRequest, opts ...grpc.CallOption) (*milvuspb.GetImportProgressResponse, error)
	ListImports(ctx context.Context, in *milvuspb.ListImportsRequest, opts ...grpc.CallOption) (*milvuspb.ListImportsResponse, error)
}
...
func (c *dataCoordClient) ImportV2(ctx context.Context, in *ImportRequestInternal, opts ...grpc.CallOption) (*milvuspb.ImportResponseV2, error) {
	out := new(milvuspb.ImportResponseV2)
...
func (c *dataCoordClient) GetImportProgress(ctx context.Context, in *milvuspb.GetImportProgressRequest, opts ...grpc.CallOption) (*milvuspb.GetImportProgressResponse, error) {
	out := new(milvuspb.GetImportProgressResponse)
...
func (c *dataCoordClient) ListImports(ctx context.Context, in *milvuspb.ListImportsRequest, opts ...grpc.CallOption) (*milvuspb.ListImportsResponse, error) {
	out := new(milvuspb.ListImportsResponse)
...
type DataCoordServer interface {
	...
	// importV2
	ImportV2(context.Context, *ImportRequestInternal) (*milvuspb.ImportResponseV2, error)
	GetImportProgress(context.Context, *milvuspb.GetImportProgressRequest) (*milvuspb.GetImportProgressResponse, error)
	ListImports(context.Context, *milvuspb.ListImportsRequest) (*milvuspb.ListImportsResponse, error)
}
...
func (*UnimplementedDataCoordServer) ImportV2(ctx context.Context, req *ImportRequestInternal) (*milvuspb.ImportResponseV2, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ImportV2 not implemented")
}
func (*UnimplementedDataCoordServer) GetImportProgress(ctx context.Context, req *milvuspb.GetImportProgressRequest) (*milvuspb.GetImportProgressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetImportProgress not implemented")
}
func (*UnimplementedDataCoordServer) ListImports(ctx context.Context, req *milvuspb.ListImportsRequest) (*milvuspb.ListImportsResponse, error) {
...
func _DataCoord_ImportV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataCoordServer).ImportV2(ctx, req.(*ImportRequestInternal))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DataCoord_GetImportProgress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(milvuspb.GetImportProgressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataCoordServer).GetImportProgress(ctx, req.(*milvuspb.GetImportProgressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DataCoord_ListImports_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(milvuspb.ListImportsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataCoordServer).ListImports(ctx, req.(*milvuspb.ListImportsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
