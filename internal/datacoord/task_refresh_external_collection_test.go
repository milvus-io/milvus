...
func TestApplyExternalCollectionSegmentUpdateWithSchemaVersion_RejectsSchemaChange(t *testing.T) {
	ctx := context.Background()
	collectionID := int64(100)
	segmentID := int64(10)
	collections := newTestCollections(collectionID)
	...
	err := applyExternalCollectionSegmentUpdateWithSchemaVersion(
		ctx,
		mt,
		collectionID,
		true,
