...
func calculateClusteringCompactionConfig(coll *metacache.CollectionInfo, view CompactionView, expectedSegmentSize int64) (totalRows, maxSegmentRows, preferSegmentRows int64, err error) {
