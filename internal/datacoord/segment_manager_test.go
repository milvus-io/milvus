...
func TestLastExpireReset(t *testing.T) {
	...
	// dataCoord restart
	newEtcdCli, _ := etcd.GetEtcdClient(Params.EtcdCfg.UseEmbedEtcd.GetAsBool(), Params.EtcdCfg.EtcdEnableAuth.GetAsBool(),
		Params.EtcdCfg.EtcdAuthUserName.GetValue(),
		Params.EtcdCfg.EtcdAuthPassword.GetValue(), Params.EtcdCfg.EtcdUseSSL.GetAsBool(),
