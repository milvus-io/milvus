...
func (s *AssignByCountPolicySuite) TestWithoutUnassignedChannels() {
	...
	s.Run("extreme cases", func() {
		...
		for i := 0; i < 100; i++ {
			channels = append(channels, getChannel(fmt.Sprintf("ch-%d", i), 1))
		}
		s.curCluster = []*NodeChannelInfo{
			{NodeID: 1, Channels: channels},
			{NodeID: 2, Channels: []RWChannel{}},
			{NodeID: 3, Channels: []RWChannel{}},
			{NodeID: 4, Channels: []RWChannel{}},
			{NodeID: 5, Channels: []RWChannel{}},
		}
