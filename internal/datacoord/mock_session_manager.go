...
// GetCompactionState provides a mock function with given fields:
func (_m *MockSessionManager) GetCompactionState() map[int64]*datapb.CompactionStateResult {
	ret := _m.Called()

	var r0 map[int64]*datapb.CompactionStateResult
	if rf, ok := ret.Get(0).(func() map[int64]*datapb.CompactionStateResult); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[int64]*datapb.CompactionStateResult)
		}
	}
...
// MockSessionManager_GetCompactionState_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCompactionState'
type MockSessionManager_GetCompactionState_Call struct {
	*mock.Call
}

// GetCompactionState is a helper method to define mock.On call
func (_e *MockSessionManager_Expecter) GetCompactionState() *MockSessionManager_GetCompactionState_Call {
	return &MockSessionManager_GetCompactionState_Call{Call: _e.mock.On("GetCompactionState")}
}

func (_c *MockSessionManager_GetCompactionState_Call) Run(run func()) *MockSessionManager_GetCompactionState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockSessionManager_GetCompactionState_Call) Return(_a0 map[int64]*datapb.CompactionStateResult) *MockSessionManager_GetCompactionState_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSessionManager_GetCompactionState_Call) RunAndReturn(run func() map[int64]*datapb.CompactionStateResult) *MockSessionManager_GetCompactionState_Call {
	_c.Call.Return(run)
	return _c
}
