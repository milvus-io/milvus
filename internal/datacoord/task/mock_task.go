...
func (_m *MockTask) GetTaskResource() taskcommon.Resource {
	ret := _m.Called()
...
func (_c *MockTask_GetTaskResource_Call) Return(_a0 taskcommon.Resource) *MockTask_GetTaskResource_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTask_GetTaskResource_Call) RunAndReturn(run func() taskcommon.Resource) *MockTask_GetTaskResource_Call {
	_c.Call.Return(run)
	return _c
}
