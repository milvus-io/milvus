...
type ChannelManager interface {
	...
	MarkChannelAdded(ctx context.Context, channelName string) error
	MarkChannelDeleted(ctx context.Context, channelName string) error
	GcConfirm(ctx context.Context, collectionID, partitionID typeutil.UniqueID) bool
	ChannelExists(ctx context.Context, channelName string) bool
	ShouldDropChannel(ctx context.Context, channelName string) bool
	DropChannel(ctx context.Context, channelName string) error
}
