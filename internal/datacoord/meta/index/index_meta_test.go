...
var (
	collID         = typeutil.UniqueID(100)
	partID         = typeutil.UniqueID(200)
	indexID        = typeutil.UniqueID(300)
	fieldID        = typeutil.UniqueID(400)
	indexName      = "_default_idx"
	segID          = typeutil.UniqueID(500)
	buildID        = typeutil.UniqueID(600)
	nodeID         = typeutil.UniqueID(700)
	partitionKeyID = typeutil.UniqueID(800)
)
...
func TestMeta_CanCreateIndex(t *testing.T) {
	var (
		...
		indexID    = typeutil.UniqueID(10)
		fieldID    = typeutil.UniqueID(100)
		indexName  = "_default_idx"
...
func TestMeta_HasSameReq(t *testing.T) {
	...
	t.Run("has same req", func(t *testing.T) {
		m.indexes[collID] = map[typeutil.UniqueID]*model.Index{
			indexID: {
				TenantID:        "",
				CollectionID:    collID,
				FieldID:         fieldID,
...
func TestMeta_AddSegmentIndex(t *testing.T) {
	...
	m := newSegmentIndexMeta(ec)
	m.segmentIndexes = map[typeutil.UniqueID]map[typeutil.UniqueID]*model.SegmentIndex{
		1: make(map[typeutil.UniqueID]*model.SegmentIndex, 0),
	}
...
func TestMeta_GetSegmentIndexState(t *testing.T) {
	var (
		...
		indexID    = typeutil.UniqueID(10)
		fieldID    = typeutil.UniqueID(100)
		segID      = typeutil.UniqueID(1000)
		buildID    = typeutil.UniqueID(10000)
		indexName  = "_default_idx"
		typeParams = []*commonpb.KeyValuePair{
			{
				Key:   common.DimKey,
	...
	m := newSegmentIndexMeta(&datacoord.Catalog{MetaKv: metakv})
	m.segmentIndexes = map[typeutil.UniqueID]map[typeutil.UniqueID]*model.SegmentIndex{
		segID: make(map[typeutil.UniqueID]*model.SegmentIndex, 0),
	}
...
func TestMeta_GetIndexedSegment(t *testing.T) {
	...
	m.indexes = map[typeutil.UniqueID]map[typeutil.UniqueID]*model.Index{
		collID: {
			indexID: {
				TenantID:        "",
				CollectionID:    collID,
	...
	m.buildID2SegmentIndex = map[typeutil.UniqueID]*model.SegmentIndex{
		buildID: {
			SegmentID:     segID,
			CollectionID:  collID,
			PartitionID:   partID,
...
func TestMeta_MarkIndexAsDeleted(t *testing.T) {
	...
	t.Run("fail", func(t *testing.T) {
		m.catalog = ec
		err := m.MarkIndexAsDeleted(collID, []typeutil.UniqueID{indexID, indexID + 1, indexID + 2})
		assert.Error(t, err)
	})
	...
	t.Run("success", func(t *testing.T) {
		...
		err = m.MarkIndexAsDeleted(collID+1, []typeutil.UniqueID{indexID, indexID + 1, indexID + 2})
		assert.NoError(t, err)
	})
}
...
func TestMeta_GetFieldIDByIndexID(t *testing.T) {
	...
	t.Run("fail", func(t *testing.T) {
		...
		assert.Equal(t, typeutil.UniqueID(0), fID)
	})
}
