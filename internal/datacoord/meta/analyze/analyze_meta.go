...
func (m *analyzeMeta) GetAnalyzeTask(taskID int64) *indexpb.AnalyzeTask {
	m.RLock()
	defer m.RUnlock()
...
func (m *analyzeMeta) UpdateAnalyzeVersion(taskID int64) error {
	m.Lock()
	defer m.Unlock()
...
func (m *analyzeMeta) BuildingAnalyzeTask(taskID, nodeID int64) error {
	m.Lock()
	defer m.Unlock()
...
func (m *analyzeMeta) CheckCleanAnalyzeTask(taskID typeutil.UniqueID) (bool, *indexpb.AnalyzeTask) {
	m.RLock()
	defer m.RUnlock()
