...
func (s *Server) importV1AckCallback(ctx context.Context, result message.BroadcastResultImportMessageV1) error {
	...
	// Query database info to get dbID
	// For now, we use 0 as dbID in ack callback since the message was already validated
	// TODO: Consider storing dbID in the broadcast message or querying from RootCoord
	var dbID int64 = 0
