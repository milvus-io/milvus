...
// Update provides a mock function with given fields: ctx, op
func (_m *MockRWChannelStore) Update(ctx context.Context, op *ChannelOpSet) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *ChannelOpSet) error); ok {
		r0 = rf(ctx, op)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - op *ChannelOpSet
func (_e *MockRWChannelStore_Expecter) Update(ctx interface{}, op interface{}) *MockRWChannelStore_Update_Call {
	return &MockRWChannelStore_Update_Call{Call: _e.mock.On("Update", ctx, op)}
}

func (_c *MockRWChannelStore_Update_Call) Run(run func(ctx context.Context, op *ChannelOpSet)) *MockRWChannelStore_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*ChannelOpSet))
	})
	return _c
}
...
func (_c *MockRWChannelStore_Update_Call) RunAndReturn(run func(context.Context, *ChannelOpSet) error) *MockRWChannelStore_Update_Call {
	_c.Call.Return(run)
	return _c
}
