...
func (_m *MockWorkerManager) QuerySlots() []WorkerSlots {
	ret := _m.Called()
	...
	var r0 []WorkerSlots
	if rf, ok := ret.Get(0).(func() []WorkerSlots); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]WorkerSlots)
		}
	}
...
func (_c *MockWorkerManager_QuerySlots_Call) Return(_a0 []WorkerSlots) *MockWorkerManager_QuerySlots_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWorkerManager_QuerySlots_Call) RunAndReturn(run func() []WorkerSlots) *MockWorkerManager_QuerySlots_Call {
	_c.Call.Return(run)
	return _c
}
