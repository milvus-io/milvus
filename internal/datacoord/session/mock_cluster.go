...
// DropCopySegment provides a mock function with given fields: ctx, nodeID, taskID, taskVersion, abort
func (_m *MockCluster) DropCopySegment(ctx context.Context, nodeID int64, taskID int64, taskVersion int64, abort bool) error {
	ret := _m.Called(ctx, nodeID, taskID, taskVersion, abort)
	...
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, int64, bool) error); ok {
		r0 = rf(ctx, nodeID, taskID, taskVersion, abort)
	} else {
		r0 = ret.Error(0)
	}
...
//   - taskVersion int64
//   - abort bool
func (_e *MockCluster_Expecter) DropCopySegment(ctx interface{}, nodeID interface{}, taskID interface{}, taskVersion interface{}, abort interface{}) *MockCluster_DropCopySegment_Call {
	return &MockCluster_DropCopySegment_Call{Call: _e.mock.On("DropCopySegment", ctx, nodeID, taskID, taskVersion, abort)}
}

func (_c *MockCluster_DropCopySegment_Call) Run(run func(ctx context.Context, nodeID int64, taskID int64, taskVersion int64, abort bool)) *MockCluster_DropCopySegment_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCluster_DropCopySegment_Call) RunAndReturn(run func(context.Context, int64, int64, int64, bool) error) *MockCluster_DropCopySegment_Call {
	_c.Call.Return(run)
	return _c
}
