...
func ValidateIndexParams(index *model.Index) error {
	...
	if err := indexparamcheck.ValidateMmapTypeParams(indexType, indexParams); err != nil {
	...
	if err := indexparamcheck.ValidateMmapTypeParams(indexType, userIndexParams); err != nil {
