...
// AddByRole provides a mock function with given fields: role, session
func (_m *MockVersionManager) AddByRole(role string, session *sessionutil.Session) {
	_m.Called(role, session)
}
...
// RemoveByRole provides a mock function with given fields: role, session
func (_m *MockVersionManager) RemoveByRole(role string, session *sessionutil.Session) {
	_m.Called(role, session)
}
...
// StartupByRole provides a mock function with given fields: role, sessions
func (_m *MockVersionManager) StartupByRole(role string, sessions map[string]*sessionutil.Session) {
	_m.Called(role, sessions)
}
...
// UpdateByRole provides a mock function with given fields: role, session
func (_m *MockVersionManager) UpdateByRole(role string, session *sessionutil.Session) {
	_m.Called(role, session)
}
