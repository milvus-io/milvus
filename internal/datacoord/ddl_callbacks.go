...
// startBroadcastWithCollectionID returns the broadcast API and the metadata
// used to select its resource keys; callers can recheck that identity under the lock.
