...
// convertToMsgImportFiles converts internal ImportFile to message ImportFile
func convertToMsgImportFiles(internals []*internalpb.ImportFile) []*msgpb.ImportFile {
