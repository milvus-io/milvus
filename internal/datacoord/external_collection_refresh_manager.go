...
//
// The number of tasks equals the number of available DataNodes (one task per DN).
// Each task receives its assigned file list via proto fields, avoiding S3 manifest reads.
