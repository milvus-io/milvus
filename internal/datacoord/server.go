...
func (s *Server) registerMetricsRequest() {
	metricsinfo.RegisterMetricsRequest(metricsinfo.SystemInfoMetrics,
		func(ctx context.Context, req *milvuspb.GetMetricsRequest, jsonReq gjson.Result) (string, error) {
			return s.getSystemInfoMetrics(ctx, req)
		})

	metricsinfo.RegisterMetricsRequest(metricsinfo.ImportTasks,
		func(ctx context.Context, req *milvuspb.GetMetricsRequest, jsonReq gjson.Result) (string, error) {
			return s.importMeta.TaskStatsJSON(), nil
		})

	metricsinfo.RegisterMetricsRequest(metricsinfo.CompactionTasks,
		func(ctx context.Context, req *milvuspb.GetMetricsRequest, jsonReq gjson.Result) (string, error) {
			return s.meta.compactionTaskMeta.TaskStatsJSON(), nil
		})

	metricsinfo.RegisterMetricsRequest(metricsinfo.BuildIndexTasks,
		func(ctx context.Context, req *milvuspb.GetMetricsRequest, jsonReq gjson.Result) (string, error) {
