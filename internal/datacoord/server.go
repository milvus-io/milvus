...
type DataCoordOption func(svr *Server)

func SetRootCoordCreator(creator rootCoordCreatorFunc) DataCoordOption {
...
func CreateServer(ctx context.Context, factory msgstream.Factory, opts ...DataCoordOption) (*Server, error) {
