...
// datacoord Spark-backfill registration site (CommitBackfillResult) needs. The coordinator
...
type BackfillAtomicGateRegistrar interface {
	RegisterSegmentList(ctx context.Context, collectionID, roundID int64, source string, vectorFieldIDs, scalarFieldIDs []int64, segmentVCommit map[int64]int64) error
}
