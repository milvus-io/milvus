...
func newSplitShardTask() *datapb.SplitShardTask {
	return &datapb.SplitShardTask{
		...
		Sources: []*datapb.SplitShardTaskSource{
			{Vchannel: "by-dev-rootcoord-dml_0_1v0", SwitchTimeTick: 2000},
		},
		Targets: []*datapb.SplitShardTaskTarget{
			{Vchannel: "by-dev-rootcoord-dml_1_1v1", Buckets: []uint64{0}},
			{Vchannel: "by-dev-rootcoord-dml_2_1v2", Buckets: []uint64{1}},
		},
...
func TestCatalogSplitShardTask(t *testing.T) {
	...
	t.Run("save and key layout", func(t *testing.T) {
		...
		assert.Equal(t, uint64(2000), saved.GetSources()[0].GetSwitchTimeTick())
	...
	t.Run("list", func(t *testing.T) {
		...
		assert.Equal(t, "by-dev-rootcoord-dml_0_1v0", tasks[0].GetSources()[0].GetVchannel())
	})
