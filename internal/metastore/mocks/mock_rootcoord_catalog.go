...
// DeleteGrantByDatabaseID provides a mock function with given fields: ctx, tenant, dbID, dbName
func (_m *RootCoordCatalog) DeleteGrantByDatabaseID(ctx context.Context, tenant string, dbID int64, dbName string) error {
	ret := _m.Called(ctx, tenant, dbID, dbName)

	if len(ret) == 0 {
		panic("no return value specified for DeleteGrantByDatabaseID")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, string) error); ok {
		r0 = rf(ctx, tenant, dbID, dbName)
	} else {
		r0 = ret.Error(0)
	}
...
// RootCoordCatalog_DeleteGrantByDatabaseID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteGrantByDatabaseID'
type RootCoordCatalog_DeleteGrantByDatabaseID_Call struct {
	*mock.Call
}

// DeleteGrantByDatabaseID is a helper method to define mock.On call
//   - ctx context.Context
//   - tenant string
//   - dbID int64
//   - dbName string
func (_e *RootCoordCatalog_Expecter) DeleteGrantByDatabaseID(ctx interface{}, tenant interface{}, dbID interface{}, dbName interface{}) *RootCoordCatalog_DeleteGrantByDatabaseID_Call {
	return &RootCoordCatalog_DeleteGrantByDatabaseID_Call{Call: _e.mock.On("DeleteGrantByDatabaseID", ctx, tenant, dbID, dbName)}
}

func (_c *RootCoordCatalog_DeleteGrantByDatabaseID_Call) Run(run func(ctx context.Context, tenant string, dbID int64, dbName string)) *RootCoordCatalog_DeleteGrantByDatabaseID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RootCoordCatalog_DeleteGrantByDatabaseID_Call) Return(_a0 error) *RootCoordCatalog_DeleteGrantByDatabaseID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RootCoordCatalog_DeleteGrantByDatabaseID_Call) RunAndReturn(run func(context.Context, string, int64, string) error) *RootCoordCatalog_DeleteGrantByDatabaseID_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteStaleNameBasedGrant provides a mock function with given fields: ctx, tenant, dbName, collectionName
func (_m *RootCoordCatalog) DeleteStaleNameBasedGrant(ctx context.Context, tenant string, dbName string, collectionName string) error {
	ret := _m.Called(ctx, tenant, dbName, collectionName)

	if len(ret) == 0 {
		panic("no return value specified for DeleteStaleNameBasedGrant")
	}
...
// RootCoordCatalog_DeleteStaleNameBasedGrant_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteStaleNameBasedGrant'
type RootCoordCatalog_DeleteStaleNameBasedGrant_Call struct {
	*mock.Call
}

// DeleteStaleNameBasedGrant is a helper method to define mock.On call
//   - ctx context.Context
//   - tenant string
//   - dbName string
//   - collectionName string
func (_e *RootCoordCatalog_Expecter) DeleteStaleNameBasedGrant(ctx interface{}, tenant interface{}, dbName interface{}, collectionName interface{}) *RootCoordCatalog_DeleteStaleNameBasedGrant_Call {
	return &RootCoordCatalog_DeleteStaleNameBasedGrant_Call{Call: _e.mock.On("DeleteStaleNameBasedGrant", ctx, tenant, dbName, collectionName)}
}

func (_c *RootCoordCatalog_DeleteStaleNameBasedGrant_Call) Run(run func(ctx context.Context, tenant string, dbName string, collectionName string)) *RootCoordCatalog_DeleteStaleNameBasedGrant_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RootCoordCatalog_DeleteStaleNameBasedGrant_Call) Return(_a0 error) *RootCoordCatalog_DeleteStaleNameBasedGrant_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RootCoordCatalog_DeleteStaleNameBasedGrant_Call) RunAndReturn(run func(context.Context, string, string, string) error) *RootCoordCatalog_DeleteStaleNameBasedGrant_Call {
	_c.Call.Return(run)
	return _c
}
