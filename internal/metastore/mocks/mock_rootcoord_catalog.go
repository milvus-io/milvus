...
// DropRLSPolicy provides a mock function with given fields: ctx, collectionID, policyID
func (_m *RootCoordCatalog) DropRLSPolicy(ctx context.Context, collectionID int64, policyID int64) error {
	ret := _m.Called(ctx, collectionID, policyID)
	...
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64) error); ok {
		r0 = rf(ctx, collectionID, policyID)
	} else {
		r0 = ret.Error(0)
	}
...
//   - collectionID int64
//   - policyID int64
func (_e *RootCoordCatalog_Expecter) DropRLSPolicy(ctx interface{}, collectionID interface{}, policyID interface{}) *RootCoordCatalog_DropRLSPolicy_Call {
	return &RootCoordCatalog_DropRLSPolicy_Call{Call: _e.mock.On("DropRLSPolicy", ctx, collectionID, policyID)}
}

func (_c *RootCoordCatalog_DropRLSPolicy_Call) Run(run func(ctx context.Context, collectionID int64, policyID int64)) *RootCoordCatalog_DropRLSPolicy_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RootCoordCatalog_DropRLSPolicy_Call) RunAndReturn(run func(context.Context, int64, int64) error) *RootCoordCatalog_DropRLSPolicy_Call {
	_c.Call.Return(run)
	return _c
}
