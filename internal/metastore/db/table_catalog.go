...
func (tc *Catalog) AlterIndex(ctx context.Context, indexes []*model.Index) error {
	//switch alterType {
	//case metastore.ADD:
...
func (tc *Catalog) AlterSegmentIndex(ctx context.Context, segIdxes []*model.SegmentIndex) error {
	return nil
}

func (tc *Catalog) DropIndex(ctx context.Context, collID typeutil.UniqueID, dropIdxID typeutil.UniqueID, ts typeutil.Timestamp) error {
	//tenantID := contextutil.TenantID(ctx)
	//
	//return tc.txImpl.Transaction(ctx, func(txCtx context.Context) error {
