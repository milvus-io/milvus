...
// flowgraph ddNode.
func newDmInputNode(initCtx context.Context, dispatcherClient msgdispatcher.Client, seekPos *msgpb.MsgPosition, dmNodeConfig *datanode.nodeConfig) (*flowgraph.InputNode, error) {
	...
	node := flowgraph.NewInputNode(
		input,
		name,
		server.Params.DataNodeCfg.FlowGraphMaxQueueLength.GetAsInt32(),
		server.Params.DataNodeCfg.FlowGraphMaxParallelism.GetAsInt32(),
