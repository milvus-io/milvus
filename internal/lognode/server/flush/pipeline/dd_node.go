...
func (ddn *ddNode) Operate(in []Msg) []Msg {
	...
	for _, msg := range msMsg.TsMessages() {
		ctx, sp := datanode.startTracer(msg, "DDNode-Operate")
	...
	for _, msg := range msMsg.TsMessages() {
		...
		case commonpb.MsgType_Insert:
			...
			datanode.rateCol.Add(metricsinfo.InsertConsumeThroughput, float64(proto.Size(&imsg.InsertRequest)))
		...
		case commonpb.MsgType_Delete:
			...
			datanode.rateCol.Add(metricsinfo.DeleteConsumeThroughput, float64(proto.Size(&dmsg.DeleteRequest)))
...
func newDDNode(ctx context.Context, collID UniqueID, vChannelName string, droppedSegmentIDs []UniqueID,
	...
	baseNode := BaseNode{}
	baseNode.SetMaxQueueLength(server.Params.DataNodeCfg.FlowGraphMaxQueueLength.GetAsInt32())
	baseNode.SetMaxParallelism(server.Params.DataNodeCfg.FlowGraphMaxParallelism.GetAsInt32())
