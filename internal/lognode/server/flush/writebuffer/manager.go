...
type BufferManager interface {
	...
	Register(channel string, metacache meta.MetaCache, opts ...WriteBufferOption) error
...
func (m *bufferManager) Register(channel string, metacache meta.MetaCache, opts ...WriteBufferOption) error {
	m.mut.Lock()
	defer m.mut.Unlock()
