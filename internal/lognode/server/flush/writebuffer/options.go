...
type writeBufferOption struct {
	...
	pkStatsFactory meta.PkStatsFactory
	metaWriter     syncmgr.MetaWriter
}

func defaultWBOption(metacache meta.MetaCache) *writeBufferOption {
...
func WithPKStatsFactory(factory meta.PkStatsFactory) WriteBufferOption {
	return func(opt *writeBufferOption) {
