...
func Test_NewClient(t *testing.T) {
	...
	// 	return &mock.MixCoordClient{Err: nil}
	// }
...
func Test_Flush(t *testing.T) {
	...
	mockGrpcClient.EXPECT().ReCall(mock.Anything, mock.Anything).RunAndReturn(func(ctx context.Context, f func(MixCoordClient) (interface{}, error)) (interface{}, error) {
		return f(mockMc)
	})
	client.(*Client).grpcClient = mockGrpcClient

	// test success
	mockMc.EXPECT().Flush(mock.Anything, mock.Anything).Return(&datapb.FlushResponse{
		Status: merr.Success(),
	}, nil)
