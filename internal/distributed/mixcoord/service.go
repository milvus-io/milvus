...
func (s *Server) AlterCollectionSchema(ctx context.Context, in *milvuspb.AlterCollectionSchemaRequest) (*milvuspb.AlterCollectionSchemaResponse, error) {
	return s.mixCoord.AlterCollectionSchema(ctx, in)
}
