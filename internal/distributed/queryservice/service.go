...
func (s *Server) init() error {
	...
	masterService, err := msc.NewClient(qs.Params.MetaRootPath, qs.Params.EtcdAddress, 3*time.Second)
	...
	dataService := dsc.NewClient(qs.Params.MetaRootPath, qs.Params.EtcdAddress, 3*time.Second)
