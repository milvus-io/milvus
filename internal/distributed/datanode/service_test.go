...
func (m *MockDataNode) NotifyChannelOperation(ctx context.Context, req *datapb.ChannelWatchInfo) (*commonpb.Status, error) {
	return m.status, m.err
}

func (m *MockDataNode) CheckChannelOperationProgress(ctx context.Context, req *datapb.ChannelOperationProgressRequest) (*datapb.ChannelOperationProgressResponse, error) {
