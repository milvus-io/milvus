...
func (c *Client) NotifyChannelOperation(ctx context.Context, req *datapb.ChannelWatchInfo) (*commonpb.Status, error) {
	return wrapGrpcCall(ctx, c, func(client datapb.DataNodeClient) (*commonpb.Status, error) {
		return client.NotifyChannelOperation(ctx, req)
	})
}

func (c *Client) CheckChannelOperationProgress(ctx context.Context, req *datapb.ChannelOperationProgressRequest) (*datapb.ChannelOperationProgressResponse, error) {
