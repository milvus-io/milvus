...
func (s *Server) init() error {
	...
	s.queryServiceClient, err = grpcqueryserviceclient.NewClient(ctx, proxynode.Params.MetaRootPath, queryServiceAddr, []string{proxynode.Params.EtcdAddress}, timeout)
	if err != nil {
		return err
	}
