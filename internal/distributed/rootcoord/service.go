...
func (s *Server) init() error {
	...
	if s.newDataCoordClient != nil {
		...
		dataCoord := s.newDataCoordClient(rootcoord.Params.BaseParams.MetaRootPath, rootcoord.Params.BaseParams.EtcdEndpoints)
	...
	if s.newIndexCoordClient != nil {
		...
		indexCoord := s.newIndexCoordClient(rootcoord.Params.BaseParams.MetaRootPath, rootcoord.Params.BaseParams.EtcdEndpoints)
	...
	if s.newQueryCoordClient != nil {
		...
		queryCoord := s.newQueryCoordClient(rootcoord.Params.BaseParams.MetaRootPath, rootcoord.Params.BaseParams.EtcdEndpoints)
