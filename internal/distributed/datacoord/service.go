...
func (s *Server) ListChannelSegmentInfo(req *datapb.ChannelSegmentInfoRequest, stream datapb.DataCoord_ListChannelSegmentInfoServer) error {
	return s.dataCoord.ListChannelSegmentInfo(req, stream)
}
