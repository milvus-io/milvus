...
func (s *Server) init() error {
	...
	proxy.Params.ProxyCfg.Port = Params.Port
	proxy.Params.ProxyCfg.IP = Params.IP

	proxy.Params.ProxyCfg.Address = Params.GetAddress()
	...
	if s.rootCoordClient == nil {
		s.rootCoordClient, err = rcc.NewClient(s.ctx, proxy.Params.BaseParams.MetaRootPath, proxy.Params.BaseParams.EtcdEndpoints)
		if err != nil {
	...
	if s.dataCoordClient == nil {
		s.dataCoordClient, err = dcc.NewClient(s.ctx, proxy.Params.BaseParams.MetaRootPath, proxy.Params.BaseParams.EtcdEndpoints)
		if err != nil {
	...
	if s.indexCoordClient == nil {
		s.indexCoordClient, err = icc.NewClient(s.ctx, proxy.Params.BaseParams.MetaRootPath, proxy.Params.BaseParams.EtcdEndpoints)
		if err != nil {
	...
	if s.queryCooedClient == nil {
		s.queryCooedClient, err = qcc.NewClient(s.ctx, proxy.Params.BaseParams.MetaRootPath, proxy.Params.BaseParams.EtcdEndpoints)
		if err != nil {
			return err
		}
	}
