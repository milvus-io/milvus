...
func (s *Server) SelectResource(ctx context.Context, req *milvuspb.SelectResourceRequest) (*milvuspb.SelectResourceResponse, error) {
	return s.proxy.SelectResource(ctx, req)
}
