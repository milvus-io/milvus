...
func TestBuildSearchResp(t *testing.T) {
	t.Run("with multi nq with int64 type", func(t *testing.T) {
		...
		assert.Equal(t, true, compareRows(res[0], expect[0], compareRow))
		assert.Equal(t, true, compareRows(res[1], expect[1], compareRow))
	})
	...
	t.Run("with one nq with int64 type", func(t *testing.T) {
		...
		assert.Equal(t, true, compareRows(res[0], expect, compareRow))
	})
